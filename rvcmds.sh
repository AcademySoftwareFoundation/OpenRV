...
alias rvenv="python3 -m venv _virtualenv && source _virtualenv/bin/activate"
alias rvsetup="SETUPTOOLS_USE_DISTUTILS=${SETUPTOOLS_USE_DISTUTILS} && rvenv && python3 -m pip install --upgrade -r ${RV_HOME}/requirements.txt"
