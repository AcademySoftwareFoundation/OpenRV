...
class: UTVHelpMenuMinorMode : MinorMode
{
    ...
    method: UTVHelpMenuMinorMode (UTVHelpMenuMinorMode;)
    {
        Menu menuList = newMenu(MenuItem[] {
                ...
                menuItem("   Mu User's Manual", "", "help_category", opUrl(,"https://github.com/AcademySoftwareFoundation/UTV/blob/main/docs/rv-manuals/rv-mu-programming.md"), enabledItem),
                menuSeparator(),
                menuItem("   GTO File Format (.rv files)", "", "help_category", opUrl(,"https://github.com/AcademySoftwareFoundation/UTV/blob/main/docs/rv-manuals/rv-gto.md"), enabledItem),
                menuSeparator(),
                menuItem("   Academy Software Foundation UTV", "", "help_category", opUrl(,"https://github.com/AcademySoftwareFoundation/UTV"), enabledItem),
                menuSeparator(),
