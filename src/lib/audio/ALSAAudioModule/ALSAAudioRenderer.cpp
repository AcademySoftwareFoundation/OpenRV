...
namespace IPCore
{
    ...
    void ALSAAudioRenderer::availableLayouts(const Device& d, LayoutsVector& layouts)
    {
        layouts.clear();
    ...
    void ALSAAudioRenderer::availableFormats(const Device& d, FormatVector& formats)
    {
        //
    ...
    void ALSAAudioRenderer::availableRates(const Device& device, Format format, RateVector& rates)
    {
        //
        //  The base class ensures that this function is not called when a
        //  device is opened.
    ...
    void ALSAAudioRenderer::configureDevice()
    {
        int err;
    ...
    void ALSAAudioRenderer::threadMain()
    {
        //
        ...
        if (schedulePolicy != "")
        {
            ...
            if (schedulePolicy == "SCHED_RR")
                policy = SCHED_RR;
            else if (schedulePolicy == "SCHED_FIFO")
                policy = SCHED_FIFO;
    ...
    void ALSAAudioRenderer::play(Session* s)
    {
    ...
    void ALSAAudioRenderer::stop(Session* s)
    {
    ...
    void ALSAAudioRenderer::shutdown()
    {
        //
