...
void 
ALSASafeAudioRenderer::createDeviceList()
{
    ...
    //
    //  For whatever reason ("pulseaudio sucks" ?) the list of devices returned
    //  here is sometimes incomplete (missing the "pusle" device).  But calling
    //  the same call again seems to work around the problem ...
    //  
...
void 
ALSASafeAudioRenderer::availableLayouts(const Device& d, LayoutsVector& layouts)  
{
    layouts.clear();
...
void 
ALSASafeAudioRenderer::availableFormats(const Device& d, FormatVector& formats)  
{
    //
...
void 
ALSASafeAudioRenderer::availableRates(const Device& device, Format format, RateVector& rates) 
{
    //
    //  The base class ensures that this function is not called when a
    //  device is opened.
...
void
ALSASafeAudioRenderer::configureDevice()
{
    int err;
...
void
ALSASafeAudioRenderer::threadMain()
{
    //
...
void
ALSASafeAudioRenderer::play(Session* s)
{
...
void
ALSASafeAudioRenderer::stop(Session* s)
{
...
void
ALSASafeAudioRenderer::shutdown()
{
    //
