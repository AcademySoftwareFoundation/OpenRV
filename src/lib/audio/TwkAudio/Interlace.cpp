...
void
deinterlace(const float* inbuffer, 
            size_t inSamples,
            int nchannels,
...
void
deinterlace(const SampleVector& inbuffer, 
            int nchannels,
            vector<SampleVector>& outbuffers) 
{
    outbuffers.resize(nchannels);
...
void
interlace(const vector<SampleVector>& inbuffers, SampleVector& outbuffer)
{
...
void
interlace(const vector<SampleVector>& inbuffers, float* outbuffer, 
