...
enum Layout
{
    ...
    Surround_5_1,  // Stereo_2       | FrontCenter       | LowFrequency, | SideLeft     | SideRight,
    Generic_5_1,   // Stereo_2       | BackLeft          | BackRight,    | FrontCenter, | LowFrequency,
    Back_5_1,      // Stereo_2       | FrontCenter       | LowFrequency, | BackLeft     | BackRight,
    ...
    AC3_5_1,       // FrontLeft   | FrontCenter | FrontRight | SideLeft | SideRight | LowFrequency
    DTS_5_1,       // FrontCenter | FrontLeft   | FrontRight | SideLeft | SideRight | LowFrequency
    AIFF_5_1,      // FrontLeft   | BackLeft    | FrontCenter | FrontRight | BackRight | LowFrequency
