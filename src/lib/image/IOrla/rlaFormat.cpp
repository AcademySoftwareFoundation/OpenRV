...
MaxExtras getMaxExtras( const RLAHeader &h )
{
    ...
    while( *p != '\0' )
    {
        switch( *p )
        {
        case 'Z': extras |= MAX_GB_Z;               break;
        case 'E': extras |= MAX_GB_MTL_ID;          break;
        case 'O': extras |= MAX_GB_NODE_ID;         break;
        case 'U': extras |= MAX_GB_UV;              break;
        case 'N': extras |= MAX_GB_NORMAL;          break;
        case 'R': extras |= MAX_GB_REALPIX;         break;
        case 'C': extras |= MAX_GB_COVERAGE;        break;
        case 'B': extras |= MAX_GB_BG;              break;
        case 'I': extras |= MAX_GB_NODE_RENDER_ID;  break;
        case 'G': extras |= MAX_GB_COLOR;           break;
        case 'T': extras |= MAX_GB_TRANSP;          break;
        case 'V': extras |= MAX_GB_VELOC;           break;
        case 'W': extras |= MAX_GB_WEIGHT;          break;
        case 'M': extras |= MAX_GB_MASK;            break;
        case 'L': extras |= MAX_LAYER_DATA;         break;
        case 'P': extras |= MAX_RENDER_INFO;        break;
        case 'D': extras |= MAX_NODE_TABLE;         break;
        case 'A': extras |= MAX_UNPREMULT;          break;
        }
        ++p;
    }
