                    ...
                    for (size_t j = 0; j < o->components.size(); j++)
                    {
                        ...
                        for (size_t x = 0; x < c->properties.size(); x++)
                        {
                            ...
                            else if (p->name == "audio_codecs")
                            {
                                ...
                                {
                                    audio_codecs.push_back(make_pair((p->stringData)[i],
                                                                     (p->stringData)[i+1]));
                                }
                            }
                            else if (p->name == "video_codecs")
                            {
                                for (int i=0; i < p->size * p->dims.x; i+=2)
                                {
                                    video_codecs.push_back(make_pair((p->stringData)[i],
                                                                     (p->stringData)[i+1]));
                                }
                            }
                            else if (p->name == "encode_parameters")
                            {
                                ...
                                {
                                    eparams.push_back(MovieIO::Parameter((p->stringData)[i],
                                                                         (p->stringData)[i+1],
                                                                         (p->stringData)[i+2]));
                                }
                            }
                            else if (p->name == "decode_parameters")
                            {
                                for (int i=0; i < p->size * p->dims.x; i+=3)
                                {
                                    dparams.push_back(MovieIO::Parameter((p->stringData)[i],
                                                                         (p->stringData)[i+1],
                                                                         (p->stringData)[i+2]));
                                }
                            }
