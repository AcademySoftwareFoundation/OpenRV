...
void
Read16Bit::planarConfig(FrameBuffer& fb, int w, int h, FrameBuffer::DataType type)
{
...
void
Read16Bit::readRGB16(const string& filename, 
                     ...
                     bool useRaw, unsigned char* deletePointer)
{
    ...
    else
    {
        ...
        for (int y = 0; y < h; y++)
        {
            ...
            if (swap) swapShorts(out, w * ch);
        }
    }
}

void
Read16Bit::readRGB16_PLANAR(const string& filename, 
                            const unsigned char* data,
                            FrameBuffer& fb,
                            int w, int h,
                            size_t maxBytes, bool swap)
...
void
Read16Bit::readRGBA16(const string& filename, 
                      const unsigned char* data,
                      FrameBuffer& fb,
                      int w, int h,
                      size_t maxBytes, 
