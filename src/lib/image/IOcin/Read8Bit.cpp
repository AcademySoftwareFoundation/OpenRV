...
void
Read8Bit::planarConfig(FrameBuffer& fb, int w, int h, FrameBuffer::DataType type)
{
...
void
Read8Bit::readRGB8(const string& filename, 
...
void
Read8Bit::readRGBA8(const string& filename, 
                    const unsigned char* data,
                    FrameBuffer& fb,
                    int w, int h,
                    size_t maxBytes, bool swap,
...
void
Read8Bit::readRGB8_PLANAR(const string& filename, 
                          const unsigned char* data,
                          FrameBuffer& fb,
                          int w, int h,
                          size_t maxBytes, bool swap)
