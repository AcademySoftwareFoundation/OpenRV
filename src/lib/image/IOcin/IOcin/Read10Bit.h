...
public:
    ...
    static void planarConfig(TwkFB::FrameBuffer&,
                             int, int,
                             TwkFB::FrameBuffer::DataType);

    static void readRGB8(const std::string&, 
                         const unsigned char*, 
                         TwkFB::FrameBuffer&, 
                         int, int, size_t maxbytes, bool swap);


    static void readRGBA8(const std::string&, 
                          const unsigned char*, 
                          TwkFB::FrameBuffer&, 
                          int, int, size_t maxbytes, 
                          bool alpha,
                          bool swap);

    static void readRGB16(const std::string&, 
                          const unsigned char*,
                          TwkFB::FrameBuffer&,
                          int, int, size_t maxbytes, bool swap);

    static void readRGBA16(const std::string&, 
                           const unsigned char*, 
                           TwkFB::FrameBuffer&, 
                           int, int, size_t maxbytes, 
                           bool alpha,
    ...
    static void readRGB10_A2(const std::string&,
                             const unsigned char*, 
                             TwkFB::FrameBuffer&,
                             int, int, size_t maxbytes, bool swap,
                             bool useRaw=false,
    ...
    static void readA2_BGR10(const std::string&,
                             const unsigned char*, 
                             TwkFB::FrameBuffer&,
                             int, int, size_t maxbytes, bool swap);

    static void readRGB8_PLANAR(const std::string&, 
                                const unsigned char*, 
                                TwkFB::FrameBuffer&, 
                                int, int, size_t maxbytes, bool swap);

    static void readRGB16_PLANAR(const std::string&,
                                 const unsigned char*,
                                 TwkFB::FrameBuffer&,
                                 int, int, size_t maxbytes, bool swap);
