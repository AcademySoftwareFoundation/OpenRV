...
IOz::IOz(bool n) : FrameBufferIO(), m_normalizeOnInput(n)
{
...
void
IOz::getImageInfo(const std::string& filename, FBInfo& fbi) const
{
    FILE* infile;
    ZFile::Header header;
               ...
               const ReadRequest& request) const
{
    ...
    //fb.restructure(w, h, 0, 1, FrameBuffer::FLOAT, 0, 0, FrameBuffer::TOPLEFT);
...
void
IOz::writeImage(const FrameBuffer& img,
                const std::string& filename,
