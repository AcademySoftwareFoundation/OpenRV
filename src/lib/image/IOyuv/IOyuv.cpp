...
IOyuv::IOyuv() : FrameBufferIO("IOyuv", "mx")
{
    //
...
IOyuv::about() const
{
    return "Raw 4:2:2 HD/SD YUV";
}


static 
void imageDimensions(size_t filesize, int& w, int& h)
{
    switch (filesize)
    {
      case  640 * 486  * 2: w = 640;  h = 486; break;
      case  720 * 480  * 2: w = 720;  h = 480; break;
      case  720 * 486  * 2: w = 720;  h = 486; break;
      case  720 * 512  * 2: w = 720;  h = 512; break;
      case 1280 * 720  * 2: w = 1280; h = 720; break;
      case 1920 * 1080 * 2: w = 1920; h = 1080; break;
...
void
IOyuv::getImageInfo(const std::string& filename, FBInfo& fbi) const
{
    struct stat statbuf;
...
void
IOyuv::readImage(FrameBuffer& fb,
