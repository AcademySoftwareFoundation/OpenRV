...
class MovieFB : public MovieReader
{
  public:
    ...
    {
      public:
        FrameFile()                                        : fileName(""), generation(0), readTime(0) {}
        FrameFile(std::string nm)                          : fileName(nm), generation(0), readTime(0) {}
        FrameFile(std::string nm, int gen, std::time_t rt) : fileName(nm), generation(gen), readTime(rt) {}
    ...
    struct CompareFrameFilePair
    {
        ...
        bool operator() (const FrameMap::value_type &a, const FrameMap::value_type &b)
        {
