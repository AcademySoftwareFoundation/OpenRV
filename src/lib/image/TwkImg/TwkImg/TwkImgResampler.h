...
//******************************************************************************
template <class COLOR, bool CHECK = true>
class NearNbRsmp
{
public:
    NearNbRsmp();
    ...
    float sample( const Image<COLOR> &img, 
                  const TwkMath::Vec2f &loc, 
                  COLOR &samp ) const;

    // Sample a point in absolute coordinates
    float sampleAbs( const Image<COLOR> &img,
                     const TwkMath::Vec2f &abs, 
                     COLOR &samp ) const;
};
...
{
    return sample( img,
                   loc - TwkMath::Vec2f( ( float )( img.origin()[0] ), 
                                         ( float )( img.origin()[1] ) ), samp );
}
...
//******************************************************************************
template <class COLOR, bool CHECK>
inline float BiLinearRsmp<COLOR, CHECK>::sampleAbs( const Image<COLOR> &img,
                                                    const TwkMath::Vec2f &loc, 
                                                    COLOR &samp ) const
{
    return sample( img,
