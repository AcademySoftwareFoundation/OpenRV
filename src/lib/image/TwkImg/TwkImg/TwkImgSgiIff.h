...
protected:
    ...
    static void readPixelsRLE( Img4uc &into, 
                               Header &aHeader, std::istream &in );
    static void readPixels( Img4uc &into, 
                            Header &aHeader, std::istream &in );
    static void writePixels( const Img4uc &outof, 
                             Header &aHeader, std::ostream &out );
};
