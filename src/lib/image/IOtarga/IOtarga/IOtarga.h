...
public:
    ...
    struct ColorMapSpec
    {
        ...
        void swap()
        {
            TwkUtil::swapShorts(&startIndex, 2); 
        }
    };
    ...
    struct TGAFileFooter
    {
        U32 extOffset;
        U32 devOffset;
        ASCII signature[18]; // wacky string footer + 8 == "TRUEVISION-XFILE.\0" means "new tga"
    };

    IOtarga(IOType ioMethod = StandardIO,
