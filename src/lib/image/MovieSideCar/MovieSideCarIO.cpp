...
namespace TwkMovie
{
    ...
    MovieReader* MovieSideCarIO::movieReader() const { return new MovieSideCar(m_sidecarPath, m_cloneable); }

    MovieWriter* MovieSideCarIO::movieWriter() const { return 0; }

    void MovieSideCarIO::getMovieInfo(const std::string& filename, MovieInfo& info) const
    {
        //
    ...
    {
        unsigned int capabilities = MovieIO::MovieRead | MovieIO::MovieReadAudio | MovieIO::AttributeRead;
    ...
    MovieLQTSideCarIO::MovieLQTSideCarIO(const string& p)
        : MovieSideCarIO(p, false)
    {
        unsigned int capabilities = MovieIO::MovieRead | MovieIO::MovieReadAudio | MovieIO::MovieBruteForceIO | MovieIO::AttributeRead;
