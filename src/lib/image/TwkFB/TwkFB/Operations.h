...
typedef void (*ColorTransformFunc)(const float* input, 
                                   float* output, 
                                   int nchannels, 
                                   int nelements, 
                                   void* data);
...
struct TWKFB_EXPORT LogCTransformParams
{
    ...
    float LogCLinearCutPoint;   // ColorSpace::LogCLinearCutPoint();  Logc to Linear cutoff
...
TWKFB_EXPORT void logLinearTransform(const float*,float*,int,int,void*); // void* => bool[nchannels]
TWKFB_EXPORT void linearLogTransform(const float*,float*,int,int,void*); // void* => bool[nchannels]
TWKFB_EXPORT void logCLinearTransform(const float*,float*,int,int,void*); // void* => LogCTransformParams
TWKFB_EXPORT void linearLogCTransform(const float*,float*,int,int,void*); // void* => LogCTransformParams
TWKFB_EXPORT void redLogLinearTransform(const float*,float*,int,int,void*); // void* => bool[nchannels]
TWKFB_EXPORT void linearRedLogTransform(const float*,float*,int,int,void*); // void* => bool[nchannels]
TWKFB_EXPORT void linearColorTransform(const float*,float*,int,int,void*); // void* => Mat44f*
TWKFB_EXPORT void yryby2rgbColorTransform(const float*,float*,int,int,void*);// void* => Vec3f* (Yw)
...
TWKFB_EXPORT void channelLUTTransform(const float*,float*,int,int,void*); // void* => LUT FB*
TWKFB_EXPORT void pixel3DLUTTransform(const float*,float*,int,int,void*); // void* => LUT FB*
TWKFB_EXPORT void luminanceLUTTransform(const float*,float*,int,int,void*); // void* => LUT FB*
TWKFB_EXPORT void gammaTransform(const float*,float*,int,int,void*); // void* => float[3]
TWKFB_EXPORT void powerTransform(const float*,float*,int,int,void*); // void* => float[3]
...
typedef void (*TransferFunc)(const float* input,
                             float* output,
                             void* data);
...
TWKFB_EXPORT void scaledTransfer(const float*, float*, void*); // void* => float
...
TWKFB_EXPORT void applyTransform(const FrameBuffer* from, 
                    FrameBuffer* to,
                    ColorTransformFunc func,
                    void *data);
...
TWKFB_EXPORT FrameBuffer* channelMap(const FrameBuffer* from,
                        const std::vector<std::string>& newMapping);

TWKFB_EXPORT FrameBuffer* channelMapToPlanar(const FrameBuffer* from,
...
TWKFB_EXPORT void cropInto(const FrameBuffer* infb, 
              FrameBuffer* outfb,
...
TWKFB_EXPORT void linearRGBA709pixelValue(const FrameBuffer* fb, 
                             int x, int y, 
                             float* result);
