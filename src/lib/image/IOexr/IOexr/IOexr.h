...
public:
    ...
    IOexr( bool rgbaOnly=false,
           bool convertYRYBY=true, 
           bool planar3channel=false,
           bool inheritChannels=false,
           bool noOneChannelPlanes=true,
...
private:
    ...
    void readImagesFromMultiViewFile(Imf::MultiPartInputFile& file,
                                       FrameBufferVector& fbs,
                                       const std::string& filename,
                                       const std::string& requestedView,
                                       const std::string& requestedLayer,
    ...
    void planarConfig(FrameBuffer&, int, int, 
...
private:
    ...
    static void addToMultiPartChannelList (std::vector<MultiPartChannel>& rcl,
    ...
    static int indexOfChannelName(const std::vector<std::string>& channelNames, 
                                  const char* names[],
                                  bool exact=false);
    static int indexOfChannelName(const std::vector<MultiPartChannel>& channelsMP, 
                                  const char* names[],
                                  bool exact=false);
    ...
    static Imf::ChannelList::Iterator findChannelWithBasename(const std::string& cname,
                                                              Imf::ChannelList& cl);
    ...
    static size_t channelListIteratorDifference(Imf::ChannelList::ConstIterator a,
    ...
    static void setChannelInfo(const std::string &name,
                               Imf::PixelType type,
                               FBInfo::ChannelInfo& info);
    ...
    static bool doesRequestedLayerExists(bool viewHasChannelConflict,
                                         const std::string& requestedView,
                                         const std::string& requestedLayer,
                                         const std::string& partNameInFile,
                                         const std::string& channelNameInFile);

    static bool doesRequestedChannelExists(bool viewHasChannelConflict,
                                           const std::string& requestedView,
                                           const std::string& requestedLayer,
                                           const std::string& requestedChannel,
                                           const std::string& partNameInFile,
    ...
    static void readMultiViewChannelList(const std::string& filename,
                                        const std::string& layer,
                                        const std::string& view,
                                        FrameBuffer& fb, 
    ...
    static void getBiggerFrameBufferAndEXRPixelType (const Imf::Channel& channel, 
                                                     FrameBuffer::DataType& fbDataType,
                                                     Imf::PixelType& exrPixelType);

    static void readMultiPartChannelList(const std::string& filename,
                                         const std::string& view,
                                         FrameBuffer& fb, 
                                         Imf::MultiPartInputFile& file,
                                         std::vector<MultiPartChannel>& channelsRead,
                                         bool convertYRYBY,
                                         bool planar3channel,
                                         bool allChannels,
                                         bool inheritChannels,
    ...
    static std::string viewStrippedPartQualifiedName(bool doStrip,
