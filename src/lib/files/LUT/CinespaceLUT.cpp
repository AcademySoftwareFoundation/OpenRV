...
string 
nextline(istream& in, float* gamma=0)
{
    if (!in)
    {
...
void 
expect(istream& in, const string& line)
{
    if (nextline(in) != line)
    {
...
string 
oneof(istream& in, const string& line1, const string& line2)
{
...
void
readCinespaceLUT(const string& filename, 
                 const string& type,
                 LUTData& lut)
{
