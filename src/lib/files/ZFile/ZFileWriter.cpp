...
//-*****************************************************************************
bool ZFileWriter::write( std::ostream &out,
                         const Header &header,
                         const float *data )
{
    out.write( ( const char * )&header.magicNumber,
               sizeof( header.magicNumber ) );
    out.write( ( const char * )&header.imageWidth,
               sizeof( header.imageWidth ) );
    out.write( ( const char * )&header.imageHeight,
               sizeof( header.imageHeight ) );
    ...
    {
        out.write( ( const char * )( data + row * header.imageWidth ),
                   rowSize );
    }
...
//-*****************************************************************************
bool ZFileWriter::write( const char *fileName,
                         const Header &header,
                         const float *data )
{
                         ...
                         const float *data )
{
    ...
    memcpy( ( void * )header.worldToScreen,
            ( const void * )&w2st, 16 * sizeof( float ) );
    memcpy( ( void * )header.worldToCamera,
            ( const void * )&w2ct, 16 * sizeof( float ) );
