...
namespace ZFile
{
    ...
    //-*****************************************************************************
    bool ZFileWriter::write(std::ostream& out, const Header& header, const float* data)
    {
        ...
        out.write((const char*)&header.worldToScreen, sizeof(header.worldToScreen));
        out.write((const char*)&header.worldToCamera, sizeof(header.worldToCamera));
    ...
    //-*****************************************************************************
    bool ZFileWriter::write(const char* fileName, const Header& header, const float* data)
    {
    ...
    //-*****************************************************************************
    bool ZFileWriter::write(std::ostream& out, int width, int height, const Mat44f& w2s, const Mat44f& w2c, const float* data)
    {
        Header header;
        ...
        memcpy((void*)header.worldToScreen, (const void*)&w2st, 16 * sizeof(float));
        memcpy((void*)header.worldToCamera, (const void*)&w2ct, 16 * sizeof(float));

        return write(out, header, data);
    }

    //-*****************************************************************************
    bool ZFileWriter::write(const char* fileName, int width, int height, const Mat44f& w2s, const Mat44f& w2c, const float* data)
    {
        std::ofstream out(UNICODE_C_STR(fileName), std::ofstream::binary);
