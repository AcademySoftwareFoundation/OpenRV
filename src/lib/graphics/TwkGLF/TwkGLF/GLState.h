...
// each GLPipeline object corresponds to a glProgram, provides access to (sets/gets) uniforms of this glProgram
// GLState is in charge of maintaining all the active GLPipeline objects, switch between GLPipeline objects, etc.
//
//
...
class GLState
{
  public:
    ...
    //----------------------------------------------------------------------
    // constructor
    GLState() : m_activeProgram(NULL),
                m_totalTextureMemory(0) {} // fixed function pipeline by default
