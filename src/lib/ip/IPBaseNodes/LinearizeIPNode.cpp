      ...
      m_active(0)
{
    ...
    PropertyInfo* info = new PropertyInfo(PropertyInfo::Persistent | 
...
string 
LinearizeIPNode::fbPrimariesToPropertyValue(const string& p)
{
    if      (p == ColorSpace::Rec709())             return "ITU Rec.709";
    else if (p == ColorSpace::sRGB())               return "ITU Rec.709";
    else if (p == ColorSpace::Rec601())             return "ITU Rec.601 525 Lines";
    else if (p == ColorSpace::Rec2020())            return "ITU Rec.2020";
    else if (p == ColorSpace::AdobeRGB())           return "AdobeRGB";
    else if (p == ColorSpace::SMPTE240M())          return "SMPTE 240M"; 
    else if (p == ColorSpace::SMPTE_C())            return "SMPTE-C";
    else if (p == ColorSpace::XYZ())                return "CIE XYZ";
    else if (p == ColorSpace::P3())                 return "DCI P3";
    else if (p == ColorSpace::ArriSceneReferred())  return "ARRI Wide Gamut Scene Referred";
    else if (p == ColorSpace::ArriWideGamut())      return "ARRI Wide Gamut";
    else if (p == ColorSpace::ACES())               return "ACES";
    return "File";
}

string 
LinearizeIPNode::fbTransferToPropertyValue(const string& t)
{
    if      (t == ColorSpace::CineonLog())          return "Cineon Log";
    else if (t == ColorSpace::None())               return "sRGB"; // really
    else if (t == ColorSpace::sRGB())               return "sRGB";
    else if (t == ColorSpace::Rec709())             return "ITU Rec.709";
    else if (t == ColorSpace::Rec2020())            return "ITU Rec.2020";
    else if (t == ColorSpace::SMPTE240M())          return "SMPTE 240M"; 
    else if (t == ColorSpace::ArriLogC())           return "ARRI LogC";
    else if (t == ColorSpace::ArriLogCFilm())       return "ARRI LogC Film";
    else if (t == ColorSpace::ViperLog())           return "Viper Log";
    else if (t == ColorSpace::RedLog())             return "Red Log";
    else if (t == ColorSpace::RedLogFilm())         return "Red Log Film";
    else if (t == ColorSpace::Linear())             return "Linear";
    else if (t == ColorSpace::Gamma18())            return "Gamma 1.8";
    else if (t == ColorSpace::Gamma22())            return "Gamma 2.2";
    else if (t == ColorSpace::Gamma24())            return "Gamma 2.4";
    else if (t == ColorSpace::Gamma26())            return "Gamma 2.6";
    return "File";
}
...
{
    if      (chr == Chromaticities::Rec709())               return "ITU Rec.709";
    else if (chr == Chromaticities::Rec601_525())           return "ITU Rec.601 525 Lines";
    else if (chr == Chromaticities::Rec601_625())           return "ITU Rec.601 625 Lines";
    else if (chr == Chromaticities::Rec2020())              return "ITU Rec.2020";
    else if (chr == Chromaticities::P3())                   return "DCI P3";
    else if (chr == Chromaticities::XYZ())                  return "CIE XYZ";
    else if (chr == Chromaticities::AdobeRGB())             return "Adobe RGB";
    else if (chr == Chromaticities::SMPTE_C())              return "SMPTE-C";
    else if (chr == Chromaticities::SMPTE_240M())           return "SMPTE 240M";
    else if (chr == Chromaticities::ACES())                 return "ACES";
    else if (chr == Chromaticities::ArriSceneReferred())    return "ARRI Wide Gamut Scene Referred";
    return "File";
}

IPImage*
LinearizeIPNode::evaluate(const Context& context)
{
    ...
    if (!img) return IPImage::newNoImage(this, "No Input");
    ...
    //
    //  If input to this node is a blend, prepare img for shaderExpr mods, etc.
    //
    ...
    if      (primaries == "ITU Rec.709")                    cc = CIECoords::Rec709();
    else if (primaries == "ITU Rec.601 525 Lines")          cc = CIECoords::Rec601_525(); 
    else if (primaries == "ITU Rec.601 625 Lines")          cc = CIECoords::Rec601_625(); 
    else if (primaries == "ITU Rec.2020")                   cc = CIECoords::Rec2020();
    else if (primaries == "CIE XYZ")                        cc = CIECoords::XYZ();
    else if (primaries == "DCI P3")                         cc = CIECoords::P3();
    else if (primaries == "AdobeRGB")                       cc = CIECoords::AdobeRGB();
    else if (primaries == "SMPTE-C")                        cc = CIECoords::SMPTE_C();
    else if (primaries == "SMPTE 240M")                     cc = CIECoords::SMPTE_240M();
    else if (primaries == "ACES")                           cc = CIECoords::ACES();
    else if (primaries == "ARRI Wide Gamut Scene Referred") cc = CIECoords::ArriSceneReferred();
    ...
    else if (primaries == "RedColor")                       cc = CIECoords::RedColor();
    else if (primaries == "RedColor2")                      cc = CIECoords::RedColor2();
    else if (primaries == "RedColor3")                      cc = CIECoords::RedColor3();
    else if (primaries == "RedColor4")                      cc = CIECoords::RedColor4();
    else if (primaries == "DragonColor")                    cc = CIECoords::DragonColor();
    else if (primaries == "DragonColor2")                   cc = CIECoords::DragonColor2();
    else if (fb && primaries == "File")
    {
        ...
        if      (p == ColorSpace::Rec709())             cc = CIECoords::Rec709();
        else if (p == ColorSpace::sRGB())               cc = CIECoords::Rec709();
        else if (p == ColorSpace::Rec601())             cc = CIECoords::Rec601_525();
        else if (p == ColorSpace::AdobeRGB())           cc = CIECoords::AdobeRGB();
        else if (p == ColorSpace::SMPTE240M())          cc = CIECoords::SMPTE_240M();
        else if (p == ColorSpace::SMPTE_C())            cc = CIECoords::SMPTE_C();
        else if (p == ColorSpace::XYZ())                cc = CIECoords::XYZ();
        else if (p == ColorSpace::P3())                 cc = CIECoords::P3();
        else if (p == ColorSpace::ArriSceneReferred())  cc = CIECoords::ArriSceneReferred();
        else if (p == ColorSpace::Rec2020())            cc = CIECoords::Rec2020();
        else if (p == ColorSpace::ACES())               cc = CIECoords::ACES();
        else if (p == ColorSpace::RedColor())           cc = CIECoords::RedColor();
        else if (p == ColorSpace::RedColor2())          cc = CIECoords::RedColor2();
        else if (p == ColorSpace::RedColor3())          cc = CIECoords::RedColor3();
        else if (p == ColorSpace::RedColor4())          cc = CIECoords::RedColor4();
        else if (p == ColorSpace::DragonColor())        cc = CIECoords::DragonColor();
        else if (p == ColorSpace::DragonColor2())       cc = CIECoords::DragonColor2();
    ...
    if (changeOfBasis)
    {
        ...
        {
            Mat44f A;
            TwkFB::colorSpaceConversionMatrix((const float*)&chr709,
                                              (const float*)&chr709,
                                              (const float*)&cneutral,
                                              (const float*)&chr709.white,
                                              true,
                                              (float*)&A);
        ...
        {
            Imf::Chromaticities chr(convert(cc.red),
                                    convert(cc.green),
                                    convert(cc.blue),
                                    convert(cc.white));
            
            TwkFB::colorSpaceConversionMatrix((const float*)&chr,
                                              (const float*)&chr709,
                                              (const float*)&cneutral,
                                              (const float*)&chr709.white,
                                              true,
    ...
    if (const TwkFB::FloatAttribute* lsa =
        dynamic_cast<const TwkFB::FloatAttribute*> (fb->findAttribute(ColorSpace::LinearScale())))
    {
        Mat44f S;
        Vec3f scl(lsa->value());
        S.makeScale(scl);
    ...
    if (transfer == "Cineon Log")
    {
        ...
        if (fb)
        {
                ...
                dynamic_cast<const TwkFB::FloatAttribute*>(fb->findAttribute(ColorSpace::BlackPoint())))
            {
                ...
                if (ftmp >= 1.0f) cinblack = (double) ftmp;
            }
            ...
            {
                float ftmp = fattr->value();
                if (ftmp >= 1.0f) cinwhite = (double) ftmp;
            ...
            {
                float ftmp = fattr->value();
                if (ftmp >= 1.0f) cinbreakpoint = (double) ftmp;
            }
        }

        img->shaderExpr = Shader::newColorCineonLogToLinear(img->shaderExpr,
                                                            cinblack,
                                                            cinwhite,
    ...
    else if ((transfer == "ARRI LogC") || (transfer == "ARRI LogC Film"))
    {
        ...
        {
            //
            // Undo the Film Style Matrix; this is done prior to linearizing the logC.
            //
