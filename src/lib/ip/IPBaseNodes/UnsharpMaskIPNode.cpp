...
IPImage*
UnsharpMaskIPNode::evaluate(const Context& context)
{
    ...
    if (unsharpR <= 5) gauss = Shader::applyGaussianFilter(this, image, (size_t)unsharpR);
    else gauss = Shader::applyFastGaussianFilter(this, image, (size_t)unsharpR);
