...
IPImage*
RotateCanvasIPNode::evaluate(const Context& context)
{
    ...
    if (rotate == Rotate90)
    {
        ...
        image->textureMatrix.set(0, r, 0,
                                 -1.0f/r, 0, fbHeight,
                                 0, 0, 1.0f);
    }
    else if (rotate == Rotate180)
    {
        image->textureMatrix.set(-1.0f, 0, fbWidth,
                                 0, -1.0f, fbHeight,
                                 0, 0, 1.0f);
    }
    ...
    {
        float r = (float)fbWidth / fbHeight;
        image->textureMatrix.set(0, -r, fbWidth,
                                 1.0f/r, 0, 0,
                                 0, 0, 1.0f);
    }
...
void
RotateCanvasIPNode::propertyChanged(const Property* p)
{
