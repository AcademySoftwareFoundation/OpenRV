...
IPNode*
RetimeGroupIPNode::newSubGraphForInput(size_t index, const IPNodes& newInputs)
{
...
void
RetimeGroupIPNode::setInputs(const IPNodes& newInputs)
{
    if (isDeleting())
    {
