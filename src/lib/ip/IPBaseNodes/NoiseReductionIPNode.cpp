...
IPImage*
NoiseReductionIPNode::evaluate(const Context& context)
{
    ...
    if (r <= 5) gaussHorizontal = Shader::applyGaussianFilter(this, image, (size_t)r);
    else gaussHorizontal = Shader::applyFastGaussianFilter(this, image, (size_t)r);
