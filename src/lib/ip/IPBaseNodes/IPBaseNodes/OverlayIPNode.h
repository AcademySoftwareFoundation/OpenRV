  ...
  public:
    ...
    struct LocalWindow
    {
        ...
        struct FrameCommands
        {
            ...
            // by default outline is drawn in gl as a polygon outline (aliased)
            ...
            // for antialaised case outline is drawn around the frame in the same color
    ...
    OverlayIPNode(const std::string& name,
