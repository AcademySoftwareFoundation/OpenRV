...
IPNode*
SwitchGroupIPNode::newSubGraphForInput(size_t index, const IPNodes& newInputs)
{
...
void
SwitchGroupIPNode::setInputs(const IPNodes& newInputs)
{
    if (isDeleting())
    {
