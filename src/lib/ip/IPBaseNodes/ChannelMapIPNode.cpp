...
void
ChannelMapIPNode::setChannelMap(const std::vector<std::string> &chmap)
{
...
void
ChannelMapIPNode::outputDisconnect(IPNode* node)
{
    IPNode::outputDisconnect(node);
}

IPImage*
ChannelMapIPNode::evaluate(const Context& context)
{
...
IPImageID*
ChannelMapIPNode::evaluateIdentifier(const Context& context)
{
...
void 
ChannelMapIPNode::propertyChanged(const Property* p) 
{
    m_showErrorMessageInEvaluate = true;
