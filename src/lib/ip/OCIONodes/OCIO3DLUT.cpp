...
namespace IPCore
{
    ...
    OCIO3DLUT::OCIO3DLUT(OCIO::GpuShaderDescRcPtr& shaderDesc, unsigned int idx, const std::string& shaderCacheID)
    {
        ...
        m_lutfb = new TwkFB::FrameBuffer(TwkFB::FrameBuffer::NormalizedCoordinates, edgelen, edgelen, edgelen, 3 /*channelSize*/,
        ...
        memcpy(m_lutfb->pixels<float>(), values, 3 * sizeof(float) * edgelen * edgelen * edgelen);
    }
