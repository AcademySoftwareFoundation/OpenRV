...
SetInputsInfo::SetInputsInfo(const std::string& name, TwkApp::CommandInfo::UndoType type) : CommandInfo(name, type) { }
...
void
SetInputs::setArgs(IPGraph* graph, const string& name, const StringVector& inputs)
{
    m_graph = graph;
    m_name  = name;
