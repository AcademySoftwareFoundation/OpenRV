...
new IPCore::Commands::SetSessionStateInfo<int>("setFrame",              \
                                             &IPCore::Session::setFrame,        \
                                             &IPCore::Session::currentFrame,    \
                                             TwkApp::CommandInfo::Undoable); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<int>("setFrameEditOnly",      \
                                             &IPCore::Session::setFrame,        \
                                             &IPCore::Session::currentFrame,    \
                                             TwkApp::CommandInfo::EditOnly); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<int>("setInc",                \
                                             &IPCore::Session::setInc,          \
                                             &IPCore::Session::inc,             \
                                             TwkApp::CommandInfo::Undoable); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<int>("setIncEditOnly",        \
                                             &IPCore::Session::setInc,          \
                                             &IPCore::Session::inc,             \
                                             TwkApp::CommandInfo::EditOnly); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<int>("setRangeStart",         \
                                             &IPCore::Session::setRangeStart,   \
                                             &IPCore::Session::rangeStart,      \
                                             TwkApp::CommandInfo::Undoable); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<int>("setRangeStartEditOnly", \
                                             &IPCore::Session::setRangeStart,   \
                                             &IPCore::Session::rangeStart,      \
                                             TwkApp::CommandInfo::EditOnly); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<int>("setRangeEnd",           \
                                             &IPCore::Session::setRangeEnd,     \
                                             &IPCore::Session::rangeEnd,        \
                                             TwkApp::CommandInfo::Undoable); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<int>("setRangeEndEditOnly",   \
                                             &IPCore::Session::setRangeEnd,     \
                                             &IPCore::Session::rangeEnd,        \
                                             TwkApp::CommandInfo::EditOnly); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<int>("setInPoint",            \
                                             &IPCore::Session::setInPoint,      \
                                             &IPCore::Session::inPoint,         \
                                             TwkApp::CommandInfo::Undoable); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<int>("setInPointEditOnly",    \
                                             &IPCore::Session::setInPoint,      \
                                             &IPCore::Session::inPoint,         \
                                             TwkApp::CommandInfo::EditOnly); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<int>("setOutPoint",           \
                                             &IPCore::Session::setOutPoint,     \
                                             &IPCore::Session::outPoint,        \
                                             TwkApp::CommandInfo::Undoable); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<int>("setOutPointEditOnly",   \
                                             &IPCore::Session::setOutPoint,     \
                                             &IPCore::Session::outPoint,        \
                                             TwkApp::CommandInfo::EditOnly); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<double>("setFPS",             \
                                                  &IPCore::Session::setFPS,     \
                                                  &IPCore::Session::fps,        \
                                                  TwkApp::CommandInfo::Undoable); \
                                                                        \
new IPCore::Commands::SetSessionStateInfo<double>("setFPSEditOnly",     \
                                                  &IPCore::Session::setFPS,     \
                                                  &IPCore::Session::fps,        \
                                                  TwkApp::CommandInfo::EditOnly); \
\
new IPCore::Commands::SetSessionObjectStateInfo<std::string>("setFileName",     \
                                                  &TwkApp::Document::setFileName,     \
                                                  &TwkApp::Document::fileName,        \
                                                  TwkApp::CommandInfo::Undoable); \
                                                                        \
new IPCore::Commands::SetSessionObjectStateInfo<std::string>("setFileNAmeEditOnly",   \
                                                  &TwkApp::Document::setFileName,     \
                                                  &TwkApp::Document::fileName,        \
                                                  TwkApp::CommandInfo::EditOnly); \
                                                                        \
new IPCore::Commands::SetRangeFromViewNodeInfo("setRangeFromViewNode", \
                                               TwkApp::CommandInfo::Undoable); \
                                                                        \
