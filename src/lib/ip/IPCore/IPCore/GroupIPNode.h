...
class GroupIPNode : public IPNode
{
  public:
    ...
    GroupIPNode(const std::string& name,
    ...
    //  This operation is optimized for one input onlye if the inputIndexOnly
  ...
  protected:
    ...
    template <class T>
    T* newMemberNodeOfType(const std::string& typeName, const std::string& nameStem)
    {
