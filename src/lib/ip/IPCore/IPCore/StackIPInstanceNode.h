...
/// StackIPInstanceNode is a base class for IPInstanceNode types which need management of multiple overlapping inputs
...
class StackIPInstanceNode : public IPInstanceNode
{
  public:
    ...
    StackIPInstanceNode(const std::string& name,
