...
void
addCoreNodeDefinitions(NodeManager* m)
{
    ...
    m->addDefinition(new NodeDefinition("Session", 2, false,
                                        "session",
    ...
    m->addDefinition(new NodeDefinition("ViewPipelineGroup", 1, true,
                                        "viewPipelineGroup",
                                        newIPNode<PipelineGroupIPNode>,
                                        "Managed Single Input Pipeline", 
                                        "", 
    ...
    {
        NodeDefinition* def = new NodeDefinition("DisplayPipelineGroup", 1, true,
    ...
    m->addDefinition(new NodeDefinition("Cache", 1, false,
                                        "cache",
                                        newIPNode<CacheIPNode>,
                                        "", "", emptyIcon,
                                        false));

    m->addDefinition(new NodeDefinition("DispTransform2D", 1, false,
                                        "dispTransform2D",
    ...
    {
        NodeDefinition* def = new NodeDefinition("DisplayColor", 1, false,
                                                 "displayColor",
    ...
    {
        NodeDefinition* def = new NodeDefinition("DisplayGroup", 1, true,
                                                 "displayGroup",
    ...
    {
        NodeDefinition* def = new NodeDefinition("OutputGroup", 1, true,
                                                 "outputGroup",
    ...
    {
        NodeDefinition* def = new NodeDefinition("TextureOutputGroup", 1, true,
                                                 "textureOutputGroup",
                                                 newIPNode<TextureOutputGroupIPNode>,
                                                 "", "", emptyIcon,
                                                 false);
    ...
    {
        NodeDefinition* def = new NodeDefinition("Resize", 1, true,
                                                 "resize",
                                                 newIPNode<ResizeIPNode>,
                                                 "", "", emptyIcon,
                                                 false);
    ...
    {
        NodeDefinition* def = new NodeDefinition("Histogram", 1, true,
                                                 "histogram",
                                                 newIPNode<HistogramIPNode>,
                                                 "", "", emptyIcon,
                                                 false);
    ...
    {
        NodeDefinition* def = new NodeDefinition("ViewGroup", 1, true,
                                                 "viewGroup",
                                                 newIPNode<ViewGroupIPNode>,
                                                 "", "", emptyIcon,
                                                 false);
    ...
    m->addDefinition(new NodeDefinition("DisplayStereo", 1, false,
                                        "displayStereo",
    ...
    {
        NodeDefinition* def = new NodeDefinition("SoundTrack", 1, false,
                                                 "soundTrack",
    ...
    {
        NodeDefinition* def = new NodeDefinition("Transform2D", 1, false,
                                                 "transform2D",
