...
RootIPNode::RootIPNode(const string& name,
...
IPImage* 
RootIPNode::evaluate(const Context& context)
{
    ...
    {
        //
        //  If we have evaluated any children, those FBs will have been checked
        //  out of the cache.  They must be checked back in or they will not be
        //  properly dereferenced and we'll never be able to delete them.
        //
...
IPImageID*
RootIPNode::evaluateIdentifier(const Context& context)
{
    const IPNodes& nodes = inputs();
