...
#define DECLARE_SYMBOL(NAME, QUALIFIER, TYPE)                           \
    const Symbol* NAME()                                                \
    {                                                                   \
        return new Symbol((Symbol::Qualifier)(Symbol::QUALIFIER), #NAME, Symbol::TYPE); \
    }
...
//  matter although there may be some extra ShaderProgram copies. Ideally,
//  the lazy building would all get done by the main thread at some point
//  *before* any caching threads get started.
//
...
dither()
{
    if (!Shader_Dither)
    {
        ...
        Shader_Dither = new Shader::Function("main",
                                             Dither_glsl,
                                             Shader::Function::UndecidedType,
                                             params,
                                             globals);
    }
...
stencilBox()
{
    if (!Shader_StencilBox)
    {
        ...
        Shader_StencilBox = new Shader::Function("main",
                                                 StencilBox_glsl,
...
stencilBoxNegAlpha()
{
    if (!Shader_StencilBoxNegAlpha)
    {
        ...
        params.push_back(new Symbol(Symbol::ParameterConstIn, "boxX", Symbol::Vec2fType));
        params.push_back(new Symbol(Symbol::ParameterConstIn, "boxY", Symbol::Vec2fType));
        Shader_StencilBoxNegAlpha = new Shader::Function("main",
                                                         StencilBoxNegAlpha_glsl,
                                                         Shader::Function::Color,
                                                         params,
                                                         globals);
    }
...
stereoChecker()
{
    if (!Shader_StereoChecker)
    {
        ...
        params.push_back(new Symbol(Symbol::ParameterConstIn, "win", Symbol::OutputImageType));
        Shader_StereoChecker = new Shader::Function("main",
                                                    StereoChecker_glsl,
                                                    Shader::Function::UndecidedType,
                                                    params,
                                                    globals);
...
stereoScanline()
{
    if (!Shader_StereoScanline)
    {
        ...
        params.push_back(new Symbol(Symbol::ParameterConstIn, "win", Symbol::OutputImageType));
        Shader_StereoScanline = new Shader::Function("main",
                                                    StereoScanline_glsl,
                                                    Shader::Function::UndecidedType,
                                                    params,
                                                    globals);
...
stereoAnaglyph()
{
    if (!Shader_StereoAnaglyph)
    {
        ...
        params.push_back(new Symbol(Symbol::ParameterConstIn, "in0", Symbol::Vec4fType));
        params.push_back(new Symbol(Symbol::ParameterConstIn, "in1", Symbol::Vec4fType));
        Shader_StereoAnaglyph = new Shader::Function("main",
                                                     StereoAnaglyph_glsl,
                                                     Shader::Function::Color,
                                                     params,
                                                     globals);
...
stereoLumAnaglyph()
{
    if (!Shader_StereoLumAnaglyph)
    {
        ...
        Shader_StereoLumAnaglyph = new Shader::Function("main",
                                                     StereoLumAnaglyph_glsl,
                                                     Shader::Function::Color,
                                                     params,
                                                     globals);
    }
...
unsharpMask()
{
    if (!Shader_FilterUnsharpMask)
    {
        ...
        Shader_FilterUnsharpMask = new Shader::Function("FilterUnsharpMask",
                                                         FilterUnsharpMask_glsl,
                                                         Shader::Function::Color,
                                                         params,
                                                         globals);
    }
...
noiseReduction()
{
    if (!Shader_FilterNoiseReduction)
    {
        ...
        params.push_back(new Symbol(Symbol::ParameterConstIn, "amount", Symbol::FloatType));
        params.push_back(new Symbol(Symbol::ParameterConstIn, "threshold", Symbol::FloatType));
        Shader_FilterNoiseReduction = new Shader::Function("FilterNoiseReduction",
                                                           FilterNoiseReduction_glsl,
                                                           Shader::Function::Color,
                                                           params,
                                                           globals);
    }
...
clarity()
{
    if (!Shader_FilterClarity)
    {
        ...
        params.push_back(new Symbol(Symbol::ParameterConstIn, "in1", Symbol::Vec4fType));
        params.push_back(new Symbol(Symbol::ParameterConstIn, "amount", Symbol::FloatType));
        Shader_FilterClarity = new Shader::Function("FilterClarity",
                                                    FilterClarity_glsl,
                                                    Shader::Function::Color,
                                                    params,
                                                    globals);
...
histogram()
{
    if (!Shader_Histogram)
    {
        ...
        params.push_back(new Symbol(Symbol::ParameterConstIn, "win", Symbol::OutputImageType));
        Shader_Histogram = new Shader::Function("Histogram",
                                                 Histogram_glsl,
...
filterGaussianVertical()
{
    if (!Shader_FilterGaussianVertical)
    {
        ...
        params.push_back(new Symbol(Symbol::ParameterConstIn, "win", Symbol::OutputImageType));
        Shader_FilterGaussianVertical = new Shader::Function("FilterGaussianVertical",
                                                             FilterGaussianVertical_glsl,
                                                             Shader::Function::UndecidedType,
                                                             params,
                                                             globals);
    }
...
filterGaussianHorizontal()
{
    if (!Shader_FilterGaussianHorizontal)
    {
        ...
        params.push_back(new Symbol(Symbol::ParameterConstIn, "sigma", Symbol::FloatType));
        params.push_back(new Symbol(Symbol::ParameterConstIn, "win", Symbol::OutputImageType));
        Shader_FilterGaussianHorizontal = new Shader::Function("FilterGaussianHorizontal",
                                                               FilterGaussianHorizontal_glsl,
                                                               Shader::Function::UndecidedType,
                                                               params,
                                                               globals);
    }
...
filterGaussianVerticalFast()
{
    if (!Shader_FilterGaussianVerticalFast)
    {
        ...
        params.push_back(new Symbol(Symbol::ParameterConstIn, "radius", Symbol::FloatType));
        params.push_back(new Symbol(Symbol::ParameterConstIn, "win", Symbol::OutputImageType));
        Shader_FilterGaussianVerticalFast = new Shader::Function("FilterGaussianVerticalFast",
...
filterGaussianHorizontalFast()
{
    if (!Shader_FilterGaussianHorizontalFast)
    {
        ...
        params.push_back(new Symbol(Symbol::ParameterConstIn, "radius", Symbol::FloatType));
        params.push_back(new Symbol(Symbol::ParameterConstIn, "win", Symbol::OutputImageType));
        Shader_FilterGaussianHorizontalFast = new Shader::Function("FilterGaussianHorizontalFast",
...
resizeDownSample()
{
    if (!Shader_ResizeDownSample)
    {
        ...
        Shader_ResizeDownSample = new Shader::Function("ResizeDownSample",
                                                       ResizeDownSample_glsl,
                                                       Shader::Function::UndecidedType,
                                                       params,
                                                       globals);
    }
...
resizeDownSampleFast()
{
    if (!Shader_ResizeDownSampleFast)
    {
        ...
        Shader_ResizeDownSampleFast = new Shader::Function("ResizeDownSampleFast",
                                                           ResizeDownSampleFast_glsl,
                                                           Shader::Function::UndecidedType,
                                                           params,
                                                           globals);
    }
...
resizeDownSampleDerivative()
{
    if (!Shader_ResizeDownSampleDerivative)
    {
        ...
        Shader_ResizeDownSampleDerivative = new Shader::Function("ResizeDownSampleDerivative",
...
resizeUpSampleVertical2()
{
    if (!Shader_ResizeUpSampleVertical2)
    {
        ...
        Shader_ResizeUpSampleVertical2 = new Shader::Function("ResizeUpSampleVertical",
                                                              ResizeUpSampleVertical_glsl,
                                                              Shader::Function::UndecidedType,
                                                              params,
                                                              globals);
    }
...
Function*
resizeUpSampleVerticalMitchell2()
{
    if (!Shader_ResizeUpSampleVerticalMitchell2)
    {
        ...
        Shader_ResizeUpSampleVerticalMitchell2 = new Shader::Function("ResizeUpSampleVerticalMitchell",
...
resizeUpSampleHorizontal2()
{
    if (!Shader_ResizeUpSampleHorizontal2)
    {
        ...
        Shader_ResizeUpSampleHorizontal2 = new Shader::Function("ResizeUpSampleHorizontal",
                                                                ResizeUpSampleHorizontal_glsl,
                                                                Shader::Function::UndecidedType,
                                                                params,
                                                                globals);
    }
...
resizeUpSampleHorizontalMitchell2()
{
    if (!Shader_ResizeUpSampleHorizontalMitchell2)
    {
        ...
        Shader_ResizeUpSampleHorizontalMitchell2 = new Shader::Function("ResizeUpSampleHorizontalMitchell",
...
inlineBoxResize()
{
    if (!Shader_InlineBoxResize)
    {
        ...
        Shader_InlineBoxResize = new Shader::Function("InlineBoxResize",
                                                      InlineBoxResize_glsl,
                                                      Shader::Function::MorphologicalFilter,
                                                      params,
                                                      globals);
    }
...
inlineAdaptiveBoxResize()
{
    if (!Shader_InlineAdaptiveBoxResize)
    {
        ...
        params.push_back(in0());
        params.push_back(_offset());
        Shader_InlineAdaptiveBoxResize = new Shader::Function("InlineAdaptiveBoxResize",
                                                              InlineAdaptiveBoxResize_glsl,
                                                              Shader::Function::MorphologicalFilter,
                                                              params,
                                                              globals);
    }
...
Function*
blend(int no, const char* funcName, const char* shaderCode)
{
    assert(no >= 2);
    ...
    return new Shader::Function( funcName,
                                 shaderCode,
                                 Shader::Function::Color,
                                 params,
                                 globals );
...
colorQuantize()
{
    if (!Shader_ColorQuantize)
    {
        ...
        Shader_ColorQuantize = new Shader::Function("ColorQuantize",
                                                    ColorQuantize_glsl,
                                                    Shader::Function::Color,
                                                    params,
                                                    globals);
...
colorCurve()
{
    if (!Shader_ColorCurve)
    {
        ...
        Shader_ColorCurve = new Shader::Function("ColorCurve",
                                                  ColorCurve_glsl,
                                                  Shader::Function::Color,
                                                  params,
                                                  globals);
...
colorHighlight()
{
    if (!Shader_ColorHighlight)
    {
        ...
        Shader_ColorHighlight = new Shader::Function("ColorHighlight",
                                                     ColorHighlight_glsl,
                                                     Shader::Function::Color,
                                                     params,
                                                     globals);
...
colorShadow()
{
    if (!Shader_ColorShadow)
    {
        ...
        Shader_ColorShadow = new Shader::Function("ColorShadow",
                                                 ColorShadow_glsl,
                                                 Shader::Function::Color,
                                                 params,
                                                 globals);
...
colorVibrance()
{
    if (!Shader_ColorVibrance)
    {
        ...
        Shader_ColorVibrance = new Shader::Function("ColorVibrance",
                                                     ColorVibrance_glsl,
                                                     Shader::Function::Color,
                                                     params,
                                                     globals);
...
colorSRGBYCbCr()
{
    if (!Shader_ColorSRGBYCbCr)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorSRGBYCbCr = new Shader::Function("ColorSRGBYCbCr",
                                                      ColorSRGBYCbCr_glsl,
                                                      Shader::Function::Color,
                                                      params,
                                                      globals);
...
colorYCbCrSRGB()
{
    if (!Shader_ColorYCbCrSRGB)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorYCbCrSRGB = new Shader::Function("ColorYCbCrSRGB",
                                                     ColorYCbCrSRGB_glsl,
                                                     Shader::Function::Color,
                                                     params,
                                                     globals);
...
colorOutOfRange()
{
    if (!Shader_ColorOutOfRange)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorOutOfRange = new Shader::Function("ColorOutOfRange",
                                                      ColorOutOfRange_glsl,
                                                      Shader::Function::Color,
                                                      params,
                                                      globals);
    }
...
colorTemperatureOffset()
{
    if (!Shader_ColorTemperatureOffset)
    {
        ...
        Shader_ColorTemperatureOffset = new Shader::Function("ColorTemperatureOffset",
                                                             ColorTemperatureOffset_glsl,
                                                             Shader::Function::Color,
                                                             params,
                                                             globals);
    }
...
colorBlendWithConstant()
{
    if (!Shader_ColorBlendWithConstant)
    {
        ...
        Shader_ColorBlendWithConstant = new Shader::Function("ColorBlendWithConstant",
                                                             ColorBlendWithConstant_glsl,
                                                             Shader::Function::Color,
                                                             params,
                                                             globals);
    }
...
colorCDL()
{
    if (!Shader_ColorCDL)
    {
        ...
        Shader_ColorCDL = new Shader::Function("ColorCDL",
                                               ColorCDL_glsl,
                                               Shader::Function::Color,
                                               params,
                                               globals);
...
colorCDL_SAT()
{
    if (!Shader_ColorCDL_SAT)
    {
        ...
        Shader_ColorCDL_SAT = new Shader::Function("ColorCDL_SAT",
                                                   ColorCDL_SAT_glsl,
                                                   Shader::Function::Color,
                                                   params,
                                                   globals);
...
colorCDL_SAT_noClamp()
{
    if (!Shader_ColorCDL_SAT_noClamp)
    {
        ...
        Shader_ColorCDL_SAT_noClamp = new Shader::Function("ColorCDL_SAT_noClamp",
                                                            ColorCDL_SAT_noClamp_glsl,
                                                            Shader::Function::Color,
                                                            params,
                                                            globals);
    }
...
colorCDLForACESLinear()
{
    if (!Shader_ColorCDLForACESLinear)
    {
        ...
        Shader_ColorCDLForACESLinear = new Shader::Function("ColorCDLForACESLinear",
                                                            ColorCDLForACESLinear_glsl,
                                                            Shader::Function::Color,
                                                            params,
                                                            globals);
    }
...
colorCDLForACESLog()
{
    if (!Shader_ColorCDLForACESLog)
    {
        ...
        Shader_ColorCDLForACESLog = new Shader::Function("ColorCDLForACESLog",
                                                            ColorCDLForACESLog_glsl,
                                                            Shader::Function::Color,
                                                            params,
                                                            globals);
    }
...
color3DLUT()
{
    if (!Shader_Color3DLUT)
    {
        ...
        //  RGBA_sampler) because its just a regular parameter. No STs are
        //  needed, etc.
        //
        ...
        Shader_Color3DLUT = new Shader::Function("Color3DLUT",
                                                 Color3DLUT_glsl,
                                                 Shader::Function::Color,
                                                 params,
                                                 globals,
...
color3DLUTGLSampling()
{
    if (!Shader_Color3DLUTGLSampling)
    {
        ...
        Shader_Color3DLUTGLSampling = new Shader::Function("Color3DLUTGLSampling",
                                                           Color3DLUTGLSampling_glsl,
                                                           Shader::Function::Color,
                                                           params,
                                                           globals,
                                                           1);
...
colorChannelLUT()
{
    if (!Shader_ColorChannelLUT)
    {
        ...
        Shader_ColorChannelLUT = new Shader::Function("ColorChannelLUT",
                                                      ColorChannelLUT_glsl,
                                                      Shader::Function::Color,
                                                      params,
                                                      globals,
                                                      3);
...
colorLuminanceLUT()
{
    if (!Shader_ColorLuminanceLUT)
    {
        ...
        Shader_ColorLuminanceLUT = new Shader::Function("ColorLuminanceLUT",
                                                        ColorLuminanceLUT_glsl,
                                                        Shader::Function::Color,
                                                        params,
                                                        globals,
                                                        1);
...
colorLogCToLinear()
{
    if (!Shader_ColorLogCLinear)
    {
        ...
        Shader_ColorLogCLinear = new Shader::Function("ColorLogCLinear",
                                                      ColorLogCLinear_glsl,
                                                      Shader::Function::Color,
                                                      params,
                                                      globals);
    }
...
colorLinearToLogC()
{
    if (!Shader_ColorLinearLogC)
    {
        ...
        Shader_ColorLinearLogC = new Shader::Function("ColorLinearLogC",
                                                      ColorLinearLogC_glsl,
                                                      Shader::Function::Color,
                                                      params,
                                                      globals);
    }
...
colorCineonLogToLinear()
{
    if (!Shader_ColorCineonLogLinear)
    {
        ...
        Shader_ColorCineonLogLinear = new Shader::Function("ColorCineonLogLinear",
                                                           ColorCineonLogLinear_glsl,
                                                           Shader::Function::Color,
                                                           params,
                                                           globals);
    }
...
Function*
colorCineonSoftClipLogToLinear()
{
    if (!Shader_ColorCineonSoftClipLogLinear)
    {
        ...
        Shader_ColorCineonSoftClipLogLinear = new Shader::Function("ColorCineonSoftClipLogLinear",
                                                                   ColorCineonSoftClipLogLinear_glsl,
                                                                   Shader::Function::Color,
                                                                   params,
                                                                   globals);
    }
...
colorLinearToCineonLog()
{
    if (!Shader_ColorLinearCineonLog)
    {
        ...
        Shader_ColorLinearCineonLog = new Shader::Function("ColorLinearCineonLog",
                                                           ColorLinearCineonLog_glsl,
                                                           Shader::Function::Color,
                                                           params,
                                                           globals);
    }
...
Function*
colorViperLogToLinear()
{
    if (!Shader_ColorViperLogLinear)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorViperLogLinear = new Shader::Function("ColorViperLogLinear",
                                                          ColorViperLogLinear_glsl,
                                                          Shader::Function::Color,
                                                          params,
                                                          globals);
    }
...
colorRedLogToLinear()
{
    if (!Shader_ColorRedLogLinear)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorRedLogLinear = new Shader::Function("ColorRedLogLinear",
                                                          ColorRedLogLinear_glsl,
                                                          Shader::Function::Color,
                                                          params,
                                                          globals);
    }
...
colorLinearToRedLog()
{
    if (!Shader_ColorLinearRedLog)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorLinearRedLog = new Shader::Function("ColorLinearRedLog",
                                                          ColorLinearRedLog_glsl,
                                                          Shader::Function::Color,
                                                          params,
                                                          globals);
    }
...
colorPremult()
{
    if (!Shader_ColorPremult)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorPremult = new Shader::Function("ColorPremult",
                                                   ColorPremult_glsl,
                                                   Shader::Function::LinearColor,
                                                   params,
                                                   globals);
    }
...
colorPremultLight()
{
    if (!Shader_ColorPremultLight)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorPremultLight = new Shader::Function("ColorPremultLight",
                                                   ColorPremultLight_glsl,
                                                   Shader::Function::LinearColor,
                                                   params,
                                                   globals);
    }
...
colorUnpremult()
{
    if (!Shader_ColorUnpremult)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorUnpremult = new Shader::Function("ColorUnpremult",
                                                     ColorUnpremult_glsl,
                                                     Shader::Function::Color,
                                                     params,
                                                     globals);
...
colorGamma()
{
    if (!Shader_ColorGamma)
    {
        ...
        params.push_back(new Symbol(Symbol::ParameterConstIn, 
                                    "gamma", 
                                    Symbol::Vec3fType));
        Shader_ColorGamma = new Shader::Function("ColorGamma",
                                                 ColorGamma_glsl,
                                                 Shader::Function::Color,
                                                 params,
                                                 globals);
...
colorClamp()
{
    if (!Shader_ColorClamp)
    {
        ...
        Shader_ColorClamp = new Shader::Function("ColorClamp",
                                                 ColorClamp_glsl,
                                                 Shader::Function::Color,
                                                 params,
                                                 globals);
...
colorMatrix()
{
    if (!Shader_ColorMatrix)
    {
        ...
        Shader_ColorMatrix = new Shader::Function("ColorMatrix",
                                                  ColorMatrix_glsl,
                                                  Shader::Function::LinearColor,
                                                  params,
                                                  globals);
...
colorMatrix4D()
{
    if (!Shader_ColorMatrix4D)
    {
        ...
        Shader_ColorMatrix4D = new Shader::Function("ColorMatrix4D",
                                                         ColorMatrix4D_glsl,
                                                         Shader::Function::LinearColor,
                                                         params,
                                                         globals);
...
colorLinearToGray()
{
    if (!Shader_ColorLinearGray)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorLinearGray = new Shader::Function("ColorLinearGray",
                                                      ColorLinearGray_glsl,
                                                      Shader::Function::Color,
                                                      params,
                                                      globals);
    }
...
colorSRGBToLinear()
{
    if (!Shader_ColorSRGBLinear)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorSRGBLinear = new Shader::Function("ColorSRGBLinear",
                                                      ColorSRGBLinear_glsl,
                                                      Shader::Function::Color,
                                                      params,
                                                      globals);
    }
...
colorLinearToSRGB()
{
    if (!Shader_ColorLinearSRGB)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorLinearSRGB = new Shader::Function("ColorLinearSRGB",
                                                      ColorLinearSRGB_glsl,
                                                      Shader::Function::Color,
                                                      params,
                                                      globals);
    }
...
ICCLinearToSRGB()
{
    if (!Shader_ICCLinearSRGB)
    {
        ...
        Shader_ICCLinearSRGB = new Shader::Function("ICCLinearSRGB",
                                                    ICCLinearSRGB_glsl,
                                                    Shader::Function::Color,
                                                    params,
                                                    globals);
...
colorRec709ToLinear()
{
    if (!Shader_ColorRec709Linear)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorRec709Linear = new Shader::Function("ColorRec709Linear",
                                                        ColorRec709Linear_glsl,
                                                        Shader::Function::Color,
                                                        params,
                                                        globals);
    }
...
colorLinearToRec709()
{
    if (!Shader_ColorLinearRec709)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorLinearRec709 = new Shader::Function("ColorLinearRec709",
                                                        ColorLinearRec709_glsl,
                                                        Shader::Function::Color,
                                                        params,
                                                        globals);
    }
...
Function*
colorSMPTE240MToLinear()
{
    if (!Shader_ColorSMPTE240MLinear)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorSMPTE240MLinear = new Shader::Function("ColorSMPTE240MLinear",
                                                           ColorSMPTE240MLinear_glsl,
                                                           Shader::Function::Color,
                                                           params,
                                                           globals);
    }
...
Function*
colorLinearToSMPTE240M()
{
    if (!Shader_ColorLinearSMPTE240M)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorLinearSMPTE240M = new Shader::Function("ColorLinearSMPTE240M",
                                                           ColorLinearSMPTE240M_glsl,
                                                           Shader::Function::Color,
                                                           params,
                                                           globals);
    }
...
Function*
colorACESLogToLinear()
{
    if (!Shader_ColorACESLogLinear)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorACESLogLinear = new Shader::Function("ColorACESLogLinear",
                                                         ColorACESLogLinear_glsl,
                                                         Shader::Function::Color,
                                                         params,
                                                         globals);
    }
...
Function*
colorLinearToACESLog()
{
    if (!Shader_ColorLinearACESLog)
    {
        SymbolVector params, globals;
        params.push_back(P());
        Shader_ColorLinearACESLog = new Shader::Function("ColorLinearACESLog",
                                                         ColorLinearACESLog_glsl,
                                                         Shader::Function::Color,
                                                         params,
                                                         globals);
    }
...
sourceY()
{
    if (!Shader_SourceY)
    {
        ...
        Shader_SourceY = new Shader::Function("SourceY",
                                              SourceY_glsl,
...
sourceYUncrop()
{
    if (!Shader_SourceYUncrop)
    {
        ...
        Shader_SourceYUncrop = new Shader::Function("SourceYUncrop",
                                                    SourceYUncrop_glsl,
                                                    Shader::Function::Source,
                                                    params,
                                                    globals);
...
sourceYVYU()
{
    if (!Shader_SourceYVYU)
    {
        ...
        Shader_SourceYVYU = new Shader::Function("SourceYVYU",
                                                 SourceYVYU_glsl,
                                                 Shader::Function::Source,
                                                 params,
                                                 globals,
...
sourceYA()
{
    if (!Shader_SourceYA)
    {
        ...
        Shader_SourceYA = new Shader::Function("SourceYA",
                                               SourceYA_glsl,
                                               Shader::Function::Source,
                                               params,
                                               globals,
...
sourceYAUncrop()
{
    if (!Shader_SourceYAUncrop)
    {
        ...
        Shader_SourceYAUncrop = new Shader::Function("SourceYAUncrop",
                                                     SourceYAUncrop_glsl,
                                                     Shader::Function::Source,
                                                     params,
                                                     globals,
...
sourcePlanarYRYBYA()
{
    if (!Shader_SourcePlanarYRYBYA)
    {
        ...
        Shader_SourcePlanarYRYBYA = new Shader::Function("SourcePlanarYRYBYA",
                                                         SourcePlanarYRYBYA_glsl,
                                                         Shader::Function::Source,
                                                         params,
                                                         globals,
                                                         4);
...
sourcePlanarYRYBYAUncrop()
{
    if (!Shader_SourcePlanarYRYBYAUncrop)
    {
        ...
        Shader_SourcePlanarYRYBYAUncrop = new Shader::Function("SourcePlanarYRYBYAUncrop",
                                                         SourcePlanarYRYBYAUncrop_glsl,
                                                         Shader::Function::Source,
                                                         params,
                                                         globals,
                                                         4);
...
sourcePlanarYRYBY()
{
    if (!Shader_SourcePlanarYRYBY)
    {
        ...
        Shader_SourcePlanarYRYBY = new Shader::Function("SourcePlanarYRYBY",
                                                        SourcePlanarYRYBY_glsl,
                                                        Shader::Function::Source,
                                                        params,
                                                        globals,
                                                        3);
...
sourcePlanarYRYBYUncrop()
{
    if (!Shader_SourcePlanarYRYBYUncrop)
    {
        ...
        Shader_SourcePlanarYRYBYUncrop = new Shader::Function("SourcePlanarYRYBYUncrop",
                                                        SourcePlanarYRYBYUncrop_glsl,
                                                        Shader::Function::Source,
                                                        params,
                                                        globals,
                                                        3);
...
sourcePlanarYAC2()
{
    if (!Shader_SourcePlanarYAC2)
    {
        ...
        Shader_SourcePlanarYAC2 = new Shader::Function("SourcePlanarYAC2",
                                                       SourcePlanarYAC2_glsl,
                                                       Shader::Function::Source,
                                                       params,
                                                       globals,
                                                       2);
...
sourcePlanarYAC2Uncrop()
{
    if (!Shader_SourcePlanarYAC2Uncrop)
    {
        ...
        Shader_SourcePlanarYAC2Uncrop = new Shader::Function("SourcePlanarYAC2Uncrop",
                                                       SourcePlanarYAC2Uncrop_glsl,
                                                       Shader::Function::Source,
                                                       params,
                                                       globals,
                                                       2);
...
sourcePlanarYA()
{
    if (!Shader_SourcePlanarYA)
    {
        ...
        Shader_SourcePlanarYA = new Shader::Function("SourcePlanarYA",
                                                     SourcePlanarYA_glsl,
                                                     Shader::Function::Source,
                                                     params,
                                                     globals,
...
sourcePlanarYAUncrop()
{
    if (!Shader_SourcePlanarYAUncrop)
    {
        ...
        Shader_SourcePlanarYAUncrop = new Shader::Function("SourcePlanarYAUncrop",
                                                     SourcePlanarYAUncrop_glsl,
                                                     Shader::Function::Source,
                                                     params,
                                                     globals,
                                                     2);
...
sourcePlanarYUVA()
{
    if (!Shader_SourcePlanarYUVA)
    {
        ...
        Shader_SourcePlanarYUVA = new Shader::Function("SourcePlanarYUVA",
                                                       SourcePlanarYUVA_glsl,
                                                       Shader::Function::Source,
                                                       params,
                                                       globals,
                                                       4);
...
sourceYUVA()
{
    if (!Shader_SourceYUVA)
    {
        ...
        Shader_SourceYUVA = new Shader::Function("SourceYUVA",
                                                 SourceYUVA_glsl,
                                                 Shader::Function::Source,
                                                 params,
                                                 globals,
...
sourceAYUV()
{
    if (!Shader_SourceAYUV)
    {
        ...
        Shader_SourceAYUV = new Shader::Function("SourceAYUV",
                                                 SourceAYUV_glsl,
                                                 Shader::Function::Source,
                                                 params,
                                                 globals,
...
sourcePlanarYUVAUncrop()
{
    if (!Shader_SourcePlanarYUVAUncrop)
    {
        ...
        Shader_SourcePlanarYUVAUncrop = new Shader::Function("SourcePlanarYUVAUncrop",
                                                           SourcePlanarYUVAUncrop_glsl,
                                                           Shader::Function::Source,
                                                           params,
                                                           globals,
                                                           4);
...
sourcePlanarYUV()
{
    if (!Shader_SourcePlanarYUV)
    {
        ...
        Shader_SourcePlanarYUV = new Shader::Function("SourcePlanarYUV",
                                                      SourcePlanarYUV_glsl,
                                                      Shader::Function::Source,
                                                      params,
                                                      globals,
                                                      3);
...
sourcePlanar2YUV()
{
    if (!Shader_SourcePlanar2YUV)
    {
        ...
        Shader_SourcePlanar2YUV = new Shader::Function("SourcePlanar2YUV",
                                                       SourcePlanar2YUV_glsl,
                                                       Shader::Function::Source,
                                                       params,
                                                       globals,
                                                       2);
...
sourcePlanarYUVUncrop()
{
    if (!Shader_SourcePlanarYUVUncrop)
    {
        ...
        Shader_SourcePlanarYUVUncrop = new Shader::Function("SourcePlanarYUVUncrop",
                                                      SourcePlanarYUVUncrop_glsl,
                                                      Shader::Function::Source,
                                                      params,
                                                      globals,
                                                      3);
...
sourcePlanarRGB()
{
    if (!Shader_SourcePlanarRGB)
    {
        ...
        Shader_SourcePlanarRGB = new Shader::Function("SourcePlanarRGB",
                                                      SourcePlanarRGB_glsl,
                                                      Shader::Function::Source,
                                                      params,
                                                      globals,
                                                      3);
...
sourcePlanarRGBUncrop()
{
    if (!Shader_SourcePlanarRGBUncrop)
    {
        ...
        Shader_SourcePlanarRGBUncrop = new Shader::Function("SourcePlanarRGBUncrop",
                                                            SourcePlanarRGBUncrop_glsl,
                                                            Shader::Function::Source,
                                                            params,
                                                            globals,
                                                            3);
...
sourcePlanarRGBA()
{
    if (!Shader_SourcePlanarRGBA)
    {
        ...
        Shader_SourcePlanarRGBA = new Shader::Function("SourcePlanarRGBA",
                                                       SourcePlanarRGBA_glsl,
                                                       Shader::Function::Source,
                                                       params,
                                                       globals,
                                                       4);
...
sourcePlanarRGBAUncrop()
{
    if (!Shader_SourcePlanarRGBAUncrop)
    {
        ...
        Shader_SourcePlanarRGBAUncrop = new Shader::Function("SourcePlanarRGBAUncrop",
                                                             SourcePlanarRGBAUncrop_glsl,
                                                             Shader::Function::Source,
                                                             params,
                                                             globals,
                                                             4);
...
sourceRGBA()
{
    if (!Shader_SourceRGBA)
    {
        ...
        Shader_SourceRGBA = new Shader::Function("SourceRGBA",
                                                 SourceRGBA_glsl,
                                                 Shader::Function::Source,
                                                 params,
                                                 globals,
...
sourceRGBAUncrop()
{
    if (!Shader_SourceRGBAUncrop)
    {
        ...
        Shader_SourceRGBAUncrop = new Shader::Function("SourceRGBAUncrop",
                                                       SourceRGBAUncrop_glsl,
                                                       Shader::Function::Source,
                                                       params,
                                                       globals,
                                                       1);
...
sourceBGRA()
{
    if (!Shader_SourceBGRA)
    {
        ...
        Shader_SourceBGRA = new Shader::Function("SourceBGRA",
                                                 SourceBGRA_glsl,
                                                 Shader::Function::Source,
                                                 params,
                                                 globals,
...
sourceBGRAUncrop()
{
    if (!Shader_SourceBGRAUncrop)
    {
        ...
        Shader_SourceBGRAUncrop = new Shader::Function("SourceBGRAUncrop",
                                                       SourceBGRAUncrop_glsl,
                                                       Shader::Function::Source,
                                                       params,
                                                       globals,
                                                       1);
...
sourceARGB()
{
    if (!Shader_SourceARGB)
    {
        ...
        Shader_SourceARGB = new Shader::Function("SourceARGB",
                                                 SourceARGB_glsl,
                                                 Shader::Function::Source,
                                                 params,
                                                 globals,
...
sourceARGBUncrop()
{
    if (!Shader_SourceARGBUncrop)
    {
        ...
        Shader_SourceARGBUncrop = new Shader::Function("SourceARGBUncrop",
                                                       SourceARGBUncrop_glsl,
                                                       Shader::Function::Source,
                                                       params,
                                                       globals,
                                                       1);
...
sourceARGBfromBGRA()
{
    if (!Shader_SourceARGBfromBGRA)
    {
        ...
        Shader_SourceARGBfromBGRA = new Shader::Function("SourceARGBfromBGRA",
                                                 SourceARGBfromBGRA_glsl,
                                                 Shader::Function::Source,
                                                 params,
                                                 globals,
                                                 1);
...
sourceARGBfromBGRAUncrop()
{
    if (!Shader_SourceARGBfromBGRAUncrop)
    {
        ...
        Shader_SourceARGBfromBGRAUncrop = new Shader::Function("SourceARGBfromBGRAUncrop",
                                                       SourceARGBfromBGRAUncrop_glsl,
                                                       Shader::Function::Source,
                                                       params,
                                                       globals,
                                                       1);
...
sourceABGR()
{
    if (!Shader_SourceABGR)
    {
        ...
        Shader_SourceABGR = new Shader::Function("SourceABGR",
                                                 SourceABGR_glsl,
                                                 Shader::Function::Source,
                                                 params,
                                                 globals,
...
sourceABGRUncrop()
{
    if (!Shader_SourceABGRUncrop)
    {
        ...
        Shader_SourceABGRUncrop = new Shader::Function("SourceABGRUncrop",
                                                       SourceABGRUncrop_glsl,
                                                       Shader::Function::Source,
                                                       params,
                                                       globals,
                                                       1);
...
sourceABGRfromBGRA()
{
    if (!Shader_SourceABGRfromBGRA)
    {
        ...
        Shader_SourceABGRfromBGRA = new Shader::Function("SourceABGRfromBGRA",
                                                 SourceABGRfromBGRA_glsl,
                                                 Shader::Function::Source,
                                                 params,
                                                 globals,
                                                 1);
...
sourceABGRfromBGRAUncrop()
{
    if (!Shader_SourceABGRfromBGRAUncrop)
    {
        ...
        Shader_SourceABGRfromBGRAUncrop = new Shader::Function("SourceABGRfromBGRAUncrop",
                                                       SourceABGRfromBGRAUncrop_glsl,
                                                       Shader::Function::Source,
                                                       params,
                                                       globals,
                                                       1);
...
boxFilter()
{
    if (!Shader_BoxFilter)
    {
        Shader_BoxFilter = new Shader::Function("BoxFilter",
                                                BoxFilter_glsl,
                                                Shader::Function::Filter);
    }
...
lensWarpRadial()
{
    ...
    {
        Shader_LensWarpRadial = new Shader::Function("LensWarpRadial",
                                                     LensWarpRadial_glsl,
                                                     Shader::Function::Filter);
    }
...
lensWarpTangential()
{
    ...
    {
        Shader_LensWarpTangential = new Shader::Function("LensWarpTangential",
                                                         LensWarpTangential_glsl,
                                                         Shader::Function::Filter);
    }
...
lensWarpRadialAndTangential()
{
    ...
    {
        Shader_LensWarpRadialAndTangential = new Shader::Function("LensWarpRadialAndTangential",
                                                                   LensWarpRadialAndTangential_glsl,
                                                                   Shader::Function::Filter);
    }
...
LensWarp3DE4AnamorphicDegree6()
{
    ...
    {
        Shader_LensWarp3DE4AnamorphicDegree6 = new Shader::Function("LensWarp3DE4AnamorphicDegree6",
...
Expression*
newDither(const IPImage* image, Expression* A, size_t displayBits, size_t seed)
{
    ...
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], A); i++;
    args[i] = new BoundSpecial(F->parameters()[i]); i++;
    args[i] = new BoundFloat(F->parameters()[i], scale); i++;
    args[i] = new BoundFloat(F->parameters()[i], fSeed); i++;
    return new Expression(F, args, image);
}

Expression*
newStencilBox(const IPImage* image, Expression* A)
{
    ...
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], A); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(xmin, xmax)); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(ymin, ymax)); i++;
    return new Expression(F, args, image);
}

Expression*
newStencilBoxNegAlpha(const IPImage* image, Expression* A)
{
    const float xmin = image->stencilBox.min.x;
    const float ymin = image->stencilBox.min.y;
    const float xmax = image->stencilBox.max.x;
...
Expression*
newStereoScanline(const IPImage* image,
                  ...
                  const vector<Expression*>& FA1)
{
    ...
    ArgumentVector args(F->parameters().size());
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA1[0]); i++;
    args[i] = new BoundExpression(F->parameters()[i], FA1[1]); i++;
    args[i] = new BoundFloat(F->parameters()[i], parityYOffset); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(0.0f)); i++;
    return new Expression(F, args, image);
}

Expression*
newStereoChecker(const IPImage* image, 
                 ...
                 const vector<Expression*>& FA1)
{
    ...
    args[i] = new BoundExpression(F->parameters()[i], FA1[0]); i++;
    args[i] = new BoundExpression(F->parameters()[i], FA1[1]); i++;
    args[i] = new BoundFloat(F->parameters()[i], parityXOffset); i++;
    args[i] = new BoundFloat(F->parameters()[i], parityYOffset); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(0.0f)); i++;
    return new Expression(F, args, image);
}
...
Expression*
newStereoAnaglyph(const IPImage* image, const vector<Expression*>& FA1)
{
    assert(FA1.size() == 2);
...
Expression*
newStereoLumAnaglyph(const IPImage* image, const vector<Expression*>& FA1)
{
    assert(FA1.size() == 2);
    ...
    args[i] = new BoundExpression(F->parameters()[i], FA1[0]); i++;
    args[i] = new BoundExpression(F->parameters()[i], FA1[1]); i++;
    args[i] = new BoundVec3f(F->parameters()[i], lumaCoefficients); i++;
    return new Expression(F, args, image);
}

Expression*
newInlineBoxResize(bool adaptive, const IPImage* image, Expression* A, const Vec2f& scale)
{
    ...
    args[i] = new BoundExpression(F->parameters()[i], A); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(0.0f)); i++;
    if (!adaptive) args[i] = new BoundVec2f(F->parameters()[i], Vec2f(1.0f) / scale); i++;
    return new Expression(F, args, image);
}

Expression*
newSimpleBoxFilter(const IPImage* image, Expression* A, const float size)
{
    const Function* F = boxFilter();
    ArgumentVector args(F->parameters().size());
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], A); i++;
    args[i] = new BoundFloat(F->parameters()[i], size); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(0.0f)); i++;
    return new Expression(F, args, image);
}
    
Expression*
newLensWarp(const IPImage* image,
            Expression* FA,
            float k1,
            float k2,
            float k3,
            ...
            const Vec2f& cropRatio)
{
    ...
    // The convention for center property was specified in terms on TOPLEFT
    // framebuffer, so we adjust accordingly since our fb is now internally
    // BOTTOMLEFT after the source shaders.
    ...
    if (doRadial)
    {
        if (doTangential)
        {
            ...
            ArgumentVector args(F->parameters().size());
            size_t i = 0;
            args[i] = new BoundExpression(F->parameters()[i], FA); i++;
            args[i] = new BoundFloat(F->parameters()[i], k1); i++;
            args[i] = new BoundFloat(F->parameters()[i], k2); i++;
            args[i] = new BoundFloat(F->parameters()[i], k3); i++;
            args[i] = new BoundFloat(F->parameters()[i], d); i++;
            args[i] = new BoundFloat(F->parameters()[i], p1); i++;
            args[i] = new BoundFloat(F->parameters()[i], p2); i++;
            args[i] = new BoundVec2f(F->parameters()[i], offsetInPixels); i++;
            args[i] = new BoundVec2f(F->parameters()[i], fInPixels); i++;
            args[i] = new BoundVec2f(F->parameters()[i], Vec2f(0.0f)); i++;
            return new Expression(F, args, image);
        }
        else
...
Expression*
newLensWarp3DE4AnamorphicDegree6(
            const IPImage* image,
            Expression* FA,
            const Vec2f& c02,
            const Vec2f& c22,
            ...
            const Vec2f& cropRatio)
{
    bool doDistort = (c02 != Vec2f(0.0f)) || (c22 != Vec2f(0.0f)) || (c04 != Vec2f(0.0f)) ||
                     (c24 != Vec2f(0.0f)) || (c44 != Vec2f(0.0f)) || (c06 != Vec2f(0.0f)) ||
                     (c26 != Vec2f(0.0f)) || (c46 != Vec2f(0.0f)) || (c66 != Vec2f(0.0f));
    ...
    if (doDistort)
    {
        ...
        size_t i = 0;
        args[i] = new BoundExpression(F->parameters()[i], FA); i++;
        args[i] = new BoundVec2f(F->parameters()[i], c02); i++;
        args[i] = new BoundVec2f(F->parameters()[i], c22); i++;
        args[i] = new BoundVec2f(F->parameters()[i], c04); i++;
        args[i] = new BoundVec2f(F->parameters()[i], c24); i++;
        args[i] = new BoundVec2f(F->parameters()[i], c44); i++;
        args[i] = new BoundVec2f(F->parameters()[i], c06); i++;
        args[i] = new BoundVec2f(F->parameters()[i], c26); i++;
        args[i] = new BoundVec2f(F->parameters()[i], c46); i++;
        args[i] = new BoundVec2f(F->parameters()[i], c66); i++;
        args[i] = new BoundVec2f(F->parameters()[i], offsetInPixels); i++;
        args[i] = new BoundVec2f(F->parameters()[i], fInPixels); i++;
        args[i] = new BoundVec2f(F->parameters()[i], Vec2f(0.0f)); i++;
        return new Expression(F, args, image);
...
const char* overShaders[]               = {Over2_glsl,
                                           Over3_glsl,
                                           Over4_glsl};
const char* replaceShaders[]            = {Replace2_glsl,
                                           Replace3_glsl,
                                           Replace4_glsl};
const char* addShaders[]                = {Add2_glsl,
                                           Add3_glsl,
                                           Add4_glsl};
const char* differenceShaders[]         = {Difference2_glsl,
                                           Difference3_glsl,
                                           Difference4_glsl};
...
// with the input Expressions as input to the blend shaders (over, add, etc.)
// the input Expressions are held in FA1, with starting position as 'startPos', and
// number of Expressions as 'size'
Expression*
newBlend(const IPImage* image, const vector<Expression*>& FA1, const IPImage::BlendMode mode)
{
    int size = FA1.size();
    ...
    {
        case IPImage::Add:
            F = blend(size, name, addShaders[size - 2]); //*2_glsl is at position 0
            break;
        case IPImage::Difference:
            F = blend(size, name, differenceShaders[size - 2]); //*2_glsl is at position 0
            break;
        case IPImage::ReverseDifference:
            F = blend(size, name, reverseDifferenceShaders[size - 2]); //*2_glsl is at position 0
            break;
        case IPImage::Replace:
            F = blend(size, name, replaceShaders[size - 2]); //*2_glsl is at position 0
            break;
        default: /*case IPImage::Over:*/
            F = blend(size, name, overShaders[size - 2]); //*2_glsl is at position 0
            break;
        //TODO: dissolve
    }
...
Expression*
newHistogram(const IPImage* image, const std::vector<Expression*>&FA1)
{
...
Expression*
newFilterGaussianVerticalFast(Expression* FA,
                              ...
                              const float sigma)
{
    ...
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundSampler(F->parameters()[i], ImageOrFB(fb, 0)); i++;
    args[i] = new BoundFloat(F->parameters()[i], radius); i++;
    args[i] = new BoundSpecial(F->parameters()[i]); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(0.0f)); i++;
...
Expression*
newFilterGaussianVertical(Expression* FA, const float radius, const float sigma)
{
    ...
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundFloat(F->parameters()[i], radius); i++;
    args[i] = new BoundFloat(F->parameters()[i], sigma); i++;
    args[i] = new BoundSpecial(F->parameters()[i]); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(0.0f)); i++;
    return new Expression(F, args, FA->image());
}
...
Expression*
newFilterGaussianHorizontal(Expression* FA, const float radius, const float sigma)
{
...
Expression*
newFilterUnsharpMask(const IPImage* image,
                     ...
                     const float threshold)
{
    ...
    args[i] = new BoundExpression(F->parameters()[i], FA1[0]); i++;
    args[i] = new BoundExpression(F->parameters()[i], FA1[1]); i++;
    args[i] = new BoundFloat(F->parameters()[i], amount); i++;
    args[i] = new BoundFloat(F->parameters()[i], threshold); i++;
    return new Expression(F, args, image);
}
    
Expression*
newFilterNoiseReduction(const IPImage* image,
                        const std::vector<Expression*>& FA1,
                        const float amount,
                        const float threshold)
{
...
Expression*
newFilterClarity(const IPImage* image,
                 const std::vector<Expression*>& FA1,
                 const float amount)
{
    assert(FA1.size() == 2);
...
Expression*
newColorQuantize(Expression* FA, int partitions)
{
    const Function* F = colorQuantize();
    ArgumentVector args(F->parameters().size());
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundFloat(F->parameters()[i], float(partitions)); i++;
    return new Expression(F, args, FA->image());
}

Expression*
newColorLineartoGray(Expression* FA)
{
...
Expression*
newColorCurveonY(Expression* FA,
                 const TwkMath::Vec3f& p1,
                 ...
                 const TwkMath::Vec3f& p4)
{
    ...
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundVec3f(F->parameters()[i], p1); i++;
    args[i] = new BoundVec3f(F->parameters()[i], p2); i++;
    args[i] = new BoundVec3f(F->parameters()[i], p3); i++;
    args[i] = new BoundVec3f(F->parameters()[i], p4); i++;
    return new Expression(F, args, FA->image());
}
    
Expression*
newColorHighlightonY(Expression* FA, const TwkMath::Vec4f& coeff, const float highlight)
{
    const Function* F = colorHighlight();
    ArgumentVector args(F->parameters().size());
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundVec4f(F->parameters()[i], coeff); i++;
    args[i] = new BoundFloat(F->parameters()[i], highlight); i++;
    return new Expression(F, args, FA->image());
}

Expression*
newColorShadowonY(Expression* FA, const TwkMath::Vec4f& coeff, const float shadow)
{
    ...
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundVec4f(F->parameters()[i], coeff); i++;
    args[i] = new BoundFloat(F->parameters()[i], shadow); i++;
    return new Expression(F, args, FA->image());
}
    
Expression*
newColorVibrance(Expression* FA, const TwkMath::Vec3f& rgb709, const float saturation)
{
    const Function* F = colorVibrance();
    ArgumentVector args(F->parameters().size());
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundVec3f(F->parameters()[i], rgb709); i++;
    args[i] = new BoundFloat(F->parameters()[i], saturation); i++;
    return new Expression(F, args, FA->image());
}
    
Expression*
newColorSRGBYCbCr(Expression* FA)
{
    if (FA->function() == colorYCbCrSRGB())
    {
        Expression* fexpr = static_cast<const BoundExpression*>
        (FA->arguments()[0])->value()->copy();
        delete FA;
        return fexpr;
    }
...
Expression*
newColorYCbCrSRGB(Expression* FA)
{
...
Expression*
newColorViperLogToLinear(Expression* FA)
{
...
Expression*
newColorRedLogToLinear(Expression* FA)
{
...
Expression*
newColorLinearToRedLog(Expression* FA)
{
...
Expression*
newColorLogCLinear(Expression* FA,
                   float pbs,
                   float eo,
                   float eg,
                   float gs,
                   ...
                   float cutoff)
{
    ...
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundFloat(F->parameters()[i], A); i++;
    args[i] = new BoundFloat(F->parameters()[i], B); i++;
    args[i] = new BoundFloat(F->parameters()[i], C); i++;
    args[i] = new BoundFloat(F->parameters()[i], D); i++;
    args[i] = new BoundFloat(F->parameters()[i], X); i++;
    args[i] = new BoundFloat(F->parameters()[i], Y); i++;
    args[i] = new BoundFloat(F->parameters()[i], cutoff); i++;
    return new Expression(F, args, FA->image());
}

Expression*
newColorLinearLogC(Expression* FA,
                   float pbs,
                   float eo,
                   float eg,
                   float gs,
...
{                   
    ...
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundFloat(F->parameters()[i], pbs); i++;
    args[i] = new BoundFloat(F->parameters()[i], eo); i++;
    args[i] = new BoundFloat(F->parameters()[i], eg); i++;
    args[i] = new BoundFloat(F->parameters()[i], gs); i++;
    args[i] = new BoundFloat(F->parameters()[i], bo); i++;
    args[i] = new BoundFloat(F->parameters()[i], ls); i++;
    args[i] = new BoundFloat(F->parameters()[i], lo); i++;
    args[i] = new BoundFloat(F->parameters()[i], cutoff); i++;
    return new Expression(F, args, FA->image());
}

Expression*
newColorCineonLogToLinear(Expression* FA,
                         double refBlack,
                         double refWhite, 
                         double softClip)
{
    ...
    if (softClip <= 0.0)
    {
        ...
        size_t i = 0;
        args[i] = new BoundExpression(F->parameters()[i], FA); i++;
        args[i] = new BoundFloat(F->parameters()[i], black); i++;
        args[i] = new BoundFloat(F->parameters()[i], whiteBlackDiff); i++;
        return new Expression(F, args, FA->image());
    }
    else
    {
        ...
        args[i] = new BoundFloat(F->parameters()[i], black); i++;
        args[i] = new BoundFloat(F->parameters()[i], whiteBlackDiff); i++;
        args[i] = new BoundFloat(F->parameters()[i], softClip); i++;
        args[i] = new BoundFloat(F->parameters()[i], breakpoint); i++;
        args[i] = new BoundFloat(F->parameters()[i], kneeGain); i++;
        args[i] = new BoundFloat(F->parameters()[i], kneeOffset); i++;
        return new Expression(F, args, FA->image());
    }
}

Expression*
newColorLinearToCineonLog(Expression* FA,
                         double refBlack,
                         double refWhite)
{
    ...
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundFloat(F->parameters()[i], refBlack); i++;
    args[i] = new BoundFloat(F->parameters()[i], refWhite); i++;
    return new Expression(F, args, FA->image());
}

Expression* 
newColorClamp(Expression* FA, float minValue, float maxValue)
{
    const Function* F = colorClamp();
    ArgumentVector args(F->parameters().size());
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundFloat(F->parameters()[i], minValue); i++;
    args[i] = new BoundFloat(F->parameters()[i], maxValue); i++;
    return new Expression(F, args, FA->image());
}
    

Expression*
newColorGamma(Expression* FA, const Vec3f& v)
{
    //
    //  Early exit if v would result in identity function
    //

    if (v == Vec3f(1,1,1)) return FA;
    ...
    else
    {
        ...
        size_t i = 0;
        args[i] = new BoundExpression(F->parameters()[i], FA); i++;
        args[i] = new BoundVec3f(F->parameters()[i], v); i++;
        return new Expression(F, args, FA->image());
    }
}

Expression*
newColorMatrix(Expression* FA, const Mat44f& M) 
{
    if (M == Mat44f()) return FA;
  ...
  if (FA->function() == colorMatrix())
  {
    ...
    else
    {
        ...
        size_t i = 0;
        args[i] = new BoundExpression(F->parameters()[i], FA); i++;
        args[i] = new BoundMat44f(F->parameters()[i], M); i++;
        return new Expression(F, args, FA->image());
    }
}

Expression*
newColorMatrix4D(Expression* FA, const Mat44f& M)
{
    if (M == Mat44f()) return FA;
...
Expression*
newColorSRGBToLinear(Expression* FA)
{
...
Expression*
newColorLinearToSRGB(Expression* FA)
{
...
Expression*
newICCLinearToSRGB(Expression* FA, 
                   const TwkMath::Vec3f& gamma,
                   ...
                   const TwkMath::Vec3f& d)
{
    ...
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundVec3f(F->parameters()[i], gamma); i++;
    args[i] = new BoundVec3f(F->parameters()[i], a); i++;
    args[i] = new BoundVec3f(F->parameters()[i], b); i++;
    args[i] = new BoundVec3f(F->parameters()[i], c); i++;
    args[i] = new BoundVec3f(F->parameters()[i], d); i++;
    return new Expression(F, args, FA->image());
}

Expression*
newColorLinearToRec709(Expression* FA)
{
...
Expression*
newColorLinearToSMPTE240M(Expression* FA)
{
...
Expression*
newColorLinearToACESLog(Expression* FA)
{
...
Expression*
newColorOutOfRange(Expression* FA)
{
...
Expression*
newColorTemperatureOffset(Expression* FA, const Vec4f& color)
{
    const Function* F = colorTemperatureOffset();
    ArgumentVector args(F->parameters().size());
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundVec4f(F->parameters()[i], color); i++;
    return new Expression(F, args, FA->image());
}

Expression*
newColorBlendWithConstant(Expression* FA, const Vec4f& color)
{
...
Expression*
newColorPremultLight(Expression* FA)
{
    if (FA->function() == colorUnpremult())
    {
        //
...
Expression*
newColorUnpremult(Expression* FA)
{
...
Expression*
newColorRec709ToLinear(Expression* FA)
{
...
Expression*
newColorSMPTE240MToLinear(Expression* FA)
{
...
Expression*
newColorACESLogToLinear(Expression* FA)
{
...
//
//  Uncrop offset X, Y are always in a BOTTOMLEFT coordinate frame, but we are
//  about to use them in the native coord frame of the FB, so convert to that
//  frame before we use them. 
//

static int
nativeUncropX(const FrameBuffer *fb)
{
    return fb->uncropX();
}

static int
nativeUncropY(const FrameBuffer *fb)
{
    return fb->uncropY();
}

static float
computeOrientation(const FrameBuffer* fb)
{
...
Expression*
newSourcePlanarYUVA(const IPImage* img, const Mat44f& M)
{
    ...
    ArgumentVector args(F->parameters().size());
    size_t i = 0;
    args[i] = new BoundSampler(F->parameters()[i], ImageOrFB(img, fb, 0)); i++;
    args[i] = new BoundSampler(F->parameters()[i], ImageOrFB(img, fb, 1)); i++;
    args[i] = new BoundSampler(F->parameters()[i], ImageOrFB(img, fb, 2)); i++;
    args[i] = new BoundSampler(F->parameters()[i], ImageOrFB(img, fb, 3)); i++;
    args[i] = new BoundImageCoord(F->parameters()[i], ImageCoord(img)); i++;
    args[i] = new BoundVec2f(F->parameters()[i], r0); i++;
    args[i] = new BoundVec2f(F->parameters()[i], r1); i++;
    args[i] = new BoundMat44f(F->parameters()[i], M); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(0.0f)); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(fb->width(), fb->height())); i++;
    
    float orientation = computeOrientation(fb);
    args[i] = new BoundFloat(F->parameters()[i], orientation); i++;
    
    return new Expression(F, args, img);
}

Expression*
newSourcePlanarYUVAUncrop(const IPImage* img, const Mat44f& M)
{
    const FrameBuffer* fb = img->fb;
    ...
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(0.0f)); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(fb->width(), fb->height())); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(nativeUncropX(fb), nativeUncropY(fb))); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(fb->uncropWidth(), fb->uncropHeight())); i++;
...
Expression*
newSourcePlanarYUV(const IPImage* img, const Mat44f& M)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourceYVYU(const IPImage* img, const Mat44f& M)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourcePlanar2YUV(const IPImage* img, const Mat44f& M)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourcePlanarYUVUncrop(const IPImage* img, const Mat44f& M)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourcePlanarYRYBY(const IPImage* img, const Vec3f& w)
{
    const FrameBuffer* fb = img->fb;
    ...
    args[i] = new BoundVec2f(F->parameters()[i], r0); i++;
    args[i] = new BoundVec2f(F->parameters()[i], r1); i++;
    args[i] = new BoundVec3f(F->parameters()[i], w); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(0.0f)); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(fb->width(), fb->height())); i++;
...
Expression*
newSourcePlanarYRYBYUncrop(const IPImage* img, const Vec3f& w)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourcePlanarYAC2(const IPImage* img, const Vec3f& w)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourcePlanarYAC2Uncrop(const IPImage* img, const Vec3f& w)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourceYUVA(const IPImage* img, const Mat44f& M)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourceAYUV(const IPImage* img, const Mat44f& M)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourcePlanarYA(const IPImage* img)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourcePlanarYAUncrop(const IPImage* img)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourcePlanarYRYBYA(const IPImage* img, const Vec3f& w)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourcePlanarYRYBYAUncrop(const IPImage* img, const Vec3f& w)
{
    const FrameBuffer* fb = img->fb;
...
Expression*
newSourcePlanarRGB(const IPImage* img)
{
...
Expression*
newSourcePlanarRGBUncrop(const IPImage* img)
{
...
Expression*
newSourcePlanarRGBA(const IPImage* img)
{
...
Expression*
newSourcePlanarRGBAUncrop(const IPImage* img)
{
...
Expression*
newSourceYUncrop(const IPImage* img)
{
...
Expression*
newSourceYAUncrop(const IPImage* img)
{
...
Expression*
newSourceRGBA(const IPImage* img)
{
    ...
    {
        args[i] = new BoundSampler(F->parameters()[i], ImageOrFB(img)); i++;
    }
    ...
    {
        args[i] = new BoundVec2f(F->parameters()[i], Vec2f(img->width, img->height)); i++;
    }
...
Expression*
newSourceRGBAUncrop(const IPImage* img)
{
...
Expression*
newSourceBGRA(const IPImage* img)
{
...
Expression*
newSourceBGRAUncrop(const IPImage* img)
{
...
Expression*
newSourceARGB(const IPImage* img)
{
...
Expression*
newSourceARGBUncrop(const IPImage* img)
{
...
Expression*
newSourceARGBfromBGRA(const IPImage* img)
{
...
Expression*
newSourceARGBfromBGRAUncrop(const IPImage* img)
{
...
Expression*
newSourceABGR(const IPImage* img)
{
...
Expression*
newSourceABGRUncrop(const IPImage* img)
{
...
Expression*
newSourceABGRfromBGRA(const IPImage* img)
{
...
Expression*
newSourceABGRfromBGRAUncrop(const IPImage* img)
{
              ...
              const Vec3f& outOffset)
{
    ...
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundSampler(F->parameters()[i], ImageOrFB(fb, 0)); i++;
    args[i] = new BoundVec3f(F->parameters()[i], sizeMinusOne); i++;
    args[i] = new BoundVec3f(F->parameters()[i], inScale); i++;
    args[i] = new BoundVec3f(F->parameters()[i], inOffset); i++;
    args[i] = new BoundVec3f(F->parameters()[i], outScale); i++;
    args[i] = new BoundVec3f(F->parameters()[i], outOffset); i++;

    return new Expression(F, args, FA->image());
}
    
Expression*
newColor3DLUTGLSampling(Expression* FA,
                        const TwkFB::FrameBuffer* fb,
                        const Vec3f& inScale,
                        const Vec3f& inOffset,
                        const Vec3f& outScale,
                        const Vec3f& outOffset)
{
...
Expression*
newColorChannelLUT(Expression* FA,
                   const TwkFB::FrameBuffer* fb,
                   const Vec3f& outScale,
                   const Vec3f& outOffset)
{
    ...
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundSampler(F->parameters()[i], ImageOrFB(fb, 0)); i++;
    args[i] = new BoundVec3f(F->parameters()[i], Vec3f(fb->width() - 1.0f)); i++;
    args[i] = new BoundVec3f(F->parameters()[i], outScale); i++;
    args[i] = new BoundVec3f(F->parameters()[i], outOffset); i++;
...
Expression*
newColorLuminanceLUT(Expression* FA, const TwkFB::FrameBuffer* fb)
{
    ...
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundSampler(F->parameters()[i], ImageOrFB(fb, 0)); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(fb->width() - 1.0f)); i++;
    return new Expression(F, args, FA->image());
}

Expression*
newColorCDL(Expression* FA,
            const Vec3f& scale,
            const Vec3f& offset,
            const Vec3f& power,
            float s,
            bool noClamp)
{
    ...
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], FA); i++;
    args[i] = new BoundVec3f(F->parameters()[i], scale); i++;
    args[i] = new BoundVec3f(F->parameters()[i], offset); i++;
    args[i] = new BoundVec3f(F->parameters()[i], power); i++;

    if (useSAT)
    {
        //
        //  NOTE: saturation matrix is using Rec709 weightings not the 601
        //  versions.
        //
        ...
        args[i] = new BoundMat44f(F->parameters()[i], S); i++;
    }
...
Expression*
newColorCDLForACES(Expression* FA,
                   const Vec3f& scale,
                   const Vec3f& offset,
                   const Vec3f& power,
                   float saturation,
                   ...
                   bool isACESLog)
{
    ...
    args[i] = new BoundFloat(F->parameters()[i], saturation); i++;
    args[i] = new BoundVec3f(F->parameters()[i], lumaCoefficients); i++;
    args[i] = new BoundVec3f(F->parameters()[i], refLow); i++;
    args[i] = new BoundVec3f(F->parameters()[i], refHigh); i++;
    args[i] = new BoundMat44f(F->parameters()[i], toACES); i++;
    args[i] = new BoundMat44f(F->parameters()[i], fromACES); i++;
    args[i] = new BoundFloat(F->parameters()[i], minClamp); i++;
    args[i] = new BoundFloat(F->parameters()[i], maxClamp); i++;
...
Expression*
newDownSample(const IPImage* image, Expression* expr, const int scale)
{
    const Function* F = scale % 2? resizeDownSample() : resizeDownSampleFast();
    ArgumentVector args(F->parameters().size());
    size_t i = 0;
    args[i] = new BoundExpression(F->parameters()[i], expr); i++;
    args[i] = new BoundFloat(F->parameters()[i], (float)scale); i++;
    args[i] = new BoundSpecial(F->parameters()[i]); i++;
    args[i] = new BoundVec2f(F->parameters()[i], Vec2f(0.0f)); i++;
...
Expression*
newDerivativeDownSample(Expression* expr)
{
...
Expression*
newUpSampleVertical(const IPImage* image, Expression* expr, bool highQuality)
{
...
Expression*
newUpSampleHorizontal(const IPImage* image, Expression* expr, bool highQuality)
{
...
Expression*
sourceAssemblyShader(IPImage* image, bool bgra, bool force)
{
    FrameBuffer* fb = image->fb;

    assert(image);

    assert( !(image->shaderExpr && 
...
Expression* 
replaceSourceWithExpression(Expression* root, Expression* expr)
{
...
static
unsigned int generateKeyForGaussian(size_t radius, float sigma)
{
    std::stringstream id;
    id << radius << sigma;
...
FrameBuffer*
generateFastGaussianWeightsFB(size_t radius, float sigma)
{
    ...
    else
    {
        ...
        // utilize gl bilinear interp to reduce the number of samples we need
        // if radius is 2*n, we need 1 + n weights
        // if radius is 2*n + 1, we need 2 + n weights
        // data contains in order, offset and weight (vec2) for each point we need to sample
        ...
        if (radius % 2 == 1)
        {
            // this sample is on its own, all the previous ones have been handled in pairs
            data[fastNo + 1] = Vec3f(radius, rawweights[radius], 0);
        }
        
        result = new FrameBuffer(dataSize, 1, 3,
                                 FrameBuffer::FLOAT,
                                 (unsigned char*)data,
                                 0, FrameBuffer::BOTTOMLEFT,
                                 false);
...
FrameBuffer*
generateFastGaussianWeightsFB(size_t radius)
{
    // 3 sigma away is 0.05 (this is a good default value)
    // 4.5 sigma away is 0.01 effectively 0 as far as filter is concerned
...
// utilize gl bilinear interp to reduce the number of samples we need
IPImage*
applyFastGaussianFilter(const IPNode* node,
                        IPImage* image,
                        size_t radius,
                        float sigma)
{
    ...
    // horizontal
    // this image doesn't necessarily have to be intermediate. if the upcoming image already has a
    // number of complicated shaders on it, it would be worth making this one intermediate.
    // otherwise it should be faster to make this current
    IPImage* gaussHorizontal = new IPImage(node,
    ...
    gaussHorizontal->shaderExpr = Shader::newFilterGaussianHorizontalFast(gaussHorizontal->shaderExpr,
                                                                          gaussFBH,
                                                                          radius);
    ...
    // vertical
    IPImage* gaussVertical = new IPImage(node,
                                         IPImage::BlendRenderType,
                                         width,
                                         height,
                                         1.0,
    ...
    gaussVertical->shaderExpr = Shader::newFilterGaussianVerticalFast(gaussVertical->shaderExpr,
                                                                      gaussFBV,
                                                                      radius);
    gaussVertical->appendChild(gaussHorizontal);
    
    // this is to make sure the gaussian (both v and h) are rendered into intermediate, and cached
    IPImage* root = new IPImage(node,
                                IPImage::BlendRenderType,
                                width,
                                height,
                                1.0,
...
// plain gaussian, no magic. compute exp in shader. for small kernels like 3 by 3, it is not worth
// sending weights in as a framebuffer. do it the old fashioned way
IPImage*
applyGaussianFilter(const IPNode* node,
                    IPImage* image,
                    size_t radius,
                    float sigma)
{
