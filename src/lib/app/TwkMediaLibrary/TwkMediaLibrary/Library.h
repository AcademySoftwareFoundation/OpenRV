...
namespace TwkMediaLibrary
{
    ...
    public:
        ...
        //
        //  ShotGrid Server :
        //  sglib://shotgun/server.shotgridsoftware.com/path/to/a/node Local :
        //  sglib://local/path/to/a/node
        //
        //  Some examples of mediaURL() or thumbnailImageURL() might be:
        //
        //  ShotGrid Server :
        //  http://server.shotgridsoftware.com/path/to/a/node?media Local :
        //  file:///Users/name/Movies/mylibrary.sglib/node21/hires.mov Local :
        //  file:///Users/name/Movies/mylibrary.sglib/node32131/thumbnail.jpg
        //
    ...
    public:
        ...
        bool deleteProperty(const PropertyKey& k)
        {
            bool b = n()->deleteProperty(k);
            return b;
        }
