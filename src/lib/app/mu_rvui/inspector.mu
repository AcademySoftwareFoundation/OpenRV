    ...
    \: popupOpts (void; Inspector this, Event event)
    {
        popupMenu(event, 
            newMenu(MenuItem[] {
                menuText("Inspector"),
                menuSeparator(),
                menuItem("Final Rendered Color", "", "", optFinalColor(this, true,), \: (int;) { isShowingFinalColor(this, true); }),
                menuItem("Source Color", "", "", optFinalColor(this, false,), \: (int;) { isShowingFinalColor(this, false); }),
                menuSeparator(),
                menuItem("Normalized [0.0, 1.0]", "", "", optNumericScale(this, 1,), \: (int;) { isNumericScale(this, 1); }),
                menuItem("8 Bit [0, 255]", "", "", optNumericScale(this, 8,), \: (int;) { isNumericScale(this, 8); }),
                menuItem("10 Bit [0, 1023]", "", "", optNumericScale(this, 10,), \: (int;) { isNumericScale(this, 10); }),
                menuItem("12 Bit [0, 4095]", "", "", optNumericScale(this, 12,), \: (int;) { isNumericScale(this, 12); }),
                menuItem("16 Bit [0, 65535]", "", "", optNumericScale(this, 16,), \: (int;) { isNumericScale(this, 16); }),
                menuSeparator(),
                menuItem("Plain Pointer", "", "", optPointerStyle(this, PointerStylePlain,), \: (int;) { isPointerStyle(this, PointerStylePlain); }),
                menuItem("Cross Pointer", "", "", optPointerStyle(this, PointerStyleCross,), \: (int;) { isPointerStyle(this, PointerStyleCross); }),
                menuItem("Box Pointer", "", "", optPointerStyle(this, PointerStyleBox,), \: (int;) { isPointerStyle(this, PointerStyleBox); }),
                menuSeparator(),
                menuItem("Close Button Always", "", "", optCloseButtonStyle(this, CloseButtonAlways,), \: (int;) { isCloseButtonStyle(this, CloseButtonAlways); }),
                menuItem("Close Button When Nearby", "", "", optCloseButtonStyle(this, CloseButtonNearby,), \: (int;) { isCloseButtonStyle(this, CloseButtonNearby); }),
                menuSeparator(),
                menuItem("Close Inspector", "", "", \: (void; Event event) { this.toggle(); }, \: (int;) { UncheckedMenuState; }),
            })
        );
    }
