...
\: buildViewMenu (Menu;)
{
    Menu a = MenuItem[] {
        subMenu("Stereo", MenuItem[] {
            ...
            menuItem("   Anaglyph", "", "", setStereo("anaglyph"), isStereo("anaglyph")),
            menuItem("   Luminance Anaglyph", "", "", setStereo("lumanaglyph"), isStereo("lumanaglyph")),
            menuItem("   Side-by-Side", "", "", setStereo("pair"), isStereo("pair")),
            menuItem("   Mirror Side-by-Side", "", "", setStereo("mirror"), isStereo("mirror")),
            ...
            menuItem("   DLP Checker", "", "", setStereo("checker"), isStereo("checker")),
            menuItem("   Scanline", "", "", setStereo("scanline"), isStereo("scanline")),
            menuItem("   Left Eye Only", "", "", setStereo("left"), isStereo("left")),
            menuItem("   Right Eye Only", "", "", setStereo("right"), isStereo("right")),
            menuItem("   Shutter Glasses", "", "", setStereo("hardware"), isStereo("hardware")),
            menuSeparator(),
            menuItem("Global Swap Eyes", "", "", ~toggleSwapEyes, propToggledAndStereoOnState("@RVDisplayStereo.stereo.swap")),
            menuItem("Global Flip Right Eye", "", "", ~toggleRFlip, propToggledAndStereoOnState("@RVDisplayStereo.rightTransform.flip")),
            menuItem("Global Flop Right Eye", "", "", ~toggleRFlop, propToggledAndStereoOnState("@RVDisplayStereo.rightTransform.flop")),
            menuSeparator(),
            menuText("Interactive Edit"),
            menuItem("    Global Relative Eye Offset (%)", "", "", stereoOffsetMode, eyeOffsetState),
            menuItem("    Global Right Eye Only Offset (%)", "", "", stereoROffsetMode, eyeOffsetState),
            menuSeparator(),
            menuItem("Reset All Stereo Offsets", "", "", resetStereoOffsets, eyeOffsetState)
            }),
        //{"Renderer", Menu {
        ...
        //  }},
        menuSeparator(),
        menuItem("Presentation Mode", "", "", ~togglePresentationMode, presentationModeState),
        menuItem("Presentation Settings", "", "", noop, enabledItem),
        menuSeparator(),
        menuItem("Frame", "", "", ~frameImage, frameState),
        menuItem("Frame Width", "", "", frameWidth, frameState),
        menuSeparator(),
        menuText("Linear to Display Correction"),
        menuItem("   No Correction", "", "", setDispConvert(""), hasDispConversion("")),
        menuItem("   sRGB", "", "", setDispConvert("sRGB"), hasDispConversion("sRGB")),
        menuItem("   Rec709", "", "", setDispConvert("Rec709"), hasDispConversion("Rec709")),
        menuItem("   Display Gamma 2.2", "", "", setDispConvert("Gamma 2.2"), hasDispConversion("Gamma 2.2")),
        menuItem("   Display Gamma 2.4", "", "", setDispConvert("Gamma 2.4"), hasDispConversion("Gamma 2.4")),
        menuItem("   Display Gamma...", "", "", enterDispGamma, dispGammaState),
        menuSeparator(),
        menuItem("Display LUT Active", "", "", ~toggleDisplayLUT, isDisplayLUTActiveState),
        menuItem("Display ICC Active", "", "", ~toggleDisplayICC, isDisplayICCActiveState),
        menuSeparator(),
        menuItem("Display Brightness (Interactive)", "", "", brightnessMode, checkForDisplayColor()),
        menuSeparator(),
        subMenu("Matte", MenuItem[] {
            menuItem("No Matte", "", "", ~setMatte(0), matteAspectState(0)),
            menuItem("1.33", "", "", ~setMatte(1.33), matteAspectState(1.33)),
            menuItem("1.66", "", "", ~setMatte(1.66), matteAspectState(1.66)),
            menuItem("1.77", "", "", ~setMatte(1.77), matteAspectState(1.77)),
            menuItem("1.85", "", "", ~setMatte(1.85), matteAspectState(1.85)),
            menuItem("2.35", "", "", ~setMatte(2.35), matteAspectState(2.35)),
            menuItem("2.40", "", "", ~setMatte(2.40), matteAspectState(2.40)),
            menuSeparator(),
            menuItem("Custom...", "", "", enterMatte, matteAspectState(-1.0))
            }),
        subMenu("Matte Opacity", MenuItem[] {
            menuItem("33%", "", "", ~setMatteOpacity(0.33), matteOpacityState(0.33)),
            menuItem("66%", "", "", ~setMatteOpacity(0.66), matteOpacityState(0.66)),
            menuItem("100%", "", "", ~setMatteOpacity(1.0), matteOpacityState(1.0)),
            menuSeparator(),
            menuItem("Custom...", "", "", enterMatteOpacity, matteOpacityState(-1.0))
        }),
        menuSeparator(),
        subMenu("Channel Display", MenuItem[] {
            menuItem("Color (All Channels)", "", "", ~showChannel(0), channelState(0)),
            menuItem("Red", "", "", ~showChannel(1), channelState(1)),
            menuItem("Green", "", "", ~showChannel(2), channelState(2)),
            menuItem("Blue", "", "", ~showChannel(3), channelState(3)),
            menuItem("Alpha", "", "", ~showChannel(4), channelState(4)),
            menuSeparator(),
            menuItem("Luminance", "", "", ~showChannel(5), channelState(5))
        }),
        subMenu("Channel Order", MenuItem[] {
            menuItem("RGBA", "", "", ~channelOrder("RGBA"), channelOrderState("RGBA")),
            menuSeparator(),
            menuItem("Custom...", "", "", enterOrder, checkForDisplayNode()),
            menuSeparator(),
            menuItem("RBGA", "", "", ~channelOrder("RBGA"), channelOrderState("RBGA")),
            menuItem("GBRA", "", "", ~channelOrder("GBRA"), channelOrderState("GBRA")),
            menuItem("GRBA", "", "", ~channelOrder("GRBA"), channelOrderState("GRBA")),
            menuItem("BRGA", "", "", ~channelOrder("BRGA"), channelOrderState("BRGA")),
            menuItem("BGRA", "", "", ~channelOrder("BGRA"), channelOrderState("BGRA")),
            menuSeparator(),
            menuItem("ABGR", "", "", ~channelOrder("ABGR"), channelOrderState("ABGR")),
            menuItem("ARGB", "", "", ~channelOrder("ARGB"), channelOrderState("ARGB")),
            menuSeparator(),
            menuItem("R00A", "", "", ~channelOrder("R00A"), channelOrderState("R00A")),
            menuItem("0G0A", "", "", ~channelOrder("0G0A"), channelOrderState("0G0A")),
            menuItem("00BA", "", "", ~channelOrder("00BA"), channelOrderState("00BA"))
        }),
        subMenu("Background", MenuItem[] {
            menuItem("Black", "", "", setBGPattern(,"black"), testBGPattern("black")),
            menuItem("18% Grey", "", "", setBGPattern(,"grey18"), testBGPattern("grey18")),
            menuItem("50% Grey", "", "", setBGPattern(,"grey50"), testBGPattern("grey50")),
            menuItem("White", "", "", setBGPattern(,"white"), testBGPattern("white")),
            menuItem("Checker", "", "", setBGPattern(,"checker"), testBGPattern("checker")),
            menuItem("Cross Hatch", "", "", setBGPattern(,"crosshatch"), testBGPattern("crosshatch"))
        }),
        menuSeparator(),
        subMenu("Dither", MenuItem[] {
            menuItem("Off", "", "", setDither(,0), testDither(0)),
            menuItem("8 Bit", "", "", setDither(,8), testDither(8)),
            menuItem("10 Bit", "", "", setDither(,10), testDither(10))
        }),
        menuSeparator(),
        menuItem("Show Out Of Range Colors", "", "", ~toggleOutOfRange, isOutOfRange),
        menuSeparator(),
        menuItem("Create/Edit Display Profiles...", "", "", ~editProfiles, displayProfilesState),
        menuSeparator(),
        menuItem("Linear Filter", "", "", ~toggleFilter, filterState),
...
\: buildMainMenu (Menu; [MenuItem] userMenus = nil)
{
    Menu exportMenu = MenuItem[] {
        ...
        menuItem("Annotated Frames...", "", "", exportAnnotatedFrames, videoSourcesExistState),
        menuItem("Audio File...", "", "", exportAs(, "*", "Audio Export"), sourcesExistState),
        menuItem("Snapshot...", "", "", exportFrame(,exportCurrentFrame), videoSourcesExistState),
        menuItem("Current Source Frame...", "", "", exportFrame(,exportCurrentSourceFrame), videoSourcesExistState),
    ...
    {
         exportMenu.push_back (menuItem("Definition of Current View Node ...", "", "", exportNodeDefinition(false,), videoSourcesExistState));
    ...
    Menu mainMenu_part1 = MenuItem[] {
        subMenu("File", MenuItem[] {
            ...
            menuItem("Open...", "", "", addMovieOrImageSources(,true,false), enabledItem),
            menuItem("Merge...", "", "", addMovieOrImageSources(,true,true), enabledItem),
            menuItem("Open into Layer...", "", "", addMovieOrImage(,addToClosestSource(,"explicit"),false), sourcesExistState),
            menuItem("Open in New Session...", "", "", openMovieOrImage, newSessionState),
            menuSeparator(),
            menuItem("Clone Session", "", "", cloneSession, newSessionState),
            menuItem("Clone RV", "", "", cloneRV, enabledItem),
            menuItem("Clone Synced RV", "", "", cloneSyncedRV, enabledItem),
            menuSeparator(),
            menuItem("Relocate Movie or Image Sequence...", "", "", relocateMovieOrImage, singleSourceState),
            menuItem("Replace Source Media...", "", "", replaceSourceMedia, singleSourceState),
            menuSeparator(),
            menuItem("Save Session", "", "", save, enabledItem),
            menuItem("Save Session As...", "", "", saveAs, enabledItem),
            menuSeparator(),
            subMenu("Import", MenuItem[] {
                menuItem("Display LUT...", "", "", openLUTFile("@RVDisplayColor"), checkForDisplayColor()),
                menuItem("Pre-Cache LUT...", "", "", openLUTFile("#RVCacheLUT"), videoSourcesAndNodeExistState("RVCacheLUT")),
                menuItem("File LUT...", "", "", openLUTFile("#RVLinearize"), videoSourcesAndNodeExistState("RVLinearize")),
                menuItem("File CDL...", "", "", openCDLFile("#RVLinearize"), videoSourcesAndNodeExistState("RVLinearize")),
                menuItem("Look LUT...", "", "", openLUTFile("#RVLookLUT"), videoSourcesAndNodeExistState("RVLookLUT")),
                menuItem("Look CDL...", "", "", openCDLFile("#RVColor"), videoSourcesAndNodeExistState("RVColor")),
                menuItem("File OTIO...", "", "", openOTIOFile(), checkForOTIOFile()),
                menuItem("Simple EDL...", "", "", ~openSimpleEDL, enabledItem)
            }),
            subMenu("Export", exportMenu),
            menuSeparator(),
            menuItem("Clear", "", "", ~clearEverything, enabledItem),
            menuItem("Close Session", "", "", queryClose, enabledItem)
        }),
        subMenu("Edit", MenuItem[] {
            ...
            //{"_", nil},
            menuItem("Mark Frame", "", "", ~toggleMark, markedState),
            menuItem("Mark Sequence Boundaries", "", "", ~markSequence, sequenceState),
            menuItem("Mark Annotated Frames", "", "", ~markAnnotatedFrames, rangeState),
            menuItem("Clear All Marks", "", "", ~clearAllMarks, hasMarksState),
            subMenu("Mark in Range", MenuItem[] {
                menuItem("Clear Range", "", "", ~clearMarksInRange, hasMarksState),
                menuSeparator(),
                menuItem("Set Range In Point", "", "", ~frameFunc(setInPoint), rangeState),
                menuItem("Set Range Out Point", "", "", ~frameFunc(setOutPoint), rangeState),
                menuItem("Reset Range", "", "", ~resetInOutPoints, rangeState),
                /*
                {"_", nil},
                ...
                */
                menuSeparator(),
                menuItem("Set Range From Marks/Boundaries", "", "", ~setInOutMarkedRange, rangeState),
                menuItem("Next Range From Marks/Boundaries", "", "", ~nextMarkedRange, rangeState),
                menuItem("Prev Range From Marks/Boundaries", "", "", ~previousMarkedRange, rangeState),
                menuItem("Expand Range From Marks/Boundaries", "", "", ~expandMarkedRange, rangeState),
                menuItem("Contract Range From Marks/Boundaries", "", "", ~contractMarkedRange, rangeState)
            }),
            menuItem("Set Range Offset", "", "", setRangeOffset, sourcesExistState)
        }),
        subMenu("Control", MenuItem[] {
            menuItem("Play", "", "", ~togglePlayFunc, playState),
            menuItem("Stop", "", "", ~stopFunc, rangeState),
            menuItem("PingPong", "", "", ~togglePingPong, pingPongState),
            menuItem("Play Once", "", "", ~togglePlayOnce, playOnceState),
            menuItem("Step Forward", "", "", ~stepForward1, rangeState),
            menuItem("Step Backward", "", "", ~stepBackward1, rangeState),
            menuItem("Reverse", "", "", ~toggleForwardsBackwards, rangeState),
            menuSeparator(),
            menuItem("Go To Frame...", "", "", enterFrame, rangeState),
            menuSeparator(),
            menuItem("Play All Frames", "", "", ~toggleRealtime, realtimeState),
                subMenu("FPS", MenuItem[] {
                    menuItem("24", "", "", ~setFPSFunc(24.0), rangeState),
                    menuItem("25", "", "", ~setFPSFunc(25.0), rangeState),
                    menuItem("23.98", "", "", ~setFPSFunc(23.98), rangeState),
                    menuItem("30", "", "", ~setFPSFunc(30.0), rangeState),
                    menuItem("29.97", "", "", ~setFPSFunc(29.97), rangeState),
                    menuSeparator(),
                    menuItem("Custom...", "", "", enterFPS, rangeState)
                }),
                menuSeparator(),
                menuItem("Play Forward", "", "", ~incN(1), forwardState),
                menuItem("Play Backward", "", "", ~incN(-1), backwardState),
                menuSeparator(),
                menuItem("Jump To Beginning", "", "", ~beginning, rangeState),
                menuItem("Jump To Ending", "", "", ~ending, rangeState),
                menuItem("Next Marked Frame", "", "", ~nextMarkedFrame, rangeState),
                menuItem("Prev Marked Frame", "", "", ~previousMarkedFrame, rangeState),
                menuItem("Matching Frame Of Next Source", "", "", ~nextMatchedFrame, rangeState),
                menuItem("Matching Frame Of Previous Source", "", "", ~previousMatchedFrame, rangeState)
            }),
            /*  
             * Moved to prefs GUI
             *
            ...
            */
            subMenu("Tools", MenuItem[] {
                ...
                menuItem("   Sequence", "", "", setCompModeAndView(nil,"defaultSequence"), viewNodeState("defaultSequence")),
                menuItem("   Replace", "", "", setCompModeAndView("replace","defaultStack"), isStackAndCompMode("replace")),
                menuItem("   Over", "", "", setCompModeAndView("over","defaultStack"), isStackAndCompMode("over")),
                menuItem("   Add", "", "", setCompModeAndView("add","defaultStack"), isStackAndCompMode("add")),
                // MenuItem {"   Dissolve", setCompModeAndView("difference","defaultStack"), nil, isStackAndCompMode("dissolve")}, 
                menuItem("   Difference", "", "", setCompModeAndView("difference","defaultStack"), isStackAndCompMode("difference")), 
                menuItem("   Difference (Inverted)", "", "", setCompModeAndView("-difference","defaultStack"), isStackAndCompMode("-difference")),
                // MenuItem {"   Picture in Picture", setCompModeAndView("pip","defaultStack"), nil, isStackAndCompMode("pip")},
                menuItem("   Tile", "", "", setCompModeAndView(nil,"defaultLayout"), viewNodeState("defaultLayout")),
                menuSeparator(),
                menuItem("Timeline", "", "", ~toggleTimeline, timelineShown),
                menuItem("Timeline Magnifier", "", "", ~toggleMotionScope, motionScopeShown),
                menuItem("Image Info", "", "", ~toggleInfo, infoShown),
                menuItem("Color Inspector", "", "", ~toggleColorInspector, colorInspectorShown),
                menuItem("Wipes", "", "", ~toggleWipe, wipeShown),
                menuItem("Info Strip", "", "", ~toggleInfoStrip, infoStripShown),
                menuItem("Process Info", "", "", ~toggleProcessInfo, processInfoShown),
                menuItem("Source Details", "", "", ~toggleSourceDetails, sourceDetailsShown),
                menuSeparator(),
                menuItem("Menu Bar", "", "", ~toggleMenuBar, menuBarShown),
                menuItem("Top View Toolbar", "", "", toggleTopViewToolbar, topTBShown),
                menuItem("Bottom View Toolbar", "", "", toggleBottomViewToolbar, botTBShown),
                menuSeparator(),
                menuItem("Force Reload Current Frame", "", "", ~reload, sourcesExistState),
                menuItem("Force Reload Region", "", "", ~reloadInOut, sourcesExistState),
                menuItem("Reload Changed Frames", "", "", ~loadCurrentSourcesChangedFrames, sourcesExistState),
                menuSeparator(),
                menuText("Cache Mode"),
                menuItem("   Look-Ahead Cache", "", "", cacheModeFunc(CacheBuffer), cacheStateFunc(CacheBuffer)),
                menuItem("   Region Cache", "", "", cacheModeFunc(CacheGreedy), cacheStateFunc(CacheGreedy)),
                menuItem("   Cache Off", "", "", cacheModeFunc(CacheOff), cacheStateFunc(CacheOff)),
                menuItem("   Release All Cached Images", "", "", ~releaseAllCachedImages, enabledItem),
                menuSeparator(),
                menuItem("Diagnostics", "", "", showDiagnosticsWindow, enabledItem),
                menuSeparator()
            }),
        subMenu("Audio", MenuItem[] {
            menuItem("Mute", "", "", ~toggleMute, isMuted),
            menuItem("Scrubbing", "", "", toggleAudioScrub, scrubAudioState),
            menuSeparator(),
            menuText("Global"),
            menuItem("   Volume", "", "", globalVolumeMode, enabledItem),
            menuItem("   Offset (seconds)", "", "", globalAudioOffsetMode, enabledItem),
            menuItem("   Offset (frames)", "", "", globalAudioOffsetFramesMode, enabledItem),
            menuItem("   Balance", "", "", globalBalanceMode, enabledItem),
            menuText("Source"),
            menuItem("   Volume", "", "", sourceVolumeMode, sourcesExistState),
            menuItem("   Offset (seconds)", "", "", sourceAudioOffsetMode, sourcesExistState),
            menuItem("   Offset (frames)", "", "", sourceAudioOffsetFramesMode, sourcesExistState),
            menuItem("   Balance", "", "", sourceBalanceMode, sourcesExistState),
            menuSeparator(),
            menuItem("   Reset All Offsets", "", "", resetAudioOffsets, enabledItem)
        }),
        subMenu("Image", MenuItem[] {
            subMenu("Color Resolution", MenuItem[] {
                    menuItem("Allow Floating Point", "", "", ~toggleFloat, isFloatAllowed),
                    menuSeparator(),
                    menuItem("Maximum Allowed", "", "", ~setBitDepthFunc(0), bitDepthState(0)),
                    menuItem("8", "", "", ~setBitDepthFunc(8), bitDepthState(8)),
                    menuItem("16", "", "", ~setBitDepthFunc(16), bitDepthState(16)),
                    menuItem("32", "", "", ~setBitDepthFunc(32), bitDepthState(32))
            }),
            subMenu("Image Resolution", MenuItem[] {
                menuItem("1.0", "", "", ~setImageResolution(1.0), imageResState(1.0)),
                menuItem("0.5", "", "", ~setImageResolution(0.5), imageResState(0.5)),
                menuItem("0.25", "", "", ~setImageResolution(0.25), imageResState(0.25)),
                menuSeparator(),
                menuItem("Custom...", "", "", enterRes, videoSourcesAndNodeExistState("RVFormat"))
            }),
            subMenu("Scale", MenuItem[] {
                menuItem("1:1", "", "", ~pixelRelativeScale(1.0), videoSourcesExistState),
                menuSeparator(),
                menuItem("2:1", "", "", ~pixelRelativeScale(2.0), videoSourcesExistState),
                menuItem("4:1", "", "", ~pixelRelativeScale(4.0), videoSourcesExistState),
                menuItem("8:1", "", "", ~pixelRelativeScale(8.0), videoSourcesExistState),
                menuSeparator(),
                menuItem("1:2", "", "", ~pixelRelativeScale(1.0/2.0), videoSourcesExistState),
                menuItem("1:4", "", "", ~pixelRelativeScale(1.0/4.0), videoSourcesExistState),
                menuItem("1:8", "", "", ~pixelRelativeScale(1.0/8.0), videoSourcesExistState)
            }),
            subMenu("Rotation", MenuItem[] {
                menuItem("No Rotation", "", "", ~rotateImage(0.0, false), rotateState(0.0)),
                menuItem("90 Clockwise", "", "", ~rotateImage(90.0, false), rotateState(90.0)),
                menuItem("90 Counter-Clockwise", "", "", ~rotateImage(-90.0, false), rotateState(-90.0)),
                menuItem("180", "", "", ~rotateImage(180.0, true), rotateState(180.0)),
                menuSeparator(),
                menuItem("+90 Clockwise", "", "", ~rotateImage(90.0, true), videoSourcesAndNodeExistState("RVTransform2D")),
                menuItem("+90 Counter-Clockwise", "", "", ~rotateImage(-90.0, true), videoSourcesAndNodeExistState("RVTransform2D")),
                menuSeparator(),
                menuItem("Arbitrary (Rotate Mode)", "", "", rotateMode, videoSourcesAndNodeExistState("RVTransform2D"))
            }),
            subMenu("Alpha Type", MenuItem[] {
                menuItem("From Image", "", "", ~alphaTypeFunc(0), alphaTypeState(0)),
                menuSeparator(),
                menuItem("Unpremultiplied", "", "", ~alphaTypeFunc(2), alphaTypeState(2)),
                menuItem("Premultiplied", "", "", ~alphaTypeFunc(1), alphaTypeState(1))
            }),
            subMenu("Pixel Aspect Ratio", MenuItem[] {
                menuItem("From Image", "", "", ~pixelAspectFunc(0.0), aspectState(0.0)),
                menuSeparator(),
                menuItem("Square", "", "", ~pixelAspectFunc(1.0), aspectState(1.0)),
                menuItem("NTSC D1 DV  4:3", "", "", ~pixelAspectFunc(0.9), aspectState(0.9)),
                menuItem("NTSC D1 DV  16:9", "", "", ~pixelAspectFunc(1.2), aspectState(1.2)),
                menuItem("PAL  4:3", "", "", ~pixelAspectFunc(1.06666), aspectState(1.0666)),
                menuItem("PAL  16:9", "", "", ~pixelAspectFunc(1.422), aspectState(1.422)),
                menuItem("Anamorphic  2:1", "", "", ~pixelAspectFunc(2.0), aspectState(2.0)),
                menuSeparator(),
                menuItem("Custom...", "", "", enterPixAspect, videoSourcesAndNodeExistState("RVLensWwarp"))
            }),
            subMenu("Stereo", MenuItem[] {
                menuItem("Swap Eyes", "", "", ~toggleSourceSwapEyes, propToggledAndStereoOnState("#RVSourceStereo.stereo.swap")),
                menuItem("Flip Right Eye", "", "", ~toggleSourceRFlip, propToggledAndStereoOnState("#RVSourceStereo.rightTransform.flip")),
                menuItem("Flop Right Eye", "", "", ~toggleSourceRFlop, propToggledAndStereoOnState("#RVSourceStereo.rightTransform.flop")),
                menuSeparator(),
                menuText("Interactive Edit"),
                menuItem("    Relative Eye Offset (%)", "", "", sourceStereoOffsetMode, eyeOffsetState),
                menuItem("    Right Eye Only Offset (%)", "", "", sourceStereoROffsetMode, eyeOffsetState)
            }),
            menuSeparator(),
            menuItem("Flip", "", "", ~toggleFlip, toggleFlipState),
            menuItem("Flop", "", "", ~toggleFlop, toggleFlopState),
            menuSeparator(),
            menuItem("Remap Source Image Channels...", "", "", enterChanMap, videoSourcesAndNodeExistState("RVChannelMap")),
            menuSeparator(),
            menuItem("Set Source FPS...", "", "", enterSourceFPS, sourcesExistState),
            menuSeparator(),
            menuItem("Cycle Stack Forward", "", "", cycleStackForward, isStackMode),
            menuItem("Cycle Stack Backward", "", "", cycleStackBackward, isStackMode)
        }),
        subMenu("Color", MenuItem[] {
            subMenu("Luminance Look Up Table", MenuItem[] {
                menuItem("Active", "", "", ~toggleLuminanceLUT, isLuminanceLUTActiveState),
                menuSeparator(),
                menuText("Luminance LUTS"),
                menuItem("   HSV ", "", "", ~HSVLUT, luminanceLUTState("HSV")),
                menuItem("   Contour 3", "", "", ~contourLUT(3), luminanceLUTState("Contour 3")),
                menuItem("   Contour 4", "", "", ~contourLUT(4), luminanceLUTState("Contour 4")),
                menuItem("   Contour 6", "", "", ~contourLUT(6), luminanceLUTState("Contour 6")),
                menuItem("   Contour 10", "", "", ~contourLUT(10), luminanceLUTState("Contour 10")),
                menuItem("   Contour 20", "", "", ~contourLUT(20), luminanceLUTState("Contour 20")),
                menuItem("   Contour 100", "", "", ~contourLUT(100), luminanceLUTState("Contour 100")),
                menuItem("   Random", "", "", ~randomLUT, luminanceLUTState("Random"))
            }),
                    //
...
=======
            ...
            menuItem("   Cineon/DPX Log", "", "", setLinConvert("Cineon Log"), hasLinConversion("Cineon Log")),
            menuItem("   ALEXA LogC", "", "", setLinConvert("ALEXA LogC"), hasLinConversion("ALEXA LogC")),
            menuItem("   ALEXA LogC Film", "", "", setLinConvert("ALEXA LogC Film"), hasLinConversion("ALEXA LogC Film")),
            // MenuItem {"   SONY S-Log",       setLinConvert("SONY S-Log"), nil, hasLinConversion("SONY S-Log")},
            menuItem("   Viper Log", "", "", setLinConvert("Viper Log"), hasLinConversion("Viper Log")),
            menuItem("   Red Log", "", "", setLinConvert("Red Log"), hasLinConversion("Red Log")),
            ...
            menuSeparator(),
            menuItem("Pre-Cache LUT", "", "", ~toggleCacheLUT, isCacheLUTActiveState),
            menuItem("File LUT", "", "", ~toggleFileLUT, isFileLUTActiveState),
            menuItem("File CDL", "", "", ~toggleFileCDL, isFileCDLActiveState),
            menuItem("File ICC", "", "", ~toggleFileICC, isFileICCActiveState),
            menuItem("Look LUT", "", "", ~toggleLookLUT, isLookLUTActiveState),
            menuItem("Look CDL", "", "", ~toggleLookCDL, isLookCDLActiveState),
            menuSeparator(),
            menuItem("Invert", "", "", ~toggleInvert, isInvert),
            //  RVHistogram node deprecated to remove from GUI for now
            // MenuItem {"Normalize", toggleNormalizeColor, nil, isNormalizingColor},
            menuSeparator(),
            menuText("Interactive Edit"),
            menuItem("    Gamma", "", "", gammaMode, videoSourcesAndNodeExistState("RVColor")),
            menuItem("    Color Offset", "", "", colorOffsetMode, videoSourcesAndNodeExistState("RVColor")),
            menuItem("    Exposure", "", "", exposureMode, videoSourcesAndNodeExistState("RVColor")),
            menuItem("    Saturation", "", "", saturationMode, videoSourcesAndNodeExistState("RVColor")),
            menuItem("    Hue", "", "", hueMode, videoSourcesAndNodeExistState("RVColor")),
            menuItem("    Contrast", "", "", contrastMode, videoSourcesAndNodeExistState("RVColor")),
            menuSeparator(),
            ...
            menuItem("Reset All Color", "", "", ~resetAllColorParameters, videoSourcesAndNodeExistState("RVColor"))
        }),
