    ...
    method: MotionScope (MotionScope; string name, timeline.Timeline t)
    {
        ...
        init(name,
             [ ("pointer-1--push", makeCategoryEventFunc("playcontrol_category", clickFunction(,setFrameOrNudge)), "Set Frame On Magnifier"),
               ...
               ("pointer-1--shift--push", makeCategoryEventFunc("mark_category", clickFunction(,setInOutPointDelayed("in",,,))), "Set In Point on Magnifier"),
               ("pointer-1--shift--drag", makeCategoryEventFunc("mark_category", clickFunction(,setInOutPointDelayed("out",,,))), "Select In/Out Region on Magnifier"),
               ...
               ("stylus-pen--push", makeCategoryEventFunc("playcontrol_category", clickFunction(,setFrameOrNudge)), "Set Frame On Timeline"),
               ("stylus-pen--drag", makeCategoryEventFunc("playcontrol_category", clickFunction(,scrubSetFrame)), "Drag Frame On Timeline"),
               ("stylus-pen--move", handleMotion, ""),
               ("stylus-pen--release", release, ""),
               ("stylus-eraser--push", makeCategoryEventFunc("playcontrol_category", clickFunction(,setFrameOrNudge)), "Set Frame On Timeline"),
               ("stylus-eraser--drag", makeCategoryEventFunc("playcontrol_category", clickFunction(,scrubSetFrame)), "Drag Frame On Timeline"),
