...
def generate_about_cpp(
    ...
    html_content.append("included with this distribution or visit the Visto GitHub repository.")
    html_content.append("</p>")
...
const char* about_Visto = "{html_str}";
'''
...
if __name__ == "__main__":
    ...
    parser.add_argument("app_name", nargs="?", default="Visto", help="Application name")
