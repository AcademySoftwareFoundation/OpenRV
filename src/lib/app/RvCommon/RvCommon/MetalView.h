...
namespace Rv
{
    ...
    public:
        ...
        //  it is driven (rendered to and presented) by a MetalDesktopVideoDevice
        ...
        explicit MetalView(RvDocument* doc, QWidget* parent = nullptr, bool noResize = true, bool presentationMode = false);
        ~MetalView();
