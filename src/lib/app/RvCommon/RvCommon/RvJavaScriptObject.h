...
class RvJavaScriptObject : public QObject, public TwkApp::EventNode
{
    Q_OBJECT
  ...
  signals:
    ...
    void eventString(const QString& eventName, 
                     const QString& contents,
                     const QString& senderName);

    void eventKey(const QString& eventName, 
                  unsigned int key,
                  unsigned int modifiers);

    void eventPointer(const QString& eventName,
                      int x, int y, int w, int h,
                      int startX, int startY,
                      int buttonStates,
                      float activationTime);

    void eventDragDrop(const QString& eventName,
                       int x, int y, int w, int h,
                       int startX, int startY,
                       int buttonStates,
