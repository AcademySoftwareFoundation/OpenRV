...
class RvPreferences: public QDialog, public PackageManager
{
    Q_OBJECT
...
private:
	...
	bool initAudioDeviceMenu(IPCore::AudioRenderer::RendererParameters &params,
                             const IPCore::AudioRenderer::DeviceVector &devices,
							 const std::string &currentDeviceName);

	bool initAudioLayoutMenu(IPCore::AudioRenderer::RendererParameters &params,
							 const IPCore::AudioRenderer::LayoutsVector &layouts,
                             const IPCore::AudioRenderer::Layout &currentLayout);

	bool initAudioFormatMenu(IPCore::AudioRenderer::RendererParameters &params,
							 const IPCore::AudioRenderer::FormatVector &formats,
                             const IPCore::AudioRenderer::Format &currentFormat);

	bool initAudioRatesMenu(IPCore::AudioRenderer::RendererParameters &params,
...
class ScrollEventEater : public QObject
{
  ...
  public:
    ScrollEventEater (QObject *obj) : QObject(obj) {}
