...
QPixmap 
colorAdjustedPixmap(const QString& rpath, bool invertSense)
{
...
QIcon 
colorAdjustedIcon(const QString& rpath, bool invertSense)
{
    const char* darkval = getenv("RV_DARK");
    bool dark = darkval && !strcmp(darkval, "1");
...
void
installApplicationPalette()
{
    QPalette p = qApp->palette();
    p.setColor(QPalette::Active, QPalette::WindowText,      QColor(217, 217, 197));
    ...
    p.setColor(QPalette::Active, QPalette::Highlight,       QColor(117, 117, 112));
    p.setColor(QPalette::Active, QPalette::HighlightedText, QColor(248, 248, 227));
    p.setColor(QPalette::Active, QPalette::Link,            QColor(0, 0, 238));
    p.setColor(QPalette::Active, QPalette::LinkVisited,     QColor(82, 24, 139));
    p.setColor(QPalette::Active, QPalette::AlternateBase,   QColor(65, 69, 65));
    ...
    p.setColor(QPalette::Active, QPalette::ButtonText,      QColor(234, 234, 213));
    ...
    //p.setColor(QPalette::Disabled, QPalette::Highlight,       QColor(117, 117, 112));
    ...
    p.setColor(QPalette::Disabled, QPalette::LinkVisited,     QColor(82, 24, 139));
    p.setColor(QPalette::Disabled, QPalette::AlternateBase,   QColor(65, 69, 65));
    p.setColor(QPalette::Disabled, QPalette::Light,           QColor(106, 106, 106));
    p.setColor(QPalette::Disabled, QPalette::Midlight,        QColor(124, 124, 124));
    ...
    p.setColor(QPalette::Inactive, QPalette::WindowText,      QColor(217, 217, 197));
    ...
    p.setColor(QPalette::Inactive, QPalette::HighlightedText, QColor(128, 128, 128));
    p.setColor(QPalette::Inactive, QPalette::Link,            QColor(0, 0, 238));
    p.setColor(QPalette::Inactive, QPalette::LinkVisited,     QColor(82, 24, 139));
    p.setColor(QPalette::Inactive, QPalette::AlternateBase,   QColor(65, 69, 65));
    p.setColor(QPalette::Inactive, QPalette::Light,           QColor(106, 106, 106));
    p.setColor(QPalette::Inactive, QPalette::Midlight,        QColor(124, 124, 124));
    ...
    p.setColor(QPalette::Inactive, QPalette::ButtonText,      QColor(234, 234, 213));
...
dumpApplicationPalette()
{
    ...
    for (int i=0; i < 17; i++)
    {
        ...
        cout << "p.setColor(QPalette::Active, (QPalette::ColorRole)" 
             << i << ", QColor("
             << r << ", " << g << ", " << b << "));" << endl;
        ...
        cout << "p.setColor(QPalette::Inactive, (QPalette::ColorRole)" 
             << i << ", QColor("
             << r << ", " << g << ", " << b << "));" << endl;
        ...
        cout << "p.setColor(QPalette::Disabled, (QPalette::ColorRole)" 
             << i << ", QColor("
             << r << ", " << g << ", " << b << "));" << endl;
