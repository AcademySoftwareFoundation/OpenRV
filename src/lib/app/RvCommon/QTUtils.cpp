...
namespace Rv
{
    ...
    void dumpApplicationPalette()
    {
        ...
        for (int i = 0; i < 17; i++)
        {
            ...
            cout << "p.setColor(QPalette::Active, (QPalette::ColorRole)" << i << ", QColor(" << r << ", " << g << ", " << b << "));"
                 << endl;
            ...
            cout << "p.setColor(QPalette::Inactive, (QPalette::ColorRole)" << i << ", QColor(" << r << ", " << g << ", " << b << "));"
                 << endl;
            ...
            cout << "p.setColor(QPalette::Disabled, (QPalette::ColorRole)" << i << ", QColor(" << r << ", " << g << ", " << b << "));"
                 << endl;
        }
    }
