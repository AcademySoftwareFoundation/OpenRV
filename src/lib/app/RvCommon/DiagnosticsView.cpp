...
namespace Rv
{
    ...
    void DiagnosticsView::applyStyle()
    {
        ...
        colors[ImGuiCol_Tab] = ImVec4(0.25f, 0.25f, 0.25f, 1.00f);                   // Inactive tab
        colors[ImGuiCol_TabHovered] = ImVec4(0.7f, 0.7f, 0.7f, 1.00f);               // Hover effect for tab
        colors[ImGuiCol_TabActive] = ImVec4(0.5f, 0.5f, 0.5f, 1.00f);                // Active tab color
        ...
        ImGui::GetIO().Fonts->AddFontFromMemoryCompressedTTF(Roboto_Regular_compressed_data, Roboto_Regular_compressed_size, 13, &fontCfg);
    }
    ...
    void DiagnosticsView::showHelpWindow()
    {
        ...
        ImGui::TextWrapped("");
        ImGui::TextWrapped("Adding your own diagnostics info is quick and easy, much easier "
                           "than building your own Qt user interface.");
        ImGui::TextWrapped("From your Python plugin, you simply need to register a "
                           "diagnostics callback, and from the callback, call ImGui/ImPlot "
                           "functions to display your data.");
        ImGui::TextWrapped("Note that there is no need to implement backends for handling "
        ...
        ImGui::TextWrapped("   commands.register_diagnostics_callback( self.my_callback )");
        ImGui::TextWrapped("");
        ImGui::TextWrapped("def __del__( self ):");
        ImGui::TextWrapped("   commands.unregister_diagnostics_callback( self.my_callback )");
        ImGui::TextWrapped("");
        ...
        ImGui::SameLine();
        ImGui::TextLinkOpenURL("ImGui Python bindings", "https://github.com/pthom/imgui_bundle/blob/"
                                                        "main/external/imgui/bindings/pybind_imgui.cpp");
        ImGui::TextLinkOpenURL("ImPlot", "https://github.com/pthom/implot");
        ImGui::SameLine();
        ImGui::TextWrapped("and");
        ImGui::SameLine();
        ImGui::TextLinkOpenURL("ImPlot Python bindings", "https://github.com/pthom/imgui_bundle/blob/main/external/implot/"
        ...
        ImGui::TextLinkOpenURL("here (ImGui)", "https://github.com/pthom/imgui_bundle/blob/main/bindings/"
                                               "imgui_bundle/demos_python/demos_immapp/imgui_demo.py");
        ImGui::SameLine();
        ImGui::TextWrapped("and");
        ImGui::SameLine();
        ImGui::TextLinkOpenURL("here (ImPlot)", "https://github.com/pthom/imgui_bundle/blob/main/bindings/"
                                                "pyodide_web_demo/examples/demo_implot_stock.py");
        ImGui::TextWrapped("");
        ImGui::TextWrapped("Finally, several good additional resources for ImGui and its "
        ...
        ImGui::SameLine();
        ImGui::TextLinkOpenURL("here", "https://pthom.github.io/imgui_manual_online/"
