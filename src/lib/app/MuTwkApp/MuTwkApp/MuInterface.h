...
std::string muEval(Mu::MuLangContext*,
                   Mu::Process*,
...
std::string muEvalStringExpr(Mu::MuLangContext*,
                             Mu::Process*,
                             const Mu::Context::ModuleList& modules,
                             const char* line,
                             const char* contextName="eval");
...
void batch(Mu::MuLangContext*,
           Mu::Process*,
           const Mu::Context::ModuleList&,
           const char* filename);

void initMu(const char* batchfile, GCFilterFunc F = 0);

void initWithFile(Mu::MuLangContext*,
                  Mu::Process*,
                  const Mu::Context::ModuleList&,
                  const char* filename);

void initWithString(Mu::MuLangContext*,
                    Mu::Process*,
                    const Mu::Context::ModuleList&,
                    const char* buffer);

void initRc(Mu::MuLangContext*,
            Mu::Process*,
            const Mu::Context::ModuleList&,
            const char* rcfile);
