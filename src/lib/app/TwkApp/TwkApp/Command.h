...
class CommandHistory
{
  public:
    ...
    void clearHistory() { clearUndoHistory(); clearRedoHistory(); }
...
template <class T>
T* 
CommandHistory::newCommand(const std::string& n)
{
...
class CompoundCommand : public Command, public CommandHistory
{
public:
...
public:
    ...
    void setArgs(const std::string& n, bool unique=true) { m_name = n; m_unique = unique; }
