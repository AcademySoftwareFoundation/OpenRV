...
Selection*
SelectionState::selection(const std::string &name, bool createIfNotThere)
{
...
Selection*
SelectionState::selection(const SelectionType *t, bool createIfNotThere)
{
    for (int i=0; i < m_selections.size(); i++)
    {
...
const Selection*
SelectionState::selection(const std::string &name) const
{
    return const_cast<SelectionState*>(this)->selection(name);
}

void 
SelectionState::set(Selection *sel)
{
    if (sel)
    {
        for (int i=0; i < m_selections.size(); i++)
