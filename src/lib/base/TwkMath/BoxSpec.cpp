...
float Box<Vec2f>::size( Box<Vec2f>::size_type i ) const
{
    ...
    else if ( min[i] == Math<float>::min() &&
              max[i] == Math<float>::max() )
    {
        // infinite
...
double Box<Vec2d>::size( Box<Vec2d>::size_type i ) const
{
    ...
    else if ( min[i] == Math<double>::min() &&
              max[i] == Math<double>::max() )
    {
        // infinite
