...
template <typename T>
inline bool
Plane<T>::less(const Point& a, const Point& b)
{
...
template <typename  T>
inline void
Plane<T>::set(const typename Plane<T>::Point& p, 
...
template <typename T>
inline
Plane<T>::Plane(const typename Plane<T>::Point &p,
		const typename Plane<T>::Vec &v)
{
    set(p,v);
}
...
template <typename T>
void
Plane<T>::set(typename Plane<T>::Point a,
	      typename Plane<T>::Point b,
...
template <typename T>
inline
Plane<T>::Plane(const typename Plane<T>::Point &a,
...
template <typename T>
inline T 
Plane<T>::distanceTo(const typename Plane<T>::Point &p) const
{
...
template <typename T>
inline T 
Plane<T>::intersectionU(const typename Plane<T>::LineT &line) const
{
...
template <typename T>
inline bool
Plane<T>::parallel(const typename Plane<T>::LineT &line) const
{
...
template <typename T>
inline bool
Plane<T>::parallel(const Plane<T> &plane) const
{
    //
...
template <typename T>
inline bool 
operator== (const Plane<T> &a, const Plane<T> &b)
{
