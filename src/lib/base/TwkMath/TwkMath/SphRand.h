...
{
public:
    SphRandGenerator(RANDGEN& rng) : SphRand<RANDGEN,VEC>(rng) {}
    SphRandGenerator(RANDGEN* rng) : SphRand<RANDGEN,VEC>(rng) {}
...
{
public:
    NormalizedSphRandGenerator(RANDGEN& rng) : SphRand<RANDGEN,VEC>(rng) {}
    NormalizedSphRandGenerator(RANDGEN* rng) : SphRand<RANDGEN,VEC>(rng) {}
