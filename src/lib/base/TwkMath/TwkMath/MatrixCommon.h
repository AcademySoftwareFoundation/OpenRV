...
//******************************************************************************
template <typename T>
inline T determinant2x2( const T m00, const T m01,
...
//******************************************************************************
template <typename T>
inline T determinant3x3( const T m00, const T m01, const T m02,
...
{
    // Get cofactors..
    const T A00 = determinant3x3( m11, m12, m13,
                                  m21, m22, m23,
                                  m31, m32, m33 );
    const T A01 = -T1 * determinant3x3( m10, m12, m13,
                                        m20, m22, m23,
                                        m30, m32, m33 );
    const T A02 = determinant3x3( m10, m11, m13,
                                  m20, m21, m23,
                                  m30, m31, m33 );
    const T A03 = -T1 * determinant3x3( m10, m11, m12,
                                        m20, m21, m22,
                                        m30, m31, m32 );
...
//******************************************************************************
template <typename T>
void invert3x3( T &m00, T &m01, T &m02,
                T &m10, T &m11, T &m12,
                T &m20, T &m21, T &m22 )
{
    // Get determinant
    const T det = determinant3x3( m00, m01, m02,
                                  m10, m11, m12,
                                  m20, m21, m22 );
    if ( det == T0 )
    {
