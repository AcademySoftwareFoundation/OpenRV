...
template <typename T>
class Rand48Generator : public Rand48
{
public:
    Rand48Generator() : Rand48() {}
    Rand48Generator(unsigned long seed) : Rand48(seed) {}
...
template <> 
inline unsigned int 
Rand48Generator<unsigned int>::operator()() 
{ 
    return nextULong(); 
}
...
template <>
inline short
Rand48Generator<short>::operator()() 
{ 
...
Rand48Generator<unsigned short>::operator()() 
{ 
