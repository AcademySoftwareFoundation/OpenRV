    ...
    else
    {
        ...
        else
        {
            ...
            if ( ceilAoverPi <= BoverPi )
            {
                ...
                {
                    return Interval<T>( std::min( cosa, cosb ),
                                        (T)1 );
                }
                else
                {
...
//******************************************************************************
template <typename T>
inline Interval<T> sin( const Interval<T> &a )
{
    assert( a.isValid() );
    ...
    else
    {
        ...
        return cos( Interval<T>( a.min - piOver2,
                                 a.max - piOver2 ) );
    }
}
...
//******************************************************************************
template <typename T>
inline Interval<T> abs( const Interval<T> &a )
{
    assert( a.isValid() );
    ...
    {
        return Interval<T>( (T)0,
                            std::max( Math<T>::abs( a.min ),
                                      Math<T>::abs( a.max ) ) );
    }
    else
    {
        // The constructor will flip them around if necessary
        return Interval<T>( Math<T>::abs( a.min ),
                            Math<T>::abs( a.max ) );
    }
}
...
//******************************************************************************
template <typename T>
inline Interval<T> sqr( const Interval<T> &a )
{
    assert( a.isValid() );
