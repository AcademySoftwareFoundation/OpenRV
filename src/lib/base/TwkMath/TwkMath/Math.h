...
//******************************************************************************
template <typename T>
inline const T &STD_MIN( const T &x, const T &y )
{
    return ( x < y ? x : y );
}
...
//******************************************************************************
template <typename T>
inline const T &STD_MAX( const T &x, const T &y )
{
    return ( x < y ? y : x );
}
...
//******************************************************************************
template <typename T>
inline T Math<T>::acos( const T &a )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::asin( const T &a )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::atan( const T &a )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::atan2( const T &y, const T &x )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::cbrt( const T &a )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::ceil( const T &a )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::cosh( const T &a )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::degToRad( const T &deg )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::floor( const T &a )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::hypot( const T &x, const T &y )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::log10( const T &a )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::mod( const T &numer, const T &denom )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::pow( const T &body, const T &expon )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::radToDeg( const T &rad )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::round( const T &dec )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::sign( const T &a )
{
    if ( a < ( T )0 )
    {
        return ( T )-1;
...
//******************************************************************************
template <typename T>
inline T Math<T>::sinh( const T &a )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::sqrt( const T &a )
{
...
//******************************************************************************
template <typename T>
inline T Math<T>::tanh( const T &a )
{
...
#ifdef TWK_NO_FLOAT_INTRINSICS
template <>
inline float Math<float>::abs( const float &a )
{
    return ::fabs( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::acos( const float &a )
{
    return ::acos( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::asin( const float &a )
{
    return ::asin( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::atan( const float &a )
{
    return ::atan( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::atan2( const float &y, const float &x )
{
    return ::atan2( y, x );
}
...
//******************************************************************************
template <>
inline float Math<float>::cbrt( const float &a )
{
    return ::cbrt( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::ceil( const float &a )
{
    return ::ceil( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::cos( const float &a )
{
    return ::cos( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::cosh( const float &a )
{
    return ::cosh( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::exp( const float &a )
{
    return ::exp( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::floor( const float &a )
{
    return ::floor( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::hypot( const float &x, const float &y )
{
...
//******************************************************************************
template <>
inline float Math<float>::log( const float &a )
{
    return ::log( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::log10( const float &a )
{
    return ::log10( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::sin( const float &a )
{
    return ::sin( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::sinh( const float &a )
{
    return ::sinh( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::sqrt( const float &a )
{
    return ::sqrt( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::tan( const float &a )
{
    return ::tan( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::tanh( const float &a )
{
    return ::tanh( a );
}
...
//******************************************************************************
template <>
inline float Math<float>::degToRad( const float &deg )
{
...
//******************************************************************************
template <>
inline float Math<float>::radToDeg( const float &rad )
{
...
//******************************************************************************
template <>
inline char Math<char>::abs( const char &v )
{
    return ( v < 0 ) ? -v : v;
}
...
//******************************************************************************
template <>
inline char Math<char>::ceil( const char &v )
{
    return v;
}
...
//******************************************************************************
template <>
inline char Math<char>::floor( const char &v )
{
    return v;
}
...
//******************************************************************************
template <>
inline short Math<short>::abs( const short &v )
{
    return ( v < 0 ) ? -v : v;
}
...
//******************************************************************************
template <>
inline short Math<short>::ceil( const short &v )
{
    return v;
}
...
//******************************************************************************
template <>
inline short Math<short>::floor( const short &v )
{
    return v;
}
...
//******************************************************************************
template <>
inline int Math<int>::abs( const int &v )
{
    return ( v < 0 ) ? -v : v;
}
...
//******************************************************************************
template <>
inline int Math<int>::ceil( const int &v )
{
    return v;
}
...
//******************************************************************************
template <>
inline int Math<int>::floor( const int &v )
{
    return v;
}
...
//******************************************************************************
template <>
inline int Math<int>::mod( const int &numer, const int &denom )
{
    return numer % denom;
}
...
//******************************************************************************
template <>
inline long Math<long>::abs( const long &v )
{
    return ( v < 0 ) ? -v : v;
}
...
//******************************************************************************
template <>
inline long Math<long>::ceil( const long &v )
{
    return v;
}
...
//******************************************************************************
template <>
inline long Math<long>::floor( const long &v )
{
    return v;
}
...
// unsigned char
template <>
inline unsigned char Math<unsigned char>::min()
{
    return 0;
}
...
//******************************************************************************
template <>
inline unsigned char Math<unsigned char>::max()
{
    return UCHAR_MAX;
}
...
//******************************************************************************
template <>
inline unsigned char Math<unsigned char>::epsilon()
{
    return 1;
}
...
//******************************************************************************
template <>
inline bool Math<unsigned char>::isFloat()
{
    return false;
}
...
//******************************************************************************
template <>
inline short Math<short>::epsilon()
{
    return 1;
}
...
//******************************************************************************
template <>
inline bool Math<short>::isFloat()
{
    return false;
}
...
// unsigned short
template <>
inline unsigned short Math<unsigned short>::min()
{
    return 0;
}
...
//******************************************************************************
template <>
inline unsigned short Math<unsigned short>::max()
{
    return USHRT_MAX;
}
...
//******************************************************************************
template <>
inline unsigned short Math<unsigned short>::epsilon()
{
    return 1;
}
...
//******************************************************************************
template <>
inline bool Math<unsigned short>::isFloat()
{
    return false;
}
...
// unsigned int
template <>
inline unsigned int Math<unsigned int>::min()
{
    return 0;
}
...
//******************************************************************************
template <>
inline unsigned int Math<unsigned int>::max()
{
    return UINT_MAX;
}
...
//******************************************************************************
template <>
inline unsigned int Math<unsigned int>::epsilon()
{
    return 1;
}
...
//******************************************************************************
template <>
inline bool Math<unsigned int>::isFloat()
{
    return false;
}
...
// unsigned long
template <>
inline unsigned long Math<unsigned long>::min()
{
    return 0;
}
...
//******************************************************************************
template <>
inline unsigned long Math<unsigned long>::max()
{
    return ULONG_MAX;
}
...
//******************************************************************************
template <>
inline unsigned long Math<unsigned long>::epsilon()
{
    return 1;
}
...
//******************************************************************************
template <>
inline bool Math<unsigned long>::isFloat()
{
    return false;
}
...
//******************************************************************************
template <>
inline bool Math<float>::isFloat()
{
    return true;
}
...
//******************************************************************************
template <>
inline bool Math<double>::isFloat()
{
    return true;
}
