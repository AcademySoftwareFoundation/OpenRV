...
//******************************************************************************
template <typename T>
inline bool abovePlane( const Vec3<T> &v0,
                        const Vec3<T> &v1,
                        const Vec3<T> &v2,
                        const Vec3<T> &p )
{
...
//******************************************************************************
template <typename T>
inline bool aboveOrOnPlane( const Vec3<T> &v0,
                            const Vec3<T> &v1,
                            const Vec3<T> &v2,
                            const Vec3<T> &p )
{
...
//******************************************************************************
template <typename T>
inline bool belowPlane( const Vec3<T> &v0,
                        const Vec3<T> &v1,
                        const Vec3<T> &v2,
                        const Vec3<T> &p )
{
...
//******************************************************************************
template <typename T>
inline bool belowOrOnPlane( const Vec3<T> &v0,
                            const Vec3<T> &v1,
                            const Vec3<T> &v2,
                            const Vec3<T> &p )
{
...
//******************************************************************************
template <typename T>
inline bool onPlane( const Vec3<T> &v0,
                     const Vec3<T> &v1,
                     const Vec3<T> &v2,
                     const Vec3<T> &p )
{
