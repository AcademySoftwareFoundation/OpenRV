...
public:
    ...
    explicit Mat22( const T &val ) :
      m00( val ), m01( val ), m10( val ), m11( val ) {}

    // Direct constructor. Initializes elements directly
    Mat22( const T &v00, const T &v01,
    ...
    explicit Mat22( const T array[] ) :
      m00( array[0] ), m01( array[1] ), m10( array[2] ), m11( array[3] ) {}
    ...
    Mat22( const Mat22<T2> &copy ) :
      m00( copy.m00 ), m01( copy.m01 ), m10( copy.m10 ), m11( copy.m11 ) {}
    ...
    { m00 = val; m01 = val; m10 = val; m11 = val; return *this; }

    // Assignment from a Mat22 of a different type
    template <typename T2>
    Mat22<T> &operator=( const Mat22<T2> &copy )
    {
        m00 = copy.m00;
        m01 = copy.m01;
        m10 = copy.m10;
    ...
    void set( const T &v00, const T &v01,
              const T &v10, const T &v11 )
    { m00 = v00; m01 = v01; m10 = v10; m11 = v11; }
...
//******************************************************************************
template <typename T>
inline Mat22<T> Mat22<T>::transposed() const
{
...
//******************************************************************************
template <typename T>
inline T Mat22<T>::determinant() const
{
...
//******************************************************************************
template <typename T>
inline Mat22<T> Mat22<T>::inverted() const
{
    Mat22<T> ret( *this );
    ret.invert();
    return ret;
...
//******************************************************************************
template <typename T>
inline Mat22<T> &Mat22<T>::operator*=( const T &v )
{
    m00 *= v;
    m01 *= v;
    m10 *= v;
...
//******************************************************************************
template <typename T>
Mat22<T> &Mat22<T>::operator*=( const Mat22<T> &v )
{
...
//******************************************************************************
template <typename T>
inline void makeIdentity( Mat22<T> &m )
{
    m.makeIdentity();
}
...
//******************************************************************************
template <typename T>
inline void transpose( Mat22<T> &m )
{
    m.transpose();
}
...
//******************************************************************************
template <typename T>
inline Mat22<T> transposed( const Mat22<T> &m )
{
    return m.transposed();
}
...
//******************************************************************************
template <typename T>
inline T determinant( const Mat22<T> &m )
{
...
//******************************************************************************
template <typename T>
inline Mat22<T> inverted( const Mat22<T> &m )
{
    return m.inverted();
}
...
template <typename T>
inline Mat22<T> operator+( const Mat22<T> &a,
                           const Mat22<T> &b )
{
    return Mat22<T>( a.m00 + b.m00,
                     a.m01 + b.m01,
                     a.m10 + b.m10,
                     a.m11 + b.m11 );
}
...
//******************************************************************************
template <typename T>
inline Mat22<T> operator*( const T &a,
                           const Mat22<T> &b )
{
    return Mat22<T>( a * b.m00,
                     a * b.m01,
                     a * b.m10,
                     a * b.m11 );
}
...
//******************************************************************************
template <typename T>
inline Vec2<T> operator*( const Mat22<T> &m,
                          const Vec2<T> &v )
{
...
//******************************************************************************
template <typename T>
inline bool operator==( const Mat22<T> &a,
                        const Mat22<T> &b )
{
    return ( ( a.m00 == b.m00 ) &&
             ( a.m01 == b.m01 ) &&
