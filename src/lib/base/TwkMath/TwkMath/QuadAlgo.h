...
namespace TwkMath
{
    ...
    //-*****************************************************************************
    //-*****************************************************************************
    template <class VEC, class VEC2> inline VEC quadMap(const VEC& p00, const VEC& p10, const VEC& p11, const VEC& p01, VEC2& uv)
    {
    ...
    {
    public:
        UvStQuadInverter(const Vec2<T>& p00, const Vec2<T>& p10, const Vec2<T>& p11, const Vec2<T>& p01);
    ...
    //-*****************************************************************************
    template <typename T>
    BoolAndVec2<T> quadInverseMap(const Vec2<T>& p00, const Vec2<T>& p10, const Vec2<T>& p11, const Vec2<T>& p01, const Vec2<T>& p);

    //-*****************************************************************************
    template <typename T>
    void quadInverseMap(const Vec2<T>& p00, const Vec2<T>& p10, const Vec2<T>& p11, const Vec2<T>& p01, const std::vector<Vec2<T>>& p,
                        std::vector<BoolAndVec2<T>>& uvs);

    //-*****************************************************************************
    template <typename T>
    BoolAndVec2<T> quadInverseMap(const Vec3<T>& p00, const Vec3<T>& p10, const Vec3<T>& p11, const Vec3<T>& p01, const Vec3<T>& p);

    //-*****************************************************************************
    template <typename T>
    void quadInverseMap(const Vec3<T>& p00, const Vec3<T>& p10, const Vec3<T>& p11, const Vec3<T>& p01, const std::vector<Vec3<T>>& p,
                        std::vector<BoolAndVec2<T>>& uvs);
    ...
    //-*****************************************************************************
    template <typename T>
    Vec2<T> quadClosestInverseMap(const Vec2<T>& p00, const Vec2<T>& p10, const Vec2<T>& p11, const Vec2<T>& p01, const Vec2<T>& p);

    //-*****************************************************************************
    template <typename T>
    void quadClosestInverseMap(const Vec2<T>& p00, const Vec2<T>& p10, const Vec2<T>& p11, const Vec2<T>& p01,
                               const std::vector<Vec2<T>>& p, std::vector<Vec2<T>>& uvs);

    //-*****************************************************************************
    template <typename T>
    Vec2<T> quadClosestInverseMap(const Vec3<T>& p00, const Vec3<T>& p10, const Vec3<T>& p11, const Vec3<T>& p01, const Vec3<T>& p);

    //-*****************************************************************************
    template <typename T>
    void quadClosestInverseMap(const Vec3<T>& p00, const Vec3<T>& p10, const Vec3<T>& p11, const Vec3<T>& p01,
                               const std::vector<Vec3<T>>& p, std::vector<Vec2<T>>& uvs);
    ...
    //-*****************************************************************************
    template <typename T>
    UvStQuadInverter<T>::UvStQuadInverter(const Vec2<T>& p00, const Vec2<T>& p10, const Vec2<T>& p11, const Vec2<T>& p01)
    {
    ...
    //-*****************************************************************************
    template <typename T>
    inline void UvStQuadInverter<T>::inverseMap(const std::vector<Vec2<T>>& sts, std::vector<BoolAndVec2<T>>& uvs) const
    {
    ...
    //-*****************************************************************************
    template <typename T>
    inline void UvStQuadInverter<T>::closestInverseMap(const std::vector<Vec2<T>>& sts, std::vector<Vec2<T>>& uvs) const
    {
        for (size_t i = 0, s = sts.size(); i < s; ++i)
        {
    ...
    //-*****************************************************************************
    template <typename T>
    inline BoolAndVec2<T> quadInverseMap(const Vec2<T>& p00, const Vec2<T>& p10, const Vec2<T>& p11, const Vec2<T>& p01, const Vec2<T>& p)
    {
    ...
    //-*****************************************************************************
    template <typename T>
    inline void quadInverseMap(const Vec2<T>& p00, const Vec2<T>& p10, const Vec2<T>& p11, const Vec2<T>& p01,
                        ...
                        std::vector<BoolAndVec2<T>>& uvs)
    {
        ...
        Mat44<T> worldToPlane(v0[0], v0[1], v0[2], -dot(v0, p00), v1[0], v1[1], v1[2], -dot(v1, p00), n[0], n[1], n[2], -dot(n, p00), T0,
                              T0, T0, T1);
    ...
    //-*****************************************************************************
    template <typename T>
    inline BoolAndVec2<T> quadInverseMap(const Vec3<T>& p00, const Vec3<T>& p10, const Vec3<T>& p11, const Vec3<T>& p01, const Vec3<T>& p)
    {
    ...
    //-*****************************************************************************
    template <typename T>
    inline Vec2<T> quadClosestInverseMap(const Vec2<T>& p00, const Vec2<T>& p10, const Vec2<T>& p11, const Vec2<T>& p01, const Vec2<T>& p)
    {
        UvStQuadInverter<T> uvqi(p00, p10, p11, p01);
    ...
    //-*****************************************************************************
    template <typename T>
    inline void quadClosestInverseMap(const Vec2<T>& p00, const Vec2<T>& p10, const Vec2<T>& p11, const Vec2<T>& p01,
                                      const std::vector<Vec2<T>>& p, std::vector<Vec2<T>>& uvs)
    {
        UvStQuadInverter<T> uvqi(p00, p10, p11, p01);
    ...
    //-*****************************************************************************
    template <typename T>
    inline Vec2<T> quadClosestInverseMap(const Vec3<T>& p00, const Vec3<T>& p10, const Vec3<T>& p11, const Vec3<T>& p01, const Vec3<T>& p)
    {
        std::vector<Vec3<T>> pvec(1);
        pvec[0] = p;
