...
//******************************************************************************
template <>
inline std::istream &operator>>( std::istream &s, Vec1<char> &v )
{
    int vx;
    s >> vx;
    v.x = vx;
...
//******************************************************************************
template <>
inline std::ostream &operator<<( std::ostream &s, const Vec1<unsigned char> &v )
{
    s << "(" << ( int )v.x << ")";
    return s;
}
...
//******************************************************************************
template <>
inline std::istream &operator>>( std::istream &s, Vec2<char> &v )
{
    int vx, vy;
    s >> vx;
    s >> vy;
...
//******************************************************************************
template <>
inline std::ostream &operator<<( std::ostream &s, const Vec2<unsigned char> &v )
{
    s << "(" << ( int )v.x << ", " << ( int )v.y << ")";
    return s;
}
...
//******************************************************************************
template <>
inline std::istream &operator>>( std::istream &s, Vec3<char> &v )
{
    int vx, vy, vz;
    s >> vx;
    s >> vy;
...
//******************************************************************************
template <>
inline std::ostream &operator<<( std::ostream &s, const Vec3<unsigned char> &v )
{
    s << "(" << ( int )v.x << ", " << ( int )v.y << ", " << ( int )v.z << ")";
    return s;
}
...
//******************************************************************************
template <>
inline std::istream &operator>>( std::istream &s, Vec4<char> &v )
{
    int vx, vy, vz, vw;
    s >> vx;
    s >> vy;
...
//******************************************************************************
template <>
inline std::ostream &operator<<( std::ostream &s, const Vec4<unsigned char> &v )
{
    s << "(" << ( int )v.x << ", " << ( int )v.y << ", "
      << ( int )v.z << ", " << ( int )v.w << ")";
    return s;
...
template <typename T>
inline std::ostream&
operator<< (std::ostream& s, const Quat<T> &q)
{
    s << "(" << q.s 
      << ", " << q.v.x
      << ", " << q.v.y
...
template <typename T>
inline std::ostream&
operator<< (std::ostream& s, const Line<T> &p)
{
    s << "(" << p.origin
      << " "
      << p.direction
...
template <typename T>
inline std::ostream&
operator<< (std::ostream& s, const Plane<T> &p)
{
    s << "(" << p.normal.x 
      << "A, " << p.normal.y
      << "B, " << p.normal.z
