...
class Chromaticities
{
  public:
    ...
    Chromaticities(const Vec& r = Vec(0.0f), 
                   const Vec& g = Vec(0.0f),
                   const Vec& b = Vec(0.0f),
    ...
    {
        return Chromaticities<T>( Vec2<T>(0.640, 0.340),
                                  Vec2<T>(0.310, 0.595),
                                  Vec2<T>(0.155, 0.070),
    ...
    {
        return Chromaticities<T>( Vec2<T>(0.640, 0.330),
                                  Vec2<T>(0.290, 0.600),
                                  Vec2<T>(0.150, 0.060),
                                  Vec2<T>(0.3127, 0.3290) );  // 6500K 
    }
    ...
    static Chromaticities<T> Rec709()
    {
        return Chromaticities<T>( Vec2<T>(0.640, 0.330),
                                  Vec2<T>(0.3, 0.6),
                                  Vec2<T>(0.15, 0.06),
                                  Vec2<T>(0.3127, 0.3290) );  // 6500K Rec709 D65 is truncated form of CIE1931.
    }
    ...
    static Chromaticities<T> Rec2020()
    {
        ...
        return Chromaticities<T>( Vec2<T>(0.708f, 0.292f),
                                  Vec2<T>(0.170f, 0.797f),
                                  Vec2<T>(0.131f, 0.046f),
                                  Vec2<T>(0.3127f, 0.3290f) );
    }
    ...
    {
        return Chromaticities<T>( Vec2<T>(0.680, 0.320),
                                  Vec2<T>(0.265, 0.690),
                                  Vec2<T>(0.150, 0.06),
    ...
    {
        return Chromaticities<T>( Vec2<T>(1.0, 0.0),
                                  Vec2<T>(0.0, 1.0),
                                  Vec2<T>(0.0, 0.0),
    ...
    {
        return Chromaticities<T>( Vec2<T>(0.630, 0.340),
                                  Vec2<T>(0.310, 0.595),
                                  Vec2<T>(0.155, 0.070),
                                  Vec2<T>(0.3127, 0.3290) ); 
    }
    ...
    {
        return Chromaticities<T>( Vec2<T>(0.67, 0.33),
                                  Vec2<T>(0.21, 0.71),
                                  Vec2<T>(0.15, 0.06),
    ...
    {
        return Chromaticities<T>( Vec2<T>(0.73470,  0.26530),
                                  Vec2<T>(0.00000,  1.00000),
    ...
    {
        return Chromaticities<T>( Vec2<T>(0.690, 0.300),
                                  Vec2<T>(0.205, 0.715),
                                  Vec2<T>(0.150, 0.045),
                                  Vec2<T>(0.3127, 0.3290)); // 6500K
    ...
    {
        return Chromaticities<T>( Vec2<T>(0.6840, 0.3130),
                                  Vec2<T>(0.2210, 0.8480),
                                  Vec2<T>(0.0861, -0.1020),
                                  Vec2<T>(0.3127, 0.3290)); // 6500K
