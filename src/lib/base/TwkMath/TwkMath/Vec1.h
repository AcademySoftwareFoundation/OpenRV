...
public:
    ...
    // requests it.
    explicit Vec1( const T &val ) : x( val ) {}
    ...
    template <class T2>
    Vec1<T> &operator=( const Vec1<T2> &copy )
    {
        x = copy.x;
        return *this;
    }
...
//******************************************************************************
template <typename T>
inline Vec1<T> &Vec1<T>::operator=( const T &value )
{
    x = value;
    return *this;
}
...
//******************************************************************************
template <typename T>
inline typename Vec1<T>::iterator Vec1<T>::begin()
{
...
//******************************************************************************
template <typename T>
inline Vec1<T> &Vec1<T>::operator+=( const T &rhs )
{
    x += rhs;
    return *this;
}
...
//******************************************************************************
template <typename T>
inline size_t dimension( Vec1<T> )
{
    return 1;
}
...
// ADDITION
template <typename T>
inline Vec1<T> operator+( const Vec1<T> &a, const T &b )
{
    return Vec1<T>( a.x + b );
}
...
//******************************************************************************
template <typename T>
inline Vec1<T> operator+( const T &a, const Vec1<T> &b )
{
    return Vec1<T>( a + b.x );
}
...
// NEGATION
template <typename T>
inline Vec1<T> operator-( const Vec1<T> &a )
{
    return Vec1<T>( -a.x );
}
