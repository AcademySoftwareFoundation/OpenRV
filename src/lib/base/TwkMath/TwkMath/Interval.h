...
public:
    ...
    Interval( const T &mn, const T &mx ) : min( mn ), max( mx )
    {
        makeValid();
    }
    ...
    Interval( const Interval<T2> &copy ) : min( copy.min ), max( copy.max )
    {
        makeValid();
    }

    // Same type copy constructor
    Interval( const Interval<T> &copy ) : min( copy.min ), max( copy.max )
    {
        makeValid();
    }
    ...
    template <typename T2>
    Interval<T> &operator=( const Interval<T2> &copy )
    {
        min = copy.min;
        max = copy.max;
        makeValid();
...
//******************************************************************************
template <typename T>
inline bool Interval<T>::isInfinite() const
{
...
//******************************************************************************
template <typename T>
inline void Interval<T>::makeInfinite()
{
    min = Math<T>::min();
    max = Math<T>::max();
}
...
//*****************************************************************************
template <typename T>
inline bool Interval<T>::intersects( const T &v ) const
{
    assert( isValid() );
...
//******************************************************************************
template <typename T>
Interval<T> &Interval<T>::operator+=( const T &val )
{
    assert( isValid() );
...
//******************************************************************************
template <typename T>
inline T size( const Interval<T> &r )
{
    return r.size();
}
...
//******************************************************************************
template <typename T>
inline T center( const Interval<T> &r )
{
    return r.center();
}
...
//******************************************************************************
template <typename T>
inline bool isInfinite( const Interval<T> &r )
{
    return r.isInfinite();
}
...
//******************************************************************************
template <typename T>
inline void makeInfinite( Interval<T> &r )
{
    r.makeInfinite();
}
...
//******************************************************************************
template <typename T>
inline bool isValid( const Interval<T> &r )
{
    return r.isValid();
}
...
//******************************************************************************
template <typename T>
inline void makeValid( Interval<T> &r )
{
    r.makeValid();
}
...
Interval<T> operator*( const Interval<T> &a, const Interval<T> &b )
{
    ...
    else
    {
        ...
        return Interval<T>(
            std::min( std::min( ac, ad ), std::min( bc, bd ) ),
