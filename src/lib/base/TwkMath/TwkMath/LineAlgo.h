...
template <typename T>
bool segmentsIntersect( const Vec2<T> &a, const Vec2<T> &b,
...
template <typename T>
bool testPointVsSegment( const Vec2<T> &a,
                         const Vec2<T> &b,
                         const Vec2<T> &P )
{
