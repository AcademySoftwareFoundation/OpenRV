...
{
    for (uint32_t* ip = (uint32_t*)data, *ep = ip + size;
         ip < ep;
         ip++)
    {
        const uint32_t x = *ip;
...
{
    for (uint16_t* ip = (uint16_t*)data, *ep = ip + size;
         ip < ep;
         ip++)
    {
        const uint16_t x = *ip;
...
inline void swapShortsCopy(void* dst, const void *src, size_t size)
{
    ...
    for (uint16_t* op = (uint16_t*)dst, *ep = op + size;
         op < ep;
         ip++, op++)
    {
        const uint16_t x = *ip;
...
//******************************************************************************
//******************************************************************************
inline void writeSwappedUshort( std::ostream &stream,
                                unsigned short val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[1] );
...
//******************************************************************************
inline void writeSwappedShort( std::ostream &stream,
                               short val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[1] );
...
//******************************************************************************
inline void writeSwappedInt( std::ostream &stream,
                             int val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[3] );
...
//******************************************************************************
inline void writeSwappedUint( std::ostream &stream,
                              unsigned int val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[3] );
...
//******************************************************************************
inline void writeSwappedLong( std::ostream &stream,
                              long val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[3] );
...
//******************************************************************************
inline void writeSwappedUlong( std::ostream &stream,
                               unsigned long val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[3] );
...
//******************************************************************************
inline void writeSwappedFloat( std::ostream &stream,
                               float val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[3] );
...
//******************************************************************************
//******************************************************************************
inline void writeSwappedUshort( FILE *stream,
                                unsigned short val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[1] );
...
//******************************************************************************
inline void writeSwappedShort( FILE *stream,
                               short val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[1] );
...
//******************************************************************************
inline void writeSwappedInt( FILE *stream,
                             int val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[3] );
...
//******************************************************************************
inline void writeSwappedUint( FILE *stream,
                              unsigned int val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[3] );
...
//******************************************************************************
inline void writeSwappedLong( FILE *stream,
                              long val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[3] );
...
//******************************************************************************
inline void writeSwappedUlong( FILE *stream,
                               unsigned long val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[3] );
...
//******************************************************************************
inline void writeSwappedFloat( FILE *stream,
                               float val )
{
    char *buf = ( char * )&val;
    std::swap( buf[0], buf[3] );
