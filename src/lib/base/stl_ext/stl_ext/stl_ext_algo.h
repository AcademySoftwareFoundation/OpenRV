...
template <typename C>
void 
remove(C& container, typename C::value_type value)
{
    typename C::iterator i = std::find(container.begin(),
                                       container.end(),
                                       value);
...
void 
remove_unsorted(Container& container, typename Container::value_type value)
{
...
copy (const Container& c, OutputIterator i)
{
