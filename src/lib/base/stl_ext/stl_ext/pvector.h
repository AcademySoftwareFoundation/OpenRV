...
{
  public:
    void_vector(size_t s=0) : _v(s) {}
    void_vector(size_t s, void *i) : _v(s,i) {}
    void_vector(const void_vector &v) : _v(v) {}
...
//#endif
    ...
    pvector(const this_type &v) : void_vector<Alloc>(v) {}
...
//#endif
    ...
    const_iterator	    end() const 
			    { return const_iterator(this->_v.end()); }
...
//#ifndef _MSC_VER
//    const_reference	    back() const { return const_reference(this->_v.back()); }
//#endif
    ...
    void		    insert(iterator pos, value_type X)
			    { this->_v.insert(pos._i,X); }

    bool		    operator==(const this_type &pv)
			    { return this->_v == pv._v; }
