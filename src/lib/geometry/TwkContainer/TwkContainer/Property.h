...
namespace TwkContainer
{
    ...
    public:
        ...
        {
        public:
            Info(bool persistent = true, bool copyable = true, size_t initialRefCount = 0, const std::string& interp = "")
        ...
        template <class T> const T* infoOfType() const { return dynamic_cast<const T*>(m_info); }
        ...
        const PropertyContainer* container() const { return m_propertyContainer; }
        ...
        void appendDefaultValue(size_t len = 1) { insertDefaultValue(size(), len); }
    ...
    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout type>
    ...
    public:
        ...
        typedef TypedProperty<Container, xsize, ysize, zsize, wsize, type> this_type;
        ...
        void push_front(const_reference v) { m_container.insert(m_container.begin(), v); }
    ...
    TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::~TypedProperty()
    {
        // nothing
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    size_t TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::size() const
    {
        return m_container.size();
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    bool TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::empty() const
    {
        return m_container.empty();
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    size_t TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::sizeofElement() const
    {
        return sizeof(typename Container::value_type);
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    void TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::insertDefaultValue(size_t index, size_t len)
    {
        m_container.insert(m_container.begin() + index, len, m_default);
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    void TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::clearToDefaultValue()
    {
        std::fill(m_container.begin(), m_container.end(), m_default);
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    void TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::swap(size_t a, size_t b)
    {
        std::swap(m_container[a], m_container[b]);
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    void TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::resize(size_t s)
    {
    ...
    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    void TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::erase(size_t s, size_t n)
    {
        if (m_container.size())
        {
            m_container.erase(m_container.begin() + s, m_container.begin() + (s + n));
        }
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    void TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::eraseUnsorted(size_t s, size_t n)
    {
        if (m_container.size())
        {
            if (n == 1)
            ...
            {
                std::copy(m_container.begin() + (m_container.size() - n - 1), m_container.end(), m_container.begin() + s);
            }
    ...
    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    Property* TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::copyNoData() const
    {
        return new this_type(mutableInfo(), name().c_str());
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    Property* TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::copy(const char* newName) const
    {
        this_type* p = new this_type(mutableInfo(), newName ? newName : name().c_str());
        p->resize(size());
    ...
    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    void TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::copy(const Property* p)
    {
    ...
    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    void TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::copyRange(const Property* p, size_t i0, size_t i1)
    {
        if (const this_type* tp = dynamic_cast<const this_type*>(p))
        {
    ...
    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    void TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::concatenate(const Property* p)
    {
        if (const this_type* tp = dynamic_cast<const this_type*>(p))
        {
    ...
    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    void TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::concatenateWithOffset(const this_type* p, T v)
    {
    ...
    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    Property::Layout TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::layoutTrait() const
    {
        return layout;
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    size_t TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::xsizeTrait() const
    {
        return xsize;
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    size_t TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::ysizeTrait() const
    {
        return ysize;
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    size_t TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::zsizeTrait() const
    {
        return zsize;
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    size_t TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::wsizeTrait() const
    {
        return wsize;
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    void* TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::rawData()
    {
        return data();
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    const void* TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::rawData() const
    {
        return data();
    }

    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    bool TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::equalityCompare(const Property* p) const
    {
        if (const this_type* tp = dynamic_cast<const this_type*>(p))
        {
    ...
    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    bool TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::structureCompare(const Property* p) const
    {
        if (const this_type* tp = dynamic_cast<const this_type*>(p))
        {
            if (m_container.size() == tp->valueContainer().size())
    ...
    template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
    std::string TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::valueAsString() const
    {
