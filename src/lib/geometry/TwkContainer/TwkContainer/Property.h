...
class Property
{
  public:
    ...
    template <class T>
    const T* infoOfType() const { return dynamic_cast<const T*>(m_info); }
...
public:
	...
	: Property(name), m_container(), m_default(defaultValue<T>()) {}
    explicit TypedProperty(Info* i, const std::string& name)
	: Property(i, name), m_container(), m_default(defaultValue<T>()) {}
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
size_t
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::sizeofElement() const
{
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
void
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::insertDefaultValue(size_t index, size_t len)
{
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
void
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::clearToDefaultValue()
{
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
void
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::swap(size_t a, size_t b)
{
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
void
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::resize(size_t s)
{ 
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
void
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::erase(size_t s, size_t n)
{ 
    if (m_container.size())
    {
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
void
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::eraseUnsorted(size_t s, size_t n)
{ 
    if (m_container.size())
    {
        if (n == 1)
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
Property*
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::copyNoData() const
{
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
Property*
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::copy(const char* newName) const
{
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
void
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::copy(const Property* p)
{
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
void
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::copyRange(const Property* p,
                                                   size_t i0, size_t i1)
{
    if (const this_type* tp = dynamic_cast<const this_type*>(p))
    {
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
void
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::concatenate(const Property* p)
{
    if (const this_type* tp = dynamic_cast<const this_type*>(p))
    {
...
template<class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
void
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::concatenateWithOffset(const this_type* p, T v)
{
...
template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
Property::Layout
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::layoutTrait() const
{
    return layout;
}
...
template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
size_t          
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::xsizeTrait() const
{
    return xsize;
}
...
template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
size_t          
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::ysizeTrait() const
{
    return ysize;
}
...
template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
size_t          
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::zsizeTrait() const
{
    return zsize;
}
...
template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
size_t          
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::wsizeTrait() const
{
    return wsize;
}
...
template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
const void*
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::rawData() const
{ 
    return data(); 
}
...
template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
bool
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::equalityCompare(const Property* p) const
{ 
    if (const this_type* tp = dynamic_cast<const this_type*>(p))
    {
...
template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
bool
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::structureCompare(const Property* p) const
{ 
    if (const this_type* tp = dynamic_cast<const this_type*>(p))
    {
        if (m_container.size() == tp->valueContainer().size())
...
template <class Container, size_t xsize, size_t ysize, size_t zsize, size_t wsize, Property::Layout layout>
std::string
TypedProperty<Container, xsize, ysize, zsize, wsize, layout>::valueAsString() const
{ 
