...
template <> size_t PropertyTraits<TYPE>::zsize();                       \
typedef TypedProperty<PropertyTraits<TYPE>::Container,                  \
                XSIZE, YSIZE, 0, Property::LAYOUT> PTYPENAME;
...
template <> size_t PropertyTraits<TYPE>::zsize();                       \
typedef TypedProperty<PropertyTraits<TYPE>::Container,                  \
                XSIZE, YSIZE, ZSIZE, Property::LAYOUT> PTYPENAME;
...
//PROPERTY_TRAITS(Mat22fProperty, TwkMath::Mat22f, "float[4]", FloatLayout, 4)
//PROPERTY_TRAITS2(Mat44fProperty, TwkMath::Mat44f, "float[4,4]", FloatLayout, 4, 4)
//PROPERTY_TRAITS2(Mat33fProperty, TwkMath::Mat33f, "float[3,3]", FloatLayout, 2, 2)
