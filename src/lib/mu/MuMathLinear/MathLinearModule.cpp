...
{
  public:
    FixedMatrixFunction(Context*context,
                        const char* name,
                        NodeFunc,
...
FixedMatrixFunction::FixedMatrixFunction(Context* context,
                                         const char *name,
                                         NodeFunc func,
                                         Attributes attrs,
                                         ...)
...
const Type* 
FixedMatrixFunction::nodeReturnType(const Node* node) const
{
...
MathLinearModule::load()
{
    ...
    globalScope()->addSymbols( new Function(c, "*", mult_m44_m44, Op,
                                            Return, "float[4,4]",
                                            Args, "float[4,4]", "float[4,4]",
                                            End),

                               new Function(c, "*", mult_m33_m33, Op,
                                            Return, "float[3,3]",
                                            Args, "float[3,3]", "float[3,3]",
                                            End),

                               new Function(c, "*", mult_m44_v4, Op,
                                            Return, "vector float[4]",
                                            Args, "float[4,4]", "vector float[4]",
                                            End),

                               new Function(c, "*", mult_m44_v3, Op,
                                            Return, "vector float[3]",
                                            Args, "float[4,4]", "vector float[3]",
                                            End),

                               new Function(c, "inverse", inverse_m44, Mapped,
                                            Return, "float[4,4]",
                                            Args, "float[4,4]",
                                            End),

                               new Function(c, "inverse", inverse_m33, Mapped,
                                            Return, "float[3,3]",
                                            Args, "float[3,3]",
                                            End),

                               new FixedMatrixFunction(c, "inverse", inverse_mXX, Mapped,
                                                       Return, "?fixed_array",
                                                       Args, "?fixed_array",
                                                       End),
