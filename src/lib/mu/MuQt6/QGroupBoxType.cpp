...
int MuQt_QGroupBox::metric(QPaintDevice::PaintDeviceMetric m) const
{
    if (!_env) return QGroupBox::metric(m);
    MuLangContext* c = (MuLangContext*)_env->context();
...
addSymbols(
    ...
    // MISSING: enterEvent (void; QGroupBox this, "QEnterEvent *" event) // protected
    _func[19] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QGroupBox_focusNextPrevChild_bool_QGroupBox_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QGroupBox"), new Param(c, "next", "bool"), End),
    _func[20] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QGroupBox_focusOutEvent_void_QGroupBox_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QGroupBox"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[21] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QGroupBox_hideEvent_void_QGroupBox_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QGroupBox"), new Param(c, "event", "qt.QHideEvent"), End),
    // MISSING: inputMethodEvent (void; QGroupBox this, "QInputMethodEvent *" event) // protected
    _func[22] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QGroupBox_keyPressEvent_void_QGroupBox_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QGroupBox"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[23] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QGroupBox_keyReleaseEvent_void_QGroupBox_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QGroupBox"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[24] = new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QGroupBox_leaveEvent_void_QGroupBox_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QGroupBox"), new Param(c, "event", "qt.QEvent"), End),
    _func[25] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QGroupBox_mouseDoubleClickEvent_void_QGroupBox_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QGroupBox"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[26] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QGroupBox_moveEvent_void_QGroupBox_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QGroupBox"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QGroupBox this, QByteArray eventType, "void *" message, "qintptr *" result) // protected
    _func[27] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QGroupBox_showEvent_void_QGroupBox_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QGroupBox"), new Param(c, "event", "qt.QShowEvent"), End),
    _func[28] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QGroupBox_tabletEvent_void_QGroupBox_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QGroupBox"), new Param(c, "event", "qt.QTabletEvent"), End),
    _func[29] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QGroupBox_wheelEvent_void_QGroupBox_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QGroupBox"), new Param(c, "event", "qt.QWheelEvent"), End),
    // MISSING: initPainter (void; QGroupBox this, "QPainter *" painter) // protected
    _func[30] = new MemberFunction(c, "metric", _n_metric0, None, Compiled, qt_QGroupBox_metric_int_QGroupBox_int, Return, "int", Parameters, new Param(c, "this", "qt.QGroupBox"), new Param(c, "m", "int"), End),
    // static functions
    EndArguments);
