...
namespace Mu
{
    ...
    bool qt_QObject_isQuickItemType_bool_QObject(Mu::Thread& NODE_THREAD,
                                                 Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QObject* arg0 = object<QObject>(param_this);
    ...
    void qt_QObject_setObjectName_void_QObject_string(Mu::Thread& NODE_THREAD,
                                                      Pointer param_this,
                                                      Pointer param_name)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    {
        NODE_RETURN(qt_QObject_isQuickItemType_bool_QObject(
    ...
    {
        qt_QObject_setObjectName_void_QObject_string(
            NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
    }
...
#include <MuQt6/QVariantType.h>
    ...
    void QObjectType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "isQuickItemType", _n_isQuickItemType0, None,
                         Compiled, qt_QObject_isQuickItemType_bool_QObject,
                         Return, "bool", Parameters,
                         new Param(c, "this", "qt.QObject"), End),
            ...
            new Function(c, "setObjectName", _n_setObjectName0, None, Compiled,
                         qt_QObject_setObjectName_void_QObject_string, Return,
                         "void", Parameters, new Param(c, "this", "qt.QObject"),
