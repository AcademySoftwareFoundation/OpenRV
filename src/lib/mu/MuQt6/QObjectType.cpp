...
#include <MuQt6/QVariantType.h>
    ...
    void QObjectType::load()
    {
        ...
        addSymbols(
            ...
            // MISSING: findChildren ("QList<T>"; QObject this, flags
            // Qt::FindChildOptions options) MISSING: findChildren ("QList<T>";
            // QObject this, QRegularExpression re, flags Qt::FindChildOptions
            // options) MISSING: inherits (bool; QObject this, "const char *"
            // className)
            ...
            new Function(c, "isQuickItemType", _n_isQuickItemType0, None, Compiled, qt_QObject_isQuickItemType_bool_QObject, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QObject"), End),
            ...
            new Function(c, "setObjectName", _n_setObjectName0, None, Compiled, qt_QObject_setObjectName_void_QObject_string, Return,
                         "void", Parameters, new Param(c, "this", "qt.QObject"), new Param(c, "name", "string"), End),
            // MISSING: setObjectName (void; QObject this, "QAnyStringView"
            // name)
            ...
            // MISSING: startTimer (int; QObject this, flags
            // std::chrono::milliseconds time, flags Qt::TimerType timerType)
            ...
            // functor, flags Qt::ConnectionType type) MISSING: tr (string;
        ...
        addSymbols(new Function(c, "findChild", findChild, None, Return, ftn, Parameters, new Param(c, "this", ftn),
                   ...
                   new Function(c, "tr", _n_tr0, None, Compiled, qt_QObject_tr_string_QObject_string_string_int, Return, "string",
                                Parameters, new Param(c, "sourceText", "string"), new Param(c, "disambiguation", "string", Value(nullptr)),
