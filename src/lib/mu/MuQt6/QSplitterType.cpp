...
namespace Mu
{
    ...
    Pointer qt_QSplitter_replaceWidget_QWidget_QSplitter_int_QWidget(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index,
                                                                     Pointer param_widget)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QSplitter* arg0 = object<QSplitter>(param_this);
    ...
    {
        NODE_RETURN(qt_QSplitter_replaceWidget_QWidget_QSplitter_int_QWidget(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int),
                                                                             NODE_ARG(2, Pointer)));
    }
    ...
    void QSplitterType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "refresh", _n_refresh0, None, Compiled, qt_QSplitter_refresh_void_QSplitter, Return, "void", Parameters,
                         new Param(c, "this", "qt.QSplitter"), End),
            new Function(c, "replaceWidget", _n_replaceWidget0, None, Compiled, qt_QSplitter_replaceWidget_QWidget_QSplitter_int_QWidget,
                         Return, "qt.QWidget", Parameters, new Param(c, "this", "qt.QSplitter"), new Param(c, "index", "int"),
                         new Param(c, "widget", "qt.QWidget"), End),
            ...
            // _p15) MISSING: setSizes (void; QSplitter this, "const QList<int>
            // &" list)
            ...
            // MISSING: initStyleOption (void; QSplitter this,
