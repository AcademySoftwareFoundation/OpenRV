...
{
    if (!_env) { QSplitter::resizeEvent(_p15); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSplitter::paintEvent(_p14); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
Pointer qt_QSplitter_replaceWidget_QWidget_QSplitter_int_QWidget(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index, Pointer param_widget)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QSplitter* arg0 = object<QSplitter>(param_this);
    int arg1 = (int)(param_index);
    QWidget * arg2 = object<QWidget>(param_widget);
    return makeinstance<QWidgetType>(c, arg0->replaceWidget(arg1, arg2), "qt.QWidget");
}
...
{
    NODE_RETURN(qt_QSplitter_replaceWidget_QWidget_QSplitter_int_QWidget(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer)));
}
...
addSymbols(
    ...
    new Function(c, "replaceWidget", _n_replaceWidget0, None, Compiled, qt_QSplitter_replaceWidget_QWidget_QSplitter_int_QWidget, Return, "qt.QWidget", Parameters, new Param(c, "this", "qt.QSplitter"), new Param(c, "index", "int"), new Param(c, "widget", "qt.QWidget"), End),
    ...
    _func[4] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QSplitter_resizeEvent_void_QSplitter_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSplitter"), new Param(c, "_p15", "qt.QResizeEvent"), End),
    // MISSING: initStyleOption (void; QSplitter this, "QStyleOptionFrame *" option) // protected
    _func[5] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QSplitter_paintEvent_void_QSplitter_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSplitter"), new Param(c, "_p14", "qt.QPaintEvent"), End),
    // static functions
    EndArguments);
