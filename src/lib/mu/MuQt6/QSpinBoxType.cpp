...
{
    if (!_env) return QSpinBox::textFromValue(value);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QSpinBox::valueFromText(text);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QSpinBox::event(event_);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::stepBy(steps); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QSpinBox::inputMethodQuery(query);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QSpinBox::minimumSizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QSpinBox::sizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
QAbstractSpinBox::StepEnabled MuQt_QSpinBox::stepEnabled() const
{
    if (!_env) return QSpinBox::stepEnabled();
    MuLangContext* c = (MuLangContext*)_env->context();
    ...
    if (F != F0) 
    {
        ...
        args[0] = Value(Pointer(_obj));
        Value rval = _env->call(F, args);
        return (QAbstractSpinBox::StepEnabled)(rval._int);
    }
    else
    {
...
{
    if (!_env) { QSpinBox::changeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::closeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::contextMenuEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::focusInEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::focusOutEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::hideEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::keyPressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::keyReleaseEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::mouseMoveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::mousePressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::mouseReleaseEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::paintEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::resizeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::showEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::timerEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSpinBox::wheelEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QSpinBox_QSpinBox_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    {
        QSpinBoxType* type = 
            c->findSymbolOfTypeByQualifiedName<QSpinBoxType>(c->internName("qt.QSpinBox"), false);
...
{
    NODE_RETURN( QSpinBox_QSpinBox_QObject(NODE_THREAD, NODE_ARG(0, Pointer)) );
}
...
void qt_QSpinBox_setStepType_void_QSpinBox_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_stepType)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QSpinBox* arg0 = object<QSpinBox>(param_this);
    QAbstractSpinBox::StepType arg1 = (QAbstractSpinBox::StepType)(param_stepType);
    arg0->setStepType(arg1);
}
...
Pointer qt_QSpinBox_textFromValue_string_QSpinBox_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_value)
{
    ...
    return isMuQtObject(arg0) ? makestring(c,((MuQt_QSpinBox*)arg0)->textFromValue_pub_parent(arg1)) : makestring(c,((MuQt_QSpinBox*)arg0)->textFromValue_pub(arg1));
}
...
int qt_QSpinBox_valueFromText_int_QSpinBox_string(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_text)
{
    ...
    return isMuQtObject(arg0) ? ((MuQt_QSpinBox*)arg0)->valueFromText_pub_parent(arg1) : ((MuQt_QSpinBox*)arg0)->valueFromText_pub(arg1);
}
...
void qt_QSpinBox_stepBy_void_QSpinBox_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_steps)
{
    ...
    if (isMuQtObject(arg0)) arg0->QSpinBox::stepBy(arg1);
...
Pointer qt_QSpinBox_inputMethodQuery_QVariant_QSpinBox_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_query)
{
    ...
    return isMuQtObject(arg0) ? makeqtype<QVariantType>(c,arg0->QSpinBox::inputMethodQuery(arg1),"qt.QVariant") : makeqtype<QVariantType>(c,arg0->inputMethodQuery(arg1),"qt.QVariant");
}
...
Pointer qt_QSpinBox_minimumSizeHint_QSize_QSpinBox(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QSpinBox* arg0 = object<QSpinBox>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QSpinBox::minimumSizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->minimumSizeHint(),"qt.QSize");
}
...
Pointer qt_QSpinBox_sizeHint_QSize_QSpinBox(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QSpinBox* arg0 = object<QSpinBox>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QSpinBox::sizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->sizeHint(),"qt.QSize");
}

int qt_QSpinBox_stepEnabled_int_QSpinBox(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QSpinBox* arg0 = object<QSpinBox>(param_this);
    return isMuQtObject(arg0) ? int(((MuQt_QSpinBox*)arg0)->stepEnabled_pub_parent()) : int(((MuQt_QSpinBox*)arg0)->stepEnabled_pub());
}
...
void qt_QSpinBox_changeEvent_void_QSpinBox_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->changeEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->changeEvent_pub(arg1);
}
...
void qt_QSpinBox_closeEvent_void_QSpinBox_QCloseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->closeEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->closeEvent_pub(arg1);
}
...
void qt_QSpinBox_contextMenuEvent_void_QSpinBox_QContextMenuEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->contextMenuEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->contextMenuEvent_pub(arg1);
}
...
void qt_QSpinBox_focusInEvent_void_QSpinBox_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->focusInEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->focusInEvent_pub(arg1);
}
...
void qt_QSpinBox_focusOutEvent_void_QSpinBox_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QSpinBox* arg0 = object<QSpinBox>(param_this);
    QFocusEvent * arg1 = getqpointer<QFocusEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->focusOutEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->focusOutEvent_pub(arg1);
}
...
void qt_QSpinBox_hideEvent_void_QSpinBox_QHideEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->hideEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->hideEvent_pub(arg1);
}
...
void qt_QSpinBox_keyPressEvent_void_QSpinBox_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    else ((MuQt_QSpinBox*)arg0)->keyPressEvent_pub(arg1);
}
...
void qt_QSpinBox_keyReleaseEvent_void_QSpinBox_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QSpinBox* arg0 = object<QSpinBox>(param_this);
    QKeyEvent * arg1 = getqpointer<QKeyEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->keyReleaseEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->keyReleaseEvent_pub(arg1);
}
...
void qt_QSpinBox_mouseMoveEvent_void_QSpinBox_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->mouseMoveEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->mouseMoveEvent_pub(arg1);
}
...
void qt_QSpinBox_mousePressEvent_void_QSpinBox_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QSpinBox* arg0 = object<QSpinBox>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->mousePressEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->mousePressEvent_pub(arg1);
}
...
void qt_QSpinBox_mouseReleaseEvent_void_QSpinBox_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QSpinBox* arg0 = object<QSpinBox>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->mouseReleaseEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->mouseReleaseEvent_pub(arg1);
}
...
void qt_QSpinBox_paintEvent_void_QSpinBox_QPaintEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->paintEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->paintEvent_pub(arg1);
}
...
void qt_QSpinBox_resizeEvent_void_QSpinBox_QResizeEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->resizeEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->resizeEvent_pub(arg1);
}
...
void qt_QSpinBox_showEvent_void_QSpinBox_QShowEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->showEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->showEvent_pub(arg1);
}
...
void qt_QSpinBox_timerEvent_void_QSpinBox_QTimerEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->timerEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->timerEvent_pub(arg1);
}
...
void qt_QSpinBox_wheelEvent_void_QSpinBox_QWheelEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSpinBox*)arg0)->wheelEvent_pub_parent(arg1);
    else ((MuQt_QSpinBox*)arg0)->wheelEvent_pub(arg1);
}
...
static NODE_IMPLEMENTATION(_n_setStepType0, void)
{
    qt_QSpinBox_setStepType_void_QSpinBox_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int));
}
...
static NODE_IMPLEMENTATION(_n_stepEnabled0, int)
{
    NODE_RETURN(qt_QSpinBox_stepEnabled_int_QSpinBox(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
QSpinBoxType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QSpinBox_QSpinBox_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QSpinBox", _n_QSpinBox0, None, Compiled, qt_QSpinBox_QSpinBox_QSpinBox_QSpinBox_QWidget, Return, "qt.QSpinBox", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "parent", "qt.QWidget"), End),
    ...
    new Function(c, "setRange", _n_setRange0, None, Compiled, qt_QSpinBox_setRange_void_QSpinBox_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "minimum", "int"), new Param(c, "maximum", "int"), End),
    // PROP: setSingleStep (void; QSpinBox this, int val)
    new Function(c, "setStepType", _n_setStepType0, None, Compiled, qt_QSpinBox_setStepType_void_QSpinBox_int, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "stepType", "int"), End),
    // PROP: setSuffix (void; QSpinBox this, string suffix)
    // PROP: singleStep (int; QSpinBox this)
    // PROP: stepType (flags QAbstractSpinBox::StepType; QSpinBox this)
    // PROP: suffix (string; QSpinBox this)
    // PROP: value (int; QSpinBox this)
    _func[0] = new MemberFunction(c, "textFromValue", _n_textFromValue0, None, Compiled, qt_QSpinBox_textFromValue_string_QSpinBox_int, Return, "string", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "value", "int"), End),
    _func[1] = new MemberFunction(c, "valueFromText", _n_valueFromText0, None, Compiled, qt_QSpinBox_valueFromText_int_QSpinBox_string, Return, "int", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "text", "string"), End),
    _func[2] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QSpinBox_event_bool_QSpinBox_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event_", "qt.QEvent"), End),
    // MISSING: validate (flags QValidator::State; QSpinBox this, string text, "int &" pos) // protected
    _func[3] = new MemberFunction(c, "stepBy", _n_stepBy0, None, Compiled, qt_QSpinBox_stepBy_void_QSpinBox_int, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "steps", "int"), End),
    _func[4] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QSpinBox_inputMethodQuery_QVariant_QSpinBox_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "query", "int"), End),
    _func[5] = new MemberFunction(c, "minimumSizeHint", _n_minimumSizeHint0, None, Compiled, qt_QSpinBox_minimumSizeHint_QSize_QSpinBox, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSpinBox"), End),
    _func[6] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QSpinBox_sizeHint_QSize_QSpinBox, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSpinBox"), End),
    // MISSING: initStyleOption (void; QSpinBox this, "QStyleOptionSpinBox *" option) // protected
    _func[7] = new MemberFunction(c, "stepEnabled", _n_stepEnabled0, None, Compiled, qt_QSpinBox_stepEnabled_int_QSpinBox, Return, "int", Parameters, new Param(c, "this", "qt.QSpinBox"), End),
    _func[8] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled, qt_QSpinBox_changeEvent_void_QSpinBox_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QEvent"), End),
    _func[9] = new MemberFunction(c, "closeEvent", _n_closeEvent0, None, Compiled, qt_QSpinBox_closeEvent_void_QSpinBox_QCloseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QCloseEvent"), End),
    _func[10] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled, qt_QSpinBox_contextMenuEvent_void_QSpinBox_QContextMenuEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QContextMenuEvent"), End),
    _func[11] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QSpinBox_focusInEvent_void_QSpinBox_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[12] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QSpinBox_focusOutEvent_void_QSpinBox_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[13] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QSpinBox_hideEvent_void_QSpinBox_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QHideEvent"), End),
    _func[14] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QSpinBox_keyPressEvent_void_QSpinBox_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[15] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QSpinBox_keyReleaseEvent_void_QSpinBox_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[16] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QSpinBox_mouseMoveEvent_void_QSpinBox_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[17] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QSpinBox_mousePressEvent_void_QSpinBox_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[18] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QSpinBox_mouseReleaseEvent_void_QSpinBox_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[19] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QSpinBox_paintEvent_void_QSpinBox_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QPaintEvent"), End),
    _func[20] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QSpinBox_resizeEvent_void_QSpinBox_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QResizeEvent"), End),
    _func[21] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QSpinBox_showEvent_void_QSpinBox_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QShowEvent"), End),
    _func[22] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QSpinBox_timerEvent_void_QSpinBox_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QTimerEvent"), End),
    _func[23] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QSpinBox_wheelEvent_void_QSpinBox_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QWheelEvent"), End),
    // static functions
    EndArguments);
