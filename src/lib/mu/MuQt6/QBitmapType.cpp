...
addSymbols(
    ...
    new Function(c, "QBitmap", _n_QBitmap1, None, Compiled, qt_QBitmap_QBitmap_QBitmap_QBitmap_int_int, Return, "qt.QBitmap", Parameters, new Param(c, "this", "qt.QBitmap"), new Param(c, "width", "int"), new Param(c, "height", "int"), End),
    ...
    // MISSING: fromImage (QBitmap; "QImage & &" image, flags Qt::ImageConversionFlags flags)
    new Function(c, "fromPixmap", _n_fromPixmap0, None, Compiled, qt_QBitmap_fromPixmap_QBitmap_QPixmap, Return, "qt.QBitmap", Parameters, new Param(c, "pixmap", "qt.QPixmap"), End),
    EndArguments);
