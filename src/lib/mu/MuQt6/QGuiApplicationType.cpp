...
namespace Mu
{
    ...
    int qt_QGuiApplication_highDpiScaleFactorRoundingPolicy_int(
    ...
    void qt_QGuiApplication_setHighDpiScaleFactorRoundingPolicy_void_int(
        Mu::Thread& NODE_THREAD, int param_policy)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        Qt::HighDpiScaleFactorRoundingPolicy arg0 =
            (Qt::HighDpiScaleFactorRoundingPolicy)(param_policy);
    ...
    {
        NODE_RETURN(qt_QGuiApplication_highDpiScaleFactorRoundingPolicy_int(
            NODE_THREAD));
    }
    ...
    {
        NODE_RETURN(qt_QGuiApplication_screenAt_QScreen_QPoint(
            NODE_THREAD, NODE_ARG(0, Pointer)));
    }
    ...
    {
        qt_QGuiApplication_setHighDpiScaleFactorRoundingPolicy_void_int(
    ...
    void QGuiApplicationType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "font", _n_font0, None, Compiled,
                         ...
                         End),
            new Function(
                c, "highDpiScaleFactorRoundingPolicy",
                _n_highDpiScaleFactorRoundingPolicy0, None, Compiled,
                qt_QGuiApplication_highDpiScaleFactorRoundingPolicy_int, Return,
                "int", End),
            ...
            new Function(c, "palette", _n_palette0, None, Compiled,
                         ...
                         "qt.QPalette", End),
            new Function(c, "primaryScreen", _n_primaryScreen0, None, Compiled,
                         qt_QGuiApplication_primaryScreen_QScreen, Return,
                         "qt.QScreen", End),
            ...
            new Function(c, "restoreOverrideCursor", _n_restoreOverrideCursor0,
                         ...
                         "void", End),
            new Function(c, "screenAt", _n_screenAt0, None, Compiled,
                         qt_QGuiApplication_screenAt_QScreen_QPoint, Return,
            ...
            new Function(
                c, "setHighDpiScaleFactorRoundingPolicy",
                _n_setHighDpiScaleFactorRoundingPolicy0, None, Compiled,
                qt_QGuiApplication_setHighDpiScaleFactorRoundingPolicy_void_int,
                Return, "void", Parameters, new Param(c, "policy", "int"), End),
            new Function(
