...
Pointer qt_QGuiApplication_screenAt_QScreen_QPoint(Mu::Thread& NODE_THREAD, Pointer param_point)
{
    ...
    return makeinstance<QScreenType>(c, QGuiApplication::screenAt(arg0), "qt.QScreen");
}
...
addSymbols(
    ...
    // MISSING: nativeInterface ("QNativeInterface *"; QGuiApplication this)
    ...
    new Function(c, "highDpiScaleFactorRoundingPolicy", _n_highDpiScaleFactorRoundingPolicy0, None, Compiled, qt_QGuiApplication_highDpiScaleFactorRoundingPolicy_int, Return, "int", End),
    ...
    new Function(c, "primaryScreen", _n_primaryScreen0, None, Compiled, qt_QGuiApplication_primaryScreen_QScreen, Return, "qt.QScreen", End),
    ...
    new Function(c, "screenAt", _n_screenAt0, None, Compiled, qt_QGuiApplication_screenAt_QScreen_QPoint, Return, "qt.QScreen", Parameters, new Param(c, "point", "qt.QPoint"), End),
    ...
    new Function(c, "setHighDpiScaleFactorRoundingPolicy", _n_setHighDpiScaleFactorRoundingPolicy0, None, Compiled, qt_QGuiApplication_setHighDpiScaleFactorRoundingPolicy_void_int, Return, "void", Parameters, new Param(c, "policy", "int"), End),
