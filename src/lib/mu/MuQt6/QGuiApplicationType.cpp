...
namespace Mu
{
    ...
    static Pointer QGuiApplication_QGuiApplication_QObject(Thread& NODE_THREAD, Pointer obj)
    {
        ...
        {
            QGuiApplicationType* type = c->findSymbolOfTypeByQualifiedName<QGuiApplicationType>(c->internName("qt.QGuiApplication"), false);
    ...
    bool qt_QGuiApplication_notify_bool_QGuiApplication_QObject_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_object,
                                                                       Pointer param_event)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QGuiApplication* arg0 = object<QGuiApplication>(param_this);
    ...
    int qt_QGuiApplication_highDpiScaleFactorRoundingPolicy_int(Mu::Thread& NODE_THREAD)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    Pointer qt_QGuiApplication_screenAt_QScreen_QPoint(Mu::Thread& NODE_THREAD, Pointer param_point)
    {
    ...
    void qt_QGuiApplication_setHighDpiScaleFactorRoundingPolicy_void_int(Mu::Thread& NODE_THREAD, int param_policy)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        Qt::HighDpiScaleFactorRoundingPolicy arg0 = (Qt::HighDpiScaleFactorRoundingPolicy)(param_policy);
    ...
    {
        NODE_RETURN(qt_QGuiApplication_notify_bool_QGuiApplication_QObject_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
    ...
    static NODE_IMPLEMENTATION(_n_applicationState0, int) { NODE_RETURN(qt_QGuiApplication_applicationState_int(NODE_THREAD)); }
    ...
    static NODE_IMPLEMENTATION(_n_clipboard0, Pointer) { NODE_RETURN(qt_QGuiApplication_clipboard_QClipboard(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_desktopSettingsAware0, bool) { NODE_RETURN(qt_QGuiApplication_desktopSettingsAware_bool(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_exec0, int) { NODE_RETURN(qt_QGuiApplication_exec_int(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_focusObject0, Pointer) { NODE_RETURN(qt_QGuiApplication_focusObject_QObject(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_font0, Pointer) { NODE_RETURN(qt_QGuiApplication_font_QFont(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_highDpiScaleFactorRoundingPolicy0, int)
    {
        NODE_RETURN(qt_QGuiApplication_highDpiScaleFactorRoundingPolicy_int(NODE_THREAD));
    }

    static NODE_IMPLEMENTATION(_n_isLeftToRight0, bool) { NODE_RETURN(qt_QGuiApplication_isLeftToRight_bool(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_isRightToLeft0, bool) { NODE_RETURN(qt_QGuiApplication_isRightToLeft_bool(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_keyboardModifiers0, int) { NODE_RETURN(qt_QGuiApplication_keyboardModifiers_int(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_mouseButtons0, int) { NODE_RETURN(qt_QGuiApplication_mouseButtons_int(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_palette0, Pointer) { NODE_RETURN(qt_QGuiApplication_palette_QPalette(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_primaryScreen0, Pointer) { NODE_RETURN(qt_QGuiApplication_primaryScreen_QScreen(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_queryKeyboardModifiers0, int) { NODE_RETURN(qt_QGuiApplication_queryKeyboardModifiers_int(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_restoreOverrideCursor0, void) { qt_QGuiApplication_restoreOverrideCursor_void(NODE_THREAD); }

    static NODE_IMPLEMENTATION(_n_screenAt0, Pointer)
    {
        NODE_RETURN(qt_QGuiApplication_screenAt_QScreen_QPoint(NODE_THREAD, NODE_ARG(0, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_setFont0, void) { qt_QGuiApplication_setFont_void_QFont(NODE_THREAD, NODE_ARG(0, Pointer)); }

    static NODE_IMPLEMENTATION(_n_setHighDpiScaleFactorRoundingPolicy0, void)
    {
        qt_QGuiApplication_setHighDpiScaleFactorRoundingPolicy_void_int(NODE_THREAD, NODE_ARG(0, int));
    }
    ...
    static NODE_IMPLEMENTATION(_n_sync0, void) { qt_QGuiApplication_sync_void(NODE_THREAD); }
    ...
    void QGuiApplicationType::load()
    {
        ...
        addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None, Return, ftn, End),
                   ...
                   new Function(c, tn, castFromObject, Cast, Compiled, QGuiApplication_QGuiApplication_QObject, Return, ftn, Parameters,
        ...
        addSymbols(
            ...
            // "int &" argc, "char * *" argv)
            new Function(c, "devicePixelRatio", _n_devicePixelRatio0, None, Compiled,
                         qt_QGuiApplication_devicePixelRatio_double_QGuiApplication, Return, "double", Parameters,
                         new Param(c, "this", "qt.QGuiApplication"), End),
            new Function(c, "isSavingSession", _n_isSavingSession0, None, Compiled, qt_QGuiApplication_isSavingSession_bool_QGuiApplication,
                         Return, "bool", Parameters, new Param(c, "this", "qt.QGuiApplication"), End),
            new Function(c, "isSessionRestored", _n_isSessionRestored0, None, Compiled,
                         qt_QGuiApplication_isSessionRestored_bool_QGuiApplication, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QGuiApplication"), End),
            // MISSING: nativeInterface ("QNativeInterface *"; QGuiApplication
            // this)
            new Function(c, "sessionId", _n_sessionId0, None, Compiled, qt_QGuiApplication_sessionId_string_QGuiApplication, Return,
                         "string", Parameters, new Param(c, "this", "qt.QGuiApplication"), End),
            new Function(c, "sessionKey", _n_sessionKey0, None, Compiled, qt_QGuiApplication_sessionKey_string_QGuiApplication, Return,
                         "string", Parameters, new Param(c, "this", "qt.QGuiApplication"), End),
            _func[0] =
                new MemberFunction(c, "notify", _n_notify0, None, Compiled, qt_QGuiApplication_notify_bool_QGuiApplication_QObject_QEvent,
                                   Return, "bool", Parameters, new Param(c, "this", "qt.QGuiApplication"),
                                   new Param(c, "object", "qt.QObject"), new Param(c, "event", "qt.QEvent"), End),
            _func[1] =
                new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QGuiApplication_event_bool_QGuiApplication_QEvent, Return,
                                   "bool", Parameters, new Param(c, "this", "qt.QGuiApplication"), new Param(c, "e", "qt.QEvent"), End),
            // static functions
            // MISSING: allWindows ("QWindowList"; )
            new Function(c, "applicationState", _n_applicationState0, None, Compiled, qt_QGuiApplication_applicationState_int, Return,
                         "int", End),
            new Function(c, "changeOverrideCursor", _n_changeOverrideCursor0, None, Compiled,
                         qt_QGuiApplication_changeOverrideCursor_void_QCursor, Return, "void", Parameters,
                         new Param(c, "cursor", "qt.QCursor"), End),
            new Function(c, "clipboard", _n_clipboard0, None, Compiled, qt_QGuiApplication_clipboard_QClipboard, Return, "qt.QClipboard",
                         End),
            new Function(c, "desktopSettingsAware", _n_desktopSettingsAware0, None, Compiled, qt_QGuiApplication_desktopSettingsAware_bool,
                         Return, "bool", End),
            new Function(c, "exec", _n_exec0, None, Compiled, qt_QGuiApplication_exec_int, Return, "int", End),
            new Function(c, "focusObject", _n_focusObject0, None, Compiled, qt_QGuiApplication_focusObject_QObject, Return, "qt.QObject",
                         End),
            // MISSING: focusWindow ("QWindow *"; )
            new Function(c, "font", _n_font0, None, Compiled, qt_QGuiApplication_font_QFont, Return, "qt.QFont", End),
            new Function(c, "highDpiScaleFactorRoundingPolicy", _n_highDpiScaleFactorRoundingPolicy0, None, Compiled,
                         qt_QGuiApplication_highDpiScaleFactorRoundingPolicy_int, Return, "int", End),
            ...
            new Function(c, "keyboardModifiers", _n_keyboardModifiers0, None, Compiled, qt_QGuiApplication_keyboardModifiers_int, Return,
                         "int", End),
            ...
            new Function(c, "primaryScreen", _n_primaryScreen0, None, Compiled, qt_QGuiApplication_primaryScreen_QScreen, Return,
                         "qt.QScreen", End),
            new Function(c, "queryKeyboardModifiers", _n_queryKeyboardModifiers0, None, Compiled,
                         qt_QGuiApplication_queryKeyboardModifiers_int, Return, "int", End),
            new Function(c, "restoreOverrideCursor", _n_restoreOverrideCursor0, None, Compiled,
                         qt_QGuiApplication_restoreOverrideCursor_void, Return, "void", End),
            new Function(c, "screenAt", _n_screenAt0, None, Compiled, qt_QGuiApplication_screenAt_QScreen_QPoint, Return, "qt.QScreen",
                         Parameters, new Param(c, "point", "qt.QPoint"), End),
            // MISSING: screens ("QList<QScreen * >"; )
            new Function(c, "setDesktopSettingsAware", _n_setDesktopSettingsAware0, None, Compiled,
                         qt_QGuiApplication_setDesktopSettingsAware_void_bool, Return, "void", Parameters, new Param(c, "on", "bool"), End),
            new Function(c, "setFont", _n_setFont0, None, Compiled, qt_QGuiApplication_setFont_void_QFont, Return, "void", Parameters,
                         new Param(c, "font", "qt.QFont"), End),
            new Function(c, "setHighDpiScaleFactorRoundingPolicy", _n_setHighDpiScaleFactorRoundingPolicy0, None, Compiled,
                         qt_QGuiApplication_setHighDpiScaleFactorRoundingPolicy_void_int, Return, "void", Parameters,
                         new Param(c, "policy", "int"), End),
            new Function(c, "setOverrideCursor", _n_setOverrideCursor0, None, Compiled, qt_QGuiApplication_setOverrideCursor_void_QCursor,
                         Return, "void", Parameters, new Param(c, "cursor", "qt.QCursor"), End),
            new Function(c, "setPalette", _n_setPalette0, None, Compiled, qt_QGuiApplication_setPalette_void_QPalette, Return, "void",
                         Parameters, new Param(c, "pal", "qt.QPalette"), End),
