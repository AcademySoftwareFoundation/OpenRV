...
{
    if (!_env) { QUdpSocket::disconnectFromHost(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QUdpSocket::resume(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QUdpSocket::setReadBufferSize(size); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QUdpSocket::setSocketOption(option, value); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QUdpSocket::socketOption(option);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QUdpSocket::waitForConnected(msecs);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QUdpSocket::waitForDisconnected(msecs);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QUdpSocket::skipData(maxSize);
    MuLangContext* c = (MuLangContext*)_env->context();
...
void qt_QUdpSocket_disconnectFromHost_void_QUdpSocket(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QUdpSocket* arg0 = object<QUdpSocket>(param_this);
    if (isMuQtObject(arg0)) arg0->QUdpSocket::disconnectFromHost();
...
void qt_QUdpSocket_resume_void_QUdpSocket(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QUdpSocket* arg0 = object<QUdpSocket>(param_this);
    if (isMuQtObject(arg0)) arg0->QUdpSocket::resume();
    else arg0->resume();
}
...
void qt_QUdpSocket_setReadBufferSize_void_QUdpSocket_int64(Mu::Thread& NODE_THREAD, Pointer param_this, int64 param_size)
{
    ...
    if (isMuQtObject(arg0)) arg0->QUdpSocket::setReadBufferSize(arg1);
    else arg0->setReadBufferSize(arg1);
}

void qt_QUdpSocket_setSocketOption_void_QUdpSocket_int_QVariant(Mu::Thread& NODE_THREAD, Pointer param_this, int param_option, Pointer param_value)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QUdpSocket* arg0 = object<QUdpSocket>(param_this);
    ...
    if (isMuQtObject(arg0)) arg0->QUdpSocket::setSocketOption(arg1, arg2);
...
Pointer qt_QUdpSocket_socketOption_QVariant_QUdpSocket_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_option)
{
    ...
    QUdpSocket* arg0 = object<QUdpSocket>(param_this);
    QAbstractSocket::SocketOption arg1 = (QAbstractSocket::SocketOption)(param_option);
    return isMuQtObject(arg0) ? makeqtype<QVariantType>(c,arg0->QUdpSocket::socketOption(arg1),"qt.QVariant") : makeqtype<QVariantType>(c,arg0->socketOption(arg1),"qt.QVariant");
}
...
{
    qt_QUdpSocket_resume_void_QUdpSocket(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    qt_QUdpSocket_setSocketOption_void_QUdpSocket_int_QVariant(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer));
}
...
addSymbols(
    ...
    // MISSING: receiveDatagram ("QNetworkDatagram"; QUdpSocket this, int64 maxSize)
    ...
    // MISSING: writeDatagram (int64; QUdpSocket this, "const QNetworkDatagram &" datagram)
    // MISSING: writeDatagram (int64; QUdpSocket this, QByteArray datagram, QHostAddress host, "quint16" port)
    // MISSING: bind (bool; QUdpSocket this, QHostAddress address, "quint16" port, flags QAbstractSocket::BindMode mode)
    // MISSING: connectToHost (void; QUdpSocket this, string hostName, "quint16" port, flags QIODeviceBase::OpenMode openMode, flags QAbstractSocket::NetworkLayerProtocol protocol)
    _func[0] = new MemberFunction(c, "disconnectFromHost", _n_disconnectFromHost0, None, Compiled, qt_QUdpSocket_disconnectFromHost_void_QUdpSocket, Return, "void", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
    _func[1] = new MemberFunction(c, "resume", _n_resume0, None, Compiled, qt_QUdpSocket_resume_void_QUdpSocket, Return, "void", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
    _func[2] = new MemberFunction(c, "setReadBufferSize", _n_setReadBufferSize0, None, Compiled, qt_QUdpSocket_setReadBufferSize_void_QUdpSocket_int64, Return, "void", Parameters, new Param(c, "this", "qt.QUdpSocket"), new Param(c, "size", "int64"), End),
    // MISSING: setSocketDescriptor (bool; QUdpSocket this, "qintptr" socketDescriptor, flags QAbstractSocket::SocketState socketState, flags QIODeviceBase::OpenMode openMode)
    _func[3] = new MemberFunction(c, "setSocketOption", _n_setSocketOption0, None, Compiled, qt_QUdpSocket_setSocketOption_void_QUdpSocket_int_QVariant, Return, "void", Parameters, new Param(c, "this", "qt.QUdpSocket"), new Param(c, "option", "int"), new Param(c, "value", "qt.QVariant"), End),
    // MISSING: socketDescriptor ("qintptr"; QUdpSocket this)
    _func[4] = new MemberFunction(c, "socketOption", _n_socketOption0, None, Compiled, qt_QUdpSocket_socketOption_QVariant_QUdpSocket_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QUdpSocket"), new Param(c, "option", "int"), End),
    _func[5] = new MemberFunction(c, "waitForConnected", _n_waitForConnected0, None, Compiled, qt_QUdpSocket_waitForConnected_bool_QUdpSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QUdpSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    _func[6] = new MemberFunction(c, "waitForDisconnected", _n_waitForDisconnected0, None, Compiled, qt_QUdpSocket_waitForDisconnected_bool_QUdpSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QUdpSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    _func[7] = new MemberFunction(c, "bytesAvailable", _n_bytesAvailable0, None, Compiled, qt_QUdpSocket_bytesAvailable_int64_QUdpSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
    _func[8] = new MemberFunction(c, "bytesToWrite", _n_bytesToWrite0, None, Compiled, qt_QUdpSocket_bytesToWrite_int64_QUdpSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
    _func[9] = new MemberFunction(c, "close", _n_close0, None, Compiled, qt_QUdpSocket_close_void_QUdpSocket, Return, "void", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
    _func[10] = new MemberFunction(c, "isSequential", _n_isSequential0, None, Compiled, qt_QUdpSocket_isSequential_bool_QUdpSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
    _func[11] = new MemberFunction(c, "waitForBytesWritten", _n_waitForBytesWritten0, None, Compiled, qt_QUdpSocket_waitForBytesWritten_bool_QUdpSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QUdpSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    _func[12] = new MemberFunction(c, "waitForReadyRead", _n_waitForReadyRead0, None, Compiled, qt_QUdpSocket_waitForReadyRead_bool_QUdpSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QUdpSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    ...
    _func[13] = new MemberFunction(c, "skipData", _n_skipData0, None, Compiled, qt_QUdpSocket_skipData_int64_QUdpSocket_int64, Return, "int64", Parameters, new Param(c, "this", "qt.QUdpSocket"), new Param(c, "maxSize", "int64"), End),
