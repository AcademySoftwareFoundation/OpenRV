...
QModelIndexType::Instance::Instance(const Class* c) : ClassInstance(c)
{
}
...
void 
QModelIndexType::registerFinalizer (void* o)
{
    GC_register_finalizer(o, QModelIndexType::finalizer, 0, 0, 0);
}

void 
QModelIndexType::finalizer (void* obj, void* data)
{
...
Pointer qt_QModelIndex_sibling_QModelIndex_QModelIndex_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_row, int param_column)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QModelIndex arg0 = getqtype<QModelIndexType>(param_this);
...
{
    NODE_RETURN(qt_QModelIndex_row_int_QModelIndex(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_sibling0, Pointer)
{
    NODE_RETURN(qt_QModelIndex_sibling_QModelIndex_QModelIndex_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
}
...
{
    NODE_RETURN(qt_QModelIndex_operatorBang_EQ__bool_QModelIndex_QModelIndex(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}

static NODE_IMPLEMENTATION(_n_operatorLT_0, bool)
{
    NODE_RETURN(qt_QModelIndex_operatorLT__bool_QModelIndex_QModelIndex(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}

static NODE_IMPLEMENTATION(_n_operatorEQ_EQ_0, bool)
{
    NODE_RETURN(qt_QModelIndex_operatorEQ_EQ__bool_QModelIndex_QModelIndex(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QModelIndex", _n_QModelIndex0, None, Compiled, qt_QModelIndex_QModelIndex_QModelIndex_QModelIndex, Return, "qt.QModelIndex", Parameters, new Param(c, "this", "qt.QModelIndex"), End),
    new Function(c, "column", _n_column0, None, Compiled, qt_QModelIndex_column_int_QModelIndex, Return, "int", Parameters, new Param(c, "this", "qt.QModelIndex"), End),
    // MISSING: constInternalPointer ("const void *"; QModelIndex this)
    new Function(c, "data", _n_data0, None, Compiled, qt_QModelIndex_data_QVariant_QModelIndex_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QModelIndex"), new Param(c, "role", "int", Value((int)Qt::DisplayRole)), End),
    new Function(c, "flags", _n_flags0, None, Compiled, qt_QModelIndex_flags_int_QModelIndex, Return, "int", Parameters, new Param(c, "this", "qt.QModelIndex"), End),
    // MISSING: internalId ("quintptr"; QModelIndex this)
    // MISSING: internalPointer ("void *"; QModelIndex this)
    new Function(c, "isValid", _n_isValid0, None, Compiled, qt_QModelIndex_isValid_bool_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QModelIndex"), End),
    ...
    // MISSING: multiData (void; QModelIndex this, "QModelRoleDataSpan" roleDataSpan)
    new Function(c, "parent", _n_parent0, None, Compiled, qt_QModelIndex_parent_QModelIndex_QModelIndex, Return, "qt.QModelIndex", Parameters, new Param(c, "this", "qt.QModelIndex"), End),
    ...
    new Function(c, "sibling", _n_sibling0, None, Compiled, qt_QModelIndex_sibling_QModelIndex_QModelIndex_int_int, Return, "qt.QModelIndex", Parameters, new Param(c, "this", "qt.QModelIndex"), new Param(c, "row", "int"), new Param(c, "column", "int"), End),
    new Function(c, "siblingAtColumn", _n_siblingAtColumn0, None, Compiled, qt_QModelIndex_siblingAtColumn_QModelIndex_QModelIndex_int, Return, "qt.QModelIndex", Parameters, new Param(c, "this", "qt.QModelIndex"), new Param(c, "column", "int"), End),
    new Function(c, "siblingAtRow", _n_siblingAtRow0, None, Compiled, qt_QModelIndex_siblingAtRow_QModelIndex_QModelIndex_int, Return, "qt.QModelIndex", Parameters, new Param(c, "this", "qt.QModelIndex"), new Param(c, "row", "int"), End),
    // static functions
    EndArguments);
globalScope()->addSymbols(
    new Function(c, "!=", _n_operatorBang_EQ_0, Op, Compiled, qt_QModelIndex_operatorBang_EQ__bool_QModelIndex_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QModelIndex"), new Param(c, "other", "qt.QModelIndex"), End),
    new Function(c, "<", _n_operatorLT_0, Op, Compiled, qt_QModelIndex_operatorLT__bool_QModelIndex_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QModelIndex"), new Param(c, "other", "qt.QModelIndex"), End),
    new Function(c, "==", _n_operatorEQ_EQ_0, Op, Compiled, qt_QModelIndex_operatorEQ_EQ__bool_QModelIndex_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QModelIndex"), new Param(c, "other", "qt.QModelIndex"), End),
    EndArguments);
scope()->addSymbols(
    EndArguments);
