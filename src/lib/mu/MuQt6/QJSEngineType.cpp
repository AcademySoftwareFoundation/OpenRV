...
{
    if (!_env) return QJSEngine::event(e);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QJSEngine::eventFilter(watched, event);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QJSEngine::customEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QJSEngine::timerEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QJSEngine_QJSEngine_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    {
        QJSEngineType* type = 
            c->findSymbolOfTypeByQualifiedName<QJSEngineType>(c->internName("qt.QJSEngine"), false);
...
{
    NODE_RETURN( QJSEngine_QJSEngine_QObject(NODE_THREAD, NODE_ARG(0, Pointer)) );
}
...
void qt_QJSEngine_throwError_void_QJSEngine_int_string(Mu::Thread& NODE_THREAD, Pointer param_this, int param_errorType, Pointer param_message)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QJSEngine* arg0 = object<QJSEngine>(param_this);
...
bool qt_QJSEngine_eventFilter_bool_QJSEngine_QObject_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_watched, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QJSEngine* arg0 = object<QJSEngine>(param_this);
...
void qt_QJSEngine_customEvent_void_QJSEngine_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QJSEngine*)arg0)->customEvent_pub_parent(arg1);
    else ((MuQt_QJSEngine*)arg0)->customEvent_pub(arg1);
}
...
void qt_QJSEngine_timerEvent_void_QJSEngine_QTimerEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QJSEngine*)arg0)->timerEvent_pub_parent(arg1);
    else ((MuQt_QJSEngine*)arg0)->timerEvent_pub(arg1);
}
...
{
    NODE_RETURN(qt_QJSEngine_eventFilter_bool_QJSEngine_QObject_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
QJSEngineType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QJSEngine_QJSEngine_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QJSEngine", _n_QJSEngine0, None, Compiled, qt_QJSEngine_QJSEngine_QJSEngine_QJSEngine, Return, "qt.QJSEngine", Parameters, new Param(c, "this", "qt.QJSEngine"), End),
    new Function(c, "QJSEngine", _n_QJSEngine1, None, Compiled, qt_QJSEngine_QJSEngine_QJSEngine_QJSEngine_QObject, Return, "qt.QJSEngine", Parameters, new Param(c, "this", "qt.QJSEngine"), new Param(c, "parent", "qt.QObject"), End),
    // MISSING: catchError ("QJSValue"; QJSEngine this)
    // MISSING: coerceValue ("To"; QJSEngine this, "const From &" from)
    new Function(c, "collectGarbage", _n_collectGarbage0, None, Compiled, qt_QJSEngine_collectGarbage_void_QJSEngine, Return, "void", Parameters, new Param(c, "this", "qt.QJSEngine"), End),
    // MISSING: evaluate ("QJSValue"; QJSEngine this, string program, string fileName, int lineNumber, string[] exceptionStackTrace)
    // MISSING: fromManagedValue ("T"; QJSEngine this, "const QJSManagedValue &" value)
    // MISSING: fromPrimitiveValue ("T"; QJSEngine this, "const QJSPrimitiveValue &" value)
    // MISSING: fromScriptValue ("T"; QJSEngine this, "const QJSValue &" value)
    // MISSING: fromVariant ("T"; QJSEngine this, QVariant value)
    // MISSING: globalObject ("QJSValue"; QJSEngine this)
    new Function(c, "hasError", _n_hasError0, None, Compiled, qt_QJSEngine_hasError_bool_QJSEngine, Return, "bool", Parameters, new Param(c, "this", "qt.QJSEngine"), End),
    // MISSING: importModule ("QJSValue"; QJSEngine this, string fileName)
    // MISSING: installExtensions (void; QJSEngine this, flags QJSEngine::Extensions extensions, "const QJSValue &" object)
    new Function(c, "isInterrupted", _n_isInterrupted0, None, Compiled, qt_QJSEngine_isInterrupted_bool_QJSEngine, Return, "bool", Parameters, new Param(c, "this", "qt.QJSEngine"), End),
    // MISSING: newArray ("QJSValue"; QJSEngine this, int length)
    // MISSING: newErrorObject ("QJSValue"; QJSEngine this, flags QJSValue::ErrorType errorType, string message)
    // MISSING: newObject ("QJSValue"; QJSEngine this)
    // MISSING: newQMetaObject ("QJSValue"; QJSEngine this, "const QMetaObject *" metaObject)
    // MISSING: newQMetaObject ("QJSValue"; QJSEngine this)
    // MISSING: newQObject ("QJSValue"; QJSEngine this, QObject object)
    // MISSING: newSymbol ("QJSValue"; QJSEngine this, string name)
    // MISSING: registerModule (bool; QJSEngine this, string moduleName, "const QJSValue &" value)
    new Function(c, "setInterrupted", _n_setInterrupted0, None, Compiled, qt_QJSEngine_setInterrupted_void_QJSEngine_bool, Return, "void", Parameters, new Param(c, "this", "qt.QJSEngine"), new Param(c, "interrupted", "bool"), End),
    // PROP: setUiLanguage (void; QJSEngine this, string language)
    new Function(c, "throwError", _n_throwError0, None, Compiled, qt_QJSEngine_throwError_void_QJSEngine_string, Return, "void", Parameters, new Param(c, "this", "qt.QJSEngine"), new Param(c, "message", "string"), End),
    new Function(c, "throwError", _n_throwError1, None, Compiled, qt_QJSEngine_throwError_void_QJSEngine_int_string, Return, "void", Parameters, new Param(c, "this", "qt.QJSEngine"), new Param(c, "errorType", "int"), new Param(c, "message", "string"), End),
    // MISSING: throwError (void; QJSEngine this, "const QJSValue &" error)
    // MISSING: toManagedValue ("QJSManagedValue"; QJSEngine this, "const T &" value)
    // MISSING: toPrimitiveValue ("QJSPrimitiveValue"; QJSEngine this, "const T &" value)
    // MISSING: toScriptValue ("QJSValue"; QJSEngine this, "const T &" value)
    // PROP: uiLanguage (string; QJSEngine this)
    _func[0] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QJSEngine_event_bool_QJSEngine_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QJSEngine"), new Param(c, "e", "qt.QEvent"), End),
    _func[1] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled, qt_QJSEngine_eventFilter_bool_QJSEngine_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QJSEngine"), new Param(c, "watched", "qt.QObject"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: metaObject ("const QMetaObject *"; QJSEngine this)
    // MISSING: childEvent (void; QJSEngine this, "QChildEvent *" event) // protected
    // MISSING: connectNotify (void; QJSEngine this, "const QMetaMethod &" signal) // protected
    _func[2] = new MemberFunction(c, "customEvent", _n_customEvent0, None, Compiled, qt_QJSEngine_customEvent_void_QJSEngine_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QJSEngine"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: disconnectNotify (void; QJSEngine this, "const QMetaMethod &" signal) // protected
    _func[3] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QJSEngine_timerEvent_void_QJSEngine_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QJSEngine"), new Param(c, "event", "qt.QTimerEvent"), End),
    // static functions
    new Function(c, "objectOwnership", _n_objectOwnership0, None, Compiled, qt_QJSEngine_objectOwnership_int_QObject, Return, "int", Parameters, new Param(c, "object", "qt.QObject"), End),
    new Function(c, "setObjectOwnership", _n_setObjectOwnership0, None, Compiled, qt_QJSEngine_setObjectOwnership_void_QObject_int, Return, "void", Parameters, new Param(c, "object", "qt.QObject"), new Param(c, "ownership", "int"), End),
    EndArguments);
