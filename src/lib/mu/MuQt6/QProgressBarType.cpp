...
namespace Mu
{
    ...
    void QProgressBarType::load()
    {
        ...
        addSymbols(
            ...
            // MISSING: enterEvent (void; QProgressBar this, "QEnterEvent *"
            // event) // protected
            ...
            // painter) // protected
            _func[31] = new MemberFunction(c, "metric", _n_metric0, None, Compiled, qt_QProgressBar_metric_int_QProgressBar_int, Return,
