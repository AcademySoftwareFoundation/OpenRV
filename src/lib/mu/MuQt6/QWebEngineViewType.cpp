...
{
    if (!_env) return QWebEngineView::sizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QWebEngineView::createWindow(type);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::closeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::contextMenuEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
void MuQt_QWebEngineView::dragEnterEvent(QDragEnterEvent * e) 
{
    if (!_env) { QWebEngineView::dragEnterEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
void MuQt_QWebEngineView::dragLeaveEvent(QDragLeaveEvent * e) 
{
    if (!_env) { QWebEngineView::dragLeaveEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
void MuQt_QWebEngineView::dragMoveEvent(QDragMoveEvent * e) 
{
    if (!_env) { QWebEngineView::dragMoveEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
void MuQt_QWebEngineView::dropEvent(QDropEvent * e) 
{
    if (!_env) { QWebEngineView::dropEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QWebEngineView::event(ev);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::hideEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::showEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QWebEngineView::hasHeightForWidth();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QWebEngineView::heightForWidth(w);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QWebEngineView::inputMethodQuery(query);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QWebEngineView::minimumSizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::changeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::focusInEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QWebEngineView::focusNextPrevChild(next);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::focusOutEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::keyPressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::keyReleaseEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::leaveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::mouseDoubleClickEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::mouseMoveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::mousePressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::mouseReleaseEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::moveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::paintEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::resizeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::tabletEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineView::wheelEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
int MuQt_QWebEngineView::metric(QPaintDevice::PaintDeviceMetric m) const
{
    if (!_env) return QWebEngineView::metric(m);
    MuLangContext* c = (MuLangContext*)_env->context();
    ...
    {
        return QWebEngineView::metric(m);
    }
}
...
static Pointer
QWebEngineView_QWebEngineView_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    else if (QWebEngineView* w = object<QWebEngineView>(widget))
    {
        QWebEngineViewType* type = 
            c->findSymbolOfTypeByQualifiedName<QWebEngineViewType>(c->internName("qt.QWebEngineView"), false);
...
Pointer qt_QWebEngineView_QWebEngineView_QWebEngineView_QWebEngineView_QWidget(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_parent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QWebEngineView_QWebEngineView_QWebEngineView_QWebEngineView_QWebEngineProfile_QWidget(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_profile, Pointer param_parent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QWebEngineView_QWebEngineView_QWebEngineView_QWebEngineView_QWebEnginePage_QWidget(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_page, Pointer param_parent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
void qt_QWebEngineView_setContent_void_QWebEngineView_QByteArray_string_QUrl(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_data, Pointer param_mimeType, Pointer param_baseUrl)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
...
void qt_QWebEngineView_setHtml_void_QWebEngineView_string_QUrl(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_html, Pointer param_baseUrl)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
...
void qt_QWebEngineView_triggerPageAction_void_QWebEngineView_int_bool(Mu::Thread& NODE_THREAD, Pointer param_this, int param_action, bool param_checked)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
    QWebEnginePage::WebAction arg1 = (QWebEnginePage::WebAction)(param_action);
...
Pointer qt_QWebEngineView_sizeHint_QSize_QWebEngineView(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QWebEngineView::sizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->sizeHint(),"qt.QSize");
}
...
Pointer qt_QWebEngineView_createWindow_QWebEngineView_QWebEngineView_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_type)
{
    ...
    return isMuQtObject(arg0) ? makeinstance<QWebEngineViewType>(c, ((MuQt_QWebEngineView*)arg0)->createWindow_pub_parent(arg1), "qt.QWebEngineView") : makeinstance<QWebEngineViewType>(c, ((MuQt_QWebEngineView*)arg0)->createWindow_pub(arg1), "qt.QWebEngineView");
}
...
void qt_QWebEngineView_closeEvent_void_QWebEngineView_QCloseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->closeEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->closeEvent_pub(arg1);
}

void qt_QWebEngineView_contextMenuEvent_void_QWebEngineView_QContextMenuEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
    QContextMenuEvent * arg1 = getqpointer<QContextMenuEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->contextMenuEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->contextMenuEvent_pub(arg1);
}
...
void qt_QWebEngineView_dragEnterEvent_void_QWebEngineView_QDragEnterEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->dragEnterEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->dragEnterEvent_pub(arg1);
}
...
void qt_QWebEngineView_dragLeaveEvent_void_QWebEngineView_QDragLeaveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->dragLeaveEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->dragLeaveEvent_pub(arg1);
}
...
void qt_QWebEngineView_dragMoveEvent_void_QWebEngineView_QDragMoveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->dragMoveEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->dragMoveEvent_pub(arg1);
}
...
void qt_QWebEngineView_dropEvent_void_QWebEngineView_QDropEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->dropEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->dropEvent_pub(arg1);
}
...
void qt_QWebEngineView_hideEvent_void_QWebEngineView_QHideEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->hideEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->hideEvent_pub(arg1);
}
...
void qt_QWebEngineView_showEvent_void_QWebEngineView_QShowEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->showEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->showEvent_pub(arg1);
}
...
Pointer qt_QWebEngineView_inputMethodQuery_QVariant_QWebEngineView_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_query)
{
    ...
    return isMuQtObject(arg0) ? makeqtype<QVariantType>(c,arg0->QWebEngineView::inputMethodQuery(arg1),"qt.QVariant") : makeqtype<QVariantType>(c,arg0->inputMethodQuery(arg1),"qt.QVariant");
}
...
Pointer qt_QWebEngineView_minimumSizeHint_QSize_QWebEngineView(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QWebEngineView::minimumSizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->minimumSizeHint(),"qt.QSize");
}
...
void qt_QWebEngineView_changeEvent_void_QWebEngineView_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->changeEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->changeEvent_pub(arg1);
}
...
void qt_QWebEngineView_focusInEvent_void_QWebEngineView_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->focusInEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->focusInEvent_pub(arg1);
}
...
bool qt_QWebEngineView_focusNextPrevChild_bool_QWebEngineView_bool(Mu::Thread& NODE_THREAD, Pointer param_this, bool param_next)
{
    ...
    return isMuQtObject(arg0) ? ((MuQt_QWebEngineView*)arg0)->focusNextPrevChild_pub_parent(arg1) : ((MuQt_QWebEngineView*)arg0)->focusNextPrevChild_pub(arg1);
}
...
void qt_QWebEngineView_focusOutEvent_void_QWebEngineView_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
    QFocusEvent * arg1 = getqpointer<QFocusEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->focusOutEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->focusOutEvent_pub(arg1);
}
...
void qt_QWebEngineView_keyPressEvent_void_QWebEngineView_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    else ((MuQt_QWebEngineView*)arg0)->keyPressEvent_pub(arg1);
}
...
void qt_QWebEngineView_keyReleaseEvent_void_QWebEngineView_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
    QKeyEvent * arg1 = getqpointer<QKeyEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->keyReleaseEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->keyReleaseEvent_pub(arg1);
}
...
void qt_QWebEngineView_leaveEvent_void_QWebEngineView_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
    QEvent * arg1 = getqpointer<QEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->leaveEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->leaveEvent_pub(arg1);
}

void qt_QWebEngineView_mouseDoubleClickEvent_void_QWebEngineView_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->mouseDoubleClickEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->mouseDoubleClickEvent_pub(arg1);
}
...
void qt_QWebEngineView_mouseMoveEvent_void_QWebEngineView_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->mouseMoveEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->mouseMoveEvent_pub(arg1);
}
...
void qt_QWebEngineView_mousePressEvent_void_QWebEngineView_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->mousePressEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->mousePressEvent_pub(arg1);
}

void qt_QWebEngineView_mouseReleaseEvent_void_QWebEngineView_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineView* arg0 = object<QWebEngineView>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->mouseReleaseEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->mouseReleaseEvent_pub(arg1);
}
...
void qt_QWebEngineView_moveEvent_void_QWebEngineView_QMoveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->moveEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->moveEvent_pub(arg1);
}
...
void qt_QWebEngineView_paintEvent_void_QWebEngineView_QPaintEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->paintEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->paintEvent_pub(arg1);
}
...
void qt_QWebEngineView_resizeEvent_void_QWebEngineView_QResizeEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->resizeEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->resizeEvent_pub(arg1);
}
...
void qt_QWebEngineView_tabletEvent_void_QWebEngineView_QTabletEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->tabletEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->tabletEvent_pub(arg1);
}
...
void qt_QWebEngineView_wheelEvent_void_QWebEngineView_QWheelEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineView*)arg0)->wheelEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineView*)arg0)->wheelEvent_pub(arg1);
}
...
{
    NODE_RETURN(qt_QWebEngineView_QWebEngineView_QWebEngineView_QWebEngineView_QWidget(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}

static NODE_IMPLEMENTATION(_n_QWebEngineView1, Pointer)
{
    NODE_RETURN(qt_QWebEngineView_QWebEngineView_QWebEngineView_QWebEngineView_QWebEngineProfile_QWidget(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}

static NODE_IMPLEMENTATION(_n_QWebEngineView2, Pointer)
{
    NODE_RETURN(qt_QWebEngineView_QWebEngineView_QWebEngineView_QWebEngineView_QWebEnginePage_QWidget(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
{
    qt_QWebEngineView_setContent_void_QWebEngineView_QByteArray_string_QUrl(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer), NODE_ARG(3, Pointer));
}

static NODE_IMPLEMENTATION(_n_setHtml0, void)
{
    qt_QWebEngineView_setHtml_void_QWebEngineView_string_QUrl(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer));
}
...
{
    qt_QWebEngineView_triggerPageAction_void_QWebEngineView_int_bool(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, bool));
}
...
{
    NODE_RETURN(qt_QWebEngineView_createWindow_QWebEngineView_QWebEngineView_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
}
...
{
    qt_QWebEngineView_contextMenuEvent_void_QWebEngineView_QContextMenuEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}

static NODE_IMPLEMENTATION(_n_dragEnterEvent0, void)
{
    qt_QWebEngineView_dragEnterEvent_void_QWebEngineView_QDragEnterEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}

static NODE_IMPLEMENTATION(_n_dragLeaveEvent0, void)
{
    qt_QWebEngineView_dragLeaveEvent_void_QWebEngineView_QDragLeaveEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
{
    NODE_RETURN(qt_QWebEngineView_inputMethodQuery_QVariant_QWebEngineView_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
}
...
{
    NODE_RETURN(qt_QWebEngineView_focusNextPrevChild_bool_QWebEngineView_bool(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, bool)));
}
...
{
    qt_QWebEngineView_mouseDoubleClickEvent_void_QWebEngineView_QMouseEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
QWebEngineViewType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QWebEngineView_QWebEngineView_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QWebEngineView", _n_QWebEngineView0, None, Compiled, qt_QWebEngineView_QWebEngineView_QWebEngineView_QWebEngineView_QWidget, Return, "qt.QWebEngineView", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "parent", "qt.QWidget"), End),
    ...
    new Function(c, "load", _n_load0, None, Compiled, qt_QWebEngineView_load_void_QWebEngineView_QUrl, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "url", "qt.QUrl"), End),
    // MISSING: load (void; QWebEngineView this, "const QWebEngineHttpRequest &" request)
    new Function(c, "page", _n_page0, None, Compiled, qt_QWebEngineView_page_QWebEnginePage_QWebEngineView, Return, "qt.QWebEnginePage", Parameters, new Param(c, "this", "qt.QWebEngineView"), End),
    new Function(c, "pageAction", _n_pageAction0, None, Compiled, qt_QWebEngineView_pageAction_QAction_QWebEngineView_int, Return, "qt.QAction", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "action", "int"), End),
    // MISSING: print (void; QWebEngineView this, "QPrinter *" printer)
    // MISSING: printToPdf (void; QWebEngineView this, string filePath, "const QPageLayout &" layout, "const QPageRanges &" ranges)
    // MISSING: printToPdf (void; QWebEngineView this, flags const std::function<void (const QByteArray & )> & resultCallback, "const QPageLayout &" layout, "const QPageRanges &" ranges)
    // PROP: selectedText (string; QWebEngineView this)
    new Function(c, "setContent", _n_setContent0, None, Compiled, qt_QWebEngineView_setContent_void_QWebEngineView_QByteArray_string_QUrl, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "data", "qt.QByteArray"), new Param(c, "mimeType", "string"), new Param(c, "baseUrl", "qt.QUrl"), End),
    new Function(c, "setHtml", _n_setHtml0, None, Compiled, qt_QWebEngineView_setHtml_void_QWebEngineView_string_QUrl, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "html", "string"), new Param(c, "baseUrl", "qt.QUrl"), End),
    new Function(c, "setPage", _n_setPage0, None, Compiled, qt_QWebEngineView_setPage_void_QWebEngineView_QWebEnginePage, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "page", "qt.QWebEnginePage"), End),
    // PROP: setUrl (void; QWebEngineView this, QUrl url)
    // PROP: setZoomFactor (void; QWebEngineView this, double factor)
    new Function(c, "settings", _n_settings0, None, Compiled, qt_QWebEngineView_settings_QWebEngineSettings_QWebEngineView, Return, "qt.QWebEngineSettings", Parameters, new Param(c, "this", "qt.QWebEngineView"), End),
    // PROP: title (string; QWebEngineView this)
    new Function(c, "triggerPageAction", _n_triggerPageAction0, None, Compiled, qt_QWebEngineView_triggerPageAction_void_QWebEngineView_int_bool, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "action", "int"), new Param(c, "checked", "bool"), End),
    // PROP: url (QUrl; QWebEngineView this)
    // PROP: zoomFactor (double; QWebEngineView this)
    _func[0] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QWebEngineView_sizeHint_QSize_QWebEngineView, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QWebEngineView"), End),
    _func[1] = new MemberFunction(c, "createWindow", _n_createWindow0, None, Compiled, qt_QWebEngineView_createWindow_QWebEngineView_QWebEngineView_int, Return, "qt.QWebEngineView", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "type", "int"), End),
    _func[2] = new MemberFunction(c, "closeEvent", _n_closeEvent0, None, Compiled, qt_QWebEngineView_closeEvent_void_QWebEngineView_QCloseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QCloseEvent"), End),
    _func[3] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled, qt_QWebEngineView_contextMenuEvent_void_QWebEngineView_QContextMenuEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QContextMenuEvent"), End),
    _func[4] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QWebEngineView_dragEnterEvent_void_QWebEngineView_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "e", "qt.QDragEnterEvent"), End),
    _func[5] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QWebEngineView_dragLeaveEvent_void_QWebEngineView_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "e", "qt.QDragLeaveEvent"), End),
    _func[6] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QWebEngineView_dragMoveEvent_void_QWebEngineView_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "e", "qt.QDragMoveEvent"), End),
    _func[7] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QWebEngineView_dropEvent_void_QWebEngineView_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "e", "qt.QDropEvent"), End),
    _func[8] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QWebEngineView_event_bool_QWebEngineView_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "ev", "qt.QEvent"), End),
    _func[9] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QWebEngineView_hideEvent_void_QWebEngineView_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QHideEvent"), End),
    _func[10] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QWebEngineView_showEvent_void_QWebEngineView_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QShowEvent"), End),
    _func[11] = new MemberFunction(c, "hasHeightForWidth", _n_hasHeightForWidth0, None, Compiled, qt_QWebEngineView_hasHeightForWidth_bool_QWebEngineView, Return, "bool", Parameters, new Param(c, "this", "qt.QWebEngineView"), End),
    _func[12] = new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QWebEngineView_heightForWidth_int_QWebEngineView_int, Return, "int", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "w", "int"), End),
    _func[13] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QWebEngineView_inputMethodQuery_QVariant_QWebEngineView_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "query", "int"), End),
    _func[14] = new MemberFunction(c, "minimumSizeHint", _n_minimumSizeHint0, None, Compiled, qt_QWebEngineView_minimumSizeHint_QSize_QWebEngineView, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QWebEngineView"), End),
    // MISSING: paintEngine ("QPaintEngine *"; QWebEngineView this)
    // MISSING: actionEvent (void; QWebEngineView this, "QActionEvent *" event) // protected
    _func[15] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled, qt_QWebEngineView_changeEvent_void_QWebEngineView_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: enterEvent (void; QWebEngineView this, "QEnterEvent *" event) // protected
    _func[16] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QWebEngineView_focusInEvent_void_QWebEngineView_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[17] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QWebEngineView_focusNextPrevChild_bool_QWebEngineView_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "next", "bool"), End),
    _func[18] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QWebEngineView_focusOutEvent_void_QWebEngineView_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QFocusEvent"), End),
    // MISSING: inputMethodEvent (void; QWebEngineView this, "QInputMethodEvent *" event) // protected
    _func[19] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QWebEngineView_keyPressEvent_void_QWebEngineView_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[20] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QWebEngineView_keyReleaseEvent_void_QWebEngineView_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[21] = new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QWebEngineView_leaveEvent_void_QWebEngineView_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QEvent"), End),
    _func[22] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QWebEngineView_mouseDoubleClickEvent_void_QWebEngineView_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[23] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QWebEngineView_mouseMoveEvent_void_QWebEngineView_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[24] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QWebEngineView_mousePressEvent_void_QWebEngineView_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[25] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QWebEngineView_mouseReleaseEvent_void_QWebEngineView_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[26] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QWebEngineView_moveEvent_void_QWebEngineView_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QWebEngineView this, QByteArray eventType, "void *" message, "qintptr *" result) // protected
    _func[27] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QWebEngineView_paintEvent_void_QWebEngineView_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QPaintEvent"), End),
    _func[28] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QWebEngineView_resizeEvent_void_QWebEngineView_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QResizeEvent"), End),
    _func[29] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QWebEngineView_tabletEvent_void_QWebEngineView_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QTabletEvent"), End),
    _func[30] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QWebEngineView_wheelEvent_void_QWebEngineView_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "event", "qt.QWheelEvent"), End),
    // MISSING: initPainter (void; QWebEngineView this, "QPainter *" painter) // protected
    _func[31] = new MemberFunction(c, "metric", _n_metric0, None, Compiled, qt_QWebEngineView_metric_int_QWebEngineView_int, Return, "int", Parameters, new Param(c, "this", "qt.QWebEngineView"), new Param(c, "m", "int"), End),
    // static functions
    new Function(c, "forPage", _n_forPage0, None, Compiled, qt_QWebEngineView_forPage_QWebEngineView_QWebEnginePage, Return, "qt.QWebEngineView", Parameters, new Param(c, "page", "qt.QWebEnginePage"), End),
    EndArguments);
