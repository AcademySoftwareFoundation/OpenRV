...
addSymbols(
    ...
    // MISSING: bindableBlockUpdates ("QBindable<bool>"; QWebChannel this)
    // MISSING: bindablePropertyUpdateInterval ("QBindable<int>"; QWebChannel this)
    ...
    // PROP: setPropertyUpdateInterval (void; QWebChannel this, int ms)
