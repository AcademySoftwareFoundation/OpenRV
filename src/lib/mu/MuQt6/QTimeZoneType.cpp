...
namespace Mu
{
    ...
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QTimeZone::Initialization arg1 =
            (QTimeZone::Initialization)(param_spec);
    ...
    Pointer
    qt_QTimeZone_asBackendZone_QTimeZone_QTimeZone(Mu::Thread& NODE_THREAD,
                                                   Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QTimeZone arg0 = getqtype<QTimeZoneType>(param_this);
        return makeqtype<QTimeZoneType>(c, arg0.asBackendZone(),
                                        "qt.QTimeZone");
    }
    ...
    int
    qt_QTimeZone_fixedSecondsAheadOfUtc_int_QTimeZone(Mu::Thread& NODE_THREAD,
                                                      Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QTimeZone arg0 = getqtype<QTimeZoneType>(param_this);
    ...
    bool qt_QTimeZone_isUtcOrFixedOffset_bool_QTimeZone(Mu::Thread& NODE_THREAD,
                                                        Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QTimeZone arg0 = getqtype<QTimeZoneType>(param_this);
    ...
    int qt_QTimeZone_territory_int_QTimeZone(Mu::Thread& NODE_THREAD,
                                             Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QTimeZone arg0 = getqtype<QTimeZoneType>(param_this);
    ...
    int qt_QTimeZone_timeSpec_int_QTimeZone(Mu::Thread& NODE_THREAD,
                                            Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QTimeZone arg0 = getqtype<QTimeZoneType>(param_this);
    ...
    Pointer
    qt_QTimeZone_fromDurationAheadOfUtc_QTimeZone_int(Mu::Thread& NODE_THREAD,
                                                      int param_offset)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        std::chrono::seconds arg0 = (std::chrono::seconds)(param_offset);
        return makeqtype<QTimeZoneType>(
            c, QTimeZone::fromDurationAheadOfUtc(arg0), "qt.QTimeZone");
    }

    Pointer
    qt_QTimeZone_fromSecondsAheadOfUtc_QTimeZone_int(Mu::Thread& NODE_THREAD,
                                                     int param_offset)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        int arg0 = (int)(param_offset);
        return makeqtype<QTimeZoneType>(
            c, QTimeZone::fromSecondsAheadOfUtc(arg0), "qt.QTimeZone");
    }
    ...
    bool qt_QTimeZone_isUtcOrFixedOffset_bool_int(Mu::Thread& NODE_THREAD,
                                                  int param_spec)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    Pointer qt_QTimeZone_windowsIdToDefaultIanaId_QByteArray_QByteArray_int(
        Mu::Thread& NODE_THREAD, Pointer param_windowsId, int param_territory)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QByteArray arg0 = getqtype<QByteArrayType>(param_windowsId);
    ...
    {
        NODE_RETURN(qt_QTimeZone_asBackendZone_QTimeZone_QTimeZone(
            NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    {
        NODE_RETURN(qt_QTimeZone_fixedSecondsAheadOfUtc_int_QTimeZone(
            NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    {
        NODE_RETURN(qt_QTimeZone_isUtcOrFixedOffset_bool_QTimeZone(
            NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    {
        NODE_RETURN(qt_QTimeZone_territory_int_QTimeZone(
            NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }

    static NODE_IMPLEMENTATION(_n_timeSpec0, int)
    {
        NODE_RETURN(qt_QTimeZone_timeSpec_int_QTimeZone(
            NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    {
        NODE_RETURN(qt_QTimeZone_fromDurationAheadOfUtc_QTimeZone_int(
            NODE_THREAD, NODE_ARG(0, int)));
    }

    static NODE_IMPLEMENTATION(_n_fromSecondsAheadOfUtc0, Pointer)
    {
        NODE_RETURN(qt_QTimeZone_fromSecondsAheadOfUtc_QTimeZone_int(
            NODE_THREAD, NODE_ARG(0, int)));
    }
    ...
    {
        NODE_RETURN(qt_QTimeZone_isUtcOrFixedOffset_bool_int(NODE_THREAD,
                                                             NODE_ARG(0, int)));
    }
    ...
    void QTimeZoneType::load()
    {
        ...
        addSymbols(
            ...
            new SymbolicConstant(c, "LocalTime", "int",
                                 Value(int(QTimeZone::LocalTime))),
        ...
        addSymbols(
            ...
            new Function(
                c, "QTimeZone", _n_QTimeZone4, None, Compiled,
                qt_QTimeZone_QTimeZone_QTimeZone_QTimeZone_QByteArray_int_string_string_int_string,
                Return, "qt.QTimeZone", Parameters,
                new Param(c, "this", "qt.QTimeZone"),
                ...
                new Param(c, "territory", "int",
                          Value((int)QLocale::AnyTerritory)),
            ...
            new Function(c, "asBackendZone", _n_asBackendZone0, None, Compiled,
                         qt_QTimeZone_asBackendZone_QTimeZone_QTimeZone, Return,
                         "qt.QTimeZone", Parameters,
                         new Param(c, "this", "qt.QTimeZone"), End),
            ...
            new Function(c, "fixedSecondsAheadOfUtc",
                         _n_fixedSecondsAheadOfUtc0, None, Compiled,
                         qt_QTimeZone_fixedSecondsAheadOfUtc_int_QTimeZone,
            ...
            new Function(
                ...
                new Param(c, "atDateTime", "qt.QDateTime"), End),
            new Function(
                c, "isUtcOrFixedOffset", _n_isUtcOrFixedOffset0, None, Compiled,
                qt_QTimeZone_isUtcOrFixedOffset_bool_QTimeZone, Return, "bool",
            ...
            new Function(c, "territory", _n_territory0, None, Compiled,
                         qt_QTimeZone_territory_int_QTimeZone, Return, "int",
                         Parameters, new Param(c, "this", "qt.QTimeZone"), End),
            new Function(c, "timeSpec", _n_timeSpec0, None, Compiled,
                         qt_QTimeZone_timeSpec_int_QTimeZone, Return, "int",
                         Parameters, new Param(c, "this", "qt.QTimeZone"), End),
            ...
            new Function(c, "fromDurationAheadOfUtc",
                         _n_fromDurationAheadOfUtc0, None, Compiled,
                         qt_QTimeZone_fromDurationAheadOfUtc_QTimeZone_int,
                         Return, "qt.QTimeZone", Parameters,
                         new Param(c, "offset", "int"), End),
            // MISSING: fromNSTimeZone (QTimeZone; "const NSTimeZone *"
            // timeZone)
            new Function(c, "fromSecondsAheadOfUtc", _n_fromSecondsAheadOfUtc0,
                         None, Compiled,
                         qt_QTimeZone_fromSecondsAheadOfUtc_QTimeZone_int,
                         Return, "qt.QTimeZone", Parameters,
                         new Param(c, "offset", "int"), End),
            ...
            new Function(c, "isTimeZoneIdAvailable", _n_isTimeZoneIdAvailable0,
                         ...
                         Return, "bool", Parameters,
                         new Param(c, "ianaId", "qt.QByteArray"), End),
            new Function(c, "isUtcOrFixedOffset", _n_isUtcOrFixedOffset1, None,
                         Compiled, qt_QTimeZone_isUtcOrFixedOffset_bool_int,
                         Return, "bool", Parameters,
                         new Param(c, "spec", "int"), End),
