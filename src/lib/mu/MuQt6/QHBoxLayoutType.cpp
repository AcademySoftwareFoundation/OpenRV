...
namespace Mu
{
    ...
    void qt_QHBoxLayout_setSpacing_void_QHBoxLayout_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_spacing)
    {
        ...
        if (isMuQtObject(arg0))
            arg0->QHBoxLayout::setSpacing(arg1);
        else
    ...
    void QHBoxLayoutType::load()
    {
        ...
        addSymbols(
            ...
            _func[11] =
                new MemberFunction(c, "setSpacing", _n_setSpacing0, None, Compiled, qt_QHBoxLayout_setSpacing_void_QHBoxLayout_int, Return,
                                   "void", Parameters, new Param(c, "this", "qt.QHBoxLayout"), new Param(c, "spacing", "int"), End),
            _func[12] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QHBoxLayout_sizeHint_QSize_QHBoxLayout, Return,
                                           "qt.QSize", Parameters, new Param(c, "this", "qt.QHBoxLayout"), End),
            _func[13] = new MemberFunction(c, "spacing", _n_spacing0, None, Compiled, qt_QHBoxLayout_spacing_int_QHBoxLayout, Return, "int",
                                           Parameters, new Param(c, "this", "qt.QHBoxLayout"), End),
            _func[14] =
