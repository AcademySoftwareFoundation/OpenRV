...
QSizeType::Instance::Instance(const Class* c) : ClassInstance(c)
{
}
...
void 
QSizeType::registerFinalizer (void* o)
{
    GC_register_finalizer(o, QSizeType::finalizer, 0, 0, 0);
}

void 
QSizeType::finalizer (void* obj, void* data)
{
...
void qt_QSize_scale_void_QSize_int_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_width, int param_height, int param_mode)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QSize arg0 = getqtype<QSizeType>(param_this);
    int arg1 = (int)(param_width);
...
{
    NODE_RETURN(qt_QSize_height_int_QSize(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_isEmpty0, bool)
{
    NODE_RETURN(qt_QSize_isEmpty_bool_QSize(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_isNull0, bool)
{
    NODE_RETURN(qt_QSize_isNull_bool_QSize(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_isValid0, bool)
{
    NODE_RETURN(qt_QSize_isValid_bool_QSize(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_scale0, void)
{
    qt_QSize_scale_void_QSize_int_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int), NODE_ARG(3, int));
}
...
{
    NODE_RETURN(qt_QSize_width_int_QSize(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QSize", _n_QSize0, None, Compiled, qt_QSize_QSize_QSize_QSize, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSize"), End),
    new Function(c, "QSize", _n_QSize1, None, Compiled, qt_QSize_QSize_QSize_QSize_int_int, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSize"), new Param(c, "width", "int"), new Param(c, "height", "int"), End),
    new Function(c, "boundedTo", _n_boundedTo0, None, Compiled, qt_QSize_boundedTo_QSize_QSize_QSize, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSize"), new Param(c, "otherSize", "qt.QSize"), End),
    new Function(c, "expandedTo", _n_expandedTo0, None, Compiled, qt_QSize_expandedTo_QSize_QSize_QSize, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSize"), new Param(c, "otherSize", "qt.QSize"), End),
    new Function(c, "grownBy", _n_grownBy0, None, Compiled, qt_QSize_grownBy_QSize_QSize_QMargins, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSize"), new Param(c, "margins", "qt.QMargins"), End),
    new Function(c, "height", _n_height0, None, Compiled, qt_QSize_height_int_QSize, Return, "int", Parameters, new Param(c, "this", "qt.QSize"), End),
    new Function(c, "isEmpty", _n_isEmpty0, None, Compiled, qt_QSize_isEmpty_bool_QSize, Return, "bool", Parameters, new Param(c, "this", "qt.QSize"), End),
    new Function(c, "isNull", _n_isNull0, None, Compiled, qt_QSize_isNull_bool_QSize, Return, "bool", Parameters, new Param(c, "this", "qt.QSize"), End),
    new Function(c, "isValid", _n_isValid0, None, Compiled, qt_QSize_isValid_bool_QSize, Return, "bool", Parameters, new Param(c, "this", "qt.QSize"), End),
    // MISSING: rheight ("int &"; QSize this)
    // MISSING: rwidth ("int &"; QSize this)
    new Function(c, "scale", _n_scale0, None, Compiled, qt_QSize_scale_void_QSize_int_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QSize"), new Param(c, "width", "int"), new Param(c, "height", "int"), new Param(c, "mode", "int"), End),
    new Function(c, "scale", _n_scale1, None, Compiled, qt_QSize_scale_void_QSize_QSize_int, Return, "void", Parameters, new Param(c, "this", "qt.QSize"), new Param(c, "size", "qt.QSize"), new Param(c, "mode", "int"), End),
    new Function(c, "setHeight", _n_setHeight0, None, Compiled, qt_QSize_setHeight_void_QSize_int, Return, "void", Parameters, new Param(c, "this", "qt.QSize"), new Param(c, "height", "int"), End),
    new Function(c, "setWidth", _n_setWidth0, None, Compiled, qt_QSize_setWidth_void_QSize_int, Return, "void", Parameters, new Param(c, "this", "qt.QSize"), new Param(c, "width", "int"), End),
    new Function(c, "shrunkBy", _n_shrunkBy0, None, Compiled, qt_QSize_shrunkBy_QSize_QSize_QMargins, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSize"), new Param(c, "margins", "qt.QMargins"), End),
    // MISSING: toCGSize ("CGSize"; QSize this)
    // MISSING: toSizeF ("QSizeF"; QSize this)
    new Function(c, "transpose", _n_transpose0, None, Compiled, qt_QSize_transpose_void_QSize, Return, "void", Parameters, new Param(c, "this", "qt.QSize"), End),
    new Function(c, "width", _n_width0, None, Compiled, qt_QSize_width_int_QSize, Return, "int", Parameters, new Param(c, "this", "qt.QSize"), End),
    // MISSING: = ("QSize & operator*"; QSize this, double factor)
    // static functions
    EndArguments);
globalScope()->addSymbols(
    new Function(c, "+=", _n_operatorPlus_EQ_0, Op, Compiled, qt_QSize_operatorPlus_EQ__QSize_QSize_QSize, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSize"), new Param(c, "size", "qt.QSize"), End),
    new Function(c, "-=", _n_operatorMinus_EQ_0, Op, Compiled, qt_QSize_operatorMinus_EQ__QSize_QSize_QSize, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSize"), new Param(c, "size", "qt.QSize"), End),
    new Function(c, "/=", _n_operatorSlash_EQ_0, Op, Compiled, qt_QSize_operatorSlash_EQ__QSize_QSize_double, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSize"), new Param(c, "divisor", "double"), End),
    EndArguments);
scope()->addSymbols(
    EndArguments);
