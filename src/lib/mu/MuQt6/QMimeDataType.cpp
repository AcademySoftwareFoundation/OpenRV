...
addSymbols(
    ...
    // MISSING: retrieveData (QVariant; QMimeData this, string mimeType, "QMetaType" type) // protected
    _func[2] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QMimeData_event_bool_QMimeData_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QMimeData"), new Param(c, "e", "qt.QEvent"), End),
    _func[3] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled, qt_QMimeData_eventFilter_bool_QMimeData_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QMimeData"), new Param(c, "watched", "qt.QObject"), new Param(c, "event", "qt.QEvent"), End),
    ...
    _func[4] = new MemberFunction(c, "customEvent", _n_customEvent0, None, Compiled, qt_QMimeData_customEvent_void_QMimeData_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMimeData"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: disconnectNotify (void; QMimeData this, "const QMetaMethod &" signal) // protected
    _func[5] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QMimeData_timerEvent_void_QMimeData_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMimeData"), new Param(c, "event", "qt.QTimerEvent"), End),
    // static functions
    EndArguments);
