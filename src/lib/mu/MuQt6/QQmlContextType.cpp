...
namespace Mu
{
    ...
    {
        NODE_RETURN(
            qt_QQmlContext_objectForName_QObject_QQmlContext_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
    }
    ...
    void QQmlContextType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "objectForName", _n_objectForName0, None, Compiled, qt_QQmlContext_objectForName_QObject_QQmlContext_string,
                         Return, "qt.QObject", Parameters, new Param(c, "this", "qt.QQmlContext"), new Param(c, "name", "string"), End),
