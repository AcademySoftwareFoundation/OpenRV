...
{
    if (!_env) return QSlider::event(event_);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QSlider::minimumSizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QSlider::sizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSlider::mouseMoveEvent(ev); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSlider::mousePressEvent(ev); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSlider::mouseReleaseEvent(ev); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSlider::paintEvent(ev); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSlider::changeEvent(ev); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSlider::keyPressEvent(ev); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSlider::timerEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QSlider::wheelEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QSlider_QSlider_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    {
        QSliderType* type = 
            c->findSymbolOfTypeByQualifiedName<QSliderType>(c->internName("qt.QSlider"), false);
...
Pointer qt_QSlider_QSlider_QSlider_QSlider_int_QWidget(Mu::Thread& NODE_THREAD, Pointer param_this, int param_orientation, Pointer param_parent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QSlider_minimumSizeHint_QSize_QSlider(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QSlider* arg0 = object<QSlider>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QSlider::minimumSizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->minimumSizeHint(),"qt.QSize");
}
...
Pointer qt_QSlider_sizeHint_QSize_QSlider(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QSlider* arg0 = object<QSlider>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QSlider::sizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->sizeHint(),"qt.QSize");
}
...
void qt_QSlider_mouseMoveEvent_void_QSlider_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_ev)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSlider*)arg0)->mouseMoveEvent_pub_parent(arg1);
    else ((MuQt_QSlider*)arg0)->mouseMoveEvent_pub(arg1);
}
...
void qt_QSlider_mousePressEvent_void_QSlider_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_ev)
{
    ...
    QSlider* arg0 = object<QSlider>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_ev);
    if (isMuQtObject(arg0)) ((MuQt_QSlider*)arg0)->mousePressEvent_pub_parent(arg1);
    else ((MuQt_QSlider*)arg0)->mousePressEvent_pub(arg1);
}
...
void qt_QSlider_mouseReleaseEvent_void_QSlider_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_ev)
{
    ...
    QSlider* arg0 = object<QSlider>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_ev);
    if (isMuQtObject(arg0)) ((MuQt_QSlider*)arg0)->mouseReleaseEvent_pub_parent(arg1);
    else ((MuQt_QSlider*)arg0)->mouseReleaseEvent_pub(arg1);
}
...
void qt_QSlider_paintEvent_void_QSlider_QPaintEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_ev)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSlider*)arg0)->paintEvent_pub_parent(arg1);
    else ((MuQt_QSlider*)arg0)->paintEvent_pub(arg1);
}
...
void qt_QSlider_changeEvent_void_QSlider_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_ev)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSlider*)arg0)->changeEvent_pub_parent(arg1);
    else ((MuQt_QSlider*)arg0)->changeEvent_pub(arg1);
}
...
void qt_QSlider_keyPressEvent_void_QSlider_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_ev)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSlider*)arg0)->keyPressEvent_pub_parent(arg1);
    else ((MuQt_QSlider*)arg0)->keyPressEvent_pub(arg1);
}
...
void qt_QSlider_timerEvent_void_QSlider_QTimerEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSlider*)arg0)->timerEvent_pub_parent(arg1);
    else ((MuQt_QSlider*)arg0)->timerEvent_pub(arg1);
}
...
void qt_QSlider_wheelEvent_void_QSlider_QWheelEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QSlider*)arg0)->wheelEvent_pub_parent(arg1);
    else ((MuQt_QSlider*)arg0)->wheelEvent_pub(arg1);
}
...
{
    NODE_RETURN(qt_QSlider_QSlider_QSlider_QSlider_int_QWidget(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer)));
}
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QSlider", _n_QSlider0, None, Compiled, qt_QSlider_QSlider_QSlider_QSlider_QWidget, Return, "qt.QSlider", Parameters, new Param(c, "this", "qt.QSlider"), new Param(c, "parent", "qt.QWidget"), End),
    new Function(c, "QSlider", _n_QSlider1, None, Compiled, qt_QSlider_QSlider_QSlider_QSlider_int_QWidget, Return, "qt.QSlider", Parameters, new Param(c, "this", "qt.QSlider"), new Param(c, "orientation", "int"), new Param(c, "parent", "qt.QWidget"), End),
    // PROP: setTickInterval (void; QSlider this, int ti)
    // PROP: setTickPosition (void; QSlider this, flags QSlider::TickPosition position)
    // PROP: tickInterval (int; QSlider this)
    // PROP: tickPosition (flags QSlider::TickPosition; QSlider this)
    _func[0] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QSlider_event_bool_QSlider_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QSlider"), new Param(c, "event_", "qt.QEvent"), End),
    _func[1] = new MemberFunction(c, "minimumSizeHint", _n_minimumSizeHint0, None, Compiled, qt_QSlider_minimumSizeHint_QSize_QSlider, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSlider"), End),
    _func[2] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QSlider_sizeHint_QSize_QSlider, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QSlider"), End),
    // MISSING: initStyleOption (void; QSlider this, "QStyleOptionSlider *" option) // protected
    _func[3] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QSlider_mouseMoveEvent_void_QSlider_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSlider"), new Param(c, "ev", "qt.QMouseEvent"), End),
    _func[4] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QSlider_mousePressEvent_void_QSlider_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSlider"), new Param(c, "ev", "qt.QMouseEvent"), End),
    _func[5] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QSlider_mouseReleaseEvent_void_QSlider_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSlider"), new Param(c, "ev", "qt.QMouseEvent"), End),
    _func[6] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QSlider_paintEvent_void_QSlider_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSlider"), new Param(c, "ev", "qt.QPaintEvent"), End),
    _func[7] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled, qt_QSlider_changeEvent_void_QSlider_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSlider"), new Param(c, "ev", "qt.QEvent"), End),
    _func[8] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QSlider_keyPressEvent_void_QSlider_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSlider"), new Param(c, "ev", "qt.QKeyEvent"), End),
    _func[9] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QSlider_timerEvent_void_QSlider_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSlider"), new Param(c, "e", "qt.QTimerEvent"), End),
    _func[10] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QSlider_wheelEvent_void_QSlider_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSlider"), new Param(c, "e", "qt.QWheelEvent"), End),
    // static functions
    EndArguments);
