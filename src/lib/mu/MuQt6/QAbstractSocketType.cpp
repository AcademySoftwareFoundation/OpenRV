...
MuQt_QAbstractSocket::MuQt_QAbstractSocket(Pointer muobj, const CallEnvironment* ce, QAbstractSocket::SocketType socketType, QObject * parent) 
...
{
    if (!_env) { QAbstractSocket::disconnectFromHost(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QAbstractSocket::resume(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QAbstractSocket::setReadBufferSize(size); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QAbstractSocket::setSocketOption(option, value); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::waitForConnected(msecs);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::waitForDisconnected(msecs);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::bytesAvailable();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::bytesToWrite();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QAbstractSocket::close(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::isSequential();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::waitForBytesWritten(msecs);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::waitForReadyRead(msecs);
    MuLangContext* c = (MuLangContext*)_env->context();
...
qint64 MuQt_QAbstractSocket::skipData(qint64 maxSize) 
{
    if (!_env) return QAbstractSocket::skipData(maxSize);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::atEnd();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::canReadLine();
    MuLangContext* c = (MuLangContext*)_env->context();
...
bool MuQt_QAbstractSocket::open(QIODeviceBase::OpenMode mode) 
{
    if (!_env) return QAbstractSocket::open(mode);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::pos();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::reset();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::seek(pos);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractSocket::size();
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QAbstractSocket_QAbstractSocket_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    else if (QAbstractSocket* w = object<QAbstractSocket>(widget))
    {
        QAbstractSocketType* type = 
            c->findSymbolOfTypeByQualifiedName<QAbstractSocketType>(c->internName("qt.QAbstractSocket"), false);
...
Pointer qt_QAbstractSocket_QAbstractSocket_QAbstractSocket_QAbstractSocket_int_QObject(Mu::Thread& NODE_THREAD, Pointer param_this, int param_socketType, Pointer param_parent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
void qt_QAbstractSocket_disconnectFromHost_void_QAbstractSocket(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractSocket* arg0 = object<QAbstractSocket>(param_this);
    if (isMuQtObject(arg0)) arg0->QAbstractSocket::disconnectFromHost();
    else arg0->disconnectFromHost();
}
...
Pointer qt_QAbstractSocket_protocolTag_string_QAbstractSocket(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractSocket* arg0 = object<QAbstractSocket>(param_this);
    return makestring(c,arg0->protocolTag());
}
...
void qt_QAbstractSocket_resume_void_QAbstractSocket(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractSocket* arg0 = object<QAbstractSocket>(param_this);
    if (isMuQtObject(arg0)) arg0->QAbstractSocket::resume();
    else arg0->resume();
}
...
void qt_QAbstractSocket_setProtocolTag_void_QAbstractSocket_string(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_tag)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractSocket* arg0 = object<QAbstractSocket>(param_this);
    const QString  arg1 = qstring(param_tag);
    arg0->setProtocolTag(arg1);
}
...
void qt_QAbstractSocket_setReadBufferSize_void_QAbstractSocket_int64(Mu::Thread& NODE_THREAD, Pointer param_this, int64 param_size)
{
    ...
    if (isMuQtObject(arg0)) arg0->QAbstractSocket::setReadBufferSize(arg1);
    else arg0->setReadBufferSize(arg1);
}

void qt_QAbstractSocket_setSocketOption_void_QAbstractSocket_int_QVariant(Mu::Thread& NODE_THREAD, Pointer param_this, int param_option, Pointer param_value)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractSocket* arg0 = object<QAbstractSocket>(param_this);
    ...
    if (isMuQtObject(arg0)) arg0->QAbstractSocket::setSocketOption(arg1, arg2);
...
Pointer qt_QAbstractSocket_socketOption_QVariant_QAbstractSocket_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_option)
{
    ...
    QAbstractSocket* arg0 = object<QAbstractSocket>(param_this);
    QAbstractSocket::SocketOption arg1 = (QAbstractSocket::SocketOption)(param_option);
    return isMuQtObject(arg0) ? makeqtype<QVariantType>(c,arg0->QAbstractSocket::socketOption(arg1),"qt.QVariant") : makeqtype<QVariantType>(c,arg0->socketOption(arg1),"qt.QVariant");
}
...
void qt_QAbstractSocket_close_void_QAbstractSocket(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractSocket* arg0 = object<QAbstractSocket>(param_this);
    if (isMuQtObject(arg0)) arg0->QAbstractSocket::close();
    else arg0->close();
}
...
void qt_QAbstractSocket_setLocalAddress_void_QAbstractSocket_QHostAddress(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_address)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractSocket* arg0 = object<QAbstractSocket>(param_this);
...
void qt_QAbstractSocket_setPeerAddress_void_QAbstractSocket_QHostAddress(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_address)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractSocket* arg0 = object<QAbstractSocket>(param_this);
    const QHostAddress  arg1 = getqtype<QHostAddressType>(param_address);
...
int64 qt_QAbstractSocket_skipData_int64_QAbstractSocket_int64(Mu::Thread& NODE_THREAD, Pointer param_this, int64 param_maxSize)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractSocket* arg0 = object<QAbstractSocket>(param_this);
    qint64 arg1 = (int64)(param_maxSize);
    return isMuQtObject(arg0) ? ((MuQt_QAbstractSocket*)arg0)->skipData_pub_parent(arg1) : ((MuQt_QAbstractSocket*)arg0)->skipData_pub(arg1);
}
...
{
    NODE_RETURN(qt_QAbstractSocket_QAbstractSocket_QAbstractSocket_QAbstractSocket_int_QObject(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer)));
}

static NODE_IMPLEMENTATION(_n_abort0, void)
{
    qt_QAbstractSocket_abort_void_QAbstractSocket(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
static NODE_IMPLEMENTATION(_n_protocolTag0, Pointer)
{
    NODE_RETURN(qt_QAbstractSocket_protocolTag_string_QAbstractSocket(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
static NODE_IMPLEMENTATION(_n_setProtocolTag0, void)
{
    qt_QAbstractSocket_setProtocolTag_void_QAbstractSocket_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
{
    qt_QAbstractSocket_setSocketOption_void_QAbstractSocket_int_QVariant(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer));
}

static NODE_IMPLEMENTATION(_n_socketOption0, Pointer)
{
    NODE_RETURN(qt_QAbstractSocket_socketOption_QVariant_QAbstractSocket_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
}
...
{
    NODE_RETURN(qt_QAbstractSocket_waitForConnected_bool_QAbstractSocket_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
}

static NODE_IMPLEMENTATION(_n_waitForDisconnected0, bool)
{
    NODE_RETURN(qt_QAbstractSocket_waitForDisconnected_bool_QAbstractSocket_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
}
...
{
    qt_QAbstractSocket_close_void_QAbstractSocket(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    NODE_RETURN(qt_QAbstractSocket_waitForBytesWritten_bool_QAbstractSocket_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
}

static NODE_IMPLEMENTATION(_n_waitForReadyRead0, bool)
{
    NODE_RETURN(qt_QAbstractSocket_waitForReadyRead_bool_QAbstractSocket_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
}

static NODE_IMPLEMENTATION(_n_setLocalAddress0, void)
{
    qt_QAbstractSocket_setLocalAddress_void_QAbstractSocket_QHostAddress(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
{
    NODE_RETURN(qt_QAbstractSocket_skipData_int64_QAbstractSocket_int64(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int64)));
}
...
QAbstractSocketType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QAbstractSocket_QAbstractSocket_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    ...
    new Alias(c, "SocketError", "int"),
      ...
      new SymbolicConstant(c, "ProxyAuthenticationRequiredError", "int", Value(int(QAbstractSocket::ProxyAuthenticationRequiredError))),
    ...
    new Alias(c, "SocketType", "int"),
      new SymbolicConstant(c, "TcpSocket", "int", Value(int(QAbstractSocket::TcpSocket))),
      new SymbolicConstant(c, "UdpSocket", "int", Value(int(QAbstractSocket::UdpSocket))),
      new SymbolicConstant(c, "SctpSocket", "int", Value(int(QAbstractSocket::SctpSocket))),
      new SymbolicConstant(c, "UnknownSocketType", "int", Value(int(QAbstractSocket::UnknownSocketType))),
    // member functions
    new Function(c, "QAbstractSocket", _n_QAbstractSocket0, None, Compiled, qt_QAbstractSocket_QAbstractSocket_QAbstractSocket_QAbstractSocket_int_QObject, Return, "qt.QAbstractSocket", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "socketType", "int"), new Param(c, "parent", "qt.QObject"), End),
    new Function(c, "abort", _n_abort0, None, Compiled, qt_QAbstractSocket_abort_void_QAbstractSocket, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    // MISSING: bind (bool; QAbstractSocket this, QHostAddress address, "quint16" port, flags QAbstractSocket::BindMode mode)
    // MISSING: bind (bool; QAbstractSocket this, flags QHostAddress::SpecialAddress addr, "quint16" port, flags QAbstractSocket::BindMode mode)
    // MISSING: bind (bool; QAbstractSocket this, "quint16" port, flags QAbstractSocket::BindMode mode)
    // MISSING: connectToHost (void; QAbstractSocket this, string hostName, "quint16" port, flags QIODeviceBase::OpenMode openMode, flags QAbstractSocket::NetworkLayerProtocol protocol)
    // MISSING: connectToHost (void; QAbstractSocket this, QHostAddress address, "quint16" port, flags QIODeviceBase::OpenMode openMode)
    _func[0] = new MemberFunction(c, "disconnectFromHost", _n_disconnectFromHost0, None, Compiled, qt_QAbstractSocket_disconnectFromHost_void_QAbstractSocket, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    new Function(c, "error", _n_error0, None, Compiled, qt_QAbstractSocket_error_int_QAbstractSocket, Return, "int", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    new Function(c, "flush", _n_flush0, None, Compiled, qt_QAbstractSocket_flush_bool_QAbstractSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    new Function(c, "isValid", _n_isValid0, None, Compiled, qt_QAbstractSocket_isValid_bool_QAbstractSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    new Function(c, "localAddress", _n_localAddress0, None, Compiled, qt_QAbstractSocket_localAddress_QHostAddress_QAbstractSocket, Return, "qt.QHostAddress", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    // MISSING: localPort ("quint16"; QAbstractSocket this)
    new Function(c, "pauseMode", _n_pauseMode0, None, Compiled, qt_QAbstractSocket_pauseMode_int_QAbstractSocket, Return, "int", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    new Function(c, "peerAddress", _n_peerAddress0, None, Compiled, qt_QAbstractSocket_peerAddress_QHostAddress_QAbstractSocket, Return, "qt.QHostAddress", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    new Function(c, "peerName", _n_peerName0, None, Compiled, qt_QAbstractSocket_peerName_string_QAbstractSocket, Return, "string", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    // MISSING: peerPort ("quint16"; QAbstractSocket this)
    new Function(c, "protocolTag", _n_protocolTag0, None, Compiled, qt_QAbstractSocket_protocolTag_string_QAbstractSocket, Return, "string", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    // MISSING: proxy ("QNetworkProxy"; QAbstractSocket this)
    new Function(c, "readBufferSize", _n_readBufferSize0, None, Compiled, qt_QAbstractSocket_readBufferSize_int64_QAbstractSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[1] = new MemberFunction(c, "resume", _n_resume0, None, Compiled, qt_QAbstractSocket_resume_void_QAbstractSocket, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    new Function(c, "setPauseMode", _n_setPauseMode0, None, Compiled, qt_QAbstractSocket_setPauseMode_void_QAbstractSocket_int, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "pauseMode", "int"), End),
    new Function(c, "setProtocolTag", _n_setProtocolTag0, None, Compiled, qt_QAbstractSocket_setProtocolTag_void_QAbstractSocket_string, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "tag", "string"), End),
    // MISSING: setProxy (void; QAbstractSocket this, "const QNetworkProxy &" networkProxy)
    _func[2] = new MemberFunction(c, "setReadBufferSize", _n_setReadBufferSize0, None, Compiled, qt_QAbstractSocket_setReadBufferSize_void_QAbstractSocket_int64, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "size", "int64"), End),
    // MISSING: setSocketDescriptor (bool; QAbstractSocket this, "qintptr" socketDescriptor, flags QAbstractSocket::SocketState socketState, flags QIODeviceBase::OpenMode openMode)
    _func[3] = new MemberFunction(c, "setSocketOption", _n_setSocketOption0, None, Compiled, qt_QAbstractSocket_setSocketOption_void_QAbstractSocket_int_QVariant, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "option", "int"), new Param(c, "value", "qt.QVariant"), End),
    // MISSING: socketDescriptor ("qintptr"; QAbstractSocket this)
    _func[4] = new MemberFunction(c, "socketOption", _n_socketOption0, None, Compiled, qt_QAbstractSocket_socketOption_QVariant_QAbstractSocket_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "option", "int"), End),
    new Function(c, "socketType", _n_socketType0, None, Compiled, qt_QAbstractSocket_socketType_int_QAbstractSocket, Return, "int", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    new Function(c, "state", _n_state0, None, Compiled, qt_QAbstractSocket_state_int_QAbstractSocket, Return, "int", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[5] = new MemberFunction(c, "waitForConnected", _n_waitForConnected0, None, Compiled, qt_QAbstractSocket_waitForConnected_bool_QAbstractSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    _func[6] = new MemberFunction(c, "waitForDisconnected", _n_waitForDisconnected0, None, Compiled, qt_QAbstractSocket_waitForDisconnected_bool_QAbstractSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    _func[7] = new MemberFunction(c, "bytesAvailable", _n_bytesAvailable0, None, Compiled, qt_QAbstractSocket_bytesAvailable_int64_QAbstractSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[8] = new MemberFunction(c, "bytesToWrite", _n_bytesToWrite0, None, Compiled, qt_QAbstractSocket_bytesToWrite_int64_QAbstractSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[9] = new MemberFunction(c, "close", _n_close0, None, Compiled, qt_QAbstractSocket_close_void_QAbstractSocket, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[10] = new MemberFunction(c, "isSequential", _n_isSequential0, None, Compiled, qt_QAbstractSocket_isSequential_bool_QAbstractSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[11] = new MemberFunction(c, "waitForBytesWritten", _n_waitForBytesWritten0, None, Compiled, qt_QAbstractSocket_waitForBytesWritten_bool_QAbstractSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    _func[12] = new MemberFunction(c, "waitForReadyRead", _n_waitForReadyRead0, None, Compiled, qt_QAbstractSocket_waitForReadyRead_bool_QAbstractSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    new Function(c, "setLocalAddress", _n_setLocalAddress0, None, Compiled, qt_QAbstractSocket_setLocalAddress_void_QAbstractSocket_QHostAddress, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "address", "qt.QHostAddress"), End),
    // MISSING: setLocalPort (void; QAbstractSocket this, "quint16" port) // protected
    new Function(c, "setPeerAddress", _n_setPeerAddress0, None, Compiled, qt_QAbstractSocket_setPeerAddress_void_QAbstractSocket_QHostAddress, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "address", "qt.QHostAddress"), End),
    new Function(c, "setPeerName", _n_setPeerName0, None, Compiled, qt_QAbstractSocket_setPeerName_void_QAbstractSocket_string, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "name", "string"), End),
    // MISSING: setPeerPort (void; QAbstractSocket this, "quint16" port) // protected
    new Function(c, "setSocketError", _n_setSocketError0, None, Compiled, qt_QAbstractSocket_setSocketError_void_QAbstractSocket_int, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "socketError", "int"), End),
    new Function(c, "setSocketState", _n_setSocketState0, None, Compiled, qt_QAbstractSocket_setSocketState_void_QAbstractSocket_int, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "state", "int"), End),
    // MISSING: readData (int64; QAbstractSocket this, "char *" data, int64 maxSize) // protected
    // MISSING: readLineData (int64; QAbstractSocket this, "char *" data, int64 maxlen) // protected
    _func[13] = new MemberFunction(c, "skipData", _n_skipData0, None, Compiled, qt_QAbstractSocket_skipData_int64_QAbstractSocket_int64, Return, "int64", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "maxSize", "int64"), End),
    // MISSING: writeData (int64; QAbstractSocket this, "const char *" data, int64 size) // protected
    _func[14] = new MemberFunction(c, "atEnd", _n_atEnd0, None, Compiled, qt_QAbstractSocket_atEnd_bool_QAbstractSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[15] = new MemberFunction(c, "canReadLine", _n_canReadLine0, None, Compiled, qt_QAbstractSocket_canReadLine_bool_QAbstractSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[16] = new MemberFunction(c, "open", _n_open0, None, Compiled, qt_QAbstractSocket_open_bool_QAbstractSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "mode", "int"), End),
    _func[17] = new MemberFunction(c, "pos", _n_pos0, None, Compiled, qt_QAbstractSocket_pos_int64_QAbstractSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[18] = new MemberFunction(c, "reset", _n_reset0, None, Compiled, qt_QAbstractSocket_reset_bool_QAbstractSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[19] = new MemberFunction(c, "seek", _n_seek0, None, Compiled, qt_QAbstractSocket_seek_bool_QAbstractSocket_int64, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "pos", "int64"), End),
    _func[20] = new MemberFunction(c, "size", _n_size0, None, Compiled, qt_QAbstractSocket_size_int64_QAbstractSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    // static functions
    EndArguments);
