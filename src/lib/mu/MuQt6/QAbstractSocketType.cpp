...
namespace Mu
{
    ...
    int64 qt_QAbstractSocket_skipData_int64_QAbstractSocket_int64(Mu::Thread& NODE_THREAD, Pointer param_this, int64 param_maxSize)
    {
        ...
        return isMuQtObject(arg0) ? ((MuQt_QAbstractSocket*)arg0)->skipData_pub_parent(arg1)
                                  : ((MuQt_QAbstractSocket*)arg0)->skipData_pub(arg1);
    }
    ...
    void QAbstractSocketType::load()
    {
        ...
        addSymbols(
            ...
            // bind (bool; QAbstractSocket this, flags
            // QHostAddress::SpecialAddress addr, "quint16" port, flags
            // QAbstractSocket::BindMode mode) MISSING: bind (bool;
            // QAbstractSocket this, "quint16" port, flags
            ...
            // "quint16" port, flags QIODeviceBase::OpenMode openMode)
            ...
            new Function(c, "protocolTag", _n_protocolTag0, None, Compiled, qt_QAbstractSocket_protocolTag_string_QAbstractSocket, Return,
                         "string", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
            ...
            new Function(c, "setProtocolTag", _n_setProtocolTag0, None, Compiled,
                         qt_QAbstractSocket_setProtocolTag_void_QAbstractSocket_string, Return, "void", Parameters,
                         new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "tag", "string"), End),
            ...
            // socketState, flags QIODeviceBase::OpenMode openMode)
            ...
            _func[6] = new MemberFunction(c, "waitForDisconnected", _n_waitForDisconnected0, None, Compiled,
                                          ...
                                          new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
            _func[7] = new MemberFunction(c, "bytesAvailable", _n_bytesAvailable0, None, Compiled,
                                          qt_QAbstractSocket_bytesAvailable_int64_QAbstractSocket, Return, "int64", Parameters,
                                          new Param(c, "this", "qt.QAbstractSocket"), End),
            _func[8] = new MemberFunction(c, "bytesToWrite", _n_bytesToWrite0, None, Compiled,
                                          qt_QAbstractSocket_bytesToWrite_int64_QAbstractSocket, Return, "int64", Parameters,
                                          new Param(c, "this", "qt.QAbstractSocket"), End),
            _func[9] = new MemberFunction(c, "close", _n_close0, None, Compiled, qt_QAbstractSocket_close_void_QAbstractSocket, Return,
                                          "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
            _func[10] = new MemberFunction(c, "isSequential", _n_isSequential0, None, Compiled,
            ...
            _func[13] = new MemberFunction(c, "skipData", _n_skipData0, None, Compiled,
                                           qt_QAbstractSocket_skipData_int64_QAbstractSocket_int64, Return, "int64", Parameters,
                                           new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "maxSize", "int64"), End),
            // MISSING: writeData (int64; QAbstractSocket this, "const char *"
            // data, int64 size) // protected
            _func[14] = new MemberFunction(c, "atEnd", _n_atEnd0, None, Compiled, qt_QAbstractSocket_atEnd_bool_QAbstractSocket, Return,
            ...
            _func[17] = new MemberFunction(c, "pos", _n_pos0, None, Compiled, qt_QAbstractSocket_pos_int64_QAbstractSocket, Return, "int64",
                                           Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
            _func[18] = new MemberFunction(c, "reset", _n_reset0, None, Compiled, qt_QAbstractSocket_reset_bool_QAbstractSocket, Return,
                                           "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
            _func[19] =
            ...
            _func[20] = new MemberFunction(c, "size", _n_size0, None, Compiled, qt_QAbstractSocket_size_int64_QAbstractSocket, Return,
