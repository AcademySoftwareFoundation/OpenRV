...
addSymbols(
    // enums
    // member functions
    // MISSING: QMouseEvent (QMouseEvent; QMouseEvent this, flags QEvent::Type type, QPointF localPos, QPointF globalPos, flags Qt::MouseButton button, flags Qt::MouseButtons buttons, flags Qt::KeyboardModifiers modifiers, "const QPointingDevice *" device)
    // MISSING: QMouseEvent (QMouseEvent; QMouseEvent this, flags QEvent::Type type, QPointF localPos, QPointF scenePos, QPointF globalPos, flags Qt::MouseButton button, flags Qt::MouseButtons buttons, flags Qt::KeyboardModifiers modifiers, "const QPointingDevice *" device)
    new Function(c, "flags", _n_flags0, None, Compiled, qt_QMouseEvent_flags_int_QMouseEvent, Return, "int", Parameters, new Param(c, "this", "qt.QMouseEvent"), End),
    // static functions
    EndArguments);
