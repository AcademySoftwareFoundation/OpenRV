...
{
    if (!_env) { QTcpSocket::disconnectFromHost(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTcpSocket::resume(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTcpSocket::setReadBufferSize(size); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTcpSocket::setSocketOption(option, value); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTcpSocket::waitForConnected(msecs);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTcpSocket::waitForDisconnected(msecs);
    MuLangContext* c = (MuLangContext*)_env->context();
...
qint64 MuQt_QTcpSocket::skipData(qint64 maxSize) 
{
    if (!_env) return QTcpSocket::skipData(maxSize);
    MuLangContext* c = (MuLangContext*)_env->context();
...
void qt_QTcpSocket_disconnectFromHost_void_QTcpSocket(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    ...
    if (isMuQtObject(arg0)) arg0->QTcpSocket::disconnectFromHost();
...
void qt_QTcpSocket_resume_void_QTcpSocket(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTcpSocket* arg0 = object<QTcpSocket>(param_this);
    if (isMuQtObject(arg0)) arg0->QTcpSocket::resume();
    else arg0->resume();
}
...
void qt_QTcpSocket_setReadBufferSize_void_QTcpSocket_int64(Mu::Thread& NODE_THREAD, Pointer param_this, int64 param_size)
{
    ...
    if (isMuQtObject(arg0)) arg0->QTcpSocket::setReadBufferSize(arg1);
    else arg0->setReadBufferSize(arg1);
}

void qt_QTcpSocket_setSocketOption_void_QTcpSocket_int_QVariant(Mu::Thread& NODE_THREAD, Pointer param_this, int param_option, Pointer param_value)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTcpSocket* arg0 = object<QTcpSocket>(param_this);
    ...
    if (isMuQtObject(arg0)) arg0->QTcpSocket::setSocketOption(arg1, arg2);
...
Pointer qt_QTcpSocket_socketOption_QVariant_QTcpSocket_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_option)
{
    ...
    QTcpSocket* arg0 = object<QTcpSocket>(param_this);
    QAbstractSocket::SocketOption arg1 = (QAbstractSocket::SocketOption)(param_option);
    return isMuQtObject(arg0) ? makeqtype<QVariantType>(c,arg0->QTcpSocket::socketOption(arg1),"qt.QVariant") : makeqtype<QVariantType>(c,arg0->socketOption(arg1),"qt.QVariant");
}
...
{
    qt_QTcpSocket_resume_void_QTcpSocket(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    qt_QTcpSocket_setSocketOption_void_QTcpSocket_int_QVariant(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer));
}
...
addSymbols(
    ...
    // MISSING: bind (bool; QTcpSocket this, QHostAddress address, "quint16" port, flags QAbstractSocket::BindMode mode)
    // MISSING: connectToHost (void; QTcpSocket this, string hostName, "quint16" port, flags QIODeviceBase::OpenMode openMode, flags QAbstractSocket::NetworkLayerProtocol protocol)
    _func[0] = new MemberFunction(c, "disconnectFromHost", _n_disconnectFromHost0, None, Compiled, qt_QTcpSocket_disconnectFromHost_void_QTcpSocket, Return, "void", Parameters, new Param(c, "this", "qt.QTcpSocket"), End),
    _func[1] = new MemberFunction(c, "resume", _n_resume0, None, Compiled, qt_QTcpSocket_resume_void_QTcpSocket, Return, "void", Parameters, new Param(c, "this", "qt.QTcpSocket"), End),
    _func[2] = new MemberFunction(c, "setReadBufferSize", _n_setReadBufferSize0, None, Compiled, qt_QTcpSocket_setReadBufferSize_void_QTcpSocket_int64, Return, "void", Parameters, new Param(c, "this", "qt.QTcpSocket"), new Param(c, "size", "int64"), End),
    // MISSING: setSocketDescriptor (bool; QTcpSocket this, "qintptr" socketDescriptor, flags QAbstractSocket::SocketState socketState, flags QIODeviceBase::OpenMode openMode)
    _func[3] = new MemberFunction(c, "setSocketOption", _n_setSocketOption0, None, Compiled, qt_QTcpSocket_setSocketOption_void_QTcpSocket_int_QVariant, Return, "void", Parameters, new Param(c, "this", "qt.QTcpSocket"), new Param(c, "option", "int"), new Param(c, "value", "qt.QVariant"), End),
    // MISSING: socketDescriptor ("qintptr"; QTcpSocket this)
    _func[4] = new MemberFunction(c, "socketOption", _n_socketOption0, None, Compiled, qt_QTcpSocket_socketOption_QVariant_QTcpSocket_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QTcpSocket"), new Param(c, "option", "int"), End),
    _func[5] = new MemberFunction(c, "waitForConnected", _n_waitForConnected0, None, Compiled, qt_QTcpSocket_waitForConnected_bool_QTcpSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QTcpSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    _func[6] = new MemberFunction(c, "waitForDisconnected", _n_waitForDisconnected0, None, Compiled, qt_QTcpSocket_waitForDisconnected_bool_QTcpSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QTcpSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    _func[7] = new MemberFunction(c, "bytesAvailable", _n_bytesAvailable0, None, Compiled, qt_QTcpSocket_bytesAvailable_int64_QTcpSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QTcpSocket"), End),
    _func[8] = new MemberFunction(c, "bytesToWrite", _n_bytesToWrite0, None, Compiled, qt_QTcpSocket_bytesToWrite_int64_QTcpSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QTcpSocket"), End),
    _func[9] = new MemberFunction(c, "close", _n_close0, None, Compiled, qt_QTcpSocket_close_void_QTcpSocket, Return, "void", Parameters, new Param(c, "this", "qt.QTcpSocket"), End),
    _func[10] = new MemberFunction(c, "isSequential", _n_isSequential0, None, Compiled, qt_QTcpSocket_isSequential_bool_QTcpSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QTcpSocket"), End),
    _func[11] = new MemberFunction(c, "waitForBytesWritten", _n_waitForBytesWritten0, None, Compiled, qt_QTcpSocket_waitForBytesWritten_bool_QTcpSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QTcpSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    _func[12] = new MemberFunction(c, "waitForReadyRead", _n_waitForReadyRead0, None, Compiled, qt_QTcpSocket_waitForReadyRead_bool_QTcpSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QTcpSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    ...
    _func[13] = new MemberFunction(c, "skipData", _n_skipData0, None, Compiled, qt_QTcpSocket_skipData_int64_QTcpSocket_int64, Return, "int64", Parameters, new Param(c, "this", "qt.QTcpSocket"), new Param(c, "maxSize", "int64"), End),
