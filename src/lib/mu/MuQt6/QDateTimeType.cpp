...
namespace Mu
{
    ...
    Pointer qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_date,
                                                                   Pointer param_time)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QDate arg1 = getqtype<QDateType>(param_date);
    ...
    {
        NODE_RETURN(qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                           NODE_ARG(2, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_currentDateTime1, Pointer) { NODE_RETURN(qt_QDateTime_currentDateTime_QDateTime(NODE_THREAD)); }
    ...
    void QDateTimeType::load()
    {
        ...
        addSymbols(
            // enums
            // member functions
            new Function(c, "QDateTime", _n_QDateTime0, None, Compiled, qt_QDateTime_QDateTime_QDateTime_QDateTime, Return, "qt.QDateTime",
                         Parameters, new Param(c, "this", "qt.QDateTime"), End),
            new Function(c, "QDateTime", _n_QDateTime1, None, Compiled, qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime_QTimeZone,
            ...
            new Function(c, "QDateTime", _n_QDateTime2, None, Compiled, qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime, Return,
            ...
            new Function(c, "addDuration", _n_addDuration0, None, Compiled, qt_QDateTime_addDuration_QDateTime_QDateTime_int, Return,
                         "qt.QDateTime", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "msecs", "int"), End),
            ...
            new Function(c, "time", _n_time0, None, Compiled, qt_QDateTime_time_QTime_QDateTime, Return, "qt.QTime", Parameters,
                         new Param(c, "this", "qt.QDateTime"), End),
            new Function(c, "timeRepresentation", _n_timeRepresentation0, None, Compiled,
                         qt_QDateTime_timeRepresentation_QTimeZone_QDateTime, Return, "qt.QTimeZone", Parameters,
                         new Param(c, "this", "qt.QDateTime"), End),
            ...
            new Function(c, "toString", _n_toString0, None, Compiled, qt_QDateTime_toString_string_QDateTime_string_QCalendar, Return,
            ...
            new Function(c, "toUTC", _n_toUTC0, None, Compiled, qt_QDateTime_toUTC_QDateTime_QDateTime, Return, "qt.QDateTime", Parameters,
                         new Param(c, "this", "qt.QDateTime"), End),
            // static functions
            new Function(c, "currentDateTime", _n_currentDateTime0, None, Compiled, qt_QDateTime_currentDateTime_QDateTime_QTimeZone,
                         Return, "qt.QDateTime", Parameters, new Param(c, "zone", "qt.QTimeZone"), End),
            new Function(c, "currentDateTime", _n_currentDateTime1, None, Compiled, qt_QDateTime_currentDateTime_QDateTime, Return,
                         "qt.QDateTime", End),
            ...
            new Function(c, "fromSecsSinceEpoch", _n_fromSecsSinceEpoch1, None, Compiled, qt_QDateTime_fromSecsSinceEpoch_QDateTime_int64,
                         Return, "qt.QDateTime", Parameters, new Param(c, "secs", "int64"), End),
            ...
            new Function(c, "fromString", _n_fromString4, None, Compiled, qt_QDateTime_fromString_QDateTime_string_string_QCalendar, Return,
                         "qt.QDateTime", Parameters, new Param(c, "string", "string"), new Param(c, "format", "string"),
                         new Param(c, "cal", "qt.QCalendar"), End),
            EndArguments);
        globalScope()->addSymbols(
            new Function(c, "+=", _n_operatorPlus_EQ_0, Op, Compiled, qt_QDateTime_operatorPlus_EQ__QDateTime_QDateTime_int, Return,
                         "qt.QDateTime", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "duration", "int"), End),
            new Function(c, "-=", _n_operatorMinus_EQ_0, Op, Compiled, qt_QDateTime_operatorMinus_EQ__QDateTime_QDateTime_int, Return,
                         "qt.QDateTime", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "duration", "int"), End),
        ...
        addSymbol(new Function(c, "fromString", _n_fromString1, None, Compiled, qt_QDateTime_fromString_QDateTime_string_string, Return,
