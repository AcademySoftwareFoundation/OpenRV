...
addSymbols(
    new Alias(c, "AceProcessingOption", "int"),
    new Alias(c, "AceProcessingOptions", "int"),
...
addSymbols(
    ...
    new Function(c, "QUrl", _n_QUrl1, None, Compiled, qt_QUrl_QUrl_QUrl_QUrl_string_int, Return, "qt.QUrl", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "url", "string"), new Param(c, "parsingMode", "int", Value((int)QUrl::TolerantMode)), End),
