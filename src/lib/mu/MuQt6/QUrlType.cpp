...
namespace Mu
{
        ...
        Pointer param_workingDirectory, int param_options)
    {
        ...
        QUrl::UserInputResolutionOptions arg2 =
            (QUrl::UserInputResolutionOptions)(param_options);
    ...
    void QUrlType::load()
    {
        ...
        addSymbols(
            ...
            new SymbolicConstant(c, "IgnoreIDNWhitelist", "int",
                                 Value(int(QUrl::IgnoreIDNWhitelist))),
            new SymbolicConstant(c, "AceTransitionalProcessing", "int",
                                 Value(int(QUrl::AceTransitionalProcessing))),
        ...
        addSymbols(
            ...
            new Function(c, "QUrl", _n_QUrl1, None, Compiled,
