...
{
    if (!_env) return QTextBrowser::loadResource(type, name);
    MuLangContext* c = (MuLangContext*)_env->context();
...
void MuQt_QTextBrowser::doSetSource(const QUrl & url, QTextDocument::ResourceType type) 
{
    if (!_env) { QTextBrowser::doSetSource(url, type); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTextBrowser::event(e);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTextBrowser::focusNextPrevChild(next);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::focusOutEvent(ev); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::keyPressEvent(ev); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::mouseMoveEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::mousePressEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::mouseReleaseEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::paintEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTextBrowser::inputMethodQuery(property);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTextBrowser::canInsertFromMimeData(source);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTextBrowser::createMimeDataFromSelection();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::insertFromMimeData(source); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::changeEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::contextMenuEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::dragEnterEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::dragLeaveEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::dragMoveEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::dropEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::focusInEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::keyReleaseEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::mouseDoubleClickEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::resizeEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::scrollContentsBy(dx, dy); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::showEvent(_p13); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTextBrowser::wheelEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QTextBrowser_QTextBrowser_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    else if (QTextBrowser* w = object<QTextBrowser>(widget))
    {
        QTextBrowserType* type = 
            c->findSymbolOfTypeByQualifiedName<QTextBrowserType>(c->internName("qt.QTextBrowser"), false);
...
Pointer qt_QTextBrowser_QTextBrowser_QTextBrowser_QTextBrowser_QWidget(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_parent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QTextBrowser_loadResource_QVariant_QTextBrowser_int_QUrl(Mu::Thread& NODE_THREAD, Pointer param_this, int param_type, Pointer param_name)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTextBrowser* arg0 = object<QTextBrowser>(param_this);
    int arg1 = (int)(param_type);
    const QUrl  arg2 = getqtype<QUrlType>(param_name);
    return isMuQtObject(arg0) ? makeqtype<QVariantType>(c,arg0->QTextBrowser::loadResource(arg1, arg2),"qt.QVariant") : makeqtype<QVariantType>(c,arg0->loadResource(arg1, arg2),"qt.QVariant");
}

void qt_QTextBrowser_doSetSource_void_QTextBrowser_QUrl_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_url, int param_type)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTextBrowser* arg0 = object<QTextBrowser>(param_this);
    const QUrl  arg1 = getqtype<QUrlType>(param_url);
    QTextDocument::ResourceType arg2 = (QTextDocument::ResourceType)(param_type);
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->doSetSource_pub_parent(arg1, arg2);
...
bool qt_QTextBrowser_focusNextPrevChild_bool_QTextBrowser_bool(Mu::Thread& NODE_THREAD, Pointer param_this, bool param_next)
{
    ...
    return isMuQtObject(arg0) ? ((MuQt_QTextBrowser*)arg0)->focusNextPrevChild_pub_parent(arg1) : ((MuQt_QTextBrowser*)arg0)->focusNextPrevChild_pub(arg1);
}
...
void qt_QTextBrowser_focusOutEvent_void_QTextBrowser_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_ev)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->focusOutEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->focusOutEvent_pub(arg1);
}
...
void qt_QTextBrowser_keyPressEvent_void_QTextBrowser_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_ev)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->keyPressEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->keyPressEvent_pub(arg1);
}
...
void qt_QTextBrowser_mouseMoveEvent_void_QTextBrowser_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->mouseMoveEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->mouseMoveEvent_pub(arg1);
}
...
void qt_QTextBrowser_mousePressEvent_void_QTextBrowser_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    QTextBrowser* arg0 = object<QTextBrowser>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_e);
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->mousePressEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->mousePressEvent_pub(arg1);
}
...
void qt_QTextBrowser_mouseReleaseEvent_void_QTextBrowser_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    QTextBrowser* arg0 = object<QTextBrowser>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_e);
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->mouseReleaseEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->mouseReleaseEvent_pub(arg1);
}
...
void qt_QTextBrowser_paintEvent_void_QTextBrowser_QPaintEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->paintEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->paintEvent_pub(arg1);
}
...
Pointer qt_QTextBrowser_inputMethodQuery_QVariant_QTextBrowser_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_property)
{
    ...
    return isMuQtObject(arg0) ? makeqtype<QVariantType>(c,arg0->QTextBrowser::inputMethodQuery(arg1),"qt.QVariant") : makeqtype<QVariantType>(c,arg0->inputMethodQuery(arg1),"qt.QVariant");
}

bool qt_QTextBrowser_canInsertFromMimeData_bool_QTextBrowser_QMimeData(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_source)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTextBrowser* arg0 = object<QTextBrowser>(param_this);
    const QMimeData * arg1 = object<QMimeData>(param_source);
    return isMuQtObject(arg0) ? ((MuQt_QTextBrowser*)arg0)->canInsertFromMimeData_pub_parent(arg1) : ((MuQt_QTextBrowser*)arg0)->canInsertFromMimeData_pub(arg1);
}
...
Pointer qt_QTextBrowser_createMimeDataFromSelection_QMimeData_QTextBrowser(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTextBrowser* arg0 = object<QTextBrowser>(param_this);
    return isMuQtObject(arg0) ? makeinstance<QMimeDataType>(c, ((MuQt_QTextBrowser*)arg0)->createMimeDataFromSelection_pub_parent(), "qt.QMimeData") : makeinstance<QMimeDataType>(c, ((MuQt_QTextBrowser*)arg0)->createMimeDataFromSelection_pub(), "qt.QMimeData");
}
...
void qt_QTextBrowser_insertFromMimeData_void_QTextBrowser_QMimeData(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_source)
{
    ...
    QTextBrowser* arg0 = object<QTextBrowser>(param_this);
    const QMimeData * arg1 = object<QMimeData>(param_source);
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->insertFromMimeData_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->insertFromMimeData_pub(arg1);
}
...
void qt_QTextBrowser_changeEvent_void_QTextBrowser_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    QTextBrowser* arg0 = object<QTextBrowser>(param_this);
    QEvent * arg1 = getqpointer<QEventType>(param_e);
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->changeEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->changeEvent_pub(arg1);
}

void qt_QTextBrowser_contextMenuEvent_void_QTextBrowser_QContextMenuEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTextBrowser* arg0 = object<QTextBrowser>(param_this);
    QContextMenuEvent * arg1 = getqpointer<QContextMenuEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->contextMenuEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->contextMenuEvent_pub(arg1);
}
...
void qt_QTextBrowser_dragEnterEvent_void_QTextBrowser_QDragEnterEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->dragEnterEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->dragEnterEvent_pub(arg1);
}
...
void qt_QTextBrowser_dragLeaveEvent_void_QTextBrowser_QDragLeaveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->dragLeaveEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->dragLeaveEvent_pub(arg1);
}
...
void qt_QTextBrowser_dragMoveEvent_void_QTextBrowser_QDragMoveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->dragMoveEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->dragMoveEvent_pub(arg1);
}
...
void qt_QTextBrowser_dropEvent_void_QTextBrowser_QDropEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->dropEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->dropEvent_pub(arg1);
}
...
void qt_QTextBrowser_focusInEvent_void_QTextBrowser_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->focusInEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->focusInEvent_pub(arg1);
}
...
void qt_QTextBrowser_keyReleaseEvent_void_QTextBrowser_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->keyReleaseEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->keyReleaseEvent_pub(arg1);
}
...
void qt_QTextBrowser_mouseDoubleClickEvent_void_QTextBrowser_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    QTextBrowser* arg0 = object<QTextBrowser>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_e);
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->mouseDoubleClickEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->mouseDoubleClickEvent_pub(arg1);
}
...
void qt_QTextBrowser_resizeEvent_void_QTextBrowser_QResizeEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->resizeEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->resizeEvent_pub(arg1);
}
...
void qt_QTextBrowser_scrollContentsBy_void_QTextBrowser_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_dx, int param_dy)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->scrollContentsBy_pub_parent(arg1, arg2);
    else ((MuQt_QTextBrowser*)arg0)->scrollContentsBy_pub(arg1, arg2);
}
...
void qt_QTextBrowser_showEvent_void_QTextBrowser_QShowEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param__p13)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->showEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->showEvent_pub(arg1);
}
...
void qt_QTextBrowser_wheelEvent_void_QTextBrowser_QWheelEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTextBrowser*)arg0)->wheelEvent_pub_parent(arg1);
    else ((MuQt_QTextBrowser*)arg0)->wheelEvent_pub(arg1);
}


static NODE_IMPLEMENTATION(_n_QTextBrowser0, Pointer)
{
    NODE_RETURN(qt_QTextBrowser_QTextBrowser_QTextBrowser_QTextBrowser_QWidget(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
{
    NODE_RETURN(qt_QTextBrowser_loadResource_QVariant_QTextBrowser_int_QUrl(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer)));
}

static NODE_IMPLEMENTATION(_n_doSetSource0, void)
{
    qt_QTextBrowser_doSetSource_void_QTextBrowser_QUrl_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int));
}
...
{
    NODE_RETURN(qt_QTextBrowser_canInsertFromMimeData_bool_QTextBrowser_QMimeData(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
{
    qt_QTextBrowser_contextMenuEvent_void_QTextBrowser_QContextMenuEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
{
    qt_QTextBrowser_scrollContentsBy_void_QTextBrowser_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int));
}
...
QTextBrowserType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QTextBrowser_QTextBrowser_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QTextBrowser", _n_QTextBrowser0, None, Compiled, qt_QTextBrowser_QTextBrowser_QTextBrowser_QTextBrowser_QWidget, Return, "qt.QTextBrowser", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "parent", "qt.QWidget"), End),
    new Function(c, "backwardHistoryCount", _n_backwardHistoryCount0, None, Compiled, qt_QTextBrowser_backwardHistoryCount_int_QTextBrowser, Return, "int", Parameters, new Param(c, "this", "qt.QTextBrowser"), End),
    new Function(c, "clearHistory", _n_clearHistory0, None, Compiled, qt_QTextBrowser_clearHistory_void_QTextBrowser, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), End),
    new Function(c, "forwardHistoryCount", _n_forwardHistoryCount0, None, Compiled, qt_QTextBrowser_forwardHistoryCount_int_QTextBrowser, Return, "int", Parameters, new Param(c, "this", "qt.QTextBrowser"), End),
    new Function(c, "historyTitle", _n_historyTitle0, None, Compiled, qt_QTextBrowser_historyTitle_string_QTextBrowser_int, Return, "string", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "i", "int"), End),
    new Function(c, "historyUrl", _n_historyUrl0, None, Compiled, qt_QTextBrowser_historyUrl_QUrl_QTextBrowser_int, Return, "qt.QUrl", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "i", "int"), End),
    new Function(c, "isBackwardAvailable", _n_isBackwardAvailable0, None, Compiled, qt_QTextBrowser_isBackwardAvailable_bool_QTextBrowser, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBrowser"), End),
    new Function(c, "isForwardAvailable", _n_isForwardAvailable0, None, Compiled, qt_QTextBrowser_isForwardAvailable_bool_QTextBrowser, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBrowser"), End),
    ...
    // PROP: sourceType (flags QTextDocument::ResourceType; QTextBrowser this)
    _func[0] = new MemberFunction(c, "loadResource", _n_loadResource0, None, Compiled, qt_QTextBrowser_loadResource_QVariant_QTextBrowser_int_QUrl, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "type", "int"), new Param(c, "name", "qt.QUrl"), End),
    _func[1] = new MemberFunction(c, "doSetSource", _n_doSetSource0, None, Compiled, qt_QTextBrowser_doSetSource_void_QTextBrowser_QUrl_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "url", "qt.QUrl"), new Param(c, "type", "int", Value((int)QTextDocument::UnknownResource)), End),
    _func[2] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QTextBrowser_event_bool_QTextBrowser_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QEvent"), End),
    _func[3] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QTextBrowser_focusNextPrevChild_bool_QTextBrowser_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "next", "bool"), End),
    _func[4] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QTextBrowser_focusOutEvent_void_QTextBrowser_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "ev", "qt.QFocusEvent"), End),
    _func[5] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QTextBrowser_keyPressEvent_void_QTextBrowser_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "ev", "qt.QKeyEvent"), End),
    _func[6] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QTextBrowser_mouseMoveEvent_void_QTextBrowser_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[7] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QTextBrowser_mousePressEvent_void_QTextBrowser_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[8] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QTextBrowser_mouseReleaseEvent_void_QTextBrowser_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[9] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QTextBrowser_paintEvent_void_QTextBrowser_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QPaintEvent"), End),
    _func[10] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QTextBrowser_inputMethodQuery_QVariant_QTextBrowser_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "property", "int"), End),
    _func[11] = new MemberFunction(c, "canInsertFromMimeData", _n_canInsertFromMimeData0, None, Compiled, qt_QTextBrowser_canInsertFromMimeData_bool_QTextBrowser_QMimeData, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "source", "qt.QMimeData"), End),
    _func[12] = new MemberFunction(c, "createMimeDataFromSelection", _n_createMimeDataFromSelection0, None, Compiled, qt_QTextBrowser_createMimeDataFromSelection_QMimeData_QTextBrowser, Return, "qt.QMimeData", Parameters, new Param(c, "this", "qt.QTextBrowser"), End),
    _func[13] = new MemberFunction(c, "insertFromMimeData", _n_insertFromMimeData0, None, Compiled, qt_QTextBrowser_insertFromMimeData_void_QTextBrowser_QMimeData, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "source", "qt.QMimeData"), End),
    _func[14] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled, qt_QTextBrowser_changeEvent_void_QTextBrowser_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QEvent"), End),
    _func[15] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled, qt_QTextBrowser_contextMenuEvent_void_QTextBrowser_QContextMenuEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "event", "qt.QContextMenuEvent"), End),
    _func[16] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QTextBrowser_dragEnterEvent_void_QTextBrowser_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QDragEnterEvent"), End),
    _func[17] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QTextBrowser_dragLeaveEvent_void_QTextBrowser_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QDragLeaveEvent"), End),
    _func[18] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QTextBrowser_dragMoveEvent_void_QTextBrowser_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QDragMoveEvent"), End),
    _func[19] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QTextBrowser_dropEvent_void_QTextBrowser_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QDropEvent"), End),
    _func[20] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QTextBrowser_focusInEvent_void_QTextBrowser_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QFocusEvent"), End),
    // MISSING: inputMethodEvent (void; QTextBrowser this, "QInputMethodEvent *" e) // protected
    _func[21] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QTextBrowser_keyReleaseEvent_void_QTextBrowser_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QKeyEvent"), End),
    _func[22] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QTextBrowser_mouseDoubleClickEvent_void_QTextBrowser_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[23] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QTextBrowser_resizeEvent_void_QTextBrowser_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QResizeEvent"), End),
    _func[24] = new MemberFunction(c, "scrollContentsBy", _n_scrollContentsBy0, None, Compiled, qt_QTextBrowser_scrollContentsBy_void_QTextBrowser_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "dx", "int"), new Param(c, "dy", "int"), End),
    _func[25] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QTextBrowser_showEvent_void_QTextBrowser_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "_p13", "qt.QShowEvent"), End),
    _func[26] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QTextBrowser_wheelEvent_void_QTextBrowser_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QWheelEvent"), End),
    // static functions
    EndArguments);
