...
namespace Mu
{
                                                                      ...
                                                                      Pointer param_title, int param_options)
    {
        ...
        QColorDialog::ColorDialogOptions arg3 = (QColorDialog::ColorDialogOptions)(param_options);
    ...
    void QColorDialogType::load()
    {
        ...
        addSymbols(
            ...
            _func[9] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled,
