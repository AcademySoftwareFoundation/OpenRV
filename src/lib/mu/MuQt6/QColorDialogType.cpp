...
addSymbols(
    ...
    _func[7] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled, qt_QColorDialog_eventFilter_bool_QColorDialog_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QColorDialog"), new Param(c, "o", "qt.QObject"), new Param(c, "e", "qt.QEvent"), End),
    _func[8] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QColorDialog_keyPressEvent_void_QColorDialog_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QColorDialog"), new Param(c, "e", "qt.QKeyEvent"), End),
    _func[9] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QColorDialog_resizeEvent_void_QColorDialog_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QColorDialog"), new Param(c, "_p15", "qt.QResizeEvent"), End),
    _func[10] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QColorDialog_showEvent_void_QColorDialog_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QColorDialog"), new Param(c, "event", "qt.QShowEvent"), End),
    // static functions
