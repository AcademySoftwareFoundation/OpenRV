...
addSymbols(
    ...
    new Function(c, "accept", _n_accept1, None, Compiled, qt_QGestureEvent_accept_void_QGestureEvent_int, Return, "void", Parameters, new Param(c, "this", "qt.QGestureEvent"), new Param(c, "gestureType", "int"), End),
    ...
    new Function(c, "ignore", _n_ignore1, None, Compiled, qt_QGestureEvent_ignore_void_QGestureEvent_int, Return, "void", Parameters, new Param(c, "this", "qt.QGestureEvent"), new Param(c, "gestureType", "int"), End),
    // MISSING: isAccepted (bool; QGestureEvent this, "QGesture *" gesture)
    new Function(c, "isAccepted", _n_isAccepted1, None, Compiled, qt_QGestureEvent_isAccepted_bool_QGestureEvent_int, Return, "bool", Parameters, new Param(c, "this", "qt.QGestureEvent"), new Param(c, "gestureType", "int"), End),
    ...
    new Function(c, "setAccepted", _n_setAccepted1, None, Compiled, qt_QGestureEvent_setAccepted_void_QGestureEvent_int_bool, Return, "void", Parameters, new Param(c, "this", "qt.QGestureEvent"), new Param(c, "gestureType", "int"), new Param(c, "value", "bool"), End),
