...
{
    if (!_env) { QLabel::paintEvent(_p14); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
addSymbols(
    ...
    _func[13] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QLabel_paintEvent_void_QLabel_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLabel"), new Param(c, "_p14", "qt.QPaintEvent"), End),
    // MISSING: initStyleOption (void; QLabel this, "QStyleOptionFrame *" option) // protected
    // static functions
    EndArguments);
