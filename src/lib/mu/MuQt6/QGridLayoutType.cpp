...
namespace Mu
{
    ...
    void qt_QGridLayout_setSpacing_void_QGridLayout_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_spacing)
    {
        ...
        if (isMuQtObject(arg0))
            arg0->QGridLayout::setSpacing(arg1);
        else
    ...
    Pointer qt_QGridLayout_replaceWidget_QLayoutItem_QGridLayout_QWidget_QWidget_int(Mu::Thread& NODE_THREAD, Pointer param_this,
                                                                                     ...
                                                                                     int param_options)
    {
        ...
        return isMuQtObject(arg0) ? makelayoutitem<QLayoutItemType>(c, arg0->QGridLayout::replaceWidget(arg1, arg2, arg3), "qt.QLayoutItem")
    ...
    {
        NODE_RETURN(qt_QGridLayout_replaceWidget_QLayoutItem_QGridLayout_QWidget_QWidget_int(
    ...
    void QGridLayoutType::load()
    {
        ...
        addSymbols(
            ...
            _func[10] =
                new MemberFunction(c, "setSpacing", _n_setSpacing0, None, Compiled, qt_QGridLayout_setSpacing_void_QGridLayout_int, Return,
                                   "void", Parameters, new Param(c, "this", "qt.QGridLayout"), new Param(c, "spacing", "int"), End),
            _func[11] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QGridLayout_sizeHint_QSize_QGridLayout, Return,
                                           "qt.QSize", Parameters, new Param(c, "this", "qt.QGridLayout"), End),
            _func[12] = new MemberFunction(c, "spacing", _n_spacing0, None, Compiled, qt_QGridLayout_spacing_int_QGridLayout, Return, "int",
                                           Parameters, new Param(c, "this", "qt.QGridLayout"), End),
            _func[13] =
            ...
            _func[16] = new MemberFunction(c, "replaceWidget", _n_replaceWidget0, None, Compiled,
                                           qt_QGridLayout_replaceWidget_QLayoutItem_QGridLayout_QWidget_QWidget_int, Return,
                                           "qt.QLayoutItem", Parameters, new Param(c, "this", "qt.QGridLayout"),
                                           new Param(c, "from", "qt.QWidget"), new Param(c, "to", "qt.QWidget"),
                                           new Param(c, "options", "int", Value((int)Qt::FindChildrenRecursively)), End),
            _func[17] = new MemberFunction(c, "controlTypes", _n_controlTypes0, None, Compiled, qt_QGridLayout_controlTypes_int_QGridLayout,
                                           Return, "int", Parameters, new Param(c, "this", "qt.QGridLayout"), End),
            _func[18] = new MemberFunction(c, "geometry", _n_geometry0, None, Compiled, qt_QGridLayout_geometry_QRect_QGridLayout, Return,
                                           "qt.QRect", Parameters, new Param(c, "this", "qt.QGridLayout"), End),
            _func[19] = new MemberFunction(c, "isEmpty", _n_isEmpty0, None, Compiled, qt_QGridLayout_isEmpty_bool_QGridLayout, Return,
                                           "bool", Parameters, new Param(c, "this", "qt.QGridLayout"), End),
            _func[20] = new MemberFunction(c, "layout", _n_layout0, None, Compiled, qt_QGridLayout_layout_QLayout_QGridLayout, Return,
