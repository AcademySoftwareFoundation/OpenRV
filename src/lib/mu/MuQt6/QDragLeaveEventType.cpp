...
QDragLeaveEventType::~QDragLeaveEventType()
{
}
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QDragLeaveEvent", _n_QDragLeaveEvent0, None, Compiled, qt_QDragLeaveEvent_QDragLeaveEvent_QDragLeaveEvent_QDragLeaveEvent, Return, "qt.QDragLeaveEvent", Parameters, new Param(c, "this", "qt.QDragLeaveEvent"), End),
    // static functions
    EndArguments);
