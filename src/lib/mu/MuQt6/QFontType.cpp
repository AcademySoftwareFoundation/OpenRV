...
QFontType::Instance::Instance(const Class* c) : ClassInstance(c)
{
}
...
void 
QFontType::registerFinalizer (void* o)
{
    GC_register_finalizer(o, QFontType::finalizer, 0, 0, 0);
}

void 
QFontType::finalizer (void* obj, void* data)
{
...
Pointer qt_QFont_QFont_QFont_QFont_string_int_int_bool(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_family, int param_pointSize, int param_weight, bool param_italic)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QFont_QFont_QFont_QFont_stringBSB_ESB__int_int_bool(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_families, int param_pointSize, int param_weight, bool param_italic)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
void qt_QFont_insertSubstitutions_void_string_stringBSB_ESB_(Mu::Thread& NODE_THREAD, Pointer param_familyName, Pointer param_substituteNames)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QString  arg0 = qstring(param_familyName);
...
{
    NODE_RETURN(qt_QFont_QFont_QFont_QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_QFont1, Pointer)
{
    NODE_RETURN(qt_QFont_QFont_QFont_QFont_string_int_int_bool(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, int), NODE_ARG(4, bool)));
}

static NODE_IMPLEMENTATION(_n_QFont2, Pointer)
{
    NODE_RETURN(qt_QFont_QFont_QFont_QFont_stringBSB_ESB__int_int_bool(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, int), NODE_ARG(4, bool)));
}

static NODE_IMPLEMENTATION(_n_QFont3, Pointer)
{
    NODE_RETURN(qt_QFont_QFont_QFont_QFont_QFont_QPaintDevice(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}

static NODE_IMPLEMENTATION(_n_bold0, bool)
{
    NODE_RETURN(qt_QFont_bold_bool_QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QFont_family_string_QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QFont_italic_bool_QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_kerning0, bool)
{
    NODE_RETURN(qt_QFont_kerning_bool_QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_key0, Pointer)
{
    NODE_RETURN(qt_QFont_key_string_QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QFont_overline_bool_QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_pixelSize0, int)
{
    NODE_RETURN(qt_QFont_pixelSize_int_QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QFont_stretch_int_QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QFont_style_int_QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_styleHint0, int)
{
    NODE_RETURN(qt_QFont_styleHint_int_QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QFont_weight_int_QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
addSymbols(
    new Alias(c, "Capitalization", "int"),
      new SymbolicConstant(c, "MixedCase", "int", Value(int(QFont::MixedCase))),
      ...
      new SymbolicConstant(c, "Capitalize", "int", Value(int(QFont::Capitalize))),
    ...
    new Alias(c, "SpacingType", "int"),
      ...
      new SymbolicConstant(c, "AbsoluteSpacing", "int", Value(int(QFont::AbsoluteSpacing))),
    new Alias(c, "Stretch", "int"),
      ...
      new SymbolicConstant(c, "UltraExpanded", "int", Value(int(QFont::UltraExpanded))),
    new Alias(c, "Style", "int"),
      ...
      new SymbolicConstant(c, "StyleOblique", "int", Value(int(QFont::StyleOblique))),
    ...
    new Alias(c, "StyleStrategy", "int"),
      ...
      new SymbolicConstant(c, "PreferNoShaping", "int", Value(int(QFont::PreferNoShaping))),
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QFont", _n_QFont0, None, Compiled, qt_QFont_QFont_QFont_QFont, Return, "qt.QFont", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "QFont", _n_QFont1, None, Compiled, qt_QFont_QFont_QFont_QFont_string_int_int_bool, Return, "qt.QFont", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "family", "string"), new Param(c, "pointSize", "int", Value((int)-1)), new Param(c, "weight", "int", Value((int)-1)), new Param(c, "italic", "bool"), End),
    new Function(c, "QFont", _n_QFont2, None, Compiled, qt_QFont_QFont_QFont_QFont_stringBSB_ESB__int_int_bool, Return, "qt.QFont", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "families", "string[]"), new Param(c, "pointSize", "int", Value((int)-1)), new Param(c, "weight", "int", Value((int)-1)), new Param(c, "italic", "bool"), End),
    new Function(c, "QFont", _n_QFont3, None, Compiled, qt_QFont_QFont_QFont_QFont_QFont_QPaintDevice, Return, "qt.QFont", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "font", "qt.QFont"), new Param(c, "pd", "qt.QPaintDevice"), End),
    // MISSING: QFont (QFont; QFont this, QFont font)
    new Function(c, "bold", _n_bold0, None, Compiled, qt_QFont_bold_bool_QFont, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "capitalization", _n_capitalization0, None, Compiled, qt_QFont_capitalization_int_QFont, Return, "int", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "defaultFamily", _n_defaultFamily0, None, Compiled, qt_QFont_defaultFamily_string_QFont, Return, "string", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "exactMatch", _n_exactMatch0, None, Compiled, qt_QFont_exactMatch_bool_QFont, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "families", _n_families0, None, Compiled, qt_QFont_families_stringBSB_ESB__QFont, Return, "string[]", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "family", _n_family0, None, Compiled, qt_QFont_family_string_QFont, Return, "string", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "fixedPitch", _n_fixedPitch0, None, Compiled, qt_QFont_fixedPitch_bool_QFont, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "fromString", _n_fromString0, None, Compiled, qt_QFont_fromString_bool_QFont_string, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "descrip", "string"), End),
    new Function(c, "hintingPreference", _n_hintingPreference0, None, Compiled, qt_QFont_hintingPreference_int_QFont, Return, "int", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "isCopyOf", _n_isCopyOf0, None, Compiled, qt_QFont_isCopyOf_bool_QFont_QFont, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "f", "qt.QFont"), End),
    new Function(c, "italic", _n_italic0, None, Compiled, qt_QFont_italic_bool_QFont, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "kerning", _n_kerning0, None, Compiled, qt_QFont_kerning_bool_QFont, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "key", _n_key0, None, Compiled, qt_QFont_key_string_QFont, Return, "string", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "letterSpacing", _n_letterSpacing0, None, Compiled, qt_QFont_letterSpacing_double_QFont, Return, "double", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "letterSpacingType", _n_letterSpacingType0, None, Compiled, qt_QFont_letterSpacingType_int_QFont, Return, "int", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "overline", _n_overline0, None, Compiled, qt_QFont_overline_bool_QFont, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "pixelSize", _n_pixelSize0, None, Compiled, qt_QFont_pixelSize_int_QFont, Return, "int", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "pointSize", _n_pointSize0, None, Compiled, qt_QFont_pointSize_int_QFont, Return, "int", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "pointSizeF", _n_pointSizeF0, None, Compiled, qt_QFont_pointSizeF_double_QFont, Return, "double", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "resolve", _n_resolve0, None, Compiled, qt_QFont_resolve_QFont_QFont_QFont, Return, "qt.QFont", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "other", "qt.QFont"), End),
    new Function(c, "setBold", _n_setBold0, None, Compiled, qt_QFont_setBold_void_QFont_bool, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "enable", "bool"), End),
    new Function(c, "setCapitalization", _n_setCapitalization0, None, Compiled, qt_QFont_setCapitalization_void_QFont_int, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "caps", "int"), End),
    new Function(c, "setFamilies", _n_setFamilies0, None, Compiled, qt_QFont_setFamilies_void_QFont_stringBSB_ESB_, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "families", "string[]"), End),
    new Function(c, "setFamily", _n_setFamily0, None, Compiled, qt_QFont_setFamily_void_QFont_string, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "family", "string"), End),
    new Function(c, "setFixedPitch", _n_setFixedPitch0, None, Compiled, qt_QFont_setFixedPitch_void_QFont_bool, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "enable", "bool"), End),
    new Function(c, "setHintingPreference", _n_setHintingPreference0, None, Compiled, qt_QFont_setHintingPreference_void_QFont_int, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "hintingPreference", "int"), End),
    new Function(c, "setItalic", _n_setItalic0, None, Compiled, qt_QFont_setItalic_void_QFont_bool, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "enable", "bool"), End),
    new Function(c, "setKerning", _n_setKerning0, None, Compiled, qt_QFont_setKerning_void_QFont_bool, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "enable", "bool"), End),
    new Function(c, "setLetterSpacing", _n_setLetterSpacing0, None, Compiled, qt_QFont_setLetterSpacing_void_QFont_int_double, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "type", "int"), new Param(c, "spacing", "double"), End),
    new Function(c, "setOverline", _n_setOverline0, None, Compiled, qt_QFont_setOverline_void_QFont_bool, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "enable", "bool"), End),
    new Function(c, "setPixelSize", _n_setPixelSize0, None, Compiled, qt_QFont_setPixelSize_void_QFont_int, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "pixelSize", "int"), End),
    new Function(c, "setPointSize", _n_setPointSize0, None, Compiled, qt_QFont_setPointSize_void_QFont_int, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "pointSize", "int"), End),
    new Function(c, "setPointSizeF", _n_setPointSizeF0, None, Compiled, qt_QFont_setPointSizeF_void_QFont_double, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "pointSize", "double"), End),
    new Function(c, "setStretch", _n_setStretch0, None, Compiled, qt_QFont_setStretch_void_QFont_int, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "factor", "int"), End),
    new Function(c, "setStrikeOut", _n_setStrikeOut0, None, Compiled, qt_QFont_setStrikeOut_void_QFont_bool, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "enable", "bool"), End),
    new Function(c, "setStyle", _n_setStyle0, None, Compiled, qt_QFont_setStyle_void_QFont_int, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "style", "int"), End),
    new Function(c, "setStyleHint", _n_setStyleHint0, None, Compiled, qt_QFont_setStyleHint_void_QFont_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "hint", "int"), new Param(c, "strategy", "int", Value((int)QFont::PreferDefault)), End),
    new Function(c, "setStyleName", _n_setStyleName0, None, Compiled, qt_QFont_setStyleName_void_QFont_string, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "styleName", "string"), End),
    new Function(c, "setStyleStrategy", _n_setStyleStrategy0, None, Compiled, qt_QFont_setStyleStrategy_void_QFont_int, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "s", "int"), End),
    new Function(c, "setUnderline", _n_setUnderline0, None, Compiled, qt_QFont_setUnderline_void_QFont_bool, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "enable", "bool"), End),
    new Function(c, "setWeight", _n_setWeight0, None, Compiled, qt_QFont_setWeight_void_QFont_int, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "weight", "int"), End),
    new Function(c, "setWordSpacing", _n_setWordSpacing0, None, Compiled, qt_QFont_setWordSpacing_void_QFont_double, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "spacing", "double"), End),
    new Function(c, "stretch", _n_stretch0, None, Compiled, qt_QFont_stretch_int_QFont, Return, "int", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "strikeOut", _n_strikeOut0, None, Compiled, qt_QFont_strikeOut_bool_QFont, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "style", _n_style0, None, Compiled, qt_QFont_style_int_QFont, Return, "int", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "styleHint", _n_styleHint0, None, Compiled, qt_QFont_styleHint_int_QFont, Return, "int", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "styleName", _n_styleName0, None, Compiled, qt_QFont_styleName_string_QFont, Return, "string", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "styleStrategy", _n_styleStrategy0, None, Compiled, qt_QFont_styleStrategy_int_QFont, Return, "int", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "swap", _n_swap0, None, Compiled, qt_QFont_swap_void_QFont_QFont, Return, "void", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "other", "qt.QFont"), End),
    new Function(c, "toString", _n_toString0, None, Compiled, qt_QFont_toString_string_QFont, Return, "string", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "underline", _n_underline0, None, Compiled, qt_QFont_underline_bool_QFont, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "weight", _n_weight0, None, Compiled, qt_QFont_weight_int_QFont, Return, "int", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "wordSpacing", _n_wordSpacing0, None, Compiled, qt_QFont_wordSpacing_double_QFont, Return, "double", Parameters, new Param(c, "this", "qt.QFont"), End),
    // MISSING: QVariant ("QVariant operator"; QFont this)
    // static functions
    new Function(c, "insertSubstitution", _n_insertSubstitution0, None, Compiled, qt_QFont_insertSubstitution_void_string_string, Return, "void", Parameters, new Param(c, "familyName", "string"), new Param(c, "substituteName", "string"), End),
    new Function(c, "insertSubstitutions", _n_insertSubstitutions0, None, Compiled, qt_QFont_insertSubstitutions_void_string_stringBSB_ESB_, Return, "void", Parameters, new Param(c, "familyName", "string"), new Param(c, "substituteNames", "string[]"), End),
    new Function(c, "removeSubstitutions", _n_removeSubstitutions0, None, Compiled, qt_QFont_removeSubstitutions_void_string, Return, "void", Parameters, new Param(c, "familyName", "string"), End),
    new Function(c, "substitute", _n_substitute0, None, Compiled, qt_QFont_substitute_string_string, Return, "string", Parameters, new Param(c, "familyName", "string"), End),
    new Function(c, "substitutes", _n_substitutes0, None, Compiled, qt_QFont_substitutes_stringBSB_ESB__string, Return, "string[]", Parameters, new Param(c, "familyName", "string"), End),
    new Function(c, "substitutions", _n_substitutions0, None, Compiled, qt_QFont_substitutions_stringBSB_ESB_, Return, "string[]", End),
    EndArguments);
globalScope()->addSymbols(
    new Function(c, "!=", _n_operatorBang_EQ_0, Op, Compiled, qt_QFont_operatorBang_EQ__bool_QFont_QFont, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "f", "qt.QFont"), End),
    new Function(c, "<", _n_operatorLT_0, Op, Compiled, qt_QFont_operatorLT__bool_QFont_QFont, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "f", "qt.QFont"), End),
    // MISSING: = (QFont; QFont this, QFont font)
    // MISSING: = (QFont; QFont this, "QFont & &" other)
    new Function(c, "==", _n_operatorEQ_EQ_0, Op, Compiled, qt_QFont_operatorEQ_EQ__bool_QFont_QFont, Return, "bool", Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "f", "qt.QFont"), End),
    EndArguments);
scope()->addSymbols(
    EndArguments);
