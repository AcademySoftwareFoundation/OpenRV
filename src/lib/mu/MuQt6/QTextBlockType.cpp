...
QTextBlockType::Instance::Instance(const Class* c) : ClassInstance(c)
{
}
...
void 
QTextBlockType::registerFinalizer (void* o)
{
    GC_register_finalizer(o, QTextBlockType::finalizer, 0, 0, 0);
}

void 
QTextBlockType::finalizer (void* obj, void* data)
{
...
{
    NODE_RETURN(qt_QTextBlock_operatorBang_EQ__bool_QTextBlock_QTextBlock(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
{
    NODE_RETURN(qt_QTextBlock_operatorEQ_EQ__bool_QTextBlock_QTextBlock(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
addSymbols(
    // enums
    // member functions
    // MISSING: QTextBlock (QTextBlock; QTextBlock this, QTextBlock other)
    // MISSING: begin ("QTextBlock::iterator"; QTextBlock this)
    // MISSING: blockFormat ("QTextBlockFormat"; QTextBlock this)
    new Function(c, "blockFormatIndex", _n_blockFormatIndex0, None, Compiled, qt_QTextBlock_blockFormatIndex_int_QTextBlock, Return, "int", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    new Function(c, "blockNumber", _n_blockNumber0, None, Compiled, qt_QTextBlock_blockNumber_int_QTextBlock, Return, "int", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    // MISSING: charFormat ("QTextCharFormat"; QTextBlock this)
    new Function(c, "charFormatIndex", _n_charFormatIndex0, None, Compiled, qt_QTextBlock_charFormatIndex_int_QTextBlock, Return, "int", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    new Function(c, "clearLayout", _n_clearLayout0, None, Compiled, qt_QTextBlock_clearLayout_void_QTextBlock, Return, "void", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    new Function(c, "contains", _n_contains0, None, Compiled, qt_QTextBlock_contains_bool_QTextBlock_int, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBlock"), new Param(c, "position", "int"), End),
    new Function(c, "document", _n_document0, None, Compiled, qt_QTextBlock_document_QTextDocument_QTextBlock, Return, "qt.QTextDocument", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    // MISSING: end ("QTextBlock::iterator"; QTextBlock this)
    new Function(c, "firstLineNumber", _n_firstLineNumber0, None, Compiled, qt_QTextBlock_firstLineNumber_int_QTextBlock, Return, "int", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    new Function(c, "isValid", _n_isValid0, None, Compiled, qt_QTextBlock_isValid_bool_QTextBlock, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    new Function(c, "isVisible", _n_isVisible0, None, Compiled, qt_QTextBlock_isVisible_bool_QTextBlock, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    // MISSING: layout ("QTextLayout *"; QTextBlock this)
    new Function(c, "length", _n_length0, None, Compiled, qt_QTextBlock_length_int_QTextBlock, Return, "int", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    new Function(c, "lineCount", _n_lineCount0, None, Compiled, qt_QTextBlock_lineCount_int_QTextBlock, Return, "int", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    new Function(c, "next", _n_next0, None, Compiled, qt_QTextBlock_next_QTextBlock_QTextBlock, Return, "qt.QTextBlock", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    new Function(c, "position", _n_position0, None, Compiled, qt_QTextBlock_position_int_QTextBlock, Return, "int", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    new Function(c, "previous", _n_previous0, None, Compiled, qt_QTextBlock_previous_QTextBlock_QTextBlock, Return, "qt.QTextBlock", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    new Function(c, "revision", _n_revision0, None, Compiled, qt_QTextBlock_revision_int_QTextBlock, Return, "int", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    new Function(c, "setLineCount", _n_setLineCount0, None, Compiled, qt_QTextBlock_setLineCount_void_QTextBlock_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextBlock"), new Param(c, "count", "int"), End),
    new Function(c, "setRevision", _n_setRevision0, None, Compiled, qt_QTextBlock_setRevision_void_QTextBlock_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextBlock"), new Param(c, "rev", "int"), End),
    // MISSING: setUserData (void; QTextBlock this, "QTextBlockUserData *" data)
    new Function(c, "setUserState", _n_setUserState0, None, Compiled, qt_QTextBlock_setUserState_void_QTextBlock_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextBlock"), new Param(c, "state", "int"), End),
    new Function(c, "setVisible", _n_setVisible0, None, Compiled, qt_QTextBlock_setVisible_void_QTextBlock_bool, Return, "void", Parameters, new Param(c, "this", "qt.QTextBlock"), new Param(c, "visible", "bool"), End),
    new Function(c, "text", _n_text0, None, Compiled, qt_QTextBlock_text_string_QTextBlock, Return, "string", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    new Function(c, "textDirection", _n_textDirection0, None, Compiled, qt_QTextBlock_textDirection_int_QTextBlock, Return, "int", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    // MISSING: textList ("QTextList *"; QTextBlock this)
    // MISSING: userData ("QTextBlockUserData *"; QTextBlock this)
    new Function(c, "userState", _n_userState0, None, Compiled, qt_QTextBlock_userState_int_QTextBlock, Return, "int", Parameters, new Param(c, "this", "qt.QTextBlock"), End),
    // static functions
    EndArguments);
globalScope()->addSymbols(
    new Function(c, "!=", _n_operatorBang_EQ_0, Op, Compiled, qt_QTextBlock_operatorBang_EQ__bool_QTextBlock_QTextBlock, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBlock"), new Param(c, "other", "qt.QTextBlock"), End),
    new Function(c, "<", _n_operatorLT_0, Op, Compiled, qt_QTextBlock_operatorLT__bool_QTextBlock_QTextBlock, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBlock"), new Param(c, "other", "qt.QTextBlock"), End),
    // MISSING: = (QTextBlock; QTextBlock this, QTextBlock other)
    new Function(c, "==", _n_operatorEQ_EQ_0, Op, Compiled, qt_QTextBlock_operatorEQ_EQ__bool_QTextBlock_QTextBlock, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBlock"), new Param(c, "other", "qt.QTextBlock"), End),
    EndArguments);
scope()->addSymbols(
    EndArguments);
