...
namespace Mu
{
    ...
    void QDockWidgetType::load()
    {
        ...
        addSymbols(
            ...
            // MISSING: enterEvent (void; QDockWidget this, "QEnterEvent *"
            // event) // protected
            ...
            // painter) // protected
            _func[30] = new MemberFunction(c, "metric", _n_metric0, None, Compiled, qt_QDockWidget_metric_int_QDockWidget_int, Return,
