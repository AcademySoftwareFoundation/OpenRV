...
int MuQt_QDockWidget::metric(QPaintDevice::PaintDeviceMetric m) const
{
...
addSymbols(
    ...
    // MISSING: enterEvent (void; QDockWidget this, "QEnterEvent *" event) // protected
    _func[14] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QDockWidget_focusInEvent_void_QDockWidget_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[15] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QDockWidget_focusNextPrevChild_bool_QDockWidget_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "next", "bool"), End),
    _func[16] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QDockWidget_focusOutEvent_void_QDockWidget_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[17] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QDockWidget_hideEvent_void_QDockWidget_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QHideEvent"), End),
    // MISSING: inputMethodEvent (void; QDockWidget this, "QInputMethodEvent *" event) // protected
    _func[18] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QDockWidget_keyPressEvent_void_QDockWidget_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[19] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QDockWidget_keyReleaseEvent_void_QDockWidget_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[20] = new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QDockWidget_leaveEvent_void_QDockWidget_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QEvent"), End),
    _func[21] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QDockWidget_mouseDoubleClickEvent_void_QDockWidget_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[22] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QDockWidget_mouseMoveEvent_void_QDockWidget_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[23] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QDockWidget_mousePressEvent_void_QDockWidget_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[24] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QDockWidget_mouseReleaseEvent_void_QDockWidget_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[25] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QDockWidget_moveEvent_void_QDockWidget_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QDockWidget this, QByteArray eventType, "void *" message, "qintptr *" result) // protected
    _func[26] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QDockWidget_resizeEvent_void_QDockWidget_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QResizeEvent"), End),
    _func[27] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QDockWidget_showEvent_void_QDockWidget_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QShowEvent"), End),
    _func[28] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QDockWidget_tabletEvent_void_QDockWidget_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QTabletEvent"), End),
    _func[29] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QDockWidget_wheelEvent_void_QDockWidget_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QWheelEvent"), End),
    // MISSING: initPainter (void; QDockWidget this, "QPainter *" painter) // protected
    _func[30] = new MemberFunction(c, "metric", _n_metric0, None, Compiled, qt_QDockWidget_metric_int_QDockWidget_int, Return, "int", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "m", "int"), End),
    // static functions
    EndArguments);
