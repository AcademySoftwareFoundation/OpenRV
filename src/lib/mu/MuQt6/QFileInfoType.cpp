...
namespace Mu
{
    ...
    void QFileInfoType::registerFinalizer(void* o) { GC_register_finalizer(o, QFileInfoType::finalizer, 0, 0, 0); }
    ...
    Pointer qt_QFileInfo_QFileInfo_QFileInfo_QFileInfo_QDir_string(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_dir,
                                                                   Pointer param_file)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    Pointer qt_QFileInfo_birthTime_QDateTime_QFileInfo(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QFileInfo& arg0 = getqtype<QFileInfoType>(param_this);
    ...
    Pointer qt_QFileInfo_fileTime_QDateTime_QFileInfo_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_time)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QFileInfo& arg0 = getqtype<QFileInfoType>(param_this);
    ...
    bool qt_QFileInfo_isAlias_bool_QFileInfo(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QFileInfo& arg0 = getqtype<QFileInfoType>(param_this);
        return arg0.isAlias();
    ...
    bool qt_QFileInfo_isJunction_bool_QFileInfo(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QFileInfo& arg0 = getqtype<QFileInfoType>(param_this);
    ...
    bool qt_QFileInfo_isShortcut_bool_QFileInfo(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QFileInfo& arg0 = getqtype<QFileInfoType>(param_this);
    ...
    bool qt_QFileInfo_isSymbolicLink_bool_QFileInfo(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QFileInfo& arg0 = getqtype<QFileInfoType>(param_this);
    ...
    Pointer qt_QFileInfo_junctionTarget_string_QFileInfo(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QFileInfo& arg0 = getqtype<QFileInfoType>(param_this);
    ...
    Pointer qt_QFileInfo_metadataChangeTime_QDateTime_QFileInfo(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QFileInfo& arg0 = getqtype<QFileInfoType>(param_this);
        return makeqtype<QDateTimeType>(c, arg0.metadataChangeTime(), "qt.QDateTime");
    }
    ...
    void qt_QFileInfo_stat_void_QFileInfo(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QFileInfo& arg0 = getqtype<QFileInfoType>(param_this);
        arg0.stat();
    ...
    {
        NODE_RETURN(qt_QFileInfo_QFileInfo_QFileInfo_QFileInfo_QDir_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                           NODE_ARG(2, Pointer)));
    }
    ...
    {
        NODE_RETURN(qt_QFileInfo_birthTime_QDateTime_QFileInfo(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_dir0, Pointer) { NODE_RETURN(qt_QFileInfo_dir_QDir_QFileInfo(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    {
        NODE_RETURN(qt_QFileInfo_isAlias_bool_QFileInfo(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    {
        NODE_RETURN(qt_QFileInfo_isJunction_bool_QFileInfo(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    {
        NODE_RETURN(qt_QFileInfo_isSymbolicLink_bool_QFileInfo(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    {
        NODE_RETURN(qt_QFileInfo_junctionTarget_string_QFileInfo(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    {
        NODE_RETURN(qt_QFileInfo_metadataChangeTime_QDateTime_QFileInfo(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_refresh0, void) { qt_QFileInfo_refresh_void_QFileInfo(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)); }
    ...
    {
        qt_QFileInfo_setFile_void_QFileInfo_QDir_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                        NODE_ARG(2, Pointer));
    }
    ...
    void QFileInfoType::load()
    {
        ...
        addSymbols(
            // enums
            // member functions
            new Function(c, "QFileInfo", _n_QFileInfo0, None, Compiled, qt_QFileInfo_QFileInfo_QFileInfo_QFileInfo, Return, "qt.QFileInfo",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "QFileInfo", _n_QFileInfo1, None, Compiled, qt_QFileInfo_QFileInfo_QFileInfo_QFileInfo_string, Return,
                         "qt.QFileInfo", Parameters, new Param(c, "this", "qt.QFileInfo"), new Param(c, "file", "string"), End),
            new Function(c, "QFileInfo", _n_QFileInfo2, None, Compiled, qt_QFileInfo_QFileInfo_QFileInfo_QFileInfo_QDir_string, Return,
                         "qt.QFileInfo", Parameters, new Param(c, "this", "qt.QFileInfo"), new Param(c, "dir", "qt.QDir"),
                         new Param(c, "file", "string"), End),
            // MISSING: QFileInfo (QFileInfo; QFileInfo this, QFileInfo
            // fileinfo)
            new Function(c, "absoluteDir", _n_absoluteDir0, None, Compiled, qt_QFileInfo_absoluteDir_QDir_QFileInfo, Return, "qt.QDir",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "absoluteFilePath", _n_absoluteFilePath0, None, Compiled, qt_QFileInfo_absoluteFilePath_string_QFileInfo,
                         Return, "string", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "absolutePath", _n_absolutePath0, None, Compiled, qt_QFileInfo_absolutePath_string_QFileInfo, Return, "string",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "baseName", _n_baseName0, None, Compiled, qt_QFileInfo_baseName_string_QFileInfo, Return, "string", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "birthTime", _n_birthTime0, None, Compiled, qt_QFileInfo_birthTime_QDateTime_QFileInfo, Return, "qt.QDateTime",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "bundleName", _n_bundleName0, None, Compiled, qt_QFileInfo_bundleName_string_QFileInfo, Return, "string",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "caching", _n_caching0, None, Compiled, qt_QFileInfo_caching_bool_QFileInfo, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "canonicalFilePath", _n_canonicalFilePath0, None, Compiled, qt_QFileInfo_canonicalFilePath_string_QFileInfo,
                         Return, "string", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "canonicalPath", _n_canonicalPath0, None, Compiled, qt_QFileInfo_canonicalPath_string_QFileInfo, Return,
                         "string", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "completeBaseName", _n_completeBaseName0, None, Compiled, qt_QFileInfo_completeBaseName_string_QFileInfo,
                         Return, "string", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "completeSuffix", _n_completeSuffix0, None, Compiled, qt_QFileInfo_completeSuffix_string_QFileInfo, Return,
                         "string", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "dir", _n_dir0, None, Compiled, qt_QFileInfo_dir_QDir_QFileInfo, Return, "qt.QDir", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "exists", _n_exists0, None, Compiled, qt_QFileInfo_exists_bool_QFileInfo, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "fileName", _n_fileName0, None, Compiled, qt_QFileInfo_fileName_string_QFileInfo, Return, "string", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "filePath", _n_filePath0, None, Compiled, qt_QFileInfo_filePath_string_QFileInfo, Return, "string", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "fileTime", _n_fileTime0, None, Compiled, qt_QFileInfo_fileTime_QDateTime_QFileInfo_int, Return, "qt.QDateTime",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), new Param(c, "time", "int"), End),
            new Function(c, "group", _n_group0, None, Compiled, qt_QFileInfo_group_string_QFileInfo, Return, "string", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "groupId", _n_groupId0, None, Compiled, qt_QFileInfo_groupId_int_QFileInfo, Return, "int", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isAbsolute", _n_isAbsolute0, None, Compiled, qt_QFileInfo_isAbsolute_bool_QFileInfo, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isAlias", _n_isAlias0, None, Compiled, qt_QFileInfo_isAlias_bool_QFileInfo, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isBundle", _n_isBundle0, None, Compiled, qt_QFileInfo_isBundle_bool_QFileInfo, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isDir", _n_isDir0, None, Compiled, qt_QFileInfo_isDir_bool_QFileInfo, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isExecutable", _n_isExecutable0, None, Compiled, qt_QFileInfo_isExecutable_bool_QFileInfo, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isFile", _n_isFile0, None, Compiled, qt_QFileInfo_isFile_bool_QFileInfo, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isHidden", _n_isHidden0, None, Compiled, qt_QFileInfo_isHidden_bool_QFileInfo, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isJunction", _n_isJunction0, None, Compiled, qt_QFileInfo_isJunction_bool_QFileInfo, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isNativePath", _n_isNativePath0, None, Compiled, qt_QFileInfo_isNativePath_bool_QFileInfo, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isReadable", _n_isReadable0, None, Compiled, qt_QFileInfo_isReadable_bool_QFileInfo, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isRelative", _n_isRelative0, None, Compiled, qt_QFileInfo_isRelative_bool_QFileInfo, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isRoot", _n_isRoot0, None, Compiled, qt_QFileInfo_isRoot_bool_QFileInfo, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isShortcut", _n_isShortcut0, None, Compiled, qt_QFileInfo_isShortcut_bool_QFileInfo, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isSymLink", _n_isSymLink0, None, Compiled, qt_QFileInfo_isSymLink_bool_QFileInfo, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isSymbolicLink", _n_isSymbolicLink0, None, Compiled, qt_QFileInfo_isSymbolicLink_bool_QFileInfo, Return,
                         "bool", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "isWritable", _n_isWritable0, None, Compiled, qt_QFileInfo_isWritable_bool_QFileInfo, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "junctionTarget", _n_junctionTarget0, None, Compiled, qt_QFileInfo_junctionTarget_string_QFileInfo, Return,
                         "string", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "lastModified", _n_lastModified0, None, Compiled, qt_QFileInfo_lastModified_QDateTime_QFileInfo, Return,
                         "qt.QDateTime", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "lastRead", _n_lastRead0, None, Compiled, qt_QFileInfo_lastRead_QDateTime_QFileInfo, Return, "qt.QDateTime",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "makeAbsolute", _n_makeAbsolute0, None, Compiled, qt_QFileInfo_makeAbsolute_bool_QFileInfo, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "metadataChangeTime", _n_metadataChangeTime0, None, Compiled,
                         qt_QFileInfo_metadataChangeTime_QDateTime_QFileInfo, Return, "qt.QDateTime", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "owner", _n_owner0, None, Compiled, qt_QFileInfo_owner_string_QFileInfo, Return, "string", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "ownerId", _n_ownerId0, None, Compiled, qt_QFileInfo_ownerId_int_QFileInfo, Return, "int", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "path", _n_path0, None, Compiled, qt_QFileInfo_path_string_QFileInfo, Return, "string", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "permission", _n_permission0, None, Compiled, qt_QFileInfo_permission_bool_QFileInfo_int, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), new Param(c, "permissions", "int"), End),
            new Function(c, "permissions", _n_permissions0, None, Compiled, qt_QFileInfo_permissions_int_QFileInfo, Return, "int",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "refresh", _n_refresh0, None, Compiled, qt_QFileInfo_refresh_void_QFileInfo, Return, "void", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "setCaching", _n_setCaching0, None, Compiled, qt_QFileInfo_setCaching_void_QFileInfo_bool, Return, "void",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), new Param(c, "enable", "bool"), End),
            new Function(c, "setFile", _n_setFile0, None, Compiled, qt_QFileInfo_setFile_void_QFileInfo_string, Return, "void", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), new Param(c, "file", "string"), End),
            new Function(c, "setFile", _n_setFile1, None, Compiled, qt_QFileInfo_setFile_void_QFileInfo_QDir_string, Return, "void",
                         Parameters, new Param(c, "this", "qt.QFileInfo"), new Param(c, "dir", "qt.QDir"), new Param(c, "file", "string"),
                         End),
            new Function(c, "size", _n_size0, None, Compiled, qt_QFileInfo_size_int64_QFileInfo, Return, "int64", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "stat", _n_stat0, None, Compiled, qt_QFileInfo_stat_void_QFileInfo, Return, "void", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "suffix", _n_suffix0, None, Compiled, qt_QFileInfo_suffix_string_QFileInfo, Return, "string", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), End),
            new Function(c, "swap", _n_swap0, None, Compiled, qt_QFileInfo_swap_void_QFileInfo_QFileInfo, Return, "void", Parameters,
                         new Param(c, "this", "qt.QFileInfo"), new Param(c, "other", "qt.QFileInfo"), End),
            new Function(c, "symLinkTarget", _n_symLinkTarget0, None, Compiled, qt_QFileInfo_symLinkTarget_string_QFileInfo, Return,
                         "string", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
            // static functions
            new Function(c, "exists", _n_exists1, None, Compiled, qt_QFileInfo_exists_bool_string, Return, "bool", Parameters,
                         new Param(c, "file", "string"), End),
            EndArguments);
