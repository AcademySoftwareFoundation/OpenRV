...
{
    qt_QFileInfo_stat_void_QFileInfo(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
addSymbols(
    ...
    new Function(c, "birthTime", _n_birthTime0, None, Compiled, qt_QFileInfo_birthTime_QDateTime_QFileInfo, Return, "qt.QDateTime", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
    ...
    new Function(c, "isAlias", _n_isAlias0, None, Compiled, qt_QFileInfo_isAlias_bool_QFileInfo, Return, "bool", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
    ...
    new Function(c, "isJunction", _n_isJunction0, None, Compiled, qt_QFileInfo_isJunction_bool_QFileInfo, Return, "bool", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
    ...
    new Function(c, "isShortcut", _n_isShortcut0, None, Compiled, qt_QFileInfo_isShortcut_bool_QFileInfo, Return, "bool", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
    ...
    new Function(c, "isSymbolicLink", _n_isSymbolicLink0, None, Compiled, qt_QFileInfo_isSymbolicLink_bool_QFileInfo, Return, "bool", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
    ...
    new Function(c, "junctionTarget", _n_junctionTarget0, None, Compiled, qt_QFileInfo_junctionTarget_string_QFileInfo, Return, "string", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
    ...
    new Function(c, "metadataChangeTime", _n_metadataChangeTime0, None, Compiled, qt_QFileInfo_metadataChangeTime_QDateTime_QFileInfo, Return, "qt.QDateTime", Parameters, new Param(c, "this", "qt.QFileInfo"), End),
