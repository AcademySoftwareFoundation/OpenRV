...
addSymbols(
    ...
    new Function(c, "mkdir", _n_mkdir0, None, Compiled, qt_QDir_mkdir_bool_QDir_string_int, Return, "bool", Parameters, new Param(c, "this", "qt.QDir"), new Param(c, "dirName", "string"), new Param(c, "permissions", "int"), End),
    new Function(c, "mkdir", _n_mkdir1, None, Compiled, qt_QDir_mkdir_bool_QDir_string, Return, "bool", Parameters, new Param(c, "this", "qt.QDir"), new Param(c, "dirName", "string"), End),
