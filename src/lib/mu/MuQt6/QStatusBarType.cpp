...
int MuQt_QStatusBar::metric(QPaintDevice::PaintDeviceMetric m) const
{
    if (!_env) return QStatusBar::metric(m);
    MuLangContext* c = (MuLangContext*)_env->context();
...
addSymbols(
    ...
    // MISSING: enterEvent (void; QStatusBar this, "QEnterEvent *" event) // protected
    _func[16] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QStatusBar_focusInEvent_void_QStatusBar_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[17] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QStatusBar_focusNextPrevChild_bool_QStatusBar_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "next", "bool"), End),
    _func[18] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QStatusBar_focusOutEvent_void_QStatusBar_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[19] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QStatusBar_hideEvent_void_QStatusBar_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QHideEvent"), End),
    // MISSING: inputMethodEvent (void; QStatusBar this, "QInputMethodEvent *" event) // protected
    _func[20] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QStatusBar_keyPressEvent_void_QStatusBar_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[21] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QStatusBar_keyReleaseEvent_void_QStatusBar_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[22] = new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QStatusBar_leaveEvent_void_QStatusBar_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QEvent"), End),
    _func[23] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QStatusBar_mouseDoubleClickEvent_void_QStatusBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[24] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QStatusBar_mouseMoveEvent_void_QStatusBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[25] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QStatusBar_mousePressEvent_void_QStatusBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[26] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QStatusBar_mouseReleaseEvent_void_QStatusBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[27] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QStatusBar_moveEvent_void_QStatusBar_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QStatusBar this, QByteArray eventType, "void *" message, "qintptr *" result) // protected
    _func[28] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QStatusBar_tabletEvent_void_QStatusBar_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QTabletEvent"), End),
    _func[29] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QStatusBar_wheelEvent_void_QStatusBar_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QWheelEvent"), End),
    // MISSING: initPainter (void; QStatusBar this, "QPainter *" painter) // protected
    _func[30] = new MemberFunction(c, "metric", _n_metric0, None, Compiled, qt_QStatusBar_metric_int_QStatusBar_int, Return, "int", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "m", "int"), End),
    // static functions
    EndArguments);
