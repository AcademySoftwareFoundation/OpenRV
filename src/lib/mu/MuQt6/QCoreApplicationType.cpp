...
addSymbols(
    ...
    // MISSING: checkPermission (flags Qt::PermissionStatus; QCoreApplication this, "const QPermission &" permission)
    // MISSING: installNativeEventFilter (void; QCoreApplication this, "QAbstractNativeEventFilter *" filterObj)
    ...
    // MISSING: removeNativeEventFilter (void; QCoreApplication this, "QAbstractNativeEventFilter *" filterObject)
    // MISSING: requestPermission (void; QCoreApplication this, "const QPermission &" permission, QObject context, "Functor" functor)
    ...
    // MISSING: connectNotify (void; QCoreApplication this, "const QMetaMethod &" signal) // protected
    ...
    // MISSING: disconnectNotify (void; QCoreApplication this, "const QMetaMethod &" signal) // protected
    ...
    // MISSING: installTranslator (bool; "QTranslator *" translationFile)
    ...
    new Function(c, "isSetuidAllowed", _n_isSetuidAllowed0, None, Compiled, qt_QCoreApplication_isSetuidAllowed_bool, Return, "bool", End),
    ...
    new Function(c, "postEvent", _n_postEvent0, None, Compiled, qt_QCoreApplication_postEvent_void_QObject_QEvent_int, Return, "void", Parameters, new Param(c, "receiver", "qt.QObject"), new Param(c, "event", "qt.QEvent"), new Param(c, "priority", "int", Value((int)Qt::NormalEventPriority)), End),
    new Function(c, "processEvents", _n_processEvents0, None, Compiled, qt_QCoreApplication_processEvents_void_int, Return, "void", Parameters, new Param(c, "flags", "int", Value((int)QEventLoop::AllEvents)), End),
    new Function(c, "processEvents", _n_processEvents1, None, Compiled, qt_QCoreApplication_processEvents_void_int_int, Return, "void", Parameters, new Param(c, "flags", "int"), new Param(c, "ms", "int"), End),
    ...
    new Function(c, "removePostedEvents", _n_removePostedEvents0, None, Compiled, qt_QCoreApplication_removePostedEvents_void_QObject_int, Return, "void", Parameters, new Param(c, "receiver", "qt.QObject"), new Param(c, "eventType", "int", Value((int)0)), End),
    ...
    new Function(c, "sendPostedEvents", _n_sendPostedEvents0, None, Compiled, qt_QCoreApplication_sendPostedEvents_void_QObject_int, Return, "void", Parameters, new Param(c, "receiver", "qt.QObject"), new Param(c, "event_type", "int", Value((int)0)), End),
    ...
    // MISSING: setEventDispatcher (void; "QAbstractEventDispatcher *" eventDispatcher)
    ...
    new Function(c, "setSetuidAllowed", _n_setSetuidAllowed0, None, Compiled, qt_QCoreApplication_setSetuidAllowed_void_bool, Return, "void", Parameters, new Param(c, "allow", "bool"), End),
    ...
    // MISSING: translate (string; "const char *" context, "const char *" sourceText, "const char *" disambiguation, int n)
    EndArguments);
