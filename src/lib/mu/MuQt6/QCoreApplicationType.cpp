...
namespace Mu
{
    ...
    void qt_QCoreApplication_processEvents_void_int_int(Mu::Thread& NODE_THREAD, int param_flags, int param_ms)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QEventLoop::ProcessEventsFlags arg0 = (QEventLoop::ProcessEventsFlags)(param_flags);
    ...
    void QCoreApplicationType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "processEvents", _n_processEvents1, None, Compiled, qt_QCoreApplication_processEvents_void_int_int, Return,
                         "void", Parameters, new Param(c, "flags", "int"), new Param(c, "ms", "int"), End),
