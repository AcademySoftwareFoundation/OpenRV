...
namespace Mu
{
    ...
    static Pointer QFile_QFile_QObject(Thread& NODE_THREAD, Pointer obj)
    {
        ...
        {
            QFileType* type = c->findSymbolOfTypeByQualifiedName<QFileType>(c->internName("qt.QFile"), false);
    ...
    static NODE_IMPLEMENTATION(castFromObject, Pointer) { NODE_RETURN(QFile_QFile_QObject(NODE_THREAD, NODE_ARG(0, Pointer))); }

    Pointer qt_QFile_QFile_QFile_QFile(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        setobject(param_this, new MuQt_QFile(param_this, NODE_THREAD.process()->callEnv()));
        return param_this;
    }
    ...
    bool qt_QFile_moveToTrash_bool_QFile(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QFile* arg0 = object<QFile>(param_this);
    ...
    bool qt_QFile_open_bool_QFile_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_mode, int param_permissions)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QFile* arg0 = object<QFile>(param_this);
        QIODeviceBase::OpenMode arg1 = (QIODeviceBase::OpenMode)(param_mode);
        QFileDevice::Permissions arg2 = (QFileDevice::Permissions)(param_permissions);
        return arg0->open(arg1, arg2);
    }

    bool qt_QFile_open_bool_QFile_int_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_fd, int param_mode,
                                              int param_handleFlags)
    {
        ...
        QFileDevice::FileHandleFlags arg3 = (QFileDevice::FileHandleFlags)(param_handleFlags);
    ...
    int qt_QFile_permissions_int_QFile(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QFile* arg0 = object<QFile>(param_this);
        return isMuQtObject(arg0) ? int(arg0->QFile::permissions()) : int(arg0->permissions());
    }
    ...
    int qt_QFile_permissions_int_string(Mu::Thread& NODE_THREAD, Pointer param_fileName)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QString arg0 = qstring(param_fileName);
    ...
    static NODE_IMPLEMENTATION(_n_QFile0, Pointer) { NODE_RETURN(qt_QFile_QFile_QFile_QFile(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    {
        NODE_RETURN(qt_QFile_QFile_QFile_QFile_string_QObject(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                              NODE_ARG(2, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_exists0, bool) { NODE_RETURN(qt_QFile_exists_bool_QFile(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    {
        NODE_RETURN(qt_QFile_moveToTrash_bool_QFile(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }

    static NODE_IMPLEMENTATION(_n_open0, bool)
    {
        NODE_RETURN(qt_QFile_open_bool_QFile_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
    }

    static NODE_IMPLEMENTATION(_n_open2, bool)
    {
        NODE_RETURN(qt_QFile_open_bool_QFile_int_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int),
                                                         NODE_ARG(3, int)));
    }

    static NODE_IMPLEMENTATION(_n_remove0, bool) { NODE_RETURN(qt_QFile_remove_bool_QFile(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    {
        NODE_RETURN(qt_QFile_open_bool_QFile_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
    }

    static NODE_IMPLEMENTATION(_n_permissions0, int)
    {
        NODE_RETURN(qt_QFile_permissions_int_QFile(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_size0, int64) { NODE_RETURN(qt_QFile_size_int64_QFile(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    static NODE_IMPLEMENTATION(_n_pos0, int64) { NODE_RETURN(qt_QFile_pos_int64_QFile(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    static NODE_IMPLEMENTATION(_n_exists1, bool) { NODE_RETURN(qt_QFile_exists_bool_string(NODE_THREAD, NODE_ARG(0, Pointer))); }
    ...
    static NODE_IMPLEMENTATION(_n_permissions1, int) { NODE_RETURN(qt_QFile_permissions_int_string(NODE_THREAD, NODE_ARG(0, Pointer))); }
    ...
    void QFileType::load()
    {
        ...
        addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None, Return, ftn, End),
                   ...
                   new Function(c, tn, castFromObject, Cast, Compiled, QFile_QFile_QObject, Return, ftn, Parameters,
        ...
        addSymbols(
            // enums
            // member functions
            new Function(c, "QFile", _n_QFile0, None, Compiled, qt_QFile_QFile_QFile_QFile, Return, "qt.QFile", Parameters,
            ...
            new Function(c, "QFile", _n_QFile1, None, Compiled, qt_QFile_QFile_QFile_QFile_string, Return, "qt.QFile", Parameters,
                         new Param(c, "this", "qt.QFile"), new Param(c, "name", "string"), End),
            new Function(c, "QFile", _n_QFile2, None, Compiled, qt_QFile_QFile_QFile_QFile_QObject, Return, "qt.QFile", Parameters,
                         new Param(c, "this", "qt.QFile"), new Param(c, "parent", "qt.QObject"), End),
            new Function(c, "QFile", _n_QFile3, None, Compiled, qt_QFile_QFile_QFile_QFile_string_QObject, Return, "qt.QFile", Parameters,
                         new Param(c, "this", "qt.QFile"), new Param(c, "name", "string"), new Param(c, "parent", "qt.QObject"), End),
            new Function(c, "copy", _n_copy0, None, Compiled, qt_QFile_copy_bool_QFile_string, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFile"), new Param(c, "newName", "string"), End),
            new Function(c, "exists", _n_exists0, None, Compiled, qt_QFile_exists_bool_QFile, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFile"), End),
            new Function(c, "link", _n_link0, None, Compiled, qt_QFile_link_bool_QFile_string, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFile"), new Param(c, "linkName", "string"), End),
            new Function(c, "moveToTrash", _n_moveToTrash0, None, Compiled, qt_QFile_moveToTrash_bool_QFile, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFile"), End),
            new Function(c, "open", _n_open0, None, Compiled, qt_QFile_open_bool_QFile_int_int, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFile"), new Param(c, "mode", "int"), new Param(c, "permissions", "int"), End),
            // MISSING: open (bool; QFile this, "FILE *" fh, flags
            // QIODeviceBase::OpenMode mode, flags QFileDevice::FileHandleFlags
            // handleFlags)
            new Function(c, "open", _n_open2, None, Compiled, qt_QFile_open_bool_QFile_int_int_int, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFile"), new Param(c, "fd", "int"), new Param(c, "mode", "int"),
                         new Param(c, "handleFlags", "int", Value((int)QFileDevice::DontCloseHandle)), End),
            new Function(c, "remove", _n_remove0, None, Compiled, qt_QFile_remove_bool_QFile, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFile"), End),
            new Function(c, "rename", _n_rename0, None, Compiled, qt_QFile_rename_bool_QFile_string, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFile"), new Param(c, "newName", "string"), End),
            new Function(c, "setFileName", _n_setFileName0, None, Compiled, qt_QFile_setFileName_void_QFile_string, Return, "void",
                         Parameters, new Param(c, "this", "qt.QFile"), new Param(c, "name", "string"), End),
            new Function(c, "symLinkTarget", _n_symLinkTarget0, None, Compiled, qt_QFile_symLinkTarget_string_QFile, Return, "string",
                         Parameters, new Param(c, "this", "qt.QFile"), End),
            _func[0] = new MemberFunction(c, "fileName", _n_fileName0, None, Compiled, qt_QFile_fileName_string_QFile, Return, "string",
                                          Parameters, new Param(c, "this", "qt.QFile"), End),
            _func[1] = new MemberFunction(c, "open", _n_open3, None, Compiled, qt_QFile_open_bool_QFile_int, Return, "bool", Parameters,
                                          new Param(c, "this", "qt.QFile"), new Param(c, "mode", "int"), End),
            _func[2] = new MemberFunction(c, "permissions", _n_permissions0, None, Compiled, qt_QFile_permissions_int_QFile, Return, "int",
                                          Parameters, new Param(c, "this", "qt.QFile"), End),
            _func[3] = new MemberFunction(c, "resize", _n_resize0, None, Compiled, qt_QFile_resize_bool_QFile_int64, Return, "bool",
                                          Parameters, new Param(c, "this", "qt.QFile"), new Param(c, "sz", "int64"), End),
            _func[4] = new MemberFunction(c, "size", _n_size0, None, Compiled, qt_QFile_size_int64_QFile, Return, "int64", Parameters,
                                          new Param(c, "this", "qt.QFile"), End),
            _func[5] = new MemberFunction(c, "atEnd", _n_atEnd0, None, Compiled, qt_QFile_atEnd_bool_QFile, Return, "bool", Parameters,
                                          new Param(c, "this", "qt.QFile"), End),
            _func[6] = new MemberFunction(c, "close", _n_close0, None, Compiled, qt_QFile_close_void_QFile, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QFile"), End),
            _func[7] = new MemberFunction(c, "isSequential", _n_isSequential0, None, Compiled, qt_QFile_isSequential_bool_QFile, Return,
                                          "bool", Parameters, new Param(c, "this", "qt.QFile"), End),
            _func[8] = new MemberFunction(c, "pos", _n_pos0, None, Compiled, qt_QFile_pos_int64_QFile, Return, "int64", Parameters,
                                          new Param(c, "this", "qt.QFile"), End),
            _func[9] = new MemberFunction(c, "seek", _n_seek0, None, Compiled, qt_QFile_seek_bool_QFile_int64, Return, "bool", Parameters,
                                          new Param(c, "this", "qt.QFile"), new Param(c, "pos", "int64"), End),
            ...
            // functions
            new Function(c, "copy", _n_copy1, None, Compiled, qt_QFile_copy_bool_string_string, Return, "bool", Parameters,
                         new Param(c, "fileName", "string"), new Param(c, "newName", "string"), End),
            new Function(c, "decodeName", _n_decodeName0, None, Compiled, qt_QFile_decodeName_string_QByteArray, Return, "string",
                         Parameters, new Param(c, "localFileName", "qt.QByteArray"), End),
            // MISSING: decodeName (string; "const char *" localFileName)
            new Function(c, "encodeName", _n_encodeName0, None, Compiled, qt_QFile_encodeName_QByteArray_string, Return, "qt.QByteArray",
                         Parameters, new Param(c, "fileName", "string"), End),
            new Function(c, "exists", _n_exists1, None, Compiled, qt_QFile_exists_bool_string, Return, "bool", Parameters,
                         new Param(c, "fileName", "string"), End),
            new Function(c, "link", _n_link1, None, Compiled, qt_QFile_link_bool_string_string, Return, "bool", Parameters,
                         new Param(c, "fileName", "string"), new Param(c, "linkName", "string"), End),
            new Function(c, "permissions", _n_permissions1, None, Compiled, qt_QFile_permissions_int_string, Return, "int", Parameters,
                         new Param(c, "fileName", "string"), End),
            new Function(c, "remove", _n_remove1, None, Compiled, qt_QFile_remove_bool_string, Return, "bool", Parameters,
                         new Param(c, "fileName", "string"), End),
            new Function(c, "rename", _n_rename1, None, Compiled, qt_QFile_rename_bool_string_string, Return, "bool", Parameters,
                         new Param(c, "oldName", "string"), new Param(c, "newName", "string"), End),
            new Function(c, "resize", _n_resize1, None, Compiled, qt_QFile_resize_bool_string_int64, Return, "bool", Parameters,
                         new Param(c, "fileName", "string"), new Param(c, "sz", "int64"), End),
            new Function(c, "symLinkTarget", _n_symLinkTarget1, None, Compiled, qt_QFile_symLinkTarget_string_string, Return, "string",
                         Parameters, new Param(c, "fileName", "string"), End),
            EndArguments);
