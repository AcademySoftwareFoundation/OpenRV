...
namespace Mu
{
    ...
    bool MuQt_QFileDevice::open(QIODeviceBase::OpenMode mode)
    {
        if (!_env)
    ...
    qint64 MuQt_QFileDevice::skipData(qint64 maxSize)
    {
        if (!_env)
    ...
    static Pointer QFileDevice_QFileDevice_QObject(Thread& NODE_THREAD, Pointer obj)
    {
        ...
        {
            QFileDeviceType* type = c->findSymbolOfTypeByQualifiedName<QFileDeviceType>(c->internName("qt.QFileDevice"), false);
    ...
    static NODE_IMPLEMENTATION(castFromObject, Pointer) { NODE_RETURN(QFileDevice_QFileDevice_QObject(NODE_THREAD, NODE_ARG(0, Pointer))); }
    ...
    Pointer qt_QFileDevice_fileTime_QDateTime_QFileDevice_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_time)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QFileDevice* arg0 = object<QFileDevice>(param_this);
        QFileDevice::FileTime arg1 = (QFileDevice::FileTime)(param_time);
    ...
    int qt_QFileDevice_permissions_int_QFileDevice(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QFileDevice* arg0 = object<QFileDevice>(param_this);
        return isMuQtObject(arg0) ? int(arg0->QFileDevice::permissions()) : int(arg0->permissions());
    }
    ...
    bool qt_QFileDevice_setFileTime_bool_QFileDevice_QDateTime_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_newDate,
                                                                   int param_fileTime)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QFileDevice* arg0 = object<QFileDevice>(param_this);
        const QDateTime arg1 = getqtype<QDateTimeType>(param_newDate);
        QFileDevice::FileTime arg2 = (QFileDevice::FileTime)(param_fileTime);
        return arg0->setFileTime(arg1, arg2);
    }
    ...
    int64 qt_QFileDevice_skipData_int64_QFileDevice_int64(Mu::Thread& NODE_THREAD, Pointer param_this, int64 param_maxSize)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QFileDevice* arg0 = object<QFileDevice>(param_this);
        qint64 arg1 = (int64)(param_maxSize);
        return isMuQtObject(arg0) ? ((MuQt_QFileDevice*)arg0)->skipData_pub_parent(arg1) : ((MuQt_QFileDevice*)arg0)->skipData_pub(arg1);
    }
    ...
    {
        NODE_RETURN(qt_QFileDevice_fileTime_QDateTime_QFileDevice_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_setFileTime0, bool)
    {
        NODE_RETURN(qt_QFileDevice_setFileTime_bool_QFileDevice_QDateTime_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
    ...
    {
        NODE_RETURN(qt_QFileDevice_skipData_int64_QFileDevice_int64(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int64)));
    }
    ...
    void QFileDeviceType::load()
    {
        ...
        addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None, Return, ftn, End),
                   ...
                   new Function(c, tn, castFromObject, Cast, Compiled, QFileDevice_QFileDevice_QObject, Return, ftn, Parameters,
        ...
        addSymbols(
            // enums
            new Alias(c, "FileError", "int"), new SymbolicConstant(c, "NoError", "int", Value(int(QFileDevice::NoError))),
            ...
            new SymbolicConstant(c, "CopyError", "int", Value(int(QFileDevice::CopyError))), new Alias(c, "FileHandleFlag", "int"),
            new Alias(c, "FileHandleFlags", "int"),
            new SymbolicConstant(c, "AutoCloseHandle", "int", Value(int(QFileDevice::AutoCloseHandle))),
            new SymbolicConstant(c, "DontCloseHandle", "int", Value(int(QFileDevice::DontCloseHandle))), new Alias(c, "Permission", "int"),
            new Alias(c, "Permissions", "int"), new SymbolicConstant(c, "ReadOwner", "int", Value(int(QFileDevice::ReadOwner))),
            ...
            // member functions
            new Function(c, "error", _n_error0, None, Compiled, qt_QFileDevice_error_int_QFileDevice, Return, "int", Parameters,
                         new Param(c, "this", "qt.QFileDevice"), End),
            _func[0] = new MemberFunction(c, "fileName", _n_fileName0, None, Compiled, qt_QFileDevice_fileName_string_QFileDevice, Return,
                                          "string", Parameters, new Param(c, "this", "qt.QFileDevice"), End),
            new Function(c, "fileTime", _n_fileTime0, None, Compiled, qt_QFileDevice_fileTime_QDateTime_QFileDevice_int, Return,
                         "qt.QDateTime", Parameters, new Param(c, "this", "qt.QFileDevice"), new Param(c, "time", "int"), End),
            new Function(c, "flush", _n_flush0, None, Compiled, qt_QFileDevice_flush_bool_QFileDevice, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFileDevice"), End),
            new Function(c, "handle", _n_handle0, None, Compiled, qt_QFileDevice_handle_int_QFileDevice, Return, "int", Parameters,
                         new Param(c, "this", "qt.QFileDevice"), End),
            // MISSING: map ("uchar *"; QFileDevice this, int64 offset, int64
            // size, flags QFileDevice::MemoryMapFlags flags)
            _func[1] = new MemberFunction(c, "permissions", _n_permissions0, None, Compiled, qt_QFileDevice_permissions_int_QFileDevice,
                                          Return, "int", Parameters, new Param(c, "this", "qt.QFileDevice"), End),
            _func[2] = new MemberFunction(c, "resize", _n_resize0, None, Compiled, qt_QFileDevice_resize_bool_QFileDevice_int64, Return,
                                          "bool", Parameters, new Param(c, "this", "qt.QFileDevice"), new Param(c, "sz", "int64"), End),
            new Function(c, "setFileTime", _n_setFileTime0, None, Compiled, qt_QFileDevice_setFileTime_bool_QFileDevice_QDateTime_int,
                         Return, "bool", Parameters, new Param(c, "this", "qt.QFileDevice"), new Param(c, "newDate", "qt.QDateTime"),
                         new Param(c, "fileTime", "int"), End),
            _func[3] = new MemberFunction(c, "setPermissions", _n_setPermissions0, None, Compiled,
                                          qt_QFileDevice_setPermissions_bool_QFileDevice_int, Return, "bool", Parameters,
                                          new Param(c, "this", "qt.QFileDevice"), new Param(c, "permissions", "int"), End),
            // MISSING: unmap (bool; QFileDevice this, "uchar *" address)
            new Function(c, "unsetError", _n_unsetError0, None, Compiled, qt_QFileDevice_unsetError_void_QFileDevice, Return, "void",
                         Parameters, new Param(c, "this", "qt.QFileDevice"), End),
            _func[4] = new MemberFunction(c, "atEnd", _n_atEnd0, None, Compiled, qt_QFileDevice_atEnd_bool_QFileDevice, Return, "bool",
                                          Parameters, new Param(c, "this", "qt.QFileDevice"), End),
            _func[5] = new MemberFunction(c, "close", _n_close0, None, Compiled, qt_QFileDevice_close_void_QFileDevice, Return, "void",
                                          Parameters, new Param(c, "this", "qt.QFileDevice"), End),
            _func[6] = new MemberFunction(c, "isSequential", _n_isSequential0, None, Compiled, qt_QFileDevice_isSequential_bool_QFileDevice,
                                          Return, "bool", Parameters, new Param(c, "this", "qt.QFileDevice"), End),
            _func[7] = new MemberFunction(c, "pos", _n_pos0, None, Compiled, qt_QFileDevice_pos_int64_QFileDevice, Return, "int64",
                                          Parameters, new Param(c, "this", "qt.QFileDevice"), End),
            _func[8] = new MemberFunction(c, "seek", _n_seek0, None, Compiled, qt_QFileDevice_seek_bool_QFileDevice_int64, Return, "bool",
                                          Parameters, new Param(c, "this", "qt.QFileDevice"), new Param(c, "pos", "int64"), End),
            _func[9] = new MemberFunction(c, "size", _n_size0, None, Compiled, qt_QFileDevice_size_int64_QFileDevice, Return, "int64",
                                          Parameters, new Param(c, "this", "qt.QFileDevice"), End),
            ...
            // protected
            _func[10] =
                new MemberFunction(c, "bytesAvailable", _n_bytesAvailable0, None, Compiled, qt_QFileDevice_bytesAvailable_int64_QFileDevice,
                                   Return, "int64", Parameters, new Param(c, "this", "qt.QFileDevice"), End),
            _func[11] =
                new MemberFunction(c, "bytesToWrite", _n_bytesToWrite0, None, Compiled, qt_QFileDevice_bytesToWrite_int64_QFileDevice,
                                   Return, "int64", Parameters, new Param(c, "this", "qt.QFileDevice"), End),
            _func[12] = new MemberFunction(c, "canReadLine", _n_canReadLine0, None, Compiled, qt_QFileDevice_canReadLine_bool_QFileDevice,
                                           Return, "bool", Parameters, new Param(c, "this", "qt.QFileDevice"), End),
            _func[13] = new MemberFunction(c, "open", _n_open0, None, Compiled, qt_QFileDevice_open_bool_QFileDevice_int, Return, "bool",
                                           Parameters, new Param(c, "this", "qt.QFileDevice"), new Param(c, "mode", "int"), End),
            _func[14] = new MemberFunction(c, "reset", _n_reset0, None, Compiled, qt_QFileDevice_reset_bool_QFileDevice, Return, "bool",
                                           Parameters, new Param(c, "this", "qt.QFileDevice"), End),
            _func[15] = new MemberFunction(c, "waitForBytesWritten", _n_waitForBytesWritten0, None, Compiled,
                                           qt_QFileDevice_waitForBytesWritten_bool_QFileDevice_int, Return, "bool", Parameters,
                                           new Param(c, "this", "qt.QFileDevice"), new Param(c, "msecs", "int"), End),
            _func[16] = new MemberFunction(c, "waitForReadyRead", _n_waitForReadyRead0, None, Compiled,
                                           qt_QFileDevice_waitForReadyRead_bool_QFileDevice_int, Return, "bool", Parameters,
                                           new Param(c, "this", "qt.QFileDevice"), new Param(c, "msecs", "int"), End),
            _func[17] =
                new MemberFunction(c, "skipData", _n_skipData0, None, Compiled, qt_QFileDevice_skipData_int64_QFileDevice_int64, Return,
                                   "int64", Parameters, new Param(c, "this", "qt.QFileDevice"), new Param(c, "maxSize", "int64"), End),
            // static functions
            EndArguments);
