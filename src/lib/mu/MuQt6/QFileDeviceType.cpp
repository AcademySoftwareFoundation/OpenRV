...
{
    if (!_env) return QFileDevice::skipData(maxSize);
    MuLangContext* c = (MuLangContext*)_env->context();
...
bool qt_QFileDevice_setFileTime_bool_QFileDevice_QDateTime_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_newDate, int param_fileTime)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QFileDevice* arg0 = object<QFileDevice>(param_this);
...
{
    NODE_RETURN(qt_QFileDevice_setFileTime_bool_QFileDevice_QDateTime_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int)));
}
...
addSymbols(
    ...
    new Function(c, "fileTime", _n_fileTime0, None, Compiled, qt_QFileDevice_fileTime_QDateTime_QFileDevice_int, Return, "qt.QDateTime", Parameters, new Param(c, "this", "qt.QFileDevice"), new Param(c, "time", "int"), End),
    ...
    new Function(c, "setFileTime", _n_setFileTime0, None, Compiled, qt_QFileDevice_setFileTime_bool_QFileDevice_QDateTime_int, Return, "bool", Parameters, new Param(c, "this", "qt.QFileDevice"), new Param(c, "newDate", "qt.QDateTime"), new Param(c, "fileTime", "int"), End),
    ...
    _func[17] = new MemberFunction(c, "skipData", _n_skipData0, None, Compiled, qt_QFileDevice_skipData_int64_QFileDevice_int64, Return, "int64", Parameters, new Param(c, "this", "qt.QFileDevice"), new Param(c, "maxSize", "int64"), End),
    // static functions
    EndArguments);
