...
namespace Mu
{
    ...
    Pointer qt_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_int(Mu::Thread& NODE_THREAD, Pointer param_this,
                                                                                       int param_type)
    {
    ...
    Pointer qt_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_string_int(Mu::Thread& NODE_THREAD, Pointer param_this,
    ...
    Pointer qt_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_QIcon_string_int(Mu::Thread& NODE_THREAD,
                                                                                                    Pointer param_this, Pointer param_icon,
                                                                                                    Pointer param_text, int param_type)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    void qt_QTableWidgetItem_setData_void_QTableWidgetItem_int_QVariant(Mu::Thread& NODE_THREAD, Pointer param_this, int param_role,
                                                                        Pointer param_value)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QTableWidgetItem* arg0 = getqpointer<QTableWidgetItemType>(param_this);
    ...
    {
        NODE_RETURN(qt_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
                                                                                               NODE_ARG(1, int)));
    }

    static NODE_IMPLEMENTATION(_n_QTableWidgetItem1, Pointer)
    {
        NODE_RETURN(qt_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_string_int(
    ...
    {
        NODE_RETURN(qt_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_QIcon_string_int(
    ...
    {
        qt_QTableWidgetItem_setData_void_QTableWidgetItem_int_QVariant(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int),
                                                                       NODE_ARG(2, Pointer));
    }
    ...
    void QTableWidgetItemType::load()
    {
        ...
        addSymbols(new Alias(c, "ItemType", "int"), new SymbolicConstant(c, "Type", "int", Value(int(QTableWidgetItem::Type))),
                   new SymbolicConstant(c, "UserType", "int", Value(int(QTableWidgetItem::UserType))), EndArguments);

        addSymbols(
            // enums
            // member functions
            new Function(c, "QTableWidgetItem", _n_QTableWidgetItem0, None, Compiled,
                         qt_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_int, Return, "qt.QTableWidgetItem",
                         Parameters, new Param(c, "this", "qt.QTableWidgetItem"),
                         new Param(c, "type", "int", Value((int)QTableWidgetItem::Type)), End),
            new Function(c, "QTableWidgetItem", _n_QTableWidgetItem1, None, Compiled,
                         qt_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_string_int, Return, "qt.QTableWidgetItem",
                         Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "text", "string"),
                         new Param(c, "type", "int", Value((int)QTableWidgetItem::Type)), End),
            new Function(c, "QTableWidgetItem", _n_QTableWidgetItem2, None, Compiled,
                         qt_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_QTableWidgetItem_QIcon_string_int, Return,
                         "qt.QTableWidgetItem", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "icon", "qt.QIcon"),
                         new Param(c, "text", "string"), new Param(c, "type", "int", Value((int)QTableWidgetItem::Type)), End),
            // MISSING: QTableWidgetItem (QTableWidgetItem; QTableWidgetItem
            // this, QTableWidgetItem other)
            new Function(c, "background", _n_background0, None, Compiled, qt_QTableWidgetItem_background_QBrush_QTableWidgetItem, Return,
                         "qt.QBrush", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "checkState", _n_checkState0, None, Compiled, qt_QTableWidgetItem_checkState_int_QTableWidgetItem, Return,
                         "int", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new MemberFunction(c, "clone", _n_clone0, None, Compiled, qt_QTableWidgetItem_clone_QTableWidgetItem_QTableWidgetItem, Return,
                               "qt.QTableWidgetItem", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "column", _n_column0, None, Compiled, qt_QTableWidgetItem_column_int_QTableWidgetItem, Return, "int",
                         Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new MemberFunction(c, "data", _n_data0, None, Compiled, qt_QTableWidgetItem_data_QVariant_QTableWidgetItem_int, Return,
                               "qt.QVariant", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "role", "int"), End),
            new Function(c, "flags", _n_flags0, None, Compiled, qt_QTableWidgetItem_flags_int_QTableWidgetItem, Return, "int", Parameters,
                         new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "font", _n_font0, None, Compiled, qt_QTableWidgetItem_font_QFont_QTableWidgetItem, Return, "qt.QFont",
                         Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "foreground", _n_foreground0, None, Compiled, qt_QTableWidgetItem_foreground_QBrush_QTableWidgetItem, Return,
                         "qt.QBrush", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "icon", _n_icon0, None, Compiled, qt_QTableWidgetItem_icon_QIcon_QTableWidgetItem, Return, "qt.QIcon",
                         Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "isSelected", _n_isSelected0, None, Compiled, qt_QTableWidgetItem_isSelected_bool_QTableWidgetItem, Return,
                         "bool", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            // MISSING: read (void; QTableWidgetItem this, "QDataStream &" in)
            new Function(c, "row", _n_row0, None, Compiled, qt_QTableWidgetItem_row_int_QTableWidgetItem, Return, "int", Parameters,
                         new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "setBackground", _n_setBackground0, None, Compiled,
                         qt_QTableWidgetItem_setBackground_void_QTableWidgetItem_QBrush, Return, "void", Parameters,
                         new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "brush", "qt.QBrush"), End),
            new Function(c, "setCheckState", _n_setCheckState0, None, Compiled, qt_QTableWidgetItem_setCheckState_void_QTableWidgetItem_int,
                         Return, "void", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "state", "int"), End),
            new MemberFunction(c, "setData", _n_setData0, None, Compiled, qt_QTableWidgetItem_setData_void_QTableWidgetItem_int_QVariant,
                               Return, "void", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "role", "int"),
                               new Param(c, "value", "qt.QVariant"), End),
            new Function(c, "setFlags", _n_setFlags0, None, Compiled, qt_QTableWidgetItem_setFlags_void_QTableWidgetItem_int, Return,
                         "void", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "flags", "int"), End),
            new Function(c, "setFont", _n_setFont0, None, Compiled, qt_QTableWidgetItem_setFont_void_QTableWidgetItem_QFont, Return, "void",
                         Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "font", "qt.QFont"), End),
            new Function(c, "setForeground", _n_setForeground0, None, Compiled,
                         qt_QTableWidgetItem_setForeground_void_QTableWidgetItem_QBrush, Return, "void", Parameters,
                         new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "brush", "qt.QBrush"), End),
            new Function(c, "setIcon", _n_setIcon0, None, Compiled, qt_QTableWidgetItem_setIcon_void_QTableWidgetItem_QIcon, Return, "void",
                         Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "icon", "qt.QIcon"), End),
            new Function(c, "setSelected", _n_setSelected0, None, Compiled, qt_QTableWidgetItem_setSelected_void_QTableWidgetItem_bool,
                         Return, "void", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "select", "bool"), End),
            new Function(c, "setSizeHint", _n_setSizeHint0, None, Compiled, qt_QTableWidgetItem_setSizeHint_void_QTableWidgetItem_QSize,
                         Return, "void", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "size", "qt.QSize"), End),
            new Function(c, "setStatusTip", _n_setStatusTip0, None, Compiled, qt_QTableWidgetItem_setStatusTip_void_QTableWidgetItem_string,
                         Return, "void", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "statusTip", "string"), End),
            new Function(c, "setText", _n_setText0, None, Compiled, qt_QTableWidgetItem_setText_void_QTableWidgetItem_string, Return,
                         "void", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "text", "string"), End),
            new Function(c, "setTextAlignment", _n_setTextAlignment0, None, Compiled,
                         qt_QTableWidgetItem_setTextAlignment_void_QTableWidgetItem_int, Return, "void", Parameters,
                         new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "alignment", "int"), End),
            new Function(c, "setToolTip", _n_setToolTip0, None, Compiled, qt_QTableWidgetItem_setToolTip_void_QTableWidgetItem_string,
                         Return, "void", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "toolTip", "string"), End),
            new Function(c, "setWhatsThis", _n_setWhatsThis0, None, Compiled, qt_QTableWidgetItem_setWhatsThis_void_QTableWidgetItem_string,
                         Return, "void", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), new Param(c, "whatsThis", "string"), End),
            new Function(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QTableWidgetItem_sizeHint_QSize_QTableWidgetItem, Return,
                         "qt.QSize", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "statusTip", _n_statusTip0, None, Compiled, qt_QTableWidgetItem_statusTip_string_QTableWidgetItem, Return,
                         "string", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "tableWidget", _n_tableWidget0, None, Compiled, qt_QTableWidgetItem_tableWidget_QTableWidget_QTableWidgetItem,
                         Return, "qt.QTableWidget", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "text", _n_text0, None, Compiled, qt_QTableWidgetItem_text_string_QTableWidgetItem, Return, "string",
                         Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "textAlignment", _n_textAlignment0, None, Compiled, qt_QTableWidgetItem_textAlignment_int_QTableWidgetItem,
                         Return, "int", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "toolTip", _n_toolTip0, None, Compiled, qt_QTableWidgetItem_toolTip_string_QTableWidgetItem, Return, "string",
                         Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "type", _n_type0, None, Compiled, qt_QTableWidgetItem_type_int_QTableWidgetItem, Return, "int", Parameters,
                         new Param(c, "this", "qt.QTableWidgetItem"), End),
            new Function(c, "whatsThis", _n_whatsThis0, None, Compiled, qt_QTableWidgetItem_whatsThis_string_QTableWidgetItem, Return,
                         "string", Parameters, new Param(c, "this", "qt.QTableWidgetItem"), End),
