...
namespace Mu
{
                                                                    ...
                                                                    Pointer param_oldGeometry)
    {
        ...
        if (isMuQtObject(arg0))
            ((MuQt_QQuickItem*)arg0)->geometryChange_pub_parent(arg1, arg2);
        else
    ...
    void QQuickItemType::load()
    {
        ...
        addSymbols(
            ...
            // QQuickItem::TransformOrigin _p27) PROP: setVisible (void;
            // QQuickItem this, bool _p4) PROP: setWidth (void; QQuickItem this,
            // double _p5) PROP: setX (void; QQuickItem this, double _p5) PROP:
