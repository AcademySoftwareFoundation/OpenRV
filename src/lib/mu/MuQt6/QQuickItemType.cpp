...
{
    if (!_env) return QQuickItem::boundingRect();
    MuLangContext* c = (MuLangContext*)_env->context();
    ...
    if (F != F0) 
    {
        ...
        return getqtype<QRectFType>(rval._Pointer);
    }
    else
    {
...
QRectF MuQt_QQuickItem::clipRect() const
{
    if (!_env) return QQuickItem::clipRect();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QQuickItem::contains(point);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QQuickItem::inputMethodQuery(query);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QQuickItem::isTextureProvider();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QQuickItem::childMouseEventFilter(item, event);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::dragEnterEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::dragLeaveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::dragMoveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::dropEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
void MuQt_QQuickItem::focusInEvent(QFocusEvent * _p14) 
{
    if (!_env) { QQuickItem::focusInEvent(_p14); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
    ...
    {
        QQuickItem::focusInEvent(_p14);
    }
}

void MuQt_QQuickItem::focusOutEvent(QFocusEvent * _p14) 
{
    if (!_env) { QQuickItem::focusOutEvent(_p14); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
    ...
    {
        QQuickItem::focusOutEvent(_p14);
    }
}

void MuQt_QQuickItem::geometryChange(const QRectF & newGeometry, const QRectF & oldGeometry) 
{
    if (!_env) { QQuickItem::geometryChange(newGeometry, oldGeometry); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::hoverEnterEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::hoverLeaveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::hoverMoveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::keyPressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::keyReleaseEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::mouseDoubleClickEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::mouseMoveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::mousePressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::mouseReleaseEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::mouseUngrabEvent(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::releaseResources(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::touchUngrabEvent(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::updatePolish(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::wheelEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::classBegin(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::componentComplete(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QQuickItem::event(ev);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QQuickItem::eventFilter(watched, event);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::customEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::timerEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QQuickItem_QQuickItem_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    {
        QQuickItemType* type = 
            c->findSymbolOfTypeByQualifiedName<QQuickItemType>(c->internName("qt.QQuickItem"), false);
...
{
    NODE_RETURN( QQuickItem_QQuickItem_QObject(NODE_THREAD, NODE_ARG(0, Pointer)) );
}
...
Pointer qt_QQuickItem_boundingRect_QRectF_QQuickItem(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QRectFType>(c,arg0->QQuickItem::boundingRect(),"qt.QRectF") : makeqtype<QRectFType>(c,arg0->boundingRect(),"qt.QRectF");
}

Pointer qt_QQuickItem_childAt_QQuickItem_QQuickItem_double_double(Mu::Thread& NODE_THREAD, Pointer param_this, double param_x, double param_y)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
...
Pointer qt_QQuickItem_clipRect_QRectF_QQuickItem(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QRectFType>(c,arg0->QQuickItem::clipRect(),"qt.QRectF") : makeqtype<QRectFType>(c,arg0->clipRect(),"qt.QRectF");
}
...
Pointer qt_QQuickItem_inputMethodQuery_QVariant_QQuickItem_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_query)
{
    ...
    return isMuQtObject(arg0) ? makeqtype<QVariantType>(c,arg0->QQuickItem::inputMethodQuery(arg1),"qt.QVariant") : makeqtype<QVariantType>(c,arg0->inputMethodQuery(arg1),"qt.QVariant");
}
...
bool qt_QQuickItem_isAncestorOf_bool_QQuickItem_QQuickItem(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_child)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    const QQuickItem * arg1 = object<QQuickItem>(param_child);
...
Pointer qt_QQuickItem_mapFromItem_QPointF_QQuickItem_QQuickItem_QPointF(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_item, Pointer param_point)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
...
Pointer qt_QQuickItem_mapRectFromItem_QRectF_QQuickItem_QQuickItem_QRectF(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_item, Pointer param_rect)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    const QQuickItem * arg1 = object<QQuickItem>(param_item);
...
Pointer qt_QQuickItem_mapRectToItem_QRectF_QQuickItem_QQuickItem_QRectF(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_item, Pointer param_rect)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    const QQuickItem * arg1 = object<QQuickItem>(param_item);
...
Pointer qt_QQuickItem_mapToItem_QPointF_QQuickItem_QQuickItem_QPointF(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_item, Pointer param_point)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    const QQuickItem * arg1 = object<QQuickItem>(param_item);
...
bool qt_QQuickItem_childMouseEventFilter_bool_QQuickItem_QQuickItem_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_item, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    QQuickItem * arg1 = object<QQuickItem>(param_item);
    QEvent * arg2 = getqpointer<QEventType>(param_event);
    return isMuQtObject(arg0) ? ((MuQt_QQuickItem*)arg0)->childMouseEventFilter_pub_parent(arg1, arg2) : ((MuQt_QQuickItem*)arg0)->childMouseEventFilter_pub(arg1, arg2);
}
...
void qt_QQuickItem_dragEnterEvent_void_QQuickItem_QDragEnterEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->dragEnterEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->dragEnterEvent_pub(arg1);
}
...
void qt_QQuickItem_dragLeaveEvent_void_QQuickItem_QDragLeaveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->dragLeaveEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->dragLeaveEvent_pub(arg1);
}
...
void qt_QQuickItem_dragMoveEvent_void_QQuickItem_QDragMoveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->dragMoveEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->dragMoveEvent_pub(arg1);
}
...
void qt_QQuickItem_dropEvent_void_QQuickItem_QDropEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->dropEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->dropEvent_pub(arg1);
}
...
void qt_QQuickItem_focusInEvent_void_QQuickItem_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param__p14)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->focusInEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->focusInEvent_pub(arg1);
}
...
void qt_QQuickItem_focusOutEvent_void_QQuickItem_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param__p14)
{
    ...
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    QFocusEvent * arg1 = getqpointer<QFocusEventType>(param__p14);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->focusOutEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->focusOutEvent_pub(arg1);
}

void qt_QQuickItem_geometryChange_void_QQuickItem_QRectF_QRectF(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_newGeometry, Pointer param_oldGeometry)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    const QRectF  arg1 = getqtype<QRectFType>(param_newGeometry);
    const QRectF  arg2 = getqtype<QRectFType>(param_oldGeometry);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->geometryChange_pub_parent(arg1, arg2);
    else ((MuQt_QQuickItem*)arg0)->geometryChange_pub(arg1, arg2);
}
...
void qt_QQuickItem_hoverEnterEvent_void_QQuickItem_QHoverEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->hoverEnterEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->hoverEnterEvent_pub(arg1);
}
...
void qt_QQuickItem_hoverLeaveEvent_void_QQuickItem_QHoverEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    QHoverEvent * arg1 = getqpointer<QHoverEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->hoverLeaveEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->hoverLeaveEvent_pub(arg1);
}
...
void qt_QQuickItem_hoverMoveEvent_void_QQuickItem_QHoverEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    QHoverEvent * arg1 = getqpointer<QHoverEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->hoverMoveEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->hoverMoveEvent_pub(arg1);
}
...
void qt_QQuickItem_keyPressEvent_void_QQuickItem_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    else ((MuQt_QQuickItem*)arg0)->keyPressEvent_pub(arg1);
}
...
void qt_QQuickItem_keyReleaseEvent_void_QQuickItem_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    QKeyEvent * arg1 = getqpointer<QKeyEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->keyReleaseEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->keyReleaseEvent_pub(arg1);
}
...
void qt_QQuickItem_mouseDoubleClickEvent_void_QQuickItem_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->mouseDoubleClickEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->mouseDoubleClickEvent_pub(arg1);
}
...
void qt_QQuickItem_mouseMoveEvent_void_QQuickItem_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->mouseMoveEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->mouseMoveEvent_pub(arg1);
}
...
void qt_QQuickItem_mousePressEvent_void_QQuickItem_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->mousePressEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->mousePressEvent_pub(arg1);
}
...
void qt_QQuickItem_mouseReleaseEvent_void_QQuickItem_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->mouseReleaseEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->mouseReleaseEvent_pub(arg1);
}
...
void qt_QQuickItem_mouseUngrabEvent_void_QQuickItem(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->mouseUngrabEvent_pub_parent();
    else ((MuQt_QQuickItem*)arg0)->mouseUngrabEvent_pub();
}
...
void qt_QQuickItem_releaseResources_void_QQuickItem(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->releaseResources_pub_parent();
    else ((MuQt_QQuickItem*)arg0)->releaseResources_pub();
}
...
void qt_QQuickItem_touchUngrabEvent_void_QQuickItem(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->touchUngrabEvent_pub_parent();
    else ((MuQt_QQuickItem*)arg0)->touchUngrabEvent_pub();
}
...
void qt_QQuickItem_updatePolish_void_QQuickItem(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->updatePolish_pub_parent();
    else ((MuQt_QQuickItem*)arg0)->updatePolish_pub();
}
...
void qt_QQuickItem_wheelEvent_void_QQuickItem_QWheelEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->wheelEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->wheelEvent_pub(arg1);
}
...
void qt_QQuickItem_classBegin_void_QQuickItem(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->classBegin_pub_parent();
    else ((MuQt_QQuickItem*)arg0)->classBegin_pub();
}
...
void qt_QQuickItem_componentComplete_void_QQuickItem(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->componentComplete_pub_parent();
    else ((MuQt_QQuickItem*)arg0)->componentComplete_pub();
}
...
bool qt_QQuickItem_eventFilter_bool_QQuickItem_QObject_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_watched, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
...
void qt_QQuickItem_customEvent_void_QQuickItem_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->customEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->customEvent_pub(arg1);
}
...
void qt_QQuickItem_timerEvent_void_QQuickItem_QTimerEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->timerEvent_pub_parent(arg1);
    else ((MuQt_QQuickItem*)arg0)->timerEvent_pub(arg1);
}


static NODE_IMPLEMENTATION(_n_QQuickItem0, Pointer)
{
    NODE_RETURN(qt_QQuickItem_QQuickItem_QQuickItem_QQuickItem_QQuickItem(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
{
    NODE_RETURN(qt_QQuickItem_childAt_QQuickItem_QQuickItem_double_double(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, double), NODE_ARG(2, double)));
}
...
{
    NODE_RETURN(qt_QQuickItem_mapFromItem_QPointF_QQuickItem_QQuickItem_QPointF(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
{
    NODE_RETURN(qt_QQuickItem_mapRectFromItem_QRectF_QQuickItem_QQuickItem_QRectF(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}

static NODE_IMPLEMENTATION(_n_mapRectFromScene0, Pointer)
{
    NODE_RETURN(qt_QQuickItem_mapRectFromScene_QRectF_QQuickItem_QRectF(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}

static NODE_IMPLEMENTATION(_n_mapRectToItem0, Pointer)
{
    NODE_RETURN(qt_QQuickItem_mapRectToItem_QRectF_QQuickItem_QQuickItem_QRectF(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
{
    NODE_RETURN(qt_QQuickItem_mapToItem_QPointF_QQuickItem_QQuickItem_QPointF(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
{
    NODE_RETURN(qt_QQuickItem_nextItemInFocusChain_QQuickItem_QQuickItem_bool(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, bool)));
}

static NODE_IMPLEMENTATION(_n_polish0, void)
{
    qt_QQuickItem_polish_void_QQuickItem(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    NODE_RETURN(qt_QQuickItem_childMouseEventFilter_bool_QQuickItem_QQuickItem_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
{
    qt_QQuickItem_geometryChange_void_QQuickItem_QRectF_QRectF(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer));
}
...
{
    qt_QQuickItem_classBegin_void_QQuickItem(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    NODE_RETURN(qt_QQuickItem_eventFilter_bool_QQuickItem_QObject_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
QQuickItemType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QQuickItem_QQuickItem_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QQuickItem", _n_QQuickItem0, None, Compiled, qt_QQuickItem_QQuickItem_QQuickItem_QQuickItem_QQuickItem, Return, "qt.QQuickItem", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "parent", "qt.QQuickItem"), End),
    new Function(c, "acceptHoverEvents", _n_acceptHoverEvents0, None, Compiled, qt_QQuickItem_acceptHoverEvents_bool_QQuickItem, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "acceptTouchEvents", _n_acceptTouchEvents0, None, Compiled, qt_QQuickItem_acceptTouchEvents_bool_QQuickItem, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "acceptedMouseButtons", _n_acceptedMouseButtons0, None, Compiled, qt_QQuickItem_acceptedMouseButtons_int_QQuickItem, Return, "int", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    ...
    // MISSING: bindableHeight ("QBindable<qreal>"; QQuickItem this)
    ...
    _func[0] = new MemberFunction(c, "boundingRect", _n_boundingRect0, None, Compiled, qt_QQuickItem_boundingRect_QRectF_QQuickItem, Return, "qt.QRectF", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "childAt", _n_childAt0, None, Compiled, qt_QQuickItem_childAt_QQuickItem_QQuickItem_double_double, Return, "qt.QQuickItem", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "x", "double"), new Param(c, "y", "double"), End),
    ...
    _func[1] = new MemberFunction(c, "clipRect", _n_clipRect0, None, Compiled, qt_QQuickItem_clipRect_QRectF_QQuickItem, Return, "qt.QRectF", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    // PROP: containmentMask (QObject; QQuickItem this)
    _func[2] = new MemberFunction(c, "contains", _n_contains0, None, Compiled, qt_QQuickItem_contains_bool_QQuickItem_QPointF, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "point", "qt.QPointF"), End),
    new Function(c, "cursor", _n_cursor0, None, Compiled, qt_QQuickItem_cursor_QCursor_QQuickItem, Return, "qt.QCursor", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "dumpItemTree", _n_dumpItemTree0, None, Compiled, qt_QQuickItem_dumpItemTree_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "ensurePolished", _n_ensurePolished0, None, Compiled, qt_QQuickItem_ensurePolished_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "filtersChildMouseEvents", _n_filtersChildMouseEvents0, None, Compiled, qt_QQuickItem_filtersChildMouseEvents_bool_QQuickItem, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "flags", _n_flags0, None, Compiled, qt_QQuickItem_flags_int_QQuickItem, Return, "int", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "forceActiveFocus", _n_forceActiveFocus0, None, Compiled, qt_QQuickItem_forceActiveFocus_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "forceActiveFocus", _n_forceActiveFocus1, None, Compiled, qt_QQuickItem_forceActiveFocus_void_QQuickItem_int, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "reason", "int"), End),
    // MISSING: grabToImage ("QSharedPointer<QQuickItemGrabResult>"; QQuickItem this, QSize targetSize)
    // PROP: hasActiveFocus (bool; QQuickItem this)
    // PROP: hasFocus (bool; QQuickItem this)
    // PROP: height (double; QQuickItem this)
    // PROP: implicitHeight (double; QQuickItem this)
    new Function(c, "implicitWidth", _n_implicitWidth0, None, Compiled, qt_QQuickItem_implicitWidth_double_QQuickItem, Return, "double", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[3] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QQuickItem_inputMethodQuery_QVariant_QQuickItem_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "query", "int"), End),
    new Function(c, "isAncestorOf", _n_isAncestorOf0, None, Compiled, qt_QQuickItem_isAncestorOf_bool_QQuickItem_QQuickItem, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "child", "qt.QQuickItem"), End),
    // PROP: isEnabled (bool; QQuickItem this)
    new Function(c, "isFocusScope", _n_isFocusScope0, None, Compiled, qt_QQuickItem_isFocusScope_bool_QQuickItem, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[4] = new MemberFunction(c, "isTextureProvider", _n_isTextureProvider0, None, Compiled, qt_QQuickItem_isTextureProvider_bool_QQuickItem, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    // PROP: isVisible (bool; QQuickItem this)
    new Function(c, "keepMouseGrab", _n_keepMouseGrab0, None, Compiled, qt_QQuickItem_keepMouseGrab_bool_QQuickItem, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "keepTouchGrab", _n_keepTouchGrab0, None, Compiled, qt_QQuickItem_keepTouchGrab_bool_QQuickItem, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "mapFromGlobal", _n_mapFromGlobal0, None, Compiled, qt_QQuickItem_mapFromGlobal_QPointF_QQuickItem_QPointF, Return, "qt.QPointF", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "point", "qt.QPointF"), End),
    new Function(c, "mapFromItem", _n_mapFromItem0, None, Compiled, qt_QQuickItem_mapFromItem_QPointF_QQuickItem_QQuickItem_QPointF, Return, "qt.QPointF", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "item", "qt.QQuickItem"), new Param(c, "point", "qt.QPointF"), End),
    new Function(c, "mapFromScene", _n_mapFromScene0, None, Compiled, qt_QQuickItem_mapFromScene_QPointF_QQuickItem_QPointF, Return, "qt.QPointF", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "point", "qt.QPointF"), End),
    new Function(c, "mapRectFromItem", _n_mapRectFromItem0, None, Compiled, qt_QQuickItem_mapRectFromItem_QRectF_QQuickItem_QQuickItem_QRectF, Return, "qt.QRectF", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "item", "qt.QQuickItem"), new Param(c, "rect", "qt.QRectF"), End),
    new Function(c, "mapRectFromScene", _n_mapRectFromScene0, None, Compiled, qt_QQuickItem_mapRectFromScene_QRectF_QQuickItem_QRectF, Return, "qt.QRectF", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "rect", "qt.QRectF"), End),
    new Function(c, "mapRectToItem", _n_mapRectToItem0, None, Compiled, qt_QQuickItem_mapRectToItem_QRectF_QQuickItem_QQuickItem_QRectF, Return, "qt.QRectF", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "item", "qt.QQuickItem"), new Param(c, "rect", "qt.QRectF"), End),
    new Function(c, "mapRectToScene", _n_mapRectToScene0, None, Compiled, qt_QQuickItem_mapRectToScene_QRectF_QQuickItem_QRectF, Return, "qt.QRectF", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "rect", "qt.QRectF"), End),
    new Function(c, "mapToGlobal", _n_mapToGlobal0, None, Compiled, qt_QQuickItem_mapToGlobal_QPointF_QQuickItem_QPointF, Return, "qt.QPointF", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "point", "qt.QPointF"), End),
    new Function(c, "mapToItem", _n_mapToItem0, None, Compiled, qt_QQuickItem_mapToItem_QPointF_QQuickItem_QQuickItem_QPointF, Return, "qt.QPointF", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "item", "qt.QQuickItem"), new Param(c, "point", "qt.QPointF"), End),
    new Function(c, "mapToScene", _n_mapToScene0, None, Compiled, qt_QQuickItem_mapToScene_QPointF_QQuickItem_QPointF, Return, "qt.QPointF", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "point", "qt.QPointF"), End),
    new Function(c, "nextItemInFocusChain", _n_nextItemInFocusChain0, None, Compiled, qt_QQuickItem_nextItemInFocusChain_QQuickItem_QQuickItem_bool, Return, "qt.QQuickItem", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "forward", "bool"), End),
    // PROP: opacity (double; QQuickItem this)
    // PROP: parentItem (QQuickItem; QQuickItem this)
    new Function(c, "polish", _n_polish0, None, Compiled, qt_QQuickItem_polish_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    ...
    new Function(c, "scopedFocusItem", _n_scopedFocusItem0, None, Compiled, qt_QQuickItem_scopedFocusItem_QQuickItem_QQuickItem, Return, "qt.QQuickItem", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "setAcceptHoverEvents", _n_setAcceptHoverEvents0, None, Compiled, qt_QQuickItem_setAcceptHoverEvents_void_QQuickItem_bool, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "enabled", "bool"), End),
    new Function(c, "setAcceptTouchEvents", _n_setAcceptTouchEvents0, None, Compiled, qt_QQuickItem_setAcceptTouchEvents_void_QQuickItem_bool, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "enabled", "bool"), End),
    new Function(c, "setAcceptedMouseButtons", _n_setAcceptedMouseButtons0, None, Compiled, qt_QQuickItem_setAcceptedMouseButtons_void_QQuickItem_int, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "buttons", "int"), End),
    ...
    new Function(c, "setCursor", _n_setCursor0, None, Compiled, qt_QQuickItem_setCursor_void_QQuickItem_QCursor, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "cursor", "qt.QCursor"), End),
    // PROP: setEnabled (void; QQuickItem this, bool _p4)
    new Function(c, "setFiltersChildMouseEvents", _n_setFiltersChildMouseEvents0, None, Compiled, qt_QQuickItem_setFiltersChildMouseEvents_void_QQuickItem_bool, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "filter", "bool"), End),
    new Function(c, "setFlag", _n_setFlag0, None, Compiled, qt_QQuickItem_setFlag_void_QQuickItem_int_bool, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "flag", "int"), new Param(c, "enabled", "bool"), End),
    new Function(c, "setFlags", _n_setFlags0, None, Compiled, qt_QQuickItem_setFlags_void_QQuickItem_int, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "flags", "int"), End),
    // PROP: setFocus (void; QQuickItem this, bool _p4)
    // PROP: setFocus (void; QQuickItem this, bool focus, flags Qt::FocusReason reason)
    // PROP: setHeight (void; QQuickItem this, double _p5)
    // PROP: setImplicitHeight (void; QQuickItem this, double _p5)
    // PROP: setImplicitWidth (void; QQuickItem this, double _p5)
    new Function(c, "setKeepMouseGrab", _n_setKeepMouseGrab0, None, Compiled, qt_QQuickItem_setKeepMouseGrab_void_QQuickItem_bool, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "keep", "bool"), End),
    new Function(c, "setKeepTouchGrab", _n_setKeepTouchGrab0, None, Compiled, qt_QQuickItem_setKeepTouchGrab_void_QQuickItem_bool, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "keep", "bool"), End),
    ...
    // PROP: setScale (void; QQuickItem this, double _p5)
    // MISSING: setSize (void; QQuickItem this, "const QSizeF &" size)
    // PROP: setSmooth (void; QQuickItem this, bool _p4)
    // PROP: setState (void; QQuickItem this, string _p16)
    // PROP: setTransformOrigin (void; QQuickItem this, flags QQuickItem::TransformOrigin _p27)
    // PROP: setVisible (void; QQuickItem this, bool _p4)
    // PROP: setWidth (void; QQuickItem this, double _p5)
    // PROP: setX (void; QQuickItem this, double _p5)
    // PROP: setY (void; QQuickItem this, double _p5)
    // PROP: setZ (void; QQuickItem this, double _p5)
    // MISSING: size ("QSizeF"; QQuickItem this)
    // PROP: smooth (bool; QQuickItem this)
    new Function(c, "stackAfter", _n_stackAfter0, None, Compiled, qt_QQuickItem_stackAfter_void_QQuickItem_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "sibling", "qt.QQuickItem"), End),
    new Function(c, "stackBefore", _n_stackBefore0, None, Compiled, qt_QQuickItem_stackBefore_void_QQuickItem_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "sibling", "qt.QQuickItem"), End),
    // PROP: state (string; QQuickItem this)
    // MISSING: textureProvider ("QSGTextureProvider *"; QQuickItem this)
    // PROP: transformOrigin (flags QQuickItem::TransformOrigin; QQuickItem this)
    new Function(c, "unsetCursor", _n_unsetCursor0, None, Compiled, qt_QQuickItem_unsetCursor_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "viewportItem", _n_viewportItem0, None, Compiled, qt_QQuickItem_viewportItem_QQuickItem_QQuickItem, Return, "qt.QQuickItem", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    ...
    _func[5] = new MemberFunction(c, "childMouseEventFilter", _n_childMouseEventFilter0, None, Compiled, qt_QQuickItem_childMouseEventFilter_bool_QQuickItem_QQuickItem_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "item", "qt.QQuickItem"), new Param(c, "event", "qt.QEvent"), End),
    _func[6] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QQuickItem_dragEnterEvent_void_QQuickItem_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QDragEnterEvent"), End),
    _func[7] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QQuickItem_dragLeaveEvent_void_QQuickItem_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QDragLeaveEvent"), End),
    _func[8] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QQuickItem_dragMoveEvent_void_QQuickItem_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QDragMoveEvent"), End),
    _func[9] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QQuickItem_dropEvent_void_QQuickItem_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QDropEvent"), End),
    _func[10] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QQuickItem_focusInEvent_void_QQuickItem_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "_p14", "qt.QFocusEvent"), End),
    _func[11] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QQuickItem_focusOutEvent_void_QQuickItem_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "_p14", "qt.QFocusEvent"), End),
    _func[12] = new MemberFunction(c, "geometryChange", _n_geometryChange0, None, Compiled, qt_QQuickItem_geometryChange_void_QQuickItem_QRectF_QRectF, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "newGeometry", "qt.QRectF"), new Param(c, "oldGeometry", "qt.QRectF"), End),
    new Function(c, "heightValid", _n_heightValid0, None, Compiled, qt_QQuickItem_heightValid_bool_QQuickItem, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[13] = new MemberFunction(c, "hoverEnterEvent", _n_hoverEnterEvent0, None, Compiled, qt_QQuickItem_hoverEnterEvent_void_QQuickItem_QHoverEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QHoverEvent"), End),
    _func[14] = new MemberFunction(c, "hoverLeaveEvent", _n_hoverLeaveEvent0, None, Compiled, qt_QQuickItem_hoverLeaveEvent_void_QQuickItem_QHoverEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QHoverEvent"), End),
    _func[15] = new MemberFunction(c, "hoverMoveEvent", _n_hoverMoveEvent0, None, Compiled, qt_QQuickItem_hoverMoveEvent_void_QQuickItem_QHoverEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QHoverEvent"), End),
    // MISSING: inputMethodEvent (void; QQuickItem this, "QInputMethodEvent *" event) // protected
    new Function(c, "isComponentComplete", _n_isComponentComplete0, None, Compiled, qt_QQuickItem_isComponentComplete_bool_QQuickItem, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[16] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QQuickItem_keyPressEvent_void_QQuickItem_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[17] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QQuickItem_keyReleaseEvent_void_QQuickItem_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[18] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QQuickItem_mouseDoubleClickEvent_void_QQuickItem_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[19] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QQuickItem_mouseMoveEvent_void_QQuickItem_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[20] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QQuickItem_mousePressEvent_void_QQuickItem_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[21] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QQuickItem_mouseReleaseEvent_void_QQuickItem_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[22] = new MemberFunction(c, "mouseUngrabEvent", _n_mouseUngrabEvent0, None, Compiled, qt_QQuickItem_mouseUngrabEvent_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[23] = new MemberFunction(c, "releaseResources", _n_releaseResources0, None, Compiled, qt_QQuickItem_releaseResources_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    // MISSING: touchEvent (void; QQuickItem this, "QTouchEvent *" event) // protected
    _func[24] = new MemberFunction(c, "touchUngrabEvent", _n_touchUngrabEvent0, None, Compiled, qt_QQuickItem_touchUngrabEvent_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "updateInputMethod", _n_updateInputMethod0, None, Compiled, qt_QQuickItem_updateInputMethod_void_QQuickItem_int, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "queries", "int", Value((int)Qt::ImQueryInput)), End),
    // MISSING: updatePaintNode ("QSGNode *"; QQuickItem this, "QSGNode *" oldNode, flags QQuickItem::UpdatePaintNodeData * updatePaintNodeData) // protected
    _func[25] = new MemberFunction(c, "updatePolish", _n_updatePolish0, None, Compiled, qt_QQuickItem_updatePolish_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[26] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QQuickItem_wheelEvent_void_QQuickItem_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QWheelEvent"), End),
    new Function(c, "widthValid", _n_widthValid0, None, Compiled, qt_QQuickItem_widthValid_bool_QQuickItem, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[27] = new MemberFunction(c, "classBegin", _n_classBegin0, None, Compiled, qt_QQuickItem_classBegin_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[28] = new MemberFunction(c, "componentComplete", _n_componentComplete0, None, Compiled, qt_QQuickItem_componentComplete_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[29] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QQuickItem_event_bool_QQuickItem_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "ev", "qt.QEvent"), End),
    _func[30] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled, qt_QQuickItem_eventFilter_bool_QQuickItem_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "watched", "qt.QObject"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: metaObject ("const QMetaObject *"; QQuickItem this)
    // MISSING: childEvent (void; QQuickItem this, "QChildEvent *" event) // protected
    // MISSING: connectNotify (void; QQuickItem this, "const QMetaMethod &" signal) // protected
    _func[31] = new MemberFunction(c, "customEvent", _n_customEvent0, None, Compiled, qt_QQuickItem_customEvent_void_QQuickItem_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: disconnectNotify (void; QQuickItem this, "const QMetaMethod &" signal) // protected
    _func[32] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QQuickItem_timerEvent_void_QQuickItem_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QTimerEvent"), End),
    // static functions
    EndArguments);
