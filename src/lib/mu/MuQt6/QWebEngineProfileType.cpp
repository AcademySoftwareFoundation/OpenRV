...
{
    if (!_env) return QWebEngineProfile::event(e);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QWebEngineProfile::eventFilter(watched, event);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineProfile::customEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QWebEngineProfile::timerEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QWebEngineProfile_QWebEngineProfile_QObject(Thread& NODE_THREAD, Pointer obj)
{
...
Pointer qt_QWebEngineProfile_QWebEngineProfile_QWebEngineProfile_QWebEngineProfile_QObject(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_parent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QWebEngineProfile_QWebEngineProfile_QWebEngineProfile_QWebEngineProfile_string_QObject(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_storageName, Pointer param_parent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
void qt_QWebEngineProfile_clearVisitedLinks_void_QWebEngineProfile_qt__QUrlBSB_ESB_(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_urls)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
...
void qt_QWebEngineProfile_removeUrlScheme_void_QWebEngineProfile_QByteArray(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_scheme)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
...
void qt_QWebEngineProfile_setHttpAcceptLanguage_void_QWebEngineProfile_string(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_httpAcceptLanguage)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
...
void qt_QWebEngineProfile_setHttpCacheMaximumSize_void_QWebEngineProfile_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_maxSize)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
...
void qt_QWebEngineProfile_setHttpCacheType_void_QWebEngineProfile_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_httpCacheType)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
...
void qt_QWebEngineProfile_setHttpUserAgent_void_QWebEngineProfile_string(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_userAgent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
...
void qt_QWebEngineProfile_setPersistentCookiesPolicy_void_QWebEngineProfile_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_newPersistentCookiesPolicy)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
...
void qt_QWebEngineProfile_setPersistentStoragePath_void_QWebEngineProfile_string(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_path)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
    const QString  arg1 = qstring(param_path);
...
void qt_QWebEngineProfile_setPushServiceEnabled_void_QWebEngineProfile_bool(Mu::Thread& NODE_THREAD, Pointer param_this, bool param_enable)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
...
void qt_QWebEngineProfile_setSpellCheckEnabled_void_QWebEngineProfile_bool(Mu::Thread& NODE_THREAD, Pointer param_this, bool param_enable)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
    bool arg1 = (bool)(param_enable);
...
void qt_QWebEngineProfile_setSpellCheckLanguages_void_QWebEngineProfile_stringBSB_ESB_(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_languages)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
...
bool qt_QWebEngineProfile_visitedLinksContainsUrl_bool_QWebEngineProfile_QUrl(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_url)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
...
bool qt_QWebEngineProfile_eventFilter_bool_QWebEngineProfile_QObject_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_watched, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
...
void qt_QWebEngineProfile_customEvent_void_QWebEngineProfile_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineProfile*)arg0)->customEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineProfile*)arg0)->customEvent_pub(arg1);
}

void qt_QWebEngineProfile_timerEvent_void_QWebEngineProfile_QTimerEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QWebEngineProfile* arg0 = object<QWebEngineProfile>(param_this);
    QTimerEvent * arg1 = getqpointer<QTimerEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QWebEngineProfile*)arg0)->timerEvent_pub_parent(arg1);
    else ((MuQt_QWebEngineProfile*)arg0)->timerEvent_pub(arg1);
}
...
{
    NODE_RETURN(qt_QWebEngineProfile_QWebEngineProfile_QWebEngineProfile_QWebEngineProfile_QObject(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}

static NODE_IMPLEMENTATION(_n_QWebEngineProfile1, Pointer)
{
    NODE_RETURN(qt_QWebEngineProfile_QWebEngineProfile_QWebEngineProfile_QWebEngineProfile_string_QObject(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
{
    qt_QWebEngineProfile_clearVisitedLinks_void_QWebEngineProfile_qt__QUrlBSB_ESB_(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
{
    qt_QWebEngineProfile_setHttpAcceptLanguage_void_QWebEngineProfile_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
{
    qt_QWebEngineProfile_setPersistentCookiesPolicy_void_QWebEngineProfile_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int));
}

static NODE_IMPLEMENTATION(_n_setPersistentStoragePath0, void)
{
    qt_QWebEngineProfile_setPersistentStoragePath_void_QWebEngineProfile_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
{
    qt_QWebEngineProfile_setSpellCheckLanguages_void_QWebEngineProfile_stringBSB_ESB_(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
{
    NODE_RETURN(qt_QWebEngineProfile_visitedLinksContainsUrl_bool_QWebEngineProfile_QUrl(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}

static NODE_IMPLEMENTATION(_n_event0, bool)
{
    NODE_RETURN(qt_QWebEngineProfile_event_bool_QWebEngineProfile_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}

static NODE_IMPLEMENTATION(_n_eventFilter0, bool)
{
    NODE_RETURN(qt_QWebEngineProfile_eventFilter_bool_QWebEngineProfile_QObject_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
QWebEngineProfileType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QWebEngineProfile_QWebEngineProfile_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QWebEngineProfile", _n_QWebEngineProfile0, None, Compiled, qt_QWebEngineProfile_QWebEngineProfile_QWebEngineProfile_QWebEngineProfile_QObject, Return, "qt.QWebEngineProfile", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "parent", "qt.QObject"), End),
    new Function(c, "QWebEngineProfile", _n_QWebEngineProfile1, None, Compiled, qt_QWebEngineProfile_QWebEngineProfile_QWebEngineProfile_QWebEngineProfile_string_QObject, Return, "qt.QWebEngineProfile", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "storageName", "string"), new Param(c, "parent", "qt.QObject"), End),
    new Function(c, "cachePath", _n_cachePath0, None, Compiled, qt_QWebEngineProfile_cachePath_string_QWebEngineProfile, Return, "string", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "clearAllVisitedLinks", _n_clearAllVisitedLinks0, None, Compiled, qt_QWebEngineProfile_clearAllVisitedLinks_void_QWebEngineProfile, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "clearHttpCache", _n_clearHttpCache0, None, Compiled, qt_QWebEngineProfile_clearHttpCache_void_QWebEngineProfile, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "clearVisitedLinks", _n_clearVisitedLinks0, None, Compiled, qt_QWebEngineProfile_clearVisitedLinks_void_QWebEngineProfile_qt__QUrlBSB_ESB_, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "urls", "qt.QUrl[]"), End),
    // MISSING: clientCertificateStore ("QWebEngineClientCertificateStore *"; QWebEngineProfile this)
    new Function(c, "cookieStore", _n_cookieStore0, None, Compiled, qt_QWebEngineProfile_cookieStore_QWebEngineCookieStore_QWebEngineProfile, Return, "qt.QWebEngineCookieStore", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "downloadPath", _n_downloadPath0, None, Compiled, qt_QWebEngineProfile_downloadPath_string_QWebEngineProfile, Return, "string", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "httpAcceptLanguage", _n_httpAcceptLanguage0, None, Compiled, qt_QWebEngineProfile_httpAcceptLanguage_string_QWebEngineProfile, Return, "string", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "httpCacheMaximumSize", _n_httpCacheMaximumSize0, None, Compiled, qt_QWebEngineProfile_httpCacheMaximumSize_int_QWebEngineProfile, Return, "int", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "httpCacheType", _n_httpCacheType0, None, Compiled, qt_QWebEngineProfile_httpCacheType_int_QWebEngineProfile, Return, "int", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "httpUserAgent", _n_httpUserAgent0, None, Compiled, qt_QWebEngineProfile_httpUserAgent_string_QWebEngineProfile, Return, "string", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    // MISSING: installUrlSchemeHandler (void; QWebEngineProfile this, QByteArray scheme, "QWebEngineUrlSchemeHandler *" handler)
    new Function(c, "isOffTheRecord", _n_isOffTheRecord0, None, Compiled, qt_QWebEngineProfile_isOffTheRecord_bool_QWebEngineProfile, Return, "bool", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "isPushServiceEnabled", _n_isPushServiceEnabled0, None, Compiled, qt_QWebEngineProfile_isPushServiceEnabled_bool_QWebEngineProfile, Return, "bool", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "isSpellCheckEnabled", _n_isSpellCheckEnabled0, None, Compiled, qt_QWebEngineProfile_isSpellCheckEnabled_bool_QWebEngineProfile, Return, "bool", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "persistentCookiesPolicy", _n_persistentCookiesPolicy0, None, Compiled, qt_QWebEngineProfile_persistentCookiesPolicy_int_QWebEngineProfile, Return, "int", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "persistentStoragePath", _n_persistentStoragePath0, None, Compiled, qt_QWebEngineProfile_persistentStoragePath_string_QWebEngineProfile, Return, "string", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    ...
    new Function(c, "setHttpAcceptLanguage", _n_setHttpAcceptLanguage0, None, Compiled, qt_QWebEngineProfile_setHttpAcceptLanguage_void_QWebEngineProfile_string, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "httpAcceptLanguage", "string"), End),
    new Function(c, "setHttpCacheMaximumSize", _n_setHttpCacheMaximumSize0, None, Compiled, qt_QWebEngineProfile_setHttpCacheMaximumSize_void_QWebEngineProfile_int, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "maxSize", "int"), End),
    new Function(c, "setHttpCacheType", _n_setHttpCacheType0, None, Compiled, qt_QWebEngineProfile_setHttpCacheType_void_QWebEngineProfile_int, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "httpCacheType", "int"), End),
    new Function(c, "setHttpUserAgent", _n_setHttpUserAgent0, None, Compiled, qt_QWebEngineProfile_setHttpUserAgent_void_QWebEngineProfile_string, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "userAgent", "string"), End),
    new Function(c, "setPersistentCookiesPolicy", _n_setPersistentCookiesPolicy0, None, Compiled, qt_QWebEngineProfile_setPersistentCookiesPolicy_void_QWebEngineProfile_int, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "newPersistentCookiesPolicy", "int"), End),
    new Function(c, "setPersistentStoragePath", _n_setPersistentStoragePath0, None, Compiled, qt_QWebEngineProfile_setPersistentStoragePath_void_QWebEngineProfile_string, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "path", "string"), End),
    new Function(c, "setPushServiceEnabled", _n_setPushServiceEnabled0, None, Compiled, qt_QWebEngineProfile_setPushServiceEnabled_void_QWebEngineProfile_bool, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "enable", "bool"), End),
    new Function(c, "setSpellCheckEnabled", _n_setSpellCheckEnabled0, None, Compiled, qt_QWebEngineProfile_setSpellCheckEnabled_void_QWebEngineProfile_bool, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "enable", "bool"), End),
    new Function(c, "setSpellCheckLanguages", _n_setSpellCheckLanguages0, None, Compiled, qt_QWebEngineProfile_setSpellCheckLanguages_void_QWebEngineProfile_stringBSB_ESB_, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "languages", "string[]"), End),
    // MISSING: setUrlRequestInterceptor (void; QWebEngineProfile this, "QWebEngineUrlRequestInterceptor *" interceptor)
    new Function(c, "settings", _n_settings0, None, Compiled, qt_QWebEngineProfile_settings_QWebEngineSettings_QWebEngineProfile, Return, "qt.QWebEngineSettings", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "spellCheckLanguages", _n_spellCheckLanguages0, None, Compiled, qt_QWebEngineProfile_spellCheckLanguages_stringBSB_ESB__QWebEngineProfile, Return, "string[]", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    new Function(c, "storageName", _n_storageName0, None, Compiled, qt_QWebEngineProfile_storageName_string_QWebEngineProfile, Return, "string", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), End),
    // MISSING: urlSchemeHandler ("const QWebEngineUrlSchemeHandler *"; QWebEngineProfile this, QByteArray scheme)
    new Function(c, "visitedLinksContainsUrl", _n_visitedLinksContainsUrl0, None, Compiled, qt_QWebEngineProfile_visitedLinksContainsUrl_bool_QWebEngineProfile_QUrl, Return, "bool", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "url", "qt.QUrl"), End),
    _func[0] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QWebEngineProfile_event_bool_QWebEngineProfile_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "e", "qt.QEvent"), End),
    _func[1] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled, qt_QWebEngineProfile_eventFilter_bool_QWebEngineProfile_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "watched", "qt.QObject"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: metaObject ("const QMetaObject *"; QWebEngineProfile this)
    // MISSING: childEvent (void; QWebEngineProfile this, "QChildEvent *" event) // protected
    // MISSING: connectNotify (void; QWebEngineProfile this, "const QMetaMethod &" signal) // protected
    _func[2] = new MemberFunction(c, "customEvent", _n_customEvent0, None, Compiled, qt_QWebEngineProfile_customEvent_void_QWebEngineProfile_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: disconnectNotify (void; QWebEngineProfile this, "const QMetaMethod &" signal) // protected
    _func[3] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QWebEngineProfile_timerEvent_void_QWebEngineProfile_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QWebEngineProfile"), new Param(c, "event", "qt.QTimerEvent"), End),
    // static functions
    new Function(c, "defaultProfile", _n_defaultProfile0, None, Compiled, qt_QWebEngineProfile_defaultProfile_QWebEngineProfile, Return, "qt.QWebEngineProfile", End),
    EndArguments);
