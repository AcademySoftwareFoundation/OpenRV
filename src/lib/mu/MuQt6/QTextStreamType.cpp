...
addSymbols(
    ...
    new Function(c, "encoding", _n_encoding0, None, Compiled, qt_QTextStream_encoding_int_QTextStream, Return, "int", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    ...
    new Function(c, "setEncoding", _n_setEncoding0, None, Compiled, qt_QTextStream_setEncoding_void_QTextStream_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "encoding", "int"), End),
