...
namespace Mu
{
    ...
    static Pointer QLocalSocket_QLocalSocket_QObject(Thread& NODE_THREAD, Pointer obj)
    {
        ...
        {
            QLocalSocketType* type = c->findSymbolOfTypeByQualifiedName<QLocalSocketType>(c->internName("qt.QLocalSocket"), false);
    ...
    Pointer qt_QLocalSocket_QLocalSocket_QLocalSocket_QLocalSocket_QObject(Mu::Thread& NODE_THREAD, Pointer param_this,
    ...
    void qt_QLocalSocket_connectToServer_void_QLocalSocket_string_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_name,
                                                                      int param_openMode)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QLocalSocket* arg0 = object<QLocalSocket>(param_this);
    ...
    {
        NODE_RETURN(
            qt_QLocalSocket_QLocalSocket_QLocalSocket_QLocalSocket_QObject(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
    }

    static NODE_IMPLEMENTATION(_n_abort0, void) { qt_QLocalSocket_abort_void_QLocalSocket(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)); }
    ...
    {
        qt_QLocalSocket_connectToServer_void_QLocalSocket_string_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                     NODE_ARG(2, int));
    }
    ...
    void QLocalSocketType::load()
    {
        ...
        addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None, Return, ftn, End),
                   ...
                   new Function(c, tn, castFromObject, Cast, Compiled, QLocalSocket_QLocalSocket_QObject, Return, ftn, Parameters,
        ...
        addSymbols(
            ...
            // member functions
            new Function(c, "QLocalSocket", _n_QLocalSocket0, None, Compiled,
                         qt_QLocalSocket_QLocalSocket_QLocalSocket_QLocalSocket_QObject, Return, "qt.QLocalSocket", Parameters,
                         new Param(c, "this", "qt.QLocalSocket"), new Param(c, "parent", "qt.QObject"), End),
            new Function(c, "abort", _n_abort0, None, Compiled, qt_QLocalSocket_abort_void_QLocalSocket, Return, "void", Parameters,
                         new Param(c, "this", "qt.QLocalSocket"), End),
            // PROP: bindableSocketOptions (flags
            // QBindable<QLocalSocket::SocketOptions>; QLocalSocket this)
            new Function(c, "connectToServer", _n_connectToServer0, None, Compiled, qt_QLocalSocket_connectToServer_void_QLocalSocket_int,
                         Return, "void", Parameters, new Param(c, "this", "qt.QLocalSocket"),
                         new Param(c, "openMode", "int", Value((int)QIODeviceBase::ReadWrite)), End),
            new Function(c, "connectToServer", _n_connectToServer1, None, Compiled,
                         qt_QLocalSocket_connectToServer_void_QLocalSocket_string_int, Return, "void", Parameters,
                         new Param(c, "this", "qt.QLocalSocket"), new Param(c, "name", "string"),
                         new Param(c, "openMode", "int", Value((int)QIODeviceBase::ReadWrite)), End),
            new Function(c, "disconnectFromServer", _n_disconnectFromServer0, None, Compiled,
                         qt_QLocalSocket_disconnectFromServer_void_QLocalSocket, Return, "void", Parameters,
                         new Param(c, "this", "qt.QLocalSocket"), End),
            new Function(c, "error", _n_error0, None, Compiled, qt_QLocalSocket_error_int_QLocalSocket, Return, "int", Parameters,
                         new Param(c, "this", "qt.QLocalSocket"), End),
            new Function(c, "flush", _n_flush0, None, Compiled, qt_QLocalSocket_flush_bool_QLocalSocket, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QLocalSocket"), End),
            new Function(c, "fullServerName", _n_fullServerName0, None, Compiled, qt_QLocalSocket_fullServerName_string_QLocalSocket,
                         Return, "string", Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            new Function(c, "isValid", _n_isValid0, None, Compiled, qt_QLocalSocket_isValid_bool_QLocalSocket, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QLocalSocket"), End),
            new Function(c, "readBufferSize", _n_readBufferSize0, None, Compiled, qt_QLocalSocket_readBufferSize_int64_QLocalSocket, Return,
                         "int64", Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            new Function(c, "serverName", _n_serverName0, None, Compiled, qt_QLocalSocket_serverName_string_QLocalSocket, Return, "string",
                         Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            new Function(c, "setReadBufferSize", _n_setReadBufferSize0, None, Compiled,
                         qt_QLocalSocket_setReadBufferSize_void_QLocalSocket_int64, Return, "void", Parameters,
                         new Param(c, "this", "qt.QLocalSocket"), new Param(c, "size", "int64"), End),
            new Function(c, "setServerName", _n_setServerName0, None, Compiled, qt_QLocalSocket_setServerName_void_QLocalSocket_string,
                         Return, "void", Parameters, new Param(c, "this", "qt.QLocalSocket"), new Param(c, "name", "string"), End),
            // MISSING: setSocketDescriptor (bool; QLocalSocket this, "qintptr"
            // socketDescriptor, flags QLocalSocket::LocalSocketState
            // socketState, flags QIODeviceBase::OpenMode openMode) PROP:
            // setSocketOptions (void; QLocalSocket this, flags
            // QLocalSocket::SocketOptions option) MISSING: socketDescriptor
            // ("qintptr"; QLocalSocket this) PROP: socketOptions (flags
            // QLocalSocket::SocketOptions; QLocalSocket this)
            new Function(c, "state", _n_state0, None, Compiled, qt_QLocalSocket_state_int_QLocalSocket, Return, "int", Parameters,
                         new Param(c, "this", "qt.QLocalSocket"), End),
            new Function(c, "waitForConnected", _n_waitForConnected0, None, Compiled,
                         qt_QLocalSocket_waitForConnected_bool_QLocalSocket_int, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QLocalSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
            new Function(c, "waitForDisconnected", _n_waitForDisconnected0, None, Compiled,
                         qt_QLocalSocket_waitForDisconnected_bool_QLocalSocket_int, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QLocalSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
            _func[0] = new MemberFunction(c, "bytesAvailable", _n_bytesAvailable0, None, Compiled,
                                          qt_QLocalSocket_bytesAvailable_int64_QLocalSocket, Return, "int64", Parameters,
                                          new Param(c, "this", "qt.QLocalSocket"), End),
            _func[1] =
                new MemberFunction(c, "bytesToWrite", _n_bytesToWrite0, None, Compiled, qt_QLocalSocket_bytesToWrite_int64_QLocalSocket,
                                   Return, "int64", Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            _func[2] = new MemberFunction(c, "canReadLine", _n_canReadLine0, None, Compiled, qt_QLocalSocket_canReadLine_bool_QLocalSocket,
                                          Return, "bool", Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            _func[3] = new MemberFunction(c, "close", _n_close0, None, Compiled, qt_QLocalSocket_close_void_QLocalSocket, Return, "void",
                                          Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            _func[4] =
                new MemberFunction(c, "isSequential", _n_isSequential0, None, Compiled, qt_QLocalSocket_isSequential_bool_QLocalSocket,
                                   Return, "bool", Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            _func[5] = new MemberFunction(c, "open", _n_open0, None, Compiled, qt_QLocalSocket_open_bool_QLocalSocket_int, Return, "bool",
                                          Parameters, new Param(c, "this", "qt.QLocalSocket"),
                                          new Param(c, "openMode", "int", Value((int)QIODeviceBase::ReadWrite)), End),
            _func[6] = new MemberFunction(c, "waitForBytesWritten", _n_waitForBytesWritten0, None, Compiled,
                                          qt_QLocalSocket_waitForBytesWritten_bool_QLocalSocket_int, Return, "bool", Parameters,
                                          new Param(c, "this", "qt.QLocalSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
            _func[7] = new MemberFunction(c, "waitForReadyRead", _n_waitForReadyRead0, None, Compiled,
                                          qt_QLocalSocket_waitForReadyRead_bool_QLocalSocket_int, Return, "bool", Parameters,
                                          new Param(c, "this", "qt.QLocalSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
            // MISSING: readData (int64; QLocalSocket this, "char *" data, int64
            // c) // protected MISSING: readLineData (int64; QLocalSocket this,
            // "char *" data, int64 maxSize) // protected
            _func[8] =
                new MemberFunction(c, "skipData", _n_skipData0, None, Compiled, qt_QLocalSocket_skipData_int64_QLocalSocket_int64, Return,
                                   "int64", Parameters, new Param(c, "this", "qt.QLocalSocket"), new Param(c, "maxSize", "int64"), End),
            // MISSING: writeData (int64; QLocalSocket this, "const char *"
            // data, int64 c) // protected
            _func[9] = new MemberFunction(c, "atEnd", _n_atEnd0, None, Compiled, qt_QLocalSocket_atEnd_bool_QLocalSocket, Return, "bool",
                                          Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            _func[10] = new MemberFunction(c, "pos", _n_pos0, None, Compiled, qt_QLocalSocket_pos_int64_QLocalSocket, Return, "int64",
                                           Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            _func[11] = new MemberFunction(c, "reset", _n_reset0, None, Compiled, qt_QLocalSocket_reset_bool_QLocalSocket, Return, "bool",
                                           Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            _func[12] = new MemberFunction(c, "seek", _n_seek0, None, Compiled, qt_QLocalSocket_seek_bool_QLocalSocket_int64, Return,
                                           "bool", Parameters, new Param(c, "this", "qt.QLocalSocket"), new Param(c, "pos", "int64"), End),
            _func[13] = new MemberFunction(c, "size", _n_size0, None, Compiled, qt_QLocalSocket_size_int64_QLocalSocket, Return, "int64",
                                           Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            // static functions
            EndArguments);
