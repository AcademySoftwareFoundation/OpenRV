...
{
    if (!_env) return QMenuBar::heightForWidth(_p3);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QMenuBar::metric(m);
    MuLangContext* c = (MuLangContext*)_env->context();
...
addSymbols(
    ...
    _func[0] = new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QMenuBar_heightForWidth_int_QMenuBar_int, Return, "int", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "_p3", "int"), End),
    ...
    // MISSING: enterEvent (void; QMenuBar this, "QEnterEvent *" event) // protected
    ...
    // MISSING: nativeEvent (bool; QMenuBar this, QByteArray eventType, "void *" message, "qintptr *" result) // protected
    ...
    _func[32] = new MemberFunction(c, "metric", _n_metric0, None, Compiled, qt_QMenuBar_metric_int_QMenuBar_int, Return, "int", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "m", "int"), End),
    // static functions
    EndArguments);
