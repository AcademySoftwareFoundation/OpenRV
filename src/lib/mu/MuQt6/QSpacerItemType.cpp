...
#include <MuQt6/QSpacerItemType.h>
#include <QtGui/QtGui>
...
int MuQt_QSpacerItem::heightForWidth(int _p3) const
{
    if (!_env) return QSpacerItem::heightForWidth(_p3);
    MuLangContext* c = (MuLangContext*)_env->context();
    ...
    {
        return QSpacerItem::heightForWidth(_p3);
    }
}
...
QWidget * MuQt_QSpacerItem::widget() const
{
...
addSymbols(
    ...
    _func[9] = new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QSpacerItem_heightForWidth_int_QSpacerItem_int, Return, "int", Parameters, new Param(c, "this", "qt.QSpacerItem"), new Param(c, "_p3", "int"), End),
