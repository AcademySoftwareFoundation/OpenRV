...
{
    if (!_env) { QHeaderView::reset(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::setModel(model); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::setVisible(v); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::sizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::sectionSizeFromContents(logicalIndex);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::currentChanged(current, old); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::event(e);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::horizontalOffset();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::mouseDoubleClickEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::mouseMoveEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::mousePressEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::mouseReleaseEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::paintEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::setSelection(rect, flags); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::verticalOffset();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::viewportEvent(e);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::keyboardSearch(search); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::setSelectionModel(selectionModel); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::sizeHintForColumn(column);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::sizeHintForRow(row);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::inputMethodQuery(query);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::edit(index, trigger, event);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::selectedIndexes();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::selectionCommand(index, event);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::startDrag(supportedActions); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::dragEnterEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::dragLeaveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::dragMoveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::dropEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
bool MuQt_QHeaderView::eventFilter(QObject * object, QEvent * event) 
{
    if (!_env) return QHeaderView::eventFilter(object, event);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::focusInEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::focusNextPrevChild(next);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::focusOutEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::keyPressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::resizeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QHeaderView::timerEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QHeaderView::viewportSizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QHeaderView_QHeaderView_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    else if (QHeaderView* w = object<QHeaderView>(widget))
    {
        QHeaderViewType* type = 
            c->findSymbolOfTypeByQualifiedName<QHeaderViewType>(c->internName("qt.QHeaderView"), false);
...
{
    NODE_RETURN( QHeaderView_QHeaderView_QObject(NODE_THREAD, NODE_ARG(0, Pointer)) );
}

Pointer qt_QHeaderView_QHeaderView_QHeaderView_QHeaderView_int_QWidget(Mu::Thread& NODE_THREAD, Pointer param_this, int param_orientation, Pointer param_parent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
void qt_QHeaderView_resizeSection_void_QHeaderView_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_logicalIndex, int param_size)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    int arg1 = (int)(param_logicalIndex);
...
void qt_QHeaderView_setSectionHidden_void_QHeaderView_int_bool(Mu::Thread& NODE_THREAD, Pointer param_this, int param_logicalIndex, bool param_hide)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    int arg1 = (int)(param_logicalIndex);
...
void qt_QHeaderView_setSectionResizeMode_void_QHeaderView_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_logicalIndex, int param_mode)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    int arg1 = (int)(param_logicalIndex);
...
void qt_QHeaderView_setSortIndicator_void_QHeaderView_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_logicalIndex, int param_order)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    int arg1 = (int)(param_logicalIndex);
...
void qt_QHeaderView_reset_void_QHeaderView(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    if (isMuQtObject(arg0)) arg0->QHeaderView::reset();
    else arg0->reset();
}
...
void qt_QHeaderView_setModel_void_QHeaderView_QAbstractItemModel(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_model)
{
    ...
    if (isMuQtObject(arg0)) arg0->QHeaderView::setModel(arg1);
...
void qt_QHeaderView_setVisible_void_QHeaderView_bool(Mu::Thread& NODE_THREAD, Pointer param_this, bool param_v)
{
    ...
    if (isMuQtObject(arg0)) arg0->QHeaderView::setVisible(arg1);
...
Pointer qt_QHeaderView_sizeHint_QSize_QHeaderView(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QHeaderView::sizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->sizeHint(),"qt.QSize");
}

Pointer qt_QHeaderView_sectionSizeFromContents_QSize_QHeaderView_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_logicalIndex)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    int arg1 = (int)(param_logicalIndex);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,((MuQt_QHeaderView*)arg0)->sectionSizeFromContents_pub_parent(arg1),"qt.QSize") : makeqtype<QSizeType>(c,((MuQt_QHeaderView*)arg0)->sectionSizeFromContents_pub(arg1),"qt.QSize");
}

void qt_QHeaderView_currentChanged_void_QHeaderView_QModelIndex_QModelIndex(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_current, Pointer param_old)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    const QModelIndex  arg1 = getqtype<QModelIndexType>(param_current);
    const QModelIndex  arg2 = getqtype<QModelIndexType>(param_old);
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->currentChanged_pub_parent(arg1, arg2);
...
int qt_QHeaderView_horizontalOffset_int_QHeaderView(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    return isMuQtObject(arg0) ? ((MuQt_QHeaderView*)arg0)->horizontalOffset_pub_parent() : ((MuQt_QHeaderView*)arg0)->horizontalOffset_pub();
}
...
void qt_QHeaderView_mouseDoubleClickEvent_void_QHeaderView_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->mouseDoubleClickEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->mouseDoubleClickEvent_pub(arg1);
}
...
void qt_QHeaderView_mouseMoveEvent_void_QHeaderView_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_e);
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->mouseMoveEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->mouseMoveEvent_pub(arg1);
}
...
void qt_QHeaderView_mousePressEvent_void_QHeaderView_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_e);
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->mousePressEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->mousePressEvent_pub(arg1);
}
...
void qt_QHeaderView_mouseReleaseEvent_void_QHeaderView_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_e);
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->mouseReleaseEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->mouseReleaseEvent_pub(arg1);
}
...
void qt_QHeaderView_paintEvent_void_QHeaderView_QPaintEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->paintEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->paintEvent_pub(arg1);
}

void qt_QHeaderView_setSelection_void_QHeaderView_QRect_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_rect, int param_flags)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    ...
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->setSelection_pub_parent(arg1, arg2);
...
int qt_QHeaderView_verticalOffset_int_QHeaderView(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    return isMuQtObject(arg0) ? ((MuQt_QHeaderView*)arg0)->verticalOffset_pub_parent() : ((MuQt_QHeaderView*)arg0)->verticalOffset_pub();
}
...
bool qt_QHeaderView_viewportEvent_bool_QHeaderView_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    QEvent * arg1 = getqpointer<QEventType>(param_e);
    return isMuQtObject(arg0) ? ((MuQt_QHeaderView*)arg0)->viewportEvent_pub_parent(arg1) : ((MuQt_QHeaderView*)arg0)->viewportEvent_pub(arg1);
}
...
void qt_QHeaderView_keyboardSearch_void_QHeaderView_string(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_search)
{
    ...
    if (isMuQtObject(arg0)) arg0->QHeaderView::keyboardSearch(arg1);
    else arg0->keyboardSearch(arg1);
}

void qt_QHeaderView_setSelectionModel_void_QHeaderView_QItemSelectionModel(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_selectionModel)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    QItemSelectionModel * arg1 = object<QItemSelectionModel>(param_selectionModel);
    if (isMuQtObject(arg0)) arg0->QHeaderView::setSelectionModel(arg1);
...
Pointer qt_QHeaderView_inputMethodQuery_QVariant_QHeaderView_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_query)
{
    ...
    return isMuQtObject(arg0) ? makeqtype<QVariantType>(c,arg0->QHeaderView::inputMethodQuery(arg1),"qt.QVariant") : makeqtype<QVariantType>(c,arg0->inputMethodQuery(arg1),"qt.QVariant");
}

bool qt_QHeaderView_edit_bool_QHeaderView_QModelIndex_int_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_index, int param_trigger, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    ...
    return isMuQtObject(arg0) ? ((MuQt_QHeaderView*)arg0)->edit_pub_parent(arg1, arg2, arg3) : ((MuQt_QHeaderView*)arg0)->edit_pub(arg1, arg2, arg3);
}
...
Pointer qt_QHeaderView_selectedIndexes_qt__QModelIndexBSB_ESB__QHeaderView(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    return isMuQtObject(arg0) ? makeqmodelindexlist(c,((MuQt_QHeaderView*)arg0)->selectedIndexes_pub_parent()) : makeqmodelindexlist(c,((MuQt_QHeaderView*)arg0)->selectedIndexes_pub());
}

int qt_QHeaderView_selectionCommand_int_QHeaderView_QModelIndex_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_index, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    const QModelIndex  arg1 = getqtype<QModelIndexType>(param_index);
    const QEvent * arg2 = getqpointer<QEventType>(param_event);
    return isMuQtObject(arg0) ? int(((MuQt_QHeaderView*)arg0)->selectionCommand_pub_parent(arg1, arg2)) : int(((MuQt_QHeaderView*)arg0)->selectionCommand_pub(arg1, arg2));
}
...
void qt_QHeaderView_startDrag_void_QHeaderView_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_supportedActions)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->startDrag_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->startDrag_pub(arg1);
}

Pointer qt_QHeaderView_visualRegionForSelection_QRegion_QHeaderView_QItemSelection(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_selection)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
...
void qt_QHeaderView_dragEnterEvent_void_QHeaderView_QDragEnterEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->dragEnterEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->dragEnterEvent_pub(arg1);
}
...
void qt_QHeaderView_dragLeaveEvent_void_QHeaderView_QDragLeaveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->dragLeaveEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->dragLeaveEvent_pub(arg1);
}
...
void qt_QHeaderView_dragMoveEvent_void_QHeaderView_QDragMoveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->dragMoveEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->dragMoveEvent_pub(arg1);
}
...
void qt_QHeaderView_dropEvent_void_QHeaderView_QDropEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->dropEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->dropEvent_pub(arg1);
}

bool qt_QHeaderView_eventFilter_bool_QHeaderView_QObject_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_object, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    QObject * arg1 = object<QObject>(param_object);
    QEvent * arg2 = getqpointer<QEventType>(param_event);
    return isMuQtObject(arg0) ? ((MuQt_QHeaderView*)arg0)->eventFilter_pub_parent(arg1, arg2) : ((MuQt_QHeaderView*)arg0)->eventFilter_pub(arg1, arg2);
}
...
void qt_QHeaderView_focusInEvent_void_QHeaderView_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->focusInEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->focusInEvent_pub(arg1);
}
...
bool qt_QHeaderView_focusNextPrevChild_bool_QHeaderView_bool(Mu::Thread& NODE_THREAD, Pointer param_this, bool param_next)
{
    ...
    return isMuQtObject(arg0) ? ((MuQt_QHeaderView*)arg0)->focusNextPrevChild_pub_parent(arg1) : ((MuQt_QHeaderView*)arg0)->focusNextPrevChild_pub(arg1);
}
...
void qt_QHeaderView_focusOutEvent_void_QHeaderView_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    QFocusEvent * arg1 = getqpointer<QFocusEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->focusOutEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->focusOutEvent_pub(arg1);
}
...
void qt_QHeaderView_keyPressEvent_void_QHeaderView_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    else ((MuQt_QHeaderView*)arg0)->keyPressEvent_pub(arg1);
}
...
void qt_QHeaderView_resizeEvent_void_QHeaderView_QResizeEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->resizeEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->resizeEvent_pub(arg1);
}
...
void qt_QHeaderView_timerEvent_void_QHeaderView_QTimerEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QHeaderView*)arg0)->timerEvent_pub_parent(arg1);
    else ((MuQt_QHeaderView*)arg0)->timerEvent_pub(arg1);
}
...
Pointer qt_QHeaderView_viewportSizeHint_QSize_QHeaderView(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QHeaderView* arg0 = object<QHeaderView>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,((MuQt_QHeaderView*)arg0)->viewportSizeHint_pub_parent(),"qt.QSize") : makeqtype<QSizeType>(c,((MuQt_QHeaderView*)arg0)->viewportSizeHint_pub(),"qt.QSize");
}


static NODE_IMPLEMENTATION(_n_QHeaderView0, Pointer)
{
    NODE_RETURN(qt_QHeaderView_QHeaderView_QHeaderView_QHeaderView_int_QWidget(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer)));
}
...
{
    NODE_RETURN(qt_QHeaderView_logicalIndexAt_int_QHeaderView_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
}
...
{
    NODE_RETURN(qt_QHeaderView_restoreState_bool_QHeaderView_QByteArray(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
{
    qt_QHeaderView_setSectionHidden_void_QHeaderView_int_bool(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, bool));
}
...
{
    qt_QHeaderView_setSectionResizeMode_void_QHeaderView_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int));
}
...
{
    qt_QHeaderView_setSortIndicator_void_QHeaderView_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int));
}
...
{
    qt_QHeaderView_reset_void_QHeaderView(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    NODE_RETURN(qt_QHeaderView_sectionSizeFromContents_QSize_QHeaderView_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
}

static NODE_IMPLEMENTATION(_n_currentChanged0, void)
{
    qt_QHeaderView_currentChanged_void_QHeaderView_QModelIndex_QModelIndex(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer));
}
...
{
    qt_QHeaderView_setSelection_void_QHeaderView_QRect_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int));
}
...
{
    qt_QHeaderView_setSelectionModel_void_QHeaderView_QItemSelectionModel(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
{
    NODE_RETURN(qt_QHeaderView_edit_bool_QHeaderView_QModelIndex_int_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, Pointer)));
}

static NODE_IMPLEMENTATION(_n_isIndexHidden0, bool)
{
    NODE_RETURN(qt_QHeaderView_isIndexHidden_bool_QHeaderView_QModelIndex(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
{
    NODE_RETURN(qt_QHeaderView_selectionCommand_int_QHeaderView_QModelIndex_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
{
    NODE_RETURN(qt_QHeaderView_visualRegionForSelection_QRegion_QHeaderView_QItemSelection(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
{
    NODE_RETURN(qt_QHeaderView_eventFilter_bool_QHeaderView_QObject_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
QHeaderViewType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QHeaderView_QHeaderView_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QHeaderView", _n_QHeaderView0, None, Compiled, qt_QHeaderView_QHeaderView_QHeaderView_QHeaderView_int_QWidget, Return, "qt.QHeaderView", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "orientation", "int"), new Param(c, "parent", "qt.QWidget"), End),
    // PROP: cascadingSectionResizes (bool; QHeaderView this)
    new Function(c, "count", _n_count0, None, Compiled, qt_QHeaderView_count_int_QHeaderView, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    // PROP: defaultAlignment (flags Qt::Alignment; QHeaderView this)
    // PROP: defaultSectionSize (int; QHeaderView this)
    new Function(c, "hiddenSectionCount", _n_hiddenSectionCount0, None, Compiled, qt_QHeaderView_hiddenSectionCount_int_QHeaderView, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    new Function(c, "hideSection", _n_hideSection0, None, Compiled, qt_QHeaderView_hideSection_void_QHeaderView_int, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), End),
    // PROP: highlightSections (bool; QHeaderView this)
    // PROP: isFirstSectionMovable (bool; QHeaderView this)
    new Function(c, "isSectionHidden", _n_isSectionHidden0, None, Compiled, qt_QHeaderView_isSectionHidden_bool_QHeaderView_int, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), End),
    // PROP: isSortIndicatorClearable (bool; QHeaderView this)
    // PROP: isSortIndicatorShown (bool; QHeaderView this)
    new Function(c, "length", _n_length0, None, Compiled, qt_QHeaderView_length_int_QHeaderView, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    new Function(c, "logicalIndex", _n_logicalIndex0, None, Compiled, qt_QHeaderView_logicalIndex_int_QHeaderView_int, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "visualIndex", "int"), End),
    new Function(c, "logicalIndexAt", _n_logicalIndexAt0, None, Compiled, qt_QHeaderView_logicalIndexAt_int_QHeaderView_int, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "position", "int"), End),
    new Function(c, "logicalIndexAt", _n_logicalIndexAt1, None, Compiled, qt_QHeaderView_logicalIndexAt_int_QHeaderView_int_int, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "x", "int"), new Param(c, "y", "int"), End),
    new Function(c, "logicalIndexAt", _n_logicalIndexAt2, None, Compiled, qt_QHeaderView_logicalIndexAt_int_QHeaderView_QPoint, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "pos", "qt.QPoint"), End),
    // PROP: maximumSectionSize (int; QHeaderView this)
    // PROP: minimumSectionSize (int; QHeaderView this)
    new Function(c, "moveSection", _n_moveSection0, None, Compiled, qt_QHeaderView_moveSection_void_QHeaderView_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "from", "int"), new Param(c, "to", "int"), End),
    new Function(c, "offset", _n_offset0, None, Compiled, qt_QHeaderView_offset_int_QHeaderView, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    new Function(c, "orientation", _n_orientation0, None, Compiled, qt_QHeaderView_orientation_int_QHeaderView, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    // PROP: resetDefaultSectionSize (void; QHeaderView this)
    new Function(c, "resizeContentsPrecision", _n_resizeContentsPrecision0, None, Compiled, qt_QHeaderView_resizeContentsPrecision_int_QHeaderView, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    new Function(c, "resizeSection", _n_resizeSection0, None, Compiled, qt_QHeaderView_resizeSection_void_QHeaderView_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), new Param(c, "size", "int"), End),
    new Function(c, "resizeSections", _n_resizeSections0, None, Compiled, qt_QHeaderView_resizeSections_void_QHeaderView_int, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "mode", "int"), End),
    new Function(c, "restoreState", _n_restoreState0, None, Compiled, qt_QHeaderView_restoreState_bool_QHeaderView_QByteArray, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "state", "qt.QByteArray"), End),
    new Function(c, "saveState", _n_saveState0, None, Compiled, qt_QHeaderView_saveState_QByteArray_QHeaderView, Return, "qt.QByteArray", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    new Function(c, "sectionPosition", _n_sectionPosition0, None, Compiled, qt_QHeaderView_sectionPosition_int_QHeaderView_int, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), End),
    new Function(c, "sectionResizeMode", _n_sectionResizeMode0, None, Compiled, qt_QHeaderView_sectionResizeMode_int_QHeaderView_int, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), End),
    new Function(c, "sectionSize", _n_sectionSize0, None, Compiled, qt_QHeaderView_sectionSize_int_QHeaderView_int, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), End),
    new Function(c, "sectionSizeHint", _n_sectionSizeHint0, None, Compiled, qt_QHeaderView_sectionSizeHint_int_QHeaderView_int, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), End),
    new Function(c, "sectionViewportPosition", _n_sectionViewportPosition0, None, Compiled, qt_QHeaderView_sectionViewportPosition_int_QHeaderView_int, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), End),
    new Function(c, "sectionsClickable", _n_sectionsClickable0, None, Compiled, qt_QHeaderView_sectionsClickable_bool_QHeaderView, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    new Function(c, "sectionsHidden", _n_sectionsHidden0, None, Compiled, qt_QHeaderView_sectionsHidden_bool_QHeaderView, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    new Function(c, "sectionsMovable", _n_sectionsMovable0, None, Compiled, qt_QHeaderView_sectionsMovable_bool_QHeaderView, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    new Function(c, "sectionsMoved", _n_sectionsMoved0, None, Compiled, qt_QHeaderView_sectionsMoved_bool_QHeaderView, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    // PROP: setCascadingSectionResizes (void; QHeaderView this, bool enable)
    // PROP: setDefaultAlignment (void; QHeaderView this, flags Qt::Alignment alignment)
    // PROP: setDefaultSectionSize (void; QHeaderView this, int size)
    // PROP: setFirstSectionMovable (void; QHeaderView this, bool movable)
    // PROP: setHighlightSections (void; QHeaderView this, bool highlight)
    // PROP: setMaximumSectionSize (void; QHeaderView this, int size)
    // PROP: setMinimumSectionSize (void; QHeaderView this, int size)
    new Function(c, "setResizeContentsPrecision", _n_setResizeContentsPrecision0, None, Compiled, qt_QHeaderView_setResizeContentsPrecision_void_QHeaderView_int, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "precision", "int"), End),
    new Function(c, "setSectionHidden", _n_setSectionHidden0, None, Compiled, qt_QHeaderView_setSectionHidden_void_QHeaderView_int_bool, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), new Param(c, "hide", "bool"), End),
    new Function(c, "setSectionResizeMode", _n_setSectionResizeMode0, None, Compiled, qt_QHeaderView_setSectionResizeMode_void_QHeaderView_int, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "mode", "int"), End),
    new Function(c, "setSectionResizeMode", _n_setSectionResizeMode1, None, Compiled, qt_QHeaderView_setSectionResizeMode_void_QHeaderView_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), new Param(c, "mode", "int"), End),
    new Function(c, "setSectionsClickable", _n_setSectionsClickable0, None, Compiled, qt_QHeaderView_setSectionsClickable_void_QHeaderView_bool, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "clickable", "bool"), End),
    new Function(c, "setSectionsMovable", _n_setSectionsMovable0, None, Compiled, qt_QHeaderView_setSectionsMovable_void_QHeaderView_bool, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "movable", "bool"), End),
    new Function(c, "setSortIndicator", _n_setSortIndicator0, None, Compiled, qt_QHeaderView_setSortIndicator_void_QHeaderView_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), new Param(c, "order", "int"), End),
    // PROP: setSortIndicatorClearable (void; QHeaderView this, bool clearable)
    // PROP: setSortIndicatorShown (void; QHeaderView this, bool show)
    // PROP: setStretchLastSection (void; QHeaderView this, bool stretch)
    new Function(c, "showSection", _n_showSection0, None, Compiled, qt_QHeaderView_showSection_void_QHeaderView_int, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), End),
    new Function(c, "sortIndicatorOrder", _n_sortIndicatorOrder0, None, Compiled, qt_QHeaderView_sortIndicatorOrder_int_QHeaderView, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    new Function(c, "sortIndicatorSection", _n_sortIndicatorSection0, None, Compiled, qt_QHeaderView_sortIndicatorSection_int_QHeaderView, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    // PROP: stretchLastSection (bool; QHeaderView this)
    new Function(c, "stretchSectionCount", _n_stretchSectionCount0, None, Compiled, qt_QHeaderView_stretchSectionCount_int_QHeaderView, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    new Function(c, "swapSections", _n_swapSections0, None, Compiled, qt_QHeaderView_swapSections_void_QHeaderView_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "first", "int"), new Param(c, "second", "int"), End),
    new Function(c, "visualIndex", _n_visualIndex0, None, Compiled, qt_QHeaderView_visualIndex_int_QHeaderView_int, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), End),
    new Function(c, "visualIndexAt", _n_visualIndexAt0, None, Compiled, qt_QHeaderView_visualIndexAt_int_QHeaderView_int, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "position", "int"), End),
    _func[0] = new MemberFunction(c, "reset", _n_reset0, None, Compiled, qt_QHeaderView_reset_void_QHeaderView, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    _func[1] = new MemberFunction(c, "setModel", _n_setModel0, None, Compiled, qt_QHeaderView_setModel_void_QHeaderView_QAbstractItemModel, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "model", "qt.QAbstractItemModel"), End),
    _func[2] = new MemberFunction(c, "setVisible", _n_setVisible0, None, Compiled, qt_QHeaderView_setVisible_void_QHeaderView_bool, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "v", "bool"), End),
    _func[3] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QHeaderView_sizeHint_QSize_QHeaderView, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    // MISSING: initStyleOption (void; QHeaderView this, "QStyleOptionHeader *" option) // protected
    // MISSING: initStyleOptionForIndex (void; QHeaderView this, "QStyleOptionHeader *" option, int logicalIndex) // protected
    // MISSING: paintSection (void; QHeaderView this, "QPainter *" painter, QRect rect, int logicalIndex) // protected
    _func[4] = new MemberFunction(c, "sectionSizeFromContents", _n_sectionSizeFromContents0, None, Compiled, qt_QHeaderView_sectionSizeFromContents_QSize_QHeaderView_int, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "logicalIndex", "int"), End),
    _func[5] = new MemberFunction(c, "currentChanged", _n_currentChanged0, None, Compiled, qt_QHeaderView_currentChanged_void_QHeaderView_QModelIndex_QModelIndex, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "current", "qt.QModelIndex"), new Param(c, "old", "qt.QModelIndex"), End),
    _func[6] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QHeaderView_event_bool_QHeaderView_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "e", "qt.QEvent"), End),
    _func[7] = new MemberFunction(c, "horizontalOffset", _n_horizontalOffset0, None, Compiled, qt_QHeaderView_horizontalOffset_int_QHeaderView, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    _func[8] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QHeaderView_mouseDoubleClickEvent_void_QHeaderView_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[9] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QHeaderView_mouseMoveEvent_void_QHeaderView_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[10] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QHeaderView_mousePressEvent_void_QHeaderView_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[11] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QHeaderView_mouseReleaseEvent_void_QHeaderView_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[12] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QHeaderView_paintEvent_void_QHeaderView_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "e", "qt.QPaintEvent"), End),
    _func[13] = new MemberFunction(c, "setSelection", _n_setSelection0, None, Compiled, qt_QHeaderView_setSelection_void_QHeaderView_QRect_int, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "rect", "qt.QRect"), new Param(c, "flags", "int"), End),
    _func[14] = new MemberFunction(c, "verticalOffset", _n_verticalOffset0, None, Compiled, qt_QHeaderView_verticalOffset_int_QHeaderView, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    _func[15] = new MemberFunction(c, "viewportEvent", _n_viewportEvent0, None, Compiled, qt_QHeaderView_viewportEvent_bool_QHeaderView_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "e", "qt.QEvent"), End),
    // MISSING: itemDelegateForIndex ("QAbstractItemDelegate *"; QHeaderView this, QModelIndex index)
    _func[16] = new MemberFunction(c, "keyboardSearch", _n_keyboardSearch0, None, Compiled, qt_QHeaderView_keyboardSearch_void_QHeaderView_string, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "search", "string"), End),
    _func[17] = new MemberFunction(c, "setSelectionModel", _n_setSelectionModel0, None, Compiled, qt_QHeaderView_setSelectionModel_void_QHeaderView_QItemSelectionModel, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "selectionModel", "qt.QItemSelectionModel"), End),
    _func[18] = new MemberFunction(c, "sizeHintForColumn", _n_sizeHintForColumn0, None, Compiled, qt_QHeaderView_sizeHintForColumn_int_QHeaderView_int, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "column", "int"), End),
    _func[19] = new MemberFunction(c, "sizeHintForRow", _n_sizeHintForRow0, None, Compiled, qt_QHeaderView_sizeHintForRow_int_QHeaderView_int, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "row", "int"), End),
    _func[20] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QHeaderView_inputMethodQuery_QVariant_QHeaderView_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "query", "int"), End),
    _func[21] = new MemberFunction(c, "edit", _n_edit0, None, Compiled, qt_QHeaderView_edit_bool_QHeaderView_QModelIndex_int_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "index", "qt.QModelIndex"), new Param(c, "trigger", "int"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: initViewItemOption (void; QHeaderView this, "QStyleOptionViewItem *" option) // protected
    _func[22] = new MemberFunction(c, "isIndexHidden", _n_isIndexHidden0, None, Compiled, qt_QHeaderView_isIndexHidden_bool_QHeaderView_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "index", "qt.QModelIndex"), End),
    _func[23] = new MemberFunction(c, "selectedIndexes", _n_selectedIndexes0, None, Compiled, qt_QHeaderView_selectedIndexes_qt__QModelIndexBSB_ESB__QHeaderView, Return, "qt.QModelIndex[]", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    _func[24] = new MemberFunction(c, "selectionCommand", _n_selectionCommand0, None, Compiled, qt_QHeaderView_selectionCommand_int_QHeaderView_QModelIndex_QEvent, Return, "int", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "index", "qt.QModelIndex"), new Param(c, "event", "qt.QEvent"), End),
    _func[25] = new MemberFunction(c, "startDrag", _n_startDrag0, None, Compiled, qt_QHeaderView_startDrag_void_QHeaderView_int, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "supportedActions", "int"), End),
    _func[26] = new MemberFunction(c, "visualRegionForSelection", _n_visualRegionForSelection0, None, Compiled, qt_QHeaderView_visualRegionForSelection_QRegion_QHeaderView_QItemSelection, Return, "qt.QRegion", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "selection", "qt.QItemSelection"), End),
    _func[27] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QHeaderView_dragEnterEvent_void_QHeaderView_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QDragEnterEvent"), End),
    _func[28] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QHeaderView_dragLeaveEvent_void_QHeaderView_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QDragLeaveEvent"), End),
    _func[29] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QHeaderView_dragMoveEvent_void_QHeaderView_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QDragMoveEvent"), End),
    _func[30] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QHeaderView_dropEvent_void_QHeaderView_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QDropEvent"), End),
    _func[31] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled, qt_QHeaderView_eventFilter_bool_QHeaderView_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "object", "qt.QObject"), new Param(c, "event", "qt.QEvent"), End),
    _func[32] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QHeaderView_focusInEvent_void_QHeaderView_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[33] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QHeaderView_focusNextPrevChild_bool_QHeaderView_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "next", "bool"), End),
    _func[34] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QHeaderView_focusOutEvent_void_QHeaderView_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QFocusEvent"), End),
    // MISSING: inputMethodEvent (void; QHeaderView this, "QInputMethodEvent *" event) // protected
    _func[35] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QHeaderView_keyPressEvent_void_QHeaderView_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[36] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QHeaderView_resizeEvent_void_QHeaderView_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QResizeEvent"), End),
    _func[37] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QHeaderView_timerEvent_void_QHeaderView_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QTimerEvent"), End),
    _func[38] = new MemberFunction(c, "viewportSizeHint", _n_viewportSizeHint0, None, Compiled, qt_QHeaderView_viewportSizeHint_QSize_QHeaderView, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    // static functions
    EndArguments);
