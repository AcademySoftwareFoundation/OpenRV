...
Pointer qt_QProcessEnvironment_QProcessEnvironment_QProcessEnvironment_QProcessEnvironment_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param__p35)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
{
    NODE_RETURN(qt_QProcessEnvironment_QProcessEnvironment_QProcessEnvironment_QProcessEnvironment_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
}
...
addSymbols(
    new Alias(c, "Initialization", "int"),
      new SymbolicConstant(c, "InheritFromParent", "int", Value(int(QProcessEnvironment::InheritFromParent))),
    EndArguments);
...
addSymbols(
    ...
    new Function(c, "QProcessEnvironment", _n_QProcessEnvironment1, None, Compiled, qt_QProcessEnvironment_QProcessEnvironment_QProcessEnvironment_QProcessEnvironment_int, Return, "qt.QProcessEnvironment", Parameters, new Param(c, "this", "qt.QProcessEnvironment"), new Param(c, "_p35", "int"), End),
    ...
    new Function(c, "inheritsFromParent", _n_inheritsFromParent0, None, Compiled, qt_QProcessEnvironment_inheritsFromParent_bool_QProcessEnvironment, Return, "bool", Parameters, new Param(c, "this", "qt.QProcessEnvironment"), End),
