...
namespace Mu
{
    ...
    Pointer
    qt_QProcessEnvironment_QProcessEnvironment_QProcessEnvironment_QProcessEnvironment_int(
        Mu::Thread& NODE_THREAD, Pointer param_this, int param__p35)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QProcessEnvironment::Initialization arg1 =
            (QProcessEnvironment::Initialization)(param__p35);
        setqtype<QProcessEnvironmentType>(param_this,
    ...
    bool qt_QProcessEnvironment_inheritsFromParent_bool_QProcessEnvironment(
        Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QProcessEnvironment& arg0 =
    ...
    {
        NODE_RETURN(
            qt_QProcessEnvironment_inheritsFromParent_bool_QProcessEnvironment(
                NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    void QProcessEnvironmentType::load()
    {
        ...
        addSymbols(new Alias(c, "Initialization", "int"),
                   new SymbolicConstant(
                       c, "InheritFromParent", "int",
                       Value(int(QProcessEnvironment::InheritFromParent))),
                   EndArguments);
        ...
        addSymbols(
            ...
            new Function(
                c, "QProcessEnvironment", _n_QProcessEnvironment1, None,
                Compiled,
                qt_QProcessEnvironment_QProcessEnvironment_QProcessEnvironment_QProcessEnvironment_int,
                Return, "qt.QProcessEnvironment", Parameters,
                new Param(c, "this", "qt.QProcessEnvironment"),
                new Param(c, "_p35", "int"), End),
            ...
            new Function(
                c, "inheritsFromParent", _n_inheritsFromParent0, None, Compiled,
                qt_QProcessEnvironment_inheritsFromParent_bool_QProcessEnvironment,
                Return, "bool", Parameters,
                new Param(c, "this", "qt.QProcessEnvironment"), End),
            new Function(
