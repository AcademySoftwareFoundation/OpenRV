...
bool MuQt_QAbstractTableModel::clearItemData(const QModelIndex & index) 
{
    if (!_env) return QAbstractTableModel::clearItemData(index);
    MuLangContext* c = (MuLangContext*)_env->context();
...
bool qt_QAbstractTableModel_clearItemData_bool_QAbstractTableModel_QModelIndex(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_index)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractTableModel* arg0 = object<QAbstractTableModel>(param_this);
    const QModelIndex  arg1 = getqtype<QModelIndexType>(param_index);
...
{
    NODE_RETURN(qt_QAbstractTableModel_clearItemData_bool_QAbstractTableModel_QModelIndex(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
addSymbols(
    ...
    _func[9] = new MemberFunction(c, "data", _n_data0, None, Compiled, qt_QAbstractTableModel_data_QVariant_QAbstractTableModel_QModelIndex_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "index", "qt.QModelIndex"), new Param(c, "role", "int", Value((int)Qt::DisplayRole)), End),
    _func[10] = new MemberFunction(c, "fetchMore", _n_fetchMore0, None, Compiled, qt_QAbstractTableModel_fetchMore_void_QAbstractTableModel_QModelIndex, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "parent", "qt.QModelIndex"), End),
    ...
    _func[12] = new MemberFunction(c, "insertColumns", _n_insertColumns0, None, Compiled, qt_QAbstractTableModel_insertColumns_bool_QAbstractTableModel_int_int_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "column", "int"), new Param(c, "count", "int"), new Param(c, "parent", "qt.QModelIndex"), End),
    _func[13] = new MemberFunction(c, "insertRows", _n_insertRows0, None, Compiled, qt_QAbstractTableModel_insertRows_bool_QAbstractTableModel_int_int_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "row", "int"), new Param(c, "count", "int"), new Param(c, "parent", "qt.QModelIndex"), End),
    ...
    _func[15] = new MemberFunction(c, "mimeData", _n_mimeData0, None, Compiled, qt_QAbstractTableModel_mimeData_QMimeData_QAbstractTableModel_qt__QModelIndexBSB_ESB_, Return, "qt.QMimeData", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "indexes", "qt.QModelIndex[]"), End),
    _func[16] = new MemberFunction(c, "mimeTypes", _n_mimeTypes0, None, Compiled, qt_QAbstractTableModel_mimeTypes_stringBSB_ESB__QAbstractTableModel, Return, "string[]", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), End),
    ...
    // MISSING: multiData (void; QAbstractTableModel this, QModelIndex index, "QModelRoleDataSpan" roleDataSpan)
    _func[19] = new MemberFunction(c, "removeColumns", _n_removeColumns0, None, Compiled, qt_QAbstractTableModel_removeColumns_bool_QAbstractTableModel_int_int_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "column", "int"), new Param(c, "count", "int"), new Param(c, "parent", "qt.QModelIndex"), End),
    _func[20] = new MemberFunction(c, "removeRows", _n_removeRows0, None, Compiled, qt_QAbstractTableModel_removeRows_bool_QAbstractTableModel_int_int_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "row", "int"), new Param(c, "count", "int"), new Param(c, "parent", "qt.QModelIndex"), End),
    // MISSING: roleNames ("QHash<int, QByteArray>"; QAbstractTableModel this)
    _func[21] = new MemberFunction(c, "rowCount", _n_rowCount0, None, Compiled, qt_QAbstractTableModel_rowCount_int_QAbstractTableModel_QModelIndex, Return, "int", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "parent", "qt.QModelIndex"), End),
    _func[22] = new MemberFunction(c, "setData", _n_setData0, None, Compiled, qt_QAbstractTableModel_setData_bool_QAbstractTableModel_QModelIndex_QVariant_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "index", "qt.QModelIndex"), new Param(c, "value", "qt.QVariant"), new Param(c, "role", "int", Value((int)Qt::EditRole)), End),
    _func[23] = new MemberFunction(c, "setHeaderData", _n_setHeaderData0, None, Compiled, qt_QAbstractTableModel_setHeaderData_bool_QAbstractTableModel_int_int_QVariant_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "section", "int"), new Param(c, "orientation", "int"), new Param(c, "value", "qt.QVariant"), new Param(c, "role", "int", Value((int)Qt::EditRole)), End),
    // MISSING: setItemData (bool; QAbstractTableModel this, QModelIndex index, "const QMap<int, QVariant> &" roles)
    _func[24] = new MemberFunction(c, "sort", _n_sort0, None, Compiled, qt_QAbstractTableModel_sort_void_QAbstractTableModel_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "column", "int"), new Param(c, "order", "int", Value((int)Qt::AscendingOrder)), End),
    ...
    _func[26] = new MemberFunction(c, "supportedDragActions", _n_supportedDragActions0, None, Compiled, qt_QAbstractTableModel_supportedDragActions_int_QAbstractTableModel, Return, "int", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), End),
    _func[27] = new MemberFunction(c, "supportedDropActions", _n_supportedDropActions0, None, Compiled, qt_QAbstractTableModel_supportedDropActions_int_QAbstractTableModel, Return, "int", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), End),
    // static functions
    EndArguments);
