...
namespace Mu
{
    ...
    void QLinearGradientType::registerFinalizer(void* o) { GC_register_finalizer(o, QLinearGradientType::finalizer, 0, 0, 0); }
    ...
    Pointer qt_QLinearGradient_QLinearGradient_QLinearGradient_QLinearGradient_QPointF_QPointF(Mu::Thread& NODE_THREAD, Pointer param_this,
                                                                                               Pointer param_start, Pointer param_finalStop)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    Pointer qt_QLinearGradient_QLinearGradient_QLinearGradient_QLinearGradient_double_double_double_double(Mu::Thread& NODE_THREAD,
                                                                                                           Pointer param_this,
                                                                                                           double param_x1, double param_y1,
                                                                                                           double param_x2, double param_y2)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    void qt_QLinearGradient_setFinalStop_void_QLinearGradient_double_double(Mu::Thread& NODE_THREAD, Pointer param_this, double param_x,
                                                                            double param_y)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QLinearGradient arg0 = getqtype<QLinearGradientType>(param_this);
    ...
    void qt_QLinearGradient_setStart_void_QLinearGradient_double_double(Mu::Thread& NODE_THREAD, Pointer param_this, double param_x,
                                                                        double param_y)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QLinearGradient arg0 = getqtype<QLinearGradientType>(param_this);
    ...
    {
        NODE_RETURN(qt_QLinearGradient_QLinearGradient_QLinearGradient_QLinearGradient_QPointF_QPointF(
    ...
    {
        NODE_RETURN(qt_QLinearGradient_QLinearGradient_QLinearGradient_QLinearGradient_double_double_double_double(
    ...
    {
        qt_QLinearGradient_setFinalStop_void_QLinearGradient_double_double(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, double),
                                                                           NODE_ARG(2, double));
    }
    ...
    {
        qt_QLinearGradient_setStart_void_QLinearGradient_double_double(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, double),
                                                                       NODE_ARG(2, double));
    }
    ...
    void QLinearGradientType::load()
    {
        ...
        addSymbols(
            // enums
            // member functions
            new Function(c, "QLinearGradient", _n_QLinearGradient0, None, Compiled,
                         qt_QLinearGradient_QLinearGradient_QLinearGradient_QLinearGradient, Return, "qt.QLinearGradient", Parameters,
                         new Param(c, "this", "qt.QLinearGradient"), End),
            new Function(c, "QLinearGradient", _n_QLinearGradient1, None, Compiled,
                         qt_QLinearGradient_QLinearGradient_QLinearGradient_QLinearGradient_QPointF_QPointF, Return, "qt.QLinearGradient",
                         Parameters, new Param(c, "this", "qt.QLinearGradient"), new Param(c, "start", "qt.QPointF"),
                         new Param(c, "finalStop", "qt.QPointF"), End),
            new Function(c, "QLinearGradient", _n_QLinearGradient2, None, Compiled,
                         qt_QLinearGradient_QLinearGradient_QLinearGradient_QLinearGradient_double_double_double_double, Return,
                         "qt.QLinearGradient", Parameters, new Param(c, "this", "qt.QLinearGradient"), new Param(c, "x1", "double"),
                         new Param(c, "y1", "double"), new Param(c, "x2", "double"), new Param(c, "y2", "double"), End),
            new Function(c, "finalStop", _n_finalStop0, None, Compiled, qt_QLinearGradient_finalStop_QPointF_QLinearGradient, Return,
                         "qt.QPointF", Parameters, new Param(c, "this", "qt.QLinearGradient"), End),
            new Function(c, "setFinalStop", _n_setFinalStop0, None, Compiled, qt_QLinearGradient_setFinalStop_void_QLinearGradient_QPointF,
                         Return, "void", Parameters, new Param(c, "this", "qt.QLinearGradient"), new Param(c, "stop", "qt.QPointF"), End),
            new Function(c, "setFinalStop", _n_setFinalStop1, None, Compiled,
                         qt_QLinearGradient_setFinalStop_void_QLinearGradient_double_double, Return, "void", Parameters,
                         new Param(c, "this", "qt.QLinearGradient"), new Param(c, "x", "double"), new Param(c, "y", "double"), End),
            new Function(c, "setStart", _n_setStart0, None, Compiled, qt_QLinearGradient_setStart_void_QLinearGradient_QPointF, Return,
                         "void", Parameters, new Param(c, "this", "qt.QLinearGradient"), new Param(c, "start", "qt.QPointF"), End),
            new Function(c, "setStart", _n_setStart1, None, Compiled, qt_QLinearGradient_setStart_void_QLinearGradient_double_double,
                         Return, "void", Parameters, new Param(c, "this", "qt.QLinearGradient"), new Param(c, "x", "double"),
                         new Param(c, "y", "double"), End),
            new Function(c, "start", _n_start0, None, Compiled, qt_QLinearGradient_start_QPointF_QLinearGradient, Return, "qt.QPointF",
                         Parameters, new Param(c, "this", "qt.QLinearGradient"), End),
            // static functions
            EndArguments);
