...
QCursorType::Instance::Instance(const Class* c) : ClassInstance(c)
{
}
...
void 
QCursorType::registerFinalizer (void* o)
{
    GC_register_finalizer(o, QCursorType::finalizer, 0, 0, 0);
}

void 
QCursorType::finalizer (void* obj, void* data)
{
...
Pointer qt_QCursor_QCursor_QCursor_QCursor_QBitmap_QBitmap_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_bitmap, Pointer param_mask, int param_hotX, int param_hotY)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QCursor_QCursor_QCursor_QCursor_QPixmap_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_pixmap, int param_hotX, int param_hotY)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
{
    NODE_RETURN(qt_QCursor_QCursor_QCursor_QCursor_QBitmap_QBitmap_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer), NODE_ARG(3, int), NODE_ARG(4, int)));
}

static NODE_IMPLEMENTATION(_n_QCursor3, Pointer)
{
    NODE_RETURN(qt_QCursor_QCursor_QCursor_QCursor_QPixmap_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, int)));
}
...
{
    NODE_RETURN(qt_QCursor_shape_int_QCursor(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QCursor_pos_QPoint_QScreen(NODE_THREAD, NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_setPos0, void)
{
    qt_QCursor_setPos_void_int_int(NODE_THREAD, NODE_ARG(0, int), NODE_ARG(1, int));
}
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QCursor", _n_QCursor0, None, Compiled, qt_QCursor_QCursor_QCursor_QCursor, Return, "qt.QCursor", Parameters, new Param(c, "this", "qt.QCursor"), End),
    new Function(c, "QCursor", _n_QCursor1, None, Compiled, qt_QCursor_QCursor_QCursor_QCursor_int, Return, "qt.QCursor", Parameters, new Param(c, "this", "qt.QCursor"), new Param(c, "shape", "int"), End),
    new Function(c, "QCursor", _n_QCursor2, None, Compiled, qt_QCursor_QCursor_QCursor_QCursor_QBitmap_QBitmap_int_int, Return, "qt.QCursor", Parameters, new Param(c, "this", "qt.QCursor"), new Param(c, "bitmap", "qt.QBitmap"), new Param(c, "mask", "qt.QBitmap"), new Param(c, "hotX", "int", Value((int)-1)), new Param(c, "hotY", "int", Value((int)-1)), End),
    new Function(c, "QCursor", _n_QCursor3, None, Compiled, qt_QCursor_QCursor_QCursor_QCursor_QPixmap_int_int, Return, "qt.QCursor", Parameters, new Param(c, "this", "qt.QCursor"), new Param(c, "pixmap", "qt.QPixmap"), new Param(c, "hotX", "int", Value((int)-1)), new Param(c, "hotY", "int", Value((int)-1)), End),
    // MISSING: QCursor (QCursor; QCursor this, QCursor c)
    // MISSING: QCursor (QCursor; QCursor this, "QCursor & &" other)
    new Function(c, "hotSpot", _n_hotSpot0, None, Compiled, qt_QCursor_hotSpot_QPoint_QCursor, Return, "qt.QPoint", Parameters, new Param(c, "this", "qt.QCursor"), End),
    new Function(c, "pixmap", _n_pixmap0, None, Compiled, qt_QCursor_pixmap_QPixmap_QCursor, Return, "qt.QPixmap", Parameters, new Param(c, "this", "qt.QCursor"), End),
    new Function(c, "setShape", _n_setShape0, None, Compiled, qt_QCursor_setShape_void_QCursor_int, Return, "void", Parameters, new Param(c, "this", "qt.QCursor"), new Param(c, "shape", "int"), End),
    new Function(c, "shape", _n_shape0, None, Compiled, qt_QCursor_shape_int_QCursor, Return, "int", Parameters, new Param(c, "this", "qt.QCursor"), End),
    new Function(c, "swap", _n_swap0, None, Compiled, qt_QCursor_swap_void_QCursor_QCursor, Return, "void", Parameters, new Param(c, "this", "qt.QCursor"), new Param(c, "other", "qt.QCursor"), End),
    ...
    new Function(c, "pos", _n_pos1, None, Compiled, qt_QCursor_pos_QPoint_QScreen, Return, "qt.QPoint", Parameters, new Param(c, "screen", "qt.QScreen"), End),
    new Function(c, "setPos", _n_setPos0, None, Compiled, qt_QCursor_setPos_void_int_int, Return, "void", Parameters, new Param(c, "x", "int"), new Param(c, "y", "int"), End),
    new Function(c, "setPos", _n_setPos1, None, Compiled, qt_QCursor_setPos_void_QScreen_int_int, Return, "void", Parameters, new Param(c, "screen", "qt.QScreen"), new Param(c, "x", "int"), new Param(c, "y", "int"), End),
    new Function(c, "setPos", _n_setPos2, None, Compiled, qt_QCursor_setPos_void_QPoint, Return, "void", Parameters, new Param(c, "p", "qt.QPoint"), End),
    new Function(c, "setPos", _n_setPos3, None, Compiled, qt_QCursor_setPos_void_QScreen_QPoint, Return, "void", Parameters, new Param(c, "screen", "qt.QScreen"), new Param(c, "p", "qt.QPoint"), End),
    EndArguments);
