...
addSymbols(
    ...
    new Function(c, "devicePixelRatio", _n_devicePixelRatio0, None, Compiled, qt_QPaintDevice_devicePixelRatio_double_QPaintDevice, Return, "double", Parameters, new Param(c, "this", "qt.QPaintDevice"), End),
