...
{
    if (!_env) return QTabBar::minimumSizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTabBar::sizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTabBar::minimumTabSizeHint(index);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::tabInserted(index); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::tabLayoutChange(); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::tabRemoved(index); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTabBar::tabSizeHint(index);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::changeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTabBar::event(event_);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::hideEvent(_p13); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::keyPressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::mouseDoubleClickEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::mouseMoveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::mousePressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::mouseReleaseEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::paintEvent(_p14); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::resizeEvent(_p15); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::showEvent(_p13); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::timerEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::wheelEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTabBar::hasHeightForWidth();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTabBar::heightForWidth(w);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTabBar::inputMethodQuery(query);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::closeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::contextMenuEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::dragEnterEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::dragLeaveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::dragMoveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::dropEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::focusInEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QTabBar::focusNextPrevChild(next);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::focusOutEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::keyReleaseEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::leaveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::moveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QTabBar::tabletEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
int MuQt_QTabBar::metric(QPaintDevice::PaintDeviceMetric m) const
{
    if (!_env) return QTabBar::metric(m);
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QTabBar_QTabBar_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    {
        QTabBarType* type = 
            c->findSymbolOfTypeByQualifiedName<QTabBarType>(c->internName("qt.QTabBar"), false);
...
int qt_QTabBar_insertTab_int_QTabBar_int_QIcon_string(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index, Pointer param_icon, Pointer param_text)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTabBar* arg0 = object<QTabBar>(param_this);
    int arg1 = (int)(param_index);
...
void qt_QTabBar_setAccessibleTabName_void_QTabBar_int_string(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index, Pointer param_name)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTabBar* arg0 = object<QTabBar>(param_this);
    int arg1 = (int)(param_index);
...
void qt_QTabBar_setTabButton_void_QTabBar_int_int_QWidget(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index, int param_position, Pointer param_widget)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTabBar* arg0 = object<QTabBar>(param_this);
    int arg1 = (int)(param_index);
...
void qt_QTabBar_setTabTextColor_void_QTabBar_int_QColor(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index, Pointer param_color)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTabBar* arg0 = object<QTabBar>(param_this);
    int arg1 = (int)(param_index);
...
void qt_QTabBar_setTabWhatsThis_void_QTabBar_int_string(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index, Pointer param_text)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTabBar* arg0 = object<QTabBar>(param_this);
    int arg1 = (int)(param_index);
...
Pointer qt_QTabBar_minimumSizeHint_QSize_QTabBar(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTabBar* arg0 = object<QTabBar>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QTabBar::minimumSizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->minimumSizeHint(),"qt.QSize");
}
...
Pointer qt_QTabBar_sizeHint_QSize_QTabBar(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTabBar* arg0 = object<QTabBar>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QTabBar::sizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->sizeHint(),"qt.QSize");
}
...
Pointer qt_QTabBar_minimumTabSizeHint_QSize_QTabBar_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index)
{
    ...
    QTabBar* arg0 = object<QTabBar>(param_this);
    int arg1 = (int)(param_index);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,((MuQt_QTabBar*)arg0)->minimumTabSizeHint_pub_parent(arg1),"qt.QSize") : makeqtype<QSizeType>(c,((MuQt_QTabBar*)arg0)->minimumTabSizeHint_pub(arg1),"qt.QSize");
}
...
void qt_QTabBar_tabInserted_void_QTabBar_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index)
{
    ...
    QTabBar* arg0 = object<QTabBar>(param_this);
    int arg1 = (int)(param_index);
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->tabInserted_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->tabInserted_pub(arg1);
}
...
void qt_QTabBar_tabLayoutChange_void_QTabBar(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTabBar* arg0 = object<QTabBar>(param_this);
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->tabLayoutChange_pub_parent();
    else ((MuQt_QTabBar*)arg0)->tabLayoutChange_pub();
}
...
void qt_QTabBar_tabRemoved_void_QTabBar_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index)
{
    ...
    QTabBar* arg0 = object<QTabBar>(param_this);
    int arg1 = (int)(param_index);
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->tabRemoved_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->tabRemoved_pub(arg1);
}
...
Pointer qt_QTabBar_tabSizeHint_QSize_QTabBar_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index)
{
    ...
    QTabBar* arg0 = object<QTabBar>(param_this);
    int arg1 = (int)(param_index);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,((MuQt_QTabBar*)arg0)->tabSizeHint_pub_parent(arg1),"qt.QSize") : makeqtype<QSizeType>(c,((MuQt_QTabBar*)arg0)->tabSizeHint_pub(arg1),"qt.QSize");
}
...
void qt_QTabBar_changeEvent_void_QTabBar_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->changeEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->changeEvent_pub(arg1);
}
...
void qt_QTabBar_hideEvent_void_QTabBar_QHideEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param__p13)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->hideEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->hideEvent_pub(arg1);
}
...
void qt_QTabBar_keyPressEvent_void_QTabBar_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    else ((MuQt_QTabBar*)arg0)->keyPressEvent_pub(arg1);
}
...
void qt_QTabBar_mouseDoubleClickEvent_void_QTabBar_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->mouseDoubleClickEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->mouseDoubleClickEvent_pub(arg1);
}
...
void qt_QTabBar_mouseMoveEvent_void_QTabBar_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QTabBar* arg0 = object<QTabBar>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->mouseMoveEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->mouseMoveEvent_pub(arg1);
}
...
void qt_QTabBar_mousePressEvent_void_QTabBar_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QTabBar* arg0 = object<QTabBar>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->mousePressEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->mousePressEvent_pub(arg1);
}
...
void qt_QTabBar_mouseReleaseEvent_void_QTabBar_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QTabBar* arg0 = object<QTabBar>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->mouseReleaseEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->mouseReleaseEvent_pub(arg1);
}
...
void qt_QTabBar_paintEvent_void_QTabBar_QPaintEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param__p14)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->paintEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->paintEvent_pub(arg1);
}
...
void qt_QTabBar_resizeEvent_void_QTabBar_QResizeEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param__p15)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->resizeEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->resizeEvent_pub(arg1);
}
...
void qt_QTabBar_showEvent_void_QTabBar_QShowEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param__p13)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->showEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->showEvent_pub(arg1);
}
...
void qt_QTabBar_timerEvent_void_QTabBar_QTimerEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->timerEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->timerEvent_pub(arg1);
}
...
void qt_QTabBar_wheelEvent_void_QTabBar_QWheelEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->wheelEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->wheelEvent_pub(arg1);
}
...
Pointer qt_QTabBar_inputMethodQuery_QVariant_QTabBar_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_query)
{
    ...
    return isMuQtObject(arg0) ? makeqtype<QVariantType>(c,arg0->QTabBar::inputMethodQuery(arg1),"qt.QVariant") : makeqtype<QVariantType>(c,arg0->inputMethodQuery(arg1),"qt.QVariant");
}
...
void qt_QTabBar_closeEvent_void_QTabBar_QCloseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->closeEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->closeEvent_pub(arg1);
}
...
void qt_QTabBar_contextMenuEvent_void_QTabBar_QContextMenuEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->contextMenuEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->contextMenuEvent_pub(arg1);
}
...
void qt_QTabBar_dragEnterEvent_void_QTabBar_QDragEnterEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->dragEnterEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->dragEnterEvent_pub(arg1);
}
...
void qt_QTabBar_dragLeaveEvent_void_QTabBar_QDragLeaveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->dragLeaveEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->dragLeaveEvent_pub(arg1);
}
...
void qt_QTabBar_dragMoveEvent_void_QTabBar_QDragMoveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->dragMoveEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->dragMoveEvent_pub(arg1);
}
...
void qt_QTabBar_dropEvent_void_QTabBar_QDropEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->dropEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->dropEvent_pub(arg1);
}
...
void qt_QTabBar_focusInEvent_void_QTabBar_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->focusInEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->focusInEvent_pub(arg1);
}
...
bool qt_QTabBar_focusNextPrevChild_bool_QTabBar_bool(Mu::Thread& NODE_THREAD, Pointer param_this, bool param_next)
{
    ...
    return isMuQtObject(arg0) ? ((MuQt_QTabBar*)arg0)->focusNextPrevChild_pub_parent(arg1) : ((MuQt_QTabBar*)arg0)->focusNextPrevChild_pub(arg1);
}
...
void qt_QTabBar_focusOutEvent_void_QTabBar_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QTabBar* arg0 = object<QTabBar>(param_this);
    QFocusEvent * arg1 = getqpointer<QFocusEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->focusOutEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->focusOutEvent_pub(arg1);
}
...
void qt_QTabBar_keyReleaseEvent_void_QTabBar_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QTabBar* arg0 = object<QTabBar>(param_this);
    QKeyEvent * arg1 = getqpointer<QKeyEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->keyReleaseEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->keyReleaseEvent_pub(arg1);
}
...
void qt_QTabBar_leaveEvent_void_QTabBar_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QTabBar* arg0 = object<QTabBar>(param_this);
    QEvent * arg1 = getqpointer<QEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->leaveEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->leaveEvent_pub(arg1);
}
...
void qt_QTabBar_moveEvent_void_QTabBar_QMoveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->moveEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->moveEvent_pub(arg1);
}
...
void qt_QTabBar_tabletEvent_void_QTabBar_QTabletEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->tabletEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->tabletEvent_pub(arg1);
}
...
{
    NODE_RETURN(qt_QTabBar_addTab_int_QTabBar_QIcon_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}

static NODE_IMPLEMENTATION(_n_insertTab0, int)
{
    NODE_RETURN(qt_QTabBar_insertTab_int_QTabBar_int_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer)));
}

static NODE_IMPLEMENTATION(_n_insertTab1, int)
{
    NODE_RETURN(qt_QTabBar_insertTab_int_QTabBar_int_QIcon_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer), NODE_ARG(3, Pointer)));
}
...
{
    qt_QTabBar_setAccessibleTabName_void_QTabBar_int_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer));
}

static NODE_IMPLEMENTATION(_n_setTabButton0, void)
{
    qt_QTabBar_setTabButton_void_QTabBar_int_int_QWidget(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int), NODE_ARG(3, Pointer));
}
...
{
    qt_QTabBar_setTabTextColor_void_QTabBar_int_QColor(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer));
}
...
{
    qt_QTabBar_setTabWhatsThis_void_QTabBar_int_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer));
}
...
{
    NODE_RETURN(qt_QTabBar_tabButton_QWidget_QTabBar_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
}
...
QTabBarType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QTabBar_QTabBar_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QTabBar", _n_QTabBar0, None, Compiled, qt_QTabBar_QTabBar_QTabBar_QTabBar_QWidget, Return, "qt.QTabBar", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "parent", "qt.QWidget"), End),
    new Function(c, "accessibleTabName", _n_accessibleTabName0, None, Compiled, qt_QTabBar_accessibleTabName_string_QTabBar_int, Return, "string", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    new Function(c, "addTab", _n_addTab0, None, Compiled, qt_QTabBar_addTab_int_QTabBar_string, Return, "int", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "text", "string"), End),
    new Function(c, "addTab", _n_addTab1, None, Compiled, qt_QTabBar_addTab_int_QTabBar_QIcon_string, Return, "int", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "icon", "qt.QIcon"), new Param(c, "text", "string"), End),
    ...
    new Function(c, "insertTab", _n_insertTab0, None, Compiled, qt_QTabBar_insertTab_int_QTabBar_int_string, Return, "int", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "text", "string"), End),
    new Function(c, "insertTab", _n_insertTab1, None, Compiled, qt_QTabBar_insertTab_int_QTabBar_int_QIcon_string, Return, "int", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "icon", "qt.QIcon"), new Param(c, "text", "string"), End),
    // PROP: isMovable (bool; QTabBar this)
    new Function(c, "isTabEnabled", _n_isTabEnabled0, None, Compiled, qt_QTabBar_isTabEnabled_bool_QTabBar_int, Return, "bool", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    new Function(c, "isTabVisible", _n_isTabVisible0, None, Compiled, qt_QTabBar_isTabVisible_bool_QTabBar_int, Return, "bool", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    new Function(c, "moveTab", _n_moveTab0, None, Compiled, qt_QTabBar_moveTab_void_QTabBar_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "from", "int"), new Param(c, "to", "int"), End),
    new Function(c, "removeTab", _n_removeTab0, None, Compiled, qt_QTabBar_removeTab_void_QTabBar_int, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    // PROP: selectionBehaviorOnRemove (flags QTabBar::SelectionBehavior; QTabBar this)
    new Function(c, "setAccessibleTabName", _n_setAccessibleTabName0, None, Compiled, qt_QTabBar_setAccessibleTabName_void_QTabBar_int_string, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "name", "string"), End),
    ...
    // PROP: setDrawBase (void; QTabBar this, bool drawTheBase)
    // PROP: setElideMode (void; QTabBar this, flags Qt::TextElideMode mode)
    // PROP: setExpanding (void; QTabBar this, bool enabled)
    // PROP: setIconSize (void; QTabBar this, QSize size)
    // PROP: setMovable (void; QTabBar this, bool movable)
    // PROP: setSelectionBehaviorOnRemove (void; QTabBar this, flags QTabBar::SelectionBehavior behavior)
    // PROP: setShape (void; QTabBar this, flags QTabBar::Shape shape)
    new Function(c, "setTabButton", _n_setTabButton0, None, Compiled, qt_QTabBar_setTabButton_void_QTabBar_int_int_QWidget, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "position", "int"), new Param(c, "widget", "qt.QWidget"), End),
    new Function(c, "setTabData", _n_setTabData0, None, Compiled, qt_QTabBar_setTabData_void_QTabBar_int_QVariant, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "data", "qt.QVariant"), End),
    new Function(c, "setTabEnabled", _n_setTabEnabled0, None, Compiled, qt_QTabBar_setTabEnabled_void_QTabBar_int_bool, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "enabled", "bool"), End),
    new Function(c, "setTabIcon", _n_setTabIcon0, None, Compiled, qt_QTabBar_setTabIcon_void_QTabBar_int_QIcon, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "icon", "qt.QIcon"), End),
    new Function(c, "setTabText", _n_setTabText0, None, Compiled, qt_QTabBar_setTabText_void_QTabBar_int_string, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "text", "string"), End),
    new Function(c, "setTabTextColor", _n_setTabTextColor0, None, Compiled, qt_QTabBar_setTabTextColor_void_QTabBar_int_QColor, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "color", "qt.QColor"), End),
    new Function(c, "setTabToolTip", _n_setTabToolTip0, None, Compiled, qt_QTabBar_setTabToolTip_void_QTabBar_int_string, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "tip", "string"), End),
    new Function(c, "setTabVisible", _n_setTabVisible0, None, Compiled, qt_QTabBar_setTabVisible_void_QTabBar_int_bool, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "visible", "bool"), End),
    new Function(c, "setTabWhatsThis", _n_setTabWhatsThis0, None, Compiled, qt_QTabBar_setTabWhatsThis_void_QTabBar_int_string, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "text", "string"), End),
    ...
    new Function(c, "tabAt", _n_tabAt0, None, Compiled, qt_QTabBar_tabAt_int_QTabBar_QPoint, Return, "int", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "position", "qt.QPoint"), End),
    new Function(c, "tabButton", _n_tabButton0, None, Compiled, qt_QTabBar_tabButton_QWidget_QTabBar_int_int, Return, "qt.QWidget", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), new Param(c, "position", "int"), End),
    new Function(c, "tabData", _n_tabData0, None, Compiled, qt_QTabBar_tabData_QVariant_QTabBar_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    new Function(c, "tabIcon", _n_tabIcon0, None, Compiled, qt_QTabBar_tabIcon_QIcon_QTabBar_int, Return, "qt.QIcon", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    new Function(c, "tabRect", _n_tabRect0, None, Compiled, qt_QTabBar_tabRect_QRect_QTabBar_int, Return, "qt.QRect", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    new Function(c, "tabText", _n_tabText0, None, Compiled, qt_QTabBar_tabText_string_QTabBar_int, Return, "string", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    new Function(c, "tabTextColor", _n_tabTextColor0, None, Compiled, qt_QTabBar_tabTextColor_QColor_QTabBar_int, Return, "qt.QColor", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    new Function(c, "tabToolTip", _n_tabToolTip0, None, Compiled, qt_QTabBar_tabToolTip_string_QTabBar_int, Return, "string", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    new Function(c, "tabWhatsThis", _n_tabWhatsThis0, None, Compiled, qt_QTabBar_tabWhatsThis_string_QTabBar_int, Return, "string", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    // PROP: tabsClosable (bool; QTabBar this)
    // PROP: usesScrollButtons (bool; QTabBar this)
    _func[0] = new MemberFunction(c, "minimumSizeHint", _n_minimumSizeHint0, None, Compiled, qt_QTabBar_minimumSizeHint_QSize_QTabBar, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QTabBar"), End),
    _func[1] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QTabBar_sizeHint_QSize_QTabBar, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QTabBar"), End),
    // MISSING: initStyleOption (void; QTabBar this, "QStyleOptionTab *" option, int tabIndex) // protected
    _func[2] = new MemberFunction(c, "minimumTabSizeHint", _n_minimumTabSizeHint0, None, Compiled, qt_QTabBar_minimumTabSizeHint_QSize_QTabBar_int, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    _func[3] = new MemberFunction(c, "tabInserted", _n_tabInserted0, None, Compiled, qt_QTabBar_tabInserted_void_QTabBar_int, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    _func[4] = new MemberFunction(c, "tabLayoutChange", _n_tabLayoutChange0, None, Compiled, qt_QTabBar_tabLayoutChange_void_QTabBar, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), End),
    _func[5] = new MemberFunction(c, "tabRemoved", _n_tabRemoved0, None, Compiled, qt_QTabBar_tabRemoved_void_QTabBar_int, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    _func[6] = new MemberFunction(c, "tabSizeHint", _n_tabSizeHint0, None, Compiled, qt_QTabBar_tabSizeHint_QSize_QTabBar_int, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "index", "int"), End),
    _func[7] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled, qt_QTabBar_changeEvent_void_QTabBar_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QEvent"), End),
    _func[8] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QTabBar_event_bool_QTabBar_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event_", "qt.QEvent"), End),
    _func[9] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QTabBar_hideEvent_void_QTabBar_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "_p13", "qt.QHideEvent"), End),
    _func[10] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QTabBar_keyPressEvent_void_QTabBar_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[11] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QTabBar_mouseDoubleClickEvent_void_QTabBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[12] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QTabBar_mouseMoveEvent_void_QTabBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[13] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QTabBar_mousePressEvent_void_QTabBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[14] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QTabBar_mouseReleaseEvent_void_QTabBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[15] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QTabBar_paintEvent_void_QTabBar_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "_p14", "qt.QPaintEvent"), End),
    _func[16] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QTabBar_resizeEvent_void_QTabBar_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "_p15", "qt.QResizeEvent"), End),
    _func[17] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QTabBar_showEvent_void_QTabBar_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "_p13", "qt.QShowEvent"), End),
    _func[18] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QTabBar_timerEvent_void_QTabBar_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QTimerEvent"), End),
    _func[19] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QTabBar_wheelEvent_void_QTabBar_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QWheelEvent"), End),
    _func[20] = new MemberFunction(c, "hasHeightForWidth", _n_hasHeightForWidth0, None, Compiled, qt_QTabBar_hasHeightForWidth_bool_QTabBar, Return, "bool", Parameters, new Param(c, "this", "qt.QTabBar"), End),
    _func[21] = new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QTabBar_heightForWidth_int_QTabBar_int, Return, "int", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "w", "int"), End),
    _func[22] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QTabBar_inputMethodQuery_QVariant_QTabBar_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "query", "int"), End),
    // MISSING: paintEngine ("QPaintEngine *"; QTabBar this)
    // MISSING: actionEvent (void; QTabBar this, "QActionEvent *" event) // protected
    _func[23] = new MemberFunction(c, "closeEvent", _n_closeEvent0, None, Compiled, qt_QTabBar_closeEvent_void_QTabBar_QCloseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QCloseEvent"), End),
    _func[24] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled, qt_QTabBar_contextMenuEvent_void_QTabBar_QContextMenuEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QContextMenuEvent"), End),
    _func[25] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QTabBar_dragEnterEvent_void_QTabBar_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QDragEnterEvent"), End),
    _func[26] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QTabBar_dragLeaveEvent_void_QTabBar_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QDragLeaveEvent"), End),
    _func[27] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QTabBar_dragMoveEvent_void_QTabBar_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QDragMoveEvent"), End),
    _func[28] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QTabBar_dropEvent_void_QTabBar_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QDropEvent"), End),
    // MISSING: enterEvent (void; QTabBar this, "QEnterEvent *" event) // protected
    _func[29] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QTabBar_focusInEvent_void_QTabBar_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[30] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QTabBar_focusNextPrevChild_bool_QTabBar_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "next", "bool"), End),
    _func[31] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QTabBar_focusOutEvent_void_QTabBar_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QFocusEvent"), End),
    // MISSING: inputMethodEvent (void; QTabBar this, "QInputMethodEvent *" event) // protected
    _func[32] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QTabBar_keyReleaseEvent_void_QTabBar_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[33] = new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QTabBar_leaveEvent_void_QTabBar_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QEvent"), End),
    _func[34] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QTabBar_moveEvent_void_QTabBar_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QTabBar this, QByteArray eventType, "void *" message, "qintptr *" result) // protected
    _func[35] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QTabBar_tabletEvent_void_QTabBar_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QTabletEvent"), End),
    // MISSING: initPainter (void; QTabBar this, "QPainter *" painter) // protected
    _func[36] = new MemberFunction(c, "metric", _n_metric0, None, Compiled, qt_QTabBar_metric_int_QTabBar_int, Return, "int", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "m", "int"), End),
    // static functions
    EndArguments);
