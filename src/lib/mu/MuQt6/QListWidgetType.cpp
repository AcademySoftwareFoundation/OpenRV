...
namespace Mu
{
    ...
    bool qt_QListWidget_isPersistentEditorOpen_bool_QListWidget_QListWidgetItem(Mu::Thread& NODE_THREAD, Pointer param_this,
                                                                                Pointer param_item)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QListWidget* arg0 = object<QListWidget>(param_this);
    ...
    void qt_QListWidget_setSelectionModel_void_QListWidget_QItemSelectionModel(Mu::Thread& NODE_THREAD, Pointer param_this,
                                                                               Pointer param_selectionModel)
    {
        ...
        if (isMuQtObject(arg0))
            arg0->QListWidget::setSelectionModel(arg1);
        else
    ...
    void qt_QListWidget_dropEvent_void_QListWidget_QDropEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
    {
        ...
        if (isMuQtObject(arg0))
            ((MuQt_QListWidget*)arg0)->dropEvent_pub_parent(arg1);
        else
            ((MuQt_QListWidget*)arg0)->dropEvent_pub(arg1);
    }
    ...
    void qt_QListWidget_scrollTo_void_QListWidget_QModelIndex_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_index,
                                                                  int param_hint)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QListWidget* arg0 = object<QListWidget>(param_this);
        ...
        if (isMuQtObject(arg0))
            arg0->QListWidget::scrollTo(arg1, arg2);
        else
    ...
    void qt_QListWidget_setRootIndex_void_QListWidget_QModelIndex(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_index)
    {
        ...
        const QModelIndex arg1 = getqtype<QModelIndexType>(param_index);
        if (isMuQtObject(arg0))
            arg0->QListWidget::setRootIndex(arg1);
        else
    ...
    void qt_QListWidget_scrollContentsBy_void_QListWidget_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_dx, int param_dy)
    {
        ...
        if (isMuQtObject(arg0))
            ((MuQt_QListWidget*)arg0)->scrollContentsBy_pub_parent(arg1, arg2);
        else
            ((MuQt_QListWidget*)arg0)->scrollContentsBy_pub(arg1, arg2);
    }
    ...
    {
        NODE_RETURN(qt_QListWidget_isPersistentEditorOpen_bool_QListWidget_QListWidgetItem(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
                                                                                           NODE_ARG(1, Pointer)));
    }
    ...
    {
        qt_QListWidget_setSelectionModel_void_QListWidget_QItemSelectionModel(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
                                                                              NODE_ARG(1, Pointer));
    }
    ...
    {
        qt_QListWidget_scrollTo_void_QListWidget_QModelIndex_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                 NODE_ARG(2, int));
    }
    ...
    {
        qt_QListWidget_scrollContentsBy_void_QListWidget_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int),
                                                                 NODE_ARG(2, int));
    }
    ...
    void QListWidgetType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "isPersistentEditorOpen", _n_isPersistentEditorOpen0, None, Compiled,
                         qt_QListWidget_isPersistentEditorOpen_bool_QListWidget_QListWidgetItem, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QListWidget"), new Param(c, "item", "qt.QListWidgetItem"), End),
            ...
            _func[0] =
                new MemberFunction(c, "setSelectionModel", _n_setSelectionModel0, None, Compiled,
                                   qt_QListWidget_setSelectionModel_void_QListWidget_QItemSelectionModel, Return, "void", Parameters,
                                   new Param(c, "this", "qt.QListWidget"), new Param(c, "selectionModel", "qt.QItemSelectionModel"), End),
            ...
            _func[6] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QListWidget_event_bool_QListWidget_QEvent, Return,
                                          "bool", Parameters, new Param(c, "this", "qt.QListWidget"), new Param(c, "e", "qt.QEvent"), End),
            _func[7] = new MemberFunction(c, "indexAt", _n_indexAt0, None, Compiled, qt_QListWidget_indexAt_QModelIndex_QListWidget_QPoint,
                                          Return, "qt.QModelIndex", Parameters, new Param(c, "this", "qt.QListWidget"),
                                          new Param(c, "p", "qt.QPoint"), End),
            _func[8] = new MemberFunction(c, "scrollTo", _n_scrollTo0, None, Compiled,
                                          qt_QListWidget_scrollTo_void_QListWidget_QModelIndex_int, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QListWidget"), new Param(c, "index", "qt.QModelIndex"),
                                          new Param(c, "hint", "int", Value((int)QAbstractItemView::EnsureVisible)), End),
            _func[9] = new MemberFunction(c, "setRootIndex", _n_setRootIndex0, None, Compiled,
                                          qt_QListWidget_setRootIndex_void_QListWidget_QModelIndex, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QListWidget"), new Param(c, "index", "qt.QModelIndex"), End),
            ...
            _func[14] = new MemberFunction(c, "horizontalOffset", _n_horizontalOffset0, None, Compiled,
                                           qt_QListWidget_horizontalOffset_int_QListWidget, Return, "int", Parameters,
                                           new Param(c, "this", "qt.QListWidget"), End),
            // MISSING: initViewItemOption (void; QListWidget this,
            // "QStyleOptionViewItem *" option) // protected
            _func[15] = new MemberFunction(c, "isIndexHidden", _n_isIndexHidden0, None, Compiled,
            ...
            _func[22] =
                new MemberFunction(c, "scrollContentsBy", _n_scrollContentsBy0, None, Compiled,
                                   qt_QListWidget_scrollContentsBy_void_QListWidget_int_int, Return, "void", Parameters,
                                   new Param(c, "this", "qt.QListWidget"), new Param(c, "dx", "int"), new Param(c, "dy", "int"), End),
            ...
            _func[26] = new MemberFunction(c, "startDrag", _n_startDrag0, None, Compiled, qt_QListWidget_startDrag_void_QListWidget_int,
            ...
            _func[30] = new MemberFunction(c, "viewportSizeHint", _n_viewportSizeHint0, None, Compiled,
