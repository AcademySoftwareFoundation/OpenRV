...
namespace Mu
{
    ...
    static Pointer QTcpServer_QTcpServer_QObject(Thread& NODE_THREAD, Pointer obj)
    {
        ...
        {
            QTcpServerType* type = c->findSymbolOfTypeByQualifiedName<QTcpServerType>(c->internName("qt.QTcpServer"), false);
    ...
    static NODE_IMPLEMENTATION(castFromObject, Pointer) { NODE_RETURN(QTcpServer_QTcpServer_QObject(NODE_THREAD, NODE_ARG(0, Pointer))); }
    ...
    int qt_QTcpServer_listenBacklogSize_int_QTcpServer(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QTcpServer* arg0 = object<QTcpServer>(param_this);
        return arg0->listenBacklogSize();
    }
    ...
    Pointer qt_QTcpServer_nextPendingConnection_QTcpSocket_QTcpServer(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QTcpServer* arg0 = object<QTcpServer>(param_this);
        return isMuQtObject(arg0) ? makeinstance<QTcpSocketType>(c, arg0->QTcpServer::nextPendingConnection(), "qt.QTcpSocket")
                                  : makeinstance<QTcpSocketType>(c, arg0->nextPendingConnection(), "qt.QTcpSocket");
    }
    ...
    void qt_QTcpServer_setListenBacklogSize_void_QTcpServer_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_size)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QTcpServer* arg0 = object<QTcpServer>(param_this);
        int arg1 = (int)(param_size);
        arg0->setListenBacklogSize(arg1);
    }
    ...
    bool qt_QTcpServer_eventFilter_bool_QTcpServer_QObject_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_watched,
                                                                  Pointer param_event)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QTcpServer* arg0 = object<QTcpServer>(param_this);
    ...
    static NODE_IMPLEMENTATION(_n_close0, void) { qt_QTcpServer_close_void_QTcpServer(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)); }
    ...
    static NODE_IMPLEMENTATION(_n_listenBacklogSize0, int)
    {
        NODE_RETURN(qt_QTcpServer_listenBacklogSize_int_QTcpServer(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_setListenBacklogSize0, void)
    {
        qt_QTcpServer_setListenBacklogSize_void_QTcpServer_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int));
    }
    ...
    {
        NODE_RETURN(qt_QTcpServer_eventFilter_bool_QTcpServer_QObject_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                             NODE_ARG(2, Pointer)));
    }
    ...
    void QTcpServerType::load()
    {
        ...
        addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None, Return, ftn, End),
                   ...
                   new Function(c, tn, castFromObject, Cast, Compiled, QTcpServer_QTcpServer_QObject, Return, ftn, Parameters,
        ...
        addSymbols(
            // enums
            // member functions
            new Function(c, "QTcpServer", _n_QTcpServer0, None, Compiled, qt_QTcpServer_QTcpServer_QTcpServer_QTcpServer_QObject, Return,
                         "qt.QTcpServer", Parameters, new Param(c, "this", "qt.QTcpServer"), new Param(c, "parent", "qt.QObject"), End),
            new Function(c, "close", _n_close0, None, Compiled, qt_QTcpServer_close_void_QTcpServer, Return, "void", Parameters,
                         new Param(c, "this", "qt.QTcpServer"), End),
            new Function(c, "errorString", _n_errorString0, None, Compiled, qt_QTcpServer_errorString_string_QTcpServer, Return, "string",
                         Parameters, new Param(c, "this", "qt.QTcpServer"), End),
            _func[0] = new MemberFunction(c, "hasPendingConnections", _n_hasPendingConnections0, None, Compiled,
                                          qt_QTcpServer_hasPendingConnections_bool_QTcpServer, Return, "bool", Parameters,
                                          new Param(c, "this", "qt.QTcpServer"), End),
            new Function(c, "isListening", _n_isListening0, None, Compiled, qt_QTcpServer_isListening_bool_QTcpServer, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QTcpServer"), End),
            // MISSING: listen (bool; QTcpServer this, QHostAddress address,
            // "quint16" port)
            new Function(c, "listenBacklogSize", _n_listenBacklogSize0, None, Compiled, qt_QTcpServer_listenBacklogSize_int_QTcpServer,
                         Return, "int", Parameters, new Param(c, "this", "qt.QTcpServer"), End),
            new Function(c, "maxPendingConnections", _n_maxPendingConnections0, None, Compiled,
                         qt_QTcpServer_maxPendingConnections_int_QTcpServer, Return, "int", Parameters,
                         new Param(c, "this", "qt.QTcpServer"), End),
            _func[1] = new MemberFunction(c, "nextPendingConnection", _n_nextPendingConnection0, None, Compiled,
                                          qt_QTcpServer_nextPendingConnection_QTcpSocket_QTcpServer, Return, "qt.QTcpSocket", Parameters,
                                          new Param(c, "this", "qt.QTcpServer"), End),
            new Function(c, "pauseAccepting", _n_pauseAccepting0, None, Compiled, qt_QTcpServer_pauseAccepting_void_QTcpServer, Return,
                         "void", Parameters, new Param(c, "this", "qt.QTcpServer"), End),
            // MISSING: proxy ("QNetworkProxy"; QTcpServer this)
            new Function(c, "resumeAccepting", _n_resumeAccepting0, None, Compiled, qt_QTcpServer_resumeAccepting_void_QTcpServer, Return,
                         "void", Parameters, new Param(c, "this", "qt.QTcpServer"), End),
            new Function(c, "serverAddress", _n_serverAddress0, None, Compiled, qt_QTcpServer_serverAddress_QHostAddress_QTcpServer, Return,
                         "qt.QHostAddress", Parameters, new Param(c, "this", "qt.QTcpServer"), End),
            new Function(c, "serverError", _n_serverError0, None, Compiled, qt_QTcpServer_serverError_int_QTcpServer, Return, "int",
                         Parameters, new Param(c, "this", "qt.QTcpServer"), End),
            // MISSING: serverPort ("quint16"; QTcpServer this)
            new Function(c, "setListenBacklogSize", _n_setListenBacklogSize0, None, Compiled,
                         qt_QTcpServer_setListenBacklogSize_void_QTcpServer_int, Return, "void", Parameters,
                         new Param(c, "this", "qt.QTcpServer"), new Param(c, "size", "int"), End),
            new Function(c, "setMaxPendingConnections", _n_setMaxPendingConnections0, None, Compiled,
                         qt_QTcpServer_setMaxPendingConnections_void_QTcpServer_int, Return, "void", Parameters,
                         new Param(c, "this", "qt.QTcpServer"), new Param(c, "numConnections", "int"), End),
            ...
            new Function(c, "addPendingConnection", _n_addPendingConnection0, None, Compiled,
                         qt_QTcpServer_addPendingConnection_void_QTcpServer_QTcpSocket, Return, "void", Parameters,
                         new Param(c, "this", "qt.QTcpServer"), new Param(c, "socket", "qt.QTcpSocket"), End),
            // MISSING: incomingConnection (void; QTcpServer this, "qintptr"
            // socketDescriptor) // protected
            _func[2] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QTcpServer_event_bool_QTcpServer_QEvent, Return, "bool",
                                          Parameters, new Param(c, "this", "qt.QTcpServer"), new Param(c, "e", "qt.QEvent"), End),
            _func[3] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled,
                                          qt_QTcpServer_eventFilter_bool_QTcpServer_QObject_QEvent, Return, "bool", Parameters,
                                          new Param(c, "this", "qt.QTcpServer"), new Param(c, "watched", "qt.QObject"),
            ...
            _func[4] = new MemberFunction(c, "customEvent", _n_customEvent0, None, Compiled,
                                          qt_QTcpServer_customEvent_void_QTcpServer_QEvent, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QTcpServer"), new Param(c, "event", "qt.QEvent"), End),
            ...
            _func[5] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled,
                                          qt_QTcpServer_timerEvent_void_QTcpServer_QTimerEvent, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QTcpServer"), new Param(c, "event", "qt.QTimerEvent"), End),
            // static functions
            EndArguments);
