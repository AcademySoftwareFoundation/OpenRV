...
addSymbols(
    ...
    new Function(c, "listenBacklogSize", _n_listenBacklogSize0, None, Compiled, qt_QTcpServer_listenBacklogSize_int_QTcpServer, Return, "int", Parameters, new Param(c, "this", "qt.QTcpServer"), End),
    ...
    new Function(c, "setListenBacklogSize", _n_setListenBacklogSize0, None, Compiled, qt_QTcpServer_setListenBacklogSize_void_QTcpServer_int, Return, "void", Parameters, new Param(c, "this", "qt.QTcpServer"), new Param(c, "size", "int"), End),
