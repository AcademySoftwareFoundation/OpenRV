...
class MuQt_QFile : public QFile
{
  public:
    ...
    MuQt_QFile(Pointer muobj, const CallEnvironment*, const std::filesystem::path & name) ;
    ...
    MuQt_QFile(Pointer muobj, const CallEnvironment*, const std::filesystem::path & name, QObject * parent) ;
