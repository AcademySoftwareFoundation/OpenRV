...
#ifndef __MuQt5__QPenType__h__
#define __MuQt5__QPenType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        QPenType(Context* context, const char* name, Class* superClass = 0);
        virtual ~QPenType();
