...
inline
void setobject (Pointer obj, const QObject* object)
{
    if (ClassInstance* i = reinterpret_cast<ClassInstance*>(obj))
...
inline
void setlayoutitem (Pointer obj, const QLayoutItem* object)
{
    if (ClassInstance* i = reinterpret_cast<ClassInstance*>(obj))
...
inline
void setpaintdevice (Pointer obj, const QPaintDevice* object)
{
    if (ClassInstance* i = reinterpret_cast<ClassInstance*>(obj))
...
template <class Type>
inline
typename Type::ValueType* getqpointer (Pointer obj)
{
    if (ClassInstance* i = reinterpret_cast<ClassInstance*>(obj))
...
template <class Type>
inline
void setqpointer (Pointer obj, const typename Type::ValueType* object)
{
    if (ClassInstance* i = reinterpret_cast<ClassInstance*>(obj))
...
inline
ClassInstance* 
makeqpointer(Context* c, const typename Type::ValueType* object, const char* name)
{
    if (!object) return 0;
...
inline
ClassInstance* 
makeqpointer(const Type* type, const typename Type::ValueType* qobject)
{
    if (!qobject) return 0;
    ClassInstance* i = ClassInstance::allocate(type);
...
template <class Type>
QList<typename Type::ValueType*>
qpointerlist(Pointer p)
{
...
template <class Type>
DynamicArray*
makeqpointerlist(Context* c, const QList<typename Type::ValueType*>& list, const char* name)
{
...
ClassInstance* 
makeinstance (Context* c, const QObject* object, const char* name)
{
...
template <class MuType>
ClassInstance* 
makelayoutitem (Context* c, const QLayoutItem* item, const char* name)
{
    const typename MuType::MuQtType* mobj = 0;
...
template <class MuType>
ClassInstance* 
makepaintdevice (Context* c, const QPaintDevice* device, const char* name)
{
    const typename MuType::MuQtType* mobj = 0;
...
template<class T>
ClassInstance* 
makeinstance(const T* type, const QObject* qobject)
{
...
template<class T>
ClassInstance* 
makelayoutitem(const T* type, const QLayoutItem* qitem)
{
    const typename T::MuQtType* mobj = 0;
...
template<class T>
ClassInstance* 
makepaintdevice(const T* type, const QPaintDevice* device)
{
    const typename T::MuQtType* mobj = 0;
...
inline
StringType::String* 
makestring (Context* c, const QString& qstr)
{
    MuLangContext* lc = static_cast<MuLangContext*>(c);
...
inline
StringType::String* 
makestring (Context* c, const char* str)
{
    if (str)
    {
        MuLangContext* lc = static_cast<MuLangContext*>(c);
...
inline
QStringList qstringlist(Pointer p)
{
    QStringList list;
    DynamicArray* array = reinterpret_cast<DynamicArray*>(p);
    for (size_t i = 0; i < array->size(); i++)
...
inline
DynamicArray*
makestringlist(Context* c, const QStringList& list)
{
    MuLangContext* lc = static_cast<MuLangContext*>(c);
    DynamicArray* array =
        new DynamicArray(static_cast<const Class*>(lc->arrayType(lc->stringType(), 1, 0)), 1);
    array->resize(list.size());
    for (size_t i = 0; i < list.size(); i++)
    {
...
inline
void
setqtype(Pointer p, const typename Type::ValueType& value)
{
...
inline
ClassInstance*
makeqtype(const Class* type, const typename Type::ValueType& value)
{
...
inline
ClassInstance* 
makeqtype (Context* c, const typename Type::ValueType& value, const char* muType)
{
...
inline
QList<QtType> qtypelist(Pointer p)
{
    QList<QtType> list;
    DynamicArray* array = reinterpret_cast<DynamicArray*>(p);
    for (size_t i = 0; i < array->size(); i++)
...
inline
DynamicArray*
makeqtypelist(Context* c, const QList<QtType>& list, const char* muType)
{
    MuLangContext* lc = static_cast<MuLangContext*>(c);
    const Class* type = c->findSymbolOfTypeByQualifiedName<Class>(lc->internName(muType), false);
    DynamicArray* array =
        new DynamicArray(static_cast<const Class*>(lc->arrayType(type, 1, 0)), 1);
    array->resize(list.size());
    for (size_t i = 0; i < list.size(); i++)
    {
...
inline
QModelIndexList qmodelindexlist(Pointer p)
{
...
inline
DynamicArray*
makeqmodelindexlist(Context* c, const QModelIndexList& list)
{
    MuLangContext* lc = static_cast<MuLangContext*>(c);
    DynamicArray* array =
        new DynamicArray(static_cast<const Class*>(lc->arrayType(lc->stringType(), 1, 0)), 1);
...
inline
QFileInfoList qfileinfolist(Pointer p)
{
    QFileInfoList list;
    DynamicArray* array = reinterpret_cast<DynamicArray*>(p);
    for (size_t i = 0; i < array->size(); i++)
...
inline
DynamicArray*
makeqfileinfolist(Context* c, const QFileInfoList& list)
{
    MuLangContext* lc = static_cast<MuLangContext*>(c);
    DynamicArray* array =
        new DynamicArray(static_cast<const Class*>(lc->arrayType(lc->stringType(), 1, 0)), 1);
