...
#ifndef __MuQt5__QGenericMatrixType__h__
#define __MuQt5__QGenericMatrixType__h__
#include <iostream>
#include <Mu/Class.h>
...
class QGenericMatrixType : public Class
{
  public:
    //
    //  Types
    ...
    typedef QGenericMatrix ValueType;
    ...
    QGenericMatrixType(Context* context, const char* name, Class* superClass = 0);
    virtual ~QGenericMatrixType();
...
#endif // __MuQt5__QGenericMatrixType__h__
