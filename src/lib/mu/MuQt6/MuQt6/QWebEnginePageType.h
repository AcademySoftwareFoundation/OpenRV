...
class QWebEnginePageType : public Class
{
  public:
    ...
    QWebEnginePageType(Context* context, 
           const char* name,
           Class* superClass = 0,
           Class* superClass2 = 0);
...
class MuQt_QWebEnginePage : public QWebEnginePage
{
  ...
  public:
    bool acceptNavigationRequest_pub(const QUrl & url, QWebEnginePage::NavigationType type, bool isMainFrame)  { return acceptNavigationRequest(url, type, isMainFrame); }
    bool acceptNavigationRequest_pub_parent(const QUrl & url, QWebEnginePage::NavigationType type, bool isMainFrame)  { return QWebEnginePage::acceptNavigationRequest(url, type, isMainFrame); }
    QStringList chooseFiles_pub(QWebEnginePage::FileSelectionMode mode, const QStringList & oldFiles, const QStringList & acceptedMimeTypes)  { return chooseFiles(mode, oldFiles, acceptedMimeTypes); }
    QStringList chooseFiles_pub_parent(QWebEnginePage::FileSelectionMode mode, const QStringList & oldFiles, const QStringList & acceptedMimeTypes)  { return QWebEnginePage::chooseFiles(mode, oldFiles, acceptedMimeTypes); }
    ...
    void javaScriptAlert_pub_parent(const QUrl & securityOrigin, const QString & msg)  { QWebEnginePage::javaScriptAlert(securityOrigin, msg); }
    bool javaScriptConfirm_pub(const QUrl & securityOrigin, const QString & msg)  { return javaScriptConfirm(securityOrigin, msg); }
    bool javaScriptConfirm_pub_parent(const QUrl & securityOrigin, const QString & msg)  { return QWebEnginePage::javaScriptConfirm(securityOrigin, msg); }
    void javaScriptConsoleMessage_pub(QWebEnginePage::JavaScriptConsoleMessageLevel level, const QString & message, int lineNumber, const QString & sourceID)  { javaScriptConsoleMessage(level, message, lineNumber, sourceID); }
    void javaScriptConsoleMessage_pub_parent(QWebEnginePage::JavaScriptConsoleMessageLevel level, const QString & message, int lineNumber, const QString & sourceID)  { QWebEnginePage::javaScriptConsoleMessage(level, message, lineNumber, sourceID); }
