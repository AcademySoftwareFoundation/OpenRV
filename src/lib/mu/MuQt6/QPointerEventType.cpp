...
addSymbols(
    // enums
    // member functions
    // MISSING: addPassiveGrabber (bool; QPointerEvent this, "const QEventPoint &" point, QObject grabber)
    new Function(c, "allPointsAccepted", _n_allPointsAccepted0, None, Compiled, qt_QPointerEvent_allPointsAccepted_bool_QPointerEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QPointerEvent"), End),
    new Function(c, "allPointsGrabbed", _n_allPointsGrabbed0, None, Compiled, qt_QPointerEvent_allPointsGrabbed_bool_QPointerEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QPointerEvent"), End),
    // MISSING: clearPassiveGrabbers (void; QPointerEvent this, "const QEventPoint &" point)
    // MISSING: exclusiveGrabber (QObject; QPointerEvent this, "const QEventPoint &" point)
    // MISSING: passiveGrabbers ("QList<QPointer<QObject>>"; QPointerEvent this, "const QEventPoint &" point)
    // MISSING: point ("QEventPoint &"; QPointerEvent this, "qsizetype" i)
    // MISSING: pointById ("QEventPoint *"; QPointerEvent this, int id)
    // MISSING: pointCount ("qsizetype"; QPointerEvent this)
    new Function(c, "pointerType", _n_pointerType0, None, Compiled, qt_QPointerEvent_pointerType_int_QPointerEvent, Return, "int", Parameters, new Param(c, "this", "qt.QPointerEvent"), End),
    // MISSING: pointingDevice ("const QPointingDevice *"; QPointerEvent this)
    // MISSING: points ("const QList<QEventPoint> &"; QPointerEvent this)
    // MISSING: removePassiveGrabber (bool; QPointerEvent this, "const QEventPoint &" point, QObject grabber)
    // MISSING: setExclusiveGrabber (void; QPointerEvent this, "const QEventPoint &" point, QObject exclusiveGrabber)
    new MemberFunction(c, "setAccepted", _n_setAccepted0, None, Compiled, qt_QPointerEvent_setAccepted_void_QPointerEvent_bool, Return, "void", Parameters, new Param(c, "this", "qt.QPointerEvent"), new Param(c, "accepted", "bool"), End),
    // static functions
    EndArguments);
