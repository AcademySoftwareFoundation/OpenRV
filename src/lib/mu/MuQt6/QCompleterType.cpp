...
{
    if (!_env) return QCompleter::pathFromIndex(index);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QCompleter::splitPath(path);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QCompleter::event(ev);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QCompleter::eventFilter(o, e);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QCompleter::customEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QCompleter::timerEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QCompleter_QCompleter_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    {
        QCompleterType* type = 
            c->findSymbolOfTypeByQualifiedName<QCompleterType>(c->internName("qt.QCompleter"), false);
...
{
    NODE_RETURN( QCompleter_QCompleter_QObject(NODE_THREAD, NODE_ARG(0, Pointer)) );
}
...
Pointer qt_QCompleter_QCompleter_QCompleter_QCompleter_QAbstractItemModel_QObject(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_model, Pointer param_parent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QCompleter_QCompleter_QCompleter_QCompleter_stringBSB_ESB__QObject(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_list, Pointer param_parent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
bool qt_QCompleter_eventFilter_bool_QCompleter_QObject_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_o, Pointer param_e)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QCompleter* arg0 = object<QCompleter>(param_this);
    QObject * arg1 = object<QObject>(param_o);
    QEvent * arg2 = getqpointer<QEventType>(param_e);
    return isMuQtObject(arg0) ? ((MuQt_QCompleter*)arg0)->eventFilter_pub_parent(arg1, arg2) : ((MuQt_QCompleter*)arg0)->eventFilter_pub(arg1, arg2);
}
...
void qt_QCompleter_customEvent_void_QCompleter_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QCompleter*)arg0)->customEvent_pub_parent(arg1);
    else ((MuQt_QCompleter*)arg0)->customEvent_pub(arg1);
}
...
void qt_QCompleter_timerEvent_void_QCompleter_QTimerEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QCompleter*)arg0)->timerEvent_pub_parent(arg1);
    else ((MuQt_QCompleter*)arg0)->timerEvent_pub(arg1);
}
...
{
    NODE_RETURN(qt_QCompleter_QCompleter_QCompleter_QCompleter_QAbstractItemModel_QObject(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}

static NODE_IMPLEMENTATION(_n_QCompleter2, Pointer)
{
    NODE_RETURN(qt_QCompleter_QCompleter_QCompleter_QCompleter_stringBSB_ESB__QObject(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
{
    NODE_RETURN(qt_QCompleter_pathFromIndex_string_QCompleter_QModelIndex(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
{
    NODE_RETURN(qt_QCompleter_splitPath_stringBSB_ESB__QCompleter_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
{
    NODE_RETURN(qt_QCompleter_eventFilter_bool_QCompleter_QObject_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
QCompleterType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QCompleter_QCompleter_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QCompleter", _n_QCompleter0, None, Compiled, qt_QCompleter_QCompleter_QCompleter_QCompleter_QObject, Return, "qt.QCompleter", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "parent", "qt.QObject"), End),
    new Function(c, "QCompleter", _n_QCompleter1, None, Compiled, qt_QCompleter_QCompleter_QCompleter_QCompleter_QAbstractItemModel_QObject, Return, "qt.QCompleter", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "model", "qt.QAbstractItemModel"), new Param(c, "parent", "qt.QObject"), End),
    new Function(c, "QCompleter", _n_QCompleter2, None, Compiled, qt_QCompleter_QCompleter_QCompleter_QCompleter_stringBSB_ESB__QObject, Return, "qt.QCompleter", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "list", "string[]"), new Param(c, "parent", "qt.QObject"), End),
    // PROP: caseSensitivity (flags Qt::CaseSensitivity; QCompleter this)
    // PROP: completionColumn (int; QCompleter this)
    new Function(c, "completionCount", _n_completionCount0, None, Compiled, qt_QCompleter_completionCount_int_QCompleter, Return, "int", Parameters, new Param(c, "this", "qt.QCompleter"), End),
    // PROP: completionMode (flags QCompleter::CompletionMode; QCompleter this)
    new Function(c, "completionModel", _n_completionModel0, None, Compiled, qt_QCompleter_completionModel_QAbstractItemModel_QCompleter, Return, "qt.QAbstractItemModel", Parameters, new Param(c, "this", "qt.QCompleter"), End),
    // PROP: completionPrefix (string; QCompleter this)
    // PROP: completionRole (int; QCompleter this)
    new Function(c, "currentCompletion", _n_currentCompletion0, None, Compiled, qt_QCompleter_currentCompletion_string_QCompleter, Return, "string", Parameters, new Param(c, "this", "qt.QCompleter"), End),
    new Function(c, "currentIndex", _n_currentIndex0, None, Compiled, qt_QCompleter_currentIndex_QModelIndex_QCompleter, Return, "qt.QModelIndex", Parameters, new Param(c, "this", "qt.QCompleter"), End),
    new Function(c, "currentRow", _n_currentRow0, None, Compiled, qt_QCompleter_currentRow_int_QCompleter, Return, "int", Parameters, new Param(c, "this", "qt.QCompleter"), End),
    // PROP: filterMode (flags Qt::MatchFlags; QCompleter this)
    // PROP: maxVisibleItems (int; QCompleter this)
    new Function(c, "model", _n_model0, None, Compiled, qt_QCompleter_model_QAbstractItemModel_QCompleter, Return, "qt.QAbstractItemModel", Parameters, new Param(c, "this", "qt.QCompleter"), End),
    // PROP: modelSorting (flags QCompleter::ModelSorting; QCompleter this)
    _func[0] = new MemberFunction(c, "pathFromIndex", _n_pathFromIndex0, None, Compiled, qt_QCompleter_pathFromIndex_string_QCompleter_QModelIndex, Return, "string", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "index", "qt.QModelIndex"), End),
    new Function(c, "popup", _n_popup0, None, Compiled, qt_QCompleter_popup_QAbstractItemView_QCompleter, Return, "qt.QAbstractItemView", Parameters, new Param(c, "this", "qt.QCompleter"), End),
    // PROP: setCaseSensitivity (void; QCompleter this, flags Qt::CaseSensitivity caseSensitivity)
    // PROP: setCompletionColumn (void; QCompleter this, int column)
    // PROP: setCompletionMode (void; QCompleter this, flags QCompleter::CompletionMode mode)
    // PROP: setCompletionRole (void; QCompleter this, int role)
    new Function(c, "setCurrentRow", _n_setCurrentRow0, None, Compiled, qt_QCompleter_setCurrentRow_bool_QCompleter_int, Return, "bool", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "row", "int"), End),
    // PROP: setFilterMode (void; QCompleter this, flags Qt::MatchFlags filterMode)
    // PROP: setMaxVisibleItems (void; QCompleter this, int maxItems)
    new Function(c, "setModel", _n_setModel0, None, Compiled, qt_QCompleter_setModel_void_QCompleter_QAbstractItemModel, Return, "void", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "model", "qt.QAbstractItemModel"), End),
    // PROP: setModelSorting (void; QCompleter this, flags QCompleter::ModelSorting sorting)
    new Function(c, "setPopup", _n_setPopup0, None, Compiled, qt_QCompleter_setPopup_void_QCompleter_QAbstractItemView, Return, "void", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "popup", "qt.QAbstractItemView"), End),
    new Function(c, "setWidget", _n_setWidget0, None, Compiled, qt_QCompleter_setWidget_void_QCompleter_QWidget, Return, "void", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "widget", "qt.QWidget"), End),
    _func[1] = new MemberFunction(c, "splitPath", _n_splitPath0, None, Compiled, qt_QCompleter_splitPath_stringBSB_ESB__QCompleter_string, Return, "string[]", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "path", "string"), End),
    new Function(c, "widget", _n_widget0, None, Compiled, qt_QCompleter_widget_QWidget_QCompleter, Return, "qt.QWidget", Parameters, new Param(c, "this", "qt.QCompleter"), End),
    // PROP: wrapAround (bool; QCompleter this)
    _func[2] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QCompleter_event_bool_QCompleter_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "ev", "qt.QEvent"), End),
    _func[3] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled, qt_QCompleter_eventFilter_bool_QCompleter_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "o", "qt.QObject"), new Param(c, "e", "qt.QEvent"), End),
    // MISSING: metaObject ("const QMetaObject *"; QCompleter this)
    // MISSING: childEvent (void; QCompleter this, "QChildEvent *" event) // protected
    // MISSING: connectNotify (void; QCompleter this, "const QMetaMethod &" signal) // protected
    _func[4] = new MemberFunction(c, "customEvent", _n_customEvent0, None, Compiled, qt_QCompleter_customEvent_void_QCompleter_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: disconnectNotify (void; QCompleter this, "const QMetaMethod &" signal) // protected
    _func[5] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QCompleter_timerEvent_void_QCompleter_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QCompleter"), new Param(c, "event", "qt.QTimerEvent"), End),
    // static functions
    EndArguments);
