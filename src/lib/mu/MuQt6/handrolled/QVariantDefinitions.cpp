...
Pointer qt_QVariant_QVariant_QVariant_QVariant_QIcon(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_val)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
{
    NODE_RETURN(qt_QVariant_QVariant_QVariant_QVariant_QIcon(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
