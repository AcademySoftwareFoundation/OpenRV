...
static Pointer
QImage_QImage_QImage_QImage_string_string(Thread& NODE_THREAD, Pointer param_this, Pointer param_fileName, Pointer param_format)
{
...
{
    return QImage_QImage_QImage_QImage_string_string(NODE_THREAD,
                                                     NODE_ARG(0, Pointer),
                                                     NODE_ARG(1, Pointer),
                                                     NODE_ARG(2, Pointer));
}
