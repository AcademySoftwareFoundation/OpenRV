...
addSymbols(
    ...
    new Function(c, "QBrush", _n_QBrush8, None, Compiled, qt_QBrush_QBrush_QBrush_QBrush_QGradient, Return, "qt.QBrush", Parameters, new Param(c, "this", "qt.QBrush"), new Param(c, "gradient", "qt.QGradient"), End),
