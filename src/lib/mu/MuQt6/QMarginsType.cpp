...
QMarginsType::Instance::Instance(const Class* c) : ClassInstance(c)
{
}
...
void 
QMarginsType::registerFinalizer (void* o)
{
    GC_register_finalizer(o, QMarginsType::finalizer, 0, 0, 0);
}

void 
QMarginsType::finalizer (void* obj, void* data)
{
...
Pointer qt_QMargins_QMargins_QMargins_QMargins_int_int_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_left, int param_top, int param_right, int param_bottom)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
{
    NODE_RETURN(qt_QMargins_QMargins_QMargins_QMargins_int_int_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int), NODE_ARG(3, int), NODE_ARG(4, int)));
}

static NODE_IMPLEMENTATION(_n_bottom0, int)
{
    NODE_RETURN(qt_QMargins_bottom_int_QMargins(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QMargins_left_int_QMargins(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_right0, int)
{
    NODE_RETURN(qt_QMargins_right_int_QMargins(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QMargins_top_int_QMargins(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QMargins", _n_QMargins0, None, Compiled, qt_QMargins_QMargins_QMargins_QMargins, Return, "qt.QMargins", Parameters, new Param(c, "this", "qt.QMargins"), End),
    new Function(c, "QMargins", _n_QMargins1, None, Compiled, qt_QMargins_QMargins_QMargins_QMargins_int_int_int_int, Return, "qt.QMargins", Parameters, new Param(c, "this", "qt.QMargins"), new Param(c, "left", "int"), new Param(c, "top", "int"), new Param(c, "right", "int"), new Param(c, "bottom", "int"), End),
    new Function(c, "bottom", _n_bottom0, None, Compiled, qt_QMargins_bottom_int_QMargins, Return, "int", Parameters, new Param(c, "this", "qt.QMargins"), End),
    new Function(c, "isNull", _n_isNull0, None, Compiled, qt_QMargins_isNull_bool_QMargins, Return, "bool", Parameters, new Param(c, "this", "qt.QMargins"), End),
    new Function(c, "left", _n_left0, None, Compiled, qt_QMargins_left_int_QMargins, Return, "int", Parameters, new Param(c, "this", "qt.QMargins"), End),
    new Function(c, "right", _n_right0, None, Compiled, qt_QMargins_right_int_QMargins, Return, "int", Parameters, new Param(c, "this", "qt.QMargins"), End),
    new Function(c, "setBottom", _n_setBottom0, None, Compiled, qt_QMargins_setBottom_void_QMargins_int, Return, "void", Parameters, new Param(c, "this", "qt.QMargins"), new Param(c, "bottom", "int"), End),
    new Function(c, "setLeft", _n_setLeft0, None, Compiled, qt_QMargins_setLeft_void_QMargins_int, Return, "void", Parameters, new Param(c, "this", "qt.QMargins"), new Param(c, "left", "int"), End),
    new Function(c, "setRight", _n_setRight0, None, Compiled, qt_QMargins_setRight_void_QMargins_int, Return, "void", Parameters, new Param(c, "this", "qt.QMargins"), new Param(c, "right", "int"), End),
    new Function(c, "setTop", _n_setTop0, None, Compiled, qt_QMargins_setTop_void_QMargins_int, Return, "void", Parameters, new Param(c, "this", "qt.QMargins"), new Param(c, "Top", "int"), End),
    // MISSING: toMarginsF ("QMarginsF"; QMargins this)
    new Function(c, "top", _n_top0, None, Compiled, qt_QMargins_top_int_QMargins, Return, "int", Parameters, new Param(c, "this", "qt.QMargins"), End),
