...
addSymbols(
    ...
    new Function(c, "doubleStep", _n_doubleStep0, None, Compiled, qt_QInputDialog_doubleStep_double_QInputDialog, Return, "double", Parameters, new Param(c, "this", "qt.QInputDialog"), End),
    ...
    new Function(c, "setDoubleStep", _n_setDoubleStep0, None, Compiled, qt_QInputDialog_setDoubleStep_void_QInputDialog_double, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "step", "double"), End),
    ...
    _func[6] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled, qt_QInputDialog_eventFilter_bool_QInputDialog_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "o", "qt.QObject"), new Param(c, "e", "qt.QEvent"), End),
    _func[7] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QInputDialog_keyPressEvent_void_QInputDialog_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "e", "qt.QKeyEvent"), End),
    _func[8] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QInputDialog_resizeEvent_void_QInputDialog_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "_p15", "qt.QResizeEvent"), End),
    _func[9] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QInputDialog_showEvent_void_QInputDialog_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "event", "qt.QShowEvent"), End),
    // static functions
    // MISSING: getDouble (double; QWidget parent, string title, string label, double value, double min, double max, int decimals, "bool *" ok, flags Qt::WindowFlags flags, double step)
