...
QImageType::Instance::Instance(const Class* c) : ClassInstance(c)
{
}
...
void 
QImageType::registerFinalizer (void* o)
{
    GC_register_finalizer(o, QImageType::finalizer, 0, 0, 0);
}

void 
QImageType::finalizer (void* obj, void* data)
{
...
Pointer qt_QImage_QImage_QImage_QImage_int_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_width, int param_height, int param_format)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QImage_copy_QImage_QImage_int_int_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_x, int param_y, int param_width, int param_height)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QImage& arg0 = getqtype<QImageType>(param_this);
...
Pointer qt_QImage_createMaskFromColor_QImage_QImage_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_color, int param_mode)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QImage& arg0 = getqtype<QImageType>(param_this);
...
Pointer qt_QImage_mirrored_QImage_QImage_bool_bool(Mu::Thread& NODE_THREAD, Pointer param_this, bool param_horizontal, bool param_vertical)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QImage& arg0 = getqtype<QImageType>(param_this);
    bool arg1 = (bool)(param_horizontal);
...
Pointer qt_QImage_scaled_QImage_QImage_QSize_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_size, int param_aspectRatioMode, int param_transformMode)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QImage& arg0 = getqtype<QImageType>(param_this);
    const QSize  arg1 = getqtype<QSizeType>(param_size);
...
Pointer qt_QImage_scaled_QImage_QImage_int_int_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_width, int param_height, int param_aspectRatioMode, int param_transformMode)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QImage& arg0 = getqtype<QImageType>(param_this);
    int arg1 = (int)(param_width);
...
void qt_QImage_setPixel_void_QImage_QPoint_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_position, int param_index_or_rgb)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QImage& arg0 = getqtype<QImageType>(param_this);
    const QPoint  arg1 = getqtype<QPointType>(param_position);
...
void qt_QImage_setPixel_void_QImage_int_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_x, int param_y, int param_index_or_rgb)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QImage& arg0 = getqtype<QImageType>(param_this);
    int arg1 = (int)(param_x);
...
void qt_QImage_setPixelColor_void_QImage_QPoint_QColor(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_position, Pointer param_color)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QImage& arg0 = getqtype<QImageType>(param_this);
    const QPoint  arg1 = getqtype<QPointType>(param_position);
...
void qt_QImage_setPixelColor_void_QImage_int_int_QColor(Mu::Thread& NODE_THREAD, Pointer param_this, int param_x, int param_y, Pointer param_color)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QImage& arg0 = getqtype<QImageType>(param_this);
    int arg1 = (int)(param_x);
...
Pointer qt_QImage_transformed_QImage_QImage_QTransform_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_matrix, int param_mode)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QImage& arg0 = getqtype<QImageType>(param_this);
...
Pointer qt_QImage_trueMatrix_QTransform_QTransform_int_int(Mu::Thread& NODE_THREAD, Pointer param_matrix, int param_width, int param_height)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
{
    NODE_RETURN(qt_QImage_QImage_QImage_QImage_QSize_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int)));
}

static NODE_IMPLEMENTATION(_n_QImage2, Pointer)
{
    NODE_RETURN(qt_QImage_QImage_QImage_QImage_int_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int), NODE_ARG(3, int)));
}

static NODE_IMPLEMENTATION(_n_allGray0, bool)
{
    NODE_RETURN(qt_QImage_allGray_bool_QImage(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QImage_convertToFormat_QImage_QImage_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
}

static NODE_IMPLEMENTATION(_n_convertedTo0, Pointer)
{
    NODE_RETURN(qt_QImage_convertedTo_QImage_QImage_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
}
...
{
    NODE_RETURN(qt_QImage_copy_QImage_QImage_int_int_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int), NODE_ARG(3, int), NODE_ARG(4, int)));
}
...
{
    NODE_RETURN(qt_QImage_createMaskFromColor_QImage_QImage_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
}

static NODE_IMPLEMENTATION(_n_depth0, int)
{
    NODE_RETURN(qt_QImage_depth_int_QImage(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QImage_format_int_QImage(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QImage_height_int_QImage(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QImage_isNull_bool_QImage(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QImage_mirrored_QImage_QImage_bool_bool(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, bool), NODE_ARG(2, bool)));
}
...
{
    NODE_RETURN(qt_QImage_pixelColor_QColor_QImage_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
}
...
{
    NODE_RETURN(qt_QImage_rect_QRect_QImage(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QImage_scaled_QImage_QImage_QSize_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, int)));
}

static NODE_IMPLEMENTATION(_n_scaled1, Pointer)
{
    NODE_RETURN(qt_QImage_scaled_QImage_QImage_int_int_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int), NODE_ARG(3, int), NODE_ARG(4, int)));
}

static NODE_IMPLEMENTATION(_n_scaledToHeight0, Pointer)
{
    NODE_RETURN(qt_QImage_scaledToHeight_QImage_QImage_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
}

static NODE_IMPLEMENTATION(_n_scaledToWidth0, Pointer)
{
    NODE_RETURN(qt_QImage_scaledToWidth_QImage_QImage_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
}
...
{
    qt_QImage_setPixel_void_QImage_int_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int), NODE_ARG(3, int));
}

static NODE_IMPLEMENTATION(_n_setPixelColor0, void)
{
    qt_QImage_setPixelColor_void_QImage_QPoint_QColor(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer));
}

static NODE_IMPLEMENTATION(_n_setPixelColor1, void)
{
    qt_QImage_setPixelColor_void_QImage_int_int_QColor(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int), NODE_ARG(3, Pointer));
}
...
{
    NODE_RETURN(qt_QImage_size_QSize_QImage(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QImage_transformed_QImage_QImage_QTransform_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int)));
}
...
{
    NODE_RETURN(qt_QImage_width_int_QImage(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QImage_trueMatrix_QTransform_QTransform_int_int(NODE_THREAD, NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
}
...
addSymbols(
    new Alias(c, "Format", "int"),
      new SymbolicConstant(c, "Format_Invalid", "int", Value(int(QImage::Format_Invalid))),
    ...
    new Alias(c, "InvertMode", "int"),
      new SymbolicConstant(c, "InvertRgb", "int", Value(int(QImage::InvertRgb))),
      new SymbolicConstant(c, "InvertRgba", "int", Value(int(QImage::InvertRgba))),
    EndArguments);

addSymbols(
    // enums
    // member functions
    new Function(c, "QImage", _n_QImage0, None, Compiled, qt_QImage_QImage_QImage_QImage, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), End),
    new Function(c, "QImage", _n_QImage1, None, Compiled, qt_QImage_QImage_QImage_QImage_QSize_int, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "size", "qt.QSize"), new Param(c, "format", "int"), End),
    new Function(c, "QImage", _n_QImage2, None, Compiled, qt_QImage_QImage_QImage_QImage_int_int_int, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "width", "int"), new Param(c, "height", "int"), new Param(c, "format", "int"), End),
    // MISSING: QImage (QImage; QImage this, "uchar *" data, int width, int height, flags QImage::Format format, "QImageCleanupFunction" cleanupFunction, "void *" cleanupInfo)
    // MISSING: QImage (QImage; QImage this, "const uchar *" data, int width, int height, flags QImage::Format format, "QImageCleanupFunction" cleanupFunction, "void *" cleanupInfo)
    // MISSING: QImage (QImage; QImage this, "uchar *" data, int width, int height, "qsizetype" bytesPerLine, flags QImage::Format format, "QImageCleanupFunction" cleanupFunction, "void *" cleanupInfo)
    // MISSING: QImage (QImage; QImage this, "const uchar *" data, int width, int height, "qsizetype" bytesPerLine, flags QImage::Format format, "QImageCleanupFunction" cleanupFunction, "void *" cleanupInfo)
    ...
    // MISSING: QImage (QImage; QImage this, QImage image)
    // MISSING: QImage (QImage; QImage this, "QImage & &" other)
    new Function(c, "allGray", _n_allGray0, None, Compiled, qt_QImage_allGray_bool_QImage, Return, "bool", Parameters, new Param(c, "this", "qt.QImage"), End),
    // MISSING: applyColorTransform (void; QImage this, "const QColorTransform &" transform)
    new Function(c, "bitPlaneCount", _n_bitPlaneCount0, None, Compiled, qt_QImage_bitPlaneCount_int_QImage, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), End),
    // MISSING: bits ("uchar *"; QImage this)
    // MISSING: bits ("const uchar *"; QImage this)
    // MISSING: bytesPerLine ("qsizetype"; QImage this)
    new Function(c, "cacheKey", _n_cacheKey0, None, Compiled, qt_QImage_cacheKey_int64_QImage, Return, "int64", Parameters, new Param(c, "this", "qt.QImage"), End),
    new Function(c, "color", _n_color0, None, Compiled, qt_QImage_color_int_QImage_int, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "i", "int"), End),
    new Function(c, "colorCount", _n_colorCount0, None, Compiled, qt_QImage_colorCount_int_QImage, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), End),
    // MISSING: colorSpace ("QColorSpace"; QImage this)
    // MISSING: colorTable ("QList<QRgb>"; QImage this)
    // MISSING: colorTransformed (QImage; QImage this, "const QColorTransform &" transform)
    // MISSING: colorTransformed (QImage; QImage this, "const QColorTransform &" transform)
    // MISSING: constBits ("const uchar *"; QImage this)
    // MISSING: constScanLine ("const uchar *"; QImage this, int i)
    new Function(c, "convertTo", _n_convertTo0, None, Compiled, qt_QImage_convertTo_void_QImage_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "format", "int"), new Param(c, "flags", "int", Value((int)Qt::AutoColor)), End),
    // MISSING: convertToColorSpace (void; QImage this, "const QColorSpace &" colorSpace)
    new Function(c, "convertToFormat", _n_convertToFormat0, None, Compiled, qt_QImage_convertToFormat_QImage_QImage_int_int, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "format", "int"), new Param(c, "flags", "int", Value((int)Qt::AutoColor)), End),
    // MISSING: convertToFormat (QImage; QImage this, flags QImage::Format format, flags Qt::ImageConversionFlags flags)
    // MISSING: convertToFormat (QImage; QImage this, flags QImage::Format format, "const QList<QRgb> &" colorTable, flags Qt::ImageConversionFlags flags)
    new Function(c, "convertedTo", _n_convertedTo0, None, Compiled, qt_QImage_convertedTo_QImage_QImage_int_int, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "format", "int"), new Param(c, "flags", "int", Value((int)Qt::AutoColor)), End),
    // MISSING: convertedTo (QImage; QImage this, flags QImage::Format format, flags Qt::ImageConversionFlags flags)
    // MISSING: convertedToColorSpace (QImage; QImage this, "const QColorSpace &" colorSpace)
    new Function(c, "copy", _n_copy0, None, Compiled, qt_QImage_copy_QImage_QImage_QRect, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "rectangle", "qt.QRect"), End),
    new Function(c, "copy", _n_copy1, None, Compiled, qt_QImage_copy_QImage_QImage_int_int_int_int, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "x", "int"), new Param(c, "y", "int"), new Param(c, "width", "int"), new Param(c, "height", "int"), End),
    new Function(c, "createAlphaMask", _n_createAlphaMask0, None, Compiled, qt_QImage_createAlphaMask_QImage_QImage_int, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "flags", "int", Value((int)Qt::AutoColor)), End),
    new Function(c, "createHeuristicMask", _n_createHeuristicMask0, None, Compiled, qt_QImage_createHeuristicMask_QImage_QImage_bool, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "clipTight", "bool"), End),
    new Function(c, "createMaskFromColor", _n_createMaskFromColor0, None, Compiled, qt_QImage_createMaskFromColor_QImage_QImage_int_int, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "color", "int"), new Param(c, "mode", "int", Value((int)Qt::MaskInColor)), End),
    new Function(c, "depth", _n_depth0, None, Compiled, qt_QImage_depth_int_QImage, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), End),
    // MISSING: deviceIndependentSize ("QSizeF"; QImage this)
    new Function(c, "devicePixelRatio", _n_devicePixelRatio0, None, Compiled, qt_QImage_devicePixelRatio_double_QImage, Return, "double", Parameters, new Param(c, "this", "qt.QImage"), End),
    new Function(c, "dotsPerMeterX", _n_dotsPerMeterX0, None, Compiled, qt_QImage_dotsPerMeterX_int_QImage, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), End),
    new Function(c, "dotsPerMeterY", _n_dotsPerMeterY0, None, Compiled, qt_QImage_dotsPerMeterY_int_QImage, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), End),
    new Function(c, "fill", _n_fill0, None, Compiled, qt_QImage_fill_void_QImage_int, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "pixelValue", "int"), End),
    new Function(c, "fill", _n_fill1, None, Compiled, qt_QImage_fill_void_QImage_QColor, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "color", "qt.QColor"), End),
    // MISSING: fill (void; QImage this, flags Qt::GlobalColor color)
    new Function(c, "format", _n_format0, None, Compiled, qt_QImage_format_int_QImage, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), End),
    new Function(c, "hasAlphaChannel", _n_hasAlphaChannel0, None, Compiled, qt_QImage_hasAlphaChannel_bool_QImage, Return, "bool", Parameters, new Param(c, "this", "qt.QImage"), End),
    new Function(c, "height", _n_height0, None, Compiled, qt_QImage_height_int_QImage, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), End),
    new Function(c, "invertPixels", _n_invertPixels0, None, Compiled, qt_QImage_invertPixels_void_QImage_int, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "mode", "int", Value((int)QImage::InvertRgb)), End),
    new Function(c, "isGrayscale", _n_isGrayscale0, None, Compiled, qt_QImage_isGrayscale_bool_QImage, Return, "bool", Parameters, new Param(c, "this", "qt.QImage"), End),
    new Function(c, "isNull", _n_isNull0, None, Compiled, qt_QImage_isNull_bool_QImage, Return, "bool", Parameters, new Param(c, "this", "qt.QImage"), End),
    // MISSING: load (bool; QImage this, string fileName, "const char *" format)
    // MISSING: load (bool; QImage this, QIODevice device, "const char *" format)
    // MISSING: loadFromData (bool; QImage this, "QByteArrayView" data, "const char *" format)
    // MISSING: loadFromData (bool; QImage this, "const uchar *" data, int len, "const char *" format)
    // MISSING: loadFromData (bool; QImage this, QByteArray data, "const char *" format)
    new Function(c, "mirror", _n_mirror0, None, Compiled, qt_QImage_mirror_void_QImage_bool_bool, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "horizontal", "bool"), new Param(c, "vertical", "bool"), End),
    new Function(c, "mirrored", _n_mirrored0, None, Compiled, qt_QImage_mirrored_QImage_QImage_bool_bool, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "horizontal", "bool"), new Param(c, "vertical", "bool"), End),
    // MISSING: mirrored (QImage; QImage this, bool horizontal, bool vertical)
    new Function(c, "offset", _n_offset0, None, Compiled, qt_QImage_offset_QPoint_QImage, Return, "qt.QPoint", Parameters, new Param(c, "this", "qt.QImage"), End),
    new Function(c, "pixel", _n_pixel0, None, Compiled, qt_QImage_pixel_int_QImage_QPoint, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "position", "qt.QPoint"), End),
    new Function(c, "pixel", _n_pixel1, None, Compiled, qt_QImage_pixel_int_QImage_int_int, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "x", "int"), new Param(c, "y", "int"), End),
    new Function(c, "pixelColor", _n_pixelColor0, None, Compiled, qt_QImage_pixelColor_QColor_QImage_QPoint, Return, "qt.QColor", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "position", "qt.QPoint"), End),
    new Function(c, "pixelColor", _n_pixelColor1, None, Compiled, qt_QImage_pixelColor_QColor_QImage_int_int, Return, "qt.QColor", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "x", "int"), new Param(c, "y", "int"), End),
    // MISSING: pixelFormat ("QPixelFormat"; QImage this)
    new Function(c, "pixelIndex", _n_pixelIndex0, None, Compiled, qt_QImage_pixelIndex_int_QImage_QPoint, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "position", "qt.QPoint"), End),
    new Function(c, "pixelIndex", _n_pixelIndex1, None, Compiled, qt_QImage_pixelIndex_int_QImage_int_int, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "x", "int"), new Param(c, "y", "int"), End),
    new Function(c, "rect", _n_rect0, None, Compiled, qt_QImage_rect_QRect_QImage, Return, "qt.QRect", Parameters, new Param(c, "this", "qt.QImage"), End),
    new Function(c, "reinterpretAsFormat", _n_reinterpretAsFormat0, None, Compiled, qt_QImage_reinterpretAsFormat_bool_QImage_int, Return, "bool", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "format", "int"), End),
    new Function(c, "rgbSwap", _n_rgbSwap0, None, Compiled, qt_QImage_rgbSwap_void_QImage, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), End),
    new Function(c, "rgbSwapped", _n_rgbSwapped0, None, Compiled, qt_QImage_rgbSwapped_QImage_QImage, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), End),
    // MISSING: rgbSwapped (QImage; QImage this)
    // MISSING: save (bool; QImage this, string fileName, "const char *" format, int quality)
    // MISSING: save (bool; QImage this, QIODevice device, "const char *" format, int quality)
    new Function(c, "scaled", _n_scaled0, None, Compiled, qt_QImage_scaled_QImage_QImage_QSize_int_int, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "size", "qt.QSize"), new Param(c, "aspectRatioMode", "int", Value((int)Qt::IgnoreAspectRatio)), new Param(c, "transformMode", "int", Value((int)Qt::FastTransformation)), End),
    new Function(c, "scaled", _n_scaled1, None, Compiled, qt_QImage_scaled_QImage_QImage_int_int_int_int, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "width", "int"), new Param(c, "height", "int"), new Param(c, "aspectRatioMode", "int", Value((int)Qt::IgnoreAspectRatio)), new Param(c, "transformMode", "int", Value((int)Qt::FastTransformation)), End),
    new Function(c, "scaledToHeight", _n_scaledToHeight0, None, Compiled, qt_QImage_scaledToHeight_QImage_QImage_int_int, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "height", "int"), new Param(c, "mode", "int", Value((int)Qt::FastTransformation)), End),
    new Function(c, "scaledToWidth", _n_scaledToWidth0, None, Compiled, qt_QImage_scaledToWidth_QImage_QImage_int_int, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "width", "int"), new Param(c, "mode", "int", Value((int)Qt::FastTransformation)), End),
    // MISSING: scanLine ("uchar *"; QImage this, int i)
    // MISSING: scanLine ("const uchar *"; QImage this, int i)
    new Function(c, "setAlphaChannel", _n_setAlphaChannel0, None, Compiled, qt_QImage_setAlphaChannel_void_QImage_QImage, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "alphaChannel", "qt.QImage"), End),
    new Function(c, "setColor", _n_setColor0, None, Compiled, qt_QImage_setColor_void_QImage_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "index", "int"), new Param(c, "colorValue", "int"), End),
    new Function(c, "setColorCount", _n_setColorCount0, None, Compiled, qt_QImage_setColorCount_void_QImage_int, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "colorCount", "int"), End),
    // MISSING: setColorSpace (void; QImage this, "const QColorSpace &" colorSpace)
    // MISSING: setColorTable (void; QImage this, "const QList<QRgb> &" colors)
    new Function(c, "setDevicePixelRatio", _n_setDevicePixelRatio0, None, Compiled, qt_QImage_setDevicePixelRatio_void_QImage_double, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "scaleFactor", "double"), End),
    new Function(c, "setDotsPerMeterX", _n_setDotsPerMeterX0, None, Compiled, qt_QImage_setDotsPerMeterX_void_QImage_int, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "x", "int"), End),
    new Function(c, "setDotsPerMeterY", _n_setDotsPerMeterY0, None, Compiled, qt_QImage_setDotsPerMeterY_void_QImage_int, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "y", "int"), End),
    new Function(c, "setOffset", _n_setOffset0, None, Compiled, qt_QImage_setOffset_void_QImage_QPoint, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "offset", "qt.QPoint"), End),
    new Function(c, "setPixel", _n_setPixel0, None, Compiled, qt_QImage_setPixel_void_QImage_QPoint_int, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "position", "qt.QPoint"), new Param(c, "index_or_rgb", "int"), End),
    new Function(c, "setPixel", _n_setPixel1, None, Compiled, qt_QImage_setPixel_void_QImage_int_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "x", "int"), new Param(c, "y", "int"), new Param(c, "index_or_rgb", "int"), End),
    new Function(c, "setPixelColor", _n_setPixelColor0, None, Compiled, qt_QImage_setPixelColor_void_QImage_QPoint_QColor, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "position", "qt.QPoint"), new Param(c, "color", "qt.QColor"), End),
    new Function(c, "setPixelColor", _n_setPixelColor1, None, Compiled, qt_QImage_setPixelColor_void_QImage_int_int_QColor, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "x", "int"), new Param(c, "y", "int"), new Param(c, "color", "qt.QColor"), End),
    new Function(c, "setText", _n_setText0, None, Compiled, qt_QImage_setText_void_QImage_string_string, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "key", "string"), new Param(c, "text", "string"), End),
    new Function(c, "size", _n_size0, None, Compiled, qt_QImage_size_QSize_QImage, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QImage"), End),
    // MISSING: sizeInBytes ("qsizetype"; QImage this)
    new Function(c, "swap", _n_swap0, None, Compiled, qt_QImage_swap_void_QImage_QImage, Return, "void", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "other", "qt.QImage"), End),
    new Function(c, "text", _n_text0, None, Compiled, qt_QImage_text_string_QImage_string, Return, "string", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "key", "string"), End),
    new Function(c, "textKeys", _n_textKeys0, None, Compiled, qt_QImage_textKeys_stringBSB_ESB__QImage, Return, "string[]", Parameters, new Param(c, "this", "qt.QImage"), End),
    ...
    new Function(c, "transformed", _n_transformed0, None, Compiled, qt_QImage_transformed_QImage_QImage_QTransform_int, Return, "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "matrix", "qt.QTransform"), new Param(c, "mode", "int", Value((int)Qt::FastTransformation)), End),
    new Function(c, "valid", _n_valid0, None, Compiled, qt_QImage_valid_bool_QImage_QPoint, Return, "bool", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "pos", "qt.QPoint"), End),
    new Function(c, "valid", _n_valid1, None, Compiled, qt_QImage_valid_bool_QImage_int_int, Return, "bool", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "x", "int"), new Param(c, "y", "int"), End),
    new Function(c, "width", _n_width0, None, Compiled, qt_QImage_width_int_QImage, Return, "int", Parameters, new Param(c, "this", "qt.QImage"), End),
    // MISSING: QVariant ("QVariant operator"; QImage this)
    // static functions
    // MISSING: fromData (QImage; "QByteArrayView" data, "const char *" format)
    // MISSING: fromData (QImage; "const uchar *" data, int size, "const char *" format)
    // MISSING: fromData (QImage; QByteArray data, "const char *" format)
    // MISSING: fromHBITMAP (QImage; "HBITMAP" hbitmap)
    // MISSING: fromHICON (QImage; "HICON" icon)
    // MISSING: toImageFormat (flags QImage::Format; "QPixelFormat" format)
    // MISSING: toPixelFormat ("QPixelFormat"; flags QImage::Format format)
    new Function(c, "trueMatrix", _n_trueMatrix0, None, Compiled, qt_QImage_trueMatrix_QTransform_QTransform_int_int, Return, "qt.QTransform", Parameters, new Param(c, "matrix", "qt.QTransform"), new Param(c, "width", "int"), new Param(c, "height", "int"), End),
    EndArguments);
globalScope()->addSymbols(
    new Function(c, "!=", _n_operatorBang_EQ_0, Op, Compiled, qt_QImage_operatorBang_EQ__bool_QImage_QImage, Return, "bool", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "image", "qt.QImage"), End),
    // MISSING: = (QImage; QImage this, QImage image)
    // MISSING: = (QImage; QImage this, "QImage & &" other)
    new Function(c, "==", _n_operatorEQ_EQ_0, Op, Compiled, qt_QImage_operatorEQ_EQ__bool_QImage_QImage, Return, "bool", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "image", "qt.QImage"), End),
    EndArguments);
scope()->addSymbols(
    EndArguments);
