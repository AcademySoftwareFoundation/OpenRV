...
addSymbols(
    ...
    // PROP: exclusionPolicy (flags QActionGroup::ExclusionPolicy; QActionGroup this)
    // PROP: isEnabled (bool; QActionGroup this)
    new Function(c, "isExclusive", _n_isExclusive0, None, Compiled, qt_QActionGroup_isExclusive_bool_QActionGroup, Return, "bool", Parameters, new Param(c, "this", "qt.QActionGroup"), End),
