...
addSymbols(
    // enums
    // member functions
    // MISSING: QKeyEvent (QKeyEvent; QKeyEvent this, flags QEvent::Type type, int key, flags Qt::KeyboardModifiers modifiers, string text, bool autorep, "quint16" count)
    // MISSING: QKeyEvent (QKeyEvent; QKeyEvent this, flags QEvent::Type type, int key, flags Qt::KeyboardModifiers modifiers, int nativeScanCode, int nativeVirtualKey, int nativeModifiers, string text, bool autorep, "quint16" count, "const QInputDevice *" device)
