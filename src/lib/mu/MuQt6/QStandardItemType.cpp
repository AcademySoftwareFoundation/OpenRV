...
namespace Mu
{
    ...
    void qt_QStandardItem_clearData_void_QStandardItem(Mu::Thread& NODE_THREAD,
                                                       Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QStandardItem* arg0 = getqpointer<QStandardItemType>(param_this);
    ...
    {
        qt_QStandardItem_clearData_void_QStandardItem(
            NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
    }
    ...
    void QStandardItemType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "clearData", _n_clearData0, None, Compiled,
                         qt_QStandardItem_clearData_void_QStandardItem, Return,
                         "void", Parameters,
                         new Param(c, "this", "qt.QStandardItem"), End),
            new MemberFunction(
