...
Pointer qt_QDragMoveEvent_QDragMoveEvent_QDragMoveEvent_QDragMoveEvent_QPoint_int_QMimeData_int_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_pos, int param_actions, Pointer param_data, int param_buttons, int param_modifiers, int param_type)
{
    ...
    setqpointer<QDragMoveEventType>(param_this,new QDragMoveEvent(arg1, arg2, arg3, arg4, arg5, arg6));
    return param_this;
}
...
static NODE_IMPLEMENTATION(_n_QDragMoveEvent0, Pointer)
{
    NODE_RETURN(qt_QDragMoveEvent_QDragMoveEvent_QDragMoveEvent_QDragMoveEvent_QPoint_int_QMimeData_int_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, Pointer), NODE_ARG(4, int), NODE_ARG(5, int), NODE_ARG(6, int)));
}
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QDragMoveEvent", _n_QDragMoveEvent0, None, Compiled, qt_QDragMoveEvent_QDragMoveEvent_QDragMoveEvent_QDragMoveEvent_QPoint_int_QMimeData_int_int_int, Return, "qt.QDragMoveEvent", Parameters, new Param(c, "this", "qt.QDragMoveEvent"), new Param(c, "pos", "qt.QPoint"), new Param(c, "actions", "int"), new Param(c, "data", "qt.QMimeData"), new Param(c, "buttons", "int"), new Param(c, "modifiers", "int"), new Param(c, "type", "int", Value((int)QEvent::DragMove)), End),
