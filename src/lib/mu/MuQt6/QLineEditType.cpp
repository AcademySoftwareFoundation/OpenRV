...
void MuQt_QLineEdit::timerEvent(QTimerEvent * e) 
{
    if (!_env) { QLineEdit::timerEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
void MuQt_QLineEdit::keyReleaseEvent(QKeyEvent * e) 
{
    if (!_env) { QLineEdit::keyReleaseEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QLineEdit::paintEvent(_p14); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QLineEdit::hasHeightForWidth();
    MuLangContext* c = (MuLangContext*)_env->context();
...
int MuQt_QLineEdit::metric(QPaintDevice::PaintDeviceMetric m) const
{
...
void qt_QLineEdit_addAction_void_QLineEdit_QAction_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_action, int param_position)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QLineEdit_addAction_QAction_QLineEdit_QIcon_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_icon, int param_position)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QLineEdit* arg0 = object<QLineEdit>(param_this);
...
int qt_QLineEdit_selectionEnd_int_QLineEdit(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QLineEdit* arg0 = object<QLineEdit>(param_this);
...
int qt_QLineEdit_selectionLength_int_QLineEdit(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QLineEdit* arg0 = object<QLineEdit>(param_this);
    return arg0->selectionLength();
}
...
void qt_QLineEdit_timerEvent_void_QLineEdit_QTimerEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QLineEdit* arg0 = object<QLineEdit>(param_this);
    QTimerEvent * arg1 = getqpointer<QTimerEventType>(param_e);
    if (isMuQtObject(arg0)) arg0->QLineEdit::timerEvent(arg1);
    else arg0->timerEvent(arg1);
}
...
void qt_QLineEdit_keyReleaseEvent_void_QLineEdit_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QLineEdit* arg0 = object<QLineEdit>(param_this);
...
{
    NODE_RETURN(qt_QLineEdit_addAction_QAction_QLineEdit_QIcon_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int)));
}
...
{
    NODE_RETURN(qt_QLineEdit_selectionEnd_int_QLineEdit(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}

static NODE_IMPLEMENTATION(_n_selectionLength0, int)
{
    NODE_RETURN(qt_QLineEdit_selectionLength_int_QLineEdit(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    qt_QLineEdit_timerEvent_void_QLineEdit_QTimerEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
addSymbols(
    ...
    new Function(c, "addAction", _n_addAction0, None, Compiled, qt_QLineEdit_addAction_void_QLineEdit_QAction_int, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "action", "qt.QAction"), new Param(c, "position", "int"), End),
    new Function(c, "addAction", _n_addAction1, None, Compiled, qt_QLineEdit_addAction_QAction_QLineEdit_QIcon_int, Return, "qt.QAction", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "icon", "qt.QIcon"), new Param(c, "position", "int"), End),
    ...
    new Function(c, "cursorBackward", _n_cursorBackward0, None, Compiled, qt_QLineEdit_cursorBackward_void_QLineEdit_bool_int, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "mark", "bool"), new Param(c, "steps", "int", Value((int)1)), End),
    new Function(c, "cursorForward", _n_cursorForward0, None, Compiled, qt_QLineEdit_cursorForward_void_QLineEdit_bool_int, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "mark", "bool"), new Param(c, "steps", "int", Value((int)1)), End),
    ...
    new Function(c, "selectionEnd", _n_selectionEnd0, None, Compiled, qt_QLineEdit_selectionEnd_int_QLineEdit, Return, "int", Parameters, new Param(c, "this", "qt.QLineEdit"), End),
    new Function(c, "selectionLength", _n_selectionLength0, None, Compiled, qt_QLineEdit_selectionLength_int_QLineEdit, Return, "int", Parameters, new Param(c, "this", "qt.QLineEdit"), End),
    ...
    // PROP: setClearButtonEnabled (void; QLineEdit this, bool enable)
    ...
    // PROP: setCursorPosition (void; QLineEdit this, int _p3)
    // PROP: setDragEnabled (void; QLineEdit this, bool b)
    // PROP: setEchoMode (void; QLineEdit this, flags QLineEdit::EchoMode _p19)
    // PROP: setFrame (void; QLineEdit this, bool _p4)
    // PROP: setInputMask (void; QLineEdit this, string inputMask)
    // PROP: setMaxLength (void; QLineEdit this, int _p3)
    // PROP: setModified (void; QLineEdit this, bool _p4)
    // PROP: setPlaceholderText (void; QLineEdit this, string _p16)
    // PROP: setReadOnly (void; QLineEdit this, bool _p4)
    ...
    _func[4] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QLineEdit_timerEvent_void_QLineEdit_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QTimerEvent"), End),
    ...
    _func[5] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled, qt_QLineEdit_changeEvent_void_QLineEdit_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "ev", "qt.QEvent"), End),
    _func[6] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled, qt_QLineEdit_contextMenuEvent_void_QLineEdit_QContextMenuEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QContextMenuEvent"), End),
    _func[7] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QLineEdit_dragEnterEvent_void_QLineEdit_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QDragEnterEvent"), End),
    _func[8] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QLineEdit_dragLeaveEvent_void_QLineEdit_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QDragLeaveEvent"), End),
    _func[9] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QLineEdit_dragMoveEvent_void_QLineEdit_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QDragMoveEvent"), End),
    _func[10] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QLineEdit_dropEvent_void_QLineEdit_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QDropEvent"), End),
    _func[11] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QLineEdit_focusInEvent_void_QLineEdit_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QFocusEvent"), End),
    _func[12] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QLineEdit_focusOutEvent_void_QLineEdit_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QFocusEvent"), End),
    // MISSING: inputMethodEvent (void; QLineEdit this, "QInputMethodEvent *" e) // protected
    _func[13] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QLineEdit_keyPressEvent_void_QLineEdit_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[14] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QLineEdit_keyReleaseEvent_void_QLineEdit_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QKeyEvent"), End),
    _func[15] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QLineEdit_mouseDoubleClickEvent_void_QLineEdit_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[16] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QLineEdit_mouseMoveEvent_void_QLineEdit_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[17] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QLineEdit_mousePressEvent_void_QLineEdit_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[18] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QLineEdit_mouseReleaseEvent_void_QLineEdit_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[19] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QLineEdit_paintEvent_void_QLineEdit_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "_p14", "qt.QPaintEvent"), End),
    _func[20] = new MemberFunction(c, "hasHeightForWidth", _n_hasHeightForWidth0, None, Compiled, qt_QLineEdit_hasHeightForWidth_bool_QLineEdit, Return, "bool", Parameters, new Param(c, "this", "qt.QLineEdit"), End),
    _func[21] = new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QLineEdit_heightForWidth_int_QLineEdit_int, Return, "int", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "w", "int"), End),
    // MISSING: paintEngine ("QPaintEngine *"; QLineEdit this)
    // MISSING: actionEvent (void; QLineEdit this, "QActionEvent *" event) // protected
    _func[22] = new MemberFunction(c, "closeEvent", _n_closeEvent0, None, Compiled, qt_QLineEdit_closeEvent_void_QLineEdit_QCloseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QCloseEvent"), End),
    // MISSING: enterEvent (void; QLineEdit this, "QEnterEvent *" event) // protected
    _func[23] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QLineEdit_focusNextPrevChild_bool_QLineEdit_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "next", "bool"), End),
    _func[24] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QLineEdit_hideEvent_void_QLineEdit_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QHideEvent"), End),
    _func[25] = new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QLineEdit_leaveEvent_void_QLineEdit_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QEvent"), End),
    _func[26] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QLineEdit_moveEvent_void_QLineEdit_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QLineEdit this, QByteArray eventType, "void *" message, "qintptr *" result) // protected
    _func[27] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QLineEdit_resizeEvent_void_QLineEdit_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QResizeEvent"), End),
    _func[28] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QLineEdit_showEvent_void_QLineEdit_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QShowEvent"), End),
    _func[29] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QLineEdit_tabletEvent_void_QLineEdit_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QTabletEvent"), End),
    _func[30] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QLineEdit_wheelEvent_void_QLineEdit_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QWheelEvent"), End),
    // MISSING: initPainter (void; QLineEdit this, "QPainter *" painter) // protected
    _func[31] = new MemberFunction(c, "metric", _n_metric0, None, Compiled, qt_QLineEdit_metric_int_QLineEdit_int, Return, "int", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "m", "int"), End),
    // static functions
    EndArguments);
