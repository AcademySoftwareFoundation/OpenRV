...
namespace Mu
{
    ...
    void qt_QLineEdit_timerEvent_void_QLineEdit_QTimerEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
    {
        ...
        if (isMuQtObject(arg0))
            arg0->QLineEdit::timerEvent(arg1);
        else
            arg0->timerEvent(arg1);
    }
    ...
    void QLineEditType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "selectionEnd", _n_selectionEnd0, None, Compiled, qt_QLineEdit_selectionEnd_int_QLineEdit, Return, "int",
                         Parameters, new Param(c, "this", "qt.QLineEdit"), End),
            new Function(c, "selectionLength", _n_selectionLength0, None, Compiled, qt_QLineEdit_selectionLength_int_QLineEdit, Return,
                         "int", Parameters, new Param(c, "this", "qt.QLineEdit"), End),
            ...
            // QLineEdit this, int _p3) PROP: setDragEnabled (void; QLineEdit
            // this, bool b) PROP: setEchoMode (void; QLineEdit this, flags
            // QLineEdit::EchoMode _p19) PROP: setFrame (void; QLineEdit this,
            // bool _p4) PROP: setInputMask (void; QLineEdit this, string
            // inputMask) PROP: setMaxLength (void; QLineEdit this, int _p3)
            ...
            _func[4] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled,
                                          qt_QLineEdit_timerEvent_void_QLineEdit_QTimerEvent, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QTimerEvent"), End),
            ...
            _func[12] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled,
            ...
            _func[14] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled,
                                           ...
                                           new Param(c, "this", "qt.QLineEdit"), new Param(c, "e", "qt.QKeyEvent"), End),
            ...
            // MISSING: enterEvent (void; QLineEdit this, "QEnterEvent *" event)
            // // protected
            _func[23] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled,
