...
CClassType::CClassType(Context* c, Class *super) : Class(c, "c_class", super)
{
}
...
CClassType::load()
{
    ...
    s->addSymbols( new ReferenceType(c, "c_class&", this), 
		   ...
		   new Function(c, "c_class", BaseFunctions::dereference, Cast,
				Return, tn,
				Args, rn, End),
    ...
    globalScope()->addSymbols(
		   ...
		   new Function(c, "print", CClassType::print, None,
				Return, "void", 
				Args, tn, End),
    ...
    addSymbols( new MemberVariable(c, "parent", tn),
                ...
                new MemberFunction(c, "bar", CClassType::bar, None,
                                   Return, "string",
                                   Args, tn,
                                   End),

                new MemberFunction(c, "baz", CClassType::baz, None,
                                   Return, "string",
                                   Args, tn,
                                   End),
