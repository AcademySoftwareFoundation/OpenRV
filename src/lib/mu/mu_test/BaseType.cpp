...
BaseType::BaseType(Context* c, Class *super) : Class(c, "base_class", super)
{
}
...
BaseType::load()
{
    ...
    s->addSymbols( new ReferenceType(c, "base_class&", this), 
		   ...
		   new Function(c, "base_class", BaseFunctions::dereference, Cast,
				Return, tn,
				Args, rn, End),
    ...
    globalScope()->addSymbols(
		   ...
		   new Function(c, "print", BaseType::print, None,
				Return, "void", 
				Args, tn, End),
		   ...
		   new Function(c, "==", BaseFunctions::eq, CommOp,
				Return, rn, 
				Args, tn, tn, End),
    ...
    addSymbols( new MemberVariable(c, "next", tn),
                ...
                new MemberFunction(c, "foo", BaseType::foo, None,
                                   Return, "string",
                                   Args, tn,
                                   End),
