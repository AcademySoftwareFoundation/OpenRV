...
void
GLModule::init(const char* name, Context* context)
{
...
#define SYMCONST( name ) new SymbolicConstant(c, #name, "int", Value(int(name)))
    ...
    addSymbols(
        ...
        //
        /* AttribMask */
        SYMCONST( GL_CURRENT_BIT ),
        SYMCONST( GL_POINT_BIT ),
        SYMCONST( GL_LINE_BIT ),
        SYMCONST( GL_POLYGON_BIT ),
        SYMCONST( GL_POLYGON_STIPPLE_BIT ),
        SYMCONST( GL_PIXEL_MODE_BIT ),
        SYMCONST( GL_LIGHTING_BIT ),
        SYMCONST( GL_FOG_BIT ),
        SYMCONST( GL_DEPTH_BUFFER_BIT ),
        SYMCONST( GL_ACCUM_BUFFER_BIT ),
        SYMCONST( GL_STENCIL_BUFFER_BIT ),
        SYMCONST( GL_VIEWPORT_BIT ),
        SYMCONST( GL_TRANSFORM_BIT ),
        SYMCONST( GL_ENABLE_BIT ),
        SYMCONST( GL_COLOR_BUFFER_BIT ),
        SYMCONST( GL_HINT_BIT ),
        SYMCONST( GL_EVAL_BIT ),
        SYMCONST( GL_LIST_BIT ),
        SYMCONST( GL_TEXTURE_BIT ),
        SYMCONST( GL_SCISSOR_BIT ),
        ...
        SYMCONST( GL_POINTS ),
        SYMCONST( GL_LINES ),
        SYMCONST( GL_LINE_LOOP ),
        SYMCONST( GL_LINE_STRIP ),
        SYMCONST( GL_TRIANGLES ),
        SYMCONST( GL_TRIANGLE_STRIP ),
        SYMCONST( GL_TRIANGLE_FAN ),
        SYMCONST( GL_QUADS ),
        SYMCONST( GL_QUAD_STRIP ),
        SYMCONST( GL_POLYGON ),
        ...
        SYMCONST( GL_ZERO ),
        SYMCONST( GL_ONE ),
        SYMCONST( GL_SRC_COLOR ),
        SYMCONST( GL_ONE_MINUS_SRC_COLOR ),
        SYMCONST( GL_SRC_ALPHA ),
        SYMCONST( GL_ONE_MINUS_SRC_ALPHA ),
        SYMCONST( GL_DST_ALPHA ),
        SYMCONST( GL_ONE_MINUS_DST_ALPHA ),

        /* BlendingFactorSrc */
        SYMCONST( GL_DST_COLOR ),
        SYMCONST( GL_ONE_MINUS_DST_COLOR ),
        SYMCONST( GL_SRC_ALPHA_SATURATE ),

        /* DrawBufferMode */
        SYMCONST( GL_NONE ),
        SYMCONST( GL_FRONT_LEFT ),
        SYMCONST( GL_FRONT_RIGHT ),
        SYMCONST( GL_BACK_LEFT ),
        SYMCONST( GL_BACK_RIGHT ),
        SYMCONST( GL_FRONT ),
        SYMCONST( GL_BACK ),
        SYMCONST( GL_LEFT ),
        SYMCONST( GL_RIGHT ),
        SYMCONST( GL_FRONT_AND_BACK ),
        SYMCONST( GL_AUX0 ),
        SYMCONST( GL_AUX1 ),
        SYMCONST( GL_AUX2 ),
        SYMCONST( GL_AUX3 ),
        ...
        /* ErrorCode */
        SYMCONST( GL_NO_ERROR ),
        SYMCONST( GL_INVALID_ENUM ),
        SYMCONST( GL_INVALID_VALUE ),
        SYMCONST( GL_INVALID_OPERATION ),
        SYMCONST( GL_STACK_OVERFLOW ),
        SYMCONST( GL_STACK_UNDERFLOW ),
        SYMCONST( GL_OUT_OF_MEMORY ),
        SYMCONST( GL_TABLE_TOO_LARGE ),

        /* FeedbackType */
        SYMCONST( GL_2D ),
        SYMCONST( GL_3D ),
        SYMCONST( GL_3D_COLOR ),
        SYMCONST( GL_3D_COLOR_TEXTURE ),
        SYMCONST( GL_4D_COLOR_TEXTURE ),

        /* FeedBackToken */
        SYMCONST( GL_PASS_THROUGH_TOKEN ),
        SYMCONST( GL_POINT_TOKEN ),
        SYMCONST( GL_LINE_TOKEN ),
        SYMCONST( GL_POLYGON_TOKEN ),
        SYMCONST( GL_BITMAP_TOKEN ),
        SYMCONST( GL_DRAW_PIXEL_TOKEN ),
        SYMCONST( GL_COPY_PIXEL_TOKEN ),
        SYMCONST( GL_LINE_RESET_TOKEN ),
        ...
        /* GetPixelMap */
        SYMCONST( GL_PIXEL_MAP_I_TO_I ),
        SYMCONST( GL_PIXEL_MAP_S_TO_S ),
        SYMCONST( GL_PIXEL_MAP_I_TO_R ),
        SYMCONST( GL_PIXEL_MAP_I_TO_G ),
        SYMCONST( GL_PIXEL_MAP_I_TO_B ),
        SYMCONST( GL_PIXEL_MAP_I_TO_A ),
        SYMCONST( GL_PIXEL_MAP_R_TO_R ),
        SYMCONST( GL_PIXEL_MAP_G_TO_G ),
        SYMCONST( GL_PIXEL_MAP_B_TO_B ),
        SYMCONST( GL_PIXEL_MAP_A_TO_A ),

        /* GetPointervPName */
        SYMCONST( GL_VERTEX_ARRAY_POINTER ),
        SYMCONST( GL_NORMAL_ARRAY_POINTER ),
        SYMCONST( GL_COLOR_ARRAY_POINTER ),
        SYMCONST( GL_INDEX_ARRAY_POINTER ),
        SYMCONST( GL_TEXTURE_COORD_ARRAY_POINTER ),
        SYMCONST( GL_EDGE_FLAG_ARRAY_POINTER ),
        EndArguments);

    addSymbols(
        /* GetPName */
        SYMCONST( GL_CURRENT_COLOR ),
        SYMCONST( GL_CURRENT_INDEX ),
        SYMCONST( GL_CURRENT_NORMAL ),
        SYMCONST( GL_CURRENT_TEXTURE_COORDS ),
        ...
        SYMCONST( GL_CURRENT_RASTER_DISTANCE ),
        SYMCONST( GL_POINT_SMOOTH ),
        SYMCONST( GL_POINT_SIZE ),
        SYMCONST( GL_SMOOTH_POINT_SIZE_RANGE ),
        SYMCONST( GL_SMOOTH_POINT_SIZE_GRANULARITY ),
        SYMCONST( GL_POINT_SIZE_RANGE ),
        SYMCONST( GL_POINT_SIZE_GRANULARITY ),
        SYMCONST( GL_LINE_SMOOTH ),
        SYMCONST( GL_LINE_WIDTH ),
        SYMCONST( GL_SMOOTH_LINE_WIDTH_RANGE ),
        SYMCONST( GL_SMOOTH_LINE_WIDTH_GRANULARITY ),
        SYMCONST( GL_LINE_WIDTH_RANGE ),
        SYMCONST( GL_LINE_WIDTH_GRANULARITY ),
        SYMCONST( GL_LINE_STIPPLE ),
        SYMCONST( GL_LINE_STIPPLE_PATTERN ),
        SYMCONST( GL_LINE_STIPPLE_REPEAT ),
        SYMCONST( GL_LIST_MODE ),
        SYMCONST( GL_MAX_LIST_NESTING ),
        SYMCONST( GL_LIST_BASE ),
        SYMCONST( GL_LIST_INDEX ),
        SYMCONST( GL_POLYGON_MODE ),
        SYMCONST( GL_POLYGON_SMOOTH ),
        SYMCONST( GL_POLYGON_STIPPLE ),
        SYMCONST( GL_EDGE_FLAG ),
        SYMCONST( GL_CULL_FACE ),
        SYMCONST( GL_CULL_FACE_MODE ),
        SYMCONST( GL_FRONT_FACE ),
        SYMCONST( GL_LIGHTING ),
        SYMCONST( GL_LIGHT_MODEL_LOCAL_VIEWER ),
        SYMCONST( GL_LIGHT_MODEL_TWO_SIDE ),
        SYMCONST( GL_LIGHT_MODEL_AMBIENT ),
        SYMCONST( GL_SHADE_MODEL ),
        SYMCONST( GL_COLOR_MATERIAL_FACE ),
        SYMCONST( GL_COLOR_MATERIAL_PARAMETER ),
        SYMCONST( GL_COLOR_MATERIAL ),
        SYMCONST( GL_FOG ),
        SYMCONST( GL_FOG_INDEX ),
        SYMCONST( GL_FOG_DENSITY ),
        SYMCONST( GL_FOG_START ),
        SYMCONST( GL_FOG_END ),
        SYMCONST( GL_FOG_MODE ),
        SYMCONST( GL_FOG_COLOR ),
        SYMCONST( GL_DEPTH_RANGE ),
        SYMCONST( GL_DEPTH_TEST ),
        SYMCONST( GL_DEPTH_WRITEMASK ),
        SYMCONST( GL_DEPTH_CLEAR_VALUE ),
        SYMCONST( GL_DEPTH_FUNC ),
        SYMCONST( GL_ACCUM_CLEAR_VALUE ),
        SYMCONST( GL_STENCIL_TEST ),
        SYMCONST( GL_STENCIL_CLEAR_VALUE ),
        SYMCONST( GL_STENCIL_FUNC ),
        SYMCONST( GL_STENCIL_VALUE_MASK ),
        SYMCONST( GL_STENCIL_FAIL ),
        SYMCONST( GL_STENCIL_PASS_DEPTH_FAIL ),
        SYMCONST( GL_STENCIL_PASS_DEPTH_PASS ),
        SYMCONST( GL_STENCIL_REF ),
        SYMCONST( GL_STENCIL_WRITEMASK ),
        SYMCONST( GL_MATRIX_MODE ),
        SYMCONST( GL_NORMALIZE ),
        SYMCONST( GL_VIEWPORT ),
        SYMCONST( GL_MODELVIEW_STACK_DEPTH ),
        SYMCONST( GL_PROJECTION_STACK_DEPTH ),
        SYMCONST( GL_TEXTURE_STACK_DEPTH ),
        SYMCONST( GL_MODELVIEW_MATRIX ),
        SYMCONST( GL_PROJECTION_MATRIX ),
        SYMCONST( GL_TEXTURE_MATRIX ),
        SYMCONST( GL_ATTRIB_STACK_DEPTH ),
        SYMCONST( GL_CLIENT_ATTRIB_STACK_DEPTH ),
        SYMCONST( GL_ALPHA_TEST ),
        SYMCONST( GL_ALPHA_TEST_FUNC ),
        SYMCONST( GL_ALPHA_TEST_REF ),
        SYMCONST( GL_DITHER ),
        SYMCONST( GL_BLEND_DST ),
        SYMCONST( GL_BLEND_SRC ),
        SYMCONST( GL_BLEND ),
        SYMCONST( GL_LOGIC_OP_MODE ),
        SYMCONST( GL_INDEX_LOGIC_OP ),
        SYMCONST( GL_LOGIC_OP ),
        SYMCONST( GL_COLOR_LOGIC_OP ),
        SYMCONST( GL_AUX_BUFFERS ),
        SYMCONST( GL_DRAW_BUFFER ),
        SYMCONST( GL_READ_BUFFER ),
        SYMCONST( GL_SCISSOR_BOX ),
        SYMCONST( GL_SCISSOR_TEST ),
        SYMCONST( GL_INDEX_CLEAR_VALUE ),
        SYMCONST( GL_INDEX_WRITEMASK ),
        SYMCONST( GL_COLOR_CLEAR_VALUE ),
        SYMCONST( GL_COLOR_WRITEMASK ),
        SYMCONST( GL_INDEX_MODE ),
        SYMCONST( GL_RGBA_MODE ),
        SYMCONST( GL_DOUBLEBUFFER ),
        SYMCONST( GL_STEREO ),
        SYMCONST( GL_RENDER_MODE ),
        SYMCONST( GL_PERSPECTIVE_CORRECTION_HINT ),
        SYMCONST( GL_POINT_SMOOTH_HINT ),
        SYMCONST( GL_LINE_SMOOTH_HINT ),
        SYMCONST( GL_POLYGON_SMOOTH_HINT ),
        SYMCONST( GL_FOG_HINT ),
        SYMCONST( GL_TEXTURE_GEN_S ),
        SYMCONST( GL_TEXTURE_GEN_T ),
        SYMCONST( GL_TEXTURE_GEN_R ),
        SYMCONST( GL_TEXTURE_GEN_Q ),
        ...
        SYMCONST( GL_PIXEL_MAP_A_TO_A_SIZE ),
        SYMCONST( GL_UNPACK_SWAP_BYTES ),
        SYMCONST( GL_UNPACK_LSB_FIRST ),
        SYMCONST( GL_UNPACK_ROW_LENGTH ),
        SYMCONST( GL_UNPACK_SKIP_ROWS ),
        SYMCONST( GL_UNPACK_SKIP_PIXELS ),
        SYMCONST( GL_UNPACK_ALIGNMENT ),
        SYMCONST( GL_PACK_SWAP_BYTES ),
        SYMCONST( GL_PACK_LSB_FIRST ),
        SYMCONST( GL_PACK_ROW_LENGTH ),
        SYMCONST( GL_PACK_SKIP_ROWS ),
        SYMCONST( GL_PACK_SKIP_PIXELS ),
        SYMCONST( GL_PACK_ALIGNMENT ),
        SYMCONST( GL_MAP_COLOR ),
        SYMCONST( GL_MAP_STENCIL ),
        SYMCONST( GL_INDEX_SHIFT ),
        SYMCONST( GL_INDEX_OFFSET ),
        SYMCONST( GL_RED_SCALE ),
        SYMCONST( GL_RED_BIAS ),
        SYMCONST( GL_ZOOM_X ),
        SYMCONST( GL_ZOOM_Y ),
        SYMCONST( GL_GREEN_SCALE ),
        SYMCONST( GL_GREEN_BIAS ),
        SYMCONST( GL_BLUE_SCALE ),
        SYMCONST( GL_BLUE_BIAS ),
        SYMCONST( GL_ALPHA_SCALE ),
        SYMCONST( GL_ALPHA_BIAS ),
        SYMCONST( GL_DEPTH_SCALE ),
        SYMCONST( GL_DEPTH_BIAS ),
        SYMCONST( GL_MAX_EVAL_ORDER ),
        SYMCONST( GL_MAX_LIGHTS ),
        SYMCONST( GL_MAX_CLIP_PLANES ),
        SYMCONST( GL_MAX_TEXTURE_SIZE ),
        ...
        SYMCONST( GL_SUBPIXEL_BITS ),
        SYMCONST( GL_INDEX_BITS ),
        SYMCONST( GL_RED_BITS ),
        SYMCONST( GL_GREEN_BITS ),
        SYMCONST( GL_BLUE_BITS ),
        SYMCONST( GL_ALPHA_BITS ),
        SYMCONST( GL_DEPTH_BITS ),
        SYMCONST( GL_STENCIL_BITS ),
        SYMCONST( GL_ACCUM_RED_BITS ),
        SYMCONST( GL_ACCUM_GREEN_BITS ),
        SYMCONST( GL_ACCUM_BLUE_BITS ),
        SYMCONST( GL_ACCUM_ALPHA_BITS ),
        SYMCONST( GL_NAME_STACK_DEPTH ),
        SYMCONST( GL_AUTO_NORMAL ),
        SYMCONST( GL_MAP1_COLOR_4 ),
        SYMCONST( GL_MAP1_INDEX ),
        SYMCONST( GL_MAP1_NORMAL ),
        SYMCONST( GL_MAP1_TEXTURE_COORD_1 ),
        SYMCONST( GL_MAP1_TEXTURE_COORD_2 ),
        SYMCONST( GL_MAP1_TEXTURE_COORD_3 ),
        SYMCONST( GL_MAP1_TEXTURE_COORD_4 ),
        SYMCONST( GL_MAP1_VERTEX_3 ),
        SYMCONST( GL_MAP1_VERTEX_4 ),
        SYMCONST( GL_MAP2_COLOR_4 ),
        SYMCONST( GL_MAP2_INDEX ),
        SYMCONST( GL_MAP2_NORMAL ),
        SYMCONST( GL_MAP2_TEXTURE_COORD_1 ),
        SYMCONST( GL_MAP2_TEXTURE_COORD_2 ),
        SYMCONST( GL_MAP2_TEXTURE_COORD_3 ),
        SYMCONST( GL_MAP2_TEXTURE_COORD_4 ),
        SYMCONST( GL_MAP2_VERTEX_3 ),
        SYMCONST( GL_MAP2_VERTEX_4 ),
        SYMCONST( GL_MAP1_GRID_DOMAIN ),
        SYMCONST( GL_MAP1_GRID_SEGMENTS ),
        SYMCONST( GL_MAP2_GRID_DOMAIN ),
        SYMCONST( GL_MAP2_GRID_SEGMENTS ),
        SYMCONST( GL_TEXTURE_1D ),
        SYMCONST( GL_TEXTURE_2D ),
        SYMCONST( GL_TEXTURE_RECTANGLE_ARB ),
        ...
        SYMCONST( GL_POLYGON_OFFSET_POINT ),
        SYMCONST( GL_POLYGON_OFFSET_LINE ),
        SYMCONST( GL_POLYGON_OFFSET_FILL ),
        SYMCONST( GL_POLYGON_OFFSET_FACTOR ),
        SYMCONST( GL_TEXTURE_BINDING_1D ),
        SYMCONST( GL_TEXTURE_BINDING_2D ),
        SYMCONST( GL_TEXTURE_BINDING_3D ),
        SYMCONST( GL_VERTEX_ARRAY ),
        SYMCONST( GL_NORMAL_ARRAY ),
        SYMCONST( GL_COLOR_ARRAY ),
        SYMCONST( GL_INDEX_ARRAY ),
        SYMCONST( GL_TEXTURE_COORD_ARRAY ),
        SYMCONST( GL_EDGE_FLAG_ARRAY ),
        SYMCONST( GL_VERTEX_ARRAY_SIZE ),
        SYMCONST( GL_VERTEX_ARRAY_TYPE ),
        SYMCONST( GL_VERTEX_ARRAY_STRIDE ),
        SYMCONST( GL_NORMAL_ARRAY_TYPE ),
        SYMCONST( GL_NORMAL_ARRAY_STRIDE ),
        SYMCONST( GL_COLOR_ARRAY_SIZE ),
        SYMCONST( GL_COLOR_ARRAY_TYPE ),
        SYMCONST( GL_COLOR_ARRAY_STRIDE ),
        SYMCONST( GL_INDEX_ARRAY_TYPE ),
        SYMCONST( GL_INDEX_ARRAY_STRIDE ),
        ...
        /* GetTextureParameter */
        SYMCONST( GL_TEXTURE_WIDTH ),
        SYMCONST( GL_TEXTURE_HEIGHT ),
        SYMCONST( GL_TEXTURE_INTERNAL_FORMAT ),
        SYMCONST( GL_TEXTURE_COMPONENTS ),
        SYMCONST( GL_TEXTURE_BORDER_COLOR ),
        SYMCONST( GL_TEXTURE_BORDER ),
        SYMCONST( GL_TEXTURE_RED_SIZE ),
        SYMCONST( GL_TEXTURE_GREEN_SIZE ),
        SYMCONST( GL_TEXTURE_BLUE_SIZE ),
        SYMCONST( GL_TEXTURE_ALPHA_SIZE ),
        SYMCONST( GL_TEXTURE_LUMINANCE_SIZE ),
        SYMCONST( GL_TEXTURE_INTENSITY_SIZE ),
        SYMCONST( GL_TEXTURE_PRIORITY ),
        SYMCONST( GL_TEXTURE_RESIDENT ),
        EndArguments);

    addSymbols(
        /* HintMode */
        SYMCONST( GL_DONT_CARE ),
        SYMCONST( GL_FASTEST ),
        SYMCONST( GL_NICEST ),
        ...
        SYMCONST( GL_AMBIENT ),
        SYMCONST( GL_DIFFUSE ),
        SYMCONST( GL_SPECULAR ),
        SYMCONST( GL_POSITION ),
        SYMCONST( GL_SPOT_DIRECTION ),
        SYMCONST( GL_SPOT_EXPONENT ),
        SYMCONST( GL_SPOT_CUTOFF ),
        SYMCONST( GL_CONSTANT_ATTENUATION ),
        SYMCONST( GL_LINEAR_ATTENUATION ),
        SYMCONST( GL_QUADRATIC_ATTENUATION ),

        /* ListMode */
        SYMCONST( GL_COMPILE ),
        SYMCONST( GL_COMPILE_AND_EXECUTE ),
        
        /* DataType */
        SYMCONST( GL_BYTE ),
        SYMCONST( GL_UNSIGNED_BYTE ),
        SYMCONST( GL_SHORT ),
        SYMCONST( GL_UNSIGNED_SHORT ),
        SYMCONST( GL_INT ),
        SYMCONST( GL_UNSIGNED_INT ),
        SYMCONST( GL_FLOAT ),
        SYMCONST( GL_2_BYTES ),
        SYMCONST( GL_3_BYTES ),
        SYMCONST( GL_4_BYTES ),
        ...
        SYMCONST( GL_CLEAR ),
        SYMCONST( GL_AND ),
        SYMCONST( GL_AND_REVERSE ),
        SYMCONST( GL_COPY ),
        SYMCONST( GL_AND_INVERTED ),
        SYMCONST( GL_NOOP ),
        SYMCONST( GL_XOR ),
        SYMCONST( GL_OR ),
        SYMCONST( GL_NOR ),
        SYMCONST( GL_EQUIV ),
        SYMCONST( GL_INVERT ),
        SYMCONST( GL_OR_REVERSE ),
        SYMCONST( GL_COPY_INVERTED ),
        SYMCONST( GL_OR_INVERTED ),
        SYMCONST( GL_NAND ),
        SYMCONST( GL_SET ),
        
        /* MaterialParameter */
        SYMCONST( GL_EMISSION ),
        SYMCONST( GL_SHININESS ),
        SYMCONST( GL_AMBIENT_AND_DIFFUSE ),
        SYMCONST( GL_COLOR_INDEXES ),

        /* MatrixMode */
        SYMCONST( GL_MODELVIEW ),
        SYMCONST( GL_PROJECTION ),
        SYMCONST( GL_TEXTURE ),
        ...
        /* PixelFormat */
        SYMCONST( GL_COLOR_INDEX ),
        SYMCONST( GL_STENCIL_INDEX ),
        SYMCONST( GL_DEPTH_COMPONENT ),
        SYMCONST( GL_RED ),
        SYMCONST( GL_GREEN ),
        SYMCONST( GL_BLUE ),
        SYMCONST( GL_ALPHA ),
        ...
        /* TextureEnvMode */
        SYMCONST( GL_MODULATE ),
        SYMCONST( GL_DECAL ),

        /* TextureEnvParameter */
        SYMCONST( GL_TEXTURE_ENV_MODE ),
        SYMCONST( GL_TEXTURE_ENV_COLOR ),

        /* TextureEnvTarget */
        SYMCONST( GL_TEXTURE_ENV ),

        /* TextureGenMode */
        SYMCONST( GL_EYE_LINEAR ),
        SYMCONST( GL_OBJECT_LINEAR ),
        SYMCONST( GL_SPHERE_MAP ),

        /* TextureGenParameter */
        SYMCONST( GL_TEXTURE_GEN_MODE ),
        SYMCONST( GL_OBJECT_PLANE ),
        ...
        SYMCONST( GL_TEXTURE_MAG_FILTER ),
        SYMCONST( GL_TEXTURE_MIN_FILTER ),
        SYMCONST( GL_TEXTURE_WRAP_S ),
        SYMCONST( GL_TEXTURE_WRAP_T ),

        /* TextureTarget */
        SYMCONST( GL_PROXY_TEXTURE_1D ),
        SYMCONST( GL_PROXY_TEXTURE_2D ),
    ...
    addSymbols(
        /* PixelInternalFormat */
        SYMCONST( GL_R3_G3_B2 ),
        SYMCONST( GL_ALPHA4 ),
        SYMCONST( GL_ALPHA8 ),
        SYMCONST( GL_ALPHA12 ),
        SYMCONST( GL_ALPHA16 ),
        SYMCONST( GL_LUMINANCE4 ),
        SYMCONST( GL_LUMINANCE8 ),
        SYMCONST( GL_LUMINANCE12 ),
        SYMCONST( GL_LUMINANCE16 ),
        SYMCONST( GL_LUMINANCE4_ALPHA4 ),
        SYMCONST( GL_LUMINANCE6_ALPHA2 ),
        SYMCONST( GL_LUMINANCE8_ALPHA8 ),
        SYMCONST( GL_LUMINANCE12_ALPHA4 ),
        SYMCONST( GL_LUMINANCE12_ALPHA12 ),
        SYMCONST( GL_LUMINANCE16_ALPHA16 ),
        SYMCONST( GL_INTENSITY ),
        SYMCONST( GL_INTENSITY4 ),
        SYMCONST( GL_INTENSITY8 ),
        SYMCONST( GL_INTENSITY12 ),
        SYMCONST( GL_INTENSITY16 ),
        SYMCONST( GL_RGB4 ),
        SYMCONST( GL_RGB5 ),
        SYMCONST( GL_RGB8 ),
        SYMCONST( GL_RGB10 ),
        ...
        SYMCONST( GL_V2F ),
        SYMCONST( GL_V3F ),
        SYMCONST( GL_C4UB_V2F ),
        SYMCONST( GL_C4UB_V3F ),
        SYMCONST( GL_C3F_V3F ),
        SYMCONST( GL_N3F_V3F ),
        SYMCONST( GL_C4F_N3F_V3F ),
        SYMCONST( GL_T2F_V3F ),
        SYMCONST( GL_T4F_V4F ),
        SYMCONST( GL_T2F_C4UB_V3F ),
        SYMCONST( GL_T2F_C3F_V3F ),
        SYMCONST( GL_T2F_N3F_V3F ),
        SYMCONST( GL_T2F_C4F_N3F_V3F ),
        SYMCONST( GL_T4F_C4F_N3F_V4F ),

        /* ClipPlaneName */
        SYMCONST( GL_CLIP_PLANE0 ),
        SYMCONST( GL_CLIP_PLANE1 ),
        SYMCONST( GL_CLIP_PLANE2 ),
        SYMCONST( GL_CLIP_PLANE3 ),
        SYMCONST( GL_CLIP_PLANE4 ),
        SYMCONST( GL_CLIP_PLANE5 ),
        ...
        /* OpenGL12 */
        SYMCONST( GL_PACK_SKIP_IMAGES ),
        SYMCONST( GL_PACK_IMAGE_HEIGHT ),
        SYMCONST( GL_UNPACK_SKIP_IMAGES ),
        SYMCONST( GL_UNPACK_IMAGE_HEIGHT ),
        SYMCONST( GL_TEXTURE_3D ),
        SYMCONST( GL_PROXY_TEXTURE_3D ),
        SYMCONST( GL_TEXTURE_DEPTH ),
        SYMCONST( GL_TEXTURE_WRAP_R ),
        SYMCONST( GL_MAX_3D_TEXTURE_SIZE ),
        SYMCONST( GL_BGR ),
        SYMCONST( GL_BGRA ),
        SYMCONST( GL_UNSIGNED_BYTE_3_3_2 ),
        ...
        SYMCONST( GL_RESCALE_NORMAL ),
        SYMCONST( GL_LIGHT_MODEL_COLOR_CONTROL ),
        SYMCONST( GL_SINGLE_COLOR ),
        SYMCONST( GL_SEPARATE_SPECULAR_COLOR ),
        SYMCONST( GL_CLAMP_TO_EDGE ),
        SYMCONST( GL_TEXTURE_MIN_LOD ),
        SYMCONST( GL_TEXTURE_MAX_LOD ),
        SYMCONST( GL_TEXTURE_BASE_LEVEL ),
        SYMCONST( GL_TEXTURE_MAX_LEVEL ),
        SYMCONST( GL_MAX_ELEMENTS_VERTICES ),
        SYMCONST( GL_MAX_ELEMENTS_INDICES ),
        SYMCONST( GL_ALIASED_POINT_SIZE_RANGE ),
        SYMCONST( GL_ALIASED_LINE_WIDTH_RANGE ),
        EndArguments);

    addSymbols(
        /* OpenGL13 */
        SYMCONST( GL_ACTIVE_TEXTURE ),
        SYMCONST( GL_CLIENT_ACTIVE_TEXTURE ),
        SYMCONST( GL_MAX_TEXTURE_UNITS ),
        SYMCONST( GL_TEXTURE0 ),
        SYMCONST( GL_TEXTURE1 ),
        SYMCONST( GL_TEXTURE2 ),
        SYMCONST( GL_TEXTURE3 ),
        SYMCONST( GL_TEXTURE4 ),
        SYMCONST( GL_TEXTURE5 ),
        SYMCONST( GL_TEXTURE6 ),
        SYMCONST( GL_TEXTURE7 ),
        SYMCONST( GL_TEXTURE8 ),
        SYMCONST( GL_TEXTURE9 ),
        SYMCONST( GL_TEXTURE10 ),
        SYMCONST( GL_TEXTURE11 ),
        SYMCONST( GL_TEXTURE12 ),
        SYMCONST( GL_TEXTURE13 ),
        SYMCONST( GL_TEXTURE14 ),
        SYMCONST( GL_TEXTURE15 ),
        SYMCONST( GL_TEXTURE16 ),
        SYMCONST( GL_TEXTURE17 ),
        SYMCONST( GL_TEXTURE18 ),
        SYMCONST( GL_TEXTURE19 ),
        SYMCONST( GL_TEXTURE20 ),
        SYMCONST( GL_TEXTURE21 ),
        SYMCONST( GL_TEXTURE22 ),
        SYMCONST( GL_TEXTURE23 ),
        SYMCONST( GL_TEXTURE24 ),
        SYMCONST( GL_TEXTURE25 ),
        SYMCONST( GL_TEXTURE26 ),
        SYMCONST( GL_TEXTURE27 ),
        SYMCONST( GL_TEXTURE28 ),
        SYMCONST( GL_TEXTURE29 ),
        SYMCONST( GL_TEXTURE30 ),
        SYMCONST( GL_TEXTURE31 ),
        SYMCONST( GL_NORMAL_MAP ),
        SYMCONST( GL_REFLECTION_MAP ),
        ...
        SYMCONST( GL_MAX_CUBE_MAP_TEXTURE_SIZE ),
        SYMCONST( GL_COMBINE ),
        SYMCONST( GL_COMBINE_RGB ),
        SYMCONST( GL_COMBINE_ALPHA ),
        SYMCONST( GL_RGB_SCALE ),
        SYMCONST( GL_ADD_SIGNED ),
        SYMCONST( GL_INTERPOLATE ),
        SYMCONST( GL_CONSTANT ),
        SYMCONST( GL_PRIMARY_COLOR ),
        SYMCONST( GL_PREVIOUS ),
        SYMCONST( GL_SOURCE0_RGB ),
        SYMCONST( GL_SOURCE1_RGB ),
        SYMCONST( GL_SOURCE2_RGB ),
        SYMCONST( GL_SOURCE0_ALPHA ),
        SYMCONST( GL_SOURCE1_ALPHA ),
        SYMCONST( GL_SOURCE2_ALPHA ),
        SYMCONST( GL_OPERAND0_RGB ),
        SYMCONST( GL_OPERAND1_RGB ),
        SYMCONST( GL_OPERAND2_RGB ),
        SYMCONST( GL_OPERAND0_ALPHA ),
        SYMCONST( GL_OPERAND1_ALPHA ),
        SYMCONST( GL_OPERAND2_ALPHA ),
        SYMCONST( GL_SUBTRACT ),
        SYMCONST( GL_TRANSPOSE_MODELVIEW_MATRIX ),
        SYMCONST( GL_TRANSPOSE_PROJECTION_MATRIX ),
        SYMCONST( GL_TRANSPOSE_TEXTURE_MATRIX ),
        SYMCONST( GL_TRANSPOSE_COLOR_MATRIX ),
        SYMCONST( GL_COMPRESSED_ALPHA ),
        SYMCONST( GL_COMPRESSED_LUMINANCE ),
        SYMCONST( GL_COMPRESSED_LUMINANCE_ALPHA ),
        SYMCONST( GL_COMPRESSED_INTENSITY ),
        SYMCONST( GL_COMPRESSED_RGB ),
        SYMCONST( GL_COMPRESSED_RGBA ),
        SYMCONST( GL_TEXTURE_COMPRESSION_HINT ),
        SYMCONST( GL_TEXTURE_COMPRESSED_IMAGE_SIZE ),
        SYMCONST( GL_TEXTURE_COMPRESSED ),
        SYMCONST( GL_NUM_COMPRESSED_TEXTURE_FORMATS ),
        SYMCONST( GL_COMPRESSED_TEXTURE_FORMATS ),
        SYMCONST( GL_DOT3_RGB ),
        SYMCONST( GL_DOT3_RGBA ),
        SYMCONST( GL_CLAMP_TO_BORDER ),
        SYMCONST( GL_MULTISAMPLE ),
        SYMCONST( GL_SAMPLE_ALPHA_TO_COVERAGE ),
        SYMCONST( GL_SAMPLE_ALPHA_TO_ONE ),
        SYMCONST( GL_SAMPLE_COVERAGE ),
        SYMCONST( GL_SAMPLE_BUFFERS ),
        SYMCONST( GL_SAMPLES ),
        SYMCONST( GL_SAMPLE_COVERAGE_VALUE ),
        SYMCONST( GL_SAMPLE_COVERAGE_INVERT ),
        SYMCONST( GL_MULTISAMPLE_BIT ),

        /* EXT_vertex_array */
#ifdef GL_VERTEX_ARRAY_EXT
        SYMCONST( GL_VERTEX_ARRAY_EXT ),
        SYMCONST( GL_NORMAL_ARRAY_EXT ),
        SYMCONST( GL_COLOR_ARRAY_EXT ),
        SYMCONST( GL_INDEX_ARRAY_EXT ),
        ...
        /* OpenGL14 */
        SYMCONST( GL_POINT_SIZE_MIN ),
        SYMCONST( GL_POINT_SIZE_MAX ),
        SYMCONST( GL_POINT_FADE_THRESHOLD_SIZE ),
        SYMCONST( GL_POINT_DISTANCE_ATTENUATION ),
        SYMCONST( GL_FOG_COORDINATE_SOURCE ),
        SYMCONST( GL_FOG_COORDINATE ),
        SYMCONST( GL_FRAGMENT_DEPTH ),
        SYMCONST( GL_CURRENT_FOG_COORDINATE ),
        SYMCONST( GL_FOG_COORDINATE_ARRAY_TYPE ),
        SYMCONST( GL_FOG_COORDINATE_ARRAY_STRIDE ),
        SYMCONST( GL_FOG_COORDINATE_ARRAY_POINTER ),
        SYMCONST( GL_FOG_COORDINATE_ARRAY ),
        SYMCONST( GL_COLOR_SUM ),
        ...
        SYMCONST( GL_SECONDARY_COLOR_ARRAY ),
        SYMCONST( GL_INCR_WRAP ),
        SYMCONST( GL_DECR_WRAP ),
        SYMCONST( GL_MAX_TEXTURE_LOD_BIAS ),
        SYMCONST( GL_TEXTURE_FILTER_CONTROL ),
        SYMCONST( GL_TEXTURE_LOD_BIAS ),
        SYMCONST( GL_GENERATE_MIPMAP ),
        SYMCONST( GL_GENERATE_MIPMAP_HINT ),
        SYMCONST( GL_BLEND_DST_RGB ),
        SYMCONST( GL_BLEND_SRC_RGB ),
        SYMCONST( GL_BLEND_DST_ALPHA ),
        SYMCONST( GL_BLEND_SRC_ALPHA ),
        SYMCONST( GL_MIRRORED_REPEAT ),
        SYMCONST( GL_DEPTH_COMPONENT16 ),
        SYMCONST( GL_DEPTH_COMPONENT24 ),
        SYMCONST( GL_DEPTH_COMPONENT32 ),
        SYMCONST( GL_TEXTURE_DEPTH_SIZE ),
        SYMCONST( GL_DEPTH_TEXTURE_MODE ),
        SYMCONST( GL_TEXTURE_COMPARE_MODE ),
        SYMCONST( GL_TEXTURE_COMPARE_FUNC ),
        SYMCONST( GL_COMPARE_R_TO_TEXTURE ),
        EndArguments);

    addSymbols(

        new Function(c, "glAccum", GLModule::glAccum, None,
                     Return, "void",
                     Args, "int", "float",
                     End ),

        new Function(c, "glAlphaFunc", GLModule::glAlphaFunc, None,
                     Return, "void",
                     Args, "int", "float",
                     End ),
        ...
        new Function(c, "glBegin", GLModule::glBegin, None,
                     Return, "void",
                     Args, "int",
                     End),
        ...
        new Function(c, "glBlendFunc", GLModule::glBlendFunc, None,
                     Return, "void",
                     Args, "int", "int",
                     End ),

        new Function(c, "glCallList", GLModule::glCallList, None,
                     Return, "void",
                     Args, "int",
                     End ),

        new Function(c, "glClear", GLModule::glClear, None,
                     Return, "void",
                     Args, "int",
                     End ),
        ...
        new Function(c, "glClipPlane", GLModule::glClipPlane, None,
                     Return, "void",
                     Args, "int", "float", "float", "float", "float",
                     End ),

        new Function(c, "glColor", GLModule::glColor3f, None,
                     Return, "void",
                     Args, "float", "float", "float", 
                     End),

        new Function(c, "glColor", GLModule::glColor4f, None,
                     Return, "void",
                     Args, "float", "float", "float", "float",
                     End),

        new Function(c, "glColor", GLModule::glColor3fv, None,
                     Return, "void",
                     Args, "vector float[3]",
                     End),

        new Function(c, "glColor", GLModule::glColor4fv, None,
                     Return, "void",
                     Args, "vector float[4]",
                     End),

        new Function(c, "glColorMask", GLModule::glColorMask, None,
                     Return, "void",
        ...
        new Function(c, "glCopyTexImage1D", GLModule::glCopyTexImage1D, None,
                     Return, "void",
                     Args, "int", "int", "int", "int", "int", "int", "int",
                     End ),

        new Function(c, "glCopyTexImage2D", GLModule::glCopyTexImage2D, None,
                     Return, "void",
                     Args, "int", "int", "int", "int", "int", "int",
                           "int", "int",
                     End ),

        new Function(c, "glCopyTexSubImage1D", GLModule::glCopyTexSubImage1D, None,
                     Return, "void",
                     Args, "int", "int", "int", "int", "int", "int",
                     End ),

        new Function(c, "glCopyTexSubImage2D", GLModule::glCopyTexSubImage2D, None,
                     Return, "void",
                     Args, "int", "int", "int", "int", "int", "int",
                           "int", "int",
                     End ),

        new Function(c, "glCullFace", GLModule::glCullFace, None,
                     Return, "void",
                     Args, "int",
                     End ),
        ...
        new Function(c, "glDeleteTextures", GLModule::glDeleteTextures, None,
                     Return, "void",
                     Args, "int[]",
                     End ),

        new Function(c, "glDepthFunc", GLModule::glDepthFunc, None,
                     Return, "void",
                     Args, "int",
                     End ),

        new Function(c, "glDepthMask", GLModule::glDepthMask, None,
                     Return, "void",
                     Args, "bool",
                     End ),
        ...
        new Function(c, "glDisable", GLModule::glDisable, None,
                     Return, "void",
                     Args, "int",
                     End),

        new Function(c, "glDisableClientState", GLModule::glDisableClientState, None,
                     Return, "void",
                     Args, "int",
                     End),
        ...
        new Function(c, "glDrawPixels", GLModule::glDrawPixels, None,
                     Return, "void",
                     Args, "int", "int", "int", "?dyn_array",
                     End),

        new Function(c, "glEdgeFlag", GLModule::glEdgeFlag, None,
                     Return, "void",
                     Args, "bool", 
                     End),

        new Function(c, "glEnable", GLModule::glEnable, None,
                     Return, "void",
                     Args, "int",
                     End),

        new Function(c, "glEnableClientState", GLModule::glEnableClientState, None,
                     Return, "void",
                     Args, "int",
                     End),

        new Function(c, "glEnd", GLModule::glEnd, None,
                     Return, "void",
                     End),

        new Function(c, "glEndList", GLModule::glEndList, None,
                     Return, "void",
                     End),
        ...
        new Function(c, "glEvalMesh1", GLModule::glEvalMesh1, None,
                     Return, "void",
                     Args, "int", "int", "int",
                     End),

        new Function(c, "glEvalMesh2", GLModule::glEvalMesh2, None,
                     Return, "void",
                     Args, "int", "int", "int", "int", "int",
                     End),
        ...
        new Function(c, "glFinish", GLModule::glFinish, None,
                     Return, "void",
                     End),

        new Function(c, "glFlush", GLModule::glFlush, None,
                     Return, "void",
                     End),

        new Function(c, "glFog", GLModule::glFogfv, None,
                     Return, "void",
                     Args, "int", "float[]",
                     End),

        new Function(c, "glFog", GLModule::glFogiv, None,
                     Return, "void",
                     Args, "int", "int[]",
                     End),

        new Function(c, "glFog", GLModule::glFogf, None,
                     Return, "void",
                     Args, "int", "float",
                     End),

        new Function(c, "glFog", GLModule::glFogi, None,
                     Return, "void",
                     Args, "int", "int",
                     End),

        new Function(c, "glFrontFace", GLModule::glFrontFace, None,
                     Return, "void",
                     Args, "int",
                     End),

        new Function(c, "glFrustum", GLModule::glFrustum, None,
                     Return, "void",
                     Args, "float", "float", "float", "float", "float", "float",
                     End),

        new Function(c, "glGenLists", GLModule::glGenLists, None,
                     Return, "int",
                     Args, "int",
                     End),
        ...
        new Function(c, "glGetError", GLModule::glGetError, None,
                     Return, "int",
                     End),

        new Function(c, "glGetFloat", GLModule::glGetFloatv, None,
                     Return, "float[]",
                     Args, "int",
                     End),
        ...
        new Function(c, "glGetString", GLModule::glGetString, None,
                     Return, "string",
                     Args, "int",
                     End),

        new Function(c, "glHint", GLModule::glHint, None,
                     Return, "void",
                     Args, "int", "int",
                     End),

        new Function(c, "glIndexMask", GLModule::glIndexMask, None,
                     Return, "void",
                     Args, "int",
                     End),

        new Function(c, "glIndex", GLModule::glIndexf, None,
                     Return, "void",
                     Args, "float",
                     End),

        new Function(c, "glIndex", GLModule::glIndexi, None,
                     Return, "void",
                     Args, "int",
                     End),

        new Function(c, "glInitNames", GLModule::glInitNames, None,
                     Return, "void",
                     End),

        new Function(c, "glIsEnabled", GLModule::glIsEnabled, None,
                     Return, "bool",
                     Args, "int",
                     End),

        new Function(c, "glIsList", GLModule::glIsList, None,
                     Return, "bool",
                     Args, "int",
                     End),

        new Function(c, "glIsTexture", GLModule::glIsTexture, None,
                     Return, "bool",
                     Args, "int",
                     End),
        ...
        new Function(c, "glLight", GLModule::glLightf, None,
                     Return, "void",
                     Args, "int", "int", "float",
                     End),

        new Function(c, "glLight", GLModule::glLighti, None,
                     Return, "void",
                     Args, "int", "int", "int",
                     End),
        ...
        new Function(c, "glLineWidth", GLModule::glLineWidth, None,
                     Return, "void",
                     Args, "float",
                     End),

        new Function(c, "glListBase", GLModule::glListBase, None,
                     Return, "void",
                     Args, "int",
                     End),
        ...
        new Function(c, "glLoadName", GLModule::glLoadName, None,
                     Return, "void",
                     Args, "int",
                     End),

        new Function(c, "glLogicOp", GLModule::glLogicOp, None,
                     Return, "void",
                     Args, "int",
                     End),

        new Function(c, "glMapGrid1", GLModule::glMapGrid1f, None,
                     Return, "void",
                     Args, "int", "float", "float",
                     End),

        new Function(c, "glMapGrid2", GLModule::glMapGrid2f, None,
                     Return, "void",
                     Args, "int", "float", "float", "int", "float", "float",
                     End),

        new Function(c, "glMaterial", GLModule::glMaterialf, None,
                     Return, "void",
                     Args, "int", "int", "float",
                     End),

        new Function(c, "glMaterial", GLModule::glMateriali, None,
                     Return, "void",
                     Args, "int", "int", "int",
                     End),
        ...
        new Function(c, "glNewList", GLModule::glNewList, None,
                     Return, "void",
                     Args, "int", "int",
                     End),

        new Function(c, "glNormal", GLModule::glNormal3f, None,
                     Return, "void",
                     Args, "float", "float", "float",
                     End),

        new Function(c, "glNormal", GLModule::glNormal3fv, None,
                     Return, "void",
                     Args, "vector float[3]",
                     End),

        new Function(c, "glOrtho", GLModule::glOrtho, None,
                     Return, "void",
                     Args, "float", "float", "float", "float", "float", "float",
                     End),
        ...
        new Function(c, "glPixelZoom", GLModule::glPixelZoom, None,
                     Return, "void",
                     Args, "float", "float",
                     End),

        new Function(c, "glPointSize", GLModule::glPointSize, None,
                     Return, "void",
                     Args, "float", 
                     End),
        ...
        new Function(c, "glPolygonStipple", GLModule::glPolygonStipple, None,
                     Return, "void",
                     Args, "byte[32,32]",
                     End),

        new Function(c, "glPopAttrib", GLModule::glPopAttrib, None,
                     Return, "void",
                     End),

        new Function(c, "glPopClientAttrib", GLModule::glPopClientAttrib, None,
                     Return, "void",
                     End),

        new Function(c, "glPopMatrix", GLModule::glPopMatrix, None,
                     Return, "void",
                     End),

        new Function(c, "glPopName", GLModule::glPopName, None,
                     Return, "void",
                     End),
        ...
        new Function(c, "glPushClientAttrib", GLModule::glPushClientAttrib, None,
                     Return, "void",
                     Args, "int",
                     End),
        ...
        new Function(c, "glPushName", GLModule::glPushName, None,
                     Return, "void",
                     Args, "int",
                     End),
        ...
        new Function(c, "glReadPixels", GLModule::glReadPixels, None,
                     Return, "void",
                     Args, "int", "int", "int", "int", "int", "?dyn_array",
                     End),
        ...
        new Function(c, "glRotate", GLModule::glRotatef, None,
                     Return, "void",
                     Args, "float", "float", "float", "float",
                     End),

        new Function(c, "glScale", GLModule::glScalef, None,
                     Return, "void",
                     Args, "float", "float", "float",
                     End),

        new Function(c, "glScissor", GLModule::glScissor, None,
                     Return, "void",
        ...
        new Function(c, "glStencilOp", GLModule::glStencilOp, None,
                     Return, "void",
                     Args, "int", "int", "int",
                     End),

        new Function(c, "glTexCoord", GLModule::glTexCoord1f, None,
                     Return, "void",
                     Args, "float",
                     End),

        new Function(c, "glTexCoord", GLModule::glTexCoord2f, None,
                     Return, "void",
                     Args, "float", "float",
                     End),

        new Function(c, "glTexCoord", GLModule::glTexCoord2fv, None,
                     Return, "void",
                     Args, "vector float[2]",
                     End),

        new Function(c, "glTexCoord", GLModule::glTexCoord3f, None,
                     Return, "void",
                     Args, "float", "float", "float",
                     End),

        new Function(c, "glTexCoord", GLModule::glTexCoord3fv, None,
                     Return, "void",
                     Args, "vector float[3]",
                     End),

        new Function(c, "glTexEnv", GLModule::glTexEnvf, None,
                     Return, "void",
                     Args, "int", "int", "float",
                     End),

        new Function(c, "glTexEnv", GLModule::glTexEnvi, None,
                     Return, "void",
                     Args, "int", "int", "int",
                     End),

        new Function(c, "glTexGen", GLModule::glTexGenf, None,
                     Return, "void",
                     Args, "int", "int", "float",
                     End),

        new Function(c, "glTexGen", GLModule::glTexGeni, None,
                     Return, "void",
                     Args, "int", "int", "int",
                     End),
        ...
        new Function(c, "glTranslate", GLModule::glTranslatef, None,
                     Return, "void",
                     Args, "float", "float", "float",
                     End),

        new Function(c, "glViewport", GLModule::glViewport, None,
                     Return, "void",
                     Args, "int", "int", "int", "int",
                     End),

        new Function(c, "glVertex", GLModule::glVertex2f, None,
                     Return, "void",
                     Args, "float", "float", 
                     End),

        new Function(c, "glVertex", GLModule::glVertex3f, None,
                     Return, "void",
                     Args, "float", "float", "float",
                     End),

        new Function(c, "glVertex", GLModule::glVertex2fv, None,
                     Return, "void",
                     Args, "vector float[2]",
                     End),

        new Function(c, "glVertex", GLModule::glVertex3fv, None,
                     Return, "void",
                     Args, "vector float[3]",
                     End),

        new Function(c, "glVertexPointer", GLModule::glVertexPointer4fv, None,
                     Return, "void",
                     Args, "(vector float[4])[]",
                     End),

        new Function(c, "glVertexPointer", GLModule::glVertexPointer3fv, None,
                     Return, "void",
                     Args, "(vector float[3])[]",
                     End),

        new Function(c, "glVertexPointer", GLModule::glVertexPointer2fv, None,
                     Return, "void",
                     Args, "(vector float[2])[]",
                     End),

        new Function(c, "glNormalPointer", GLModule::glNormalPointer3fv, None,
                     Return, "void",
                     Args, "(vector float[3])[]",
                     End),
        ...
        new Function(c, "glTexCoordPointer", GLModule::glTexCoordPointer4fv, None,
                     Return, "void",
                     Args, "(vector float[4])[]",
                     End),

        new Function(c, "glTexCoordPointer", GLModule::glTexCoordPointer3fv, None,
                     Return, "void",
                     Args, "(vector float[3])[]",
                     End),

        new Function(c, "glTexCoordPointer", GLModule::glTexCoordPointer2fv, None,
                     Return, "void",
                     Args, "(vector float[2])[]",
                     End),

        new Function(c, "glTexCoordPointer", GLModule::glTexCoordPointer1f, None,
                     Return, "void",
                     Args, "float[]",
                     End),

        new Function(c, "glInterleavedArrays", GLModule::glInterleavedArrays, None,
                     Return, "void",
...
{
    ::glColor3f( NODE_ARG(0,float), NODE_ARG(1,float), 
                 NODE_ARG(2,float) );
}
...
{
    ::glColor4f( NODE_ARG(0,float), NODE_ARG(1,float), 
                 NODE_ARG(2,float), NODE_ARG(3,float) );
}
...
{
    ::glColorMask( NODE_ARG(0,bool), NODE_ARG(1,bool), 
                   NODE_ARG(2,bool), NODE_ARG(3,bool) );
}
...
{
    ::glCopyPixels( NODE_ARG(0,int), NODE_ARG(1,int),
...
{
    ::glCopyTexImage1D( NODE_ARG(0,int), NODE_ARG(1,int),
                        NODE_ARG(2,int), NODE_ARG(3,int),
...
{
    ::glCopyTexImage2D( NODE_ARG(0,int), NODE_ARG(1,int),
                        NODE_ARG(2,int), NODE_ARG(3,int),
                        NODE_ARG(4,int), NODE_ARG(5,int),
...
{
    ::glDrawArrays( NODE_ARG(0,int), NODE_ARG(1,int),
                    NODE_ARG(2,int) );
}
...
NODE_IMPLEMENTATION(GLModule::glEnd, void)
{
    ::glEnd();
}

NODE_IMPLEMENTATION(GLModule::glEndList, void)
{
    ::glEndList();
}
...
{
    ::glEvalMesh1( NODE_ARG(0,int), NODE_ARG(1,int),
                   NODE_ARG(2,int) );
}

NODE_IMPLEMENTATION(GLModule::glEvalMesh2, void)
{
    ::glEvalMesh2( NODE_ARG(0,int), NODE_ARG(1,int),
                   NODE_ARG(2,int), NODE_ARG(3,int),
                   NODE_ARG(4,int) );
}
...
NODE_IMPLEMENTATION(GLModule::glFinish, void)
{
    ::glFinish();
}

NODE_IMPLEMENTATION(GLModule::glFlush, void)
{
    ::glFlush();
}
...
{
    ::glFrustum( NODE_ARG(0,float), NODE_ARG(1,float),
                 NODE_ARG(2,float), NODE_ARG(3,float),
                 NODE_ARG(4,float), NODE_ARG(5,float) );
}
...
NODE_IMPLEMENTATION(GLModule::glInitNames, void)
{
    ::glInitNames();
}
...
{
    ::glLightf( NODE_ARG(0,int), NODE_ARG(1,int), 
                NODE_ARG(2,float) );
}
...
NODE_IMPLEMENTATION(GLModule::glLoadIdentity, void)
{
    ::glLoadIdentity();
}
...
{
    ::glMapGrid1f( NODE_ARG(0,int), NODE_ARG(1,float),
                   NODE_ARG(2,float) );
}

NODE_IMPLEMENTATION(GLModule::glMapGrid2f, void)
{
    ::glMapGrid2f( NODE_ARG(0,int), NODE_ARG(1,float),
                   NODE_ARG(2,float), NODE_ARG(3,int),
                   NODE_ARG(4,float), NODE_ARG(5,float) );
}

NODE_IMPLEMENTATION(GLModule::glMaterialf, void)
{
    ::glMaterialf( NODE_ARG(0,int), NODE_ARG(1,int),
                   NODE_ARG(2,float) );
}

NODE_IMPLEMENTATION(GLModule::glMateriali, void)
{
    ::glMateriali( NODE_ARG(0,int), NODE_ARG(1,int),
                   NODE_ARG(2,int) );
}
...
{
    ::glOrtho( NODE_ARG(0,float), NODE_ARG(1,float),
               NODE_ARG(2,float), NODE_ARG(3,float),
               NODE_ARG(4,float), NODE_ARG(5,float) );
}
...
NODE_IMPLEMENTATION(GLModule::glPopAttrib, void)
{
    ::glPopAttrib();
}
...
NODE_IMPLEMENTATION(GLModule::glPopMatrix, void)
{
    ::glPopMatrix();
}

NODE_IMPLEMENTATION(GLModule::glPopName, void)
{
    ::glPopName();
}
...
NODE_IMPLEMENTATION(GLModule::glPushMatrix, void)
{
    ::glPushMatrix();
}
...
{
    ::glRotatef( NODE_ARG(0,float), NODE_ARG(1,float),
                 NODE_ARG(2,float), NODE_ARG(3,float) );
}

NODE_IMPLEMENTATION(GLModule::glScalef, void)
{
    ::glScalef( NODE_ARG(0,float), NODE_ARG(1,float),
                NODE_ARG(2,float) );
}

NODE_IMPLEMENTATION(GLModule::glScissor, void)
{
    ::glScissor( NODE_ARG(0,int), NODE_ARG(1,int),
                 NODE_ARG(2,int), NODE_ARG(3,int) );
}
...
{
    ::glStencilFunc( NODE_ARG(0,int), NODE_ARG(1,int),
                     NODE_ARG(2,int) );
}
...
{
    ::glStencilOp( NODE_ARG(0,int), NODE_ARG(1,int),
                   NODE_ARG(2,int) );
}
...
{
    ::glTexEnvf( NODE_ARG(0,int), NODE_ARG(1,int),
                 NODE_ARG(2,float) );
}

NODE_IMPLEMENTATION(GLModule::glTexEnvi, void)
{
    ::glTexEnvi( NODE_ARG(0,int), NODE_ARG(1,int),
                 NODE_ARG(2,int) );
}

NODE_IMPLEMENTATION(GLModule::glTexGenf, void)
{
    ::glTexGenf( NODE_ARG(0,int), NODE_ARG(1,int),
                 NODE_ARG(2,float) );
}

NODE_IMPLEMENTATION(GLModule::glTexGeni, void)
{
    ::glTexGeni( NODE_ARG(0,int), NODE_ARG(1,int),
                 NODE_ARG(2,int) );
}
...
{
    ::glTexParameteri( NODE_ARG(0,int), NODE_ARG(1,int),
                       NODE_ARG(2,int) );
}
...
{
    ::glViewport( NODE_ARG(0,int), NODE_ARG(1,int),
                  NODE_ARG(2,int), NODE_ARG(3,int) );
}
...
NODE_IMPLEMENTATION(GLModule::glInterleavedArrays, void)
{
    ...
    ::glInterleavedArrays(NODE_ARG(0, int), 
                          NODE_ARG(1, int), 
                          array->data<GLvoid>());
}
