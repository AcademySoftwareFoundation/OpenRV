...
IOModule::load()
{
    ...
    addSymbols( streamType,
                ...
                /* AJG - Linux dirent64 d_type's - not needed in win32 'cuz there is no d_type */
#if !defined _MSC_VER
...
#endif
                new Function(c, "print", IOModule::printString, None,
                             Return, os,
                             Args, os, "string", End),

                new Function(c, "print", IOModule::print_int, None,
                             Return, os,
                             Args, os, "int", End),

                new Function(c, "print", IOModule::print_float, None,
                             Return, os,
                             Args, os, "float", End),

                new Function(c, "print", IOModule::print_double, None,
                             Return, os,
                             Args, os, "double", End),

                new Function(c, "print", IOModule::print_bool, None,
                             Return, os,
                             Args, os, "bool", End),

                new Function(c, "print", IOModule::print_byte, None,
                             Return, os,
                             Args, os, "byte", End),

                new Function(c, "print", IOModule::print_char, None,
                             Return, os,
                             Args, os, "char", End),

                new Function(c, "endl", IOModule::print_endl, None,
                             Return, os,
                             Args, os, End),

                new Function(c, "flush", IOModule::print_flush, None,
                             Return, os,
                             Args, os, End),

                new Function(c, "read_string", IOModule::readString, None,
                             Return, "string",
                             Parameters, 
                             new Param(c, "is", is),
                             new Param(c, "count", "int", Value(int(1))),
                             End),

                new Function(c, "read_int", IOModule::read_int, None,
                             Return, "int",
                             Args, is, End),

                new Function(c, "read_float", IOModule::read_float, None,
                             Return, "float",
                             Args, is, End),

                new Function(c, "read_double", IOModule::read_double, None,
                             Return, "double",
                             Args, is, End),

                new Function(c, "read_bool", IOModule::read_bool, None,
                             Return, "bool",
                             Args, is, End),

                new Function(c, "read_byte", IOModule::read_byte, None,
                             Return, "byte",
                             Args, is, End),

                new Function(c, "read_char", IOModule::read_char, None,
                             Return, "char",
                             Args, is, End),

                new Function(c, "read_line", IOModule::read_line, None,
                             Return, "string",
                             Args, is, "char", End),

                new Function(c, "read_all", IOModule::read_all, None,
                             Return, "string",
                             Args, is, End),
                ...
                new Function(c, "serialize", IOModule::serialize, None,
                             Return, "int",
                             Args, os, "object", End),

                new Function(c, "deserialize", IOModule::deserialize, None,
                             Return, "object",
                             Args, is, End),

                new Function(c, "out", IOModule::out, None,
                             Return, os,
                             End),

                new Function(c, "err", IOModule::err, None,
                             Return, os,
                             End),

                new Function(c, "in", IOModule::in, None,
                             Return, is,
                             End),

                new Function(c, "directory", IOModule::directory, 
                             None,
                             Return, "[(string,int)]",
                             Args, "string",
                             End),
    ...
    path->addSymbols( new Function(c, "basename", IOModule::basename, Mapped, 
                                   Return, "string",
                                   Args, "string",
                                   End),

                      new Function(c, "dirname", IOModule::dirname, Mapped, 
                                   Return, "string",
                                   Args, "string",
                                   End),

                      new Function(c, "extension", IOModule::extension, Mapped, 
                                   Return, "string",
                                   Args, "string",
                                   End),

                      new Function(c, "without_extension", IOModule::without_extension, Mapped, 
                                   Return, "string",
                                   Args, "string",
                                   End),

                      new Function(c, "exists", IOModule::exists, None, 
                                   Return, "bool",
                                   Args, "string",
                                   End),

                      new Function(c, "expand", IOModule::expand, None, 
                                   Return, "string",
                                   Args, "string",
                                   End),

                      new Function(c, "join", IOModule::join, None,
                                   Return, "string",
                                   Args, "string", "string",
                                   End),
                      ...
                      new Function(c, "path_separator", IOModule::path_separator,
                                   None,
                                   Return, "string",
                                   End),
...
NODE_IMPLEMENTATION(IOModule::dirname, Pointer)
{
    ...
    if (i > 0 && i == s->size()-1) i = s->utf8().rfind(delimiter, i-1);
...
#if defined _MSC_VER
    /* AJG - incomplete rewrite!  Probably have to look to fox to figure out how to do this right */
