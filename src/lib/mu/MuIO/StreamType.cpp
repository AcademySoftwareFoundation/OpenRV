...
StreamType::StreamType(Context* c, const char* name, Class *super) : Class(c, name, super)
{
...
Object*
StreamType::newObject() const
{
    return new Stream(this);
}

void
StreamType::deleteObject(Object *obj) const
{
    delete static_cast<StreamType::Stream*>(obj);
}

void 
StreamType::outputValue(ostream &o, const Value &value, bool full) const
{
...
void 
StreamType::outputValueRecursive(ostream &o,
