...
void 
OFStreamType::finalizer (void* obj, void* data)
{
...
Object*
OFStreamType::newObject() const
{
    return new OFStream(this);
}

void
OFStreamType::deleteObject(Object *obj) const
{
...
OFStreamType::load()
{
    ...
    s->addSymbols( new ReferenceType(c, "ofstream&", this), 
		   ...
		   new Function(c, "ofstream", OFStreamType::construct0, None,
				Return, tn, End),
		   ...
		   new Function(c, "ofstream", OFStreamType::construct1, None,
				Return, tn,
				Args, "string", "int", End),

		   new Function(c, "ofstream", BaseFunctions::dereference, Cast,
				Return, tn,
				Args, rn, End),
    ...
    addSymbols( new Function(c, "close", OFStreamType::close, None,
                             Return, "void",
                             Args, tn, End),

                new Function(c, "open", OFStreamType::open, None,
                             Return, "void",
