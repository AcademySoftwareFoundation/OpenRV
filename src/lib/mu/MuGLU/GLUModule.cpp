...
//        newGlConstant( GLU_EXT_nurbs_tessellator ),
        ...
        /* Boolean */
        newGlConstant( GLU_FALSE ),
        newGlConstant( GLU_TRUE ),

        /* Version */
        newGlConstant( GLU_VERSION_1_1 ),
        newGlConstant( GLU_VERSION_1_2 ),
//        newGlConstant( GLU_VERSION_1_3 ),

        /* StringName */
        newGlConstant( GLU_VERSION ),
        newGlConstant( GLU_EXTENSIONS ),

        /* ErrorCode */
        newGlConstant( GLU_INVALID_ENUM ),
        newGlConstant( GLU_INVALID_VALUE ),
...
//        newGlConstant( GLU_NURBS_END_DATA_EXT ),
        ...
        /* NurbsError */
        newGlConstant( GLU_NURBS_ERROR1 ),
        newGlConstant( GLU_NURBS_ERROR2 ),
        newGlConstant( GLU_NURBS_ERROR3 ),
        newGlConstant( GLU_NURBS_ERROR4 ),
        newGlConstant( GLU_NURBS_ERROR5 ),
        newGlConstant( GLU_NURBS_ERROR6 ),
        newGlConstant( GLU_NURBS_ERROR7 ),
        newGlConstant( GLU_NURBS_ERROR8 ),
        newGlConstant( GLU_NURBS_ERROR9 ),
        newGlConstant( GLU_NURBS_ERROR10 ),
        newGlConstant( GLU_NURBS_ERROR11 ),
        newGlConstant( GLU_NURBS_ERROR12 ),
        newGlConstant( GLU_NURBS_ERROR13 ),
        newGlConstant( GLU_NURBS_ERROR14 ),
        newGlConstant( GLU_NURBS_ERROR15 ),
        newGlConstant( GLU_NURBS_ERROR16 ),
        newGlConstant( GLU_NURBS_ERROR17 ),
        newGlConstant( GLU_NURBS_ERROR18 ),
        newGlConstant( GLU_NURBS_ERROR19 ),
        newGlConstant( GLU_NURBS_ERROR20 ),
        newGlConstant( GLU_NURBS_ERROR21 ),
        newGlConstant( GLU_NURBS_ERROR22 ),
        newGlConstant( GLU_NURBS_ERROR23 ),
        newGlConstant( GLU_NURBS_ERROR24 ),
        newGlConstant( GLU_NURBS_ERROR25 ),
        newGlConstant( GLU_NURBS_ERROR26 ),
        newGlConstant( GLU_NURBS_ERROR27 ),
        newGlConstant( GLU_NURBS_ERROR28 ),
        newGlConstant( GLU_NURBS_ERROR29 ),
        newGlConstant( GLU_NURBS_ERROR30 ),
        newGlConstant( GLU_NURBS_ERROR31 ),
        newGlConstant( GLU_NURBS_ERROR32 ),
        newGlConstant( GLU_NURBS_ERROR33 ),
        newGlConstant( GLU_NURBS_ERROR34 ),
        newGlConstant( GLU_NURBS_ERROR35 ),
        newGlConstant( GLU_NURBS_ERROR36 ),
        newGlConstant( GLU_NURBS_ERROR37 ),

        /* NurbsProperty */
        newGlConstant( GLU_AUTO_LOAD_MATRIX ),
        newGlConstant( GLU_CULLING ),
        newGlConstant( GLU_SAMPLING_TOLERANCE ),
        newGlConstant( GLU_DISPLAY_MODE ),
        newGlConstant( GLU_PARAMETRIC_TOLERANCE ),
        newGlConstant( GLU_SAMPLING_METHOD ),
        newGlConstant( GLU_U_STEP ),
...
//        newGlConstant( GLU_OBJECT_PATH_LENGTH_EXT ),
        newGlConstant( GLU_PATH_LENGTH ),
        newGlConstant( GLU_PARAMETRIC_ERROR ),
        newGlConstant( GLU_DOMAIN_DISTANCE ),

        /* NurbsTrim */
        newGlConstant( GLU_MAP1_TRIM_2 ),
        newGlConstant( GLU_MAP1_TRIM_3 ),

        /* QuadricDrawStyle */
        newGlConstant( GLU_POINT ),
        newGlConstant( GLU_LINE ),
        newGlConstant( GLU_FILL ),
        newGlConstant( GLU_SILHOUETTE ),

        /* QuadricCallback */
        /* ), */

        /* QuadricNormal */
        newGlConstant( GLU_SMOOTH ),
        newGlConstant( GLU_FLAT ),
        newGlConstant( GLU_NONE ),

        /* QuadricOrientation */
        newGlConstant( GLU_OUTSIDE ),
        newGlConstant( GLU_INSIDE ),

        /* TessCallback */
        newGlConstant( GLU_TESS_BEGIN ),
        newGlConstant( GLU_BEGIN ),
        newGlConstant( GLU_TESS_VERTEX ),
        newGlConstant( GLU_VERTEX ),
        newGlConstant( GLU_TESS_END ),
        newGlConstant( GLU_END ),
        newGlConstant( GLU_TESS_ERROR ),
        newGlConstant( GLU_TESS_EDGE_FLAG ),
        newGlConstant( GLU_EDGE_FLAG ),
        newGlConstant( GLU_TESS_COMBINE ),
        ...
        /* TessContour */
        newGlConstant( GLU_CW ),
        newGlConstant( GLU_CCW ),
        newGlConstant( GLU_INTERIOR ),
        newGlConstant( GLU_EXTERIOR ),
        ...
        /* TessError */
        newGlConstant( GLU_TESS_ERROR1 ),
        newGlConstant( GLU_TESS_ERROR2 ),
        newGlConstant( GLU_TESS_ERROR3 ),
        newGlConstant( GLU_TESS_ERROR4 ),
        newGlConstant( GLU_TESS_ERROR5 ),
        newGlConstant( GLU_TESS_ERROR6 ),
        newGlConstant( GLU_TESS_ERROR7 ),
        newGlConstant( GLU_TESS_ERROR8 ),
        ...
        new Function(c, "gluBuild2DMipmaps", GLUModule::gluBuild2DMipmaps, None,
                      Return, "int",
                      Args, "int", "int", "int", "int", "int", "?class",
                      End ),

        new Function(c, "gluCheckExtension", GLUModule::gluCheckExtension, None,
                      Return, "bool",
                      Args, "string", "string",
                      End ),
        ...
        new Function(c, "gluLookAt", GLUModule::gluLookAt, None,
                      Return, "void",
                      Args, "float", "float", "float", "float", "float", 
                            "float", "float", "float", "float", 
                      End ),

        new Function(c, "gluLookAt", GLUModule::gluLookAtv, None,
                      Return, "void",
                      Args, "vector float[3]", "vector float[3]", 
                            "vector float[3]", 
                      End ),

        new Function(c, "gluOrtho2D", GLUModule::gluOrtho2D, None,
                      Return, "void",
...
{
    ::gluLookAt( NODE_ARG(0,float), NODE_ARG(1,float), 
                 NODE_ARG(2,float), NODE_ARG(3,float), 
                 NODE_ARG(4,float), NODE_ARG(5,float), 
                 NODE_ARG(6,float), NODE_ARG(7,float), 
                 NODE_ARG(8,float) );
}
...
{
    ::gluOrtho2D( NODE_ARG(0,float), NODE_ARG(1,float), 
                  NODE_ARG(2,float), NODE_ARG(3,float) );
}
...
NODE_IMPLEMENTATION(GLUModule::gluScaleImage, int)
{
    ...
    NODE_RETURN( ::gluScaleImage( format, 
                                  wIn, hIn, typeIn, dataIn->data<void>(),
                                  wOut, hOut, typeOut, dataOut->data<void>() 
                                ) 
               );
}
