...
Pointer qt_QTextStream_codec_QTextCodec_QTextStream(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTextStream * arg0 = getqpointer<QTextStreamType>(param_this);
...
void qt_QTextStream_setCodec_void_QTextStream_QTextCodec(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_codec)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTextStream * arg0 = getqpointer<QTextStreamType>(param_this);
...
{
    NODE_RETURN(qt_QTextStream_codec_QTextCodec_QTextStream(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    qt_QTextStream_flush_void_QTextStream(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    qt_QTextStream_reset_void_QTextStream(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    qt_QTextStream_setCodec_void_QTextStream_QTextCodec(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
addSymbols(
    new Alias(c, "FieldAlignment", "int"),
      new SymbolicConstant(c, "AlignLeft", "int", Value(int(QTextStream::AlignLeft))),
    ...
    new Alias(c, "RealNumberNotation", "int"),
      ...
      new SymbolicConstant(c, "SmartNotation", "int", Value(int(QTextStream::SmartNotation))),
    new Alias(c, "Status", "int"),
      ...
      new SymbolicConstant(c, "WriteFailed", "int", Value(int(QTextStream::WriteFailed))),
    EndArguments);
...
addSymbols(
    ...
    // MISSING: QTextStream (QTextStream; QTextStream this, "FILE *" fileHandle, flags QIODevice::OpenMode openMode)
    ...
    new Function(c, "codec", _n_codec0, None, Compiled, qt_QTextStream_codec_QTextCodec_QTextStream, Return, "qt.QTextCodec", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    ...
    new Function(c, "fieldAlignment", _n_fieldAlignment0, None, Compiled, qt_QTextStream_fieldAlignment_int_QTextStream, Return, "int", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    new Function(c, "fieldWidth", _n_fieldWidth0, None, Compiled, qt_QTextStream_fieldWidth_int_QTextStream, Return, "int", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    new Function(c, "flush", _n_flush0, None, Compiled, qt_QTextStream_flush_void_QTextStream, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    new Function(c, "generateByteOrderMark", _n_generateByteOrderMark0, None, Compiled, qt_QTextStream_generateByteOrderMark_bool_QTextStream, Return, "bool", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    new Function(c, "integerBase", _n_integerBase0, None, Compiled, qt_QTextStream_integerBase_int_QTextStream, Return, "int", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    // MISSING: locale ("QLocale"; QTextStream this)
    new Function(c, "numberFlags", _n_numberFlags0, None, Compiled, qt_QTextStream_numberFlags_int_QTextStream, Return, "int", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    // MISSING: padChar ("QChar"; QTextStream this)
    new Function(c, "pos", _n_pos0, None, Compiled, qt_QTextStream_pos_int64_QTextStream, Return, "int64", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    new Function(c, "read", _n_read0, None, Compiled, qt_QTextStream_read_string_QTextStream_int64, Return, "string", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "maxlen", "int64"), End),
    new Function(c, "readAll", _n_readAll0, None, Compiled, qt_QTextStream_readAll_string_QTextStream, Return, "string", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    new Function(c, "readLine", _n_readLine0, None, Compiled, qt_QTextStream_readLine_string_QTextStream_int64, Return, "string", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "maxlen", "int64"), End),
    new Function(c, "realNumberNotation", _n_realNumberNotation0, None, Compiled, qt_QTextStream_realNumberNotation_int_QTextStream, Return, "int", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    new Function(c, "realNumberPrecision", _n_realNumberPrecision0, None, Compiled, qt_QTextStream_realNumberPrecision_int_QTextStream, Return, "int", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    new Function(c, "reset", _n_reset0, None, Compiled, qt_QTextStream_reset_void_QTextStream, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    new Function(c, "resetStatus", _n_resetStatus0, None, Compiled, qt_QTextStream_resetStatus_void_QTextStream, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    new Function(c, "seek", _n_seek0, None, Compiled, qt_QTextStream_seek_bool_QTextStream_int64, Return, "bool", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "pos", "int64"), End),
    new Function(c, "setAutoDetectUnicode", _n_setAutoDetectUnicode0, None, Compiled, qt_QTextStream_setAutoDetectUnicode_void_QTextStream_bool, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "enabled", "bool"), End),
    new Function(c, "setCodec", _n_setCodec0, None, Compiled, qt_QTextStream_setCodec_void_QTextStream_QTextCodec, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "codec", "qt.QTextCodec"), End),
    // MISSING: setCodec (void; QTextStream this, "const char *" codecName)
    new Function(c, "setDevice", _n_setDevice0, None, Compiled, qt_QTextStream_setDevice_void_QTextStream_QIODevice, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "device", "qt.QIODevice"), End),
    new Function(c, "setFieldAlignment", _n_setFieldAlignment0, None, Compiled, qt_QTextStream_setFieldAlignment_void_QTextStream_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "mode", "int"), End),
    new Function(c, "setFieldWidth", _n_setFieldWidth0, None, Compiled, qt_QTextStream_setFieldWidth_void_QTextStream_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "width", "int"), End),
    new Function(c, "setGenerateByteOrderMark", _n_setGenerateByteOrderMark0, None, Compiled, qt_QTextStream_setGenerateByteOrderMark_void_QTextStream_bool, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "generate", "bool"), End),
    new Function(c, "setIntegerBase", _n_setIntegerBase0, None, Compiled, qt_QTextStream_setIntegerBase_void_QTextStream_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "base", "int"), End),
    // MISSING: setLocale (void; QTextStream this, "const QLocale &" locale)
    new Function(c, "setNumberFlags", _n_setNumberFlags0, None, Compiled, qt_QTextStream_setNumberFlags_void_QTextStream_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "flags", "int"), End),
    // MISSING: setPadChar (void; QTextStream this, "QChar" ch)
    new Function(c, "setRealNumberNotation", _n_setRealNumberNotation0, None, Compiled, qt_QTextStream_setRealNumberNotation_void_QTextStream_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "notation", "int"), End),
    new Function(c, "setRealNumberPrecision", _n_setRealNumberPrecision0, None, Compiled, qt_QTextStream_setRealNumberPrecision_void_QTextStream_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "precision", "int"), End),
    new Function(c, "setStatus", _n_setStatus0, None, Compiled, qt_QTextStream_setStatus_void_QTextStream_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "status", "int"), End),
    new Function(c, "skipWhiteSpace", _n_skipWhiteSpace0, None, Compiled, qt_QTextStream_skipWhiteSpace_void_QTextStream, Return, "void", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    new Function(c, "status", _n_status0, None, Compiled, qt_QTextStream_status_int_QTextStream, Return, "int", Parameters, new Param(c, "this", "qt.QTextStream"), End),
    // static functions
    EndArguments);
