...
namespace Mu
{
    ...
    void QTextStreamType::load()
    {
        ...
        addSymbols(
            // enums
            // member functions
            new Function(c, "QTextStream", _n_QTextStream0, None, Compiled, qt_QTextStream_QTextStream_QTextStream_QTextStream, Return,
            ...
            new Function(c, "codec", _n_codec0, None, Compiled, qt_QTextStream_codec_QTextCodec_QTextStream, Return, "qt.QTextCodec",
            ...
            new Function(c, "setCodec", _n_setCodec0, None, Compiled, qt_QTextStream_setCodec_void_QTextStream_QTextCodec, Return, "void",
                         Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "codec", "qt.QTextCodec"), End),
