...
addSymbols(
    ...
    // MISSING: connectToHost (void; QUdpSocket this, string hostName, "quint16" port, "OpenMode" openMode, flags QAbstractSocket::NetworkLayerProtocol protocol)
    ...
    // MISSING: setSocketDescriptor (bool; QUdpSocket this, "qintptr" socketDescriptor, flags QAbstractSocket::SocketState socketState, "OpenMode" openMode)
    ...
    _func[7] = new MemberFunction(c, "atEnd", _n_atEnd0, None, Compiled, qt_QUdpSocket_atEnd_bool_QUdpSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
    _func[8] = new MemberFunction(c, "bytesAvailable", _n_bytesAvailable0, None, Compiled, qt_QUdpSocket_bytesAvailable_int64_QUdpSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
    _func[9] = new MemberFunction(c, "bytesToWrite", _n_bytesToWrite0, None, Compiled, qt_QUdpSocket_bytesToWrite_int64_QUdpSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
    _func[10] = new MemberFunction(c, "canReadLine", _n_canReadLine0, None, Compiled, qt_QUdpSocket_canReadLine_bool_QUdpSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
    _func[11] = new MemberFunction(c, "close", _n_close0, None, Compiled, qt_QUdpSocket_close_void_QUdpSocket, Return, "void", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
    _func[12] = new MemberFunction(c, "isSequential", _n_isSequential0, None, Compiled, qt_QUdpSocket_isSequential_bool_QUdpSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
    _func[13] = new MemberFunction(c, "waitForBytesWritten", _n_waitForBytesWritten0, None, Compiled, qt_QUdpSocket_waitForBytesWritten_bool_QUdpSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QUdpSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    _func[14] = new MemberFunction(c, "waitForReadyRead", _n_waitForReadyRead0, None, Compiled, qt_QUdpSocket_waitForReadyRead_bool_QUdpSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QUdpSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
