    ...
    void QUdpSocketType::load()
    {
        ...
        addSymbols(
            ...
            _func[6] = new MemberFunction(c, "waitForDisconnected", _n_waitForDisconnected0, None, Compiled,
                                          ...
                                          new Param(c, "this", "qt.QUdpSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
            _func[7] = new MemberFunction(c, "atEnd", _n_atEnd0, None, Compiled, qt_QUdpSocket_atEnd_bool_QUdpSocket, Return, "bool",
                                          Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
            _func[8] =
            ...
            _func[9] = new MemberFunction(c, "bytesToWrite", _n_bytesToWrite0, None, Compiled, qt_QUdpSocket_bytesToWrite_int64_QUdpSocket,
                                          Return, "int64", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
            _func[10] = new MemberFunction(c, "canReadLine", _n_canReadLine0, None, Compiled, qt_QUdpSocket_canReadLine_bool_QUdpSocket,
                                           Return, "bool", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
            _func[11] = new MemberFunction(c, "close", _n_close0, None, Compiled, qt_QUdpSocket_close_void_QUdpSocket, Return, "void",
                                           Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
            _func[12] = new MemberFunction(c, "isSequential", _n_isSequential0, None, Compiled, qt_QUdpSocket_isSequential_bool_QUdpSocket,
                                           Return, "bool", Parameters, new Param(c, "this", "qt.QUdpSocket"), End),
