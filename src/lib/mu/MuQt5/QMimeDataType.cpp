...
namespace Mu
{
    ...
    Pointer qt_QMimeData_retrieveData_QVariant_QMimeData_string_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_mimeType,
                                                                    int param_type)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QMimeData* arg0 = object<QMimeData>(param_this);
        ...
        return isMuQtObject(arg0) ? makeqtype<QVariantType>(c, ((MuQt_QMimeData*)arg0)->retrieveData_pub_parent(arg1, arg2), "qt.QVariant")
                                  : makeqtype<QVariantType>(c, ((MuQt_QMimeData*)arg0)->retrieveData_pub(arg1, arg2), "qt.QVariant");
    }
    ...
    {
        NODE_RETURN(qt_QMimeData_retrieveData_QVariant_QMimeData_string_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                            NODE_ARG(2, int)));
    }
    ...
    void QMimeDataType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "urls", _n_urls0, None, Compiled, qt_QMimeData_urls_qt__QUrlBSB_ESB__QMimeData, Return, "qt.QUrl[]", Parameters,
                         new Param(c, "this", "qt.QMimeData"), End),
            _func[2] = new MemberFunction(c, "retrieveData", _n_retrieveData0, None, Compiled,
                                          qt_QMimeData_retrieveData_QVariant_QMimeData_string_int, Return, "qt.QVariant", Parameters,
                                          new Param(c, "this", "qt.QMimeData"), new Param(c, "mimeType", "string"),
                                          new Param(c, "type", "int"), End),
            _func[3] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QMimeData_event_bool_QMimeData_QEvent, Return, "bool",
                                          Parameters, new Param(c, "this", "qt.QMimeData"), new Param(c, "e", "qt.QEvent"), End),
            _func[4] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled,
            ...
            _func[5] = new MemberFunction(c, "customEvent", _n_customEvent0, None, Compiled, qt_QMimeData_customEvent_void_QMimeData_QEvent,
                                          Return, "void", Parameters, new Param(c, "this", "qt.QMimeData"),
                                          new Param(c, "event", "qt.QEvent"), End),
            // MISSING: disconnectNotify (void; QMimeData this, "const
            // QMetaMethod &" signal) // protected
            _func[6] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled,
