...
void qt_QItemSelectionRange_swap_void_QItemSelectionRange_QItemSelectionRange(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_other)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QItemSelectionRange arg0 = getqtype<QItemSelectionRangeType>(param_this);
...
{
    qt_QItemSelectionRange_swap_void_QItemSelectionRange_QItemSelectionRange(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
addSymbols(
    ...
    // MISSING: QItemSelectionRange (QItemSelectionRange; QItemSelectionRange this, QItemSelectionRange other)
    new Function(c, "QItemSelectionRange", _n_QItemSelectionRange3, None, Compiled, qt_QItemSelectionRange_QItemSelectionRange_QItemSelectionRange_QItemSelectionRange_QModelIndex_QModelIndex, Return, "qt.QItemSelectionRange", Parameters, new Param(c, "this", "qt.QItemSelectionRange"), new Param(c, "topLeft", "qt.QModelIndex"), new Param(c, "bottomRight", "qt.QModelIndex"), End),
    new Function(c, "QItemSelectionRange", _n_QItemSelectionRange4, None, Compiled, qt_QItemSelectionRange_QItemSelectionRange_QItemSelectionRange_QItemSelectionRange_QModelIndex, Return, "qt.QItemSelectionRange", Parameters, new Param(c, "this", "qt.QItemSelectionRange"), new Param(c, "index", "qt.QModelIndex"), End),
    ...
    new Function(c, "swap", _n_swap0, None, Compiled, qt_QItemSelectionRange_swap_void_QItemSelectionRange_QItemSelectionRange, Return, "void", Parameters, new Param(c, "this", "qt.QItemSelectionRange"), new Param(c, "other", "qt.QItemSelectionRange"), End),
...
globalScope()->addSymbols(
    ...
    // MISSING: = (QItemSelectionRange; QItemSelectionRange this, QItemSelectionRange other)
    // MISSING: = (QItemSelectionRange; QItemSelectionRange this, QItemSelectionRange other)
