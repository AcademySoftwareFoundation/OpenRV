...
globalScope()->addSymbols(
    ...
    EndArguments);
scope()->addSymbols(
    new Function(c, "QVariant", _co_n_QVariant0, Cast, Compiled, qt_QCursor_QVariant_QVariant_QVariant_QCursor, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QVariant"), new Param(c, "from", "qt.QCursor"), End),
    EndArguments);
