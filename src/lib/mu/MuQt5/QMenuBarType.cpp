...
{
    if (!_env) return QMenuBar::heightForWidth(_p4);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QMenuBar::focusInEvent(_p14); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QMenuBar::focusOutEvent(_p14); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QMenuBar::leaveEvent(_p9); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QMenuBar::resizeEvent(_p15); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QMenuBar::hasHeightForWidth();
    MuLangContext* c = (MuLangContext*)_env->context();
...
addSymbols(
    ...
    new Function(c, "cornerWidget", _n_cornerWidget0, None, Compiled, qt_QMenuBar_cornerWidget_QWidget_QMenuBar_int, Return, "qt.QWidget", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "corner", "int", Value((int)Qt::TopRightCorner)), End),
    ...
    new Function(c, "setCornerWidget", _n_setCornerWidget0, None, Compiled, qt_QMenuBar_setCornerWidget_void_QMenuBar_QWidget_int, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "widget", "qt.QWidget"), new Param(c, "corner", "int", Value((int)Qt::TopRightCorner)), End),
    ...
    _func[0] = new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QMenuBar_heightForWidth_int_QMenuBar_int, Return, "int", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "_p4", "int"), End),
    ...
    _func[6] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QMenuBar_focusInEvent_void_QMenuBar_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "_p14", "qt.QFocusEvent"), End),
    _func[7] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QMenuBar_focusOutEvent_void_QMenuBar_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "_p14", "qt.QFocusEvent"), End),
    ...
    _func[9] = new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QMenuBar_leaveEvent_void_QMenuBar_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "_p9", "qt.QEvent"), End),
    ...
    _func[14] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QMenuBar_resizeEvent_void_QMenuBar_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "_p15", "qt.QResizeEvent"), End),
    ...
    _func[16] = new MemberFunction(c, "hasHeightForWidth", _n_hasHeightForWidth0, None, Compiled, qt_QMenuBar_hasHeightForWidth_bool_QMenuBar, Return, "bool", Parameters, new Param(c, "this", "qt.QMenuBar"), End),
    _func[17] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QMenuBar_inputMethodQuery_QVariant_QMenuBar_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "query", "int"), End),
    // MISSING: paintEngine ("QPaintEngine *"; QMenuBar this)
    _func[18] = new MemberFunction(c, "closeEvent", _n_closeEvent0, None, Compiled, qt_QMenuBar_closeEvent_void_QMenuBar_QCloseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QCloseEvent"), End),
    _func[19] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled, qt_QMenuBar_contextMenuEvent_void_QMenuBar_QContextMenuEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QContextMenuEvent"), End),
    _func[20] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QMenuBar_dragEnterEvent_void_QMenuBar_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QDragEnterEvent"), End),
    _func[21] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QMenuBar_dragLeaveEvent_void_QMenuBar_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QDragLeaveEvent"), End),
    _func[22] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QMenuBar_dragMoveEvent_void_QMenuBar_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QDragMoveEvent"), End),
    _func[23] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QMenuBar_dropEvent_void_QMenuBar_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QDropEvent"), End),
    _func[24] = new MemberFunction(c, "enterEvent", _n_enterEvent0, None, Compiled, qt_QMenuBar_enterEvent_void_QMenuBar_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QEvent"), End),
    _func[25] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QMenuBar_focusNextPrevChild_bool_QMenuBar_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "next", "bool"), End),
    _func[26] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QMenuBar_hideEvent_void_QMenuBar_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QHideEvent"), End),
    // MISSING: inputMethodEvent (void; QMenuBar this, "QInputMethodEvent *" event) // protected
    _func[27] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QMenuBar_keyReleaseEvent_void_QMenuBar_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[28] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QMenuBar_mouseDoubleClickEvent_void_QMenuBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[29] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QMenuBar_moveEvent_void_QMenuBar_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QMenuBar this, QByteArray eventType, "void *" message, "long *" result) // protected
    _func[30] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QMenuBar_showEvent_void_QMenuBar_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QShowEvent"), End),
    _func[31] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QMenuBar_tabletEvent_void_QMenuBar_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QTabletEvent"), End),
    _func[32] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QMenuBar_wheelEvent_void_QMenuBar_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QWheelEvent"), End),
    // MISSING: initPainter (void; QMenuBar this, "QPainter *" painter) // protected
