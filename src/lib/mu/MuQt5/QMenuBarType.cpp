...
namespace Mu
{
    ...
    int qt_QMenuBar_heightForWidth_int_QMenuBar_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param__p4)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QMenuBar* arg0 = object<QMenuBar>(param_this);
    ...
    void QMenuBarType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "addAction", _n_addAction0, None, Compiled, qt_QMenuBar_addAction_QAction_QMenuBar_string, Return, "qt.QAction",
                         Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "text", "string"), End),
            ...
            _func[0] =
                new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QMenuBar_heightForWidth_int_QMenuBar_int,
                                   Return, "int", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "_p4", "int"), End),
            _func[1] =
            ...
            _func[24] =
                new MemberFunction(c, "enterEvent", _n_enterEvent0, None, Compiled, qt_QMenuBar_enterEvent_void_QMenuBar_QEvent, Return,
                                   "void", Parameters, new Param(c, "this", "qt.QMenuBar"), new Param(c, "event", "qt.QEvent"), End),
            _func[25] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled,
            ...
            _func[27] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled,
            ...
            _func[28] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled,
