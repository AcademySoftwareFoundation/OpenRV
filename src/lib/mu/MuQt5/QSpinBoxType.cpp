...
addSymbols(
    ...
    _func[7] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled, qt_QSpinBox_changeEvent_void_QSpinBox_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QEvent"), End),
    _func[8] = new MemberFunction(c, "closeEvent", _n_closeEvent0, None, Compiled, qt_QSpinBox_closeEvent_void_QSpinBox_QCloseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QCloseEvent"), End),
    _func[9] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled, qt_QSpinBox_contextMenuEvent_void_QSpinBox_QContextMenuEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QContextMenuEvent"), End),
    _func[10] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QSpinBox_focusInEvent_void_QSpinBox_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[11] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QSpinBox_focusOutEvent_void_QSpinBox_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[12] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QSpinBox_hideEvent_void_QSpinBox_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QHideEvent"), End),
    _func[13] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QSpinBox_keyPressEvent_void_QSpinBox_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[14] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QSpinBox_keyReleaseEvent_void_QSpinBox_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[15] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QSpinBox_mouseMoveEvent_void_QSpinBox_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[16] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QSpinBox_mousePressEvent_void_QSpinBox_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[17] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QSpinBox_mouseReleaseEvent_void_QSpinBox_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[18] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QSpinBox_paintEvent_void_QSpinBox_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QPaintEvent"), End),
    _func[19] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QSpinBox_resizeEvent_void_QSpinBox_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QResizeEvent"), End),
    _func[20] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QSpinBox_showEvent_void_QSpinBox_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QShowEvent"), End),
    _func[21] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QSpinBox_timerEvent_void_QSpinBox_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QTimerEvent"), End),
    _func[22] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QSpinBox_wheelEvent_void_QSpinBox_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSpinBox"), new Param(c, "event", "qt.QWheelEvent"), End),
    // static functions
    EndArguments);
