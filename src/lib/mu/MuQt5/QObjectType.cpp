...
addSymbols(
    ...
    // MISSING: findChildren ("QList<T>"; QObject this, QRegExp regExp, flags Qt::FindChildOptions options)
    // MISSING: findChildren ("QList<T>"; QObject this, "const QRegularExpression &" re, flags Qt::FindChildOptions options)
