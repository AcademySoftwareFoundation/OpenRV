...
addSymbols(
    ...
    // MISSING: QMouseEvent (QMouseEvent; QMouseEvent this, "Type" type, QPointF localPos, QPointF windowPos, QPointF screenPos, flags Qt::MouseButton button, flags Qt::MouseButtons buttons, flags Qt::KeyboardModifiers modifiers, flags Qt::MouseEventSource source)
    ...
    new Function(c, "source", _n_source0, None, Compiled, qt_QMouseEvent_source_int_QMouseEvent, Return, "int", Parameters, new Param(c, "this", "qt.QMouseEvent"), End),
