...
namespace Mu
{
    ...
    void qt_QQuickItem_geometryChanged_void_QQuickItem_QRectF_QRectF(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_newGeometry,
    ...
    static NODE_IMPLEMENTATION(_n_grabMouse0, void) { qt_QQuickItem_grabMouse_void_QQuickItem(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)); }
    ...
    {
        qt_QQuickItem_geometryChanged_void_QQuickItem_QRectF_QRectF(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                    NODE_ARG(2, Pointer));
    }
    ...
    void QQuickItemType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "grabMouse", _n_grabMouse0, None, Compiled, qt_QQuickItem_grabMouse_void_QQuickItem, Return, "void", Parameters,
                         new Param(c, "this", "qt.QQuickItem"), End),
            ...
            _func[2] = new MemberFunction(c, "isTextureProvider", _n_isTextureProvider0, None, Compiled,
            ...
            // QQuickItem this)
            new Function(c, "ungrabMouse", _n_ungrabMouse0, None, Compiled, qt_QQuickItem_ungrabMouse_void_QQuickItem, Return, "void",
                         Parameters, new Param(c, "this", "qt.QQuickItem"), End),
            new Function(c, "ungrabTouchPoints", _n_ungrabTouchPoints0, None, Compiled, qt_QQuickItem_ungrabTouchPoints_void_QQuickItem,
                         Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
            ...
            _func[3] = new MemberFunction(c, "childMouseEventFilter", _n_childMouseEventFilter0, None, Compiled,
            ...
            _func[7] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QQuickItem_dropEvent_void_QQuickItem_QDropEvent,
            ...
            _func[8] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled,
                                          ...
                                          new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QFocusEvent"), End),
            _func[9] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled,
                                          ...
                                          new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QFocusEvent"), End),
            _func[10] = new MemberFunction(c, "geometryChanged", _n_geometryChanged0, None, Compiled,
                                           qt_QQuickItem_geometryChanged_void_QQuickItem_QRectF_QRectF, Return, "void", Parameters,
            ...
            new Function(c, "heightValid", _n_heightValid0, None, Compiled, qt_QQuickItem_heightValid_bool_QQuickItem, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QQuickItem"), End),
            _func[11] = new MemberFunction(c, "hoverEnterEvent", _n_hoverEnterEvent0, None, Compiled,
            ...
            _func[12] = new MemberFunction(c, "hoverLeaveEvent", _n_hoverLeaveEvent0, None, Compiled,
                                           qt_QQuickItem_hoverLeaveEvent_void_QQuickItem_QHoverEvent, Return, "void", Parameters,
                                           new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QHoverEvent"), End),
            _func[13] = new MemberFunction(c, "hoverMoveEvent", _n_hoverMoveEvent0, None, Compiled,
            ...
            _func[19] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled,
                                           ...
                                           new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QMouseEvent"), End),
            _func[20] = new MemberFunction(c, "mouseUngrabEvent", _n_mouseUngrabEvent0, None, Compiled,
                                           qt_QQuickItem_mouseUngrabEvent_void_QQuickItem, Return, "void", Parameters,
                                           new Param(c, "this", "qt.QQuickItem"), End),
            _func[21] = new MemberFunction(c, "releaseResources", _n_releaseResources0, None, Compiled,
                                           qt_QQuickItem_releaseResources_void_QQuickItem, Return, "void", Parameters,
                                           new Param(c, "this", "qt.QQuickItem"), End),
            // MISSING: touchEvent (void; QQuickItem this, "QTouchEvent *"
            // event) // protected
            _func[22] = new MemberFunction(c, "touchUngrabEvent", _n_touchUngrabEvent0, None, Compiled,
            ...
            // protected
            _func[23] = new MemberFunction(c, "updatePolish", _n_updatePolish0, None, Compiled, qt_QQuickItem_updatePolish_void_QQuickItem,
                                           Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
            ...
            new Function(c, "widthValid", _n_widthValid0, None, Compiled, qt_QQuickItem_widthValid_bool_QQuickItem, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QQuickItem"), End),
            _func[25] = new MemberFunction(c, "classBegin", _n_classBegin0, None, Compiled, qt_QQuickItem_classBegin_void_QQuickItem,
                                           Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
            _func[26] = new MemberFunction(c, "componentComplete", _n_componentComplete0, None, Compiled,
                                           qt_QQuickItem_componentComplete_void_QQuickItem, Return, "void", Parameters,
                                           new Param(c, "this", "qt.QQuickItem"), End),
            _func[27] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QQuickItem_event_bool_QQuickItem_QEvent, Return,
                                           "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "ev", "qt.QEvent"), End),
            _func[28] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled,
            ...
            _func[29] = new MemberFunction(c, "customEvent", _n_customEvent0, None, Compiled,
