...
{
    if (!_env) { QQuickItem::focusInEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QQuickItem::focusOutEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
void MuQt_QQuickItem::geometryChanged(const QRectF & newGeometry, const QRectF & oldGeometry) 
{
    if (!_env) { QQuickItem::geometryChanged(newGeometry, oldGeometry); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
void qt_QQuickItem_grabMouse_void_QQuickItem(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    arg0->grabMouse();
...
void qt_QQuickItem_ungrabMouse_void_QQuickItem(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    arg0->ungrabMouse();
...
void qt_QQuickItem_ungrabTouchPoints_void_QQuickItem(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
...
void qt_QQuickItem_focusInEvent_void_QQuickItem_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
...
void qt_QQuickItem_focusOutEvent_void_QQuickItem_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    QFocusEvent * arg1 = getqpointer<QFocusEventType>(param_event);
...
void qt_QQuickItem_geometryChanged_void_QQuickItem_QRectF_QRectF(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_newGeometry, Pointer param_oldGeometry)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QQuickItem* arg0 = object<QQuickItem>(param_this);
    const QRectF  arg1 = getqtype<QRectFType>(param_newGeometry);
    const QRectF  arg2 = getqtype<QRectFType>(param_oldGeometry);
    if (isMuQtObject(arg0)) ((MuQt_QQuickItem*)arg0)->geometryChanged_pub_parent(arg1, arg2);
    else ((MuQt_QQuickItem*)arg0)->geometryChanged_pub(arg1, arg2);
}
...
{
    qt_QQuickItem_grabMouse_void_QQuickItem(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    qt_QQuickItem_ungrabMouse_void_QQuickItem(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}

static NODE_IMPLEMENTATION(_n_ungrabTouchPoints0, void)
{
    qt_QQuickItem_ungrabTouchPoints_void_QQuickItem(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    qt_QQuickItem_geometryChanged_void_QQuickItem_QRectF_QRectF(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer));
}
...
addSymbols(
    ...
    _func[0] = new MemberFunction(c, "contains", _n_contains0, None, Compiled, qt_QQuickItem_contains_bool_QQuickItem_QPointF, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "point", "qt.QPointF"), End),
    ...
    new Function(c, "grabMouse", _n_grabMouse0, None, Compiled, qt_QQuickItem_grabMouse_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    // MISSING: grabToImage ("QSharedPointer<QQuickItemGrabResult>"; QQuickItem this, QSize targetSize)
    // MISSING: grabTouchPoints (void; QQuickItem this, "const QVector<int> &" ids)
    ...
    _func[1] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QQuickItem_inputMethodQuery_QVariant_QQuickItem_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "query", "int"), End),
    ...
    _func[2] = new MemberFunction(c, "isTextureProvider", _n_isTextureProvider0, None, Compiled, qt_QQuickItem_isTextureProvider_bool_QQuickItem, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    ...
    // PROP: setHeight (void; QQuickItem this, double _p6)
    // PROP: setImplicitHeight (void; QQuickItem this, double _p6)
    // PROP: setImplicitWidth (void; QQuickItem this, double _p6)
    ...
    // PROP: setTransformOrigin (void; QQuickItem this, flags QQuickItem::TransformOrigin _p16)
    // PROP: setVisible (void; QQuickItem this, bool _p5)
    // PROP: setWidth (void; QQuickItem this, double _p6)
    // PROP: setX (void; QQuickItem this, double _p6)
    // PROP: setY (void; QQuickItem this, double _p6)
    // PROP: setZ (void; QQuickItem this, double _p6)
    ...
    new Function(c, "ungrabMouse", _n_ungrabMouse0, None, Compiled, qt_QQuickItem_ungrabMouse_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    new Function(c, "ungrabTouchPoints", _n_ungrabTouchPoints0, None, Compiled, qt_QQuickItem_ungrabTouchPoints_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    ...
    _func[3] = new MemberFunction(c, "childMouseEventFilter", _n_childMouseEventFilter0, None, Compiled, qt_QQuickItem_childMouseEventFilter_bool_QQuickItem_QQuickItem_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "item", "qt.QQuickItem"), new Param(c, "event", "qt.QEvent"), End),
    _func[4] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QQuickItem_dragEnterEvent_void_QQuickItem_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QDragEnterEvent"), End),
    _func[5] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QQuickItem_dragLeaveEvent_void_QQuickItem_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QDragLeaveEvent"), End),
    _func[6] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QQuickItem_dragMoveEvent_void_QQuickItem_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QDragMoveEvent"), End),
    _func[7] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QQuickItem_dropEvent_void_QQuickItem_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QDropEvent"), End),
    _func[8] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QQuickItem_focusInEvent_void_QQuickItem_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[9] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QQuickItem_focusOutEvent_void_QQuickItem_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[10] = new MemberFunction(c, "geometryChanged", _n_geometryChanged0, None, Compiled, qt_QQuickItem_geometryChanged_void_QQuickItem_QRectF_QRectF, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "newGeometry", "qt.QRectF"), new Param(c, "oldGeometry", "qt.QRectF"), End),
    ...
    _func[11] = new MemberFunction(c, "hoverEnterEvent", _n_hoverEnterEvent0, None, Compiled, qt_QQuickItem_hoverEnterEvent_void_QQuickItem_QHoverEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QHoverEvent"), End),
    _func[12] = new MemberFunction(c, "hoverLeaveEvent", _n_hoverLeaveEvent0, None, Compiled, qt_QQuickItem_hoverLeaveEvent_void_QQuickItem_QHoverEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QHoverEvent"), End),
    _func[13] = new MemberFunction(c, "hoverMoveEvent", _n_hoverMoveEvent0, None, Compiled, qt_QQuickItem_hoverMoveEvent_void_QQuickItem_QHoverEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QHoverEvent"), End),
    ...
    // MISSING: itemChange (void; QQuickItem this, flags QQuickItem::ItemChange change, "const ItemChangeData &" value) // protected
    _func[14] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QQuickItem_keyPressEvent_void_QQuickItem_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[15] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QQuickItem_keyReleaseEvent_void_QQuickItem_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[16] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QQuickItem_mouseDoubleClickEvent_void_QQuickItem_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[17] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QQuickItem_mouseMoveEvent_void_QQuickItem_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[18] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QQuickItem_mousePressEvent_void_QQuickItem_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[19] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QQuickItem_mouseReleaseEvent_void_QQuickItem_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[20] = new MemberFunction(c, "mouseUngrabEvent", _n_mouseUngrabEvent0, None, Compiled, qt_QQuickItem_mouseUngrabEvent_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[21] = new MemberFunction(c, "releaseResources", _n_releaseResources0, None, Compiled, qt_QQuickItem_releaseResources_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    // MISSING: touchEvent (void; QQuickItem this, "QTouchEvent *" event) // protected
    _func[22] = new MemberFunction(c, "touchUngrabEvent", _n_touchUngrabEvent0, None, Compiled, qt_QQuickItem_touchUngrabEvent_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    ...
    // MISSING: updatePaintNode ("QSGNode *"; QQuickItem this, "QSGNode *" oldNode, "UpdatePaintNodeData *" updatePaintNodeData) // protected
    _func[23] = new MemberFunction(c, "updatePolish", _n_updatePolish0, None, Compiled, qt_QQuickItem_updatePolish_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[24] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QQuickItem_wheelEvent_void_QQuickItem_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QWheelEvent"), End),
    ...
    _func[25] = new MemberFunction(c, "classBegin", _n_classBegin0, None, Compiled, qt_QQuickItem_classBegin_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[26] = new MemberFunction(c, "componentComplete", _n_componentComplete0, None, Compiled, qt_QQuickItem_componentComplete_void_QQuickItem, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), End),
    _func[27] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QQuickItem_event_bool_QQuickItem_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "ev", "qt.QEvent"), End),
    _func[28] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled, qt_QQuickItem_eventFilter_bool_QQuickItem_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "watched", "qt.QObject"), new Param(c, "event", "qt.QEvent"), End),
    ...
    _func[29] = new MemberFunction(c, "customEvent", _n_customEvent0, None, Compiled, qt_QQuickItem_customEvent_void_QQuickItem_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: disconnectNotify (void; QQuickItem this, "const QMetaMethod &" signal) // protected
    _func[30] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QQuickItem_timerEvent_void_QQuickItem_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QQuickItem"), new Param(c, "event", "qt.QTimerEvent"), End),
    // static functions
    EndArguments);
