...
namespace Mu
{
    ...
    int qt_QNetworkAccessManager_networkAccessible_int_QNetworkAccessManager(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QNetworkAccessManager* arg0 = object<QNetworkAccessManager>(param_this);
    ...
    void qt_QNetworkAccessManager_setNetworkAccessible_void_QNetworkAccessManager_int(Mu::Thread& NODE_THREAD, Pointer param_this,
                                                                                      int param_accessible)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QNetworkAccessManager* arg0 = object<QNetworkAccessManager>(param_this);
        QNetworkAccessManager::NetworkAccessibility arg1 = (QNetworkAccessManager::NetworkAccessibility)(param_accessible);
    ...
    {
        NODE_RETURN(qt_QNetworkAccessManager_networkAccessible_int_QNetworkAccessManager(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    {
        qt_QNetworkAccessManager_setNetworkAccessible_void_QNetworkAccessManager_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
                                                                                     NODE_ARG(1, int));
    }
    ...
    void QNetworkAccessManagerType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "networkAccessible", _n_networkAccessible0, None, Compiled,
                         qt_QNetworkAccessManager_networkAccessible_int_QNetworkAccessManager, Return, "int", Parameters,
                         new Param(c, "this", "qt.QNetworkAccessManager"), End),
            ...
            new Function(c, "setNetworkAccessible", _n_setNetworkAccessible0, None, Compiled,
                         qt_QNetworkAccessManager_setNetworkAccessible_void_QNetworkAccessManager_int, Return, "void", Parameters,
                         new Param(c, "this", "qt.QNetworkAccessManager"), new Param(c, "accessible", "int"), End),
            ...
            new Function(c, "supportedSchemes", _n_supportedSchemes0, None, Compiled,
                         qt_QNetworkAccessManager_supportedSchemes_stringBSB_ESB__QNetworkAccessManager, Return, "string[]", Parameters,
                         new Param(c, "this", "qt.QNetworkAccessManager"), End),
