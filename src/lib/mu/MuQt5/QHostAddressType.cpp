...
addSymbols(
    ...
    // MISSING: QHostAddress (QHostAddress; QHostAddress this, "quint8 *" ip6Addr)
    ...
    new Function(c, "QHostAddress", _n_QHostAddress6, None, Compiled, qt_QHostAddress_QHostAddress_QHostAddress_QHostAddress_string, Return, "qt.QHostAddress", Parameters, new Param(c, "this", "qt.QHostAddress"), new Param(c, "address", "string"), End),
    ...
    new Function(c, "setAddress", _n_setAddress5, None, Compiled, qt_QHostAddress_setAddress_bool_QHostAddress_string, Return, "bool", Parameters, new Param(c, "this", "qt.QHostAddress"), new Param(c, "address", "string"), End),
    ...
    new Function(c, "toIPv4Address", _n_toIPv4Address0, None, Compiled, qt_QHostAddress_toIPv4Address_int_QHostAddress, Return, "int", Parameters, new Param(c, "this", "qt.QHostAddress"), End),
...
globalScope()->addSymbols(
    ...
    // MISSING: = (QHostAddress; QHostAddress this, string address)
