...
addSymbols(
    ...
    new Function(c, "QCalendar", _n_QCalendar2, None, Compiled, qt_QCalendar_QCalendar_QCalendar_QCalendar_int, Return, "qt.QCalendar", Parameters, new Param(c, "this", "qt.QCalendar"), new Param(c, "system", "int"), End),
    new Function(c, "QCalendar", _n_QCalendar3, None, Compiled, qt_QCalendar_QCalendar_QCalendar_QCalendar, Return, "qt.QCalendar", Parameters, new Param(c, "this", "qt.QCalendar"), End),
