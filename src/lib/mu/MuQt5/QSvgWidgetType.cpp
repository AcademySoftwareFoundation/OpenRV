...
{
    if (!_env) { QSvgWidget::enterEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
void qt_QSvgWidget_enterEvent_void_QSvgWidget_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QSvgWidget* arg0 = object<QSvgWidget>(param_this);
    QEvent * arg1 = getqpointer<QEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QSvgWidget*)arg0)->enterEvent_pub_parent(arg1);
    else ((MuQt_QSvgWidget*)arg0)->enterEvent_pub(arg1);
}
...
addSymbols(
    ...
    _func[13] = new MemberFunction(c, "enterEvent", _n_enterEvent0, None, Compiled, qt_QSvgWidget_enterEvent_void_QSvgWidget_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QEvent"), End),
    _func[14] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QSvgWidget_focusInEvent_void_QSvgWidget_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[15] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QSvgWidget_focusNextPrevChild_bool_QSvgWidget_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "next", "bool"), End),
    _func[16] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QSvgWidget_focusOutEvent_void_QSvgWidget_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[17] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QSvgWidget_hideEvent_void_QSvgWidget_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QHideEvent"), End),
    // MISSING: inputMethodEvent (void; QSvgWidget this, "QInputMethodEvent *" event) // protected
    _func[18] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QSvgWidget_keyPressEvent_void_QSvgWidget_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[19] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QSvgWidget_keyReleaseEvent_void_QSvgWidget_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[20] = new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QSvgWidget_leaveEvent_void_QSvgWidget_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QEvent"), End),
    _func[21] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QSvgWidget_mouseDoubleClickEvent_void_QSvgWidget_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[22] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QSvgWidget_mouseMoveEvent_void_QSvgWidget_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[23] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QSvgWidget_mousePressEvent_void_QSvgWidget_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[24] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QSvgWidget_mouseReleaseEvent_void_QSvgWidget_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[25] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QSvgWidget_moveEvent_void_QSvgWidget_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QSvgWidget this, QByteArray eventType, "void *" message, "long *" result) // protected
    _func[26] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QSvgWidget_resizeEvent_void_QSvgWidget_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QResizeEvent"), End),
    _func[27] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QSvgWidget_showEvent_void_QSvgWidget_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QShowEvent"), End),
    _func[28] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QSvgWidget_tabletEvent_void_QSvgWidget_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QTabletEvent"), End),
    _func[29] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QSvgWidget_wheelEvent_void_QSvgWidget_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event", "qt.QWheelEvent"), End),
    _func[30] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QSvgWidget_event_bool_QSvgWidget_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QSvgWidget"), new Param(c, "event_", "qt.QEvent"), End),
    // MISSING: initPainter (void; QSvgWidget this, "QPainter *" painter) // protected
    // MISSING: metric (int; QSvgWidget this, "PaintDeviceMetric" m) // protected
    // static functions
    EndArguments);
