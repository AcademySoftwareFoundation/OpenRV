...
namespace Mu
{
    ...
    void QGroupBoxType::load()
    {
        ...
        addSymbols(
            ...
            _func[19] =
                new MemberFunction(c, "enterEvent", _n_enterEvent0, None, Compiled, qt_QGroupBox_enterEvent_void_QGroupBox_QEvent, Return,
            ...
            _func[23] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled,
