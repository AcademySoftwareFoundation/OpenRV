...
namespace Mu
{
    ...
    static NODE_IMPLEMENTATION(_n_count0, int) { NODE_RETURN(qt_QDir_count_int_QDir(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    void QDirType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "QDir", _n_QDir1, None, Compiled, qt_QDir_QDir_QDir_QDir_string, Return, "qt.QDir", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "path", "string"), End),
            new Function(c, "QDir", _n_QDir2, None, Compiled, qt_QDir_QDir_QDir_QDir_string_string_int_int, Return, "qt.QDir", Parameters,
            ...
            new Function(c, "count", _n_count0, None, Compiled, qt_QDir_count_int_QDir, Return, "int", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            ...
            new Function(c, "makeAbsolute", _n_makeAbsolute0, None, Compiled, qt_QDir_makeAbsolute_bool_QDir, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            new Function(c, "mkdir", _n_mkdir0, None, Compiled, qt_QDir_mkdir_bool_QDir_string, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "dirName", "string"), End),
        ...
        globalScope()->addSymbols(new Function(c, "!=", _n_operatorBang_EQ_0, Op, Compiled, qt_QDir_operatorBang_EQ__bool_QDir_QDir, Return,
                                  ...
                                  new Function(c, "==", _n_operatorEQ_EQ_0, Op, Compiled, qt_QDir_operatorEQ_EQ__bool_QDir_QDir, Return,
                                               "bool", Parameters, new Param(c, "this", "qt.QDir"), new Param(c, "dir", "qt.QDir"), End),
                                  new Function(c, "[]", _n_operatorBSB_ESB_0, Op, Compiled, qt_QDir_operatorBSB_ESB__string_QDir_int,
                                               Return, "string", Parameters, new Param(c, "this", "qt.QDir"), new Param(c, "pos", "int"),
                                               End),
                                  EndArguments);
