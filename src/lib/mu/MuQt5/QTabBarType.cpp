...
{
    if (!_env) { QTabBar::enterEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
void qt_QTabBar_enterEvent_void_QTabBar_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTabBar* arg0 = object<QTabBar>(param_this);
    QEvent * arg1 = getqpointer<QEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QTabBar*)arg0)->enterEvent_pub_parent(arg1);
    else ((MuQt_QTabBar*)arg0)->enterEvent_pub(arg1);
}
...
{
    qt_QTabBar_enterEvent_void_QTabBar_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
addSymbols(
    ...
    // PROP: setElideMode (void; QTabBar this, flags Qt::TextElideMode _p18)
    ...
    _func[11] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QTabBar_mouseMoveEvent_void_QTabBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[12] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QTabBar_mousePressEvent_void_QTabBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[13] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QTabBar_mouseReleaseEvent_void_QTabBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[14] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QTabBar_paintEvent_void_QTabBar_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "_p14", "qt.QPaintEvent"), End),
    _func[15] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QTabBar_resizeEvent_void_QTabBar_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "_p15", "qt.QResizeEvent"), End),
    _func[16] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QTabBar_showEvent_void_QTabBar_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "_p13", "qt.QShowEvent"), End),
    _func[17] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QTabBar_timerEvent_void_QTabBar_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QTimerEvent"), End),
    _func[18] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QTabBar_wheelEvent_void_QTabBar_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QWheelEvent"), End),
    _func[19] = new MemberFunction(c, "hasHeightForWidth", _n_hasHeightForWidth0, None, Compiled, qt_QTabBar_hasHeightForWidth_bool_QTabBar, Return, "bool", Parameters, new Param(c, "this", "qt.QTabBar"), End),
    _func[20] = new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QTabBar_heightForWidth_int_QTabBar_int, Return, "int", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "w", "int"), End),
    _func[21] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QTabBar_inputMethodQuery_QVariant_QTabBar_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "query", "int"), End),
    // MISSING: paintEngine ("QPaintEngine *"; QTabBar this)
    // MISSING: actionEvent (void; QTabBar this, "QActionEvent *" event) // protected
    _func[22] = new MemberFunction(c, "closeEvent", _n_closeEvent0, None, Compiled, qt_QTabBar_closeEvent_void_QTabBar_QCloseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QCloseEvent"), End),
    _func[23] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled, qt_QTabBar_contextMenuEvent_void_QTabBar_QContextMenuEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QContextMenuEvent"), End),
    _func[24] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QTabBar_dragEnterEvent_void_QTabBar_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QDragEnterEvent"), End),
    _func[25] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QTabBar_dragLeaveEvent_void_QTabBar_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QDragLeaveEvent"), End),
    _func[26] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QTabBar_dragMoveEvent_void_QTabBar_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QDragMoveEvent"), End),
    _func[27] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QTabBar_dropEvent_void_QTabBar_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QDropEvent"), End),
    _func[28] = new MemberFunction(c, "enterEvent", _n_enterEvent0, None, Compiled, qt_QTabBar_enterEvent_void_QTabBar_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QEvent"), End),
    ...
    _func[34] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QTabBar_mouseDoubleClickEvent_void_QTabBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[35] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QTabBar_moveEvent_void_QTabBar_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QTabBar this, QByteArray eventType, "void *" message, "long *" result) // protected
    _func[36] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QTabBar_tabletEvent_void_QTabBar_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "event", "qt.QTabletEvent"), End),
    // MISSING: initPainter (void; QTabBar this, "QPainter *" painter) // protected
    _func[37] = new MemberFunction(c, "metric", _n_metric0, None, Compiled, qt_QTabBar_metric_int_QTabBar_int, Return, "int", Parameters, new Param(c, "this", "qt.QTabBar"), new Param(c, "m", "int"), End),
    // static functions
    EndArguments);
