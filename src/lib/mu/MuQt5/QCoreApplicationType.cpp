...
namespace Mu
{
    ...
    static Pointer QCoreApplication_QCoreApplication_QObject(Thread& NODE_THREAD, Pointer obj)
    {
    ...
    bool qt_QCoreApplication_notify_bool_QCoreApplication_QObject_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this,
                                                                         Pointer param_receiver, Pointer param_event)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    bool qt_QCoreApplication_event_bool_QCoreApplication_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
    {
        ...
        return isMuQtObject(arg0) ? ((MuQt_QCoreApplication*)arg0)->event_pub_parent(arg1)
                                  : ((MuQt_QCoreApplication*)arg0)->event_pub(arg1);
    }

    bool qt_QCoreApplication_eventFilter_bool_QCoreApplication_QObject_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this,
    ...
    void qt_QCoreApplication_postEvent_void_QObject_QEvent_int(Mu::Thread& NODE_THREAD, Pointer param_receiver, Pointer param_event,
                                                               int param_priority)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    void qt_QCoreApplication_setSetuidAllowed_void_bool(Mu::Thread& NODE_THREAD, bool param_allow)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    {
        NODE_RETURN(qt_QCoreApplication_notify_bool_QCoreApplication_QObject_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
    ...
    {
        NODE_RETURN(qt_QCoreApplication_eventFilter_bool_QCoreApplication_QObject_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
                                                                                         NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_applicationDirPath0, Pointer) { NODE_RETURN(qt_QCoreApplication_applicationDirPath_string(NODE_THREAD)); }
    ...
    static NODE_IMPLEMENTATION(_n_applicationPid0, int64) { NODE_RETURN(qt_QCoreApplication_applicationPid_int64(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_arguments0, Pointer) { NODE_RETURN(qt_QCoreApplication_arguments_stringBSB_ESB_(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_closingDown0, bool) { NODE_RETURN(qt_QCoreApplication_closingDown_bool(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_exec0, int) { NODE_RETURN(qt_QCoreApplication_exec_int(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_exit0, void) { qt_QCoreApplication_exit_void_int(NODE_THREAD, NODE_ARG(0, int)); }

    static NODE_IMPLEMENTATION(_n_flush0, void) { qt_QCoreApplication_flush_void(NODE_THREAD); }

    static NODE_IMPLEMENTATION(_n_instance0, Pointer) { NODE_RETURN(qt_QCoreApplication_instance_QCoreApplication(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_isSetuidAllowed0, bool) { NODE_RETURN(qt_QCoreApplication_isSetuidAllowed_bool(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_libraryPaths0, Pointer) { NODE_RETURN(qt_QCoreApplication_libraryPaths_stringBSB_ESB_(NODE_THREAD)); }
    ...
    static NODE_IMPLEMENTATION(_n_processEvents0, void) { qt_QCoreApplication_processEvents_void_int(NODE_THREAD, NODE_ARG(0, int)); }
    ...
    {
        qt_QCoreApplication_setSetuidAllowed_void_bool(NODE_THREAD, NODE_ARG(0, bool));
    }

    static NODE_IMPLEMENTATION(_n_startingUp0, bool) { NODE_RETURN(qt_QCoreApplication_startingUp_bool(NODE_THREAD)); }
    ...
    void QCoreApplicationType::load()
    {
        ...
        addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None, Return, ftn, End),
                   ...
                   new Function(c, tn, castFromObject, Cast, Compiled, QCoreApplication_QCoreApplication_QObject, Return, ftn, Parameters,
        ...
        addSymbols(
            ...
            _func[0] =
                new MemberFunction(c, "notify", _n_notify0, None, Compiled, qt_QCoreApplication_notify_bool_QCoreApplication_QObject_QEvent,
                                   Return, "bool", Parameters, new Param(c, "this", "qt.QCoreApplication"),
                                   new Param(c, "receiver", "qt.QObject"), new Param(c, "event", "qt.QEvent"), End),
            // MISSING: removeNativeEventFilter (void; QCoreApplication this,
            // "QAbstractNativeEventFilter *" filterObject)
            _func[1] =
                new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QCoreApplication_event_bool_QCoreApplication_QEvent, Return,
                                   "bool", Parameters, new Param(c, "this", "qt.QCoreApplication"), new Param(c, "e", "qt.QEvent"), End),
            _func[2] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled,
                                          qt_QCoreApplication_eventFilter_bool_QCoreApplication_QObject_QEvent, Return, "bool", Parameters,
                                          new Param(c, "this", "qt.QCoreApplication"), new Param(c, "watched", "qt.QObject"),
            ...
            _func[3] = new MemberFunction(c, "customEvent", _n_customEvent0, None, Compiled,
                                          qt_QCoreApplication_customEvent_void_QCoreApplication_QEvent, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QCoreApplication"), new Param(c, "event", "qt.QEvent"), End),
            ...
            _func[4] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled,
                                          qt_QCoreApplication_timerEvent_void_QCoreApplication_QTimerEvent, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QCoreApplication"), new Param(c, "event", "qt.QTimerEvent"), End),
            // static functions
            new Function(c, "addLibraryPath", _n_addLibraryPath0, None, Compiled, qt_QCoreApplication_addLibraryPath_void_string, Return,
                         "void", Parameters, new Param(c, "path", "string"), End),
            new Function(c, "applicationDirPath", _n_applicationDirPath0, None, Compiled, qt_QCoreApplication_applicationDirPath_string,
                         Return, "string", End),
            new Function(c, "applicationFilePath", _n_applicationFilePath0, None, Compiled, qt_QCoreApplication_applicationFilePath_string,
                         Return, "string", End),
            new Function(c, "applicationPid", _n_applicationPid0, None, Compiled, qt_QCoreApplication_applicationPid_int64, Return, "int64",
                         End),
            new Function(c, "arguments", _n_arguments0, None, Compiled, qt_QCoreApplication_arguments_stringBSB_ESB_, Return, "string[]",
                         End),
            ...
            new Function(c, "exit", _n_exit0, None, Compiled, qt_QCoreApplication_exit_void_int, Return, "void", Parameters,
            ...
            // translationFile)
            new Function(c, "instance", _n_instance0, None, Compiled, qt_QCoreApplication_instance_QCoreApplication, Return,
                         "qt.QCoreApplication", End),
            new Function(c, "isSetuidAllowed", _n_isSetuidAllowed0, None, Compiled, qt_QCoreApplication_isSetuidAllowed_bool, Return,
                         "bool", End),
            new Function(c, "libraryPaths", _n_libraryPaths0, None, Compiled, qt_QCoreApplication_libraryPaths_stringBSB_ESB_, Return,
                         "string[]", End),
            new Function(c, "postEvent", _n_postEvent0, None, Compiled, qt_QCoreApplication_postEvent_void_QObject_QEvent_int, Return,
                         "void", Parameters, new Param(c, "receiver", "qt.QObject"), new Param(c, "event", "qt.QEvent"),
                         new Param(c, "priority", "int", Value((int)Qt::NormalEventPriority)), End),
            new Function(c, "processEvents", _n_processEvents0, None, Compiled, qt_QCoreApplication_processEvents_void_int, Return, "void",
                         Parameters, new Param(c, "flags", "int", Value((int)QEventLoop::AllEvents)), End),
            new Function(c, "processEvents", _n_processEvents1, None, Compiled, qt_QCoreApplication_processEvents_void_int_int, Return,
                         "void", Parameters, new Param(c, "flags", "int"), new Param(c, "maxtime", "int"), End),
            new Function(c, "removeLibraryPath", _n_removeLibraryPath0, None, Compiled, qt_QCoreApplication_removeLibraryPath_void_string,
                         Return, "void", Parameters, new Param(c, "path", "string"), End),
            new Function(c, "removePostedEvents", _n_removePostedEvents0, None, Compiled,
                         qt_QCoreApplication_removePostedEvents_void_QObject_int, Return, "void", Parameters,
                         new Param(c, "receiver", "qt.QObject"), new Param(c, "eventType", "int", Value((int)0)), End),
            // MISSING: removeTranslator (bool; "QTranslator *" translationFile)
            new Function(c, "sendEvent", _n_sendEvent0, None, Compiled, qt_QCoreApplication_sendEvent_bool_QObject_QEvent, Return, "bool",
                         Parameters, new Param(c, "receiver", "qt.QObject"), new Param(c, "event", "qt.QEvent"), End),
            new Function(c, "sendPostedEvents", _n_sendPostedEvents0, None, Compiled, qt_QCoreApplication_sendPostedEvents_void_QObject_int,
                         Return, "void", Parameters, new Param(c, "receiver", "qt.QObject"),
                         new Param(c, "event_type", "int", Value((int)0)), End),
            new Function(c, "setAttribute", _n_setAttribute0, None, Compiled, qt_QCoreApplication_setAttribute_void_int_bool, Return,
                         "void", Parameters, new Param(c, "attribute", "int"), new Param(c, "on", "bool"), End),
            // MISSING: setEventDispatcher (void; "QAbstractEventDispatcher *"
            // eventDispatcher)
            new Function(c, "setLibraryPaths", _n_setLibraryPaths0, None, Compiled, qt_QCoreApplication_setLibraryPaths_void_stringBSB_ESB_,
                         Return, "void", Parameters, new Param(c, "paths", "string[]"), End),
            new Function(c, "setSetuidAllowed", _n_setSetuidAllowed0, None, Compiled, qt_QCoreApplication_setSetuidAllowed_void_bool,
                         Return, "void", Parameters, new Param(c, "allow", "bool"), End),
            new Function(c, "startingUp", _n_startingUp0, None, Compiled, qt_QCoreApplication_startingUp_bool, Return, "bool", End),
            new Function(c, "testAttribute", _n_testAttribute0, None, Compiled, qt_QCoreApplication_testAttribute_bool_int, Return, "bool",
                         Parameters, new Param(c, "attribute", "int"), End),
