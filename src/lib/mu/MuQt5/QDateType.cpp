...
namespace Mu
{
    ...
    static NODE_IMPLEMENTATION(_n_day0, int) { NODE_RETURN(qt_QDate_day_int_QDate(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }

    static NODE_IMPLEMENTATION(_n_dayOfWeek0, int) { NODE_RETURN(qt_QDate_dayOfWeek_int_QDate(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }

    static NODE_IMPLEMENTATION(_n_dayOfYear0, int) { NODE_RETURN(qt_QDate_dayOfYear_int_QDate(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    static NODE_IMPLEMENTATION(_n_month0, int) { NODE_RETURN(qt_QDate_month_int_QDate(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    static NODE_IMPLEMENTATION(_n_year0, int) { NODE_RETURN(qt_QDate_year_int_QDate(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    void QDateType::load()
    {
        ...
        addSymbols(new Alias(c, "MonthNameType", "int"), new SymbolicConstant(c, "DateFormat", "int", Value(int(QDate::DateFormat))),
                   new SymbolicConstant(c, "StandaloneFormat", "int", Value(int(QDate::StandaloneFormat))), EndArguments);
        ...
        addSymbols(
            ...
            new Function(c, "addMonths", _n_addMonths0, None, Compiled, qt_QDate_addMonths_QDate_QDate_int, Return, "qt.QDate", Parameters,
                         new Param(c, "this", "qt.QDate"), new Param(c, "nmonths", "int"), End),
            new Function(c, "addYears", _n_addYears0, None, Compiled, qt_QDate_addYears_QDate_QDate_int, Return, "qt.QDate", Parameters,
                         new Param(c, "this", "qt.QDate"), new Param(c, "nyears", "int"), End),
            new Function(c, "day", _n_day0, None, Compiled, qt_QDate_day_int_QDate, Return, "int", Parameters,
                         new Param(c, "this", "qt.QDate"), End),
            new Function(c, "dayOfWeek", _n_dayOfWeek0, None, Compiled, qt_QDate_dayOfWeek_int_QDate, Return, "int", Parameters,
                         new Param(c, "this", "qt.QDate"), End),
            new Function(c, "dayOfYear", _n_dayOfYear0, None, Compiled, qt_QDate_dayOfYear_int_QDate, Return, "int", Parameters,
                         new Param(c, "this", "qt.QDate"), End),
            new Function(c, "daysInMonth", _n_daysInMonth0, None, Compiled, qt_QDate_daysInMonth_int_QDate, Return, "int", Parameters,
                         new Param(c, "this", "qt.QDate"), End),
            new Function(c, "daysInYear", _n_daysInYear0, None, Compiled, qt_QDate_daysInYear_int_QDate, Return, "int", Parameters,
                         new Param(c, "this", "qt.QDate"), End),
            ...
            new Function(c, "isValid", _n_isValid0, None, Compiled, qt_QDate_isValid_bool_QDate, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDate"), End),
            new Function(c, "month", _n_month0, None, Compiled, qt_QDate_month_int_QDate, Return, "int", Parameters,
                         new Param(c, "this", "qt.QDate"), End),
            ...
            new Function(c, "toJulianDay", _n_toJulianDay0, None, Compiled, qt_QDate_toJulianDay_int64_QDate, Return, "int64", Parameters,
                         new Param(c, "this", "qt.QDate"), End),
            new Function(c, "toString", _n_toString0, None, Compiled, qt_QDate_toString_string_QDate_string, Return, "string", Parameters,
                         new Param(c, "this", "qt.QDate"), new Param(c, "format", "string"), End),
            ...
            new Function(c, "year", _n_year0, None, Compiled, qt_QDate_year_int_QDate, Return, "int", Parameters,
                         new Param(c, "this", "qt.QDate"), End),
            // static functions
            ...
            new Function(c, "fromString", _n_fromString1, None, Compiled, qt_QDate_fromString_QDate_string_string, Return, "qt.QDate",
            ...
            new Function(c, "longDayName", _n_longDayName0, None, Compiled, qt_QDate_longDayName_string_int_int, Return, "string",
                         Parameters, new Param(c, "weekday", "int"), new Param(c, "type", "int", Value((int)QDate::DateFormat)), End),
            new Function(c, "longMonthName", _n_longMonthName0, None, Compiled, qt_QDate_longMonthName_string_int_int, Return, "string",
                         Parameters, new Param(c, "month", "int"), new Param(c, "type", "int", Value((int)QDate::DateFormat)), End),
            new Function(c, "shortDayName", _n_shortDayName0, None, Compiled, qt_QDate_shortDayName_string_int_int, Return, "string",
                         Parameters, new Param(c, "weekday", "int"), new Param(c, "type", "int", Value((int)QDate::DateFormat)), End),
            new Function(c, "shortMonthName", _n_shortMonthName0, None, Compiled, qt_QDate_shortMonthName_string_int_int, Return, "string",
                         Parameters, new Param(c, "month", "int"), new Param(c, "type", "int", Value((int)QDate::DateFormat)), End),
            EndArguments);
        globalScope()->addSymbols(new Function(c, "!=", _n_operatorBang_EQ_0, Op, Compiled, qt_QDate_operatorBang_EQ__bool_QDate_QDate,
                                               Return, "bool", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "d", "qt.QDate"),
                                               End),
                                  new Function(c, "<", _n_operatorLT_0, Op, Compiled, qt_QDate_operatorLT__bool_QDate_QDate, Return, "bool",
                                               Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "d", "qt.QDate"), End),
                                  new Function(c, "<=", _n_operatorLT_EQ_0, Op, Compiled, qt_QDate_operatorLT_EQ__bool_QDate_QDate, Return,
                                               "bool", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "d", "qt.QDate"), End),
                                  new Function(c, "==", _n_operatorEQ_EQ_0, Op, Compiled, qt_QDate_operatorEQ_EQ__bool_QDate_QDate, Return,
                                               "bool", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "d", "qt.QDate"), End),
                                  new Function(c, ">", _n_operatorGT_0, Op, Compiled, qt_QDate_operatorGT__bool_QDate_QDate, Return, "bool",
                                               Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "d", "qt.QDate"), End),
                                  new Function(c, ">=", _n_operatorGT_EQ_0, Op, Compiled, qt_QDate_operatorGT_EQ__bool_QDate_QDate, Return,
                                               "bool", Parameters, new Param(c, "this", "qt.QDate"), new Param(c, "d", "qt.QDate"), End),
                                  EndArguments);
