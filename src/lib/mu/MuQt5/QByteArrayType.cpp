...
namespace Mu
{
    ...
    Pointer qt_QByteArray_insert_QByteArray_QByteArray_int_QByteArray(Mu::Thread& NODE_THREAD, Pointer param_this, int param_i,
                                                                      Pointer param_ba)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QByteArray& arg0 = getqtype<QByteArrayType>(param_this);
    ...
    Pointer qt_QByteArray_insert_QByteArray_QByteArray_int_string(Mu::Thread& NODE_THREAD, Pointer param_this, int param_i,
                                                                  Pointer param_str)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QByteArray& arg0 = getqtype<QByteArrayType>(param_this);
    ...
    int qt_QByteArray_lastIndexOf_int_QByteArray_QByteArray_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_ba,
                                                                int param_from)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QByteArray& arg0 = getqtype<QByteArrayType>(param_this);
    ...
    Pointer qt_QByteArray_replace_QByteArray_QByteArray_int_int_QByteArray(Mu::Thread& NODE_THREAD, Pointer param_this, int param_pos,
    ...
    Pointer qt_QByteArray_replace_QByteArray_QByteArray_QByteArray_QByteArray(Mu::Thread& NODE_THREAD, Pointer param_this,
                                                                              Pointer param_before, Pointer param_after)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QByteArray& arg0 = getqtype<QByteArrayType>(param_this);
    ...
    Pointer qt_QByteArray_replace_QByteArray_QByteArray_string_QByteArray(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_before,
                                                                          Pointer param_after)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QByteArray& arg0 = getqtype<QByteArrayType>(param_this);
    ...
    {
        NODE_RETURN(qt_QByteArray_indexOf_int_QByteArray_QByteArray_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                        NODE_ARG(2, int)));
    }

    static NODE_IMPLEMENTATION(_n_indexOf3, int)
    {
        NODE_RETURN(qt_QByteArray_indexOf_int_QByteArray_string_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                    NODE_ARG(2, int)));
    }

    static NODE_IMPLEMENTATION(_n_insert0, Pointer)
    {
        NODE_RETURN(qt_QByteArray_insert_QByteArray_QByteArray_int_QByteArray(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int),
                                                                              NODE_ARG(2, Pointer)));
    }

    static NODE_IMPLEMENTATION(_n_insert4, Pointer)
    {
        NODE_RETURN(qt_QByteArray_insert_QByteArray_QByteArray_int_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int),
                                                                          NODE_ARG(2, Pointer)));
    }
    ...
    {
        NODE_RETURN(qt_QByteArray_lastIndexOf_int_QByteArray_QByteArray_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                            NODE_ARG(2, int)));
    }

    static NODE_IMPLEMENTATION(_n_lastIndexOf3, int)
    {
        NODE_RETURN(qt_QByteArray_lastIndexOf_int_QByteArray_string_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                        NODE_ARG(2, int)));
    }
    ...
    {
        NODE_RETURN(
            qt_QByteArray_mid_QByteArray_QByteArray_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
    }
    ...
    {
        NODE_RETURN(qt_QByteArray_remove_QByteArray_QByteArray_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int),
                                                                       NODE_ARG(2, int)));
    }
    ...
    {
        NODE_RETURN(qt_QByteArray_replace_QByteArray_QByteArray_int_int_QByteArray(
    ...
    {
        NODE_RETURN(qt_QByteArray_replace_QByteArray_QByteArray_QByteArray_QByteArray(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
                                                                                      NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
    }

    static NODE_IMPLEMENTATION(_n_replace13, Pointer)
    {
        NODE_RETURN(qt_QByteArray_replace_QByteArray_QByteArray_string_QByteArray(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
                                                                                  NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_size0, int) { NODE_RETURN(qt_QByteArray_size_int_QByteArray(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    {
        NODE_RETURN(
            qt_QByteArray_operatorPlus_EQ__QByteArray_QByteArray_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
    }
    ...
    void QByteArrayType::load()
    {
        ...
        addSymbols(new Alias(c, "Base64Option", "int"), new Alias(c, "Base64Options", "int"),
                   ...
                   new SymbolicConstant(c, "OmitTrailingEquals", "int", Value(int(QByteArray::OmitTrailingEquals))), EndArguments);
        ...
        addSymbols(
            ...
            new Function(c, "capacity", _n_capacity0, None, Compiled, qt_QByteArray_capacity_int_QByteArray, Return, "int", Parameters,
            ...
            new Function(c, "chop", _n_chop0, None, Compiled, qt_QByteArray_chop_void_QByteArray_int, Return, "void", Parameters,
                         new Param(c, "this", "qt.QByteArray"), new Param(c, "n", "int"), End),
            ...
            new Function(c, "contains", _n_contains0, None, Compiled, qt_QByteArray_contains_bool_QByteArray_QByteArray, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "ba", "qt.QByteArray"), End),
            // MISSING: contains (bool; QByteArray this, "const char *" str)
            // MISSING: contains (bool; QByteArray this, "char" ch)
            new Function(c, "count", _n_count0, None, Compiled, qt_QByteArray_count_int_QByteArray_QByteArray, Return, "int", Parameters,
                         new Param(c, "this", "qt.QByteArray"), new Param(c, "ba", "qt.QByteArray"), End),
            // MISSING: count (int; QByteArray this, "const char *" str)
            // MISSING: count (int; QByteArray this, "char" ch)
            new Function(c, "count", _n_count3, None, Compiled, qt_QByteArray_count_int_QByteArray, Return, "int", Parameters,
                         new Param(c, "this", "qt.QByteArray"), End),
            ...
            new Function(c, "endsWith", _n_endsWith0, None, Compiled, qt_QByteArray_endsWith_bool_QByteArray_QByteArray, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "ba", "qt.QByteArray"), End),
            ...
            new Function(c, "indexOf", _n_indexOf0, None, Compiled, qt_QByteArray_indexOf_int_QByteArray_QByteArray_int, Return, "int",
                         Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "ba", "qt.QByteArray"),
            ...
            // from)
            new Function(c, "indexOf", _n_indexOf3, None, Compiled, qt_QByteArray_indexOf_int_QByteArray_string_int, Return, "int",
                         Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "str", "string"),
                         new Param(c, "from", "int", Value((int)0)), End),
            new Function(c, "insert", _n_insert0, None, Compiled, qt_QByteArray_insert_QByteArray_QByteArray_int_QByteArray, Return,
                         "qt.QByteArray", Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "i", "int"),
            ...
            new Function(c, "insert", _n_insert4, None, Compiled, qt_QByteArray_insert_QByteArray_QByteArray_int_string, Return,
                         "qt.QByteArray", Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "i", "int"),
            ...
            new Function(c, "isNull", _n_isNull0, None, Compiled, qt_QByteArray_isNull_bool_QByteArray, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QByteArray"), End),
            new Function(c, "lastIndexOf", _n_lastIndexOf0, None, Compiled, qt_QByteArray_lastIndexOf_int_QByteArray_QByteArray_int, Return,
                         "int", Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "ba", "qt.QByteArray"),
            ...
            // int from)
            new Function(c, "lastIndexOf", _n_lastIndexOf3, None, Compiled, qt_QByteArray_lastIndexOf_int_QByteArray_string_int, Return,
                         "int", Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "str", "string"),
                         new Param(c, "from", "int", Value((int)-1)), End),
            new Function(c, "left", _n_left0, None, Compiled, qt_QByteArray_left_QByteArray_QByteArray_int, Return, "qt.QByteArray",
                         Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "len", "int"), End),
            // MISSING: leftJustified (QByteArray; QByteArray this, int width,
            // "char" fill, bool truncate)
            new Function(c, "length", _n_length0, None, Compiled, qt_QByteArray_length_int_QByteArray, Return, "int", Parameters,
                         new Param(c, "this", "qt.QByteArray"), End),
            new Function(c, "mid", _n_mid0, None, Compiled, qt_QByteArray_mid_QByteArray_QByteArray_int_int, Return, "qt.QByteArray",
                         Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "pos", "int"),
                         new Param(c, "len", "int", Value((int)-1)), End),
            new Function(c, "prepend", _n_prepend0, None, Compiled, qt_QByteArray_prepend_QByteArray_QByteArray_QByteArray, Return,
                         "qt.QByteArray", Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "ba", "qt.QByteArray"), End),
            ...
            new Function(c, "remove", _n_remove0, None, Compiled, qt_QByteArray_remove_QByteArray_QByteArray_int_int, Return,
                         "qt.QByteArray", Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "pos", "int"),
                         new Param(c, "len", "int"), End),
            // MISSING: rend ("reverse_iterator"; QByteArray this)
            // MISSING: rend ("const_reverse_iterator"; QByteArray this)
            new Function(c, "repeated", _n_repeated0, None, Compiled, qt_QByteArray_repeated_QByteArray_QByteArray_int, Return,
                         "qt.QByteArray", Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "times", "int"), End),
            new Function(c, "replace", _n_replace0, None, Compiled, qt_QByteArray_replace_QByteArray_QByteArray_int_int_QByteArray, Return,
                         "qt.QByteArray", Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "pos", "int"),
                         new Param(c, "len", "int"), new Param(c, "after", "qt.QByteArray"), End),
            ...
            new Function(c, "replace", _n_replace7, None, Compiled, qt_QByteArray_replace_QByteArray_QByteArray_QByteArray_QByteArray,
                         Return, "qt.QByteArray", Parameters, new Param(c, "this", "qt.QByteArray"),
                         new Param(c, "before", "qt.QByteArray"), new Param(c, "after", "qt.QByteArray"), End),
            ...
            new Function(c, "replace", _n_replace13, None, Compiled, qt_QByteArray_replace_QByteArray_QByteArray_string_QByteArray, Return,
                         "qt.QByteArray", Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "before", "string"),
                         new Param(c, "after", "qt.QByteArray"), End),
            new Function(c, "reserve", _n_reserve0, None, Compiled, qt_QByteArray_reserve_void_QByteArray_int, Return, "void", Parameters,
                         new Param(c, "this", "qt.QByteArray"), new Param(c, "size", "int"), End),
            new Function(c, "resize", _n_resize0, None, Compiled, qt_QByteArray_resize_void_QByteArray_int, Return, "void", Parameters,
                         new Param(c, "this", "qt.QByteArray"), new Param(c, "size", "int"), End),
            new Function(c, "right", _n_right0, None, Compiled, qt_QByteArray_right_QByteArray_QByteArray_int, Return, "qt.QByteArray",
                         Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "len", "int"), End),
            ...
            new Function(c, "simplified", _n_simplified0, None, Compiled, qt_QByteArray_simplified_QByteArray_QByteArray, Return,
                         "qt.QByteArray", Parameters, new Param(c, "this", "qt.QByteArray"), End),
            new Function(c, "size", _n_size0, None, Compiled, qt_QByteArray_size_int_QByteArray, Return, "int", Parameters,
                         new Param(c, "this", "qt.QByteArray"), End),
            ...
            new Function(c, "squeeze", _n_squeeze0, None, Compiled, qt_QByteArray_squeeze_void_QByteArray, Return, "void", Parameters,
                         new Param(c, "this", "qt.QByteArray"), End),
            new Function(c, "startsWith", _n_startsWith0, None, Compiled, qt_QByteArray_startsWith_bool_QByteArray_QByteArray, Return,
                         "bool", Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "ba", "qt.QByteArray"), End),
            ...
            new Function(c, "toBase64", _n_toBase640, None, Compiled, qt_QByteArray_toBase64_QByteArray_QByteArray, Return, "qt.QByteArray",
                         Parameters, new Param(c, "this", "qt.QByteArray"), End),
            new Function(c, "toBase64", _n_toBase641, None, Compiled, qt_QByteArray_toBase64_QByteArray_QByteArray_int, Return,
                         "qt.QByteArray", Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "options", "int"), End),
            ...
            new Function(c, "toHex", _n_toHex0, None, Compiled, qt_QByteArray_toHex_QByteArray_QByteArray, Return, "qt.QByteArray",
                         Parameters, new Param(c, "this", "qt.QByteArray"), End),
            ...
            new Function(c, "trimmed", _n_trimmed0, None, Compiled, qt_QByteArray_trimmed_QByteArray_QByteArray, Return, "qt.QByteArray",
                         Parameters, new Param(c, "this", "qt.QByteArray"), End),
            new Function(c, "truncate", _n_truncate0, None, Compiled, qt_QByteArray_truncate_void_QByteArray_int, Return, "void",
                         Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "pos", "int"), End),
            // static functions
            new Function(c, "fromBase64", _n_fromBase640, None, Compiled, qt_QByteArray_fromBase64_QByteArray_QByteArray, Return,
                         "qt.QByteArray", Parameters, new Param(c, "base64", "qt.QByteArray"), End),
            new Function(c, "fromBase64", _n_fromBase641, None, Compiled, qt_QByteArray_fromBase64_QByteArray_QByteArray_int, Return,
                         "qt.QByteArray", Parameters, new Param(c, "base64", "qt.QByteArray"), new Param(c, "options", "int"), End),
        ...
        globalScope()->addSymbols(
            ...
            new Function(c, "+=", _n_operatorPlus_EQ_3, Op, Compiled, qt_QByteArray_operatorPlus_EQ__QByteArray_QByteArray_string, Return,
                         "qt.QByteArray", Parameters, new Param(c, "this", "qt.QByteArray"), new Param(c, "str", "string"), End),
