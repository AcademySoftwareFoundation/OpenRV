...
Pointer qt_QUrl_fromUserInput_QUrl_string_string_int(Mu::Thread& NODE_THREAD, Pointer param_userInput, Pointer param_workingDirectory, int param_options)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QString  arg0 = qstring(param_userInput);
...
{
    NODE_RETURN(qt_QUrl_fromUserInput_QUrl_string_string_int(NODE_THREAD, NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int)));
}
...
addSymbols(
    ...
    new Alias(c, "ComponentFormattingOptions", "int"),
      ...
      new SymbolicConstant(c, "FullyDecoded", "int", Value(int(QUrl::FullyDecoded))),
    new Alias(c, "ParsingMode", "int"),
      ...
      new SymbolicConstant(c, "DecodedMode", "int", Value(int(QUrl::DecodedMode))),
    ...
    new Alias(c, "UserInputResolutionOptions", "int"),
      ...
      new SymbolicConstant(c, "AssumeLocalFile", "int", Value(int(QUrl::AssumeLocalFile))),
    EndArguments);
...
addSymbols(
    ...
    new Function(c, "QUrl", _n_QUrl2, None, Compiled, qt_QUrl_QUrl_QUrl_QUrl_string_int, Return, "qt.QUrl", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "url", "string"), new Param(c, "parsingMode", "int", Value((int)QUrl::TolerantMode)), End),
    // MISSING: QUrl (QUrl; QUrl this, QUrl other)
    new Function(c, "adjusted", _n_adjusted0, None, Compiled, qt_QUrl_adjusted_QUrl_QUrl_int, Return, "qt.QUrl", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "options", "int"), End),
    new Function(c, "authority", _n_authority0, None, Compiled, qt_QUrl_authority_string_QUrl_int, Return, "string", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "options", "int", Value((int)QUrl::PrettyDecoded)), End),
    ...
    new Function(c, "fileName", _n_fileName0, None, Compiled, qt_QUrl_fileName_string_QUrl_int, Return, "string", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "options", "int", Value((int)QUrl::FullyDecoded)), End),
    new Function(c, "fragment", _n_fragment0, None, Compiled, qt_QUrl_fragment_string_QUrl_int, Return, "string", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "options", "int", Value((int)QUrl::PrettyDecoded)), End),
    ...
    new Function(c, "host", _n_host0, None, Compiled, qt_QUrl_host_string_QUrl_int, Return, "string", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "options", "int", Value((int)QUrl::FullyDecoded)), End),
    ...
    new Function(c, "matches", _n_matches0, None, Compiled, qt_QUrl_matches_bool_QUrl_QUrl_int, Return, "bool", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "url", "qt.QUrl"), new Param(c, "options", "int"), End),
    new Function(c, "password", _n_password0, None, Compiled, qt_QUrl_password_string_QUrl_int, Return, "string", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "options", "int", Value((int)QUrl::FullyDecoded)), End),
    new Function(c, "path", _n_path0, None, Compiled, qt_QUrl_path_string_QUrl_int, Return, "string", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "options", "int", Value((int)QUrl::FullyDecoded)), End),
    new Function(c, "port", _n_port0, None, Compiled, qt_QUrl_port_int_QUrl_int, Return, "int", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "defaultPort", "int", Value((int)-1)), End),
    new Function(c, "query", _n_query0, None, Compiled, qt_QUrl_query_string_QUrl_int, Return, "string", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "options", "int", Value((int)QUrl::PrettyDecoded)), End),
    ...
    new Function(c, "setAuthority", _n_setAuthority0, None, Compiled, qt_QUrl_setAuthority_void_QUrl_string_int, Return, "void", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "authority", "string"), new Param(c, "mode", "int", Value((int)QUrl::TolerantMode)), End),
    new Function(c, "setFragment", _n_setFragment0, None, Compiled, qt_QUrl_setFragment_void_QUrl_string_int, Return, "void", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "fragment", "string"), new Param(c, "mode", "int", Value((int)QUrl::TolerantMode)), End),
    new Function(c, "setHost", _n_setHost0, None, Compiled, qt_QUrl_setHost_void_QUrl_string_int, Return, "void", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "host", "string"), new Param(c, "mode", "int", Value((int)QUrl::DecodedMode)), End),
    ...
    new Function(c, "setQuery", _n_setQuery0, None, Compiled, qt_QUrl_setQuery_void_QUrl_string_int, Return, "void", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "query", "string"), new Param(c, "mode", "int", Value((int)QUrl::TolerantMode)), End),
    new Function(c, "setQuery", _n_setQuery1, None, Compiled, qt_QUrl_setQuery_void_QUrl_QUrlQuery, Return, "void", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "query", "qt.QUrlQuery"), End),
    ...
    new Function(c, "setUrl", _n_setUrl0, None, Compiled, qt_QUrl_setUrl_void_QUrl_string_int, Return, "void", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "url", "string"), new Param(c, "parsingMode", "int", Value((int)QUrl::TolerantMode)), End),
    new Function(c, "setUserInfo", _n_setUserInfo0, None, Compiled, qt_QUrl_setUserInfo_void_QUrl_string_int, Return, "void", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "userInfo", "string"), new Param(c, "mode", "int", Value((int)QUrl::TolerantMode)), End),
    ...
    new Function(c, "topLevelDomain", _n_topLevelDomain0, None, Compiled, qt_QUrl_topLevelDomain_string_QUrl_int, Return, "string", Parameters, new Param(c, "this", "qt.QUrl"), new Param(c, "options", "int", Value((int)QUrl::FullyDecoded)), End),
    ...
    new Function(c, "fromStringList", _n_fromStringList0, None, Compiled, qt_QUrl_fromStringList_qt__QUrlBSB_ESB__stringBSB_ESB__int, Return, "qt.QUrl[]", Parameters, new Param(c, "urls", "string[]"), new Param(c, "mode", "int", Value((int)QUrl::TolerantMode)), End),
    ...
    new Function(c, "fromUserInput", _n_fromUserInput1, None, Compiled, qt_QUrl_fromUserInput_QUrl_string_string_int, Return, "qt.QUrl", Parameters, new Param(c, "userInput", "string"), new Param(c, "workingDirectory", "string"), new Param(c, "options", "int", Value((int)QUrl::DefaultResolution)), End),
