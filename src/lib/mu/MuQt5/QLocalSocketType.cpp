...
addSymbols(
    ...
    new Function(c, "connectToServer", _n_connectToServer0, None, Compiled, qt_QLocalSocket_connectToServer_void_QLocalSocket_int, Return, "void", Parameters, new Param(c, "this", "qt.QLocalSocket"), new Param(c, "openMode", "int", Value((int)QIODevice::ReadWrite)), End),
    new Function(c, "connectToServer", _n_connectToServer1, None, Compiled, qt_QLocalSocket_connectToServer_void_QLocalSocket_string_int, Return, "void", Parameters, new Param(c, "this", "qt.QLocalSocket"), new Param(c, "name", "string"), new Param(c, "openMode", "int", Value((int)QIODevice::ReadWrite)), End),
    ...
    // MISSING: setSocketDescriptor (bool; QLocalSocket this, "qintptr" socketDescriptor, flags QLocalSocket::LocalSocketState socketState, flags QIODevice::OpenModeFlag openMode)
    ...
    _func[5] = new MemberFunction(c, "open", _n_open0, None, Compiled, qt_QLocalSocket_open_bool_QLocalSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QLocalSocket"), new Param(c, "openMode", "int", Value((int)QIODevice::ReadWrite)), End),
    ...
    _func[8] = new MemberFunction(c, "atEnd", _n_atEnd0, None, Compiled, qt_QLocalSocket_atEnd_bool_QLocalSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
    _func[9] = new MemberFunction(c, "pos", _n_pos0, None, Compiled, qt_QLocalSocket_pos_int64_QLocalSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
    _func[10] = new MemberFunction(c, "reset", _n_reset0, None, Compiled, qt_QLocalSocket_reset_bool_QLocalSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
    _func[11] = new MemberFunction(c, "seek", _n_seek0, None, Compiled, qt_QLocalSocket_seek_bool_QLocalSocket_int64, Return, "bool", Parameters, new Param(c, "this", "qt.QLocalSocket"), new Param(c, "pos", "int64"), End),
    _func[12] = new MemberFunction(c, "size", _n_size0, None, Compiled, qt_QLocalSocket_size_int64_QLocalSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
