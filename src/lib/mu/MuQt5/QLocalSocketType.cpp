...
namespace Mu
{
    ...
    void qt_QLocalSocket_connectToServer_void_QLocalSocket_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_openMode)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QLocalSocket* arg0 = object<QLocalSocket>(param_this);
        QIODevice::OpenModeFlag arg1 = (QIODevice::OpenModeFlag)(param_openMode);
                                                                      ...
                                                                      int param_openMode)
    {
        ...
        QIODevice::OpenModeFlag arg2 = (QIODevice::OpenModeFlag)(param_openMode);
    ...
    void QLocalSocketType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "connectToServer", _n_connectToServer0, None, Compiled, qt_QLocalSocket_connectToServer_void_QLocalSocket_int,
                         ...
                         new Param(c, "openMode", "int", Value((int)QIODevice::ReadWrite)), End),
            ...
            _func[8] = new MemberFunction(c, "atEnd", _n_atEnd0, None, Compiled, qt_QLocalSocket_atEnd_bool_QLocalSocket, Return, "bool",
                                          Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            _func[9] = new MemberFunction(c, "pos", _n_pos0, None, Compiled, qt_QLocalSocket_pos_int64_QLocalSocket, Return, "int64",
                                          Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            _func[10] = new MemberFunction(c, "reset", _n_reset0, None, Compiled, qt_QLocalSocket_reset_bool_QLocalSocket, Return, "bool",
                                           Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
            _func[11] = new MemberFunction(c, "seek", _n_seek0, None, Compiled, qt_QLocalSocket_seek_bool_QLocalSocket_int64, Return,
                                           "bool", Parameters, new Param(c, "this", "qt.QLocalSocket"), new Param(c, "pos", "int64"), End),
            _func[12] = new MemberFunction(c, "size", _n_size0, None, Compiled, qt_QLocalSocket_size_int64_QLocalSocket, Return, "int64",
                                           Parameters, new Param(c, "this", "qt.QLocalSocket"), End),
