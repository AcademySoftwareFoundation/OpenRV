...
addSymbols(
    ...
    new Function(c, "sortByColumn", _n_sortByColumn0, None, Compiled, qt_QTreeView_sortByColumn_void_QTreeView_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "column", "int"), new Param(c, "order", "int"), End),
    ...
    // MISSING: dataChanged (void; QTreeView this, QModelIndex topLeft, QModelIndex bottomRight, "const QVector<int> &" roles)
    ...
    // MISSING: scrollTo (void; QTreeView this, QModelIndex index, "ScrollHint" hint)
    _func[3] = new MemberFunction(c, "selectAll", _n_selectAll0, None, Compiled, qt_QTreeView_selectAll_void_QTreeView, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), End),
    _func[4] = new MemberFunction(c, "setModel", _n_setModel0, None, Compiled, qt_QTreeView_setModel_void_QTreeView_QAbstractItemModel, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "model", "qt.QAbstractItemModel"), End),
    _func[5] = new MemberFunction(c, "setRootIndex", _n_setRootIndex0, None, Compiled, qt_QTreeView_setRootIndex_void_QTreeView_QModelIndex, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "index", "qt.QModelIndex"), End),
    _func[6] = new MemberFunction(c, "setSelectionModel", _n_setSelectionModel0, None, Compiled, qt_QTreeView_setSelectionModel_void_QTreeView_QItemSelectionModel, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "selectionModel", "qt.QItemSelectionModel"), End),
    _func[7] = new MemberFunction(c, "visualRect", _n_visualRect0, None, Compiled, qt_QTreeView_visualRect_QRect_QTreeView_QModelIndex, Return, "qt.QRect", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "index", "qt.QModelIndex"), End),
    ...
    _func[8] = new MemberFunction(c, "currentChanged", _n_currentChanged0, None, Compiled, qt_QTreeView_currentChanged_void_QTreeView_QModelIndex_QModelIndex, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "current", "qt.QModelIndex"), new Param(c, "previous", "qt.QModelIndex"), End),
    _func[9] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QTreeView_dragMoveEvent_void_QTreeView_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QDragMoveEvent"), End),
    _func[10] = new MemberFunction(c, "horizontalOffset", _n_horizontalOffset0, None, Compiled, qt_QTreeView_horizontalOffset_int_QTreeView, Return, "int", Parameters, new Param(c, "this", "qt.QTreeView"), End),
    _func[11] = new MemberFunction(c, "isIndexHidden", _n_isIndexHidden0, None, Compiled, qt_QTreeView_isIndexHidden_bool_QTreeView_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "index", "qt.QModelIndex"), End),
    _func[12] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QTreeView_keyPressEvent_void_QTreeView_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[13] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QTreeView_mouseDoubleClickEvent_void_QTreeView_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[14] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QTreeView_mouseMoveEvent_void_QTreeView_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[15] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QTreeView_mousePressEvent_void_QTreeView_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[16] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QTreeView_mouseReleaseEvent_void_QTreeView_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QMouseEvent"), End),
    // MISSING: moveCursor (QModelIndex; QTreeView this, "CursorAction" cursorAction, flags Qt::KeyboardModifiers modifiers) // protected
    _func[17] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QTreeView_paintEvent_void_QTreeView_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QPaintEvent"), End),
    _func[18] = new MemberFunction(c, "rowsAboutToBeRemoved", _n_rowsAboutToBeRemoved0, None, Compiled, qt_QTreeView_rowsAboutToBeRemoved_void_QTreeView_QModelIndex_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "parent", "qt.QModelIndex"), new Param(c, "start", "int"), new Param(c, "end", "int"), End),
    _func[19] = new MemberFunction(c, "rowsInserted", _n_rowsInserted0, None, Compiled, qt_QTreeView_rowsInserted_void_QTreeView_QModelIndex_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "parent", "qt.QModelIndex"), new Param(c, "start", "int"), new Param(c, "end", "int"), End),
    _func[20] = new MemberFunction(c, "scrollContentsBy", _n_scrollContentsBy0, None, Compiled, qt_QTreeView_scrollContentsBy_void_QTreeView_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "dx", "int"), new Param(c, "dy", "int"), End),
    _func[21] = new MemberFunction(c, "selectedIndexes", _n_selectedIndexes0, None, Compiled, qt_QTreeView_selectedIndexes_qt__QModelIndexBSB_ESB__QTreeView, Return, "qt.QModelIndex[]", Parameters, new Param(c, "this", "qt.QTreeView"), End),
    _func[22] = new MemberFunction(c, "selectionChanged", _n_selectionChanged0, None, Compiled, qt_QTreeView_selectionChanged_void_QTreeView_QItemSelection_QItemSelection, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "selected", "qt.QItemSelection"), new Param(c, "deselected", "qt.QItemSelection"), End),
    _func[23] = new MemberFunction(c, "setSelection", _n_setSelection0, None, Compiled, qt_QTreeView_setSelection_void_QTreeView_QRect_int, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "rect", "qt.QRect"), new Param(c, "command", "int"), End),
    _func[24] = new MemberFunction(c, "sizeHintForColumn", _n_sizeHintForColumn0, None, Compiled, qt_QTreeView_sizeHintForColumn_int_QTreeView_int, Return, "int", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "column", "int"), End),
    _func[25] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QTreeView_timerEvent_void_QTreeView_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QTimerEvent"), End),
    _func[26] = new MemberFunction(c, "updateGeometries", _n_updateGeometries0, None, Compiled, qt_QTreeView_updateGeometries_void_QTreeView, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), End),
    _func[27] = new MemberFunction(c, "verticalOffset", _n_verticalOffset0, None, Compiled, qt_QTreeView_verticalOffset_int_QTreeView, Return, "int", Parameters, new Param(c, "this", "qt.QTreeView"), End),
    _func[28] = new MemberFunction(c, "viewportEvent", _n_viewportEvent0, None, Compiled, qt_QTreeView_viewportEvent_bool_QTreeView_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QEvent"), End),
    _func[29] = new MemberFunction(c, "viewportSizeHint", _n_viewportSizeHint0, None, Compiled, qt_QTreeView_viewportSizeHint_QSize_QTreeView, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QTreeView"), End),
    _func[30] = new MemberFunction(c, "visualRegionForSelection", _n_visualRegionForSelection0, None, Compiled, qt_QTreeView_visualRegionForSelection_QRegion_QTreeView_QItemSelection, Return, "qt.QRegion", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "selection", "qt.QItemSelection"), End),
    _func[31] = new MemberFunction(c, "sizeHintForRow", _n_sizeHintForRow0, None, Compiled, qt_QTreeView_sizeHintForRow_int_QTreeView_int, Return, "int", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "row", "int"), End),
    _func[32] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QTreeView_inputMethodQuery_QVariant_QTreeView_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "query", "int"), End),
    _func[33] = new MemberFunction(c, "edit", _n_edit0, None, Compiled, qt_QTreeView_edit_bool_QTreeView_QModelIndex_int_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "index", "qt.QModelIndex"), new Param(c, "trigger", "int"), new Param(c, "event", "qt.QEvent"), End),
    _func[34] = new MemberFunction(c, "selectionCommand", _n_selectionCommand0, None, Compiled, qt_QTreeView_selectionCommand_int_QTreeView_QModelIndex_QEvent, Return, "int", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "index", "qt.QModelIndex"), new Param(c, "event", "qt.QEvent"), End),
    _func[35] = new MemberFunction(c, "startDrag", _n_startDrag0, None, Compiled, qt_QTreeView_startDrag_void_QTreeView_int, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "supportedActions", "int"), End),
    // MISSING: viewOptions ("QStyleOptionViewItem"; QTreeView this) // protected
    _func[36] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QTreeView_dragEnterEvent_void_QTreeView_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QDragEnterEvent"), End),
    _func[37] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QTreeView_dragLeaveEvent_void_QTreeView_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QDragLeaveEvent"), End),
    _func[38] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QTreeView_dropEvent_void_QTreeView_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QDropEvent"), End),
    _func[39] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QTreeView_event_bool_QTreeView_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event_", "qt.QEvent"), End),
    _func[40] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QTreeView_focusInEvent_void_QTreeView_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[41] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QTreeView_focusNextPrevChild_bool_QTreeView_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "next", "bool"), End),
    _func[42] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QTreeView_focusOutEvent_void_QTreeView_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QFocusEvent"), End),
    // MISSING: inputMethodEvent (void; QTreeView this, "QInputMethodEvent *" event) // protected
    _func[43] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QTreeView_resizeEvent_void_QTreeView_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTreeView"), new Param(c, "event", "qt.QResizeEvent"), End),
    // static functions
    EndArguments);
