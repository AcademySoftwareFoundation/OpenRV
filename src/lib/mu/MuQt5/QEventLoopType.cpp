...
{
    if (!_env) return QEventLoop::event(event_);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QEventLoop::eventFilter(watched, event);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QEventLoop::customEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QEventLoop::timerEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QEventLoop_QEventLoop_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    {
        QEventLoopType* type = 
            c->findSymbolOfTypeByQualifiedName<QEventLoopType>(c->internName("qt.QEventLoop"), false);
...
{
    NODE_RETURN( QEventLoop_QEventLoop_QObject(NODE_THREAD, NODE_ARG(0, Pointer)) );
}
...
void qt_QEventLoop_processEvents_void_QEventLoop_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_flags, int param_maxTime)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QEventLoop* arg0 = object<QEventLoop>(param_this);
    QEventLoop::ProcessEventsFlags arg1 = (QEventLoop::ProcessEventsFlags)(param_flags);
...
bool qt_QEventLoop_eventFilter_bool_QEventLoop_QObject_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_watched, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QEventLoop* arg0 = object<QEventLoop>(param_this);
...
void qt_QEventLoop_customEvent_void_QEventLoop_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QEventLoop*)arg0)->customEvent_pub_parent(arg1);
    else ((MuQt_QEventLoop*)arg0)->customEvent_pub(arg1);
}
...
void qt_QEventLoop_timerEvent_void_QEventLoop_QTimerEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QEventLoop*)arg0)->timerEvent_pub_parent(arg1);
    else ((MuQt_QEventLoop*)arg0)->timerEvent_pub(arg1);
}
...
{
    qt_QEventLoop_wakeUp_void_QEventLoop(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    NODE_RETURN(qt_QEventLoop_eventFilter_bool_QEventLoop_QObject_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
QEventLoopType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QEventLoop_QEventLoop_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QEventLoop", _n_QEventLoop0, None, Compiled, qt_QEventLoop_QEventLoop_QEventLoop_QEventLoop_QObject, Return, "qt.QEventLoop", Parameters, new Param(c, "this", "qt.QEventLoop"), new Param(c, "parent", "qt.QObject"), End),
    new Function(c, "exec", _n_exec0, None, Compiled, qt_QEventLoop_exec_int_QEventLoop_int, Return, "int", Parameters, new Param(c, "this", "qt.QEventLoop"), new Param(c, "flags", "int", Value((int)QEventLoop::AllEvents)), End),
    new Function(c, "exit", _n_exit0, None, Compiled, qt_QEventLoop_exit_void_QEventLoop_int, Return, "void", Parameters, new Param(c, "this", "qt.QEventLoop"), new Param(c, "returnCode", "int", Value((int)0)), End),
    new Function(c, "isRunning", _n_isRunning0, None, Compiled, qt_QEventLoop_isRunning_bool_QEventLoop, Return, "bool", Parameters, new Param(c, "this", "qt.QEventLoop"), End),
    new Function(c, "processEvents", _n_processEvents0, None, Compiled, qt_QEventLoop_processEvents_bool_QEventLoop_int, Return, "bool", Parameters, new Param(c, "this", "qt.QEventLoop"), new Param(c, "flags", "int", Value((int)QEventLoop::AllEvents)), End),
    new Function(c, "processEvents", _n_processEvents1, None, Compiled, qt_QEventLoop_processEvents_void_QEventLoop_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QEventLoop"), new Param(c, "flags", "int"), new Param(c, "maxTime", "int"), End),
    new Function(c, "wakeUp", _n_wakeUp0, None, Compiled, qt_QEventLoop_wakeUp_void_QEventLoop, Return, "void", Parameters, new Param(c, "this", "qt.QEventLoop"), End),
    _func[0] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QEventLoop_event_bool_QEventLoop_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QEventLoop"), new Param(c, "event_", "qt.QEvent"), End),
    _func[1] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled, qt_QEventLoop_eventFilter_bool_QEventLoop_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QEventLoop"), new Param(c, "watched", "qt.QObject"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: metaObject ("const QMetaObject *"; QEventLoop this)
    // MISSING: childEvent (void; QEventLoop this, "QChildEvent *" event) // protected
    // MISSING: connectNotify (void; QEventLoop this, "const QMetaMethod &" signal) // protected
    _func[2] = new MemberFunction(c, "customEvent", _n_customEvent0, None, Compiled, qt_QEventLoop_customEvent_void_QEventLoop_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QEventLoop"), new Param(c, "event", "qt.QEvent"), End),
    // MISSING: disconnectNotify (void; QEventLoop this, "const QMetaMethod &" signal) // protected
    _func[3] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QEventLoop_timerEvent_void_QEventLoop_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QEventLoop"), new Param(c, "event", "qt.QTimerEvent"), End),
    // static functions
    EndArguments);
