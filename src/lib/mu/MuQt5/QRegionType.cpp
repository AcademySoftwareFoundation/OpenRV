...
Pointer qt_QRegion_QVariant_QVariant_QVariant_QRegion(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_from)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
{
    NODE_RETURN(qt_QRegion_QVariant_QVariant_QVariant_QRegion(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
addSymbols(
    ...
    new Function(c, "QRegion", _n_QRegion5, None, Compiled, qt_QRegion_QRegion_QRegion_QRegion_QBitmap, Return, "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "bm", "qt.QBitmap"), End),
...
globalScope()->addSymbols(
    ...
    EndArguments);
scope()->addSymbols(
    new Function(c, "QVariant", _co_n_QVariant0, Cast, Compiled, qt_QRegion_QVariant_QVariant_QVariant_QRegion, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QVariant"), new Param(c, "from", "qt.QRegion"), End),
    EndArguments);
