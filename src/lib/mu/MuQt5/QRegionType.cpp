...
namespace Mu
{
    ...
    void QRegionType::load()
    {
        ...
        addSymbols(
            ...
            // this, QRegion r)
            new Function(c, "QRegion", _n_QRegion5, None, Compiled, qt_QRegion_QRegion_QRegion_QRegion_QBitmap, Return, "qt.QRegion",
        ...
        globalScope()->addSymbols(
            ...
            new Function(c, "|=", _n_operatorPipe_EQ_0, Op, Compiled, qt_QRegion_operatorPipe_EQ__QRegion_QRegion_QRegion, Return,
                         "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            EndArguments);
        scope()->addSymbols(new Function(c, "QVariant", _co_n_QVariant0, Cast, Compiled, qt_QRegion_QVariant_QVariant_QVariant_QRegion,
