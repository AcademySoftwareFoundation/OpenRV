...
{
    if (!_env) return QDialog::event(e);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDialog::enterEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
void qt_QDialog_enterEvent_void_QDialog_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QDialog* arg0 = object<QDialog>(param_this);
    QEvent * arg1 = getqpointer<QEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QDialog*)arg0)->enterEvent_pub_parent(arg1);
    else ((MuQt_QDialog*)arg0)->enterEvent_pub(arg1);
}
...
addSymbols(
    ...
    _func[5] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QDialog_event_bool_QDialog_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "e", "qt.QEvent"), End),
    _func[6] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled, qt_QDialog_eventFilter_bool_QDialog_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "o", "qt.QObject"), new Param(c, "e", "qt.QEvent"), End),
    _func[7] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QDialog_keyPressEvent_void_QDialog_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "e", "qt.QKeyEvent"), End),
    _func[8] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QDialog_resizeEvent_void_QDialog_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "_p15", "qt.QResizeEvent"), End),
    _func[9] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QDialog_showEvent_void_QDialog_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QShowEvent"), End),
    _func[10] = new MemberFunction(c, "hasHeightForWidth", _n_hasHeightForWidth0, None, Compiled, qt_QDialog_hasHeightForWidth_bool_QDialog, Return, "bool", Parameters, new Param(c, "this", "qt.QDialog"), End),
    _func[11] = new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QDialog_heightForWidth_int_QDialog_int, Return, "int", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "w", "int"), End),
    _func[12] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QDialog_inputMethodQuery_QVariant_QDialog_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "query", "int"), End),
    // MISSING: paintEngine ("QPaintEngine *"; QDialog this)
    // MISSING: actionEvent (void; QDialog this, "QActionEvent *" event) // protected
    _func[13] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled, qt_QDialog_changeEvent_void_QDialog_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QEvent"), End),
    _func[14] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QDialog_dragEnterEvent_void_QDialog_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QDragEnterEvent"), End),
    _func[15] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QDialog_dragLeaveEvent_void_QDialog_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QDragLeaveEvent"), End),
    _func[16] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QDialog_dragMoveEvent_void_QDialog_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QDragMoveEvent"), End),
    _func[17] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QDialog_dropEvent_void_QDialog_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QDropEvent"), End),
    _func[18] = new MemberFunction(c, "enterEvent", _n_enterEvent0, None, Compiled, qt_QDialog_enterEvent_void_QDialog_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QEvent"), End),
    _func[19] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QDialog_focusInEvent_void_QDialog_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[20] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QDialog_focusNextPrevChild_bool_QDialog_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "next", "bool"), End),
    _func[21] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QDialog_focusOutEvent_void_QDialog_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[22] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QDialog_hideEvent_void_QDialog_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QHideEvent"), End),
    // MISSING: inputMethodEvent (void; QDialog this, "QInputMethodEvent *" event) // protected
    _func[23] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QDialog_keyReleaseEvent_void_QDialog_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[24] = new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QDialog_leaveEvent_void_QDialog_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QEvent"), End),
    _func[25] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QDialog_mouseDoubleClickEvent_void_QDialog_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[26] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QDialog_mouseMoveEvent_void_QDialog_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[27] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QDialog_mousePressEvent_void_QDialog_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[28] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QDialog_mouseReleaseEvent_void_QDialog_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[29] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QDialog_moveEvent_void_QDialog_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QDialog this, QByteArray eventType, "void *" message, "long *" result) // protected
    _func[30] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QDialog_paintEvent_void_QDialog_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QPaintEvent"), End),
    _func[31] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QDialog_tabletEvent_void_QDialog_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QTabletEvent"), End),
    _func[32] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QDialog_wheelEvent_void_QDialog_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "event", "qt.QWheelEvent"), End),
    // MISSING: initPainter (void; QDialog this, "QPainter *" painter) // protected
    _func[33] = new MemberFunction(c, "metric", _n_metric0, None, Compiled, qt_QDialog_metric_int_QDialog_int, Return, "int", Parameters, new Param(c, "this", "qt.QDialog"), new Param(c, "m", "int"), End),
    // static functions
    EndArguments);
