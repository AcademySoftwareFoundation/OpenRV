...
{
    if (!_env) return QAbstractTableModel::sibling(row, column, idx);
    MuLangContext* c = (MuLangContext*)_env->context();
...
bool MuQt_QAbstractTableModel::canDropMimeData(const QMimeData * data, Qt::DropAction action, int row, int column, const QModelIndex & parent) const
{
    if (!_env) return QAbstractTableModel::canDropMimeData(data, action, row, column, parent);
    MuLangContext* c = (MuLangContext*)_env->context();
...
bool MuQt_QAbstractTableModel::moveColumns(const QModelIndex & sourceParent, int sourceColumn, int count, const QModelIndex & destinationParent, int destinationChild) 
{
    if (!_env) return QAbstractTableModel::moveColumns(sourceParent, sourceColumn, count, destinationParent, destinationChild);
    MuLangContext* c = (MuLangContext*)_env->context();
...
bool MuQt_QAbstractTableModel::moveRows(const QModelIndex & sourceParent, int sourceRow, int count, const QModelIndex & destinationParent, int destinationChild) 
{
    if (!_env) return QAbstractTableModel::moveRows(sourceParent, sourceRow, count, destinationParent, destinationChild);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QAbstractTableModel::supportedDragActions();
    MuLangContext* c = (MuLangContext*)_env->context();
...
Pointer qt_QAbstractTableModel_sibling_QModelIndex_QAbstractTableModel_int_int_QModelIndex(Mu::Thread& NODE_THREAD, Pointer param_this, int param_row, int param_column, Pointer param_idx)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractTableModel* arg0 = object<QAbstractTableModel>(param_this);
    int arg1 = (int)(param_row);
    ...
    return isMuQtObject(arg0) ? makeqtype<QModelIndexType>(c,arg0->QAbstractTableModel::sibling(arg1, arg2, arg3),"qt.QModelIndex") : makeqtype<QModelIndexType>(c,arg0->sibling(arg1, arg2, arg3),"qt.QModelIndex");
}
...
bool qt_QAbstractTableModel_canDropMimeData_bool_QAbstractTableModel_QMimeData_int_int_int_QModelIndex(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_data, int param_action, int param_row, int param_column, Pointer param_parent)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractTableModel* arg0 = object<QAbstractTableModel>(param_this);
    const QMimeData * arg1 = object<QMimeData>(param_data);
    ...
    int arg4 = (int)(param_column);
    const QModelIndex  arg5 = getqtype<QModelIndexType>(param_parent);
    return isMuQtObject(arg0) ? arg0->QAbstractTableModel::canDropMimeData(arg1, arg2, arg3, arg4, arg5) : arg0->canDropMimeData(arg1, arg2, arg3, arg4, arg5);
}
...
bool qt_QAbstractTableModel_moveColumns_bool_QAbstractTableModel_QModelIndex_int_int_QModelIndex_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_sourceParent, int param_sourceColumn, int param_count, Pointer param_destinationParent, int param_destinationChild)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractTableModel* arg0 = object<QAbstractTableModel>(param_this);
    ...
    return isMuQtObject(arg0) ? arg0->QAbstractTableModel::moveColumns(arg1, arg2, arg3, arg4, arg5) : arg0->moveColumns(arg1, arg2, arg3, arg4, arg5);
}

bool qt_QAbstractTableModel_moveRows_bool_QAbstractTableModel_QModelIndex_int_int_QModelIndex_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_sourceParent, int param_sourceRow, int param_count, Pointer param_destinationParent, int param_destinationChild)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QAbstractTableModel* arg0 = object<QAbstractTableModel>(param_this);
    const QModelIndex  arg1 = getqtype<QModelIndexType>(param_sourceParent);
    ...
    const QModelIndex  arg4 = getqtype<QModelIndexType>(param_destinationParent);
    int arg5 = (int)(param_destinationChild);
    return isMuQtObject(arg0) ? arg0->QAbstractTableModel::moveRows(arg1, arg2, arg3, arg4, arg5) : arg0->moveRows(arg1, arg2, arg3, arg4, arg5);
}
...
{
    NODE_RETURN(qt_QAbstractTableModel_sibling_QModelIndex_QAbstractTableModel_int_int_QModelIndex(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int), NODE_ARG(3, Pointer)));
}
...
{
    NODE_RETURN(qt_QAbstractTableModel_canDropMimeData_bool_QAbstractTableModel_QMimeData_int_int_int_QModelIndex(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, int), NODE_ARG(4, int), NODE_ARG(5, Pointer)));
}
...
{
    NODE_RETURN(qt_QAbstractTableModel_moveColumns_bool_QAbstractTableModel_QModelIndex_int_int_QModelIndex_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, int), NODE_ARG(4, Pointer), NODE_ARG(5, int)));
}

static NODE_IMPLEMENTATION(_n_moveRows0, bool)
{
    NODE_RETURN(qt_QAbstractTableModel_moveRows_bool_QAbstractTableModel_QModelIndex_int_int_QModelIndex_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, int), NODE_ARG(4, Pointer), NODE_ARG(5, int)));
}
...
addSymbols(
    ...
    _func[2] = new MemberFunction(c, "index", _n_index0, None, Compiled, qt_QAbstractTableModel_index_QModelIndex_QAbstractTableModel_int_int_QModelIndex, Return, "qt.QModelIndex", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "row", "int"), new Param(c, "column", "int"), new Param(c, "parent", "qt.QModelIndex"), End),
    _func[3] = new MemberFunction(c, "sibling", _n_sibling0, None, Compiled, qt_QAbstractTableModel_sibling_QModelIndex_QAbstractTableModel_int_int_QModelIndex, Return, "qt.QModelIndex", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "row", "int"), new Param(c, "column", "int"), new Param(c, "idx", "qt.QModelIndex"), End),
    ...
    _func[6] = new MemberFunction(c, "canFetchMore", _n_canFetchMore0, None, Compiled, qt_QAbstractTableModel_canFetchMore_bool_QAbstractTableModel_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "parent", "qt.QModelIndex"), End),
    _func[7] = new MemberFunction(c, "columnCount", _n_columnCount0, None, Compiled, qt_QAbstractTableModel_columnCount_int_QAbstractTableModel_QModelIndex, Return, "int", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "parent", "qt.QModelIndex"), End),
    _func[8] = new MemberFunction(c, "data", _n_data0, None, Compiled, qt_QAbstractTableModel_data_QVariant_QAbstractTableModel_QModelIndex_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "index", "qt.QModelIndex"), new Param(c, "role", "int", Value((int)Qt::DisplayRole)), End),
    _func[9] = new MemberFunction(c, "fetchMore", _n_fetchMore0, None, Compiled, qt_QAbstractTableModel_fetchMore_void_QAbstractTableModel_QModelIndex, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "parent", "qt.QModelIndex"), End),
    _func[10] = new MemberFunction(c, "headerData", _n_headerData0, None, Compiled, qt_QAbstractTableModel_headerData_QVariant_QAbstractTableModel_int_int_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "section", "int"), new Param(c, "orientation", "int"), new Param(c, "role", "int", Value((int)Qt::DisplayRole)), End),
    _func[11] = new MemberFunction(c, "insertColumns", _n_insertColumns0, None, Compiled, qt_QAbstractTableModel_insertColumns_bool_QAbstractTableModel_int_int_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "column", "int"), new Param(c, "count", "int"), new Param(c, "parent", "qt.QModelIndex"), End),
    _func[12] = new MemberFunction(c, "insertRows", _n_insertRows0, None, Compiled, qt_QAbstractTableModel_insertRows_bool_QAbstractTableModel_int_int_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "row", "int"), new Param(c, "count", "int"), new Param(c, "parent", "qt.QModelIndex"), End),
    // MISSING: itemData ("QMap<int, QVariant>"; QAbstractTableModel this, QModelIndex index)
    _func[13] = new MemberFunction(c, "match", _n_match0, None, Compiled, qt_QAbstractTableModel_match_qt__QModelIndexBSB_ESB__QAbstractTableModel_QModelIndex_int_QVariant_int_int, Return, "qt.QModelIndex[]", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "start", "qt.QModelIndex"), new Param(c, "role", "int"), new Param(c, "value", "qt.QVariant"), new Param(c, "hits", "int", Value((int)1)), new Param(c, "flags", "int", Value((int)Qt::MatchFlags( Qt::MatchStartsWith | Qt::MatchWrap ))), End),
    _func[14] = new MemberFunction(c, "mimeData", _n_mimeData0, None, Compiled, qt_QAbstractTableModel_mimeData_QMimeData_QAbstractTableModel_qt__QModelIndexBSB_ESB_, Return, "qt.QMimeData", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "indexes", "qt.QModelIndex[]"), End),
    _func[15] = new MemberFunction(c, "mimeTypes", _n_mimeTypes0, None, Compiled, qt_QAbstractTableModel_mimeTypes_stringBSB_ESB__QAbstractTableModel, Return, "string[]", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), End),
    _func[16] = new MemberFunction(c, "moveColumns", _n_moveColumns0, None, Compiled, qt_QAbstractTableModel_moveColumns_bool_QAbstractTableModel_QModelIndex_int_int_QModelIndex_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "sourceParent", "qt.QModelIndex"), new Param(c, "sourceColumn", "int"), new Param(c, "count", "int"), new Param(c, "destinationParent", "qt.QModelIndex"), new Param(c, "destinationChild", "int"), End),
    _func[17] = new MemberFunction(c, "moveRows", _n_moveRows0, None, Compiled, qt_QAbstractTableModel_moveRows_bool_QAbstractTableModel_QModelIndex_int_int_QModelIndex_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "sourceParent", "qt.QModelIndex"), new Param(c, "sourceRow", "int"), new Param(c, "count", "int"), new Param(c, "destinationParent", "qt.QModelIndex"), new Param(c, "destinationChild", "int"), End),
    _func[18] = new MemberFunction(c, "removeColumns", _n_removeColumns0, None, Compiled, qt_QAbstractTableModel_removeColumns_bool_QAbstractTableModel_int_int_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "column", "int"), new Param(c, "count", "int"), new Param(c, "parent", "qt.QModelIndex"), End),
    _func[19] = new MemberFunction(c, "removeRows", _n_removeRows0, None, Compiled, qt_QAbstractTableModel_removeRows_bool_QAbstractTableModel_int_int_QModelIndex, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "row", "int"), new Param(c, "count", "int"), new Param(c, "parent", "qt.QModelIndex"), End),
    // MISSING: roleNames ("QHash<int, QByteArray>"; QAbstractTableModel this)
    _func[20] = new MemberFunction(c, "rowCount", _n_rowCount0, None, Compiled, qt_QAbstractTableModel_rowCount_int_QAbstractTableModel_QModelIndex, Return, "int", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "parent", "qt.QModelIndex"), End),
    _func[21] = new MemberFunction(c, "setData", _n_setData0, None, Compiled, qt_QAbstractTableModel_setData_bool_QAbstractTableModel_QModelIndex_QVariant_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "index", "qt.QModelIndex"), new Param(c, "value", "qt.QVariant"), new Param(c, "role", "int", Value((int)Qt::EditRole)), End),
    _func[22] = new MemberFunction(c, "setHeaderData", _n_setHeaderData0, None, Compiled, qt_QAbstractTableModel_setHeaderData_bool_QAbstractTableModel_int_int_QVariant_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "section", "int"), new Param(c, "orientation", "int"), new Param(c, "value", "qt.QVariant"), new Param(c, "role", "int", Value((int)Qt::EditRole)), End),
    // MISSING: setItemData (bool; QAbstractTableModel this, QModelIndex index, "const QMap<int, QVariant> &" roles)
    _func[23] = new MemberFunction(c, "sort", _n_sort0, None, Compiled, qt_QAbstractTableModel_sort_void_QAbstractTableModel_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "column", "int"), new Param(c, "order", "int", Value((int)Qt::AscendingOrder)), End),
    _func[24] = new MemberFunction(c, "span", _n_span0, None, Compiled, qt_QAbstractTableModel_span_QSize_QAbstractTableModel_QModelIndex, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "index", "qt.QModelIndex"), End),
    _func[25] = new MemberFunction(c, "supportedDragActions", _n_supportedDragActions0, None, Compiled, qt_QAbstractTableModel_supportedDragActions_int_QAbstractTableModel, Return, "int", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), End),
    _func[26] = new MemberFunction(c, "supportedDropActions", _n_supportedDropActions0, None, Compiled, qt_QAbstractTableModel_supportedDropActions_int_QAbstractTableModel, Return, "int", Parameters, new Param(c, "this", "qt.QAbstractTableModel"), End),
    // static functions
    EndArguments);
