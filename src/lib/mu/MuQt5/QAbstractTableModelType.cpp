...
namespace Mu
{
    ...
    void QAbstractTableModelType::load()
    {
        ...
        addSymbols(
            ...
            _func[7] = new MemberFunction(c, "columnCount", _n_columnCount0, None, Compiled,
            ...
            _func[9] = new MemberFunction(c, "fetchMore", _n_fetchMore0, None, Compiled,
                                          qt_QAbstractTableModel_fetchMore_void_QAbstractTableModel_QModelIndex, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QAbstractTableModel"), new Param(c, "parent", "qt.QModelIndex"), End),
