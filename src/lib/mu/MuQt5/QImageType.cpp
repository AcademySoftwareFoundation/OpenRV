...
namespace Mu
{
    ...
    Pointer qt_QImage_transformed_QImage_QImage_QMatrix_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_matrix,
                                                            int param_mode)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QImage& arg0 = getqtype<QImageType>(param_this);
    ...
    {
        NODE_RETURN(qt_QImage_transformed_QImage_QImage_QMatrix_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                    NODE_ARG(2, int)));
    }
    ...
    void QImageType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "byteCount", _n_byteCount0, None, Compiled, qt_QImage_byteCount_int_QImage, Return, "int", Parameters,
                         new Param(c, "this", "qt.QImage"), End),
            new Function(c, "bytesPerLine", _n_bytesPerLine0, None, Compiled, qt_QImage_bytesPerLine_int_QImage, Return, "int", Parameters,
                         new Param(c, "this", "qt.QImage"), End),
            ...
            new Function(c, "textKeys", _n_textKeys0, None, Compiled, qt_QImage_textKeys_stringBSB_ESB__QImage, Return, "string[]",
                         Parameters, new Param(c, "this", "qt.QImage"), End),
            new Function(c, "transformed", _n_transformed0, None, Compiled, qt_QImage_transformed_QImage_QImage_QMatrix_int, Return,
                         "qt.QImage", Parameters, new Param(c, "this", "qt.QImage"), new Param(c, "matrix", "qt.QMatrix"),
                         new Param(c, "mode", "int", Value((int)Qt::FastTransformation)), End),
            new Function(c, "transformed", _n_transformed1, None, Compiled, qt_QImage_transformed_QImage_QImage_QTransform_int, Return,
            ...
            new Function(c, "trueMatrix", _n_trueMatrix0, None, Compiled, qt_QImage_trueMatrix_QMatrix_QMatrix_int_int, Return,
                         "qt.QMatrix", Parameters, new Param(c, "matrix", "qt.QMatrix"), new Param(c, "width", "int"),
                         new Param(c, "height", "int"), End),
            new Function(c, "trueMatrix", _n_trueMatrix1, None, Compiled, qt_QImage_trueMatrix_QTransform_QTransform_int_int, Return,
        ...
        globalScope()->addSymbols(
            ...
            EndArguments);
        scope()->addSymbols(new Function(c, "QVariant", _co_n_QVariant0, Cast, Compiled, qt_QImage_QVariant_QVariant_QVariant_QImage,
