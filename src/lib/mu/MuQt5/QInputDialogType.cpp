...
{
    if (!_env) { QInputDialog::done(result); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QInputDialog::minimumSizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QInputDialog::setVisible(visible); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QInputDialog::sizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QInputDialog::closeEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QInputDialog::contextMenuEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QInputDialog::event(e);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QInputDialog::eventFilter(o, e);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QInputDialog::keyPressEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QInputDialog::resizeEvent(_p15); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QInputDialog::showEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QInputDialog_QInputDialog_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    else if (QInputDialog* w = object<QInputDialog>(widget))
    {
        QInputDialogType* type = 
            c->findSymbolOfTypeByQualifiedName<QInputDialogType>(c->internName("qt.QInputDialog"), false);
...
void qt_QInputDialog_setDoubleRange_void_QInputDialog_double_double(Mu::Thread& NODE_THREAD, Pointer param_this, double param_min, double param_max)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QInputDialog* arg0 = object<QInputDialog>(param_this);
    double arg1 = (double)(param_min);
...
void qt_QInputDialog_done_void_QInputDialog_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_result)
{
    ...
    if (isMuQtObject(arg0)) arg0->QInputDialog::done(arg1);
    else arg0->done(arg1);
}
...
Pointer qt_QInputDialog_minimumSizeHint_QSize_QInputDialog(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QInputDialog* arg0 = object<QInputDialog>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QInputDialog::minimumSizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->minimumSizeHint(),"qt.QSize");
}
...
void qt_QInputDialog_setVisible_void_QInputDialog_bool(Mu::Thread& NODE_THREAD, Pointer param_this, bool param_visible)
{
    ...
    if (isMuQtObject(arg0)) arg0->QInputDialog::setVisible(arg1);
...
Pointer qt_QInputDialog_sizeHint_QSize_QInputDialog(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QInputDialog* arg0 = object<QInputDialog>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QInputDialog::sizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->sizeHint(),"qt.QSize");
}
...
void qt_QInputDialog_closeEvent_void_QInputDialog_QCloseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QInputDialog*)arg0)->closeEvent_pub_parent(arg1);
    else ((MuQt_QInputDialog*)arg0)->closeEvent_pub(arg1);
}
...
void qt_QInputDialog_contextMenuEvent_void_QInputDialog_QContextMenuEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QInputDialog*)arg0)->contextMenuEvent_pub_parent(arg1);
    else ((MuQt_QInputDialog*)arg0)->contextMenuEvent_pub(arg1);
}

bool qt_QInputDialog_event_bool_QInputDialog_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QInputDialog* arg0 = object<QInputDialog>(param_this);
    QEvent * arg1 = getqpointer<QEventType>(param_e);
    return isMuQtObject(arg0) ? ((MuQt_QInputDialog*)arg0)->event_pub_parent(arg1) : ((MuQt_QInputDialog*)arg0)->event_pub(arg1);
}

bool qt_QInputDialog_eventFilter_bool_QInputDialog_QObject_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_o, Pointer param_e)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QInputDialog* arg0 = object<QInputDialog>(param_this);
    QObject * arg1 = object<QObject>(param_o);
    QEvent * arg2 = getqpointer<QEventType>(param_e);
    return isMuQtObject(arg0) ? ((MuQt_QInputDialog*)arg0)->eventFilter_pub_parent(arg1, arg2) : ((MuQt_QInputDialog*)arg0)->eventFilter_pub(arg1, arg2);
}
...
void qt_QInputDialog_keyPressEvent_void_QInputDialog_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QInputDialog*)arg0)->keyPressEvent_pub_parent(arg1);
    else ((MuQt_QInputDialog*)arg0)->keyPressEvent_pub(arg1);
}
...
void qt_QInputDialog_resizeEvent_void_QInputDialog_QResizeEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param__p15)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QInputDialog*)arg0)->resizeEvent_pub_parent(arg1);
    else ((MuQt_QInputDialog*)arg0)->resizeEvent_pub(arg1);
}
...
void qt_QInputDialog_showEvent_void_QInputDialog_QShowEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QInputDialog*)arg0)->showEvent_pub_parent(arg1);
    else ((MuQt_QInputDialog*)arg0)->showEvent_pub(arg1);
}


static NODE_IMPLEMENTATION(_n_QInputDialog0, Pointer)
{
    NODE_RETURN(qt_QInputDialog_QInputDialog_QInputDialog_QInputDialog_QWidget_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int)));
}
...
{
    qt_QInputDialog_setDoubleRange_void_QInputDialog_double_double(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, double), NODE_ARG(2, double));
}
...
{
    qt_QInputDialog_contextMenuEvent_void_QInputDialog_QContextMenuEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}

static NODE_IMPLEMENTATION(_n_event0, bool)
{
    NODE_RETURN(qt_QInputDialog_event_bool_QInputDialog_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}

static NODE_IMPLEMENTATION(_n_eventFilter0, bool)
{
    NODE_RETURN(qt_QInputDialog_eventFilter_bool_QInputDialog_QObject_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
}
...
QInputDialogType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QInputDialog_QInputDialog_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    ...
    new Function(c, "doubleMaximum", _n_doubleMaximum0, None, Compiled, qt_QInputDialog_doubleMaximum_double_QInputDialog, Return, "double", Parameters, new Param(c, "this", "qt.QInputDialog"), End),
    ...
    new Function(c, "doubleValue", _n_doubleValue0, None, Compiled, qt_QInputDialog_doubleValue_double_QInputDialog, Return, "double", Parameters, new Param(c, "this", "qt.QInputDialog"), End),
    new Function(c, "inputMode", _n_inputMode0, None, Compiled, qt_QInputDialog_inputMode_int_QInputDialog, Return, "int", Parameters, new Param(c, "this", "qt.QInputDialog"), End),
    new Function(c, "intMaximum", _n_intMaximum0, None, Compiled, qt_QInputDialog_intMaximum_int_QInputDialog, Return, "int", Parameters, new Param(c, "this", "qt.QInputDialog"), End),
    ...
    new Function(c, "isComboBoxEditable", _n_isComboBoxEditable0, None, Compiled, qt_QInputDialog_isComboBoxEditable_bool_QInputDialog, Return, "bool", Parameters, new Param(c, "this", "qt.QInputDialog"), End),
    new Function(c, "labelText", _n_labelText0, None, Compiled, qt_QInputDialog_labelText_string_QInputDialog, Return, "string", Parameters, new Param(c, "this", "qt.QInputDialog"), End),
    ...
    // MISSING: open (void; QInputDialog this, QObject receiver, "const char *" member)
    new Function(c, "options", _n_options0, None, Compiled, qt_QInputDialog_options_int_QInputDialog, Return, "int", Parameters, new Param(c, "this", "qt.QInputDialog"), End),
    new Function(c, "setCancelButtonText", _n_setCancelButtonText0, None, Compiled, qt_QInputDialog_setCancelButtonText_void_QInputDialog_string, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "text", "string"), End),
    new Function(c, "setComboBoxEditable", _n_setComboBoxEditable0, None, Compiled, qt_QInputDialog_setComboBoxEditable_void_QInputDialog_bool, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "editable", "bool"), End),
    new Function(c, "setComboBoxItems", _n_setComboBoxItems0, None, Compiled, qt_QInputDialog_setComboBoxItems_void_QInputDialog_stringBSB_ESB_, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "items", "string[]"), End),
    new Function(c, "setDoubleDecimals", _n_setDoubleDecimals0, None, Compiled, qt_QInputDialog_setDoubleDecimals_void_QInputDialog_int, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "decimals", "int"), End),
    new Function(c, "setDoubleMaximum", _n_setDoubleMaximum0, None, Compiled, qt_QInputDialog_setDoubleMaximum_void_QInputDialog_double, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "max", "double"), End),
    new Function(c, "setDoubleMinimum", _n_setDoubleMinimum0, None, Compiled, qt_QInputDialog_setDoubleMinimum_void_QInputDialog_double, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "min", "double"), End),
    new Function(c, "setDoubleRange", _n_setDoubleRange0, None, Compiled, qt_QInputDialog_setDoubleRange_void_QInputDialog_double_double, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "min", "double"), new Param(c, "max", "double"), End),
    new Function(c, "setDoubleValue", _n_setDoubleValue0, None, Compiled, qt_QInputDialog_setDoubleValue_void_QInputDialog_double, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "value", "double"), End),
    new Function(c, "setInputMode", _n_setInputMode0, None, Compiled, qt_QInputDialog_setInputMode_void_QInputDialog_int, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "mode", "int"), End),
    new Function(c, "setIntMaximum", _n_setIntMaximum0, None, Compiled, qt_QInputDialog_setIntMaximum_void_QInputDialog_int, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "max", "int"), End),
    new Function(c, "setIntMinimum", _n_setIntMinimum0, None, Compiled, qt_QInputDialog_setIntMinimum_void_QInputDialog_int, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "min", "int"), End),
    new Function(c, "setIntRange", _n_setIntRange0, None, Compiled, qt_QInputDialog_setIntRange_void_QInputDialog_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "min", "int"), new Param(c, "max", "int"), End),
    new Function(c, "setIntStep", _n_setIntStep0, None, Compiled, qt_QInputDialog_setIntStep_void_QInputDialog_int, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "step", "int"), End),
    new Function(c, "setIntValue", _n_setIntValue0, None, Compiled, qt_QInputDialog_setIntValue_void_QInputDialog_int, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "value", "int"), End),
    new Function(c, "setLabelText", _n_setLabelText0, None, Compiled, qt_QInputDialog_setLabelText_void_QInputDialog_string, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "text", "string"), End),
    new Function(c, "setOkButtonText", _n_setOkButtonText0, None, Compiled, qt_QInputDialog_setOkButtonText_void_QInputDialog_string, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "text", "string"), End),
    new Function(c, "setOption", _n_setOption0, None, Compiled, qt_QInputDialog_setOption_void_QInputDialog_int_bool, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "option", "int"), new Param(c, "on", "bool"), End),
    new Function(c, "setOptions", _n_setOptions0, None, Compiled, qt_QInputDialog_setOptions_void_QInputDialog_int, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "options", "int"), End),
    new Function(c, "setTextEchoMode", _n_setTextEchoMode0, None, Compiled, qt_QInputDialog_setTextEchoMode_void_QInputDialog_int, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "mode", "int"), End),
    new Function(c, "setTextValue", _n_setTextValue0, None, Compiled, qt_QInputDialog_setTextValue_void_QInputDialog_string, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "text", "string"), End),
    new Function(c, "testOption", _n_testOption0, None, Compiled, qt_QInputDialog_testOption_bool_QInputDialog_int, Return, "bool", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "option", "int"), End),
    new Function(c, "textEchoMode", _n_textEchoMode0, None, Compiled, qt_QInputDialog_textEchoMode_int_QInputDialog, Return, "int", Parameters, new Param(c, "this", "qt.QInputDialog"), End),
    ...
    _func[0] = new MemberFunction(c, "done", _n_done0, None, Compiled, qt_QInputDialog_done_void_QInputDialog_int, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "result", "int"), End),
    _func[1] = new MemberFunction(c, "minimumSizeHint", _n_minimumSizeHint0, None, Compiled, qt_QInputDialog_minimumSizeHint_QSize_QInputDialog, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QInputDialog"), End),
    _func[2] = new MemberFunction(c, "setVisible", _n_setVisible0, None, Compiled, qt_QInputDialog_setVisible_void_QInputDialog_bool, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "visible", "bool"), End),
    _func[3] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QInputDialog_sizeHint_QSize_QInputDialog, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QInputDialog"), End),
    _func[4] = new MemberFunction(c, "closeEvent", _n_closeEvent0, None, Compiled, qt_QInputDialog_closeEvent_void_QInputDialog_QCloseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "e", "qt.QCloseEvent"), End),
    _func[5] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled, qt_QInputDialog_contextMenuEvent_void_QInputDialog_QContextMenuEvent, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "e", "qt.QContextMenuEvent"), End),
    _func[6] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QInputDialog_event_bool_QInputDialog_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "e", "qt.QEvent"), End),
    _func[7] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled, qt_QInputDialog_eventFilter_bool_QInputDialog_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "o", "qt.QObject"), new Param(c, "e", "qt.QEvent"), End),
    _func[8] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QInputDialog_keyPressEvent_void_QInputDialog_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "e", "qt.QKeyEvent"), End),
    _func[9] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QInputDialog_resizeEvent_void_QInputDialog_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "_p15", "qt.QResizeEvent"), End),
    _func[10] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QInputDialog_showEvent_void_QInputDialog_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "event", "qt.QShowEvent"), End),
    // static functions
    // MISSING: getDouble (double; QWidget parent, string title, string label, double value, double min, double max, int decimals, "bool *" ok, flags Qt::WindowFlags flags)
    // MISSING: getInt (int; QWidget parent, string title, string label, int value, int min, int max, int step, "bool *" ok, flags Qt::WindowFlags flags)
    // MISSING: getItem (string; QWidget parent, string title, string label, string[] items, int current, bool editable, "bool *" ok, flags Qt::WindowFlags flags, flags Qt::InputMethodHints inputMethodHints)
    // MISSING: getMultiLineText (string; QWidget parent, string title, string label, string text, "bool *" ok, flags Qt::WindowFlags flags, flags Qt::InputMethodHints inputMethodHints)
    // MISSING: getText (string; QWidget parent, string title, string label, flags QLineEdit::EchoMode mode, string text, "bool *" ok, flags Qt::WindowFlags flags, flags Qt::InputMethodHints inputMethodHints)
    EndArguments);
