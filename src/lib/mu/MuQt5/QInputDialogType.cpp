...
namespace Mu
{
    ...
    void QInputDialogType::load()
    {
        ...
        addSymbols(
            ...
            _func[6] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QInputDialog_event_bool_QInputDialog_QEvent, Return,
                                          "bool", Parameters, new Param(c, "this", "qt.QInputDialog"), new Param(c, "e", "qt.QEvent"), End),
