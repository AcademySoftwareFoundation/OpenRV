...
addSymbols(
    ...
    // MISSING: viewOptions ("QStyleOptionViewItem"; QHeaderView this) // protected
    ...
    _func[31] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QHeaderView_focusInEvent_void_QHeaderView_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[32] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QHeaderView_focusNextPrevChild_bool_QHeaderView_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "next", "bool"), End),
    _func[33] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QHeaderView_focusOutEvent_void_QHeaderView_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QFocusEvent"), End),
    // MISSING: inputMethodEvent (void; QHeaderView this, "QInputMethodEvent *" event) // protected
    _func[34] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QHeaderView_keyPressEvent_void_QHeaderView_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[35] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QHeaderView_resizeEvent_void_QHeaderView_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QResizeEvent"), End),
    _func[36] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QHeaderView_timerEvent_void_QHeaderView_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QHeaderView"), new Param(c, "event", "qt.QTimerEvent"), End),
    _func[37] = new MemberFunction(c, "viewportSizeHint", _n_viewportSizeHint0, None, Compiled, qt_QHeaderView_viewportSizeHint_QSize_QHeaderView, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QHeaderView"), End),
    // static functions
    EndArguments);
