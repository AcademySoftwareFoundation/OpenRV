...
addSymbols(
    ...
    // MISSING: qRegisterAnimationInterpolator (void; "QVariant(* ) ( const T & from, const T & to, qreal progress )" func)
    // MISSING: qAddPostRoutine (void; "QtCleanUpFunction" ptr)
    // MISSING: qt_extension ("T"; "QAbstractExtensionManager *" manager, QObject object)
    // MISSING: qRegisterStaticPluginInstanceFunction (void; "QtPluginInstanceFunction" function)
    // MISSING: qScriptConnect (bool; QObject sender, "const char *" signal, "const QScriptValue &" receiver, "const QScriptValue &" function)
    // MISSING: qScriptDisconnect (bool; QObject sender, "const char *" signal, "const QScriptValue &" receiver, "const QScriptValue &" function)
    // MISSING: qScriptRegisterMetaType (int; "QScriptEngine *" engine, "QScriptValue(* ) ( QScriptEngine *, const T & t )" toScriptValue, "void(* ) ( const QScriptValue &, T & t )" fromScriptValue, "const QScriptValue &" prototype)
    // MISSING: qScriptRegisterSequenceMetaType (int; "QScriptEngine *" engine, "const QScriptValue &" prototype)
    // MISSING: qScriptValueFromQMetaObject ("QScriptValue"; "QScriptEngine *" engine)
    // MISSING: qScriptValueFromSequence ("QScriptValue"; "QScriptEngine *" engine, "const Container &" container)
    // MISSING: qScriptValueFromValue ("QScriptValue"; "QScriptEngine *" engine, "const T &" value)
    // MISSING: qScriptValueToSequence (void; "const QScriptValue &" value, "Container &" container)
    // MISSING: qScriptValueToValue ("T"; "const QScriptValue &" value)
    // MISSING: qVariantFromValue (QVariant; "const T &" value)
    // MISSING: qVariantSetValue (void; QVariant variant, "const T &" value)
    // MISSING: qVariantValue ("T"; QVariant value)
    // MISSING: qvariant_cast ("T"; QVariant value)
    new Function(c, "qAlpha", _n_qAlpha0, None, Compiled, qt__qAlpha_int_int, Return, "int", Parameters, new Param(c, "rgba", "int"), End),
    new Function(c, "qBlue", _n_qBlue0, None, Compiled, qt__qBlue_int_int, Return, "int", Parameters, new Param(c, "rgb", "int"), End),
    new Function(c, "qGray", _n_qGray0, None, Compiled, qt__qGray_int_int_int_int, Return, "int", Parameters, new Param(c, "r", "int"), new Param(c, "g", "int"), new Param(c, "b", "int"), End),
    new Function(c, "qGray", _n_qGray1, None, Compiled, qt__qGray_int_int, Return, "int", Parameters, new Param(c, "rgb", "int"), End),
    new Function(c, "qGreen", _n_qGreen0, None, Compiled, qt__qGreen_int_int, Return, "int", Parameters, new Param(c, "rgb", "int"), End),
    new Function(c, "qRed", _n_qRed0, None, Compiled, qt__qRed_int_int, Return, "int", Parameters, new Param(c, "rgb", "int"), End),
    new Function(c, "qRgb", _n_qRgb0, None, Compiled, qt__qRgb_int_int_int_int, Return, "int", Parameters, new Param(c, "r", "int"), new Param(c, "g", "int"), new Param(c, "b", "int"), End),
    new Function(c, "qRgba", _n_qRgba0, None, Compiled, qt__qRgba_int_int_int_int_int, Return, "int", Parameters, new Param(c, "r", "int"), new Param(c, "g", "int"), new Param(c, "b", "int"), new Param(c, "a", "int"), End),
    // MISSING: qChecksum ("quint16"; "const char *" data, int len)
    new Function(c, "qCompress", _n_qCompress0, None, Compiled, qt__qCompress_QByteArray_QByteArray_int, Return, "qt.QByteArray", Parameters, new Param(c, "data", "qt.QByteArray"), new Param(c, "compressionLevel", "int"), End),
    // MISSING: qCompress (QByteArray; "const uchar *" data, int nbytes, int compressionLevel)
    new Function(c, "qUncompress", _n_qUncompress0, None, Compiled, qt__qUncompress_QByteArray_QByteArray, Return, "qt.QByteArray", Parameters, new Param(c, "data", "qt.QByteArray"), End),
    // MISSING: qUncompress (QByteArray; "const uchar *" data, int nbytes)
    // MISSING: qsnprintf (int; "char *" str, "size_t" n, "const char *" fmt, "..." _p45)
    // MISSING: qstrcmp (int; "const char *" str1, "const char *" str2)
    // MISSING: qstrcpy ("char *"; "char *" dst, "const char *" src)
    // MISSING: qstrdup ("char *"; "const char *" src)
    // MISSING: qstricmp (int; "const char *" str1, "const char *" str2)
    // MISSING: qstrlen (int; "const char *" str)
    // MISSING: qstrncmp (int; "const char *" str1, "const char *" str2, int len)
    // MISSING: qstrncpy ("char *"; "char *" dst, "const char *" src, int len)
    // MISSING: qstrnicmp (int; "const char *" str1, "const char *" str2, int len)
    // MISSING: qstrnlen (int; "const char *" str, int maxlen)
    // MISSING: qvsnprintf (int; "char *" str, "size_t" n, "const char *" fmt, "va_list" ap)
    new Function(c, "qFuzzyCompare", _n_qFuzzyCompare0, None, Compiled, qt__qFuzzyCompare_bool_QMatrix_QMatrix, Return, "bool", Parameters, new Param(c, "m1", "qt.QMatrix"), new Param(c, "m2", "qt.QMatrix"), End),
    new Function(c, "qFuzzyCompare", _n_qFuzzyCompare1, None, Compiled, qt__qFuzzyCompare_bool_QTransform_QTransform, Return, "bool", Parameters, new Param(c, "t1", "qt.QTransform"), new Param(c, "t2", "qt.QTransform"), End),
    EndArguments);
globalScope()->addSymbols(
    // MISSING: << ("QDataStream &"; "QDataStream &" s, QFont font)
    // MISSING: >> ("QDataStream &"; "QDataStream &" s, QFont font)
    new Function(c, "!=", _n_operatorBang_EQ_0, Op, Compiled, qt__operatorBang_EQ__bool_QSize_QSize, Return, "bool", Parameters, new Param(c, "s1", "qt.QSize"), new Param(c, "s2", "qt.QSize"), End),
    new Function(c, "*", _n_operatorStar_0, Op, Compiled, qt__operatorStar__QSize_QSize_double, Return, "qt.QSize", Parameters, new Param(c, "size", "qt.QSize"), new Param(c, "factor", "double"), End),
    new Function(c, "*", _n_operatorStar_1, Op, Compiled, qt__operatorStar__QSize_double_QSize, Return, "qt.QSize", Parameters, new Param(c, "factor", "double"), new Param(c, "size", "qt.QSize"), End),
    new Function(c, "+", _n_operatorPlus_0, Op, Compiled, qt__operatorPlus__QSize_QSize_QSize, Return, "qt.QSize", Parameters, new Param(c, "s1", "qt.QSize"), new Param(c, "s2", "qt.QSize"), End),
    new Function(c, "-", _n_operatorMinus_0, Op, Compiled, qt__operatorMinus__QSize_QSize_QSize, Return, "qt.QSize", Parameters, new Param(c, "s1", "qt.QSize"), new Param(c, "s2", "qt.QSize"), End),
    new Function(c, "/", _n_operatorSlash_0, Op, Compiled, qt__operatorSlash__QSize_QSize_double, Return, "qt.QSize", Parameters, new Param(c, "size", "qt.QSize"), new Param(c, "divisor", "double"), End),
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QSize size)
    new Function(c, "==", _n_operatorEQ_EQ_0, Op, Compiled, qt__operatorEQ_EQ__bool_QSize_QSize, Return, "bool", Parameters, new Param(c, "s1", "qt.QSize"), new Param(c, "s2", "qt.QSize"), End),
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QSize size)
    new Function(c, "!=", _n_operatorBang_EQ_1, Op, Compiled, qt__operatorBang_EQ__bool_QPoint_QPoint, Return, "bool", Parameters, new Param(c, "p1", "qt.QPoint"), new Param(c, "p2", "qt.QPoint"), End),
    new Function(c, "*", _n_operatorStar_2, Op, Compiled, qt__operatorStar__QPoint_QPoint_double, Return, "qt.QPoint", Parameters, new Param(c, "point", "qt.QPoint"), new Param(c, "factor", "double"), End),
    new Function(c, "*", _n_operatorStar_3, Op, Compiled, qt__operatorStar__QPoint_double_QPoint, Return, "qt.QPoint", Parameters, new Param(c, "factor", "double"), new Param(c, "point", "qt.QPoint"), End),
    new Function(c, "+", _n_operatorPlus_1, Op, Compiled, qt__operatorPlus__QPoint_QPoint_QPoint, Return, "qt.QPoint", Parameters, new Param(c, "p1", "qt.QPoint"), new Param(c, "p2", "qt.QPoint"), End),
    new Function(c, "-", _n_operatorMinus_1, Op, Compiled, qt__operatorMinus__QPoint_QPoint_QPoint, Return, "qt.QPoint", Parameters, new Param(c, "p1", "qt.QPoint"), new Param(c, "p2", "qt.QPoint"), End),
    new Function(c, "-", _n_operatorMinus_2, Op, Compiled, qt__operatorMinus__QPoint_QPoint, Return, "qt.QPoint", Parameters, new Param(c, "point", "qt.QPoint"), End),
    new Function(c, "/", _n_operatorSlash_1, Op, Compiled, qt__operatorSlash__QPoint_QPoint_double, Return, "qt.QPoint", Parameters, new Param(c, "point", "qt.QPoint"), new Param(c, "divisor", "double"), End),
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QPoint point)
    new Function(c, "==", _n_operatorEQ_EQ_1, Op, Compiled, qt__operatorEQ_EQ__bool_QPoint_QPoint, Return, "bool", Parameters, new Param(c, "p1", "qt.QPoint"), new Param(c, "p2", "qt.QPoint"), End),
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QPoint point)
    new Function(c, "!=", _n_operatorBang_EQ_2, Op, Compiled, qt__operatorBang_EQ__bool_QRect_QRect, Return, "bool", Parameters, new Param(c, "r1", "qt.QRect"), new Param(c, "r2", "qt.QRect"), End),
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QRect rectangle)
    new Function(c, "==", _n_operatorEQ_EQ_2, Op, Compiled, qt__operatorEQ_EQ__bool_QRect_QRect, Return, "bool", Parameters, new Param(c, "r1", "qt.QRect"), new Param(c, "r2", "qt.QRect"), End),
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QRect rectangle)
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QIcon icon)
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QIcon icon)
    new Function(c, "!=", _n_operatorBang_EQ_3, Op, Compiled, qt__operatorBang_EQ__bool_QVariant_QVariant, Return, "bool", Parameters, new Param(c, "v1", "qt.QVariant"), new Param(c, "v2", "qt.QVariant"), End),
    new Function(c, "==", _n_operatorEQ_EQ_3, Op, Compiled, qt__operatorEQ_EQ__bool_QVariant_QVariant, Return, "bool", Parameters, new Param(c, "v1", "qt.QVariant"), new Param(c, "v2", "qt.QVariant"), End),
    // MISSING: << ("QDataStream &"; "QDataStream &" out, QStandardItem item)
    // MISSING: >> ("QDataStream &"; "QDataStream &" in, QStandardItem item)
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QPixmap pixmap)
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QPixmap pixmap)
    // MISSING: << ("QDataStream &"; "QDataStream &" out, QDateTime dateTime)
    // MISSING: >> ("QDataStream &"; "QDataStream &" in, QDateTime dateTime)
    ...
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QKeySequence sequence)
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QKeySequence sequence)
    new Function(c, "==", _n_operatorEQ_EQ_4, Op, Compiled, qt__operatorEQ_EQ__bool_QKeyEvent_int, Return, "bool", Parameters, new Param(c, "e", "qt.QKeyEvent"), new Param(c, "key", "int"), End),
    new Function(c, "==", _n_operatorEQ_EQ_5, Op, Compiled, qt__operatorEQ_EQ__bool_int_QKeyEvent, Return, "bool", Parameters, new Param(c, "key", "int"), new Param(c, "e", "qt.QKeyEvent"), End),
    // MISSING: << ("QDataStream &"; "QDataStream &" out, QRegExp regExp)
    // MISSING: >> ("QDataStream &"; "QDataStream &" in, QRegExp regExp)
    // MISSING: << ("QDataStream &"; "QDataStream &" s, QRegion r)
    // MISSING: >> ("QDataStream &"; "QDataStream &" s, QRegion r)
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QColor color)
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QColor color)
    // MISSING: << ("QDataStream &"; "QDataStream &" out, QListWidgetItem item)
    // MISSING: >> ("QDataStream &"; "QDataStream &" in, QListWidgetItem item)
    // MISSING: << ("QDataStream &"; "QDataStream &" out, QTreeWidgetItem item)
    // MISSING: >> ("QDataStream &"; "QDataStream &" in, QTreeWidgetItem item)
    // MISSING: << ("QDataStream &"; "QDataStream &" out, QTableWidgetItem item)
    // MISSING: >> ("QDataStream &"; "QDataStream &" in, QTableWidgetItem item)
    // MISSING: << ("QDataStream &"; "QDataStream &" out, QUrl url)
    // MISSING: >> ("QDataStream &"; "QDataStream &" in, QUrl url)
    new Function(c, "!=", _n_operatorBang_EQ_4, Op, Compiled, qt__operatorBang_EQ__bool_QByteArray_QByteArray, Return, "bool", Parameters, new Param(c, "a1", "qt.QByteArray"), new Param(c, "a2", "qt.QByteArray"), End),
    ...
    new Function(c, "+", _n_operatorPlus_6, Op, Compiled, qt__operatorPlus__QByteArray_QByteArray_QByteArray, Return, "qt.QByteArray", Parameters, new Param(c, "a1", "qt.QByteArray"), new Param(c, "a2", "qt.QByteArray"), End),
    new Function(c, "<", _n_operatorLT_0, Op, Compiled, qt__operatorLT__bool_QByteArray_QByteArray, Return, "bool", Parameters, new Param(c, "a1", "qt.QByteArray"), new Param(c, "a2", "qt.QByteArray"), End),
    // MISSING: < (bool; QByteArray a1, "const char *" a2)
    // MISSING: < (bool; "const char *" a1, QByteArray a2)
    // MISSING: << ("QDataStream &"; "QDataStream &" out, QByteArray ba)
    new Function(c, "<=", _n_operatorLT_EQ_0, Op, Compiled, qt__operatorLT_EQ__bool_QByteArray_QByteArray, Return, "bool", Parameters, new Param(c, "a1", "qt.QByteArray"), new Param(c, "a2", "qt.QByteArray"), End),
    // MISSING: <= (bool; QByteArray a1, "const char *" a2)
    // MISSING: <= (bool; "const char *" a1, QByteArray a2)
    new Function(c, "==", _n_operatorEQ_EQ_6, Op, Compiled, qt__operatorEQ_EQ__bool_QByteArray_QByteArray, Return, "bool", Parameters, new Param(c, "a1", "qt.QByteArray"), new Param(c, "a2", "qt.QByteArray"), End),
    // MISSING: == (bool; QByteArray a1, "const char *" a2)
    // MISSING: == (bool; "const char *" a1, QByteArray a2)
    new Function(c, ">", _n_operatorGT_0, Op, Compiled, qt__operatorGT__bool_QByteArray_QByteArray, Return, "bool", Parameters, new Param(c, "a1", "qt.QByteArray"), new Param(c, "a2", "qt.QByteArray"), End),
    // MISSING: > (bool; QByteArray a1, "const char *" a2)
    // MISSING: > (bool; "const char *" a1, QByteArray a2)
    new Function(c, ">=", _n_operatorGT_EQ_0, Op, Compiled, qt__operatorGT_EQ__bool_QByteArray_QByteArray, Return, "bool", Parameters, new Param(c, "a1", "qt.QByteArray"), new Param(c, "a2", "qt.QByteArray"), End),
    // MISSING: >= (bool; QByteArray a1, "const char *" a2)
    // MISSING: >= (bool; "const char *" a1, QByteArray a2)
    // MISSING: >> ("QDataStream &"; "QDataStream &" in, QByteArray ba)
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QImage image)
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QImage image)
    // MISSING: << ("QDataStream &"; "QDataStream &" s, "const QPicture &" r)
    // MISSING: >> ("QDataStream &"; "QDataStream &" s, "QPicture &" r)
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QPixmap pixmap)
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QPixmap pixmap)
    // MISSING: << ("QDataStream &"; "QDataStream &" out, QHostAddress address)
    // MISSING: >> ("QDataStream &"; "QDataStream &" in, QHostAddress address)
    new Function(c, "!=", _n_operatorBang_EQ_7, Op, Compiled, qt__operatorBang_EQ__bool_QMargins_QMargins, Return, "bool", Parameters, new Param(c, "m1", "qt.QMargins"), new Param(c, "m2", "qt.QMargins"), End),
    new Function(c, "==", _n_operatorEQ_EQ_9, Op, Compiled, qt__operatorEQ_EQ__bool_QMargins_QMargins, Return, "bool", Parameters, new Param(c, "m1", "qt.QMargins"), new Param(c, "m2", "qt.QMargins"), End),
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QBrush brush)
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QBrush brush)
    new Function(c, "*", _n_operatorStar_4, Op, Compiled, qt__operatorStar__QPoint_QPoint_QMatrix, Return, "qt.QPoint", Parameters, new Param(c, "point", "qt.QPoint"), new Param(c, "matrix", "qt.QMatrix"), End),
    new Function(c, "*", _n_operatorStar_5, Op, Compiled, qt__operatorStar__QPointF_QPointF_QMatrix, Return, "qt.QPointF", Parameters, new Param(c, "point", "qt.QPointF"), new Param(c, "matrix", "qt.QMatrix"), End),
    // MISSING: * ("QLineF"; "const QLineF &" line, QMatrix matrix)
    // MISSING: * ("QLine"; "const QLine &" line, QMatrix matrix)
    // MISSING: * ("QPolygon"; "const QPolygon &" polygon, QMatrix matrix)
    // MISSING: * ("QPolygonF"; "const QPolygonF &" polygon, QMatrix matrix)
    new Function(c, "*", _n_operatorStar_10, Op, Compiled, qt__operatorStar__QRegion_QRegion_QMatrix, Return, "qt.QRegion", Parameters, new Param(c, "region", "qt.QRegion"), new Param(c, "matrix", "qt.QMatrix"), End),
    // MISSING: * (QPainterPath; "const QPainterPath &" path, QMatrix matrix)
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QMatrix matrix)
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QMatrix matrix)
    new Function(c, "*", _n_operatorStar_12, Op, Compiled, qt__operatorStar__QPoint_QPoint_QTransform, Return, "qt.QPoint", Parameters, new Param(c, "point", "qt.QPoint"), new Param(c, "matrix", "qt.QTransform"), End),
    new Function(c, "*", _n_operatorStar_13, Op, Compiled, qt__operatorStar__QPointF_QPointF_QTransform, Return, "qt.QPointF", Parameters, new Param(c, "point", "qt.QPointF"), new Param(c, "matrix", "qt.QTransform"), End),
    // MISSING: * ("QLineF"; "const QLineF &" line, QTransform matrix)
    // MISSING: * ("QLine"; "const QLine &" line, QTransform matrix)
    // MISSING: * ("QPolygon"; "const QPolygon &" polygon, QTransform matrix)
    // MISSING: * ("QPolygonF"; "const QPolygonF &" polygon, QTransform matrix)
    new Function(c, "*", _n_operatorStar_18, Op, Compiled, qt__operatorStar__QRegion_QRegion_QTransform, Return, "qt.QRegion", Parameters, new Param(c, "region", "qt.QRegion"), new Param(c, "matrix", "qt.QTransform"), End),
    // MISSING: * (QPainterPath; "const QPainterPath &" path, QTransform matrix)
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QTransform matrix)
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QTransform matrix)
    new Function(c, "!=", _n_operatorBang_EQ_8, Op, Compiled, qt__operatorBang_EQ__bool_QPointF_QPointF, Return, "bool", Parameters, new Param(c, "p1", "qt.QPointF"), new Param(c, "p2", "qt.QPointF"), End),
    new Function(c, "*", _n_operatorStar_20, Op, Compiled, qt__operatorStar__QPointF_QPointF_double, Return, "qt.QPointF", Parameters, new Param(c, "point", "qt.QPointF"), new Param(c, "factor", "double"), End),
    new Function(c, "*", _n_operatorStar_21, Op, Compiled, qt__operatorStar__QPointF_double_QPointF, Return, "qt.QPointF", Parameters, new Param(c, "factor", "double"), new Param(c, "point", "qt.QPointF"), End),
    new Function(c, "+", _n_operatorPlus_7, Op, Compiled, qt__operatorPlus__QPointF_QPointF_QPointF, Return, "qt.QPointF", Parameters, new Param(c, "p1", "qt.QPointF"), new Param(c, "p2", "qt.QPointF"), End),
    new Function(c, "-", _n_operatorMinus_3, Op, Compiled, qt__operatorMinus__QPointF_QPointF_QPointF, Return, "qt.QPointF", Parameters, new Param(c, "p1", "qt.QPointF"), new Param(c, "p2", "qt.QPointF"), End),
    new Function(c, "-", _n_operatorMinus_4, Op, Compiled, qt__operatorMinus__QPointF_QPointF, Return, "qt.QPointF", Parameters, new Param(c, "point", "qt.QPointF"), End),
    new Function(c, "/", _n_operatorSlash_2, Op, Compiled, qt__operatorSlash__QPointF_QPointF_double, Return, "qt.QPointF", Parameters, new Param(c, "point", "qt.QPointF"), new Param(c, "divisor", "double"), End),
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QPointF point)
    new Function(c, "==", _n_operatorEQ_EQ_10, Op, Compiled, qt__operatorEQ_EQ__bool_QPointF_QPointF, Return, "bool", Parameters, new Param(c, "p1", "qt.QPointF"), new Param(c, "p2", "qt.QPointF"), End),
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QPointF point)
    // MISSING: << ("QDataStream &"; "QDataStream &" s, QPalette p)
    // MISSING: >> ("QDataStream &"; "QDataStream &" s, QPalette p)
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, "const QPainterPath &" path)
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, "QPainterPath &" path)
    new Function(c, "!=", _n_operatorBang_EQ_9, Op, Compiled, qt__operatorBang_EQ__bool_QRectF_QRectF, Return, "bool", Parameters, new Param(c, "r1", "qt.QRectF"), new Param(c, "r2", "qt.QRectF"), End),
    // MISSING: << ("QDataStream &"; "QDataStream &" stream, QRectF rectangle)
    new Function(c, "==", _n_operatorEQ_EQ_11, Op, Compiled, qt__operatorEQ_EQ__bool_QRectF_QRectF, Return, "bool", Parameters, new Param(c, "r1", "qt.QRectF"), new Param(c, "r2", "qt.QRectF"), End),
    // MISSING: >> ("QDataStream &"; "QDataStream &" stream, QRectF rectangle)
    EndArguments);
scope()->addSymbols(
    EndArguments);
