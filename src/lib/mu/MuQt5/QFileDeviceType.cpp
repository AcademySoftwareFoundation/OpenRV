...
namespace Mu
{
    ...
    void QFileDeviceType::load()
    {
        ...
        addSymbols(
            ...
            new Alias(c, "MemoryMapFlags", "int"), new SymbolicConstant(c, "NoOptions", "int", Value(int(QFileDevice::NoOptions))),
            new SymbolicConstant(c, "MapPrivateOption", "int", Value(int(QFileDevice::MapPrivateOption))),
            new Alias(c, "Permission", "int"), new Alias(c, "Permissions", "int"),
