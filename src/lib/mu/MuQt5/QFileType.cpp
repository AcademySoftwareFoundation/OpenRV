...
namespace Mu
{
    ...
    static NODE_IMPLEMENTATION(_n_open0, void) { qt_QFile_open_bool_QFile_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)); }
    ...
    void QFileType::load()
    {
        ...
        addSymbols(
            // enums
            // member functions
            new Function(c, "QFile", _n_QFile0, None, Compiled, qt_QFile_QFile_QFile_QFile_string, Return, "qt.QFile", Parameters,
                         new Param(c, "this", "qt.QFile"), new Param(c, "name", "string"), End),
            new Function(c, "QFile", _n_QFile1, None, Compiled, qt_QFile_QFile_QFile_QFile_QObject, Return, "qt.QFile", Parameters,
                         new Param(c, "this", "qt.QFile"), new Param(c, "parent", "qt.QObject"), End),
            new Function(c, "QFile", _n_QFile2, None, Compiled, qt_QFile_QFile_QFile_QFile_string_QObject, Return, "qt.QFile", Parameters,
            ...
            _func[1] = new MemberFunction(c, "resize", _n_resize0, None, Compiled, qt_QFile_resize_bool_QFile_int64, Return, "bool",
                                          Parameters, new Param(c, "this", "qt.QFile"), new Param(c, "sz", "int64"), End),
            // MISSING: setPermissions (bool; QFile this, "Permissions"
            // permissions)
            _func[2] = new MemberFunction(c, "size", _n_size0, None, Compiled, qt_QFile_size_int64_QFile, Return, "int64", Parameters,
                                          new Param(c, "this", "qt.QFile"), End),
            _func[3] = new MemberFunction(c, "atEnd", _n_atEnd0, None, Compiled, qt_QFile_atEnd_bool_QFile, Return, "bool", Parameters,
                                          new Param(c, "this", "qt.QFile"), End),
            _func[4] = new MemberFunction(c, "close", _n_close0, None, Compiled, qt_QFile_close_void_QFile, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QFile"), End),
            _func[5] = new MemberFunction(c, "isSequential", _n_isSequential0, None, Compiled, qt_QFile_isSequential_bool_QFile, Return,
                                          "bool", Parameters, new Param(c, "this", "qt.QFile"), End),
            _func[6] = new MemberFunction(c, "pos", _n_pos0, None, Compiled, qt_QFile_pos_int64_QFile, Return, "int64", Parameters,
                                          new Param(c, "this", "qt.QFile"), End),
            _func[7] = new MemberFunction(c, "seek", _n_seek0, None, Compiled, qt_QFile_seek_bool_QFile_int64, Return, "bool", Parameters,
                                          new Param(c, "this", "qt.QFile"), new Param(c, "pos", "int64"), End),
            _func[8] = new MemberFunction(c, "open", _n_open0, None, Compiled, qt_QFile_open_bool_QFile_int, Return, "bool", Parameters,
