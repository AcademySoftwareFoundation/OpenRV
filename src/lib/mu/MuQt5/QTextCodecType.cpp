...
namespace Mu
{
    ...
    Pointer qt_QTextCodec_codecForHtml_QTextCodec_QByteArray_QTextCodec(Mu::Thread& NODE_THREAD, Pointer param_ba,
                                                                        Pointer param_defaultCodec)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    Pointer qt_QTextCodec_codecForUtfText_QTextCodec_QByteArray_QTextCodec(Mu::Thread& NODE_THREAD, Pointer param_ba,
                                                                           Pointer param_defaultCodec)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QByteArray arg0 = getqtype<QByteArrayType>(param_ba);
    ...
    static NODE_IMPLEMENTATION(_n_codecForLocale0, Pointer) { NODE_RETURN(qt_QTextCodec_codecForLocale_QTextCodec(NODE_THREAD)); }
    ...
    {
        NODE_RETURN(
            qt_QTextCodec_codecForUtfText_QTextCodec_QByteArray_QTextCodec(NODE_THREAD, NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
    }
    ...
    void QTextCodecType::load()
    {
        ...
        addSymbols(new Alias(c, "ConversionFlag", "int"), new Alias(c, "ConversionFlags", "int"),
                   ...
                   new SymbolicConstant(c, "IgnoreHeader", "int", Value(int(QTextCodec::IgnoreHeader))), EndArguments);
        ...
        addSymbols(
            ...
            new Function(c, "canEncode", _n_canEncode1, None, Compiled, qt_QTextCodec_canEncode_bool_QTextCodec_string, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QTextCodec"), new Param(c, "s", "string"), End),
            new Function(c, "fromUnicode", _n_fromUnicode0, None, Compiled, qt_QTextCodec_fromUnicode_QByteArray_QTextCodec_string, Return,
                         "qt.QByteArray", Parameters, new Param(c, "this", "qt.QTextCodec"), new Param(c, "str", "string"), End),
            ...
            new MemberFunction(c, "mibEnum", _n_mibEnum0, None, Compiled, qt_QTextCodec_mibEnum_int_QTextCodec, Return, "int", Parameters,
                               new Param(c, "this", "qt.QTextCodec"), End),
            new MemberFunction(c, "name", _n_name0, None, Compiled, qt_QTextCodec_name_QByteArray_QTextCodec, Return, "qt.QByteArray",
                               Parameters, new Param(c, "this", "qt.QTextCodec"), End),
            new Function(c, "toUnicode", _n_toUnicode0, None, Compiled, qt_QTextCodec_toUnicode_string_QTextCodec_QByteArray, Return,
                         "string", Parameters, new Param(c, "this", "qt.QTextCodec"), new Param(c, "a", "qt.QByteArray"), End),
            ...
            new Function(c, "codecForHtml", _n_codecForHtml0, None, Compiled, qt_QTextCodec_codecForHtml_QTextCodec_QByteArray_QTextCodec,
                         Return, "qt.QTextCodec", Parameters, new Param(c, "ba", "qt.QByteArray"),
                         new Param(c, "defaultCodec", "qt.QTextCodec"), End),
            new Function(c, "codecForHtml", _n_codecForHtml1, None, Compiled, qt_QTextCodec_codecForHtml_QTextCodec_QByteArray, Return,
                         "qt.QTextCodec", Parameters, new Param(c, "ba", "qt.QByteArray"), End),
            new Function(c, "codecForLocale", _n_codecForLocale0, None, Compiled, qt_QTextCodec_codecForLocale_QTextCodec, Return,
                         "qt.QTextCodec", End),
            new Function(c, "codecForMib", _n_codecForMib0, None, Compiled, qt_QTextCodec_codecForMib_QTextCodec_int, Return,
                         "qt.QTextCodec", Parameters, new Param(c, "mib", "int"), End),
            new Function(c, "codecForName", _n_codecForName0, None, Compiled, qt_QTextCodec_codecForName_QTextCodec_QByteArray, Return,
                         "qt.QTextCodec", Parameters, new Param(c, "name", "qt.QByteArray"), End),
            // MISSING: codecForName (QTextCodec; "const char *" name)
            new Function(c, "codecForUtfText", _n_codecForUtfText0, None, Compiled,
                         qt_QTextCodec_codecForUtfText_QTextCodec_QByteArray_QTextCodec, Return, "qt.QTextCodec", Parameters,
                         new Param(c, "ba", "qt.QByteArray"), new Param(c, "defaultCodec", "qt.QTextCodec"), End),
            new Function(c, "codecForUtfText", _n_codecForUtfText1, None, Compiled, qt_QTextCodec_codecForUtfText_QTextCodec_QByteArray,
                         Return, "qt.QTextCodec", Parameters, new Param(c, "ba", "qt.QByteArray"), End),
            new Function(c, "setCodecForLocale", _n_setCodecForLocale0, None, Compiled, qt_QTextCodec_setCodecForLocale_void_QTextCodec,
                         Return, "void", Parameters, new Param(c, "c", "qt.QTextCodec"), End),
            EndArguments);
