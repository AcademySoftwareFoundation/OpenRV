...
MuQt_QDockWidget::MuQt_QDockWidget(Pointer muobj, const CallEnvironment* ce, const QString & title, QWidget * parent, Qt::WindowFlags flags) 
...
{
    if (!_env) { QDockWidget::changeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::closeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QDockWidget::event(event_);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::paintEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QDockWidget::hasHeightForWidth();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QDockWidget::heightForWidth(w);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QDockWidget::inputMethodQuery(query);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QDockWidget::minimumSizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QDockWidget::sizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::contextMenuEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::dragEnterEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::dragLeaveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::dragMoveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::dropEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::enterEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::focusInEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QDockWidget::focusNextPrevChild(next);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::focusOutEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::hideEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::keyPressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::keyReleaseEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::leaveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::mouseDoubleClickEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::mouseMoveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::mousePressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::mouseReleaseEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::moveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::resizeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::showEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::tabletEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDockWidget::wheelEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QDockWidget::metric(m);
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QDockWidget_QDockWidget_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    else if (QDockWidget* w = object<QDockWidget>(widget))
    {
        QDockWidgetType* type = 
            c->findSymbolOfTypeByQualifiedName<QDockWidgetType>(c->internName("qt.QDockWidget"), false);
...
{
    NODE_RETURN( QDockWidget_QDockWidget_QObject(NODE_THREAD, NODE_ARG(0, Pointer)) );
}

Pointer qt_QDockWidget_QDockWidget_QDockWidget_QDockWidget_string_QWidget_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_title, Pointer param_parent, int param_flags)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QDockWidget_QDockWidget_QDockWidget_QDockWidget_QWidget_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_parent, int param_flags)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
void qt_QDockWidget_changeEvent_void_QDockWidget_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->changeEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->changeEvent_pub(arg1);
}
...
void qt_QDockWidget_closeEvent_void_QDockWidget_QCloseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->closeEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->closeEvent_pub(arg1);
}
...
void qt_QDockWidget_paintEvent_void_QDockWidget_QPaintEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->paintEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->paintEvent_pub(arg1);
}
...
Pointer qt_QDockWidget_inputMethodQuery_QVariant_QDockWidget_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_query)
{
    ...
    return isMuQtObject(arg0) ? makeqtype<QVariantType>(c,arg0->QDockWidget::inputMethodQuery(arg1),"qt.QVariant") : makeqtype<QVariantType>(c,arg0->inputMethodQuery(arg1),"qt.QVariant");
}
...
Pointer qt_QDockWidget_minimumSizeHint_QSize_QDockWidget(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QDockWidget* arg0 = object<QDockWidget>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QDockWidget::minimumSizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->minimumSizeHint(),"qt.QSize");
}
...
Pointer qt_QDockWidget_sizeHint_QSize_QDockWidget(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QDockWidget* arg0 = object<QDockWidget>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QDockWidget::sizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->sizeHint(),"qt.QSize");
}

void qt_QDockWidget_contextMenuEvent_void_QDockWidget_QContextMenuEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QDockWidget* arg0 = object<QDockWidget>(param_this);
    QContextMenuEvent * arg1 = getqpointer<QContextMenuEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->contextMenuEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->contextMenuEvent_pub(arg1);
}
...
void qt_QDockWidget_dragEnterEvent_void_QDockWidget_QDragEnterEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->dragEnterEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->dragEnterEvent_pub(arg1);
}
...
void qt_QDockWidget_dragLeaveEvent_void_QDockWidget_QDragLeaveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->dragLeaveEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->dragLeaveEvent_pub(arg1);
}
...
void qt_QDockWidget_dragMoveEvent_void_QDockWidget_QDragMoveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->dragMoveEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->dragMoveEvent_pub(arg1);
}
...
void qt_QDockWidget_dropEvent_void_QDockWidget_QDropEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->dropEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->dropEvent_pub(arg1);
}
...
void qt_QDockWidget_enterEvent_void_QDockWidget_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QDockWidget* arg0 = object<QDockWidget>(param_this);
    QEvent * arg1 = getqpointer<QEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->enterEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->enterEvent_pub(arg1);
}
...
void qt_QDockWidget_focusInEvent_void_QDockWidget_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->focusInEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->focusInEvent_pub(arg1);
}
...
bool qt_QDockWidget_focusNextPrevChild_bool_QDockWidget_bool(Mu::Thread& NODE_THREAD, Pointer param_this, bool param_next)
{
    ...
    return isMuQtObject(arg0) ? ((MuQt_QDockWidget*)arg0)->focusNextPrevChild_pub_parent(arg1) : ((MuQt_QDockWidget*)arg0)->focusNextPrevChild_pub(arg1);
}
...
void qt_QDockWidget_focusOutEvent_void_QDockWidget_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QDockWidget* arg0 = object<QDockWidget>(param_this);
    QFocusEvent * arg1 = getqpointer<QFocusEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->focusOutEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->focusOutEvent_pub(arg1);
}
...
void qt_QDockWidget_hideEvent_void_QDockWidget_QHideEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->hideEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->hideEvent_pub(arg1);
}
...
void qt_QDockWidget_keyPressEvent_void_QDockWidget_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    else ((MuQt_QDockWidget*)arg0)->keyPressEvent_pub(arg1);
}
...
void qt_QDockWidget_keyReleaseEvent_void_QDockWidget_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QDockWidget* arg0 = object<QDockWidget>(param_this);
    QKeyEvent * arg1 = getqpointer<QKeyEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->keyReleaseEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->keyReleaseEvent_pub(arg1);
}
...
void qt_QDockWidget_leaveEvent_void_QDockWidget_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QDockWidget* arg0 = object<QDockWidget>(param_this);
    QEvent * arg1 = getqpointer<QEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->leaveEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->leaveEvent_pub(arg1);
}
...
void qt_QDockWidget_mouseDoubleClickEvent_void_QDockWidget_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->mouseDoubleClickEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->mouseDoubleClickEvent_pub(arg1);
}
...
void qt_QDockWidget_mouseMoveEvent_void_QDockWidget_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QDockWidget* arg0 = object<QDockWidget>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->mouseMoveEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->mouseMoveEvent_pub(arg1);
}
...
void qt_QDockWidget_mousePressEvent_void_QDockWidget_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QDockWidget* arg0 = object<QDockWidget>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->mousePressEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->mousePressEvent_pub(arg1);
}
...
void qt_QDockWidget_mouseReleaseEvent_void_QDockWidget_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QDockWidget* arg0 = object<QDockWidget>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->mouseReleaseEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->mouseReleaseEvent_pub(arg1);
}
...
void qt_QDockWidget_moveEvent_void_QDockWidget_QMoveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->moveEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->moveEvent_pub(arg1);
}
...
void qt_QDockWidget_resizeEvent_void_QDockWidget_QResizeEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->resizeEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->resizeEvent_pub(arg1);
}
...
void qt_QDockWidget_showEvent_void_QDockWidget_QShowEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->showEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->showEvent_pub(arg1);
}
...
void qt_QDockWidget_tabletEvent_void_QDockWidget_QTabletEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->tabletEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->tabletEvent_pub(arg1);
}
...
void qt_QDockWidget_wheelEvent_void_QDockWidget_QWheelEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDockWidget*)arg0)->wheelEvent_pub_parent(arg1);
    else ((MuQt_QDockWidget*)arg0)->wheelEvent_pub(arg1);
}
...
{
    NODE_RETURN(qt_QDockWidget_QDockWidget_QDockWidget_QDockWidget_string_QWidget_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer), NODE_ARG(3, int)));
}

static NODE_IMPLEMENTATION(_n_QDockWidget1, Pointer)
{
    NODE_RETURN(qt_QDockWidget_QDockWidget_QDockWidget_QDockWidget_QWidget_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int)));
}
...
QDockWidgetType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QDockWidget_QDockWidget_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    ...
    // PROP: setAllowedAreas (void; QDockWidget this, flags Qt::DockWidgetAreas areas)
    // PROP: setFeatures (void; QDockWidget this, flags QDockWidget::DockWidgetFeatures features)
    // PROP: setFloating (void; QDockWidget this, bool floating)
    new Function(c, "setTitleBarWidget", _n_setTitleBarWidget0, None, Compiled, qt_QDockWidget_setTitleBarWidget_void_QDockWidget_QWidget, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "widget", "qt.QWidget"), End),
    new Function(c, "setWidget", _n_setWidget0, None, Compiled, qt_QDockWidget_setWidget_void_QDockWidget_QWidget, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "widget", "qt.QWidget"), End),
    new Function(c, "titleBarWidget", _n_titleBarWidget0, None, Compiled, qt_QDockWidget_titleBarWidget_QWidget_QDockWidget, Return, "qt.QWidget", Parameters, new Param(c, "this", "qt.QDockWidget"), End),
    new Function(c, "toggleViewAction", _n_toggleViewAction0, None, Compiled, qt_QDockWidget_toggleViewAction_QAction_QDockWidget, Return, "qt.QAction", Parameters, new Param(c, "this", "qt.QDockWidget"), End),
    new Function(c, "widget", _n_widget0, None, Compiled, qt_QDockWidget_widget_QWidget_QDockWidget, Return, "qt.QWidget", Parameters, new Param(c, "this", "qt.QDockWidget"), End),
    // MISSING: initStyleOption (void; QDockWidget this, "QStyleOptionDockWidget *" option) // protected
    _func[0] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled, qt_QDockWidget_changeEvent_void_QDockWidget_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QEvent"), End),
    _func[1] = new MemberFunction(c, "closeEvent", _n_closeEvent0, None, Compiled, qt_QDockWidget_closeEvent_void_QDockWidget_QCloseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QCloseEvent"), End),
    _func[2] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QDockWidget_event_bool_QDockWidget_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event_", "qt.QEvent"), End),
    _func[3] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QDockWidget_paintEvent_void_QDockWidget_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QPaintEvent"), End),
    _func[4] = new MemberFunction(c, "hasHeightForWidth", _n_hasHeightForWidth0, None, Compiled, qt_QDockWidget_hasHeightForWidth_bool_QDockWidget, Return, "bool", Parameters, new Param(c, "this", "qt.QDockWidget"), End),
    _func[5] = new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QDockWidget_heightForWidth_int_QDockWidget_int, Return, "int", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "w", "int"), End),
    _func[6] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QDockWidget_inputMethodQuery_QVariant_QDockWidget_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "query", "int"), End),
    _func[7] = new MemberFunction(c, "minimumSizeHint", _n_minimumSizeHint0, None, Compiled, qt_QDockWidget_minimumSizeHint_QSize_QDockWidget, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QDockWidget"), End),
    _func[8] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QDockWidget_sizeHint_QSize_QDockWidget, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QDockWidget"), End),
    // MISSING: paintEngine ("QPaintEngine *"; QDockWidget this)
    // MISSING: actionEvent (void; QDockWidget this, "QActionEvent *" event) // protected
    _func[9] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled, qt_QDockWidget_contextMenuEvent_void_QDockWidget_QContextMenuEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QContextMenuEvent"), End),
    _func[10] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QDockWidget_dragEnterEvent_void_QDockWidget_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QDragEnterEvent"), End),
    _func[11] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QDockWidget_dragLeaveEvent_void_QDockWidget_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QDragLeaveEvent"), End),
    _func[12] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QDockWidget_dragMoveEvent_void_QDockWidget_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QDragMoveEvent"), End),
    _func[13] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QDockWidget_dropEvent_void_QDockWidget_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QDropEvent"), End),
    _func[14] = new MemberFunction(c, "enterEvent", _n_enterEvent0, None, Compiled, qt_QDockWidget_enterEvent_void_QDockWidget_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QEvent"), End),
    _func[15] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QDockWidget_focusInEvent_void_QDockWidget_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[16] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QDockWidget_focusNextPrevChild_bool_QDockWidget_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "next", "bool"), End),
    _func[17] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QDockWidget_focusOutEvent_void_QDockWidget_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[18] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QDockWidget_hideEvent_void_QDockWidget_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QHideEvent"), End),
    // MISSING: inputMethodEvent (void; QDockWidget this, "QInputMethodEvent *" event) // protected
    _func[19] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QDockWidget_keyPressEvent_void_QDockWidget_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[20] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QDockWidget_keyReleaseEvent_void_QDockWidget_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[21] = new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QDockWidget_leaveEvent_void_QDockWidget_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QEvent"), End),
    _func[22] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QDockWidget_mouseDoubleClickEvent_void_QDockWidget_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[23] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QDockWidget_mouseMoveEvent_void_QDockWidget_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[24] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QDockWidget_mousePressEvent_void_QDockWidget_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[25] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QDockWidget_mouseReleaseEvent_void_QDockWidget_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[26] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QDockWidget_moveEvent_void_QDockWidget_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QDockWidget this, QByteArray eventType, "void *" message, "long *" result) // protected
    _func[27] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QDockWidget_resizeEvent_void_QDockWidget_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QResizeEvent"), End),
    _func[28] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QDockWidget_showEvent_void_QDockWidget_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QShowEvent"), End),
    _func[29] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QDockWidget_tabletEvent_void_QDockWidget_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QTabletEvent"), End),
    _func[30] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QDockWidget_wheelEvent_void_QDockWidget_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "event", "qt.QWheelEvent"), End),
    // MISSING: initPainter (void; QDockWidget this, "QPainter *" painter) // protected
    _func[31] = new MemberFunction(c, "metric", _n_metric0, None, Compiled, qt_QDockWidget_metric_int_QDockWidget_int, Return, "int", Parameters, new Param(c, "this", "qt.QDockWidget"), new Param(c, "m", "int"), End),
    // static functions
    EndArguments);
