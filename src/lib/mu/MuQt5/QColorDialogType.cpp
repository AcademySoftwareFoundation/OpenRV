...
namespace Mu
{
    ...
    static Pointer QColorDialog_QColorDialog_QObject(Thread& NODE_THREAD, Pointer obj)
    {
        ...
        {
            QColorDialogType* type = c->findSymbolOfTypeByQualifiedName<QColorDialogType>(c->internName("qt.QColorDialog"), false);
    ...
    Pointer qt_QColorDialog_QColorDialog_QColorDialog_QColorDialog_QWidget(Mu::Thread& NODE_THREAD, Pointer param_this,
    ...
    Pointer qt_QColorDialog_QColorDialog_QColorDialog_QColorDialog_QColor_QWidget(Mu::Thread& NODE_THREAD, Pointer param_this,
                                                                                  Pointer param_initial, Pointer param_parent)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    Pointer qt_QColorDialog_minimumSizeHint_QSize_QColorDialog(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QColorDialog* arg0 = object<QColorDialog>(param_this);
        return isMuQtObject(arg0) ? makeqtype<QSizeType>(c, arg0->QColorDialog::minimumSizeHint(), "qt.QSize")
    ...
    Pointer qt_QColorDialog_sizeHint_QSize_QColorDialog(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QColorDialog* arg0 = object<QColorDialog>(param_this);
        return isMuQtObject(arg0) ? makeqtype<QSizeType>(c, arg0->QColorDialog::sizeHint(), "qt.QSize")
    ...
    bool qt_QColorDialog_eventFilter_bool_QColorDialog_QObject_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_o,
                                                                      Pointer param_e)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QColorDialog* arg0 = object<QColorDialog>(param_this);
        ...
        return isMuQtObject(arg0) ? ((MuQt_QColorDialog*)arg0)->eventFilter_pub_parent(arg1, arg2)
    ...
    Pointer qt_QColorDialog_getColor_QColor_QColor_QWidget_string_int(Mu::Thread& NODE_THREAD, Pointer param_initial, Pointer param_parent,
    ...
    {
        NODE_RETURN(
            qt_QColorDialog_QColorDialog_QColorDialog_QColorDialog_QWidget(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
    }

    static NODE_IMPLEMENTATION(_n_QColorDialog1, Pointer)
    {
        NODE_RETURN(qt_QColorDialog_QColorDialog_QColorDialog_QColorDialog_QColor_QWidget(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
    ...
    {
        qt_QColorDialog_contextMenuEvent_void_QColorDialog_QContextMenuEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
                                                                             NODE_ARG(1, Pointer));
    }
    ...
    {
        NODE_RETURN(qt_QColorDialog_eventFilter_bool_QColorDialog_QObject_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
                                                                                 NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_customCount0, int) { NODE_RETURN(qt_QColorDialog_customCount_int(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_getColor0, Pointer)
    {
        NODE_RETURN(qt_QColorDialog_getColor_QColor_QColor_QWidget_string_int(NODE_THREAD, NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
    ...
    void QColorDialogType::load()
    {
        ...
        addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None, Return, ftn, End),
                   ...
                   new Function(c, tn, castFromObject, Cast, Compiled, QColorDialog_QColorDialog_QObject, Return, ftn, Parameters,
        ...
        addSymbols(
            // enums
            // member functions
            new Function(c, "QColorDialog", _n_QColorDialog0, None, Compiled,
                         qt_QColorDialog_QColorDialog_QColorDialog_QColorDialog_QWidget, Return, "qt.QColorDialog", Parameters,
                         new Param(c, "this", "qt.QColorDialog"), new Param(c, "parent", "qt.QWidget"), End),
            new Function(c, "QColorDialog", _n_QColorDialog1, None, Compiled,
                         qt_QColorDialog_QColorDialog_QColorDialog_QColorDialog_QColor_QWidget, Return, "qt.QColorDialog", Parameters,
                         new Param(c, "this", "qt.QColorDialog"), new Param(c, "initial", "qt.QColor"),
            ...
            new Function(c, "selectedColor", _n_selectedColor0, None, Compiled, qt_QColorDialog_selectedColor_QColor_QColorDialog, Return,
                         "qt.QColor", Parameters, new Param(c, "this", "qt.QColorDialog"), End),
            // PROP: setCurrentColor (void; QColorDialog this, QColor color)
            new Function(c, "setOption", _n_setOption0, None, Compiled, qt_QColorDialog_setOption_void_QColorDialog_int_bool, Return,
                         "void", Parameters, new Param(c, "this", "qt.QColorDialog"), new Param(c, "option", "int"),
                         new Param(c, "on", "bool"), End),
            // PROP: setOptions (void; QColorDialog this, flags
            // QColorDialog::ColorDialogOptions options)
            new Function(c, "testOption", _n_testOption0, None, Compiled, qt_QColorDialog_testOption_bool_QColorDialog_int, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QColorDialog"), new Param(c, "option", "int"), End),
            _func[0] = new MemberFunction(c, "setVisible", _n_setVisible0, None, Compiled,
                                          qt_QColorDialog_setVisible_void_QColorDialog_bool, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QColorDialog"), new Param(c, "visible", "bool"), End),
            _func[1] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled,
                                          qt_QColorDialog_changeEvent_void_QColorDialog_QEvent, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QColorDialog"), new Param(c, "e", "qt.QEvent"), End),
            _func[2] = new MemberFunction(c, "done", _n_done0, None, Compiled, qt_QColorDialog_done_void_QColorDialog_int, Return, "void",
                                          Parameters, new Param(c, "this", "qt.QColorDialog"), new Param(c, "result", "int"), End),
            _func[3] = new MemberFunction(c, "minimumSizeHint", _n_minimumSizeHint0, None, Compiled,
                                          qt_QColorDialog_minimumSizeHint_QSize_QColorDialog, Return, "qt.QSize", Parameters,
                                          new Param(c, "this", "qt.QColorDialog"), End),
            _func[4] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QColorDialog_sizeHint_QSize_QColorDialog, Return,
                                          "qt.QSize", Parameters, new Param(c, "this", "qt.QColorDialog"), End),
            _func[5] = new MemberFunction(c, "closeEvent", _n_closeEvent0, None, Compiled,
                                          qt_QColorDialog_closeEvent_void_QColorDialog_QCloseEvent, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QColorDialog"), new Param(c, "e", "qt.QCloseEvent"), End),
            _func[6] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled,
                                          qt_QColorDialog_contextMenuEvent_void_QColorDialog_QContextMenuEvent, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QColorDialog"), new Param(c, "e", "qt.QContextMenuEvent"), End),
            _func[7] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QColorDialog_event_bool_QColorDialog_QEvent, Return,
                                          "bool", Parameters, new Param(c, "this", "qt.QColorDialog"), new Param(c, "e", "qt.QEvent"), End),
            _func[8] = new MemberFunction(c, "eventFilter", _n_eventFilter0, None, Compiled,
                                          qt_QColorDialog_eventFilter_bool_QColorDialog_QObject_QEvent, Return, "bool", Parameters,
                                          new Param(c, "this", "qt.QColorDialog"), new Param(c, "o", "qt.QObject"),
                                          new Param(c, "e", "qt.QEvent"), End),
            _func[9] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled,
                                          qt_QColorDialog_keyPressEvent_void_QColorDialog_QKeyEvent, Return, "void", Parameters,
                                          new Param(c, "this", "qt.QColorDialog"), new Param(c, "e", "qt.QKeyEvent"), End),
            _func[10] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled,
                                           qt_QColorDialog_resizeEvent_void_QColorDialog_QResizeEvent, Return, "void", Parameters,
                                           new Param(c, "this", "qt.QColorDialog"), new Param(c, "_p15", "qt.QResizeEvent"), End),
            _func[11] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled,
                                           qt_QColorDialog_showEvent_void_QColorDialog_QShowEvent, Return, "void", Parameters,
                                           new Param(c, "this", "qt.QColorDialog"), new Param(c, "event", "qt.QShowEvent"), End),
            // static functions
            new Function(c, "customColor", _n_customColor0, None, Compiled, qt_QColorDialog_customColor_QColor_int, Return, "qt.QColor",
                         Parameters, new Param(c, "index", "int"), End),
            new Function(c, "customCount", _n_customCount0, None, Compiled, qt_QColorDialog_customCount_int, Return, "int", End),
            new Function(c, "getColor", _n_getColor0, None, Compiled, qt_QColorDialog_getColor_QColor_QColor_QWidget_string_int, Return,
                         "qt.QColor", Parameters, new Param(c, "initial", "qt.QColor"), new Param(c, "parent", "qt.QWidget"),
                         new Param(c, "title", "string"), new Param(c, "options", "int", Value((int)QColorDialog::ColorDialogOptions())),
                         End),
            new Function(c, "setCustomColor", _n_setCustomColor0, None, Compiled, qt_QColorDialog_setCustomColor_void_int_QColor, Return,
                         "void", Parameters, new Param(c, "index", "int"), new Param(c, "color", "qt.QColor"), End),
            new Function(c, "setStandardColor", _n_setStandardColor0, None, Compiled, qt_QColorDialog_setStandardColor_void_int_QColor,
                         Return, "void", Parameters, new Param(c, "index", "int"), new Param(c, "color", "qt.QColor"), End),
            new Function(c, "standardColor", _n_standardColor0, None, Compiled, qt_QColorDialog_standardColor_QColor_int, Return,
                         "qt.QColor", Parameters, new Param(c, "index", "int"), End),
            EndArguments);
