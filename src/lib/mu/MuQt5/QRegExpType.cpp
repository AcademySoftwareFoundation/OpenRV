...
QRegExpType::Instance::Instance(const Class* c) : ClassInstance(c)
{
}
...
void 
QRegExpType::registerFinalizer (void* o)
{
    GC_register_finalizer(o, QRegExpType::finalizer, 0, 0, 0);
}

void 
QRegExpType::finalizer (void* obj, void* data)
{
...
Pointer qt_QRegExp_QRegExp_QRegExp_QRegExp_string_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_pattern, int param_cs, int param_syntax)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
int qt_QRegExp_indexIn_int_QRegExp_string_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_str, int param_offset, int param_caretMode)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QRegExp& arg0 = getqtype<QRegExpType>(param_this);
    const QString  arg1 = qstring(param_str);
...
int qt_QRegExp_lastIndexIn_int_QRegExp_string_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_str, int param_offset, int param_caretMode)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QRegExp& arg0 = getqtype<QRegExpType>(param_this);
    const QString  arg1 = qstring(param_str);
...
{
    NODE_RETURN(qt_QRegExp_QRegExp_QRegExp_QRegExp_string_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, int)));
}
...
{
    NODE_RETURN(qt_QRegExp_indexIn_int_QRegExp_string_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, int)));
}
...
{
    NODE_RETURN(qt_QRegExp_lastIndexIn_int_QRegExp_string_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, int)));
}
...
{
    NODE_RETURN(qt_QRegExp_escape_string_string(NODE_THREAD, NODE_ARG(0, Pointer)));
}
...
addSymbols(
    new Alias(c, "CaretMode", "int"),
      new SymbolicConstant(c, "CaretAtZero", "int", Value(int(QRegExp::CaretAtZero))),
    ...
    new Alias(c, "PatternSyntax", "int"),
      new SymbolicConstant(c, "RegExp", "int", Value(int(QRegExp::RegExp))),
      ...
      new SymbolicConstant(c, "W3CXmlSchema11", "int", Value(int(QRegExp::W3CXmlSchema11))),
    EndArguments);

addSymbols(
    // enums
    // member functions
    new Function(c, "QRegExp", _n_QRegExp0, None, Compiled, qt_QRegExp_QRegExp_QRegExp_QRegExp, Return, "qt.QRegExp", Parameters, new Param(c, "this", "qt.QRegExp"), End),
    new Function(c, "QRegExp", _n_QRegExp1, None, Compiled, qt_QRegExp_QRegExp_QRegExp_QRegExp_string_int_int, Return, "qt.QRegExp", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "pattern", "string"), new Param(c, "cs", "int", Value((int)Qt::CaseSensitive)), new Param(c, "syntax", "int", Value((int)QRegExp::RegExp)), End),
    // MISSING: QRegExp (QRegExp; QRegExp this, QRegExp rx)
    new Function(c, "cap", _n_cap0, None, Compiled, qt_QRegExp_cap_string_QRegExp_int, Return, "string", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "nth", "int", Value((int)0)), End),
    new Function(c, "captureCount", _n_captureCount0, None, Compiled, qt_QRegExp_captureCount_int_QRegExp, Return, "int", Parameters, new Param(c, "this", "qt.QRegExp"), End),
    new Function(c, "capturedTexts", _n_capturedTexts0, None, Compiled, qt_QRegExp_capturedTexts_stringBSB_ESB__QRegExp, Return, "string[]", Parameters, new Param(c, "this", "qt.QRegExp"), End),
    new Function(c, "caseSensitivity", _n_caseSensitivity0, None, Compiled, qt_QRegExp_caseSensitivity_int_QRegExp, Return, "int", Parameters, new Param(c, "this", "qt.QRegExp"), End),
    new Function(c, "errorString", _n_errorString0, None, Compiled, qt_QRegExp_errorString_string_QRegExp, Return, "string", Parameters, new Param(c, "this", "qt.QRegExp"), End),
    new Function(c, "exactMatch", _n_exactMatch0, None, Compiled, qt_QRegExp_exactMatch_bool_QRegExp_string, Return, "bool", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "str", "string"), End),
    new Function(c, "indexIn", _n_indexIn0, None, Compiled, qt_QRegExp_indexIn_int_QRegExp_string_int_int, Return, "int", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "str", "string"), new Param(c, "offset", "int", Value((int)0)), new Param(c, "caretMode", "int", Value((int)QRegExp::CaretAtZero)), End),
    new Function(c, "isEmpty", _n_isEmpty0, None, Compiled, qt_QRegExp_isEmpty_bool_QRegExp, Return, "bool", Parameters, new Param(c, "this", "qt.QRegExp"), End),
    new Function(c, "isMinimal", _n_isMinimal0, None, Compiled, qt_QRegExp_isMinimal_bool_QRegExp, Return, "bool", Parameters, new Param(c, "this", "qt.QRegExp"), End),
    new Function(c, "isValid", _n_isValid0, None, Compiled, qt_QRegExp_isValid_bool_QRegExp, Return, "bool", Parameters, new Param(c, "this", "qt.QRegExp"), End),
    new Function(c, "lastIndexIn", _n_lastIndexIn0, None, Compiled, qt_QRegExp_lastIndexIn_int_QRegExp_string_int_int, Return, "int", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "str", "string"), new Param(c, "offset", "int", Value((int)-1)), new Param(c, "caretMode", "int", Value((int)QRegExp::CaretAtZero)), End),
    new Function(c, "matchedLength", _n_matchedLength0, None, Compiled, qt_QRegExp_matchedLength_int_QRegExp, Return, "int", Parameters, new Param(c, "this", "qt.QRegExp"), End),
    new Function(c, "pattern", _n_pattern0, None, Compiled, qt_QRegExp_pattern_string_QRegExp, Return, "string", Parameters, new Param(c, "this", "qt.QRegExp"), End),
    new Function(c, "patternSyntax", _n_patternSyntax0, None, Compiled, qt_QRegExp_patternSyntax_int_QRegExp, Return, "int", Parameters, new Param(c, "this", "qt.QRegExp"), End),
    new Function(c, "pos", _n_pos0, None, Compiled, qt_QRegExp_pos_int_QRegExp_int, Return, "int", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "nth", "int", Value((int)0)), End),
    new Function(c, "setCaseSensitivity", _n_setCaseSensitivity0, None, Compiled, qt_QRegExp_setCaseSensitivity_void_QRegExp_int, Return, "void", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "cs", "int"), End),
    new Function(c, "setMinimal", _n_setMinimal0, None, Compiled, qt_QRegExp_setMinimal_void_QRegExp_bool, Return, "void", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "minimal", "bool"), End),
    new Function(c, "setPattern", _n_setPattern0, None, Compiled, qt_QRegExp_setPattern_void_QRegExp_string, Return, "void", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "pattern", "string"), End),
    new Function(c, "setPatternSyntax", _n_setPatternSyntax0, None, Compiled, qt_QRegExp_setPatternSyntax_void_QRegExp_int, Return, "void", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "syntax", "int"), End),
    new Function(c, "swap", _n_swap0, None, Compiled, qt_QRegExp_swap_void_QRegExp_QRegExp, Return, "void", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "other", "qt.QRegExp"), End),
    // static functions
    new Function(c, "escape", _n_escape0, None, Compiled, qt_QRegExp_escape_string_string, Return, "string", Parameters, new Param(c, "str", "string"), End),
    EndArguments);
globalScope()->addSymbols(
    new Function(c, "!=", _n_operatorBang_EQ_0, Op, Compiled, qt_QRegExp_operatorBang_EQ__bool_QRegExp_QRegExp, Return, "bool", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "rx", "qt.QRegExp"), End),
    // MISSING: = (QRegExp; QRegExp this, QRegExp rx)
    // MISSING: = (QRegExp; QRegExp this, QRegExp other)
    new Function(c, "==", _n_operatorEQ_EQ_0, Op, Compiled, qt_QRegExp_operatorEQ_EQ__bool_QRegExp_QRegExp, Return, "bool", Parameters, new Param(c, "this", "qt.QRegExp"), new Param(c, "rx", "qt.QRegExp"), End),
    EndArguments);
scope()->addSymbols(
    EndArguments);
