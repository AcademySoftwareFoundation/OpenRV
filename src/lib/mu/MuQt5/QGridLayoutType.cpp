...
addSymbols(
    ...
    new Function(c, "QGridLayout", _n_QGridLayout1, None, Compiled, qt_QGridLayout_QGridLayout_QGridLayout_QGridLayout, Return, "qt.QGridLayout", Parameters, new Param(c, "this", "qt.QGridLayout"), End),
    ...
    new Function(c, "setSpacing", _n_setSpacing0, None, Compiled, qt_QGridLayout_setSpacing_void_QGridLayout_int, Return, "void", Parameters, new Param(c, "this", "qt.QGridLayout"), new Param(c, "spacing", "int"), End),
    // PROP: setVerticalSpacing (void; QGridLayout this, int spacing)
    new Function(c, "spacing", _n_spacing0, None, Compiled, qt_QGridLayout_spacing_int_QGridLayout, Return, "int", Parameters, new Param(c, "this", "qt.QGridLayout"), End),
    ...
    _func[10] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QGridLayout_sizeHint_QSize_QGridLayout, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QGridLayout"), End),
    _func[11] = new MemberFunction(c, "takeAt", _n_takeAt0, None, Compiled, qt_QGridLayout_takeAt_QLayoutItem_QGridLayout_int, Return, "qt.QLayoutItem", Parameters, new Param(c, "this", "qt.QGridLayout"), new Param(c, "index", "int"), End),
    _func[12] = new MemberFunction(c, "addItem", _n_addItem1, None, Compiled, qt_QGridLayout_addItem_void_QGridLayout_QLayoutItem, Return, "void", Parameters, new Param(c, "this", "qt.QGridLayout"), new Param(c, "item", "qt.QLayoutItem"), End),
    _func[13] = new MemberFunction(c, "indexOf", _n_indexOf0, None, Compiled, qt_QGridLayout_indexOf_int_QGridLayout_QWidget, Return, "int", Parameters, new Param(c, "this", "qt.QGridLayout"), new Param(c, "widget", "qt.QWidget"), End),
    _func[14] = new MemberFunction(c, "controlTypes", _n_controlTypes0, None, Compiled, qt_QGridLayout_controlTypes_int_QGridLayout, Return, "int", Parameters, new Param(c, "this", "qt.QGridLayout"), End),
    _func[15] = new MemberFunction(c, "geometry", _n_geometry0, None, Compiled, qt_QGridLayout_geometry_QRect_QGridLayout, Return, "qt.QRect", Parameters, new Param(c, "this", "qt.QGridLayout"), End),
    _func[16] = new MemberFunction(c, "isEmpty", _n_isEmpty0, None, Compiled, qt_QGridLayout_isEmpty_bool_QGridLayout, Return, "bool", Parameters, new Param(c, "this", "qt.QGridLayout"), End),
    _func[17] = new MemberFunction(c, "layout", _n_layout0, None, Compiled, qt_QGridLayout_layout_QLayout_QGridLayout, Return, "qt.QLayout", Parameters, new Param(c, "this", "qt.QGridLayout"), End),
