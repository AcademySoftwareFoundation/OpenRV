...
addSymbols(
    ...
    _func[11] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QHBoxLayout_sizeHint_QSize_QHBoxLayout, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QHBoxLayout"), End),
    _func[12] = new MemberFunction(c, "takeAt", _n_takeAt0, None, Compiled, qt_QHBoxLayout_takeAt_QLayoutItem_QHBoxLayout_int, Return, "qt.QLayoutItem", Parameters, new Param(c, "this", "qt.QHBoxLayout"), new Param(c, "index", "int"), End),
    // static functions
    EndArguments);
