...
addSymbols(
    ...
    _func[10] = new MemberFunction(c, "controlTypes", _n_controlTypes0, None, Compiled, qt_QStackedLayout_controlTypes_int_QStackedLayout, Return, "int", Parameters, new Param(c, "this", "qt.QStackedLayout"), End),
    _func[11] = new MemberFunction(c, "expandingDirections", _n_expandingDirections0, None, Compiled, qt_QStackedLayout_expandingDirections_int_QStackedLayout, Return, "int", Parameters, new Param(c, "this", "qt.QStackedLayout"), End),
    _func[12] = new MemberFunction(c, "geometry", _n_geometry0, None, Compiled, qt_QStackedLayout_geometry_QRect_QStackedLayout, Return, "qt.QRect", Parameters, new Param(c, "this", "qt.QStackedLayout"), End),
    _func[13] = new MemberFunction(c, "invalidate", _n_invalidate0, None, Compiled, qt_QStackedLayout_invalidate_void_QStackedLayout, Return, "void", Parameters, new Param(c, "this", "qt.QStackedLayout"), End),
    _func[14] = new MemberFunction(c, "isEmpty", _n_isEmpty0, None, Compiled, qt_QStackedLayout_isEmpty_bool_QStackedLayout, Return, "bool", Parameters, new Param(c, "this", "qt.QStackedLayout"), End),
    _func[15] = new MemberFunction(c, "layout", _n_layout0, None, Compiled, qt_QStackedLayout_layout_QLayout_QStackedLayout, Return, "qt.QLayout", Parameters, new Param(c, "this", "qt.QStackedLayout"), End),
    _func[16] = new MemberFunction(c, "maximumSize", _n_maximumSize0, None, Compiled, qt_QStackedLayout_maximumSize_QSize_QStackedLayout, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QStackedLayout"), End),
