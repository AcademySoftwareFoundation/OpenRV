...
namespace Mu
{
    ...
    void QStackedLayoutType::load()
    {
        ...
        addSymbols(
            ...
            _func[11] = new MemberFunction(c, "expandingDirections", _n_expandingDirections0, None, Compiled,
                                           qt_QStackedLayout_expandingDirections_int_QStackedLayout, Return, "int", Parameters,
                                           new Param(c, "this", "qt.QStackedLayout"), End),
            _func[12] = new MemberFunction(c, "geometry", _n_geometry0, None, Compiled, qt_QStackedLayout_geometry_QRect_QStackedLayout,
            ...
            _func[14] = new MemberFunction(c, "isEmpty", _n_isEmpty0, None, Compiled, qt_QStackedLayout_isEmpty_bool_QStackedLayout, Return,
                                           "bool", Parameters, new Param(c, "this", "qt.QStackedLayout"), End),
            _func[15] = new MemberFunction(c, "layout", _n_layout0, None, Compiled, qt_QStackedLayout_layout_QLayout_QStackedLayout, Return,
