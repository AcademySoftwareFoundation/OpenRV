...
{
    if (!_env) return QDial::minimumSizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDial::mouseMoveEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDial::mousePressEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDial::mouseReleaseEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDial::paintEvent(pe); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDial::resizeEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDial::changeEvent(ev); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDial::keyPressEvent(ev); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDial::timerEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QDial::wheelEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QDial_QDial_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    {
        QDialType* type = 
            c->findSymbolOfTypeByQualifiedName<QDialType>(c->internName("qt.QDial"), false);
...
Pointer qt_QDial_minimumSizeHint_QSize_QDial(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    ...
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QDial::minimumSizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->minimumSizeHint(),"qt.QSize");
}
...
Pointer qt_QDial_sizeHint_QSize_QDial(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QDial* arg0 = object<QDial>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QDial::sizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->sizeHint(),"qt.QSize");
}
...
void qt_QDial_mouseMoveEvent_void_QDial_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDial*)arg0)->mouseMoveEvent_pub_parent(arg1);
    else ((MuQt_QDial*)arg0)->mouseMoveEvent_pub(arg1);
}
...
void qt_QDial_mousePressEvent_void_QDial_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    QDial* arg0 = object<QDial>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_e);
    if (isMuQtObject(arg0)) ((MuQt_QDial*)arg0)->mousePressEvent_pub_parent(arg1);
    else ((MuQt_QDial*)arg0)->mousePressEvent_pub(arg1);
}
...
void qt_QDial_mouseReleaseEvent_void_QDial_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    QDial* arg0 = object<QDial>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_e);
    if (isMuQtObject(arg0)) ((MuQt_QDial*)arg0)->mouseReleaseEvent_pub_parent(arg1);
    else ((MuQt_QDial*)arg0)->mouseReleaseEvent_pub(arg1);
}
...
void qt_QDial_paintEvent_void_QDial_QPaintEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_pe)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDial*)arg0)->paintEvent_pub_parent(arg1);
    else ((MuQt_QDial*)arg0)->paintEvent_pub(arg1);
}
...
void qt_QDial_resizeEvent_void_QDial_QResizeEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDial*)arg0)->resizeEvent_pub_parent(arg1);
    else ((MuQt_QDial*)arg0)->resizeEvent_pub(arg1);
}
...
void qt_QDial_changeEvent_void_QDial_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_ev)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDial*)arg0)->changeEvent_pub_parent(arg1);
    else ((MuQt_QDial*)arg0)->changeEvent_pub(arg1);
}
...
void qt_QDial_keyPressEvent_void_QDial_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_ev)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDial*)arg0)->keyPressEvent_pub_parent(arg1);
    else ((MuQt_QDial*)arg0)->keyPressEvent_pub(arg1);
}
...
void qt_QDial_timerEvent_void_QDial_QTimerEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDial*)arg0)->timerEvent_pub_parent(arg1);
    else ((MuQt_QDial*)arg0)->timerEvent_pub(arg1);
}
...
void qt_QDial_wheelEvent_void_QDial_QWheelEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QDial*)arg0)->wheelEvent_pub_parent(arg1);
    else ((MuQt_QDial*)arg0)->wheelEvent_pub(arg1);
}
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QDial", _n_QDial0, None, Compiled, qt_QDial_QDial_QDial_QDial_QWidget, Return, "qt.QDial", Parameters, new Param(c, "this", "qt.QDial"), new Param(c, "parent", "qt.QWidget"), End),
    ...
    _func[0] = new MemberFunction(c, "minimumSizeHint", _n_minimumSizeHint0, None, Compiled, qt_QDial_minimumSizeHint_QSize_QDial, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QDial"), End),
    _func[1] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QDial_sizeHint_QSize_QDial, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QDial"), End),
    // MISSING: initStyleOption (void; QDial this, "QStyleOptionSlider *" option) // protected
    _func[2] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QDial_event_bool_QDial_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QDial"), new Param(c, "e", "qt.QEvent"), End),
    _func[3] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QDial_mouseMoveEvent_void_QDial_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDial"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[4] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QDial_mousePressEvent_void_QDial_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDial"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[5] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QDial_mouseReleaseEvent_void_QDial_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDial"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[6] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QDial_paintEvent_void_QDial_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDial"), new Param(c, "pe", "qt.QPaintEvent"), End),
    _func[7] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QDial_resizeEvent_void_QDial_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDial"), new Param(c, "e", "qt.QResizeEvent"), End),
    // MISSING: sliderChange (void; QDial this, "SliderChange" change) // protected
    _func[8] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled, qt_QDial_changeEvent_void_QDial_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDial"), new Param(c, "ev", "qt.QEvent"), End),
    _func[9] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QDial_keyPressEvent_void_QDial_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDial"), new Param(c, "ev", "qt.QKeyEvent"), End),
    _func[10] = new MemberFunction(c, "timerEvent", _n_timerEvent0, None, Compiled, qt_QDial_timerEvent_void_QDial_QTimerEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDial"), new Param(c, "e", "qt.QTimerEvent"), End),
    _func[11] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QDial_wheelEvent_void_QDial_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QDial"), new Param(c, "e", "qt.QWheelEvent"), End),
    // static functions
    EndArguments);
