...
namespace Mu
{
    ...
    void QAbstractItemViewType::load()
    {
        ...
        addSymbols(
            ...
            _func[27] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled,
            ...
            _func[31] =
                new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled,
                                   ...
                                   new Param(c, "this", "qt.QAbstractItemView"), new Param(c, "event", "qt.QMouseEvent"), End),
            _func[32] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled,
            ...
            _func[34] = new MemberFunction(c, "viewportEvent", _n_viewportEvent0, None, Compiled,
            ...
            _func[35] = new MemberFunction(c, "viewportSizeHint", _n_viewportSizeHint0, None, Compiled,
                                           qt_QAbstractItemView_viewportSizeHint_QSize_QAbstractItemView, Return, "qt.QSize", Parameters,
                                           new Param(c, "this", "qt.QAbstractItemView"), End),
            _func[36] = new MemberFunction(c, "setupViewport", _n_setupViewport0, None, Compiled,
            ...
            _func[37] = new MemberFunction(c, "minimumSizeHint", _n_minimumSizeHint0, None, Compiled,
            ...
            _func[39] =
                new MemberFunction(c, "scrollContentsBy", _n_scrollContentsBy0, None, Compiled,
                                   ...
                                   new Param(c, "this", "qt.QAbstractItemView"), new Param(c, "dx", "int"), new Param(c, "dy", "int"), End),
            _func[40] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled,
            ...
            _func[41] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled,
            ...
            _func[42] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled,
