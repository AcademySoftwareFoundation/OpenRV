...
globalScope()->addSymbols(new Function(c, "print", printTextStream, None, Return, "void", Compiled, print_void_qt_QTextStream_string,
                          ...
                          new Function(c, "QTextStream", _n_QTextStream4, None, Compiled,
                                       qt_QTextStream_QTextStream_QTextStream_QTextStream_QByteArray_int, Return, "qt.QTextStream",
                                       Parameters, new Param(c, "this", "qt.QTextStream"), new Param(c, "array", "qt.QByteArray"),
