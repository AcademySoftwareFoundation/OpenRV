...
namespace Mu
{
    ...
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        return makeinstance<QDesktopWidgetType>(c, QApplication::desktop(), "qt.QDesktopWidget");
    }
    ...
    void qt_QApplication_setActiveWindow_void_QWidget(Mu::Thread& NODE_THREAD, Pointer param_active)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    void qt_QApplication_setColorSpec_void_int(Mu::Thread& NODE_THREAD, int param_spec)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    ...
    static NODE_IMPLEMENTATION(_n_colorSpec0, int) { NODE_RETURN(qt_QApplication_colorSpec_int(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_desktop0, Pointer) { NODE_RETURN(qt_QApplication_desktop_QDesktopWidget(NODE_THREAD)); }
    ...
    {
        qt_QApplication_setActiveWindow_void_QWidget(NODE_THREAD, NODE_ARG(0, Pointer));
    }

    static NODE_IMPLEMENTATION(_n_setColorSpec0, void) { qt_QApplication_setColorSpec_void_int(NODE_THREAD, NODE_ARG(0, int)); }
    ...
    void QApplicationType::load()
    {
        ...
        addSymbols(
            ...
            // argc, "char * *" argv)
            new Function(c, "notify", _n_notify0, None, Compiled, qt_QApplication_notify_bool_QApplication_QObject_QEvent, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QApplication"), new Param(c, "receiver", "qt.QObject"),
                         new Param(c, "e", "qt.QEvent"), End),
            // PROP: styleSheet (string; QApplication this)
            new Function(c, "event", _n_event0, None, Compiled, qt_QApplication_event_bool_QApplication_QEvent, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QApplication"), new Param(c, "e", "qt.QEvent"), End),
            // static functions
            ...
            new Function(c, "colorSpec", _n_colorSpec0, None, Compiled, qt_QApplication_colorSpec_int, Return, "int", End),
            new Function(c, "desktop", _n_desktop0, None, Compiled, qt_QApplication_desktop_QDesktopWidget, Return, "qt.QDesktopWidget",
                         End),
            ...
            new Function(c, "setActiveWindow", _n_setActiveWindow0, None, Compiled, qt_QApplication_setActiveWindow_void_QWidget, Return,
                         "void", Parameters, new Param(c, "active", "qt.QWidget"), End),
            new Function(c, "setColorSpec", _n_setColorSpec0, None, Compiled, qt_QApplication_setColorSpec_void_int, Return, "void",
