...
addSymbols(
    ...
    new Function(c, "notify", _n_notify0, None, Compiled, qt_QApplication_notify_bool_QApplication_QObject_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QApplication"), new Param(c, "receiver", "qt.QObject"), new Param(c, "e", "qt.QEvent"), End),
    // PROP: styleSheet (string; QApplication this)
    new Function(c, "event", _n_event0, None, Compiled, qt_QApplication_event_bool_QApplication_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QApplication"), new Param(c, "e", "qt.QEvent"), End),
    // static functions
    ...
    new Function(c, "desktop", _n_desktop0, None, Compiled, qt_QApplication_desktop_QDesktopWidget, Return, "qt.QDesktopWidget", End),
    ...
    new Function(c, "setActiveWindow", _n_setActiveWindow0, None, Compiled, qt_QApplication_setActiveWindow_void_QWidget, Return, "void", Parameters, new Param(c, "active", "qt.QWidget"), End),
    new Function(c, "setColorSpec", _n_setColorSpec0, None, Compiled, qt_QApplication_setColorSpec_void_int, Return, "void", Parameters, new Param(c, "spec", "int"), End),
