...
addSymbols(
    ...
    _func[1] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QTextBrowser_event_bool_QTextBrowser_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QEvent"), End),
    _func[2] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QTextBrowser_focusNextPrevChild_bool_QTextBrowser_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "next", "bool"), End),
    _func[3] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QTextBrowser_focusOutEvent_void_QTextBrowser_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "ev", "qt.QFocusEvent"), End),
    _func[4] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QTextBrowser_keyPressEvent_void_QTextBrowser_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "ev", "qt.QKeyEvent"), End),
    _func[5] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QTextBrowser_mouseMoveEvent_void_QTextBrowser_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[6] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QTextBrowser_mousePressEvent_void_QTextBrowser_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[7] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QTextBrowser_mouseReleaseEvent_void_QTextBrowser_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[8] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QTextBrowser_paintEvent_void_QTextBrowser_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QPaintEvent"), End),
    _func[9] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QTextBrowser_inputMethodQuery_QVariant_QTextBrowser_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "property", "int"), End),
    _func[10] = new MemberFunction(c, "canInsertFromMimeData", _n_canInsertFromMimeData0, None, Compiled, qt_QTextBrowser_canInsertFromMimeData_bool_QTextBrowser_QMimeData, Return, "bool", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "source", "qt.QMimeData"), End),
    _func[11] = new MemberFunction(c, "createMimeDataFromSelection", _n_createMimeDataFromSelection0, None, Compiled, qt_QTextBrowser_createMimeDataFromSelection_QMimeData_QTextBrowser, Return, "qt.QMimeData", Parameters, new Param(c, "this", "qt.QTextBrowser"), End),
    _func[12] = new MemberFunction(c, "insertFromMimeData", _n_insertFromMimeData0, None, Compiled, qt_QTextBrowser_insertFromMimeData_void_QTextBrowser_QMimeData, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "source", "qt.QMimeData"), End),
    _func[13] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled, qt_QTextBrowser_changeEvent_void_QTextBrowser_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QEvent"), End),
    _func[14] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled, qt_QTextBrowser_contextMenuEvent_void_QTextBrowser_QContextMenuEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "event", "qt.QContextMenuEvent"), End),
    _func[15] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QTextBrowser_dragEnterEvent_void_QTextBrowser_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QDragEnterEvent"), End),
    _func[16] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QTextBrowser_dragLeaveEvent_void_QTextBrowser_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QDragLeaveEvent"), End),
    _func[17] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QTextBrowser_dragMoveEvent_void_QTextBrowser_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QDragMoveEvent"), End),
    _func[18] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QTextBrowser_dropEvent_void_QTextBrowser_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QDropEvent"), End),
    _func[19] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QTextBrowser_focusInEvent_void_QTextBrowser_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QFocusEvent"), End),
    // MISSING: inputMethodEvent (void; QTextBrowser this, "QInputMethodEvent *" e) // protected
    _func[20] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QTextBrowser_keyReleaseEvent_void_QTextBrowser_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QKeyEvent"), End),
    _func[21] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QTextBrowser_mouseDoubleClickEvent_void_QTextBrowser_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QMouseEvent"), End),
    _func[22] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QTextBrowser_resizeEvent_void_QTextBrowser_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QResizeEvent"), End),
    _func[23] = new MemberFunction(c, "scrollContentsBy", _n_scrollContentsBy0, None, Compiled, qt_QTextBrowser_scrollContentsBy_void_QTextBrowser_int_int, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "dx", "int"), new Param(c, "dy", "int"), End),
    _func[24] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QTextBrowser_showEvent_void_QTextBrowser_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "_p13", "qt.QShowEvent"), End),
    _func[25] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QTextBrowser_wheelEvent_void_QTextBrowser_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QTextBrowser"), new Param(c, "e", "qt.QWheelEvent"), End),
    // static functions
    EndArguments);
