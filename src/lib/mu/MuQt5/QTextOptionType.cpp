...
void qt_QTextOption_setTabStop_void_QTextOption_double(Mu::Thread& NODE_THREAD, Pointer param_this, double param_tabStop)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTextOption arg0 = getqtype<QTextOptionType>(param_this);
...
double qt_QTextOption_tabStop_double_QTextOption(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QTextOption arg0 = getqtype<QTextOptionType>(param_this);
    return arg0.tabStop();
...
{
    qt_QTextOption_setTabStop_void_QTextOption_double(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, double));
}
...
{
    NODE_RETURN(qt_QTextOption_tabStop_double_QTextOption(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
addSymbols(
    ...
    new Function(c, "setTabStop", _n_setTabStop0, None, Compiled, qt_QTextOption_setTabStop_void_QTextOption_double, Return, "void", Parameters, new Param(c, "this", "qt.QTextOption"), new Param(c, "tabStop", "double"), End),
    // MISSING: setTabs (void; QTextOption this, "const QList<Tab> &" tabStops)
    ...
    new Function(c, "tabStop", _n_tabStop0, None, Compiled, qt_QTextOption_tabStop_double_QTextOption, Return, "double", Parameters, new Param(c, "this", "qt.QTextOption"), End),
