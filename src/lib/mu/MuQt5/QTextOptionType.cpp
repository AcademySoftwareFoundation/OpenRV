...
namespace Mu
{
    ...
    void QTextOptionType::load()
    {
        ...
        addSymbols(
            ...
            // &" tabStops)
            new Function(c, "setTabStop", _n_setTabStop0, None, Compiled, qt_QTextOption_setTabStop_void_QTextOption_double, Return, "void",
                         Parameters, new Param(c, "this", "qt.QTextOption"), new Param(c, "tabStop", "double"), End),
            ...
            new Function(c, "tabStop", _n_tabStop0, None, Compiled, qt_QTextOption_tabStop_double_QTextOption, Return, "double", Parameters,
                         new Param(c, "this", "qt.QTextOption"), End),
