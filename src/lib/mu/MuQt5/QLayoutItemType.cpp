...
{
    if (!_env) return QLayoutItem::heightForWidth(w);
    MuLangContext* c = (MuLangContext*)_env->context();
...
int qt_QLayoutItem_heightForWidth_int_QLayoutItem_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_w)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QLayoutItem* arg0 = layoutitem<QLayoutItem>(param_this);
...
addSymbols(
    ...
    _func[4] = new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QLayoutItem_heightForWidth_int_QLayoutItem_int, Return, "int", Parameters, new Param(c, "this", "qt.QLayoutItem"), new Param(c, "w", "int"), End),
