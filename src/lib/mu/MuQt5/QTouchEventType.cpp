...
addSymbols(
    new Alias(c, "DeviceType", "int"),
      new SymbolicConstant(c, "TouchScreen", "int", Value(int(QTouchEvent::TouchScreen))),
      new SymbolicConstant(c, "TouchPad", "int", Value(int(QTouchEvent::TouchPad))),
    EndArguments);
addSymbols(
    // enums
    // member functions
    //new Function(c, "QTouchEvent", _n_QTouchEvent0, None, Compiled, qt_QTouchEvent_QTouchEvent_QTouchEvent_QTouchEvent_int_int_int_int_int, Return, "qt.QTouchEvent", Parameters, new Param(c, "this", "qt.QTouchEvent"), new Param(c, "eventType", "int"), new Param(c, "deviceType", "int"), new Param(c, "modifiers", "int"), new Param(c, "touchPointStates", "int"), new Param(c, "touchPoints", "int"), End),
    new Function(c, "deviceType", _n_deviceType0, None, Compiled, qt_QTouchEvent_deviceType_int_QTouchEvent, Return, "int", Parameters, new Param(c, "this", "qt.QTouchEvent"), End),
    new Function(c, "touchPointStates", _n_touchPointStates0, None, Compiled, qt_QTouchEvent_touchPointStates_int_QTouchEvent, Return, "int", Parameters, new Param(c, "this", "qt.QTouchEvent"), End),
    new Function(c, "touchPoints", _n_touchPoints0, None, Compiled, qt_QTouchEvent_touchPoints_int_QTouchEvent, Return, "int", Parameters, new Param(c, "this", "qt.QTouchEvent"), End),
    new Function(c, "widget", _n_widget0, None, Compiled, qt_QTouchEvent_widget_QWidget_QTouchEvent, Return, "qt.QWidget", Parameters, new Param(c, "this", "qt.QTouchEvent"), End),
    // static functions
    EndArguments);
