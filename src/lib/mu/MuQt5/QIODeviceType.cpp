...
addSymbols(
    ...
    new Function(c, "write", _n_write2, None, Compiled, qt_QIODevice_write_int64_QIODevice_QByteArray, Return, "int64", Parameters, new Param(c, "this", "qt.QIODevice"), new Param(c, "byteArray", "qt.QByteArray"), End),
    ...
    // NOT INHERITABLE PROTECTED: setOpenMode (void; QIODevice this, flags QIODevice::OpenMode openMode) // protected
