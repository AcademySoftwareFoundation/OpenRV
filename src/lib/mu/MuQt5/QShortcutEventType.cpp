...
namespace Mu
{
    ...
    Pointer qt_QShortcutEvent_QShortcutEvent_QShortcutEvent_QShortcutEvent_QKeySequence_int_bool(Mu::Thread& NODE_THREAD,
                                                                                                 Pointer param_this, Pointer param_key,
    ...
    {
        NODE_RETURN(qt_QShortcutEvent_QShortcutEvent_QShortcutEvent_QShortcutEvent_QKeySequence_int_bool(
    ...
    void QShortcutEventType::load()
    {
        ...
        addSymbols(
            // enums
            // member functions
            new Function(c, "QShortcutEvent", _n_QShortcutEvent0, None, Compiled,
                         qt_QShortcutEvent_QShortcutEvent_QShortcutEvent_QShortcutEvent_QKeySequence_int_bool, Return, "qt.QShortcutEvent",
                         Parameters, new Param(c, "this", "qt.QShortcutEvent"), new Param(c, "key", "qt.QKeySequence"),
                         new Param(c, "id", "int"), new Param(c, "ambiguous", "bool"), End),
            ...
            new Function(c, "shortcutId", _n_shortcutId0, None, Compiled, qt_QShortcutEvent_shortcutId_int_QShortcutEvent, Return, "int",
                         Parameters, new Param(c, "this", "qt.QShortcutEvent"), End),
            // static functions
            EndArguments);
