...
{
    if (!_env) return QStatusBar::event(e);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::paintEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::resizeEvent(e); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::showEvent(_p13); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QStatusBar::hasHeightForWidth();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QStatusBar::heightForWidth(w);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QStatusBar::inputMethodQuery(query);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QStatusBar::minimumSizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QStatusBar::sizeHint();
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::changeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::closeEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::contextMenuEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::dragEnterEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::dragLeaveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::dragMoveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::dropEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::enterEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::focusInEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) return QStatusBar::focusNextPrevChild(next);
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::focusOutEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::hideEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::keyPressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::keyReleaseEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::leaveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::mouseDoubleClickEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::mouseMoveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::mousePressEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::mouseReleaseEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::moveEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::tabletEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
{
    if (!_env) { QStatusBar::wheelEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
static Pointer
QStatusBar_QStatusBar_QObject(Thread& NODE_THREAD, Pointer obj)
{
    ...
    {
        QStatusBarType* type = 
            c->findSymbolOfTypeByQualifiedName<QStatusBarType>(c->internName("qt.QStatusBar"), false);
...
{
    NODE_RETURN( QStatusBar_QStatusBar_QObject(NODE_THREAD, NODE_ARG(0, Pointer)) );
}
...
void qt_QStatusBar_addPermanentWidget_void_QStatusBar_QWidget_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_widget, int param_stretch)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
int qt_QStatusBar_insertPermanentWidget_int_QStatusBar_int_QWidget_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index, Pointer param_widget, int param_stretch)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QStatusBar* arg0 = object<QStatusBar>(param_this);
...
int qt_QStatusBar_insertWidget_int_QStatusBar_int_QWidget_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_index, Pointer param_widget, int param_stretch)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QStatusBar* arg0 = object<QStatusBar>(param_this);
    int arg1 = (int)(param_index);
...
void qt_QStatusBar_paintEvent_void_QStatusBar_QPaintEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->paintEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->paintEvent_pub(arg1);
}
...
void qt_QStatusBar_resizeEvent_void_QStatusBar_QResizeEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_e)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->resizeEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->resizeEvent_pub(arg1);
}
...
void qt_QStatusBar_showEvent_void_QStatusBar_QShowEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param__p13)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->showEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->showEvent_pub(arg1);
}
...
Pointer qt_QStatusBar_inputMethodQuery_QVariant_QStatusBar_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_query)
{
    ...
    return isMuQtObject(arg0) ? makeqtype<QVariantType>(c,arg0->QStatusBar::inputMethodQuery(arg1),"qt.QVariant") : makeqtype<QVariantType>(c,arg0->inputMethodQuery(arg1),"qt.QVariant");
}
...
Pointer qt_QStatusBar_minimumSizeHint_QSize_QStatusBar(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QStatusBar* arg0 = object<QStatusBar>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QStatusBar::minimumSizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->minimumSizeHint(),"qt.QSize");
}
...
Pointer qt_QStatusBar_sizeHint_QSize_QStatusBar(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QStatusBar* arg0 = object<QStatusBar>(param_this);
    return isMuQtObject(arg0) ? makeqtype<QSizeType>(c,arg0->QStatusBar::sizeHint(),"qt.QSize") : makeqtype<QSizeType>(c,arg0->sizeHint(),"qt.QSize");
}
...
void qt_QStatusBar_changeEvent_void_QStatusBar_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->changeEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->changeEvent_pub(arg1);
}
...
void qt_QStatusBar_closeEvent_void_QStatusBar_QCloseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->closeEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->closeEvent_pub(arg1);
}
...
void qt_QStatusBar_contextMenuEvent_void_QStatusBar_QContextMenuEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->contextMenuEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->contextMenuEvent_pub(arg1);
}
...
void qt_QStatusBar_dragEnterEvent_void_QStatusBar_QDragEnterEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->dragEnterEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->dragEnterEvent_pub(arg1);
}
...
void qt_QStatusBar_dragLeaveEvent_void_QStatusBar_QDragLeaveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->dragLeaveEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->dragLeaveEvent_pub(arg1);
}
...
void qt_QStatusBar_dragMoveEvent_void_QStatusBar_QDragMoveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->dragMoveEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->dragMoveEvent_pub(arg1);
}
...
void qt_QStatusBar_dropEvent_void_QStatusBar_QDropEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->dropEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->dropEvent_pub(arg1);
}

void qt_QStatusBar_enterEvent_void_QStatusBar_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QStatusBar* arg0 = object<QStatusBar>(param_this);
    QEvent * arg1 = getqpointer<QEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->enterEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->enterEvent_pub(arg1);
}
...
void qt_QStatusBar_focusInEvent_void_QStatusBar_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->focusInEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->focusInEvent_pub(arg1);
}
...
bool qt_QStatusBar_focusNextPrevChild_bool_QStatusBar_bool(Mu::Thread& NODE_THREAD, Pointer param_this, bool param_next)
{
    ...
    return isMuQtObject(arg0) ? ((MuQt_QStatusBar*)arg0)->focusNextPrevChild_pub_parent(arg1) : ((MuQt_QStatusBar*)arg0)->focusNextPrevChild_pub(arg1);
}
...
void qt_QStatusBar_focusOutEvent_void_QStatusBar_QFocusEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QStatusBar* arg0 = object<QStatusBar>(param_this);
    QFocusEvent * arg1 = getqpointer<QFocusEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->focusOutEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->focusOutEvent_pub(arg1);
}
...
void qt_QStatusBar_hideEvent_void_QStatusBar_QHideEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->hideEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->hideEvent_pub(arg1);
}
...
void qt_QStatusBar_keyPressEvent_void_QStatusBar_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    else ((MuQt_QStatusBar*)arg0)->keyPressEvent_pub(arg1);
}
...
void qt_QStatusBar_keyReleaseEvent_void_QStatusBar_QKeyEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QStatusBar* arg0 = object<QStatusBar>(param_this);
    QKeyEvent * arg1 = getqpointer<QKeyEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->keyReleaseEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->keyReleaseEvent_pub(arg1);
}
...
void qt_QStatusBar_leaveEvent_void_QStatusBar_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QStatusBar* arg0 = object<QStatusBar>(param_this);
    QEvent * arg1 = getqpointer<QEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->leaveEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->leaveEvent_pub(arg1);
}
...
void qt_QStatusBar_mouseDoubleClickEvent_void_QStatusBar_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->mouseDoubleClickEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->mouseDoubleClickEvent_pub(arg1);
}
...
void qt_QStatusBar_mouseMoveEvent_void_QStatusBar_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QStatusBar* arg0 = object<QStatusBar>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->mouseMoveEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->mouseMoveEvent_pub(arg1);
}
...
void qt_QStatusBar_mousePressEvent_void_QStatusBar_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QStatusBar* arg0 = object<QStatusBar>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->mousePressEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->mousePressEvent_pub(arg1);
}
...
void qt_QStatusBar_mouseReleaseEvent_void_QStatusBar_QMouseEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    QStatusBar* arg0 = object<QStatusBar>(param_this);
    QMouseEvent * arg1 = getqpointer<QMouseEventType>(param_event);
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->mouseReleaseEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->mouseReleaseEvent_pub(arg1);
}
...
void qt_QStatusBar_moveEvent_void_QStatusBar_QMoveEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->moveEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->moveEvent_pub(arg1);
}
...
void qt_QStatusBar_tabletEvent_void_QStatusBar_QTabletEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->tabletEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->tabletEvent_pub(arg1);
}
...
void qt_QStatusBar_wheelEvent_void_QStatusBar_QWheelEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QStatusBar*)arg0)->wheelEvent_pub_parent(arg1);
    else ((MuQt_QStatusBar*)arg0)->wheelEvent_pub(arg1);
}
...
{
    qt_QStatusBar_addPermanentWidget_void_QStatusBar_QWidget_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int));
}

static NODE_IMPLEMENTATION(_n_addWidget0, void)
{
    qt_QStatusBar_addWidget_void_QStatusBar_QWidget_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int));
}
...
{
    NODE_RETURN(qt_QStatusBar_insertPermanentWidget_int_QStatusBar_int_QWidget_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer), NODE_ARG(3, int)));
}

static NODE_IMPLEMENTATION(_n_insertWidget0, int)
{
    NODE_RETURN(qt_QStatusBar_insertWidget_int_QStatusBar_int_QWidget_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, Pointer), NODE_ARG(3, int)));
}
...
{
    qt_QStatusBar_hideOrShow_void_QStatusBar(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}

static NODE_IMPLEMENTATION(_n_reformat0, void)
{
    qt_QStatusBar_reformat_void_QStatusBar(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    qt_QStatusBar_enterEvent_void_QStatusBar_QEvent(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
}
...
QStatusBarType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, castFromObject, Cast,
                            Compiled, QStatusBar_QStatusBar_QObject,
                            Return, ftn,
                            Parameters,
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QStatusBar", _n_QStatusBar0, None, Compiled, qt_QStatusBar_QStatusBar_QStatusBar_QStatusBar_QWidget, Return, "qt.QStatusBar", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "parent", "qt.QWidget"), End),
    new Function(c, "addPermanentWidget", _n_addPermanentWidget0, None, Compiled, qt_QStatusBar_addPermanentWidget_void_QStatusBar_QWidget_int, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "widget", "qt.QWidget"), new Param(c, "stretch", "int", Value((int)0)), End),
    new Function(c, "addWidget", _n_addWidget0, None, Compiled, qt_QStatusBar_addWidget_void_QStatusBar_QWidget_int, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "widget", "qt.QWidget"), new Param(c, "stretch", "int", Value((int)0)), End),
    new Function(c, "currentMessage", _n_currentMessage0, None, Compiled, qt_QStatusBar_currentMessage_string_QStatusBar, Return, "string", Parameters, new Param(c, "this", "qt.QStatusBar"), End),
    new Function(c, "insertPermanentWidget", _n_insertPermanentWidget0, None, Compiled, qt_QStatusBar_insertPermanentWidget_int_QStatusBar_int_QWidget_int, Return, "int", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "index", "int"), new Param(c, "widget", "qt.QWidget"), new Param(c, "stretch", "int", Value((int)0)), End),
    new Function(c, "insertWidget", _n_insertWidget0, None, Compiled, qt_QStatusBar_insertWidget_int_QStatusBar_int_QWidget_int, Return, "int", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "index", "int"), new Param(c, "widget", "qt.QWidget"), new Param(c, "stretch", "int", Value((int)0)), End),
    // PROP: isSizeGripEnabled (bool; QStatusBar this)
    new Function(c, "removeWidget", _n_removeWidget0, None, Compiled, qt_QStatusBar_removeWidget_void_QStatusBar_QWidget, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "widget", "qt.QWidget"), End),
    // PROP: setSizeGripEnabled (void; QStatusBar this, bool _p5)
    new Function(c, "hideOrShow", _n_hideOrShow0, None, Compiled, qt_QStatusBar_hideOrShow_void_QStatusBar, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), End),
    new Function(c, "reformat", _n_reformat0, None, Compiled, qt_QStatusBar_reformat_void_QStatusBar, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), End),
    _func[0] = new MemberFunction(c, "event", _n_event0, None, Compiled, qt_QStatusBar_event_bool_QStatusBar_QEvent, Return, "bool", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "e", "qt.QEvent"), End),
    _func[1] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QStatusBar_paintEvent_void_QStatusBar_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QPaintEvent"), End),
    _func[2] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QStatusBar_resizeEvent_void_QStatusBar_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "e", "qt.QResizeEvent"), End),
    _func[3] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QStatusBar_showEvent_void_QStatusBar_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "_p13", "qt.QShowEvent"), End),
    _func[4] = new MemberFunction(c, "hasHeightForWidth", _n_hasHeightForWidth0, None, Compiled, qt_QStatusBar_hasHeightForWidth_bool_QStatusBar, Return, "bool", Parameters, new Param(c, "this", "qt.QStatusBar"), End),
    _func[5] = new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QStatusBar_heightForWidth_int_QStatusBar_int, Return, "int", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "w", "int"), End),
    _func[6] = new MemberFunction(c, "inputMethodQuery", _n_inputMethodQuery0, None, Compiled, qt_QStatusBar_inputMethodQuery_QVariant_QStatusBar_int, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "query", "int"), End),
    _func[7] = new MemberFunction(c, "minimumSizeHint", _n_minimumSizeHint0, None, Compiled, qt_QStatusBar_minimumSizeHint_QSize_QStatusBar, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QStatusBar"), End),
    _func[8] = new MemberFunction(c, "sizeHint", _n_sizeHint0, None, Compiled, qt_QStatusBar_sizeHint_QSize_QStatusBar, Return, "qt.QSize", Parameters, new Param(c, "this", "qt.QStatusBar"), End),
    // MISSING: paintEngine ("QPaintEngine *"; QStatusBar this)
    // MISSING: actionEvent (void; QStatusBar this, "QActionEvent *" event) // protected
    _func[9] = new MemberFunction(c, "changeEvent", _n_changeEvent0, None, Compiled, qt_QStatusBar_changeEvent_void_QStatusBar_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QEvent"), End),
    _func[10] = new MemberFunction(c, "closeEvent", _n_closeEvent0, None, Compiled, qt_QStatusBar_closeEvent_void_QStatusBar_QCloseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QCloseEvent"), End),
    _func[11] = new MemberFunction(c, "contextMenuEvent", _n_contextMenuEvent0, None, Compiled, qt_QStatusBar_contextMenuEvent_void_QStatusBar_QContextMenuEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QContextMenuEvent"), End),
    _func[12] = new MemberFunction(c, "dragEnterEvent", _n_dragEnterEvent0, None, Compiled, qt_QStatusBar_dragEnterEvent_void_QStatusBar_QDragEnterEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QDragEnterEvent"), End),
    _func[13] = new MemberFunction(c, "dragLeaveEvent", _n_dragLeaveEvent0, None, Compiled, qt_QStatusBar_dragLeaveEvent_void_QStatusBar_QDragLeaveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QDragLeaveEvent"), End),
    _func[14] = new MemberFunction(c, "dragMoveEvent", _n_dragMoveEvent0, None, Compiled, qt_QStatusBar_dragMoveEvent_void_QStatusBar_QDragMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QDragMoveEvent"), End),
    _func[15] = new MemberFunction(c, "dropEvent", _n_dropEvent0, None, Compiled, qt_QStatusBar_dropEvent_void_QStatusBar_QDropEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QDropEvent"), End),
    _func[16] = new MemberFunction(c, "enterEvent", _n_enterEvent0, None, Compiled, qt_QStatusBar_enterEvent_void_QStatusBar_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QEvent"), End),
    _func[17] = new MemberFunction(c, "focusInEvent", _n_focusInEvent0, None, Compiled, qt_QStatusBar_focusInEvent_void_QStatusBar_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[18] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QStatusBar_focusNextPrevChild_bool_QStatusBar_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "next", "bool"), End),
    _func[19] = new MemberFunction(c, "focusOutEvent", _n_focusOutEvent0, None, Compiled, qt_QStatusBar_focusOutEvent_void_QStatusBar_QFocusEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QFocusEvent"), End),
    _func[20] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QStatusBar_hideEvent_void_QStatusBar_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QHideEvent"), End),
    // MISSING: inputMethodEvent (void; QStatusBar this, "QInputMethodEvent *" event) // protected
    _func[21] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled, qt_QStatusBar_keyPressEvent_void_QStatusBar_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[22] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QStatusBar_keyReleaseEvent_void_QStatusBar_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QKeyEvent"), End),
    _func[23] = new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QStatusBar_leaveEvent_void_QStatusBar_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QEvent"), End),
    _func[24] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QStatusBar_mouseDoubleClickEvent_void_QStatusBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[25] = new MemberFunction(c, "mouseMoveEvent", _n_mouseMoveEvent0, None, Compiled, qt_QStatusBar_mouseMoveEvent_void_QStatusBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[26] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled, qt_QStatusBar_mousePressEvent_void_QStatusBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[27] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled, qt_QStatusBar_mouseReleaseEvent_void_QStatusBar_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[28] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QStatusBar_moveEvent_void_QStatusBar_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QStatusBar this, QByteArray eventType, "void *" message, "long *" result) // protected
    _func[29] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QStatusBar_tabletEvent_void_QStatusBar_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QTabletEvent"), End),
    _func[30] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QStatusBar_wheelEvent_void_QStatusBar_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QWheelEvent"), End),
    // MISSING: initPainter (void; QStatusBar this, "QPainter *" painter) // protected
    // MISSING: metric (int; QStatusBar this, "PaintDeviceMetric" m) // protected
    // static functions
    EndArguments);
