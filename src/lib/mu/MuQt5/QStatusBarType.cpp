...
namespace Mu
{
    ...
    void QStatusBarType::load()
    {
        ...
        addSymbols(
            ...
            _func[16] =
                new MemberFunction(c, "enterEvent", _n_enterEvent0, None, Compiled, qt_QStatusBar_enterEvent_void_QStatusBar_QEvent, Return,
            ...
            _func[21] = new MemberFunction(c, "keyPressEvent", _n_keyPressEvent0, None, Compiled,
            ...
            _func[23] =
                new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QStatusBar_leaveEvent_void_QStatusBar_QEvent, Return,
                                   "void", Parameters, new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QEvent"), End),
            _func[24] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled,
            ...
            _func[26] = new MemberFunction(c, "mousePressEvent", _n_mousePressEvent0, None, Compiled,
                                           ...
                                           new Param(c, "this", "qt.QStatusBar"), new Param(c, "event", "qt.QMouseEvent"), End),
            _func[27] = new MemberFunction(c, "mouseReleaseEvent", _n_mouseReleaseEvent0, None, Compiled,
