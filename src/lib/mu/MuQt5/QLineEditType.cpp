...
addSymbols(
    ...
    // PROP: setCursorPosition (void; QLineEdit this, int _p4)
    // PROP: setDragEnabled (void; QLineEdit this, bool b)
    // PROP: setEchoMode (void; QLineEdit this, flags QLineEdit::EchoMode _p9)
    // PROP: setFrame (void; QLineEdit this, bool _p5)
    // PROP: setInputMask (void; QLineEdit this, string inputMask)
    // PROP: setMaxLength (void; QLineEdit this, int _p4)
    ...
    _func[17] = new MemberFunction(c, "paintEvent", _n_paintEvent0, None, Compiled, qt_QLineEdit_paintEvent_void_QLineEdit_QPaintEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "_p14", "qt.QPaintEvent"), End),
    _func[18] = new MemberFunction(c, "hasHeightForWidth", _n_hasHeightForWidth0, None, Compiled, qt_QLineEdit_hasHeightForWidth_bool_QLineEdit, Return, "bool", Parameters, new Param(c, "this", "qt.QLineEdit"), End),
    _func[19] = new MemberFunction(c, "heightForWidth", _n_heightForWidth0, None, Compiled, qt_QLineEdit_heightForWidth_int_QLineEdit_int, Return, "int", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "w", "int"), End),
    // MISSING: paintEngine ("QPaintEngine *"; QLineEdit this)
    // MISSING: actionEvent (void; QLineEdit this, "QActionEvent *" event) // protected
    _func[20] = new MemberFunction(c, "closeEvent", _n_closeEvent0, None, Compiled, qt_QLineEdit_closeEvent_void_QLineEdit_QCloseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QCloseEvent"), End),
    _func[21] = new MemberFunction(c, "enterEvent", _n_enterEvent0, None, Compiled, qt_QLineEdit_enterEvent_void_QLineEdit_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QEvent"), End),
    _func[22] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QLineEdit_focusNextPrevChild_bool_QLineEdit_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "next", "bool"), End),
    _func[23] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QLineEdit_hideEvent_void_QLineEdit_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QHideEvent"), End),
    _func[24] = new MemberFunction(c, "keyReleaseEvent", _n_keyReleaseEvent0, None, Compiled, qt_QLineEdit_keyReleaseEvent_void_QLineEdit_QKeyEvent, Return, "void", Parameters, new Param(c, "this", "qt.QLineEdit"), new Param(c, "event", "qt.QKeyEvent"), End),
    ...
    // MISSING: nativeEvent (bool; QLineEdit this, QByteArray eventType, "void *" message, "long *" result) // protected
