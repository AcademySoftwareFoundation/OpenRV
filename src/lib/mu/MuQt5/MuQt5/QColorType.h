...
//
#ifndef __MuQt5__QColorType__h__
#define __MuQt5__QColorType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        QColorType(Context* context, const char* name, Class* superClass = 0);
        virtual ~QColorType();
...
#endif // __MuQt5__QColorType__h__
