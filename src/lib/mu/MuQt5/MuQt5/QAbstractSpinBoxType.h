...
class MuQt_QAbstractSpinBox : public QAbstractSpinBox
{
  ...
  public:
    ...
    void enterEvent_pub_parent(QEvent * event)  { QAbstractSpinBox::enterEvent(event); }
    ...
    int metric_pub_parent(PaintDeviceMetric m) const { return QAbstractSpinBox::metric(m); }
  public:
