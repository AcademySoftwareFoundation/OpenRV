...
//
#ifndef __MuQt5__QRectFType__h__
#define __MuQt5__QRectFType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        QRectFType(Context* context, const char* name, Class* superClass = 0);
        virtual ~QRectFType();
...
#endif // __MuQt5__QRectFType__h__
