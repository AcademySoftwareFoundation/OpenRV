...
class QQuickItemType : public Class
{
  public:
    ...
    QQuickItemType(Context* context, 
           const char* name,
           Class* superClass = 0,
           Class* superClass2 = 0);
...
class MuQt_QQuickItem : public QQuickItem
{
  ...
  public:
    ...
    void geometryChanged_pub_parent(const QRectF & newGeometry, const QRectF & oldGeometry)  { QQuickItem::geometryChanged(newGeometry, oldGeometry); }
