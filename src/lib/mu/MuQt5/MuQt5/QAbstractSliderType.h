...
class QAbstractSliderType : public Class
{
  public:
    ...
    QAbstractSliderType(Context* context, 
           const char* name,
           Class* superClass = 0,
           Class* superClass2 = 0);
...
class MuQt_QAbstractSlider : public QAbstractSlider
{
  ...
  public:
    ...
    void setRepeatAction_pub(QAbstractSlider::SliderAction action, int thresholdTime, int repeatTime)  { setRepeatAction(action, thresholdTime, repeatTime); }
    void setRepeatAction_pub_parent(QAbstractSlider::SliderAction action, int thresholdTime, int repeatTime)  { QAbstractSlider::setRepeatAction(action, thresholdTime, repeatTime); }
