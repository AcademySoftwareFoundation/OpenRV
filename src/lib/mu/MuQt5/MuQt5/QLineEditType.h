...
class MuQt_QLineEdit : public QLineEdit
{
  ...
  public:
    ...
    void enterEvent_pub_parent(QEvent * event)  { QLineEdit::enterEvent(event); }
    ...
    void keyReleaseEvent_pub_parent(QKeyEvent * event)  { QLineEdit::keyReleaseEvent(event); }
    ...
    int metric_pub_parent(PaintDeviceMetric m) const { return QLineEdit::metric(m); }
  public:
