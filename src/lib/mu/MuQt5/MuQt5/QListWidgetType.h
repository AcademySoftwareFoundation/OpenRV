...
class MuQt_QListWidget : public QListWidget
{
  ...
  public:
    ...
    QModelIndex indexFromItem_pub(QListWidgetItem * item) const { return indexFromItem(item); }
    QModelIndex indexFromItem_pub_parent(QListWidgetItem * item) const { return QListWidget::indexFromItem(item); }
    QListWidgetItem * itemFromIndex_pub(const QModelIndex & index) const { return itemFromIndex(index); }
    QListWidgetItem * itemFromIndex_pub_parent(const QModelIndex & index) const { return QListWidget::itemFromIndex(index); }
    QList<QListWidgetItem * > items_pub(const QMimeData * data) const { return items(data); }
    QList<QListWidgetItem * > items_pub_parent(const QMimeData * data) const { return QListWidget::items(data); }
