...
//
#ifndef __MuQt5__QToolBarType__h__
#define __MuQt5__QToolBarType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        QToolBarType(Context* context, const char* name, Class* superClass = 0,
                     Class* superClass2 = 0);
    ...
    public:
        ...
        MuQt_QToolBar(Pointer muobj, const CallEnvironment*,
