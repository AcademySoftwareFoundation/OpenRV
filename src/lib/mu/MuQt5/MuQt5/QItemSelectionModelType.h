...
class QItemSelectionModelType : public Class
{
  public:
    ...
    QItemSelectionModelType(Context* context, 
           const char* name,
           Class* superClass = 0,
           Class* superClass2 = 0);
...
class MuQt_QItemSelectionModel : public QItemSelectionModel
{
  ...
  public:
    void emitSelectionChanged_pub(const QItemSelection & newSelection, const QItemSelection & oldSelection)  { emitSelectionChanged(newSelection, oldSelection); }
    void emitSelectionChanged_pub_parent(const QItemSelection & newSelection, const QItemSelection & oldSelection)  { QItemSelectionModel::emitSelectionChanged(newSelection, oldSelection); }
