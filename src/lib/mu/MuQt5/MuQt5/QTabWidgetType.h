...
class QTabWidgetType : public Class
{
  public:
    ...
    QTabWidgetType(Context* context, 
           const char* name,
           Class* superClass = 0,
           Class* superClass2 = 0);
...
class MuQt_QTabWidget : public QTabWidget
{
  ...
  public:
    ...
    void enterEvent_pub_parent(QEvent * event)  { QTabWidget::enterEvent(event); }
    ...
    int metric_pub_parent(PaintDeviceMetric m) const { return QTabWidget::metric(m); }
  public:
