...
//
#ifndef __MuQt5__QPaletteType__h__
...
namespace Mu
{
    ...
    class QPaletteType : public Class
    {
    public:
        //
        //  Types
        ...
        QPaletteType(Context* context, const char* name, Class* superClass = 0);
        virtual ~QPaletteType();
...
#endif // __MuQt5__QPaletteType__h__
