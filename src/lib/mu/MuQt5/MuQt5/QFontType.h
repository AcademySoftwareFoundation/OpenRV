...
//
#ifndef __MuQt5__QFontType__h__
#define __MuQt5__QFontType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        QFontType(Context* context, const char* name, Class* superClass = 0);
        virtual ~QFontType();
