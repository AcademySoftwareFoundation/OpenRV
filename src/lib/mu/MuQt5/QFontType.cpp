...
addSymbols(
    ...
    new Function(c, "lastResortFamily", _n_lastResortFamily0, None, Compiled, qt_QFont_lastResortFamily_string_QFont, Return, "string", Parameters, new Param(c, "this", "qt.QFont"), End),
    new Function(c, "lastResortFont", _n_lastResortFont0, None, Compiled, qt_QFont_lastResortFont_string_QFont, Return, "string", Parameters, new Param(c, "this", "qt.QFont"), End),
...
globalScope()->addSymbols(
    ...
    EndArguments);
scope()->addSymbols(
    new Function(c, "QVariant", _co_n_QVariant0, Cast, Compiled, qt_QFont_QVariant_QVariant_QVariant_QFont, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QVariant"), new Param(c, "from", "qt.QFont"), End),
    EndArguments);
