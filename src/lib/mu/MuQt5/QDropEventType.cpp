...
addSymbols(
    // enums
    // member functions
    // MISSING: QDropEvent (QDropEvent; QDropEvent this, QPointF pos, flags Qt::DropActions actions, QMimeData data, flags Qt::MouseButtons buttons, flags Qt::KeyboardModifiers modifiers, "Type" type)
    ...
    new Function(c, "keyboardModifiers", _n_keyboardModifiers0, None, Compiled, qt_QDropEvent_keyboardModifiers_int_QDropEvent, Return, "int", Parameters, new Param(c, "this", "qt.QDropEvent"), End),
    ...
    new Function(c, "mouseButtons", _n_mouseButtons0, None, Compiled, qt_QDropEvent_mouseButtons_int_QDropEvent, Return, "int", Parameters, new Param(c, "this", "qt.QDropEvent"), End),
    new Function(c, "pos", _n_pos0, None, Compiled, qt_QDropEvent_pos_QPoint_QDropEvent, Return, "qt.QPoint", Parameters, new Param(c, "this", "qt.QDropEvent"), End),
    new Function(c, "posF", _n_posF0, None, Compiled, qt_QDropEvent_posF_QPointF_QDropEvent, Return, "qt.QPointF", Parameters, new Param(c, "this", "qt.QDropEvent"), End),
