...
QBitmapType::Instance::Instance(const Class* c) : ClassInstance(c)
{
}
...
void 
QBitmapType::registerFinalizer (void* o)
{
    GC_register_finalizer(o, QBitmapType::finalizer, 0, 0, 0);
}

void 
QBitmapType::finalizer (void* obj, void* data)
{
...
Pointer qt_QBitmap_QBitmap_QBitmap_QBitmap_QPixmap(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_pixmap)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QBitmap_QBitmap_QBitmap_QBitmap_QSize(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_size)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QBitmap_QVariant_QVariant_QVariant_QBitmap(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_from)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
{
    NODE_RETURN(qt_QBitmap_QBitmap_QBitmap_QBitmap_QPixmap(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}

static NODE_IMPLEMENTATION(_n_QBitmap2, Pointer)
{
    NODE_RETURN(qt_QBitmap_QBitmap_QBitmap_QBitmap_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
}

static NODE_IMPLEMENTATION(_n_QBitmap3, Pointer)
{
    NODE_RETURN(qt_QBitmap_QBitmap_QBitmap_QBitmap_QSize(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
{
    NODE_RETURN(qt_QBitmap_QVariant_QVariant_QVariant_QBitmap(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer)));
}
...
addSymbols(
    // enums
    // member functions
    new Function(c, "QBitmap", _n_QBitmap0, None, Compiled, qt_QBitmap_QBitmap_QBitmap_QBitmap, Return, "qt.QBitmap", Parameters, new Param(c, "this", "qt.QBitmap"), End),
    new Function(c, "QBitmap", _n_QBitmap1, None, Compiled, qt_QBitmap_QBitmap_QBitmap_QBitmap_QPixmap, Return, "qt.QBitmap", Parameters, new Param(c, "this", "qt.QBitmap"), new Param(c, "pixmap", "qt.QPixmap"), End),
    new Function(c, "QBitmap", _n_QBitmap2, None, Compiled, qt_QBitmap_QBitmap_QBitmap_QBitmap_int_int, Return, "qt.QBitmap", Parameters, new Param(c, "this", "qt.QBitmap"), new Param(c, "width", "int"), new Param(c, "height", "int"), End),
    new Function(c, "QBitmap", _n_QBitmap3, None, Compiled, qt_QBitmap_QBitmap_QBitmap_QBitmap_QSize, Return, "qt.QBitmap", Parameters, new Param(c, "this", "qt.QBitmap"), new Param(c, "size", "qt.QSize"), End),
    // MISSING: QBitmap (QBitmap; QBitmap this, string fileName, "const char *" format)
    new Function(c, "clear", _n_clear0, None, Compiled, qt_QBitmap_clear_void_QBitmap, Return, "void", Parameters, new Param(c, "this", "qt.QBitmap"), End),
    new Function(c, "swap", _n_swap0, None, Compiled, qt_QBitmap_swap_void_QBitmap_QBitmap, Return, "void", Parameters, new Param(c, "this", "qt.QBitmap"), new Param(c, "other", "qt.QBitmap"), End),
    new Function(c, "transformed", _n_transformed0, None, Compiled, qt_QBitmap_transformed_QBitmap_QBitmap_QTransform, Return, "qt.QBitmap", Parameters, new Param(c, "this", "qt.QBitmap"), new Param(c, "matrix", "qt.QTransform"), End),
    // static functions
    // MISSING: fromData (QBitmap; QSize size, "const uchar *" bits, flags QImage::Format monoFormat)
    new Function(c, "fromImage", _n_fromImage0, None, Compiled, qt_QBitmap_fromImage_QBitmap_QImage_int, Return, "qt.QBitmap", Parameters, new Param(c, "image", "qt.QImage"), new Param(c, "flags", "int", Value((int)Qt::AutoColor)), End),
    EndArguments);
globalScope()->addSymbols(
    // MISSING: = (QBitmap; QBitmap this, QPixmap pixmap)
    EndArguments);
scope()->addSymbols(
    new Function(c, "QVariant", _co_n_QVariant0, Cast, Compiled, qt_QBitmap_QVariant_QVariant_QVariant_QBitmap, Return, "qt.QVariant", Parameters, new Param(c, "this", "qt.QVariant"), new Param(c, "from", "qt.QBitmap"), End),
    EndArguments);
