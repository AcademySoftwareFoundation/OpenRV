...
namespace Mu
{
    ...
    void QBitmapType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "QBitmap", _n_QBitmap1, None, Compiled, qt_QBitmap_QBitmap_QBitmap_QBitmap_QPixmap, Return, "qt.QBitmap",
                         Parameters, new Param(c, "this", "qt.QBitmap"), new Param(c, "pixmap", "qt.QPixmap"), End),
            new Function(c, "QBitmap", _n_QBitmap2, None, Compiled, qt_QBitmap_QBitmap_QBitmap_QBitmap_int_int, Return, "qt.QBitmap",
                         Parameters, new Param(c, "this", "qt.QBitmap"), new Param(c, "width", "int"), new Param(c, "height", "int"), End),
            new Function(c, "QBitmap", _n_QBitmap3, None, Compiled, qt_QBitmap_QBitmap_QBitmap_QBitmap_QSize, Return, "qt.QBitmap",
                         Parameters, new Param(c, "this", "qt.QBitmap"), new Param(c, "size", "qt.QSize"), End),
        ...
        globalScope()->addSymbols(
            ...
            EndArguments);
        scope()->addSymbols(new Function(c, "QVariant", _co_n_QVariant0, Cast, Compiled, qt_QBitmap_QVariant_QVariant_QVariant_QBitmap,
