...
Pointer qt_QModelIndex_child_QModelIndex_QModelIndex_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_row, int param_column)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
{
    NODE_RETURN(qt_QModelIndex_child_QModelIndex_QModelIndex_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
}
...
addSymbols(
    ...
    new Function(c, "child", _n_child0, None, Compiled, qt_QModelIndex_child_QModelIndex_QModelIndex_int_int, Return, "qt.QModelIndex", Parameters, new Param(c, "this", "qt.QModelIndex"), new Param(c, "row", "int"), new Param(c, "column", "int"), End),
