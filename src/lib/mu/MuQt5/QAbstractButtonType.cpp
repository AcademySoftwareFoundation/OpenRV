...
{
    if (!_env) { QAbstractButton::enterEvent(event); return; }
    MuLangContext* c = (MuLangContext*)_env->context();
...
void qt_QAbstractButton_enterEvent_void_QAbstractButton_QEvent(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_event)
{
    ...
    if (isMuQtObject(arg0)) ((MuQt_QAbstractButton*)arg0)->enterEvent_pub_parent(arg1);
    else ((MuQt_QAbstractButton*)arg0)->enterEvent_pub(arg1);
}
...
addSymbols(
    ...
    _func[25] = new MemberFunction(c, "enterEvent", _n_enterEvent0, None, Compiled, qt_QAbstractButton_enterEvent_void_QAbstractButton_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractButton"), new Param(c, "event", "qt.QEvent"), End),
    _func[26] = new MemberFunction(c, "focusNextPrevChild", _n_focusNextPrevChild0, None, Compiled, qt_QAbstractButton_focusNextPrevChild_bool_QAbstractButton_bool, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractButton"), new Param(c, "next", "bool"), End),
    _func[27] = new MemberFunction(c, "hideEvent", _n_hideEvent0, None, Compiled, qt_QAbstractButton_hideEvent_void_QAbstractButton_QHideEvent, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractButton"), new Param(c, "event", "qt.QHideEvent"), End),
    // MISSING: inputMethodEvent (void; QAbstractButton this, "QInputMethodEvent *" event) // protected
    _func[28] = new MemberFunction(c, "leaveEvent", _n_leaveEvent0, None, Compiled, qt_QAbstractButton_leaveEvent_void_QAbstractButton_QEvent, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractButton"), new Param(c, "event", "qt.QEvent"), End),
    _func[29] = new MemberFunction(c, "mouseDoubleClickEvent", _n_mouseDoubleClickEvent0, None, Compiled, qt_QAbstractButton_mouseDoubleClickEvent_void_QAbstractButton_QMouseEvent, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractButton"), new Param(c, "event", "qt.QMouseEvent"), End),
    _func[30] = new MemberFunction(c, "moveEvent", _n_moveEvent0, None, Compiled, qt_QAbstractButton_moveEvent_void_QAbstractButton_QMoveEvent, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractButton"), new Param(c, "event", "qt.QMoveEvent"), End),
    // MISSING: nativeEvent (bool; QAbstractButton this, QByteArray eventType, "void *" message, "long *" result) // protected
    _func[31] = new MemberFunction(c, "resizeEvent", _n_resizeEvent0, None, Compiled, qt_QAbstractButton_resizeEvent_void_QAbstractButton_QResizeEvent, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractButton"), new Param(c, "event", "qt.QResizeEvent"), End),
    _func[32] = new MemberFunction(c, "showEvent", _n_showEvent0, None, Compiled, qt_QAbstractButton_showEvent_void_QAbstractButton_QShowEvent, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractButton"), new Param(c, "event", "qt.QShowEvent"), End),
    _func[33] = new MemberFunction(c, "tabletEvent", _n_tabletEvent0, None, Compiled, qt_QAbstractButton_tabletEvent_void_QAbstractButton_QTabletEvent, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractButton"), new Param(c, "event", "qt.QTabletEvent"), End),
    _func[34] = new MemberFunction(c, "wheelEvent", _n_wheelEvent0, None, Compiled, qt_QAbstractButton_wheelEvent_void_QAbstractButton_QWheelEvent, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractButton"), new Param(c, "event", "qt.QWheelEvent"), End),
    // MISSING: initPainter (void; QAbstractButton this, "QPainter *" painter) // protected
    // MISSING: metric (int; QAbstractButton this, "PaintDeviceMetric" m) // protected
    // static functions
    EndArguments);
