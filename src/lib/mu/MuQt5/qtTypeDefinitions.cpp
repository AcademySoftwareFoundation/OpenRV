...
QWidgetType* addAllQTSymbols(MuLangContext* c, Module* qt)
{
    ...
    QWebEngineHistoryType* t_QWebEngineHistory = new QWebEngineHistoryType(c, "QWebEngineHistory");
    ...
    QWheelEventType* t_QWheelEvent = new QWheelEventType(c, "QWheelEvent", t_QInputEvent);
    qt->addSymbol(t_QWheelEvent);
    QBoxLayoutType* t_QBoxLayout = new QBoxLayoutType(c, "QBoxLayout", t_QLayout);
    qt->addSymbol(t_QBoxLayout);
    QHoverEventType* t_QHoverEvent = new QHoverEventType(c, "QHoverEvent", t_QInputEvent);
    ...
    QTabletEventType* t_QTabletEvent = new QTabletEventType(c, "QTabletEvent", t_QInputEvent);
    ...
    QMouseEventType* t_QMouseEvent = new QMouseEventType(c, "QMouseEvent", t_QInputEvent);
    ...
    QDesktopWidgetType* t_QDesktopWidget = new QDesktopWidgetType(c, "QDesktopWidget", t_QWidget);
