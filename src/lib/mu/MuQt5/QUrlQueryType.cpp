...
QUrlQueryType::Instance::Instance(const Class* c) : ClassInstance(c)
{
}
...
void 
QUrlQueryType::registerFinalizer (void* o)
{
    GC_register_finalizer(o, QUrlQueryType::finalizer, 0, 0, 0);
}

void 
QUrlQueryType::finalizer (void* obj, void* data)
{
...
void qt_QUrlQuery_addQueryItem_void_QUrlQuery_string_string(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_key, Pointer param_value)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QUrlQuery_allQueryItemValues_stringBSB_ESB__QUrlQuery_string_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_key, int param_encoding)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
Pointer qt_QUrlQuery_queryItemValue_string_QUrlQuery_string_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_key, int param_encoding)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QUrlQuery& arg0 = getqtype<QUrlQueryType>(param_this);
    const QString  arg1 = qstring(param_key);
...
{
    NODE_RETURN(qt_QUrlQuery_allQueryItemValues_stringBSB_ESB__QUrlQuery_string_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int)));
}

static NODE_IMPLEMENTATION(_n_clear0, void)
{
    qt_QUrlQuery_clear_void_QUrlQuery(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer));
}
...
{
    NODE_RETURN(qt_QUrlQuery_queryItemValue_string_QUrlQuery_string_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int)));
}
...
addSymbols(
    ...
    new Function(c, "allQueryItemValues", _n_allQueryItemValues0, None, Compiled, qt_QUrlQuery_allQueryItemValues_stringBSB_ESB__QUrlQuery_string_int, Return, "string[]", Parameters, new Param(c, "this", "qt.QUrlQuery"), new Param(c, "key", "string"), new Param(c, "encoding", "int", Value((int)QUrl::PrettyDecoded)), End),
    new Function(c, "clear", _n_clear0, None, Compiled, qt_QUrlQuery_clear_void_QUrlQuery, Return, "void", Parameters, new Param(c, "this", "qt.QUrlQuery"), End),
    new Function(c, "hasQueryItem", _n_hasQueryItem0, None, Compiled, qt_QUrlQuery_hasQueryItem_bool_QUrlQuery_string, Return, "bool", Parameters, new Param(c, "this", "qt.QUrlQuery"), new Param(c, "key", "string"), End),
    new Function(c, "isEmpty", _n_isEmpty0, None, Compiled, qt_QUrlQuery_isEmpty_bool_QUrlQuery, Return, "bool", Parameters, new Param(c, "this", "qt.QUrlQuery"), End),
    new Function(c, "query", _n_query0, None, Compiled, qt_QUrlQuery_query_string_QUrlQuery_int, Return, "string", Parameters, new Param(c, "this", "qt.QUrlQuery"), new Param(c, "encoding", "int", Value((int)QUrl::PrettyDecoded)), End),
    new Function(c, "queryItemValue", _n_queryItemValue0, None, Compiled, qt_QUrlQuery_queryItemValue_string_QUrlQuery_string_int, Return, "string", Parameters, new Param(c, "this", "qt.QUrlQuery"), new Param(c, "key", "string"), new Param(c, "encoding", "int", Value((int)QUrl::PrettyDecoded)), End),
    // MISSING: queryItems ("QList<QPair<QString, QString> >"; QUrlQuery this, flags QUrl::ComponentFormattingOptions encoding)
    // MISSING: queryPairDelimiter ("QChar"; QUrlQuery this)
    // MISSING: queryValueDelimiter ("QChar"; QUrlQuery this)
    new Function(c, "removeAllQueryItems", _n_removeAllQueryItems0, None, Compiled, qt_QUrlQuery_removeAllQueryItems_void_QUrlQuery_string, Return, "void", Parameters, new Param(c, "this", "qt.QUrlQuery"), new Param(c, "key", "string"), End),
    new Function(c, "removeQueryItem", _n_removeQueryItem0, None, Compiled, qt_QUrlQuery_removeQueryItem_void_QUrlQuery_string, Return, "void", Parameters, new Param(c, "this", "qt.QUrlQuery"), new Param(c, "key", "string"), End),
    new Function(c, "setQuery", _n_setQuery0, None, Compiled, qt_QUrlQuery_setQuery_void_QUrlQuery_string, Return, "void", Parameters, new Param(c, "this", "qt.QUrlQuery"), new Param(c, "queryString", "string"), End),
    // MISSING: setQueryDelimiters (void; QUrlQuery this, "QChar" valueDelimiter, "QChar" pairDelimiter)
    // MISSING: setQueryItems (void; QUrlQuery this, "const QList<QPair<QString, QString> > &" query)
    new Function(c, "swap", _n_swap0, None, Compiled, qt_QUrlQuery_swap_void_QUrlQuery_QUrlQuery, Return, "void", Parameters, new Param(c, "this", "qt.QUrlQuery"), new Param(c, "other", "qt.QUrlQuery"), End),
    new Function(c, "toString", _n_toString0, None, Compiled, qt_QUrlQuery_toString_string_QUrlQuery_int, Return, "string", Parameters, new Param(c, "this", "qt.QUrlQuery"), new Param(c, "encoding", "int", Value((int)QUrl::PrettyDecoded)), End),
    // static functions
    // MISSING: defaultQueryPairDelimiter ("QChar"; )
    // MISSING: defaultQueryValueDelimiter ("QChar"; )
    EndArguments);
globalScope()->addSymbols(
    new Function(c, "!=", _n_operatorBang_EQ_0, Op, Compiled, qt_QUrlQuery_operatorBang_EQ__bool_QUrlQuery_QUrlQuery, Return, "bool", Parameters, new Param(c, "this", "qt.QUrlQuery"), new Param(c, "other", "qt.QUrlQuery"), End),
    // MISSING: = (QUrlQuery; QUrlQuery this, QUrlQuery other)
    // MISSING: = (QUrlQuery; QUrlQuery this, QUrlQuery other)
    new Function(c, "==", _n_operatorEQ_EQ_0, Op, Compiled, qt_QUrlQuery_operatorEQ_EQ__bool_QUrlQuery_QUrlQuery, Return, "bool", Parameters, new Param(c, "this", "qt.QUrlQuery"), new Param(c, "other", "qt.QUrlQuery"), End),
    EndArguments);
scope()->addSymbols(
    EndArguments);
