...
static Pointer
HintWidget_HintWidget(Thread& NODE_THREAD, Pointer obj, Pointer tuple, Pointer p)
{
...
static void
setWidget_void_HintWidget_Widget(Thread& NODE_THREAD, Pointer obj, Pointer wobj)
{
    ClassInstance* self = reinterpret_cast<ClassInstance*>(obj);
...
static void
setContentSize_void_HintWidget_tuple(Thread& NODE_THREAD, Pointer obj, Pointer tuple)
{
    ClassInstance* self = reinterpret_cast<ClassInstance*>(obj);
    HintWidget* w = object<HintWidget>(self);
    ClassInstance* i = reinterpret_cast<ClassInstance*>(tuple);
...
{
    NODE_RETURN( HintWidget_HintWidget(NODE_THREAD,
                               NODE_ARG(0, Pointer),
                               NODE_ARG(1, Pointer),
                               NODE_ARG(2, Pointer)));
}
...
{
    setWidget_void_HintWidget_Widget(NODE_THREAD,
                                     NODE_ARG(0, Pointer),
                                     NODE_ARG(1, Pointer));
}
...
{
    setContentSize_void_HintWidget_tuple(NODE_THREAD,
                                         NODE_ARG(0, Pointer),
                                         NODE_ARG(1, Pointer));
}
...
HintWidgetType::load()
{
    ...
    addSymbols(new Function(c, "__allocate", BaseFunctions::classAllocate, None,
               ...
               new Function(c, tn, construct, None,
                            Compiled, HintWidget_HintWidget,
                            Return, ftn,
                            Parameters,
               ...
               new Function(c, "setWidget", Mu::setWidget, None,
                            Compiled, setWidget_void_HintWidget_Widget,
                            Return, "void",
                            Parameters,
                            new Param(c, "this", ftn),
               ...
               new Function(c, "setContentSize", Mu::setContentSize, None,
                            Compiled, setContentSize_void_HintWidget_tuple,
                            Return, "void",
                            Parameters,
                            new Param(c, "this", ftn),
                            new Param(c, "size", "(int,int)"),
