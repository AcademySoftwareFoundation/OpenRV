...
addSymbols(
    ...
    // MISSING: connectToHost (void; QAbstractSocket this, string hostName, "quint16" port, flags QIODevice::OpenModeFlag openMode, flags QAbstractSocket::NetworkLayerProtocol protocol)
    // MISSING: connectToHost (void; QAbstractSocket this, QHostAddress address, "quint16" port, flags QIODevice::OpenModeFlag openMode)
    ...
    // MISSING: setSocketDescriptor (bool; QAbstractSocket this, "qintptr" socketDescriptor, flags QAbstractSocket::SocketState socketState, flags QIODevice::OpenModeFlag openMode)
    ...
    _func[7] = new MemberFunction(c, "atEnd", _n_atEnd0, None, Compiled, qt_QAbstractSocket_atEnd_bool_QAbstractSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[8] = new MemberFunction(c, "bytesAvailable", _n_bytesAvailable0, None, Compiled, qt_QAbstractSocket_bytesAvailable_int64_QAbstractSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[9] = new MemberFunction(c, "bytesToWrite", _n_bytesToWrite0, None, Compiled, qt_QAbstractSocket_bytesToWrite_int64_QAbstractSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[10] = new MemberFunction(c, "canReadLine", _n_canReadLine0, None, Compiled, qt_QAbstractSocket_canReadLine_bool_QAbstractSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[11] = new MemberFunction(c, "close", _n_close0, None, Compiled, qt_QAbstractSocket_close_void_QAbstractSocket, Return, "void", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[12] = new MemberFunction(c, "isSequential", _n_isSequential0, None, Compiled, qt_QAbstractSocket_isSequential_bool_QAbstractSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[13] = new MemberFunction(c, "waitForBytesWritten", _n_waitForBytesWritten0, None, Compiled, qt_QAbstractSocket_waitForBytesWritten_bool_QAbstractSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    _func[14] = new MemberFunction(c, "waitForReadyRead", _n_waitForReadyRead0, None, Compiled, qt_QAbstractSocket_waitForReadyRead_bool_QAbstractSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "msecs", "int", Value((int)30000)), End),
    ...
    _func[15] = new MemberFunction(c, "open", _n_open0, None, Compiled, qt_QAbstractSocket_open_bool_QAbstractSocket_int, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "mode", "int"), End),
    _func[16] = new MemberFunction(c, "pos", _n_pos0, None, Compiled, qt_QAbstractSocket_pos_int64_QAbstractSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[17] = new MemberFunction(c, "reset", _n_reset0, None, Compiled, qt_QAbstractSocket_reset_bool_QAbstractSocket, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    _func[18] = new MemberFunction(c, "seek", _n_seek0, None, Compiled, qt_QAbstractSocket_seek_bool_QAbstractSocket_int64, Return, "bool", Parameters, new Param(c, "this", "qt.QAbstractSocket"), new Param(c, "pos", "int64"), End),
    _func[19] = new MemberFunction(c, "size", _n_size0, None, Compiled, qt_QAbstractSocket_size_int64_QAbstractSocket, Return, "int64", Parameters, new Param(c, "this", "qt.QAbstractSocket"), End),
    // static functions
    EndArguments);
