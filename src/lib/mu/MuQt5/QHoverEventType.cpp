...
addSymbols(
    // enums
    // member functions
    // MISSING: QHoverEvent (QHoverEvent; QHoverEvent this, "Type" type, QPointF pos, QPointF oldPos, flags Qt::KeyboardModifiers modifiers)
    ...
    new Function(c, "pos", _n_pos0, None, Compiled, qt_QHoverEvent_pos_QPoint_QHoverEvent, Return, "qt.QPoint", Parameters, new Param(c, "this", "qt.QHoverEvent"), End),
    new Function(c, "posF", _n_posF0, None, Compiled, qt_QHoverEvent_posF_QPointF_QHoverEvent, Return, "qt.QPointF", Parameters, new Param(c, "this", "qt.QHoverEvent"), End),
    // static functions
    EndArguments);
