...
struct SpyData
{
    SpyData(SignalSpy* s, const Function* f) : spy(s), func(f) {}
    SignalSpy* spy;
    const Function* func;
};
...
static const char*
signalName(const string& method, vector<char>& buffer, vector<QMetaMethod>& methods)
{
    //
...
static void
findSignal(const QMetaObject* metaObject, const Function* F, vector<QMetaMethod>& methods)
{
...
static void
findSignalByName(const QMetaObject* metaObject,
                 const char* name,
                 const Function* F,
...
static void
showSignals(const QMetaObject* metaObject, const Function* F, ostream& o)
{
    for (size_t i = 0; i < metaObject->methodCount(); i++)
    {
        QMetaMethod method = metaObject->method(i);
...
static NODE_IMPLEMENTATION(connect, int)
{
    ...
    if (!sender) throw NilArgumentException(NODE_THREAD);
    ...
    if (ok && !methods.empty())
    {
        ...
        {
            if (i != 1) str << ",";
            if (const char* name = qtType(Fsig->argType(i))) str << name;
        }
    ...
    else
    {
        ...
        ostringstream str;
        str << "qt.connect: function "; Fslot->output(str);

        if (methods.empty())
        {
            str << " cannot be connected because "; Fsig->output(str);
            str << " is not a signal";
        ...
        {
            str << " is incompatible with signal "; Fsig->output(str);
        }
...
static NODE_IMPLEMENTATION(connect2, int)
{
    ...
    if (inName.find('(') == string::npos)
    {
        ...
        if (methods.size() > 0) inName = methods[0].methodSignature().constData();
    }

    SignalSpy* spy = new SignalSpy(sender, 
                                   signalName(inName.c_str(), nameBuffer, methods), 
                                   Fslot, 
                                   process);
...
static NODE_IMPLEMENTATION(loadUIFile, Pointer)
{
    ...
    // Note that we cannot instantiate a QWebEngineView widget via a .ui file 
    // to conform with LGPL licensing.
    // Because the Qt QWebEngineView plugin is GPL due to its QtDesigner dependency. 
    // So to work around this inconvenience we will manually replace 'webView' 
    // QWidget with QWebEngineView if any.
    if ( w )
    {
...
static NODE_IMPLEMENTATION(qinvoke, bool)
{
    ...
    if (!arg0 || !name) throw NilArgumentException(NODE_THREAD);

    const QMetaObject* metaObject = arg0->metaObject();
    const int          index      = metaObject->indexOfMethod(name->c_str());

    if (index == -1) throw BadArgumentException(NODE_THREAD);
    ...
    {
      default:
      case 0: connectionType = Qt::AutoConnection; break;
      case 1: connectionType = Qt::DirectConnection; break;
      case 2: connectionType = Qt::QueuedConnection; break;
      case 3: connectionType = Qt::BlockingQueuedConnection; break;
      case 4: connectionType = Qt::UniqueConnection; break;
    }
...
qtModule::load()
{
    ...
    //
    //  Register types so that SignalSpy works (see qtUtils.h for DECLARE macros)
    //
    ...
    qt->addSymbols(
                   ...
                   new SymbolicConstant(c, "AlignHorizontal_Mask", "int", Value(int(Qt::AlignLeft | Qt::AlignRight | Qt::AlignHCenter | Qt::AlignJustify | Qt::AlignAbsolute))),
                   ...
                   new SymbolicConstant(c, "AA_MacPluginApplication", "int", Value(int(5))),
                   ...
                   new SymbolicConstant(c, "KeepAspectRatioByExpanding", "int", Value(int(2))),
                   ...
                   new SymbolicConstant(c, "BottomRightCorner", "int", Value(int(0x00003))),
                   ...
                   //new SymbolicConstant(c, "SystemLocaleShortDate", "int", Value(int(?))),
                   //new SymbolicConstant(c, "SystemLocaleLongDate", "int", Value(int(?))),
                   //new SymbolicConstant(c, "DefaultLocaleShortDate", "int", Value(int(?))),
                   ...
                   new SymbolicConstant(c, "LeftDockWidgetArea", "int", Value(int(0x1))),
                   ...
                   new SymbolicConstant(c, "TargetMoveAction", "int", Value(int(0x8002))),
                   ...
                   new SymbolicConstant(c, "AvoidDither", "int", Value(int(0x00000080))),
                   ...
                   new SymbolicConstant(c, "IntersectsItemBoundingRect", "int", Value(int(0x3))),
                   new Alias(c, "Key", "int"),
                   ...
                   new SymbolicConstant(c, "Key_Cancel", "int", Value(int(0x01020001))),
                   ...
                   new SymbolicConstant(c, "GroupSwitchModifier", "int", Value(int(0x40000000))),
                   ...
                   new SymbolicConstant(c, "SHIFT", "int", Value(int(Qt::ShiftModifier))),
                   ...
                   new SymbolicConstant(c, "UNICODE_ACCEL", "int", Value(int(0x00000000))),
                   ...
                   new SymbolicConstant(c, "SquareCap", "int", Value(int(Qt::FlatCap))),
                   ...
                   new SymbolicConstant(c, "ApplicationShortcut", "int", Value(int(2))),
                   ...
                   new SymbolicConstant(c, "TextSingleLine", "int", Value(int(0x0100))),
                   ...
                   new SymbolicConstant(c, "TextJustificationForced", "int", Value(int(0x10000))),
                   ...
                   new SymbolicConstant(c, "TextEditorInteraction", "int", Value(int(Qt::TextSelectableByMouse | Qt::TextSelectableByKeyboard | Qt::TextEditable))),
                   new SymbolicConstant(c, "TextBrowserInteraction", "int", Value(int(Qt::TextSelectableByMouse | Qt::LinksAccessibleByMouse | Qt::LinksAccessibleByKeyboard))),
                   ...
                   new SymbolicConstant(c, "ToolButtonTextUnderIcon", "int", Value(int(3))),
                   new Alias(c, "TransformationMode", "int"),
                   new SymbolicConstant(c, "FastTransformation", "int", Value(int(0))),
                   new SymbolicConstant(c, "SmoothTransformation", "int", Value(int(1))),
                   ...
                   new SymbolicConstant(c, "WA_MacFrameworkScaled", "int", Value(int(117))),
                   ...
                   new SymbolicConstant(c, "WindowActive", "int", Value(int(0x00000008))),
                   ...
                   new SymbolicConstant(c, "WindowMinMaxButtonsHint", "int", Value(int(Qt::WindowMinimizeButtonHint | Qt::WindowMaximizeButtonHint))),
    ...
    addSymbols( qt,
                ...
                new Function(c, "connect", Mu::connect, None,
                             Return, "int",
                             Parameters,
                             new Param(c, "sender", "qt.QObject"),
                             new Param(c, "signal", "?function"),
                             new Param(c, "callback", "?function"),
                             End),

                new Function(c, "connect", Mu::connect2, None,
                             Return, "int",
                             Parameters,
                             new Param(c, "sender", "qt.QObject"),
                ...
                new Function(c, "exists", Mu::qobjectExists, None,
                             Return, "bool",
                             Parameters,
                             new Param(c, "qobj", "qt.QObject"),
                             End),

                new Function(c, "invoke", Mu::qinvoke, None,
                             Return, "bool",
                             Args, "qt.QObject", "int", "string",
                             Optional, "?varargs",
                             Maximum, 6,
                             End),
    ...
    addSymbol( new Function(c, "loadUIFile", Mu::loadUIFile, None,
                             Return, "qt.QObject",
                             Parameters,
    ...
    globalScope()->addSymbols( 
                              new Function(c, "==", Mu::qobjectEquality, Op,
                                            Return, "bool",
                                            Parameters,
                                            new Param(c, "a", "qt.QObject"),
                                            new Param(c, "b", "qt.QObject"),
                                            End),
                               
                               new Function(c, "!=", Mu::qobjectInequality, Op,
                                            Return, "bool",
                                            Parameters,
                                            new Param(c, "a", "qt.QObject"),
                                            new Param(c, "b", "qt.QObject"),
                              ...
                              new Function(c, "==", Mu::qobjectEquality, Op,
                                            Return, "bool",
                                            Parameters,
                                            new Param(c, "a", "qt.QStandardItem"),
                                            new Param(c, "b", "qt.QStandardItem"),
                                            End),
                              ...
                              new Function(c, "==", Mu::qobjectEquality, Op,
                                            Return, "bool",
                                            Parameters,
                                            new Param(c, "a", "qt.QListWidgetItem"),
                                            new Param(c, "b", "qt.QListWidgetItem"),
                                            End),
                              ...
                              new Function(c, "==", Mu::qobjectEquality, Op,
                                            Return, "bool",
                                            Parameters,
                                            new Param(c, "a", "qt.QTreeWidgetItem"),
                                            new Param(c, "b", "qt.QTreeWidgetItem"),
                                            End),
                              ...
                              new Function(c, "==", Mu::qobjectEquality, Op,
                                            Return, "bool",
                                            Parameters,
                                            new Param(c, "a", "qt.QTableWidgetItem"),
                                            new Param(c, "b", "qt.QTableWidgetItem"),
                                            End),
