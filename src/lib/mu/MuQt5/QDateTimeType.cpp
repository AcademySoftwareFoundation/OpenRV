...
Pointer qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_date, Pointer param_time, int param_spec, int param_offsetSeconds)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QDate  arg1 = getqtype<QDateType>(param_date);
    const QTime  arg2 = getqtype<QTimeType>(param_time);
...
Pointer qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_date, Pointer param_time, int param_spec)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    const QDate  arg1 = getqtype<QDateType>(param_date);
    const QTime  arg2 = getqtype<QTimeType>(param_time);
...
Pointer qt_QDateTime_fromMSecsSinceEpoch_QDateTime_int64_int_int(Mu::Thread& NODE_THREAD, int64 param_msecs, int param_spec, int param_offsetSeconds)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    qint64 arg0 = (int64)(param_msecs);
    Qt::TimeSpec arg1 = (Qt::TimeSpec)(param_spec);
...
Pointer qt_QDateTime_fromSecsSinceEpoch_QDateTime_int64_int_int(Mu::Thread& NODE_THREAD, int64 param_secs, int param_spec, int param_offsetSeconds)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
...
{
    NODE_RETURN(qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer), NODE_ARG(3, int), NODE_ARG(4, int)));
}

static NODE_IMPLEMENTATION(_n_QDateTime4, Pointer)
{
    NODE_RETURN(qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer), NODE_ARG(3, int)));
}
...
{
    NODE_RETURN(qt_QDateTime_fromMSecsSinceEpoch_QDateTime_int64_int_int(NODE_THREAD, NODE_ARG(0, int64), NODE_ARG(1, int), NODE_ARG(2, int)));
}
...
{
    NODE_RETURN(qt_QDateTime_fromSecsSinceEpoch_QDateTime_int64_int_int(NODE_THREAD, NODE_ARG(0, int64), NODE_ARG(1, int), NODE_ARG(2, int)));
}
...
addSymbols(
    ...
    // MISSING: QDateTime (QDateTime; QDateTime this, QDateTime other)
    new Function(c, "QDateTime", _n_QDateTime2, None, Compiled, qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime_QTimeZone, Return, "qt.QDateTime", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "date", "qt.QDate"), new Param(c, "time", "qt.QTime"), new Param(c, "timeZone", "qt.QTimeZone"), End),
    new Function(c, "QDateTime", _n_QDateTime3, None, Compiled, qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime_int_int, Return, "qt.QDateTime", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "date", "qt.QDate"), new Param(c, "time", "qt.QTime"), new Param(c, "spec", "int"), new Param(c, "offsetSeconds", "int"), End),
    new Function(c, "QDateTime", _n_QDateTime4, None, Compiled, qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime_int, Return, "qt.QDateTime", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "date", "qt.QDate"), new Param(c, "time", "qt.QTime"), new Param(c, "spec", "int", Value((int)Qt::LocalTime)), End),
    new Function(c, "QDateTime", _n_QDateTime5, None, Compiled, qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate, Return, "qt.QDateTime", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "date", "qt.QDate"), End),
    new Function(c, "QDateTime", _n_QDateTime6, None, Compiled, qt_QDateTime_QDateTime_QDateTime_QDateTime, Return, "qt.QDateTime", Parameters, new Param(c, "this", "qt.QDateTime"), End),
    ...
    new Function(c, "setOffsetFromUtc", _n_setOffsetFromUtc0, None, Compiled, qt_QDateTime_setOffsetFromUtc_void_QDateTime_int, Return, "void", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "offsetSeconds", "int"), End),
    ...
    new Function(c, "setTimeSpec", _n_setTimeSpec0, None, Compiled, qt_QDateTime_setTimeSpec_void_QDateTime_int, Return, "void", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "spec", "int"), End),
    ...
    new Function(c, "toString", _n_toString0, None, Compiled, qt_QDateTime_toString_string_QDateTime_string, Return, "string", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "format", "string"), End),
    ...
    new Function(c, "toString", _n_toString2, None, Compiled, qt_QDateTime_toString_string_QDateTime_string_QCalendar, Return, "string", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "format", "string"), new Param(c, "cal", "qt.QCalendar"), End),
    ...
    new Function(c, "toTimeSpec", _n_toTimeSpec0, None, Compiled, qt_QDateTime_toTimeSpec_QDateTime_QDateTime_int, Return, "qt.QDateTime", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "spec", "int"), End),
    ...
    // static functions
    new Function(c, "currentDateTime", _n_currentDateTime0, None, Compiled, qt_QDateTime_currentDateTime_QDateTime, Return, "qt.QDateTime", End),
    ...
    new Function(c, "fromMSecsSinceEpoch", _n_fromMSecsSinceEpoch0, None, Compiled, qt_QDateTime_fromMSecsSinceEpoch_QDateTime_int64, Return, "qt.QDateTime", Parameters, new Param(c, "msecs", "int64"), End),
    new Function(c, "fromMSecsSinceEpoch", _n_fromMSecsSinceEpoch1, None, Compiled, qt_QDateTime_fromMSecsSinceEpoch_QDateTime_int64_int_int, Return, "qt.QDateTime", Parameters, new Param(c, "msecs", "int64"), new Param(c, "spec", "int"), new Param(c, "offsetSeconds", "int", Value((int)0)), End),
    new Function(c, "fromMSecsSinceEpoch", _n_fromMSecsSinceEpoch2, None, Compiled, qt_QDateTime_fromMSecsSinceEpoch_QDateTime_int64_QTimeZone, Return, "qt.QDateTime", Parameters, new Param(c, "msecs", "int64"), new Param(c, "timeZone", "qt.QTimeZone"), End),
    // MISSING: fromNSDate (QDateTime; "const NSDate *" date)
    new Function(c, "fromSecsSinceEpoch", _n_fromSecsSinceEpoch0, None, Compiled, qt_QDateTime_fromSecsSinceEpoch_QDateTime_int64_int_int, Return, "qt.QDateTime", Parameters, new Param(c, "secs", "int64"), new Param(c, "spec", "int", Value((int)Qt::LocalTime)), new Param(c, "offsetSeconds", "int", Value((int)0)), End),
    new Function(c, "fromSecsSinceEpoch", _n_fromSecsSinceEpoch1, None, Compiled, qt_QDateTime_fromSecsSinceEpoch_QDateTime_int64_QTimeZone, Return, "qt.QDateTime", Parameters, new Param(c, "secs", "int64"), new Param(c, "timeZone", "qt.QTimeZone"), End),
    ...
    new Function(c, "fromString", _n_fromString2, None, Compiled, qt_QDateTime_fromString_QDateTime_string_string_QCalendar, Return, "qt.QDateTime", Parameters, new Param(c, "string", "string"), new Param(c, "format", "string"), new Param(c, "cal", "qt.QCalendar"), End),
    EndArguments);
globalScope()->addSymbols(
    // MISSING: = (QDateTime; QDateTime this, QDateTime other)
    new Function(c, "!=", _n_operatorBang_EQ_0, Op, Compiled, qt_QDateTime_operatorBang_EQ__bool_QDateTime_QDateTime, Return, "bool", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "other", "qt.QDateTime"), End),
    new Function(c, "<", _n_operatorLT_0, Op, Compiled, qt_QDateTime_operatorLT__bool_QDateTime_QDateTime, Return, "bool", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "other", "qt.QDateTime"), End),
    new Function(c, "<=", _n_operatorLT_EQ_0, Op, Compiled, qt_QDateTime_operatorLT_EQ__bool_QDateTime_QDateTime, Return, "bool", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "other", "qt.QDateTime"), End),
    new Function(c, "==", _n_operatorEQ_EQ_0, Op, Compiled, qt_QDateTime_operatorEQ_EQ__bool_QDateTime_QDateTime, Return, "bool", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "other", "qt.QDateTime"), End),
    new Function(c, ">", _n_operatorGT_0, Op, Compiled, qt_QDateTime_operatorGT__bool_QDateTime_QDateTime, Return, "bool", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "other", "qt.QDateTime"), End),
    new Function(c, ">=", _n_operatorGT_EQ_0, Op, Compiled, qt_QDateTime_operatorGT_EQ__bool_QDateTime_QDateTime, Return, "bool", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "other", "qt.QDateTime"), End),
    EndArguments);
scope()->addSymbols(
    EndArguments);
