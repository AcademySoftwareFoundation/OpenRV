...
namespace Mu
{
    ...
    Pointer qt_QDateTime_fromSecsSinceEpoch_QDateTime_int64_int_int(
        Mu::Thread& NODE_THREAD, int64 param_secs, int param_spec,
        int param_offsetSeconds)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        ...
        int arg2 = (int)(param_offsetSeconds);
        return makeqtype<QDateTimeType>(
            c, QDateTime::fromSecsSinceEpoch(arg0, arg1, arg2), "qt.QDateTime");
    }
    ...
    {
        NODE_RETURN(qt_QDateTime_fromSecsSinceEpoch_QDateTime_int64_int_int(
            NODE_THREAD, NODE_ARG(0, int64), NODE_ARG(1, int),
            NODE_ARG(2, int)));
    }
    ...
    void QDateTimeType::load()
    {
        ...
        addSymbols(
            ...
            new Function(
                c, "QDateTime", _n_QDateTime4, None, Compiled,
                qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime_QTimeZone,
                Return, "qt.QDateTime", Parameters,
                new Param(c, "this", "qt.QDateTime"),
                new Param(c, "date", "qt.QDate"),
            ...
            new Function(
                c, "fromMSecsSinceEpoch", _n_fromMSecsSinceEpoch2, None,
                Compiled,
            ...
            new Function(
                ...
                qt_QDateTime_fromSecsSinceEpoch_QDateTime_int64_int_int, Return,
                "qt.QDateTime", Parameters, new Param(c, "secs", "int64"),
                new Param(c, "spec", "int", Value((int)Qt::LocalTime)),
                new Param(c, "offsetSeconds", "int", Value((int)0)), End),
            new Function(
