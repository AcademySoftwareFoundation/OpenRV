...
void qt_QDateTime_setTime_t_void_QDateTime_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_seconds)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QDateTime arg0 = getqtype<QDateTimeType>(param_this);
...
int qt_QDateTime_toTime_t_int_QDateTime(Mu::Thread& NODE_THREAD, Pointer param_this)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    QDateTime arg0 = getqtype<QDateTimeType>(param_this);
...
Pointer qt_QDateTime_fromTime_t_QDateTime_int(Mu::Thread& NODE_THREAD, int param_seconds)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    uint arg0 = (int)(param_seconds);
    return makeqtype<QDateTimeType>(c,QDateTime::fromTime_t(arg0),"qt.QDateTime");
}

Pointer qt_QDateTime_fromTime_t_QDateTime_int_int_int(Mu::Thread& NODE_THREAD, int param_seconds, int param_spec, int param_offsetSeconds)
{
    MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
    uint arg0 = (int)(param_seconds);
    Qt::TimeSpec arg1 = (Qt::TimeSpec)(param_spec);
    int arg2 = (int)(param_offsetSeconds);
    return makeqtype<QDateTimeType>(c,QDateTime::fromTime_t(arg0, arg1, arg2),"qt.QDateTime");
}
...
{
    qt_QDateTime_setTime_t_void_QDateTime_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int));
}
...
{
    NODE_RETURN(qt_QDateTime_toTime_t_int_QDateTime(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
}
...
{
    NODE_RETURN(qt_QDateTime_fromTime_t_QDateTime_int(NODE_THREAD, NODE_ARG(0, int)));
}

static NODE_IMPLEMENTATION(_n_fromTime_t1, Pointer)
{
    NODE_RETURN(qt_QDateTime_fromTime_t_QDateTime_int_int_int(NODE_THREAD, NODE_ARG(0, int), NODE_ARG(1, int), NODE_ARG(2, int)));
}
...
addSymbols(
    ...
    new Function(c, "QDateTime", _n_QDateTime1, None, Compiled, qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate, Return, "qt.QDateTime", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "date", "qt.QDate"), End),
    new Function(c, "QDateTime", _n_QDateTime2, None, Compiled, qt_QDateTime_QDateTime_QDateTime_QDateTime_QDate_QTime_int, Return, "qt.QDateTime", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "date", "qt.QDate"), new Param(c, "time", "qt.QTime"), new Param(c, "spec", "int", Value((int)Qt::LocalTime)), End),
    ...
    new Function(c, "setTime_t", _n_setTime_t0, None, Compiled, qt_QDateTime_setTime_t_void_QDateTime_int, Return, "void", Parameters, new Param(c, "this", "qt.QDateTime"), new Param(c, "seconds", "int"), End),
    ...
    new Function(c, "toTime_t", _n_toTime_t0, None, Compiled, qt_QDateTime_toTime_t_int_QDateTime, Return, "int", Parameters, new Param(c, "this", "qt.QDateTime"), End),
    ...
    new Function(c, "fromTime_t", _n_fromTime_t0, None, Compiled, qt_QDateTime_fromTime_t_QDateTime_int, Return, "qt.QDateTime", Parameters, new Param(c, "seconds", "int"), End),
    new Function(c, "fromTime_t", _n_fromTime_t1, None, Compiled, qt_QDateTime_fromTime_t_QDateTime_int_int_int, Return, "qt.QDateTime", Parameters, new Param(c, "seconds", "int"), new Param(c, "spec", "int"), new Param(c, "offsetSeconds", "int", Value((int)0)), End),
    // MISSING: fromTime_t (QDateTime; int seconds, "const QTimeZone &" timeZone)
    EndArguments);
