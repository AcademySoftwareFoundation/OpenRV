...
// ajg2 - Is there some way to warn via the code that getuid, etc. returns 0 on win32?
#if defined _MSC_VER
#include <direct.h>
#else
#include <sys/file.h>
...
Module*
SystemModule::init(const char *name, Context *context)
{
...
//                 SYMCONST(O_EXLOCK),
                ...
                SYMCONST(SOCK_STREAM),
                SYMCONST(SOCK_DGRAM),
                SYMCONST(SOCK_RAW),
                SYMCONST(SOCK_SEQPACKET),
                SYMCONST(SOCK_RDM),
    ...
    addSymbols( new Function(c, "getenv", SystemModule::getenv, None,
                             Args, "string",
                             Return, "string",
                             End),

                new Function(c, "getenv", SystemModule::getenv2, None,
                             Args, "string", "string",
                             Return, "string",
                             End),

                new Function(c, "getenv", SystemModule::getenv3, None,
                             Return, "[string]",
                             End),

                new Function(c, "unsetenv", SystemModule::unsetenv, None,
                             Args, "string",
                             Return, "void",
                             End),

                new Function(c, "putenv", SystemModule::putenv, None,
                             Args, "string",
                             Return, "void",
                             End),

                new Function(c, "setenv", SystemModule::setenv, None,
                             Args, "string", "string", "bool",
                             Return, "void",
                             End),

                new Function(c, "getcwd", SystemModule::getcwd, None,
                             Return, "string",
                             End),

                new Function(c, "ctermid", SystemModule::ctermid, None,
                             Return, "string",
                             End),

                new Function(c, "chdir", SystemModule::chdir, None,
                             Args, "string",
                             Return, "void",
                             End),

                new Function(c, "getuid", SystemModule::getuid, None,
                             Return, "int",
                             End),

                new Function(c, "geteuid", SystemModule::geteuid, None,
                             Return, "int",
                             End),

                new Function(c, "getgid", SystemModule::getgid, None,
                             Return, "int",
                             End),

                new Function(c, "getegid", SystemModule::getegid, None,
                             Return, "int",
                             End),

                new Function(c, "getpid", SystemModule::getpid, None,
                             Return, "int",
                             End),

                new Function(c, "getppid", SystemModule::getppid, None,
                             Return, "int",
                             End),

                new Function(c, "getpgid", SystemModule::getpgid, None,
                             Args, "int",
                             Return, "int",
                             End),

                new Function(c, "getpgrp", SystemModule::getpgrp, None,
                             Return, "int",
                             End),

                new Function(c, "setuid", SystemModule::setuid, None,
                             Args, "int",
                             Return, "void",
                             End),

                new Function(c, "seteuid", SystemModule::seteuid, None,
                             Args, "int",
                             Return, "void",
                             End),

                new Function(c, "setgid", SystemModule::setgid, None,
                             Args, "int",
                             Return, "void",
                             End),

                new Function(c, "setegid", SystemModule::setegid, None,
                             Args, "int",
                             Return, "void",
                             End),

                new Function(c, "setsid", SystemModule::setsid, None,
                             Return, "int",
                             End),

                new Function(c, "setpgid", SystemModule::setpgid, None,
                             Args, "int", "int",
                             Return, "void",
                             End),

                new Function(c, "setreuid", SystemModule::setreuid, None,
                             Args, "int", "int",
                             Return, "void",
                             End),

                new Function(c, "setregid", SystemModule::setregid, None,
                             Args, "int", "int",
                             Return, "void",
                             End),

                new Function(c, "umask", SystemModule::umask, None,
                             Args, "int",
                             Return, "int",
                             End),

                new Function(c, "chmod", SystemModule::chmod, None,
                             Args, "string", "int",
                             Return, "void",
                             End),

                new Function(c, "mkdir", SystemModule::mkdir, None,
                             Args, "string", "int",
                             Return, "void",
                             End),

                new Function(c, "mkfifo", SystemModule::mkfifo, None,
                             Args, "string", "int",
                             Return, "void",
                             End),

                new Function(c, "mknod", SystemModule::mknod, None,
                             Args, "string", "int", "int",
                             Return, "void",
                             End),

                new Function(c, "readlink", SystemModule::readlink, None,
                             Args, "string",
                             Return, "string",
                             End),

                new Function(c, "fork", SystemModule::fork, None,
                             Return, "int",
                             End),

                new Function(c, "exec", SystemModule::exec, None,
                             Return, "void",
                             Args, "string", "[string]", "[string]",
                             End),

                new Function(c, "system", SystemModule::system, None,
                             Return, "int",
                             Args, "string",
                             End),

                new Function(c, "system2", SystemModule::system2, None,
                             Return, "string",
                             Args, "string",
                             End),

                new Function(c, "defaultWindowsOpen", SystemModule::defaultWindowsOpen, None,
                             Return, "int",
                             Args, "string",
                             End),

                new Function(c, "wait", SystemModule::wait, None,
                             Return, "(int,int)",
                             End),

                new Function(c, "wait", SystemModule::waitpid, None,
                             Return, "(int,int)",
                             Args, "int", "int",
                             End),

                new Function(c, "WIFEXITED", SystemModule::wifexited, None,
                             Return, "bool",
                             Args, "int",
                             End),
                ...
                new Function(c, "WCOREDUMP", SystemModule::wcoredump, None,
                             Return, "int",
                             Args, "bool",
                             End),
                ...
                new Function(c, "WTERMSIG", SystemModule::wtermsig, None,
                             Return, "int",
                             Args, "int",
                             End),

                new Function(c, "WSTOPSIG", SystemModule::wstopsig, None,
                             Return, "int",
                             Args, "int",
                             End),

                new Function(c, "_exit", SystemModule::_exit, None,
                             Return, "void",
                             Args, "int",
                             End),

                new Function(c, "kill", SystemModule::kill, None,
                             Return, "void",
                             Args, "int", "int",
                             End),
                ...
                new Function(c, "flock", SystemModule::flock, None,
                             Return, "int",
                             Args, "int", "int",
                             End),

                new Function(c, "fcntl", SystemModule::fcntl, None,
                             Return, "int",
                             Args, "int", "int", "int",
                             End),

                new Function(c, "pipe", SystemModule::pipe, None,
                             Return, "(int,int)",
                             End),

                new Function(c, "open", SystemModule::open, None,
                             Return, "int",
                             Args, "string", "int", "int",
                             End),

                new Function(c, "close", SystemModule::close, None,
                             Return, "void",
                             Args, "int",
                             End),

                new Function(c, "dup", SystemModule::dup, None,
                             Return, "int",
                             Args, "int",
                             End),

                new Function(c, "dup2", SystemModule::dup2, None,
                             Return, "int",
                             Args, "int", "int",
                             End),

                new Function(c, "read", SystemModule::read, None,
                             Return, "int",
                             Args, "int", "byte[]",
                             End),

                new Function(c, "write", SystemModule::write, None,
                             Return, "int",
                             Args, "int", "byte[]",
                             End),

                new Function(c, "lseek", SystemModule::lseek, None,
                             Return, "int",
                             Args, "int", "int", "int",
                             End),

                new Function(c, "link", SystemModule::link, None,
                             Return, "void",
                             Args, "string", "string",
                             End),

                new Function(c, "unlink", SystemModule::link, None,
                             Return, "void",
                             Args, "string",
                             End),

                new Function(c, "ioctl", SystemModule::ioctl, None,
                             Return, "void",
                             Args, "int", "int64", "?",
                             End),

                new Function(c, "stat", SystemModule::stat, None,
                             Return, "system.statinfo",
                             Args, "string",
                             End),

                new Function(c, "S_ISBLK", SystemModule::s_isblk, Mapped,
                             Return, "bool",
                             Args, "short",
                             End),

                new Function(c, "S_ISCHR", SystemModule::s_ischr, Mapped,
                             Return, "bool",
                             Args, "short",
                             End),

                new Function(c, "S_ISDIR", SystemModule::s_isdir, Mapped,
                             Return, "bool",
                             Args, "short",
                             End),

                new Function(c, "S_ISFIFO", SystemModule::s_isfifo, Mapped,
                             Return, "bool",
                             Args, "short",
                             End),

                new Function(c, "S_ISREG", SystemModule::s_isreg, Mapped,
                             Return, "bool",
                             Args, "short",
                             End),

                new Function(c, "S_ISLNK", SystemModule::s_islnk, Mapped,
                             Return, "bool",
                             Args, "short",
                             End),

                new Function(c, "S_ISSOCK", SystemModule::s_issock, Mapped,
                             Return, "bool",
                             Args, "short",
                             End),

                new Function(c, "socket", SystemModule::socket, None,
                             Return, "int",
                             Args, "int", "int", "int",
                             End),

                new Function(c, "time", SystemModule::time, None,
                             Return, "int64",
                             End),
    ...
    addSymbols( new Function(c, "fopen", SystemModule::fopen, None,
                             Return, "system.FILE",
                             Args, "string", "string",
                             End),

                new Function(c, "fdopen", SystemModule::fdopen, None,
                             Return, "system.FILE",
                             Args, "int", "string",
                             End),
                ...
                new Function(c, "freopen", SystemModule::freopen, None,
                             Return, "system.FILE",
                             Args, "string", "string", "system.FILE",
                             End),

                new Function(c, "fclose", SystemModule::fclose, None,
                             Return, "void",
                             Args, "system.FILE",
                             End),
                ...
                new Function(c, "feof", SystemModule::feof, None,
                             Return, "bool",
                             Args, "system.FILE",
                             End),

                new Function(c, "ferror", SystemModule::ferror, None,
                             Return, "bool",
                             Args, "system.FILE",
                             End),

                new Function(c, "fileno", SystemModule::fileno, None,
                             Return, "int",
                             Args, "system.FILE",
                             End),
...
static void
ThrowErrno(Thread& thread, int errnum)
{
    if (errnum == 0) errnum = errno;
...
#else
    pid_t p = ::fork();
    if (p == -1) ThrowErrno(NODE_THREAD, 0);
    NODE_RETURN(int(p));
#endif
}
...
NODE_IMPLEMENTATION(SystemModule::exec, void)
{
    ...
    for (List args(p, NODE_ARG_OBJECT(1, ClassInstance));
         args.isNotNil();
         args++)
    {
    ...
    for (List envp(p, NODE_ARG_OBJECT(2, ClassInstance));
         envp.isNotNil();
         envp++)
    {
...
#else
	int r  = ::flock(fd, op);
    if (r < 0) ThrowErrno(NODE_THREAD, 0);
    NODE_RETURN(r);
#endif
}
...
NODE_IMPLEMENTATION(SystemModule::fcntl, int)
{
    ...
    switch (cmd)
    {
      ...
      case F_GETOWN:
          NODE_RETURN(r);
      default:
          if (r == -1) ThrowErrno(NODE_THREAD, 0);
          NODE_RETURN(r);
    }
#endif
}
...
NODE_IMPLEMENTATION(SystemModule::system2, Pointer)
{
    ...
    if ( !fd ) ThrowErrno(NODE_THREAD, 0);
...
NODE_IMPLEMENTATION(SystemModule::fopen, Pointer)
{
    ...
    if (!file) ThrowErrno(NODE_THREAD, 0);
...
NODE_IMPLEMENTATION(SystemModule::fclose, void)
{
    ...
    if (rval != 0) ThrowErrno(NODE_THREAD,0);
}
...
NODE_IMPLEMENTATION(SystemModule::time, int64)
{
    NODE_RETURN(::time(0));
}
