...
namespace Mu
{
    ...
    void PyObjectType::outputValue(ostream& o, const Value& value, bool full) const
    {
    ...
    void PyObjectType::outputValueRecursive(ostream& o, const ValuePointer vp, ValueOutputState& state) const
    {
