...
EncodingModule::load()
{
    ...
    addSymbols( new Function(c, "to_base64",
                             EncodingModule::to_base64, None,
                             Return, "byte[]",
                             Parameters,
                             new ParameterVariable(c, "data", "byte[]"),
                             End),

                new Function(c, "from_base64",
                             EncodingModule::from_base64, None,
                             Return, "byte[]",
                             Parameters,
                             new ParameterVariable(c, "data", "byte[]"),
                             End),

                new Function(c, "string_to_utf8",
                             EncodingModule::string_to_utf8, None,
                             Return, "byte[]",
                             Parameters,
                             new ParameterVariable(c, "text", "string"),
                             End),

                new Function(c, "utf8_to_string",
                             EncodingModule::utf8_to_string, None,
                             Return, "string",
                             Parameters,
                             new ParameterVariable(c, "data", "byte[]"),
                             End),
...
NODE_IMPLEMENTATION(EncodingModule::from_base64, Pointer)
{
    ...
    else
    {
        ...
        size_t s = insize / 4 * 3;
        if (d == (unsigned char)0xff) s--;
        if (c == (unsigned char)0xff) s--;
        out->resize(s);
    }
