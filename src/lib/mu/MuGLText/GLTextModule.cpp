...
#define newGlConstant( name ) new SymbolicConstant(c, #name, "int", Value(name))
    ...
    addSymbols(
        ...
        new Function(c,  "init", GLTextModule::TwkGLText_init, None,
                      Return, "void",
                      Args, Optional, "string",
                      End ),

        new Function(c,  "writeAt", GLTextModule::writeAt, None,
                      Return, "void",
        ...
        new Function(c,  "writeAt", GLTextModule::writeAt, None,
                      Return, "void",
                      Args, "vector float[2]", "string",
                      End ),

        new Function(c,  "writeAtNL", GLTextModule::writeAtNLf, None,
                      Return, "void",
                      Args, "float", "float", "string",
                      Optional, "float",
                      End ),
        ...
        new Function(c,  "size", GLTextModule::setSize, None,
                      Return, "void",
                      Args, "int",
                      End ),

        new Function(c,  "size", GLTextModule::getSize, None,
                      Return, "int",
                      End ),

        new Function(c,  "bounds", GLTextModule::bounds, None,
                      Return, "float[4]",
                      Args, "string", 
                      End ),

        new Function(c,  "boundsNL", GLTextModule::boundsNL, None,
                      Return, "float[4]",
                      Args, "string", 
                      Optional, "float",
                      End ),

        new Function(c,  "color", GLTextModule::color4f, None,
                      Return, "void",
                      Args, "float", "float", "float", 
                      Optional, "float",
                      End ),

        new Function(c,  "color", GLTextModule::color3fv, None,
                      Return, "void",
                      Args, "vector float[3]", 
                      End ),

        new Function(c,  "color", GLTextModule::color4fv, None,
                      Return, "void",
                      Args, "vector float[4]", 
                      End ),

        new Function(c,  "width", GLTextModule::width, None,
                      Return, "float",
                      Args, "string", 
                      End ),

        new Function(c,  "height", GLTextModule::height, None,
                      Return, "float",
                      Args, "string", 
                      End ),

        new Function(c,  "widthNL", GLTextModule::widthNL, None,
                      Return, "float",
                      Args, "string", 
                      End ),

        new Function(c,  "heightNL", GLTextModule::heightNL, None,
                      Return, "float",
                      Args, "string", 
                      End ),

        new Function(c,  "ascenderHeight", GLTextModule::ascenderHeight, None,
                      Return, "float",
                      End ),

        new Function(c,  "descenderDepth", GLTextModule::descenderDepth, None,
                      Return, "float",
                      End ),
...
static string
removeReturns(string s)
//
//  Turn \r\n into \n, so that we don't get little boxes for the \r.  Add
//  spaces to blank lines so they don't get collapsed.  Trim newlines from the
//  end.
//
{
    size_t pos = 0;
...
NODE_IMPLEMENTATION(GLTextModule::bounds, Pointer)
{
    ...
    FixedArray *bounds = 
        (FixedArray*)ClassInstance::allocate(atype);
