...
#define assert_void_bool(T,A) {if (!(A)) throw_assertion_failure(T,#A);}
...
inline float
math_util_lerp_float_float_float_float(Mu::Thread&, float a, float b, float t)
{
    return b * t + a * (1.0f - t);
}

inline float
math_util_clamp_float_float_float_float(Mu::Thread&, 
                                        float val,
                                        float mn,
                                        float mx)
{
...
inline int
math_util_random_int_int(Mu::Thread&, int div)
{
