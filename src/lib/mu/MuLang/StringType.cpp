...
static void 
throwBadFormatOpArgType(Thread& thread, int arg, char key, const Type* atype)
{
    ostringstream str;
...
Pointer
string_string(Mu::Thread& NODE_THREAD)
{
...
Pointer
string_string_int(Mu::Thread& NODE_THREAD, int i)
{
    Process *p = NODE_THREAD.process();
    MuLangContext *c = static_cast<MuLangContext*>(p->context());
    char temp[40];
...
Pointer
string_string_int64(Mu::Thread& NODE_THREAD, int64 i)
{
    Process *p = NODE_THREAD.process();
    MuLangContext *c = static_cast<MuLangContext*>(p->context());
    char temp[80];
...
Pointer
string_string_float(Mu::Thread& NODE_THREAD, float i)
{
    Process *p = NODE_THREAD.process();
    MuLangContext *c = static_cast<MuLangContext*>(p->context());
    char temp[40];
...
Pointer
string_string_double(Mu::Thread& NODE_THREAD, double i)
{
    Process *p = NODE_THREAD.process();
    MuLangContext *c = static_cast<MuLangContext*>(p->context());
    char temp[80];
...
Pointer
string_string_byte(Mu::Thread& NODE_THREAD, char i)
{
    Process *p = NODE_THREAD.process();
    MuLangContext *c = static_cast<MuLangContext*>(p->context());
    char temp[40];
...
Pointer
string_string_bool(Mu::Thread& NODE_THREAD, bool i)
{
    Process *p = NODE_THREAD.process();
    MuLangContext *c = static_cast<MuLangContext*>(p->context());
...
Pointer
string_string_string(Mu::Thread& NODE_THREAD, Pointer ptr)
{
    ...
    if (i) return stype->allocate(i->c_str());
    else return stype->allocate("nil");
}

Pointer
string_string_QMark_class_or_interface(Mu::Thread& NODE_THREAD, Pointer ptr)
{
...
Pointer
string_string_QMark_opaque(Mu::Thread& NODE_THREAD, Pointer ptr)
{
    Object* obj = reinterpret_cast<Object*>(ptr);
    Process *p = NODE_THREAD.process();
    MuLangContext* c = static_cast<MuLangContext*>(p->context());
...
Pointer
string_string_QMark_variant(Mu::Thread& NODE_THREAD, Pointer ptr)
{
    return string_string_QMark_class_or_interface(NODE_THREAD, ptr);
}

Pointer
string_string_vector_floatBSB_4ESB_(Mu::Thread& NODE_THREAD, Vector4f i)
{
    Process *p = NODE_THREAD.process();
    MuLangContext* c = static_cast<MuLangContext*>(p->context());
...
Pointer
string_string_vector_floatBSB_3ESB_(Mu::Thread& NODE_THREAD, Vector3f i)
{
    Process *p = NODE_THREAD.process();
    MuLangContext* c = static_cast<MuLangContext*>(p->context());
...
Pointer
string_string_vector_floatBSB_2ESB_(Mu::Thread& NODE_THREAD, Vector2f i)
{
    Process *p = NODE_THREAD.process();
    MuLangContext* c = static_cast<MuLangContext*>(p->context());
...
Pointer
Plus__string_string_string(Mu::Thread& NODE_THREAD, Pointer ps1, Pointer ps2)
{
...
Pointer
Plus_EQ__stringAmp__stringAmp__string(Mu::Thread& NODE_THREAD, Pointer pa, Pointer pb)
{
...
int
int_int_string(Mu::Thread& NODE_THREAD, Pointer ptr)
{
    const StringType::String* a = reinterpret_cast<StringType::String*>(ptr);
    if (!a) throw NilArgumentException(NODE_THREAD);
    return atoi(a->c_str());
}

float
float_float_string(Mu::Thread& NODE_THREAD, Pointer ptr)
{
    const StringType::String* a = reinterpret_cast<StringType::String*>(ptr);
    if (!a) throw NilArgumentException(NODE_THREAD);
    return atof(a->c_str());
...
double
double_double_string(Mu::Thread& NODE_THREAD, Pointer ptr)
{
    const StringType::String* a = reinterpret_cast<StringType::String*>(ptr);
    if (!a) throw NilArgumentException(NODE_THREAD);
    return atof(a->c_str());
...
bool
bool_bool_string(Mu::Thread& NODE_THREAD, Pointer ptr)
{
    const StringType::String* a = reinterpret_cast<StringType::String*>(ptr);
    if (!a) throw NilArgumentException(NODE_THREAD);
...
bool
EQ_EQ__bool_string_string(Mu::Thread& NODE_THREAD, Pointer aptr, Pointer bptr)
{
    ...
    if (!a || !b) throw NilArgumentException(NODE_THREAD);
    return *a == *b;
}

bool
Bang_EQ__bool_string_string(Mu::Thread& NODE_THREAD, Pointer aptr, Pointer bptr)
{
    const StringType::String* a = reinterpret_cast<StringType::String*>(aptr);
    const StringType::String* b = reinterpret_cast<StringType::String*>(bptr);
    if (!a || !b) throw NilArgumentException(NODE_THREAD);
...
static Pointer
format_op(Mu::Thread& NODE_THREAD, Pointer fmtPtr, const FormatArgs& args)
{
    ...
    while (!fmtstr.empty() &&
           (regexec_result = regexec(&StringType::_format_re, 
                                     fmtstr.c_str(),
                                     matches.size(),
                                     &matches.front(), 0)) != REG_NOMATCH)
    {
        if (regexec_result)
        {
            char errtemp[256];
                ...
                switch (key)
                {
                  ...
                  case 'x':
                      if (t == c->intType() || t == c->charType())
                      {
                          do
                          {
                              if (n+1 > temp.size()) temp.resize(n+1);
                              else if (n < 0) temp.resize(temp.size() * 2);

                              n = snprintf(&temp.front(), 
                                           temp.size(),
                                           fmtsub.c_str(),
...
Pointer
PCent__string_string_int(Mu::Thread& NODE_THREAD,
                         Pointer fmtPtr,
                         int arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_int64(Mu::Thread& NODE_THREAD,
                           Pointer fmtPtr,
                           int64 arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_float(Mu::Thread& NODE_THREAD,
                           Pointer fmtPtr,
                           float arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_double(Mu::Thread& NODE_THREAD,
                            Pointer fmtPtr,
                            double arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_half(Mu::Thread& NODE_THREAD,
                          Pointer fmtPtr,
                          short arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_short(Mu::Thread& NODE_THREAD,
                           Pointer fmtPtr,
                           short arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_char(Mu::Thread& NODE_THREAD,
                          Pointer fmtPtr,
                          int arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_byte(Mu::Thread& NODE_THREAD,
                          Pointer fmtPtr,
                          char arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_QMark_class_not_tuple(Mu::Thread& NODE_THREAD,
                                           Pointer fmtPtr,
                                           Pointer arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_QMark_opaque(Mu::Thread& NODE_THREAD,
                                  Pointer fmtPtr,
                                  Pointer arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_bool(Mu::Thread& NODE_THREAD,
                          Pointer fmtPtr,
                          bool arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_vector_floatBSB_4ESB_(Mu::Thread& NODE_THREAD,
                                           Pointer fmtPtr,
                                           Vector4f arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_vector_floatBSB_3ESB_(Mu::Thread& NODE_THREAD,
                                           Pointer fmtPtr,
                                           Vector3f arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_vector_floatBSB_2ESB_(Mu::Thread& NODE_THREAD,
                                           Pointer fmtPtr,
                                           Vector2f arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_charBSB_2ESB_(Mu::Thread& NODE_THREAD,
                                   Pointer fmtPtr,
                                   Pointer arg)
{
    Process*       p = NODE_THREAD.process();
...
Pointer
PCent__string_string_QMark_tuple(Mu::Thread& NODE_THREAD,
                                 Pointer fmtPtr,
                                 Pointer argPtr)
{
...
void
print_void_string(Mu::Thread& NODE_THREAD, Pointer ptr)
{
...
int
string_size_int_string(Mu::Thread& NODE_THREAD, Pointer ptr)
{
    const StringType::String* o = reinterpret_cast<StringType::String*>(ptr);
    if (!o) throw NilArgumentException(NODE_THREAD);
    return o->numChars();
}

int
string_hash_int_string(Mu::Thread& NODE_THREAD, Pointer ptr)
{
    const StringType::String* o = reinterpret_cast<StringType::String*>(ptr);
    if (!o) throw NilArgumentException(NODE_THREAD);
    return o->hash();
...
int
compare_int_string_string(Mu::Thread& NODE_THREAD, Pointer aptr, Pointer bptr)
{
    const StringType::String* a = reinterpret_cast<StringType::String*>(aptr);
    const StringType::String* b = reinterpret_cast<StringType::String*>(bptr);
    if (!a || !b) throw NilArgumentException(NODE_THREAD);
...
Pointer
string_join_string_stringBSB_ESB__string(Mu::Thread& NODE_THREAD,
                                          Pointer aptr,
                                          Pointer bptr)
{
    Process* p = NODE_THREAD.process();
    ...
    if (!array || !del) throw NilArgumentException(NODE_THREAD);
...
Pointer
string_split_stringBSB_ESB__string_string_bool(Mu::Thread& NODE_THREAD,
                                               Pointer aptr,
                                               Pointer bptr,
                                               bool seq)
{
    ...
    const StringType::String* del = reinterpret_cast<StringType::String*>(bptr);
    if (!str || !del) throw NilArgumentException(NODE_THREAD);
    ...
    if (seq)
    {
        ...
        while (p0 != UTF8String::npos && p0 < text.size())
        {
            ...
            if (p1 != UTF8String::npos) p0 = p1 + seperator.size();
            else p0 = p1;
        }
    }
    else
...
int
string_BSB_ESB__char_string_int(Mu::Thread& NODE_THREAD, Pointer aptr, int a)
{
    //
    ...
    if (!self) throw NilArgumentException(NODE_THREAD);
...
Pointer
string_substr_string_string_int_int(Mu::Thread& NODE_THREAD,
                                    Pointer aptr,
                                    int start,
                                    int len)
{
    ...
    if (start + len > usize) len = usize - start;
...
StringType::String* 
StringType::allocate(const Mu::String& instr) const
{
...
StringType::String* 
StringType::allocate(const Mu::Name& instr) const
{
    StringType::String* s = new StringType::String(this);
    s->set(instr);
    return s;
...
StringType::String* 
StringType::allocate(const std::string& instr) const
{
    StringType::String* s = new StringType::String(this);
...
StringType::String* 
StringType::allocate(const ostringstream& str) const
{
    StringType::String* s = new StringType::String(this);
    s->set(str.str());
    return s;
...
StringType::String* 
StringType::allocate(const char* instr) const
{
    StringType::String* s = new StringType::String(this);
...
StringType::String* 
StringType::allocate(size_t n) const
{
    StringType::String* s = new StringType::String(this);
    return s;
}
...
void
StringType::String::setn(const char* s, size_t size)
{
...
void
StringType::String::set(const char* s)
{
    //if (_utf8string && _utf8string != blank) MU_GC_FREE((void*)_utf8string);
...
size_t
StringType::String::numChars() const
{
    return UTF8len(_utf8string);
}

bool 
StringType::String::operator == (const char* b) const
{
    return compare(b) == 0;
}

bool 
StringType::String::operator == (const StringType::String& b) const
{
...
int
StringType::String::compare(const char* p) const
{
    if (p && _utf8string)
    {
...
stdUTF32String 
StringType::String::utf32std() const
{
    stdUTF32String abuf;
    copyConvert(abuf);
    return abuf;
...
stdUTF16String 
StringType::String::utf16std() const
{
    stdUTF16String abuf;
    copyConvert(abuf);
    return abuf;
...
void 
StringType::String::copyConvert(UTF32String& s) const
{
    utf8::utf8to32(_utf8string, _utf8string + size(), back_inserter(s));
}

void 
StringType::String::copyConvert(UTF16String& s) const
{
    utf8::utf8to16(_utf8string, _utf8string + size(), back_inserter(s));
}

void 
StringType::String::copyConvert(UTF8String& s) const
{
    s = _utf8string;
}

void 
StringType::String::copyConvert(stdUTF32String& s) const
{
    utf8::utf8to32(_utf8string, _utf8string + size(), back_inserter(s));
}

void 
StringType::String::copyConvert(stdUTF16String& s) const
{
    utf8::utf8to16(_utf8string, _utf8string + size(), back_inserter(s));
}

void 
StringType::String::copyConvert(stdUTF8String& s) const
{
    s = _utf8string;
}
...
StringType::StringType(Context* c, Class *super) : Class(c, "string", super)
{
}
...
Object*
StringType::newObject() const
{
    return new String(this);
}

size_t
StringType::objectSize() const
{
    return sizeof(StringType::String);
}

void
StringType::constructInstance(Pointer obj) const
{
...
void
StringType::copyInstance(Pointer a, Pointer b) const
{
...
void
StringType::deleteObject(Object *obj) const
{
    delete static_cast<StringType::String*>(obj);
}

void 
StringType::outputValue(ostream &o, const Value &value, bool full) const
{
...
void 
StringType::outputValueRecursive(ostream &o,
...
void
StringType::outputQuotedString(ostream &o, const Mu::String& str, char delim)
{
    o << delim;
...
void
StringType::serialize(std::ostream& o,
...
void
StringType::deserialize(std::istream& i,
...
StringType::load()
{
    if (_init)
    {
        ...
        *b = 0;
                              ...
                              REG_EXTENDED))
        {
            ...
            cerr << "ERROR: internal format re failed: "
                 << &temp.front()
                 << endl;
        }
    ...
    s->addSymbols( new ReferenceType(c, "string&",this), 

		   new Function(c, "string", StringType::construct, None,
                                Compiled, string_string,
				Return, "string", End),

		   new Function(c, "string", BaseFunctions::dereference, Cast,
				Return, "string",
				Args, "string&", End),

		   new Function(c, "string", StringType::from_int, Cast,
                                Compiled, string_string_int,
				Return, "string", 
				Args, "int", End),

		   new Function(c, "string", StringType::from_int64, Cast,
                                Compiled, string_string_int64,
				Return, "string", 
				Args, "int64", End),

		   new Function(c, "string", StringType::from_float, Lossy,
                                Compiled, string_string_float,
				Return, "string", 
				Args, "float", End),

		   new Function(c, "string", StringType::from_double, Lossy,
                                Compiled, string_string_double,
				Return, "string", 
				Args, "double", End),

		   new Function(c, "string", StringType::from_bool, Cast,
                                Compiled, string_string_bool,
				Return, "string", 
				Args, "bool", End),

		   new Function(c, "string", StringType::from_byte, Cast,
                                Compiled, string_string_byte,
				Return, "string", 
				Args, "byte", End),

		   new Function(c, "string", StringType::from_vector4, Cast,
                                Compiled, string_string_vector_floatBSB_4ESB_,
				Return, "string", 
				Args, "vector float[4]", End),

		   new Function(c, "string", StringType::from_vector3, Cast,
                                Compiled, string_string_vector_floatBSB_3ESB_,
				Return, "string", 
				Args, "vector float[3]", End),

		   new Function(c, "string", StringType::from_vector2, Cast,
                                Compiled, string_string_vector_floatBSB_2ESB_,
				Return, "string", 
				Args, "vector float[2]", End),

		   new Function(c, "string", StringType::from_string, None,
                                Compiled, string_string_string,
				Return, "string", 
				Args, "string", End),

		   new Function(c, "string", StringType::from_class, Cast,
                                Compiled, string_string_QMark_class_or_interface,
				Return, "string", 
				Args, "?class_or_interface", End),

		   new Function(c, "string", StringType::from_opaque, Cast,
                                Compiled, string_string_QMark_opaque,
				Return, "string", 
				Args, "?opaque", End),

		   new Function(c, "string", StringType::from_variant, Cast,
                                Compiled, string_string_QMark_variant,
				Return, "string", 
				Args, "?variant", End),

		   new Function(c, "int", StringType::to_int, Mapped,
                                Compiled, int_int_string,
				Return, "int", 
				Args, "string", End),

		   new Function(c, "float", StringType::to_float, Mapped,
                                Compiled, float_float_string,
				Return, "float", 
				Args, "string", End),

		   new Function(c, "double", StringType::to_double, Mapped,
                                Compiled, double_double_string,
				Return, "double", 
				Args, "string", End),

		   new Function(c, "bool", StringType::to_bool, Mapped,
                                Compiled, bool_bool_string,
				Return, "bool", 
				Args, "string", End),

		   new Function(c, "=", BaseFunctions::assign, 
                                AsOp | NativeInlined,
                                Compiled, __C_EQ__stringAmp__stringAmp__string,
				Return, "string&", 
				Args, "string&", "string", End),

		   new Function(c, "%", StringType::formatOp, Function::Operator,
                                Compiled, PCent__string_string_QMark_tuple,
				Return, "string", 
		   ...
		   new Function(c, "%", StringType::formatOp_class, Function::Operator,
				...
				Return, "string", 
				Args, "string", "?object_not_tuple", End),

		   new Function(c, "%", StringType::formatOp_opaque, Function::Operator,
                                Compiled, PCent__string_string_QMark_opaque,
				Return, "string", 
				Args, "string", "?opaque", End),

		   new Function(c, "%", StringType::formatOp_int, Function::Operator,
                                Compiled, PCent__string_string_int,
				Return, "string", 
				Args, "string", "int", End),

		   new Function(c, "%", StringType::formatOp_int64, Function::Operator,
                                Compiled, PCent__string_string_int64,
				Return, "string", 
				Args, "string", "int64", End),

		   new Function(c, "%", StringType::formatOp_float, Function::Operator,
                                Compiled, PCent__string_string_float,
				Return, "string", 
				Args, "string", "float", End),

		   new Function(c, "%", StringType::formatOp_double, Function::Operator,
                                Compiled, PCent__string_string_double,
				Return, "string", 
				Args, "string", "double", End),

		   new Function(c, "%", StringType::formatOp_half, Function::Operator,
                                Compiled, PCent__string_string_half,
				Return, "string", 
				Args, "string", "half", End),

		   new Function(c, "%", StringType::formatOp_char, Function::Operator,
                                Compiled, PCent__string_string_char,
				Return, "string", 
				Args, "string", "char", End),

		   new Function(c, "%", StringType::formatOp_bool, Function::Operator,
                                Compiled, PCent__string_string_bool,
				Return, "string", 
				Args, "string", "bool", End),

		   new Function(c, "%", StringType::formatOp_byte, Function::Operator,
                                Compiled, PCent__string_string_byte,
				Return, "string", 
				Args, "string", "byte", End),

		   new Function(c, "%", StringType::formatOp_short, Function::Operator,
                                Compiled, PCent__string_string_short,
				Return, "string", 
				Args, "string", "short", End),

		   new Function(c, "%", StringType::formatOp_Vector4f, Function::Operator,
                                Compiled, PCent__string_string_vector_floatBSB_4ESB_,
				Return, "string", 
				Args, "string", "vector float[4]", End),

		   new Function(c, "%", StringType::formatOp_Vector3f, Function::Operator,
                                Compiled, PCent__string_string_vector_floatBSB_3ESB_,
				Return, "string", 
				Args, "string", "vector float[3]", End),

		   new Function(c, "%", StringType::formatOp_Vector2f, Function::Operator,
                                Compiled, PCent__string_string_vector_floatBSB_2ESB_,
				Return, "string", 
				Args, "string", "vector float[2]", End),

		   new Function(c, "%", StringType::formatOp_charArray, Function::Operator,
                                Compiled, PCent__string_string_charBSB_2ESB_,
				Return, "string", 
				Args, "string", "char[]", End),

		   new Function(c, "+", StringType::plus, Op,
                                Compiled, Plus__string_string_string,
				Return, "string", 
				Args, "string", "string", End),

		   new Function(c, "==", StringType::equals, CommOp,
                                Compiled, EQ_EQ__bool_string_string,
				Return, "bool", 
				Args, "string", "string", End),

		   new Function(c, "!=", StringType::notequals, CommOp,
                                Compiled, Bang_EQ__bool_string_string,
				Return, "bool", 
				Args, "string", "string", End),

		   new Function(c, "print", StringType::print, None,
                                Compiled, print_void_string,
				Return, "void", 
				Args, "string", End),

		   new Function(c, "+=", StringType::assignPlus, AsOp,
                                Compiled, Plus_EQ__stringAmp__stringAmp__string,
				Return, "string&",
				Args, "string&", "string", End),
                   
                   new Function(c, "compare", StringType::compare, Mapped,
                                Compiled, compare_int_string_string,
                                Return, "int",
                                Args, "string", "string", End),
    ...
    addSymbols( new Function(c, "size", StringType::size, Mapped,
                             Compiled, string_size_int_string,
                             Return, "int",
                             Parameters,
                             new ParameterVariable(c, "this", "string"),
                             End),

		new Function(c, "substr", StringType::substr, Mapped,
                             Compiled, string_substr_string_string_int_int,
                             Return, "string",
                             Parameters,
                             new ParameterVariable(c, "this", "string"),
                             new ParameterVariable(c, "index0", "int"),
                             new ParameterVariable(c, "length", "int"),
                             End),

		new Function(c, "[]", StringType::index, Mapped,
                             Compiled, string_BSB_ESB__char_string_int,
                             Return, "char", 
                             Parameters,
                             new ParameterVariable(c, "this", "string"),
                ...
                new Function(c, "split", StringType::split, Mapped,
                             Compiled, string_split_stringBSB_ESB__string_string_bool,
                             Return, "string[]",
                             Parameters,
                             new ParameterVariable(c, "this", "string"),
                ...
                new Function(c, "join", StringType::join_array, Mapped,
                             Compiled, string_join_string_stringBSB_ESB__string,
                             Return, "string",
                             Parameters,
                             new ParameterVariable(c, "strings", "string[]"),
                             new ParameterVariable(c, "seperator", "string"),
                             End),

		new Function(c, "hash", StringType::hash, Mapped,
                             Compiled, string_hash_int_string,
                             Return, "int",
                             Parameters,
                             new ParameterVariable(c, "this", "string"),
                             End),
...
{
    NODE_RETURN(string_string_QMark_class_or_interface(NODE_THREAD,
...
{
    NODE_RETURN(EQ_EQ__bool_string_string(NODE_THREAD,
                                          NODE_ARG(0, Pointer),
                                          NODE_ARG(1, Pointer)));
}
...
{
    NODE_RETURN(Bang_EQ__bool_string_string(NODE_THREAD,
                                            NODE_ARG(0, Pointer),
                                            NODE_ARG(1, Pointer)));
}
...
{
    NODE_RETURN(compare_int_string_string(NODE_THREAD,
                                          NODE_ARG(0,Pointer),
                                          NODE_ARG(1,Pointer)));
}
...
{
    NODE_RETURN(string_split_stringBSB_ESB__string_string_bool(NODE_THREAD,
                                                               NODE_ARG(0,Pointer),
                                                               NODE_ARG(1,Pointer),
                                                               NODE_ARG(2, bool)));
}
...
{
    NODE_RETURN(string_join_string_stringBSB_ESB__string(NODE_THREAD,
                                                         NODE_ARG(0,Pointer),
                                                         NODE_ARG(1,Pointer)));
}
...
{
    NODE_RETURN(string_BSB_ESB__char_string_int(NODE_THREAD,
                                                NODE_ARG(0,Pointer),
                                                NODE_ARG(1,int)));
}
...
{
    NODE_RETURN(string_substr_string_string_int_int(NODE_THREAD,
                                                    NODE_ARG(0,Pointer),
                                                    NODE_ARG(1,int),
                                                    NODE_ARG(2,int)));
}
