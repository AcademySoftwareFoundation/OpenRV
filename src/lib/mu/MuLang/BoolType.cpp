...
BoolType::BoolType(Context* c) : PrimitiveType(c, "bool", BoolRep::rep())
{
}
...
PrimitiveObject*
BoolType::newObject() const
{
    return new PrimitiveObject(this);
}

Value 
BoolType::nodeEval(const Node *n, Thread &thread) const
{
    return Value( (*n->func()._boolFunc)(*n,thread) );
}

void
BoolType::nodeEval(void *p, const Node *n, Thread &thread) const
{
...
void 
BoolType::outputValue(ostream &o, const Value &value, bool full) const
{
    o << (value._bool ? "true" : "false");
}

void 
BoolType::outputValueRecursive(ostream &o,
...
bool __C_QMark_Colon__bool_bool_bool(T, bool p, bool a, bool b) 
      { return p ? a : b; }
bool __C_eq_QMark_non_primitive_or_nil_QMark_non_primitive_or_nil(T, Pointer a, Pointer b)
        { return a == b; }
bool __C_neq_QMark_non_primitive_or_nil_QMark_non_primitive_or_nil(T, Pointer a, Pointer b)
        { return a != b; }
void __C_assert_void_bool(T t,bool a) {if (!a) throw_assertion_failure(t,"");}
#undef T
...
BoolType::load()
{
    ...
    s->addSymbols( new ReferenceType(c, "bool&", this),
		   ...
		   new Function(c, "bool", BoolType::defaultBool, 
                                ...
                                Compiled, __C_bool_bool,
				Return, "bool",
				End),

		   new Function(c, "bool", BoolType::dereference, 
                                Cast | NativeInlined,
                                Compiled, __C_bool_boolAmp_,
				Return, "bool",
				Args, "bool&", End),

		   new Function(c, "=", BoolType::assign, 
                                AsOp | NativeInlined,
                                Compiled, __C_EQ__boolAmp__boolAmp__bool,
				Return, "bool&", 
				Args, "bool&", "bool", End),

        	   new Function(c, "!", BoolType::logicalNot, 
                                Op | NativeInlined,
                                Compiled, __C_Bang__bool_bool,
				Return, "bool", 
				Args, "bool", End),

		   new Function(c, "&&", BoolType::logicalAnd, 
                                Op | NativeInlined,
                                Compiled, __C_Amp_Amp__bool_bool_bool,
				Return, "bool", 
				Args, "bool", "bool", End),

		   new Function(c, "||", BoolType::logicalOr, 
                                Op | NativeInlined,
                                Compiled, __C_Pipe_Pipe__bool_bool_bool,
				Return, "bool", 
				Args, "bool", "bool", End),

		   new Function(c, "?:", BoolType::conditionalExpr, Op,
                                Compiled, __C_QMark_Colon__bool_bool_bool,
				Return, "bool", 
				Args, "bool", "bool", "bool", End),

		   new Function(c, "__if", BoolType::__if, None,
				Return, "void",
				Args, "bool", "?", End),

		   new Function(c, "__if", BoolType::__if_else, None,
				Return, "void",
				Args, "bool", "?", "?", End),

		   new Function(c, "__for", BoolType::__for, None,
				Return, "void",
				Args, "?", "bool", "?", "?", End),

                   new Function(c, "__repeat", BoolType::__repeat, None,
                                Return, "void",
                                Args, "int", "?", End),

		   new Function(c, "__for_each",
                                BoolType::__for_each_fixed_array, None,
				Return, "void",
				Args, "?reference", "?fixed_array", "?", End),

		   new Function(c, "__for_each", 
                                BoolType::__for_each_dynamic_array, None,
				Return, "void",
				Args, "?reference", "?dyn_array", "?", End),

		   new Function(c, "__for_each", 
                                BoolType::__for_each_list, None,
				Return, "void",
				Args, "?reference", "?list", "?", End),

                   new Function(c, "__for_index",
                                BoolType::__for_index_dynamic_array, None,
                                Return, "void",
                                Args, "?reference", "?dyn_array", "?", End),

                   new Function(c, "__for_index",
                                BoolType::__for_index_fixed1_array, None,
                                Return, "void",
                                Args, "?reference", 
                                      "?fixed_array", "?", End),

                   new Function(c, "__for_index",
                                BoolType::__for_index_fixed2_array, None,
                                Return, "void",
                                Args, "?reference", "?reference", 
                                      "?fixed_array", "?", End),

                   new Function(c, "__for_index",
                                BoolType::__for_index_fixed3_array, None,
                                Return, "void",
                                Args, "?reference", "?reference", "?reference", 
                                      "?fixed_array", "?", End),

		   new Function(c, "__while", BoolType::__while, None,
				Return, "void",
				Args, "bool", "?", End),

		   new Function(c, "__do_while", BoolType::__do_while, None,
				Return, "void",
				Args, "?", "bool", End),

		   new Function(c, "__break", BoolType::__break, None,
				Return, "void",
				End),

		   new Function(c, "__continue", BoolType::__continue, None,
				Return, "void",
				End),

		   new Function(c, "assert", BoolType::assertion, 
                                NativeInlined,
                                Compiled, __C_assert_void_bool,
				Return, "void",
				Args, "bool", End),

                   new Function(c, "eq", BaseFunctions::eq, 
                                CommOp | NativeInlined,
                                Compiled, __C_eq_QMark_non_primitive_or_nil_QMark_non_primitive_or_nil,
                                Return, "bool",
                                Args, "?non_primitive_or_nil", 
                                "?non_primitive_or_nil",
                                End),

                   new Function(c, "neq", BaseFunctions::neq, 
                                CommOp | NativeInlined,
                                Compiled, __C_neq_QMark_non_primitive_or_nil_QMark_non_primitive_or_nil,
                                Return, "bool",
                                Args, "?non_primitive_or_nil", 
                                "?non_primitive_or_nil",
                                End),
...
NODE_IMPLEMENTATION(BoolType::defaultBool,bool)
{
    NODE_RETURN(false);
}
...
NODE_IMPLEMENTATION(BoolType::__if,void)
{
    ...
    //	really bad assumption. The other route is MU_SAFE_ARGUMENTS. It calls the
    //	type to get the correct type.
    //
...
NODE_IMPLEMENTATION(BoolType::__for,void)
{
	...
	else
	{
	    ...
	    if (rv == JumpReturnCode::Continue) continue;
	    else break;
	}
    }
...
NODE_IMPLEMENTATION(BoolType::__repeat, void)
{
	...
	else
	{
	    ...
	    if (rv == JumpReturnCode::Continue) {i++; continue;}
	    else break;
	}
    ...
    if (obj)
    {
        for (List list(NODE_THREAD.process(), obj); list.isNotNil();)
        {
            ...
            else
            {
                ...
                if (rv == JumpReturnCode::Continue) {++list; continue;}
                else break;
            }
        ...
        *index0 = i;
        ...
        for (size_t j=0; j < size1;)
        {
            ...
            else
            {
                ...
                if (rv == JumpReturnCode::Continue) {j++; continue;}
                else break;
            }
            ...
            *index1 = j;
            ...
            for (size_t k=0; k < size2;)
            {
                ...
                else
                {
                    ...
                    if (rv == JumpReturnCode::Continue) {k++; continue;}
                    else break;
                }
                k++;
            }
...
void 
throw_assertion_failure(Mu::Thread& NODE_THREAD, const char* expr)
{
...
NODE_IMPLEMENTATION(BoolType::assertion,void)
{
	...
	NodePrinter printer( const_cast<Node*>(NODE_THIS.argNode(0)), 
				 str, NodePrinter::Lispy );
	printer.traverse();
