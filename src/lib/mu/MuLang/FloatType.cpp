...
FloatType::FloatType(Context* c) : PrimitiveType(c, "float", FloatRep::rep())
{
}
...
PrimitiveObject*
FloatType::newObject() const
{
    return new PrimitiveObject(this);
}

Value 
FloatType::nodeEval(const Node *n, Thread &thread) const
{
    return Value((*n->func()._floatFunc)(*n,thread));
}

void
FloatType::nodeEval(void *p, const Node *n, Thread &thread) const
{
...
void 
FloatType::outputValue(ostream &o, const Value &value, bool full) const
{
...
void
FloatType::outputValueRecursive(ostream &o,
...
FloatType::load()
{
    ...
    s->addSymbols( new ReferenceType(c, "float&",this), 

		   new Function(c, "float", FloatType::defaultFloat, Mapped,
                                Compiled, __C_float_float,
				Return, "float",
				End),

		   new Function(c, "float", FloatType::dereference, Cast,
                                Compiled, __C_float_float_floatAmp_,
				Return, "float",
				Args, "float&", End),

		   new Function(c, "+", FloatType::add, CommOp,
                                Compiled, __C_Plus__float_float_float,
				Return, "float", 
				Args, "float", "float", End),

		   new Function(c, "-", FloatType::sub, Op,
                                Compiled, __C_Minus__float_float_float,
				Return, "float", 
				Args, "float", "float", End),

		   new Function(c, "-", FloatType::negate, Op,
                                Compiled, __C_Minus__float_float,
				Return, "float", 
				Args, "float", End),

		   new Function(c, "*", FloatType::mult, CommOp,
                                Compiled, __C_Star__float_float_float,
				Return, "float", 
				Args, "float", "float", End),

		   new Function(c, "/", FloatType::div, Op,
                                Compiled, __C_Slash__float_float_float,
				Return, "float", 
				Args, "float", "float", End),

		   new Function(c, "%", FloatType::mod, Op,
                                Compiled, __C_PCent__float_float_float,
				Return, "float", 
				Args, "float", "float", End),

		   new Function(c, "float", FloatType::int2float, Cast,
                                Compiled, __C_float_float_int,
				Return, "float", 
				Args, "int", End),

		   new Function(c, "float", FloatType::double2float, Lossy,
                                Compiled, __C_float_float_double,
				Return, "float", 
				Args, "double", End),

		   new Function(c, "float", FloatType::int642float, Cast,
                                Compiled, __C_float_float_int64,
				Return, "float", 
				Args, "int64", End),

		   new Function(c, "=", FloatType::assign, AsOp,
                                Compiled, __C_EQ__floatAmp__floatAmp__float,
				Return, "float&", 
				Args, "float&", "float", End),

		   new Function(c, "+=", FloatType::assignPlus, AsOp,
                                Compiled, __C_Plus_EQ__floatAmp__floatAmp__float,
				Return, "float&", 
				Args, "float&", "float", End),

		   new Function(c, "-=", FloatType::assignSub, AsOp,
                                Compiled, __C_Minus_EQ__floatAmp__floatAmp__float,
				Return, "float&", 
				Args, "float&", "float", End),

		   new Function(c, "*=", FloatType::assignMult, AsOp,
                                Compiled, __C_Star_EQ__floatAmp__floatAmp__float,
				Return, "float&", 
				Args, "float&", "float", End),

		   new Function(c, "/=", FloatType::assignDiv, AsOp,
                                Compiled, __C_Slash_EQ__floatAmp__floatAmp__float,
				Return, "float&", 
				Args, "float&", "float", End),

		   new Function(c, "%=", FloatType::assignMod, AsOp,
                                Compiled, __C_PCent_EQ__floatAmp__floatAmp__float,
				Return, "float&", 
				Args, "float&", "float", End),

		   new Function(c, "?:", FloatType::conditionalExpr, Op,
                                Compiled, __C_QMark_Colon__bool_float_float,
				Return, "float", 
				Args, "bool", "float", "float", End),

		   new Function(c, "print", FloatType::print, None,
                                Compiled, __C_print_void_float,
				Return, "void", 
				Args, "float", End),

		   new Function(c, "==", FloatType::equals, CommOp,
                                Compiled, __C_EQ_EQ__bool_float_float,
				Return, "bool", 
				Args, "float", "float", End),

		   new Function(c, "!=", FloatType::notEquals, CommOp,
                                Compiled, __C_Bang_EQ__bool_float_float,
				Return, "bool", 
				Args, "float", "float", End),

		   new Function(c, ">=", FloatType::greaterThanEq, Op,
                                Compiled, __C_GT_EQ__bool_float_float,
				Return, "bool", 
				Args, "float", "float", End),

		   new Function(c, "<=", FloatType::lessThanEq, Op,
                                Compiled, __C_LT_EQ__bool_float_float,
				Return, "bool", 
				Args, "float", "float", End),

		   new Function(c, "<", FloatType::lessThan, Op,
                                Compiled, __C_LT__bool_float_float,
				Return, "bool", 
				Args, "float", "float", End),

		   new Function(c, ">", FloatType::greaterThan, Op,
                                Compiled, __C_GT__bool_float_float,
				Return, "bool", 
				Args, "float", "float", End),

		   new Function(c, "pre++", FloatType::preInc, Op,
                                Compiled, __C_prePlus_Plus__float_floatAmp_,
				Return, "float", 
				Args, "float&", End),

		   new Function(c, "post++", FloatType::postInc, Op,
                                Compiled, __C_postPlus_Plus__float_floatAmp_,
				Return, "float", 
				Return, "float", 
				Args, "float&", End),

		   new Function(c, "pre--", FloatType::preDec, Op,
                                Compiled, __C_preMinus_Minus__float_floatAmp_,
				Return, "float", 
				Args, "float&", End),

		   new Function(c, "post--", FloatType::postDec, Op,
                                Compiled, __C_postMinus_Minus__float_floatAmp_,
				Return, "float", 
				Args, "float&", End),
...
NODE_IMPLEMENTATION(FloatType::defaultFloat,float)
{
    NODE_RETURN(0.0f);
}
...
{
    NODE_RETURN( NODE_ARG(0,bool) ? NODE_ARG(1,float) : NODE_ARG(2,float) );
}
