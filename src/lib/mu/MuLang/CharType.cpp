...
CharType::CharType(Context* c) : PrimitiveType(c, "char", IntRep::rep())
{
}
...
PrimitiveObject*
CharType::newObject() const
{
    return new PrimitiveObject(this);
}

Value 
CharType::nodeEval(const Node *n, Thread &thread) const
{
    return Value((*n->func()._intFunc)(*n,thread));
}

void
CharType::nodeEval(void *p, const Node *n, Thread &thread) const
{
...
void 
CharType::outputValue(ostream &o, const Value &value, bool full) const
{
    String s;
    int c = value._int;
...
void
CharType::outputValueRecursive(ostream &o, const ValuePointer vp, ValueOutputState& state) const
{
    String s;
...
CharType::load()
{
    ...
    s->addSymbols( new ReferenceType(c, "char&", this),

		   new Function(c, "char", IntType::defaultInt, Mapped,
                                Compiled, __C_char_char,
				Return, "char",
				End),

		   new Function(c, "char", IntType::dereference, Cast,
				Return, "char",
				Args, "char&", End),

                   new Function(c, "char", CharType::fromInt, Mapped,
                                Compiled, __C_char_char_int,
                                Return, "char",
                                Args, "int",
                                End),

                    // pass through same as fromInt
                   new Function(c, "int", CharType::fromInt, Mapped, 
                                Compiled, __C_int_int_char,
                                Return, "int",
                                Args, "char",
                                End),

		   new Function(c, "string", CharType::toString, Cast,
				Return, "string",
				Args, "char", End),

		   new Function(c, "=", IntType::assign, AsOp,
                                Compiled, __C_EQ__charAmp__charAmp__char,
				Return, "char&", 
				Args, "char&", "char", End),

		   new Function(c, "?:", IntType::conditionalExpr, Op,
                                Compiled, __C_QMark_Colon__bool_char_char,
				Return, "char", 
				Args, "bool", "char", "char", End),

		   new Function(c, "+", IntType::add, CommOp,
                                Compiled, __C_Plus__char_char_int,
				Return, "char", 
				Args, "char", "int", End),

		   new Function(c, "-", IntType::sub, Op,
                                Compiled, __C_Minus__char_char_int,
				Return, "int", 
				Args, "char", "char", End),
		   ...
		   new Function(c, "+=", IntType::assignPlus, AsOp,
                                Compiled, __C_Plus_EQ__charAmp__charAmp__int,
				Return, "char&", 
				Args, "char&", "int", End),

		   new Function(c, "-=", IntType::assignSub, AsOp,
                                Compiled, __C_Minus_EQ__charAmp__charAmp__int,
				Return, "char&", 
				Args, "char&", "int", End),

		   new Function(c, "==", IntType::equals, CommOp,
                                Compiled, __C_EQ_EQ__bool_char_char,
				Return, "bool", 
				Args, "char", "char", End),

		   new Function(c, "!=", IntType::notEquals, CommOp,
                                Compiled, __C_Bang_EQ__bool_char_char,
				Return, "bool", 
				Args, "char", "char", End),

		   new Function(c, ">=", IntType::greaterThanEq, Op,
                                Compiled, __C_GT_EQ__bool_char_char,
				Return, "bool", 
				Args, "char", "char", End),

		   new Function(c, "<=", IntType::lessThanEq, Op,
                                Compiled, __C_LT_EQ__bool_char_char,
				Return, "bool", 
				Args, "char", "char", End),

		   new Function(c, "<", IntType::lessThan, Op,
                                Compiled, __C_LT__bool_char_char,
				Return, "bool", 
				Args, "char", "char", End),

		   new Function(c, ">", IntType::greaterThan, Op,
                                Compiled, __C_GT__bool_char_char,
				Return, "bool", 
				Args, "char", "char", End),

		   new Function(c, "pre++", IntType::preInc, Op,
                                Compiled, __C_prePlus_Plus__char_charAmp_,
				Return, "char", 
				Args, "char&", End),

		   new Function(c, "post++", IntType::postInc, Op,
                                Compiled, __C_postPlus_Plus__char_charAmp_,
				Return, "char", 
				Args, "char&", End),

		   new Function(c, "pre--", IntType::preDec, Op,
                                Compiled, __C_preMinus_Minus__char_charAmp_,
				Return, "char", 
				Args, "char&", End),

		   new Function(c, "post--", IntType::postDec, Op,
                                Compiled, __C_postMinus_Minus__char_charAmp_,
				Return, "char", 
				Args, "char&", End),
