...
Type*
MuLangContext::arrayType(const Type* elementType, 
...
Type*  
MuLangContext::arrayType(const Type* elementType, const SizeVector& dimensions)
{
...
Type*
MuLangContext::arrayType(const Type* elementType, size_t dimensions, ...)
{
    va_list ap;
...
TypedValue
MuLangContext::evalText(const char *text, 
...
TypedValue
MuLangContext::evalFile(const char *file, 
                        Process* p,
                        const ModuleList& modules)
{
...
Type*
MuLangContext::parseType(const char *text, Process* p)
{
    if (!p) p = new Process(this);
...
void
MuLangContext::parseStream(Process* process, istream& in, const char* inputName)
{
...
Object* 
MuLangContext::exceptionObject(Exception& exc)
{
