...
IntType::IntType(Context* c) : PrimitiveType(c, "int", IntRep::rep())
{
}
...
PrimitiveObject*
IntType::newObject() const
{
    return new PrimitiveObject(this);
}

Value 
IntType::nodeEval(const Node *n, Thread &thread) const
{
    return Value((*n->func()._intFunc)(*n,thread));
}

void
IntType::nodeEval(void *p, const Node *n, Thread &thread) const
{
...
void 
IntType::outputValue(ostream &o, const Value &value, bool full) const
{
    o << value._int;
}

void
IntType::outputValueRecursive(ostream &o, const ValuePointer p, ValueOutputState& state) const
{
...
IntType::load()
{
    ...
    s->addSymbols( new ReferenceType(c, "int&", this),

		   new Function(c, "int", IntType::defaultInt, Mapped,
                                Compiled, __C_int_int,
				Return, "int",
				End),

		   new Function(c, "int", IntType::dereference, Cast,
                                Compiled, __C_int_int_intAmp_,
				Return, "int",
				Args, "int&", End),

		   new Function(c, "+", IntType::add, CommOp,
                                Compiled, __C_Plus__int_int_int,
				Return, "int", 
				Args, "int", "int", End),

		   new Function(c, "-", IntType::sub, Op,
                                Compiled, __C_Minus__int_int_int,
				Return, "int", 
				Args, "int", "int", End),

		   new Function(c, "-", IntType::negate, Op,
                                Compiled, __C_Minus__int_int,
				Return, "int", 
				Args, "int", End),

		   new Function(c, "*", IntType::mult, CommOp,
                                Compiled, __C_Star__int_int_int,
				Return, "int", 
				Args, "int", "int", End),

		   new Function(c, "/", IntType::div, Op,
                                Compiled, __C_Slash__int_int_int,
				Return, "int", 
				Args, "int", "int", End),

		   new Function(c, "%", IntType::mod, Op,
                                Compiled, __C_PCent__int_int_int,
				Return, "int", 
				Args, "int", "int", End),

		   new Function(c, "int", IntType::float2int, Lossy,
                                Compiled, __C_int_int_float,
				Return, "int", 
				Args, "float", End),

		   new Function(c, "int", IntType::double2int, Lossy,
                                Compiled, __C_int_int_double,
				Return, "int", 
				Args, "double", End),

		   new Function(c, "=", IntType::assign, AsOp,
                                Compiled, __C_EQ__intAmp__intAmp__int,
				Return, "int&", 
				Args, "int&", "int", End),

		   new Function(c, "+=", IntType::assignPlus, AsOp,
                                Compiled, __C_Plus_EQ__intAmp__intAmp__int,
				Return, "int&", 
				Args, "int&", "int", End),

		   new Function(c, "-=", IntType::assignSub, AsOp,
                                Compiled, __C_Minus_EQ__intAmp__intAmp__int,
				Return, "int&", 
				Args, "int&", "int", End),

		   new Function(c, "*=", IntType::assignMult, AsOp,
                                Compiled, __C_Star_EQ__intAmp__intAmp__int,
				Return, "int&", 
				Args, "int&", "int", End),

		   new Function(c, "/=", IntType::assignDiv, AsOp,
                                Compiled, __C_Slash_EQ__intAmp__intAmp__int,
				Return, "int&", 
				Args, "int&", "int", End),

		   new Function(c, "%=", IntType::assignMod, AsOp,
                                Compiled, __C_PCent_EQ__intAmp__intAmp__int,
				Return, "int&", 
				Args, "int&", "int", End),

		   new Function(c, "?:", IntType::conditionalExpr, 
                                Op ^ NativeInlined, // not inlined
                                Compiled, __C_QMark_Colon__bool_int_int,
				Return, "int", 
				Args, "bool", "int", "int", End),

		   new Function(c, "==", IntType::equals, CommOp,
                                Compiled, __C_EQ_EQ__bool_int_int,
				Return, "bool", 
				Args, "int", "int", End),

		   new Function(c, "!=", IntType::notEquals, CommOp,
                                Compiled, __C_Bang_EQ__bool_int_int,
				Return, "bool", 
				Args, "int", "int", End),

		   new Function(c, ">=", IntType::greaterThanEq, Op,
                                Compiled, __C_GT_EQ__bool_int_int,
				Return, "bool", 
				Args, "int", "int", End),

		   new Function(c, "<=", IntType::lessThanEq, Op,
                                Compiled, __C_LT_EQ__bool_int_int,
				Return, "bool", 
				Args, "int", "int", End),

		   new Function(c, "<", IntType::lessThan, Op,
                                Compiled, __C_LT__bool_int_int,
				Return, "bool", 
				Args, "int", "int", End),

		   new Function(c, ">", IntType::greaterThan, Op,
                                Compiled, __C_GT__bool_int_int,
				Return, "bool", 
				Args, "int", "int", End),

		   new Function(c, "|", IntType::bitOr, CommOp,
                                Compiled, __C_Pipe__int_int_int,
				Return, "int", 
				Args, "int", "int", End),

		   new Function(c, "&", IntType::bitAnd, CommOp,
                                Compiled, __C_Amp__int_int_int,
				Return, "int", 
				Args, "int", "int", End),

		   new Function(c, "^", IntType::bitXor, CommOp,
                                Compiled, __C_Caret__int_int_int,
				Return, "int", 
				Args, "int", "int", End),

		   new Function(c, "~", IntType::bitNot, Op,
                                Compiled, __C_Tilde__int_int,
				Return, "int", 
				Args, "int", End),

		   new Function(c, "<<", IntType::shiftLeft, Op,
                                Compiled, __C_LT_LT___int_int_int,
				Return, "int", 
				Args, "int", "int", End),

		   new Function(c, ">>", IntType::shiftRight, Op,
                                Compiled, __C_GT_GT___int_int_int,
				Return, "int", 
				Args, "int", "int", End),

		   new Function(c, "pre++", IntType::preInc, Op,
                                Compiled, __C_prePlus_Plus__int_intAmp_,
				Return, "int", 
				Args, "int&", End),

		   new Function(c, "post++", IntType::postInc, Op,
                                Compiled, __C_postPlus_Plus__int_intAmp_,
				Return, "int", 
				Args, "int&", End),

		   new Function(c, "pre--", IntType::preDec, Op,
                                Compiled, __C_preMinus_Minus__int_intAmp_,
				Return, "int", 
				Args, "int&", End),

		   new Function(c, "post--", IntType::postDec, Op,
                                Compiled, __C_postMinus_Minus__int_intAmp_,
				Return, "int", 
				Args, "int&", End),

		   EndArguments);

    this->addSymbols( new SymbolicConstant(c, "max", "int", 
...
NODE_IMPLEMENTATION(IntType::defaultInt,int)
{
    NODE_RETURN(0);
}
