...
MathUtilModule::MathUtilModule(Context* c) : Module(c, "math_util") {}
...
#define T Thread&
float __C_math_util_clamp_float_float_float_float(T, float a, float b, float c)
{ 
...
float __C_math_util_linstep_float_float_float_float(T, float a, float b, float c)
{
    return linstep(a,b,c);
}

float __C_math_util_smoothstep_float_float_float_float(T, float a, float b, float c)
{
    return smoothstep(a,b,c);
}

float __C_math_util_hermite_float_float_float_float_float_float(T,
                                                      float a, float b, 
                                                      float c, float d, 
                                                      float e)
{
...
float __C_math_util_lerp_float_float_float_float(T, float a, float b, float t)
{
...
Vector3f __C_math_util_rotate_vector_floatBSB_3ESB__vector_floatBSB_3ESB__vector_floatBSB_3ESB_float(T, Vector3f p, Vector3f axis, float radians)
{ 
...
Vector3f __C_math_util_dnoise3_vector_floatBSB_3ESB__vector_floatBSB_3ESB_(T, Vector3f a)
{
    return Mu::dnoise3(a);
}

Vector2f __C_math_util_dnoise2_vector_floatBSB_2ESB__vector_floatBSB_2ESB_(T, Vector2f a) 
{
    return Mu::dnoise2(a);
}
...
float __C_math_util_noise1_float_float(T, float a)
{
    return Mu::noise1(a);
}
...
MathUtilModule::load()
{
    ...
    addSymbols( new Function(c, "clamp", MathUtilModule::clamp, Mapped,
                             Compiled, __C_math_util_clamp_float_float_float_float,
                             Return, "float",
                             Args, "float", "float", "float",
                             End),

                new Function(c, "step", MathUtilModule::step, Mapped,
                             Compiled, __C_math_util_step_float_float_float,
                             Return, "float",
                             Args, "float", "float",
                             End),

                new Function(c, "linstep", MathUtilModule::linstep, Mapped,
                             Compiled, __C_math_util_linstep_float_float_float_float,
                             Return, "float",
                             Args, "float", "float", "float",
                             End),

                new Function(c, "smoothstep", MathUtilModule::smoothstep, Mapped,
                             Compiled, __C_math_util_smoothstep_float_float_float_float,
                             Return, "float",
                             Args, "float", "float", "float",
                             End),

                new Function(c, "hermite", MathUtilModule::hermite, Mapped,
                             Compiled, __C_math_util_hermite_float_float_float_float_float_float,
                             Return, "float",
                             Args, "float", "float", "float", "float","float",
                             End),

                new Function(c, "lerp", MathUtilModule::lerp, Mapped,
                             Compiled, __C_math_util_lerp_float_float_float_float,
                             Return, "float",
                             Args, "float", "float", "float",
                             End),

                new Function(c, "lerp", MathUtilModule::lerp2f, None,
                             Compiled, __C_math_util_lerp_vector_floatBSB_2ESB__vector_floatBSB_2ESB__vector_floatBSB_2ESB_,
                             Return, "vector float[2]",
                             Args, "vector float[2]", "vector float[2]","float",
                             End),

                new Function(c, "lerp", MathUtilModule::lerp3f, None,
                             Compiled, __C_math_util_lerp_vector_floatBSB_3ESB__vector_floatBSB_3ESB__vector_floatBSB_3ESB_,
                             Return, "vector float[3]",
                             Args, "vector float[3]", "vector float[3]","float",
                             End),

                new Function(c, "lerp", MathUtilModule::lerp4f, None,
                             Compiled, __C_math_util_lerp_vector_floatBSB_4ESB__vector_floatBSB_4ESB__vector_floatBSB_4ESB_,
                             Return, "vector float[4]",
                             Args, "vector float[4]", "vector float[4]","float",
                             End),

                new Function(c, "rotate", MathUtilModule::rotate, Mapped,
                             Compiled, __C_math_util_rotate_vector_floatBSB_3ESB__vector_floatBSB_3ESB__vector_floatBSB_3ESB_float,
                             Return, "vector float[3]",
                             Args, "vector float[3]", "vector float[3]","float",
                             End),

                new Function(c, "degrees", MathUtilModule::degrees, Mapped,
                             Compiled, __C_math_util_degrees_float_float,
                             Return, "float",
                             Args, "float",
                             End),

                new Function(c, "radians", MathUtilModule::radians, Mapped,
                             Compiled, __C_math_util_radians_float_float,
                             Return, "float",
                             Args, "float", End),

                new Function(c, "random", MathUtilModule::randomf2, None,
                             Compiled, __C_math_util_random_float_float_float,
                             Return, "float",
                             Args, "float", "float",
                             End),

                new Function(c, "random", MathUtilModule::randomf, None,
                             Compiled, __C_math_util_random_float_float,
                             Return, "float",
                             Args, "float", End,
                             End),

                new Function(c, "random", MathUtilModule::random, None,
                             Compiled, __C_math_util_random_int_int,
                             Return, "int",
                             Args, "int",
                             End),

                new Function(c, "gauss", MathUtilModule::gauss, None,
                             Compiled, __C_math_util_gauss_float_float,
                             Return, "float",
                             Args, "float",
                             End),

                new Function(c, "seed", MathUtilModule::seed, None,
                             Compiled, __C_math_util_seed_void_int,
                             Return, "void",
                             Args, "int", End),

                new Function(c, "sphrand", MathUtilModule::sphrand, None,
                             Compiled, __C_math_util_sphrand_vector_floatBSB_3ESB_,
                             Return, "vector float[3]",
                             End),

                new Function(c, "noise", MathUtilModule::noise1, Mapped,
                             Compiled, __C_math_util_noise1_float_float,
                             Return, "float",
                             Args, "float",
                             End),

                new Function(c, "noise", MathUtilModule::noise2, Mapped,
                             Compiled, __C_math_util_noise2_float_vector_floatBSB_2ESB_,
                             Return, "float",
                             Args, "vector float[2]",
                             End),

                new Function(c, "noise", MathUtilModule::noise3, Mapped,
                             Compiled, __C_math_util_noise3_float_vector_floatBSB_3ESB_,
                             Return, "float",
                             Args, "vector float[3]",
                             End),

                new Function(c, "dnoise", MathUtilModule::dnoise1, Mapped,
                             Compiled, __C_math_util_dnoise1_float_float,
                             Return, "float",
                             Args, "float",
                             End),

                new Function(c, "dnoise", MathUtilModule::dnoise2, Mapped,
                             Compiled, __C_math_util_dnoise2_vector_floatBSB_2ESB__vector_floatBSB_2ESB_,
                             Return, "vector float[2]",
                             Args, "vector float[2]",
                             End),

                new Function(c, "dnoise", MathUtilModule::dnoise3, Mapped,
                             Compiled, __C_math_util_dnoise3_vector_floatBSB_3ESB__vector_floatBSB_3ESB_,
                             Return, "vector float[3]",
                             Args, "vector float[3]",
                             End),
...
float
hermite(float p0, float p1, float r0, float r1, float t)
{
    const float t2 = t * t;
    const float t3 = t2 * t;
    const float t2_x3 = t2 * 3.0f;
    const float t3_x2 = t3 * 2.0f;
    return (float(p0 * (t3_x2 - t2_x3)
                  + p1 * (-t3_x2 + t2_x3)
                  + r0 * (t3 - 2.0f * t2 + t)
                  + r1 * (t3 - t2)));
}
...
float
linstep(float a, float b, float t)
{
    bool invert = false;
...
float
smoothstep(float a, float b, float u)
{
    bool invert = false;
...
float
noise2(const Vector2f &v)
{
    return Mu::noise2((const float*)&v );
}
...
float
noise3(const Vector3f &v)
{
    return Mu::noise3((const float*)&v);
}
...
Vector3f
rotate(Vector3f p, Vector3f axis, float radians)
{
