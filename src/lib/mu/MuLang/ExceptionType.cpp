...
ExceptionType::Exception::Exception(const Class *c) : ClassInstance(c) {}

String
ExceptionType::Exception::backtraceAsString() const
{
...
ExceptionType::ExceptionType(Context* c, Class *super) : Class(c, "exception", super)
{
}
...
Object*
ExceptionType::newObject() const
{
    return new Exception(this);
}

void
ExceptionType::deleteObject(Object *obj) const
{
...
void 
ExceptionType::outputValueRecursive(ostream &o,
...
ExceptionType::load()
{
    ...
    s->addSymbols( new ReferenceType(c, "exception&",this), 
		   ...
		   new Function(c, "exception", ExceptionType::construct, None,
		   ...
		   new Function(c, "=", ExceptionType::assign, AsOp,
				Return, "exception&", 
				Args, "exception&", "exception", End),

		   new Function(c, "==", ExceptionType::equals, CommOp,
				Return, "bool", 
				Args, "exception", "exception", End),

		   new Function(c, "print", ExceptionType::print, None,
				Return, "void", 
				Args, "exception", End),

		   new Function(c, "__try", ExceptionType::mu__try, None,
				Return, "void", 
				Args, "?", "?", Optional, "?varargs", End),

		   new Function(c, "__catch", ExceptionType::mu__catch, None,
				Return, "bool", 
				Args, "?", "?", End),
		   ...
		   new Function(c, "__exception", 
				ExceptionType::mu__exception, None,
				Return, "object", End),

		   new Function(c, "__throw", 
				ExceptionType::mu__throw_exception, None,
				Return, "void", 
				Args, "exception", End),

		   new Function(c, "__throw", 
				ExceptionType::mu__throw, None,
				Return, "void", 
				Args, "object", End),

		   new Function(c, "__rethrow", 
				ExceptionType::mu__rethrow, None,
				Return, "void", End),
    ...
    addSymbols( new MemberFunction(c, "copy", ExceptionType::copy, Mapped,
                ...
                new MemberFunction(c, "backtrace", ExceptionType::backtrace, None,
                                   Return, "string[]",
                                   Args, "exception", End),
		EndArguments );
...
NODE_IMPLEMENTATION(ExceptionType::mu__throw_exception, void)
{
    ...
    NODE_THREAD.setException(e);
    // NOTE : Comment-out the following line to avoid a crash in the backtrace
    // code.
...
NODE_IMPLEMENTATION(ExceptionType::stringCast, Pointer)
{
    ...
    Process *p = NODE_THREAD.process();
    const Class *c = static_cast<const ExceptionType*>(NODE_THIS.type());
    ExceptionType::Exception *o = 
	new ExceptionType::Exception(c);
    o->string() = s->c_str();
    NODE_RETURN(Pointer(o));
}
