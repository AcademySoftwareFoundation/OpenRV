...
ByteType::ByteType(Context* c) : PrimitiveType(c, "byte", CharRep::rep())
{
}
...
PrimitiveObject*
ByteType::newObject() const
{
    return new PrimitiveObject(this);
}

Value 
ByteType::nodeEval(const Node *n, Thread &thread) const
{
    return Value((*n->func()._charFunc)(*n,thread));
}

void
ByteType::nodeEval(void *p, const Node *n, Thread &thread) const
{
...
void 
ByteType::outputValue(ostream &o, const Value &value, bool full) const
{
    o << int(byte(value._char));
}

void
ByteType::outputValueRecursive(ostream &o, 
...
ByteType::load()
{
    ...
    s->addSymbols( new ReferenceType(c, "byte&", this),

		   new Function(c, "byte", ByteType::defaultByte, Mapped,
                                Compiled, __C_byte_byte,
				Return, "byte",
				End),

		   new Function(c, "byte", ByteType::dereference, Cast,
                                Compiled, __C_byte_byte_byteAmp_,
				Return, "byte",
				Args, "byte&", End),

                   new Function(c, "byte", ByteType::fromInt64, Cast | Lossy,
                                Compiled, __C_byte_byte_int64,
                                Return, "byte",
                                Args, "int64", End), 

                   new Function(c, "byte", ByteType::fromInt, Cast | Lossy,
                                Compiled, __C_byte_byte_int,
                                Return, "byte",
                                Args, "int", End), 

                   new Function(c, "byte", ByteType::fromChar, Cast | Lossy,
                                Compiled, __C_byte_byte_char,
                                Return, "byte",
                                Args, "char", End), 

                   new Function(c, "int", ByteType::fromByte, Cast,
                                Compiled, __C_int_int_byte,
                                Return, "int",
                                Args, "byte", End), 

		   new Function(c, "+", ByteType::add, CommOp,
                                Compiled, __C_Plus__byte_byte_byte,
				Return, "byte", 
				Args, "byte", "byte", End),

		   new Function(c, "-", ByteType::sub, Op,
                                Compiled, __C_Minus__byte_byte_byte,
				Return, "byte", 
				Args, "byte", "byte", End),

		   new Function(c, "-", ByteType::negate, Op,
                                Compiled, __C_Minus__byte_byte,
				Return, "byte", 
				Args, "byte", End),

		   new Function(c, "*", ByteType::mult, CommOp,
                                Compiled, __C_Star__byte_byte_byte,
				Return, "byte", 
				Args, "byte", "byte", End),

		   new Function(c, "/", ByteType::div, Op,
                                Compiled, __C_Slash__byte_byte_byte,
				Return, "byte", 
				Args, "byte", "byte", End),

		   new Function(c, "%", ByteType::mod, Op,
                                Compiled, __C_PCent__byte_byte_byte,
				Return, "byte", 
				Args, "byte", "byte", End),

		   new Function(c, "=", ByteType::assign, AsOp,
                                Compiled, __C_EQ__byteAmp__byteAmp__byte,
				Return, "byte&", 
				Args, "byte&", "byte", End),

		   new Function(c, "+=", ByteType::assignPlus, AsOp,
                                Compiled, __C_Plus_EQ__byteAmp__byteAmp__byte,
				Return, "byte&", 
				Args, "byte&", "byte", End),

		   new Function(c, "-=", ByteType::assignSub, AsOp,
                                Compiled, __C_Minus_EQ__byteAmp__byteAmp__byte,
				Return, "byte&", 
				Args, "byte&", "byte", End),

		   new Function(c, "*=", ByteType::assignMult, AsOp,
                                Compiled, __C_Star_EQ__byteAmp__byteAmp__byte,
				Return, "byte&", 
				Args, "byte&", "byte", End),

		   new Function(c, "/=", ByteType::assignDiv, AsOp,
                                Compiled, __C_Slash_EQ__byteAmp__byteAmp__byte,
				Return, "byte&", 
				Args, "byte&", "byte", End),

		   new Function(c, "%=", ByteType::assignDiv, AsOp,
                                Compiled, __C_PCent_EQ__byteAmp__byteAmp__byte,
				Return, "byte&", 
				Args, "byte&", "byte", End),

		   new Function(c, "?:", ByteType::conditionalExpr,
                                Op ^ NativeInlined, // not inlined
                                Compiled, __C_QMark_Colon__bool_byte_byte,
				Return, "byte", 
				Args, "bool", "byte", "byte", End),

		   new Function(c, "==", ByteType::equals, CommOp,
                                Compiled, __C_EQ_EQ__bool_byte_byte,
				Return, "bool", 
				Args, "byte", "byte", End),

		   new Function(c, "!=", ByteType::notEquals, CommOp,
                                Compiled, __C_Bang_EQ__bool_byte_byte,
				Return, "bool", 
				Args, "byte", "byte", End),

		   new Function(c, ">=", ByteType::greaterThanEq, Op,
                                Compiled, __C_GT_EQ__bool_byte_byte,
				Return, "bool", 
				Args, "byte", "byte", End),

		   new Function(c, "<=", ByteType::lessThanEq, Op,
                                Compiled, __C_LT_EQ__bool_byte_byte,
				Return, "bool", 
				Args, "byte", "byte", End),

		   new Function(c, "<", ByteType::lessThan, Op,
                                Compiled, __C_LT__bool_byte_byte,
				Return, "bool", 
				Args, "byte", "byte", End),

		   new Function(c, ">", ByteType::greaterThan, Op,
                                Compiled, __C_GT__bool_byte_byte,
				Return, "bool", 
				Args, "byte", "byte", End),

		   new Function(c, "|", ByteType::bitOr, CommOp,
                                Compiled, __C_Pipe__byte_byte_byte,
				Return, "byte", 
				Args, "byte", "byte", End),

		   new Function(c, "&", ByteType::bitAnd, CommOp,
                                Compiled, __C_Amp__byte_byte_byte,
				Return, "byte", 
				Args, "byte", "byte", End),

		   new Function(c, "^", ByteType::bitXor, CommOp,
                                Compiled, __C_Caret__byte_byte_byte,
				Return, "byte", 
				Args, "byte", "byte", End),

		   new Function(c, "~", ByteType::bitNot, Op,
                                Compiled, __C_Tilde__byte_byte,
				Return, "byte", 
				Args, "byte", End),

		   new Function(c, "<<", ByteType::shiftLeft, Op,
                                Compiled, __C_LT_LT___byte_byte_byte,
				Return, "byte", 
				Args, "byte", "byte", End),

		   new Function(c, ">>", ByteType::shiftRight, Op,
                                Compiled, __C_GT_GT___byte_byte_byte,
				Return, "byte", 
				Args, "byte", "byte", End),

		   new Function(c, "pre++", ByteType::preInc, Op,
                                Compiled, __C_prePlus_Plus__byte_byteAmp_,
				Return, "byte", 
				Args, "byte&", End),

		   new Function(c, "post++", ByteType::postInc, Op,
                                Compiled, __C_postPlus_Plus__byte_byteAmp_,
				Return, "byte", 
				Args, "byte&", End),

		   new Function(c, "pre--", ByteType::preDec, Op,
                                Compiled, __C_preMinus_Minus__byte_byteAmp_,
				Return, "byte", 
				Args, "byte&", End),

		   new Function(c, "post--", ByteType::postDec, Op,
                                Compiled, __C_postMinus_Minus__byte_byteAmp_,
				Return, "byte", 
				Args, "byte&", End),

		   EndArguments);

    this->addSymbols( new SymbolicConstant(c, "max", "byte", 
...
NODE_IMPLEMENTATION(ByteType::defaultByte, char)
{
    NODE_RETURN(char(0));
}
