...
class Function : public Symbol
{
  public:
    ...
    //
    //  Function("foo",			// Function: void foo(int,float,double)
    // 	         &fooFunc,		// node function
    //	         Function::None,           // no attributes
    //	         Function::Return, "void",
    //	         Function::Args, "int", "float", Function::Optional, "double",
    //	         Function::End);
    //
    //	Note: Once you use the "Optional" argument keyword, all remaining
    //	declared arguments are optional. The "Maximum" keyword is useful
    //	when there are pseudo types (pattern types) supplied. Here's an
    //	example:
    //
    //  Function("foo",	
    // 	         &fooFunc,
    ...
    bool		    hasDependentSideEffects() const   
                            { return _dependentSideEffects; }
    bool		    isContextDependent() const 
			    { return _contextDependent;}
    ...
    //
    //	matches() returns true if the name, return value, and arguments all
    //	match.
    //
...
#define USING_MU_FUNCTION_SYMBOLS                                       \
    ...
    Mu::Function::Attributes CommOp = Mu::Function::Mapped |            \
                                    Mu::Function::Commutative |         \
                                    Mu::Function::Operator |            \
                                    Mu::Function::NoSideEffects;        \
    Mu::Function::Attributes Op     = Mu::Function::Mapped |            \
                                    Mu::Function::Operator |            \
                                    Mu::Function::NoSideEffects;        \
    Mu::Function::Attributes Mapped = Mu::Function::Mapped |            \
                                    Mu::Function::NoSideEffects;        \
    Mu::Function::Attributes Pure = Mu::Function::Mapped |              \
                                    Mu::Function::NoSideEffects;        \
    Mu::Function::Attributes Cast   = Mapped | Mu::Function::Cast;      \
    Mu::Function::Attributes Lossy  = Cast | Mu::Function::Lossy;       \
    Mu::Function::Attributes AsOp   = Mu::Function::MemberOperator |    \
                                    Mu::Function::Operator;             \
