...
template<class T,class Traits>
inline
HashTable<T,Traits>::Iterator::Iterator(const HashTable<T,Traits> *table)
...
template<class T,class Traits>
void
HashTable<T,Traits>::Iterator::operator++()
{
    if (_item) 
...
template<class T,class Traits>
HashTable<T,Traits>::Item::Item(const T &thing) : _data(thing), _next(0) 
{
}

template<class T,class Traits>
HashTable<T,Traits>::HashTable() : _table(0), _tableSize(0), _size(0)
{ 
    resize(); 
}
...
template<class T,class Traits>
const typename HashTable<T,Traits>::Item* 
HashTable<T,Traits>::firstItemOf(typename HashTable<T,Traits>::HashValue h) const
{
