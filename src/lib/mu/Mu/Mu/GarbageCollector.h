...
# endif
  ...
  GC_Tp* allocate(size_type GC_n, const void* = 0) {
    ...
    return static_cast<GC_Tp *>
	    (MU_GC_selective_alloc(GC_n * sizeof(GC_Tp),
...
inline bool operator==(const MuGCAPI_allocator<GC_T1>&, const MuGCAPI_allocator<GC_T2>&)
{
  return true;
}
