...
#define GC_THREADS 1
// Note: windows.h includes winsock.h by default (if WIN32_LEAN_AND_MEAN is not defined). 
// Any time winsock.h gets included before winsock2.h, there will be compiler errors.
// The reason is because the two files DO NOT co-exist very well. winsock2.h was designed 
// to replace winsock.h, not extend it. Everything that is defined in winsock.h is also 
