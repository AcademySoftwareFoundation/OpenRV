...
void
Type::outputNode(std::ostream &o, const Node *n) const
{
...
void
Type::outputValueRecursive(ostream& o,
                           const ValuePointer,
...
void
Type::outputValue(std::ostream &o, const ValuePointer p, bool full) const
{
...
Type::MatchResult
Type::match(const Type *other, Bindings& bindings) const
{
    if (isPrimitiveType())
    {
...
size_t
Type::objectSize() const
{
    return 0;
}

const Type*
Type::nodeReturnType(const Node*) const
{
    return this;
}

void
Type::deleteObject(Object *obj) const
{
    cerr << "Type::deleteObject -- "
	 << hex << obj << " " << name() << endl;
}

void
Type::constructInstance(Pointer) const
{
    abort();
}

void 
Type::copyInstance(Pointer from, Pointer to) const
{
    abort();
}
...
const Type*
Type::fieldType(size_t) const
{
    return 0;
}

ValuePointer
Type::fieldPointer(Object*, size_t) const
{
    return 0;
}

const ValuePointer
Type::fieldPointer(const Object*, size_t) const
{
    return 0;
}

void
Type::serialize(std::ostream& o, 
...
void
Type::deserialize(std::istream& i, 
...
void
Type::reconstitute(Archive::Reader& archive, Object* obj) const
{
    const Type*  ftype = 0;
    ValuePointer fp    = 0;
    size_t       index = 0;
