...
NODE_IMPLEMENTATION(RiMuBindings::RiAttribute, void)
{
    ...
    if( ! parseTokens( NODE_THIS, NODE_THREAD,
                       tokens, pointers,
                       numTokens, nPoints, 1 ) )
    {
...
{
    ::RiMotionBegin( 2, NODE_ARG(0,float),
                        NODE_ARG(1,float), NULL );
}


// *****************************************************************************
NODE_IMPLEMENTATION(RiMuBindings::RiMotionEnd, void)
{
    ::RiMotionEnd();
}
...
NODE_IMPLEMENTATION(RiMuBindings::RiLightSource, int)
{
    ...
    RtLightHandle light = ::RiLightSourceV( (char*)shaderName, 
...
RtBasis &RiMuBindings::basisFromStr( std::string name )
{
    ...
    if( name == "BSpline" ) return RiBSplineBasis;
    if( name == "CatmullRom" ) return RiCatmullRomBasis;
    if( name == "Hermite" ) return RiHermiteBasis;
    if( name == "Power" ) return RiPowerBasis;
...
NODE_IMPLEMENTATION(RiMuBindings::RiCurves, void)
{
    ...
    ::RiCurvesV( (RtToken)degree, nCurves, nVerts, (RtToken)wrap,
                 numTokens, tokens, pointers );
...
NODE_IMPLEMENTATION(RiMuBindings::RiProcedural, void)
{
    ...
    if( NODE_NUM_ARGS() == 3 )
    {
        ...
        for( int i = 0; i < 6; ++i ) bounds[i] = b->element<float>(i);
    }
...
NODE_IMPLEMENTATION(RiMuBindings::RiTransformPoints, bool)
{
    ...
    RtPoint *result = ::RiTransformPoints( (char *)fromspace.c_str(),
                                           (char *)tospace.c_str(),
                                           verts->size(),
                                           verts->data<RtPoint>() );
    if( ! result )
...
// *****************************************************************************
bool RiMuBindings::parseTokens( const Mu::Node &node_, 
                                Mu::Thread &thread_,
                                RtToken *tokens,
                                RtPointer *pointers,
                                int &numTokens,
...
// *****************************************************************************
void RiMuBindings::freeTokens( RtToken *tokens,
                               int numTokens,
                               int startAtArg )
{
...
void RiMuBindings::addSymbols( Context *context )
{
    ...
    context->globalScope()->addSymbols(
        ...
        new Function(c, "RiAttribute", RiMuBindings::RiAttribute,
                                 NoHint,
                                 Args, "string", "?varargs",
        ...
        new Function(c, "RiTranslate", RiMuBindings::RiTranslatef,
                                 NoHint,
                                 Return, "void",
                                 Args, "float", "float", "float", 
                                 End),

        new Function(c, "RiTranslate", RiMuBindings::RiTranslatev,
                                 NoHint,
                                 Return, "void",
                                 Args, "vector float[3]",
                                 End),

        new Function(c, "RiRotate", RiMuBindings::RiRotate,
                                 NoHint,
                                 Return, "void",
                                 Args, "float", "float", "float", "float", 
                                 End),

        new Function(c, "RiScale", RiMuBindings::RiScale,
                                 NoHint,
                                 Return, "void",
                                 Args, "float", "float", "float", 
                                 End),

        new Function(c, "RiTransform", RiMuBindings::RiTransformF,
                                 NoHint,
                                 Return, "void",
                                 Args, "float", "float", "float", "float", 
        ...
        new Function(c, "RiTransform", RiMuBindings::RiTransformM,
                                 NoHint,
                                 Return, "void",
                                 Args, "float[4,4]",
                                 End),

        new Function(c, "RiConcatTransform", RiMuBindings::RiConcatTransformF,
                                 NoHint,
                                 Return, "void",
                                 Args, "float", "float", "float", "float", 
                                       "float", "float", "float", "float",
        ...
        new Function(c, "RiConcatTransform", RiMuBindings::RiConcatTransformM,
                                 NoHint,
                                 Return, "void",
                                 Args, "float[4,4]",
                                 End),
        ...
        new Function(c, "RiMotionEnd", RiMuBindings::RiMotionEnd,
                                 NoHint,
                                 Return, "void",
                                 End),

        new Function(c, "RiColor", RiMuBindings::RiColor,
                                 NoHint,
                                 Return, "void",
                                 Args, "float", "float", "float", 
                                 End),

        new Function(c, "RiColor", RiMuBindings::RiColorf,
                                 NoHint,
                                 Return, "void",
                                 Args, "vector float[3]", 
                                 End),

        new Function(c, "RiOpacity", RiMuBindings::RiOpacity,
                                 NoHint,
                                 Return, "void",
                                 Args, "float", Optional, "float", "float", 
                                 End),

        new Function(c, "RiOpacity", RiMuBindings::RiOpacityf,
                                 NoHint,
                                 Return, "void",
                                 Args, "vector float[3]", 
                                 End),
        ...
        new Function(c, "RiMatte", RiMuBindings::RiMatte,
                                 NoHint,
                                 Return, "void",
                                 Args, "bool", 
                                 End),

        new Function(c, "RiSurface", RiMuBindings::RiSurface,
                                 NoHint,
                                 Return, "void",
                                 Args, "string", Optional, "?varargs",
                                 Maximum, MAX_PARAMETER_TOKENS,  
                                 End),
        ...
        new Function(c, "RiIlluminate", RiMuBindings::RiIlluminate,
                                 NoHint,
                                 Return, "void",
                                 Args, "int", "bool",
                                 End),

        new Function(c, "RiSphere", RiMuBindings::RiSphere,
                                 NoHint,
                                 Return, "void",
                                 Args, "float", "float", "float", "float",
                                 End),

        new Function(c, "RiBasis", RiMuBindings::RiBasis,
                                 NoHint,
                                 Return, "void",
                                 Args, "string", "int", "string", "int",
                                 End),

        new Function(c, "RiPoints", RiMuBindings::RiPoints,
                                 NoHint,
                                 Return, "void",
                                 Args, "string", "?varargs",
                                 Maximum, MAX_PARAMETER_TOKENS, 
        ...
        new Function(c, "RiCurves", RiMuBindings::RiCurves,
                                 NoHint,
                                 Return, "void",
                                 Args, "string", "int", "int[]", 
                                       "string", "?varargs",
        ...
        new Function(c, "RiPolygon", RiMuBindings::RiPolygon,
                                 NoHint,
                                 Return, "void",
                                 Args, "?varargs",
                                 Maximum, MAX_PARAMETER_TOKENS, 
        ...
        new Function(c, "RiProcedural", RiMuBindings::RiProcedural,
                                 NoHint,
                                 Return, "void",
                                 Args, "string", "string",
                                 Optional, "float[6]",
        ...
        new Function(c, "RiTransformPoints", RiMuBindings::RiTransformPoints,
                                 NoHint,
                                 Return, "bool",
