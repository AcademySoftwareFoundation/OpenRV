...
```text
In file included from /UTV/src/lib/graphics/TwkGLF/GLVideoDevice.cpp:5:
In file included from /UTV/src/lib/graphics/TwkGLF/GLVideoDevice.h:7:
...
In file included from /UTV/src/lib/base/TwkMath/time.h:7:
In file included from /UTV/src/lib/base/TwkMath/math.h:12:
...
```text
/UTV/src/lib/base/TwkUtil/FileStream.cpp:170:10: fatal error: libaio.h: No such file or directory
 #include <libaio.h>
          ^~~~~~~~~~
```
...
/UTV/src/bin/apps/rv/main.cpp:419: undefined reference to `qInitResources_rv()'
collect2: error: ld returned 1 exit status
