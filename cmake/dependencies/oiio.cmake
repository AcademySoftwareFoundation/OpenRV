...
IF(RV_USE_SYSTEM_DEPS)
  ...
  ENDIF()
    ...
    IF(DEFINED OpenImageIO_VERSION)
      SET(RV_DEPS_OIIO_VERSION "${OpenImageIO_VERSION}")
      SET(RV_DEPS_OIIO_VERSION "${OpenImageIO_VERSION}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED OPENIMAGEIO_VERSION)
      SET(RV_DEPS_OIIO_VERSION "${OPENIMAGEIO_VERSION}")
      SET(RV_DEPS_OIIO_VERSION "${OPENIMAGEIO_VERSION}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED OpenImageIO_VERSION_STRING)
      SET(RV_DEPS_OIIO_VERSION "${OpenImageIO_VERSION_STRING}")
      SET(RV_DEPS_OIIO_VERSION "${OpenImageIO_VERSION_STRING}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED OPENIMAGEIO_VERSION_STRING)
      SET(RV_DEPS_OIIO_VERSION "${OPENIMAGEIO_VERSION_STRING}")
      SET(RV_DEPS_OIIO_VERSION "${OPENIMAGEIO_VERSION_STRING}" CACHE STRING "" FORCE)
    ENDIF()
