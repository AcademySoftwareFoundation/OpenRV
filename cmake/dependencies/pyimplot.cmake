...
MESSAGE(STATUS "imgui include dirs: ${_imgui_include_dirs}")
...
EXTERNALPROJECT_ADD(
  ...
  PATCH_COMMAND
    ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/imgui/CMakeLists_PyImplot.cmake
    ${CMAKE_BINARY_DIR}/RV_DEPS_IMGUI/deps/imgui-bundle-pyimplot/external/implot/CMakeLists.txt && ${CMAKE_COMMAND} -E copy
    ${CMAKE_CURRENT_SOURCE_DIR}/imgui/pybind_implot_module.cpp ${CMAKE_BINARY_DIR}/RV_DEPS_IMGUI/deps/imgui-bundle-pyimplot/external/implot/bindings
  UPDATE_COMMAND ${_requirements_install_command}
...
# TODO: Linux and Windows support
IF(RV_TARGET_DARWIN)
  SET(_libname
