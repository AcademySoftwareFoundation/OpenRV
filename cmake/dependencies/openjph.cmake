...
IF(RV_USE_SYSTEM_DEPS)
  ...
  ENDIF()
    ...
    IF(DEFINED PkgConfig_VERSION)
      SET(RV_DEPS_OPENJPH_VERSION "${PkgConfig_VERSION}")
      SET(RV_DEPS_OPENJPH_VERSION "${PkgConfig_VERSION}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED PKGCONFIG_VERSION)
      SET(RV_DEPS_OPENJPH_VERSION "${PKGCONFIG_VERSION}")
      SET(RV_DEPS_OPENJPH_VERSION "${PKGCONFIG_VERSION}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED PkgConfig_VERSION_STRING)
      SET(RV_DEPS_OPENJPH_VERSION "${PkgConfig_VERSION_STRING}")
      SET(RV_DEPS_OPENJPH_VERSION "${PkgConfig_VERSION_STRING}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED PKGCONFIG_VERSION_STRING)
      SET(RV_DEPS_OPENJPH_VERSION "${PKGCONFIG_VERSION_STRING}")
      SET(RV_DEPS_OPENJPH_VERSION "${PKGCONFIG_VERSION_STRING}" CACHE STRING "" FORCE)
    ENDIF()
