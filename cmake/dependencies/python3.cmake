...
IF(RV_USE_SYSTEM_DEPS)
  ...
  IF(NOT TARGET Python::Python)
    ...
    TARGET_LINK_LIBRARIES(Python::Python INTERFACE Python3::Python)
    TARGET_INCLUDE_DIRECTORIES(Python::Python INTERFACE ${Python3_INCLUDE_DIRS})
  ENDIF()
  
  SET(RV_DEPS_PYTHON3_EXECUTABLE ${Python3_EXECUTABLE} CACHE INTERNAL "" FORCE)
