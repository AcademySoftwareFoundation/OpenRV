...
IF(RV_TARGET_DARWIN)
  LIST(APPEND _python3_make_command "--macos-deploy-target")
  LIST(APPEND _python3_make_command ${CMAKE_OSX_DEPLOYMENT_TARGET})
ENDIF()
...
IF(RV_TARGET_DARWIN)
  LIST(APPEND _pyside2_make_command "--macos-deploy-target")
  LIST(APPEND _pyside2_make_command ${CMAKE_OSX_DEPLOYMENT_TARGET})
ENDIF()
