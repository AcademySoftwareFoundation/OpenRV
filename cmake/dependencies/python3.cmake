...
# ##############################################################################################################################################################
# Build PyOpenGL_accelerate from patched source. The patch fixes Python 3 compatibility (long -> ctypes.c_long) that newer Cython versions require.
# Once this is fixed just add PyOpenGL_accelerate into the requirements.txt.in file and remove the patch.
MESSAGE(STATUS "Patching PyOpenGL_accelerate and building from source")
