...
EXTERNALPROJECT_ADD(
  ...
  PATCH_COMMAND
    ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/imgui/CMakeLists_PyImGUI.cmake
    ${CMAKE_BINARY_DIR}/RV_DEPS_IMGUI/deps/imgui-bundle/external/imgui/CMakeLists.txt && ${CMAKE_COMMAND} -E copy
...
IF(RV_TARGET_DARWIN)
  SET(_libname
      "pyimgui.cpython-${RV_DEPS_PYTHON_VERSION_SHORT}-darwin.so"
  )
ELSEIF(RV_TARGET_LINUX)
  SET(_libname
    "pyimgui.cpython-${RV_DEPS_PYTHON_VERSION_SHORT}-x86_64-linux-gnu.so"
    )
ENDIF()
