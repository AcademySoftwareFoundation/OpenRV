...
IF(RV_USE_SYSTEM_DEPS)
  ...
  ENDIF()
    ...
    IF(DEFINED Boost_VERSION)
      SET(RV_DEPS_BOOST_VERSION "${Boost_VERSION}")
      SET(RV_DEPS_BOOST_VERSION "${Boost_VERSION}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED BOOST_VERSION)
      SET(RV_DEPS_BOOST_VERSION "${BOOST_VERSION}")
      SET(RV_DEPS_BOOST_VERSION "${BOOST_VERSION}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED Boost_VERSION_STRING)
      SET(RV_DEPS_BOOST_VERSION "${Boost_VERSION_STRING}")
      SET(RV_DEPS_BOOST_VERSION "${Boost_VERSION_STRING}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED BOOST_VERSION_STRING)
      SET(RV_DEPS_BOOST_VERSION "${BOOST_VERSION_STRING}")
      SET(RV_DEPS_BOOST_VERSION "${BOOST_VERSION_STRING}" CACHE STRING "" FORCE)
    ENDIF()
