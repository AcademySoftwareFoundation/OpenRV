...
IF(RV_USE_SYSTEM_DEPS)
  ...
  ENDIF()
    ...
    IF(DEFINED PNG_VERSION)
      SET(RV_DEPS_PNG_VERSION "${PNG_VERSION}")
      SET(RV_DEPS_PNG_VERSION "${PNG_VERSION}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED PNG_VERSION)
      SET(RV_DEPS_PNG_VERSION "${PNG_VERSION}")
      SET(RV_DEPS_PNG_VERSION "${PNG_VERSION}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED PNG_VERSION_STRING)
      SET(RV_DEPS_PNG_VERSION "${PNG_VERSION_STRING}")
      SET(RV_DEPS_PNG_VERSION "${PNG_VERSION_STRING}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED PNG_VERSION_STRING)
      SET(RV_DEPS_PNG_VERSION "${PNG_VERSION_STRING}")
      SET(RV_DEPS_PNG_VERSION "${PNG_VERSION_STRING}" CACHE STRING "" FORCE)
    ENDIF()
...
RV_CREATE_STANDARD_DEPS_VARIABLES("RV_DEPS_PNG" "${RV_DEPS_PNG_VERSION}" "make" "")
