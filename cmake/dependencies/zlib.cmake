...
IF(RV_USE_SYSTEM_DEPS)
  ...
  ENDIF()
    ...
    IF(DEFINED ZLIB_VERSION)
      SET(RV_DEPS_ZLIB_VERSION "${ZLIB_VERSION}")
      SET(RV_DEPS_ZLIB_VERSION "${ZLIB_VERSION}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED ZLIB_VERSION)
      SET(RV_DEPS_ZLIB_VERSION "${ZLIB_VERSION}")
      SET(RV_DEPS_ZLIB_VERSION "${ZLIB_VERSION}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED ZLIB_VERSION_STRING)
      SET(RV_DEPS_ZLIB_VERSION "${ZLIB_VERSION_STRING}")
      SET(RV_DEPS_ZLIB_VERSION "${ZLIB_VERSION_STRING}" CACHE STRING "" FORCE)
    ELSEIF(DEFINED ZLIB_VERSION_STRING)
      SET(RV_DEPS_ZLIB_VERSION "${ZLIB_VERSION_STRING}")
      SET(RV_DEPS_ZLIB_VERSION "${ZLIB_VERSION_STRING}" CACHE STRING "" FORCE)
    ENDIF()
...
RV_CREATE_STANDARD_DEPS_VARIABLES("RV_DEPS_ZLIB" "${RV_DEPS_ZLIB_VERSION}" "make" "")
