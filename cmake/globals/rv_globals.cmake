...
IF(RV_TARGET_DARWIN)
  ...
  EXECUTE_PROCESS(COMMAND ${CMAKE_COMMAND} -E create_symlink "MacOS" "bin"  WORKING_DIRECTORY ${RV_STAGE_ROOT_DIR})
...
IF(RV_TARGET_DARWIN)
  SET(RV_STAGE_LIB_DIR
          ${RV_STAGE_FRAMEWORKS_DIR}
  )
  EXECUTE_PROCESS(COMMAND ${CMAKE_COMMAND} -E create_symlink "Frameworks" "lib"  WORKING_DIRECTORY ${RV_STAGE_ROOT_DIR})
ELSE ()
  SET(RV_STAGE_LIB_DIR
