...
IF(RV_FFMPEG_8)
    ...
    SET(RV_DEPS_FFMPEG_VERSION_LIB_avutil "60")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_swresample "6")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_swscale "9")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_avcodec "62")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_avformat "62")
ELSEIF(RV_FFMPEG_7)
    SET(RV_DEPS_FFMPEG_VERSION "n7.1")
    SET(RV_DEPS_FFMPEG_DOWNLOAD_HASH "a7a85ec05c9bc3aeefee12743899d8ab")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_avutil "59")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_swresample "5")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_swscale "8")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_avcodec "61")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_avformat "61")
ELSEIF(RV_FFMPEG_6)
    SET(RV_DEPS_FFMPEG_VERSION "n6.1.2")
    SET(RV_DEPS_FFMPEG_DOWNLOAD_HASH "953b858e5be3ab66232bdbb90e42f50d")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_avutil "58")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_swresample "4")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_swscale "7")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_avcodec "60")
    SET(RV_DEPS_FFMPEG_VERSION_LIB_avformat "60")
ELSE()
...
SET(RV_DEPS_OPENJPH_VERSION "0.21.3")
SET(RV_DEPS_OPENJPH_DOWNLOAD_HASH "d0a3fb5f643a8948d5874624ff94a229")
...
SET(RV_DEPS_PCRE2_VERSION "10.43")
SET(RV_DEPS_PCRE2_DOWNLOAD_HASH "e4c3f2a24eb5c15bec8360e50b3f0137")
...
SET(RV_DEPS_SPDLOG_VERSION "1.11.0")
SET(RV_DEPS_SPDLOG_DOWNLOAD_HASH "cd620e0f103737a122a3b6539bd0a57a")

# tiff
# https://gitlab.com/libtiff/libtiff
SET(RV_DEPS_TIFF_VERSION "4.6.0")
SET(RV_DEPS_TIFF_DOWNLOAD_HASH "118a2e5fc9ed71653195b332b9715890")
SET(RV_DEPS_TIFF_VERSION_LIB "6.0.2")

# webp
# https://github.com/webmproject/libwebp
SET(RV_DEPS_WEBP_VERSION "1.2.1")
SET(RV_DEPS_WEBP_DOWNLOAD_HASH "ef5ac6de4b800afaebeb10df9ef189b2")

# zlib
# https://github.com/madler/zlib
SET(RV_DEPS_ZLIB_VERSION "1.3.1")
SET(RV_DEPS_ZLIB_DOWNLOAD_HASH "127b8a71a3fb8bebe89df1080f15fdf6")
