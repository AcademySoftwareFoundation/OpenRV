# CY2023 VFX Reference Platform versions of dependencies see https://vfxplatform.com/
...
IF(RV_VFX_PLATFORM STREQUAL "CY2023")
  ...
  SET(RV_DEPS_OCIO_DOWNLOAD_HASH
      "d337d7cc890c6a04ad725556c2b7fb4c"
  )
  ...
  SET(RV_DEPS_OPENEXR_DOWNLOAD_HASH
      "bbb385d52695502ea47303a2810a8bc1"
  )
  ...
  # SET(RV_DEPS_PYSIDE_VERSION "5.15.18") SET(RV_DEPS_PYSIDE_DOWNLOAD_HASH "52aa32613f7a69ff46e38ed8a427eb38")
  SET(RV_DEPS_PYSIDE_ARCHIVE_URL
      "https://mirrors.ocf.berkeley.edu/qt/official_releases/QtForPython/pyside2/PySide2-${RV_DEPS_PYSIDE_VERSION}-src/pyside-setup-opensource-src-${RV_DEPS_PYSIDE_VERSION}.zip"
  )
